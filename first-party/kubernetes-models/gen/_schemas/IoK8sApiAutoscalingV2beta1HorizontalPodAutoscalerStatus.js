...
const schema7 = {
  "properties": {
    "conditions": {
      "$ref": "GZtN1CPZ2r7hPIaXGxmsSEtovdNaGggZUUd63BbpJ0"
    },
    "currentMetrics": {
      "$ref": "6XnmLsHKtAKEYrWIJxR4unK9fiTKvnbqranwyOzmHXI"
    },
    "currentReplicas": {
  ...
  "type": "object",
  "$id": "io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerStatus"
};
const schema8 = {
  "items": {
    "$ref": "8TUtlpBYE3MfMznjfpnUakA5QXP4tkOxlS2BfSS2NU"
  },
  "type": "array",
  "nullable": true
};
...
const schema10 = {};
import { validate as validate25 } from "./IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerCondition";
...
const schema11 = {
  "items": {
    "$ref": "K3JhbdCuQ61KsJcIPW7oyBeBZcqb61Kux2FtObBktSA"
  },
  "type": "array",
  "nullable": true
};
...
const schema13 = {};
import { validate as validate31 } from "./IoK8sApiAutoscalingV2beta1MetricStatus";
