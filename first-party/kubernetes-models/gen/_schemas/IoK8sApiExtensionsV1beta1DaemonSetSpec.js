...
const schema7 = {
  "properties": {
    ...
    "updateStrategy": {
      "$ref": "AGe0K2XemvOcjasLXAjKcPOrbpnt0xvRGMhAyxWm8"
    }
  },
  "required": ["template"],
  "type": "object",
...
const schema13 = {
  "nullableRef": "io.k8s.api.extensions.v1beta1.DaemonSetUpdateStrategy#"
};
const schema14 = {};
import { validate as validate36 } from "./IoK8sApiExtensionsV1beta1DaemonSetUpdateStrategy";
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.templateGeneration !== undefined) {
      if (!validate33(data.templateGeneration, {
        instancePath: instancePath + "/templateGeneration",
        parentData: data,
        parentDataProperty: "templateGeneration",
        rootData
      })) {
    ...
    if (data.updateStrategy !== undefined) {
      if (!validate35(data.updateStrategy, {
