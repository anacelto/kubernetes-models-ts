...
const schema7 = {
  ...
  "required": ["allowed"],
  "type": "object",
  "$id": "io.k8s.api.authorization.v1beta1.SubjectAccessReviewStatus"
};
const schema8 = {
  "type": "boolean"
};
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.evaluationError !== undefined) {
      if (!validate21(data.evaluationError, {
