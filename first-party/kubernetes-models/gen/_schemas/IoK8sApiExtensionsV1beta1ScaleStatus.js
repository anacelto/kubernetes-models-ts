...
const schema6 = {
  ...
  "required": ["replicas"],
  "type": "object",
  "$id": "io.k8s.api.extensions.v1beta1.ScaleStatus"
};
const schema7 = {
  "format": "int32",
  "type": "integer"
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.targetSelector !== undefined) {
      if (!validate28(data.targetSelector, {
        instancePath: instancePath + "/targetSelector",
        parentData: data,
        parentDataProperty: "targetSelector",
        rootData
      })) {
