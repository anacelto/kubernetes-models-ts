...
const schema8 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "0xsWVA7x7TZiQNPv5hnEIFVzIhkJP58Wgs6hmkYSTPs"
    },
  ...
  "type": "object",
  "$id": "io.k8s.api.extensions.v1beta1.DaemonSetStatus"
};
const schema7 = {
  "format": "int32",
  "type": "integer",
...
const schema9 = {
  "items": {
    "$ref": "MwhmuhHBZTA4GUiG1YCe5ktB2ikVPEwaXsSRluGPo"
  },
  "type": "array",
  "nullable": true
};
const schema10 = {
  "$ref": "io.k8s.api.extensions.v1beta1.DaemonSetCondition#"
};
const schema11 = {};
import { validate as validate27 } from "./IoK8sApiExtensionsV1beta1DaemonSetCondition";
