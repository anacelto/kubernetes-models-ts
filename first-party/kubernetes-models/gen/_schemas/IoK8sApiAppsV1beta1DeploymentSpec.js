...
const schema7 = {
  "properties": {
    ...
    "rollbackTo": {
      "$ref": "cdM2W2qisPsk65036m3Pnj6QZ6PJdamTfGrMnM9FnIE"
    },
    "selector": {
      "$ref": "Am3gJXrJDlim5pEjXjCk4qB5T1njejh9RaIGwx5cLKg"
    },
    "strategy": {
      "$ref": "ufCjRqtXuupJTdgxt0Fzd5UMoly9AZzmOBbrwILPM"
    },
    "template": {
...
const schema9 = {
  "nullableRef": "io.k8s.api.apps.v1beta1.RollbackConfig#"
};
const schema10 = {};
import { validate as validate30 } from "./IoK8sApiAppsV1beta1RollbackConfig";
...
const schema12 = {};
import { validate as validate34 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1LabelSelector";
...
const schema13 = {
  "nullableRef": "io.k8s.api.apps.v1beta1.DeploymentStrategy#"
};
const schema14 = {};
import { validate as validate38 } from "./IoK8sApiAppsV1beta1DeploymentStrategy";
...
const schema16 = {};
import { validate as validate42 } from "./IoK8sApiCoreV1PodTemplateSpec";
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.rollbackTo !== undefined) {
      if (!validate29(data.rollbackTo, {
        instancePath: instancePath + "/rollbackTo",
        parentData: data,
        parentDataProperty: "rollbackTo",
        rootData
      })) {
