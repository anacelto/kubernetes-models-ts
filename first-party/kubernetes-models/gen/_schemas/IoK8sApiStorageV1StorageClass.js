...
const schema7 = {
  "properties": {
    ...
    "volumeBindingMode": {
      "$ref": "PQ2gT52l31hzuwJWHTOzEPeBbkN6AhoAT9cB3WhgnZY"
    }
  },
...
const schema11 = {};
import { validate as validate27 } from "./IoK8sApiCoreV1TopologySelectorTerm";
...
function validate48(data, {
  ...
  if (!(data === "Immediate" || data === "WaitForFirstConsumer")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowVolumeExpansion !== undefined) {
      if (!validate23(data.allowVolumeExpansion, {
    ...
    if (data.allowedTopologies !== undefined) {
      if (!validate25(data.allowedTopologies, {
    ...
    if (data.mountOptions !== undefined) {
      if (!validate39(data.mountOptions, {
    ...
    if (data.reclaimPolicy !== undefined) {
      if (!validate46(data.reclaimPolicy, {
    ...
    if (data.volumeBindingMode !== undefined) {
      if (!validate48(data.volumeBindingMode, {
