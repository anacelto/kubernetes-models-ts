...
function validate24(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clusterScope !== undefined) {
      if (!validate26(data.clusterScope, {
        instancePath: instancePath + "/clusterScope",
        parentData: data,
        parentDataProperty: "clusterScope",
        rootData
      })) {
    ...
    if (data.verbs !== undefined) {
      if (!validate22(data.verbs, {
        instancePath: instancePath + "/verbs",
        parentData: data,
        parentDataProperty: "verbs",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
