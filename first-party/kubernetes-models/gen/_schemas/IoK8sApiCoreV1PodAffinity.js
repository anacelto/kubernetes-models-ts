...
const schema6 = {
  "properties": {
    "preferredDuringSchedulingIgnoredDuringExecution": {
      "$ref": "QLWYr4cWa8E73WQph4gQvuQAhV0lvdjFHABiC5dWso"
    },
    "requiredDuringSchedulingIgnoredDuringExecution": {
      "$ref": "GSJSQGfd21r5ivvID2XgP7EizdFWGkBqhMhLyKQs"
    }
  },
  "type": "object",
...
const schema7 = {
  "items": {
    "$ref": "9md3BcG0JvrbbOb4wkk6HRQ5htaEmfYdJ3GyVJZAePo"
  },
  "type": "array",
  "nullable": true
};
...
const schema9 = {};
import { validate as validate24 } from "./IoK8sApiCoreV1WeightedPodAffinityTerm";
...
const schema10 = {
  "items": {
    "$ref": "mTlbwAZrhIKDBLpa3OZFZdguJ42LCgbXuQdvYVGIvs"
  },
  "type": "array",
  "nullable": true
};
...
const schema12 = {};
import { validate as validate30 } from "./IoK8sApiCoreV1PodAffinityTerm";
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate22(data.preferredDuringSchedulingIgnoredDuringExecution, {
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate28(data.requiredDuringSchedulingIgnoredDuringExecution, {
