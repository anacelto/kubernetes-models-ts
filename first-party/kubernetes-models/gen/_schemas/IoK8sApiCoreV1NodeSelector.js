...
const schema6 = {
  "properties": {
    "nodeSelectorTerms": {
      "$ref": "VO64qSDYYQUvo9HMXjABQ5UlmskeTkAxml4Mvv3o"
    }
  },
...
const schema7 = {
  "items": {
    "$ref": "C6oPudYHNtYr6bPutKUwJW6qyQhoKLDXC2E3AuVYRw"
  },
  "type": "array"
};
const schema8 = {
...
const schema9 = {};
import { validate as validate24 } from "./IoK8sApiCoreV1NodeSelectorTerm";
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelectorTerms !== undefined) {
      if (!validate22(data.nodeSelectorTerms, {
