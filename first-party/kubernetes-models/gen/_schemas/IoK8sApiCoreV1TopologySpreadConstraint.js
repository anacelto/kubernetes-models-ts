...
const schema8 = {
  "properties": {
    ...
    "nodeAffinityPolicy": {
      "$ref": "n9OgPpO9sw6puImoCrDloNL1ej4Jp6xfqkJRh6oz6o"
    },
    "nodeTaintsPolicy": {
      "$ref": "n9OgPpO9sw6puImoCrDloNL1ej4Jp6xfqkJRh6oz6o"
    },
    ...
    "whenUnsatisfiable": {
      "$ref": "OtHAe45QRCmkfs69BL7aU65JOC4LwhHw9KnxWoOTug"
    }
  },
...
function validate38(data, {
  ...
  if (!(data === "DoNotSchedule" || data === "ScheduleAnyway")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.whenUnsatisfiable !== undefined) {
      if (!validate38(data.whenUnsatisfiable, {
