...
const schema8 = {
  ...
  "type": "object",
  "$id": "io.k8s.api.core.v1.ConfigMapNodeConfigSource"
};
const schema6 = {
  "type": "string"
};
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.kubeletConfigKey === undefined) {
      const err2 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "kubeletConfigKey"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.kubeletConfigKey !== undefined) {
      if (!validate21(data.kubeletConfigKey, {
        instancePath: instancePath + "/kubeletConfigKey",
        parentData: data,
        parentDataProperty: "kubeletConfigKey",
        rootData
      })) {
