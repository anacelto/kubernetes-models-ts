...
const schema12 = {
  "properties": {
    ...
    "env": {
      "$ref": "yIbAZvedlIbeo9RoaqqtkbKzECcog3YxTbn7B2WIY"
    },
    "envFrom": {
      "$ref": "N34Yp0dqqBJlqAv7PUQrKkCq0PLVsXd2dHD8rccA0I"
    },
    "image": {
    ...
    "lifecycle": {
      "$ref": "QtkeGo2m0ryWgS8eMchb21waeNtVUBkj0EXk2yjRdA"
    },
    "livenessProbe": {
      "$ref": "AQKEOtvOc0TPXBLKISVwXIy83OCdeweH0cH6Ao4HQY"
    },
    "name": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    "ports": {
      "$ref": "AW9yZGjvQr9fqlDdAHJyX0qcpR8746IMijkjbhGL5I"
    },
    "readinessProbe": {
      "$ref": "AQKEOtvOc0TPXBLKISVwXIy83OCdeweH0cH6Ao4HQY"
    },
    "resizePolicy": {
      "$ref": "nuZfZD4mwt4GuRrCdWlF7eWEfXDjlXBE69cLsY1HWE"
    },
    "resources": {
      "$ref": "LCuqVEex7TOBimxIHLrrAeQUO1WNTqnFUIgG6xGw"
    },
    "securityContext": {
      "$ref": "AGuiYL9oZCOxfVZh7nG7lRojrRfNsof4mUi4QOOk"
    },
    "startupProbe": {
      "$ref": "AQKEOtvOc0TPXBLKISVwXIy83OCdeweH0cH6Ao4HQY"
    },
    ...
    "terminationMessagePolicy": {
      "$ref": "fwChSsVIAfLRsQOLzNlzzC8TLIJNycRWgBUZvmo4"
    },
    "tty": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
    "volumeDevices": {
      "$ref": "tyX8RgQaIHVCy4bVrf1Wud0XBRQG2wsN69ADUPDg"
    },
    "volumeMounts": {
      "$ref": "7nQdH308tsC2Pc8JoqUaRWdnJqZA543wVKdBCDrbyEk"
    },
    "workingDir": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema13 = {
  "items": {
    "$ref": "kJAidYQJzZfN9ldjuqGkgQ0MQSHC2VHvGdzWeJWJE"
  },
  "type": "array",
  "nullable": true
};
...
const schema15 = {};
import { validate as validate34 } from "./IoK8sApiCoreV1EnvVar";
...
const schema16 = {
  "items": {
    "$ref": "8pRbCJiYFKJFuSoM7tt3OrWLXODJTK4jCi0HkihZDU"
  },
  "type": "array",
  "nullable": true
};
...
const schema18 = {};
import { validate as validate40 } from "./IoK8sApiCoreV1EnvFromSource";
...
const schema20 = {
  "nullableRef": "io.k8s.api.core.v1.Lifecycle#"
};
const schema21 = {};
import { validate as validate48 } from "./IoK8sApiCoreV1Lifecycle";
...
const schema8 = {
  "nullableRef": "io.k8s.api.core.v1.Probe#"
};
const schema9 = {};
import { validate as validate25 } from "./IoK8sApiCoreV1Probe";
...
const schema22 = {
  "items": {
    "$ref": "kdQRsRrFe3OVcLxlKRCG6FH0cvqaO0l3NNRGI6JNncE"
  },
  "type": "array",
  "nullable": true
};
...
const schema24 = {};
import { validate as validate55 } from "./IoK8sApiCoreV1ContainerPort";
...
const schema25 = {
  "items": {
    "$ref": "xJUAliulLqwE6mSBni9D8CbNwwkyHx3q6PNQQ0jgU"
  },
  "type": "array",
  "nullable": true
};
const schema26 = {
  "$ref": "io.k8s.api.core.v1.ContainerResizePolicy#"
};
const schema27 = {};
import { validate as validate62 } from "./IoK8sApiCoreV1ContainerResizePolicy";
...
const schema29 = {};
import { validate as validate67 } from "./IoK8sApiCoreV1ResourceRequirements";
...
const schema30 = {
  "nullableRef": "io.k8s.api.core.v1.SecurityContext#"
};
const schema31 = {};
import { validate as validate71 } from "./IoK8sApiCoreV1SecurityContext";
...
function validate79(data, {
  ...
  if (!(data === "FallbackToLogsOnError" || data === "File")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema33 = {
  "items": {
    "$ref": "aLOO0yo6oEC1g7azkru94yr3jmkrTrZTa4bdEBdX0A"
  },
  "type": "array",
  "nullable": true
};
...
const schema35 = {};
import { validate as validate84 } from "./IoK8sApiCoreV1VolumeDevice";
...
const schema36 = {
  "items": {
    "$ref": "VzmkUwIeSN0TPga6HZafvurYxwH4hVilO8DaTnF5XCI"
  },
  "type": "array",
  "nullable": true
};
...
const schema38 = {};
import { validate as validate90 } from "./IoK8sApiCoreV1VolumeMount";
...
function validate29(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imagePullPolicy !== undefined) {
      if (!validate45(data.imagePullPolicy, {
    ...
    if (data.livenessProbe !== undefined) {
      if (!validate24(data.livenessProbe, {
    ...
    if (data.readinessProbe !== undefined) {
      if (!validate24(data.readinessProbe, {
    ...
    if (data.resizePolicy !== undefined) {
      if (!validate60(data.resizePolicy, {
    ...
    if (data.securityContext !== undefined) {
      if (!validate70(data.securityContext, {
    ...
    if (data.startupProbe !== undefined) {
      if (!validate24(data.startupProbe, {
    ...
    if (data.targetContainerName !== undefined) {
      if (!validate28(data.targetContainerName, {
    ...
    if (data.terminationMessagePath !== undefined) {
      if (!validate28(data.terminationMessagePath, {
    ...
    if (data.terminationMessagePolicy !== undefined) {
      if (!validate79(data.terminationMessagePolicy, {
    ...
    if (data.volumeDevices !== undefined) {
      if (!validate82(data.volumeDevices, {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate88(data.volumeMounts, {
