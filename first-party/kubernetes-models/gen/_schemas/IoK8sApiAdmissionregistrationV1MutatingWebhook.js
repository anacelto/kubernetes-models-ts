...
const schema9 = {
  "properties": {
    ...
    "clientConfig": {
      "$ref": "qZcW8tHC0xTf8OVrKOGenaM2XVUJdLcy5dnunr5mc3I"
    },
    "failurePolicy": {
      "$ref": "AKFW9qjCGE1e7UguywpbqSBWhiH6KXdIyXjsEeD9UMk"
    },
    "matchConditions": {
      "$ref": "Yxim6IAUVsRL3iE4IxbpLxcuO2DLuvZ3Z5Yk3EJuxw"
    },
    "matchPolicy": {
      "$ref": "zPoxdsvSiSdJfezB5jFeBbKRNfCSGSdoUz8A7sLTM8"
    },
    "name": {
    ...
    "reinvocationPolicy": {
      "$ref": "gumAnL0MZo2C9qEQwXlB1bcYvAJ2JoklYO4HixgQ"
    },
    "rules": {
      "$ref": "Pk7hrX90IfsaSYiIoVAljHC8cpO4WYAERTs9yrH1uw"
    },
    "sideEffects": {
      "$ref": "gUB2cv0f2DuUJ5zQeZESM4ubPoHfN8JiHzkkRr8JFqA"
    },
    "timeoutSeconds": {
...
const schema12 = {};
import { validate as validate30 } from "./IoK8sApiAdmissionregistrationV1WebhookClientConfig";
...
const schema14 = {
  "items": {
    "$ref": "nDjydP68VtsVPW36B6bBhVwa2tWv24HdBrNPmOrmjY"
  },
  "type": "array",
  "nullable": true
};
const schema15 = {
  "$ref": "io.k8s.api.admissionregistration.v1.MatchCondition#"
};
const schema16 = {};
import { validate as validate37 } from "./IoK8sApiAdmissionregistrationV1MatchCondition";
...
const schema8 = {};
import { validate as validate23 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1LabelSelector";
...
const schema19 = {
  "items": {
    "$ref": "QtUevZNTDniveY2IuJodqwuJuGq6cGAY5VrpGNDUg"
  },
  "type": "array",
  "nullable": true
};
...
const schema21 = {};
import { validate as validate50 } from "./IoK8sApiAdmissionregistrationV1RuleWithOperations";
...
function validate54(data, {
  ...
  if (!(data === "None" || data === "NoneOnDryRun" || data === "Some" || data === "Unknown")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.admissionReviewVersions === undefined) {
      const err3 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "admissionReviewVersions"
        }
      };
      if (vErrors === null) {
        vErrors = [err3];
    ...
    if (data.admissionReviewVersions !== undefined) {
      if (!validate26(data.admissionReviewVersions, {
        instancePath: instancePath + "/admissionReviewVersions",
        parentData: data,
        parentDataProperty: "admissionReviewVersions",
        rootData
      })) {
    ...
    if (data.clientConfig !== undefined) {
      if (!validate29(data.clientConfig, {
        instancePath: instancePath + "/clientConfig",
        parentData: data,
        parentDataProperty: "clientConfig",
        rootData
      })) {
    ...
    if (data.failurePolicy !== undefined) {
      if (!validate33(data.failurePolicy, {
    ...
    if (data.matchConditions !== undefined) {
      if (!validate35(data.matchConditions, {
    ...
    if (data.matchPolicy !== undefined) {
      if (!validate41(data.matchPolicy, {
    ...
    if (data.objectSelector !== undefined) {
      if (!validate22(data.objectSelector, {
    ...
    if (data.reinvocationPolicy !== undefined) {
      if (!validate46(data.reinvocationPolicy, {
        instancePath: instancePath + "/reinvocationPolicy",
        parentData: data,
        parentDataProperty: "reinvocationPolicy",
        rootData
      })) {
    ...
    if (data.sideEffects !== undefined) {
      if (!validate54(data.sideEffects, {
        instancePath: instancePath + "/sideEffects",
        parentData: data,
        parentDataProperty: "sideEffects",
        rootData
      })) {
    ...
    if (data.timeoutSeconds !== undefined) {
      if (!validate56(data.timeoutSeconds, {
