...
const schema6 = {
  "properties": {
    "addressType": {
      "$ref": "pcKIgXbm4CIOPb81n4EexeRLxNbm5h38bq8IlsCBY"
    },
    "apiVersion": {
      "$ref": "DflgglkMglHc62LG79TivmdHD6U2k3PtAex5W1645I"
    },
    "endpoints": {
      "$ref": "lpseVxMscLtNWgKjOGKS1gbapRsp3iN0JNEtQlwT18"
    },
    "kind": {
      "$ref": "vBguzplKkifVZTzhAqR5IGGUhiWZFCDCfxbGSZRU0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "ports": {
      "$ref": "sJReokQCRnJzPVsr5AnbG7L9avMpWHUXxcaTOsr6s"
    }
  },
  "required": ["addressType", "endpoints", "apiVersion", "kind"],
  "type": "object",
...
const schema9 = {
  "items": {
    "$ref": "S26SP4rwHJPh10D28CA6CdLpYxl3S7PUiuEPoc0N3no"
  },
  "type": "array"
};
const schema10 = {
...
const schema11 = {};
import { validate as validate28 } from "./IoK8sApiDiscoveryV1Endpoint";
...
const schema15 = {
  "items": {
    "$ref": "u22JGwALsXLPZdUDXceOUnTP4JwvyqSJTFV2qNNQE50"
  },
  "type": "array",
  "nullable": true
};
...
const schema17 = {};
import { validate as validate40 } from "./IoK8sApiDiscoveryV1EndpointPort";
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.addressType !== undefined) {
      if (!validate22(data.addressType, {
        instancePath: instancePath + "/addressType",
        parentData: data,
        parentDataProperty: "addressType",
        rootData
      })) {
