...
const schema9 = {
  "properties": {
    "matchExpressions": {
      "$ref": "luMq2C799JNOGdi8fJLPkkT63YAM86xUGaHqn8JYwec"
    },
    "matchFields": {
      "$ref": "luMq2C799JNOGdi8fJLPkkT63YAM86xUGaHqn8JYwec"
    }
...
const schema6 = {
  "items": {
    "$ref": "hyAr0zzfycnexD4pfYBF6GTeDnEwhtNT7hDn2Nh4c"
  },
  "type": "array",
  "nullable": true
};
...
const schema8 = {};
import { validate as validate23 } from "./IoK8sApiCoreV1NodeSelectorRequirement";
...
function validate26(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate21(data.matchExpressions, {
    ...
    if (data.matchFields !== undefined) {
      if (!validate21(data.matchFields, {
