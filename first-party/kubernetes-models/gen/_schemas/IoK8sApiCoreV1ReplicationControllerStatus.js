...
const schema7 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "cqBBkrSNzJfg0GFxk4Cac3xjTsTFEdc56ZFeyD45o7s"
    },
  ...
  "required": ["replicas"],
  "type": "object",
  "$id": "io.k8s.api.core.v1.ReplicationControllerStatus"
};
const schema6 = {
  "format": "int32",
  "type": "integer",
...
const schema8 = {
  "items": {
    "$ref": "8vFZ57dsHgFO0fQuRq9hsLyo9UloC8XtY9vlK50Uc0"
  },
  "type": "array",
  "nullable": true
};
...
const schema10 = {};
import { validate as validate26 } from "./IoK8sApiCoreV1ReplicationControllerCondition";
