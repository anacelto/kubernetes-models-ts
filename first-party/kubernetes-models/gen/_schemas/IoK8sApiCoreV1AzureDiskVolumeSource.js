...
const schema7 = {
  "properties": {
    "cachingMode": {
      "$ref": "MHZmv4WXZa3u2HQpagTBL6ppP6rKEmw0cZUBlgLj1c"
    },
    "diskName": {
    ...
    "kind": {
      "$ref": "wFfXAWnG7dItURDWSYOuvLcXB7Z0iJsKaBeghF8zlbU"
    },
    "readOnly": {
...
function validate23(data, {
  ...
  if (!(data === "None" || data === "ReadOnly" || data === "ReadWrite")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate29(data, {
  ...
  if (!(data === "Dedicated" || data === "Managed" || data === "Shared")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
