...
function validate26(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultRequest !== undefined) {
      if (!validate21(data.defaultRequest, {
        instancePath: instancePath + "/defaultRequest",
        parentData: data,
        parentDataProperty: "defaultRequest",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.maxLimitRequestRatio !== undefined) {
      if (!validate21(data.maxLimitRequestRatio, {
        instancePath: instancePath + "/maxLimitRequestRatio",
        parentData: data,
        parentDataProperty: "maxLimitRequestRatio",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
