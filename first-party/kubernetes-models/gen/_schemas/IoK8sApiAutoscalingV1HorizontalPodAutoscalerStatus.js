...
const schema7 = {
  ...
  "type": "object",
  "$id": "io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerStatus"
};
const schema8 = {
  "format": "int32",
  "type": "integer",
...
const schema10 = {};
import { validate as validate28 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1Time";
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.currentCPUUtilizationPercentage !== undefined) {
      if (!validate23(data.currentCPUUtilizationPercentage, {
        instancePath: instancePath + "/currentCPUUtilizationPercentage",
        parentData: data,
        parentDataProperty: "currentCPUUtilizationPercentage",
        rootData
      })) {
    ...
    if (data.lastScaleTime !== undefined) {
      if (!validate27(data.lastScaleTime, {
