...
const schema7 = {
  "properties": {
    "allocatable": {
      "$ref": "X8c0QOhUXbYXoLSiCcBP36CAcbciPQ6mvy9DeuJmBQY"
    },
    "name": {
...
const schema8 = {
  "nullableRef": "io.k8s.api.storage.v1beta1.VolumeNodeResources#"
};
const schema9 = {};
import { validate as validate24 } from "./IoK8sApiStorageV1beta1VolumeNodeResources";
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allocatable !== undefined) {
      if (!validate23(data.allocatable, {
    ...
    if (data.topologyKeys !== undefined) {
      if (!validate29(data.topologyKeys, {
        instancePath: instancePath + "/topologyKeys",
        parentData: data,
        parentDataProperty: "topologyKeys",
        rootData
      })) {
