...
const schema35 = {};
import { validate as validate83 } from "./IoK8sApiCoreV1VolumeDevice";
...
const schema38 = {};
import { validate as validate89 } from "./IoK8sApiCoreV1VolumeMount";
...
function validate29(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.terminationMessagePolicy !== undefined) {
      if (!validate78(data.terminationMessagePolicy, {
    ...
    if (data.volumeDevices !== undefined) {
      if (!validate81(data.volumeDevices, {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate87(data.volumeMounts, {
