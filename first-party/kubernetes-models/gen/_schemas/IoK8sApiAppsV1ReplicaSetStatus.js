...
const schema7 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "E0bqJPxWE54Cih3J4bpMSqeQ8Ia9AScGA40OH8flU"
    },
  ...
  "required": ["replicas"],
  "type": "object",
  "$id": "io.k8s.api.apps.v1.ReplicaSetStatus"
};
const schema6 = {
  "format": "int32",
  "type": "integer",
...
const schema8 = {
  "items": {
    "$ref": "6JIY2HpwiCCf7TuoMJ1MnpcGiGnFtAszNG8EOMUtvw"
  },
  "type": "array",
  "nullable": true
};
...
const schema10 = {};
import { validate as validate26 } from "./IoK8sApiAppsV1ReplicaSetCondition";
