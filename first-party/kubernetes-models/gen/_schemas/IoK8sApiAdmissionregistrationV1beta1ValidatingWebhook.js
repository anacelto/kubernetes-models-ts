...
const schema10 = {
  "properties": {
    ...
    "clientConfig": {
      "$ref": "UL1MXPaiwRFoc1kNWxyyESMGWrOg1Z3CdwkH4Or0Um8"
    },
    "failurePolicy": {
    ...
    "rules": {
      "$ref": "hAI3UEp8MeEg9UyozBTT9ePTMBYDYPsSUv1KCe9DrQ"
    },
    "sideEffects": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema13 = {};
import { validate as validate31 } from "./IoK8sApiAdmissionregistrationV1beta1WebhookClientConfig";
...
const schema14 = {
  "items": {
    "$ref": "xpWalsFPkUW0dmvVIettO1kwL2ge56aM7FllyHgZRvg"
  },
  "type": "array",
  "nullable": true
};
...
const schema16 = {};
import { validate as validate41 } from "./IoK8sApiAdmissionregistrationV1beta1RuleWithOperations";
...
function validate26(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.admissionReviewVersions !== undefined) {
      if (!validate27(data.admissionReviewVersions, {
    ...
    if (data.clientConfig !== undefined) {
      if (!validate30(data.clientConfig, {
    ...
    if (data.failurePolicy !== undefined) {
      if (!validate21(data.failurePolicy, {
    ...
    if (data.matchPolicy !== undefined) {
      if (!validate21(data.matchPolicy, {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate23(data.namespaceSelector, {
    ...
    if (data.objectSelector !== undefined) {
      if (!validate23(data.objectSelector, {
    ...
    if (data.sideEffects !== undefined) {
      if (!validate21(data.sideEffects, {
    ...
    if (data.timeoutSeconds !== undefined) {
      if (!validate46(data.timeoutSeconds, {
