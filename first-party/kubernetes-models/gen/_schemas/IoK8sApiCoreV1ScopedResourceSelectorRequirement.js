...
const schema6 = {
  "properties": {
    ...
    "scopeName": {
      "$ref": "CvTK8XmxAhQuv7JuPnhfGd75Y834gSYTxey80QPSNjk"
    },
    "values": {
...
function validate24(data, {
  ...
  if (!(data === "BestEffort" || data === "CrossNamespacePodAffinity" || data === "NotBestEffort" || data === "NotTerminating" || data === "PriorityClass" || data === "Terminating")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.scopeName !== undefined) {
      if (!validate24(data.scopeName, {
        instancePath: instancePath + "/scopeName",
        parentData: data,
        parentDataProperty: "scopeName",
        rootData
      })) {
