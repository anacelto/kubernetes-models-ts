...
const schema8 = {
  "properties": {
    ...
    "jobTemplate": {
      "$ref": "epkWEocf530Fdji6E3KiT3yRQzmp5lA1DuG2csVCY"
    },
    "schedule": {
...
const schema10 = {};
import { validate as validate27 } from "./IoK8sApiBatchV1beta1JobTemplateSpec";
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.concurrencyPolicy !== undefined) {
      if (!validate22(data.concurrencyPolicy, {
