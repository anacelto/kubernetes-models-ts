...
const schema7 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "m35BC4ZbrNH1IZkyO7SibowIc3sGNAAq3ohTJMu2w0"
    },
    "observedGeneration": {
  ...
  "type": "object",
  "$id": "io.k8s.api.apps.v1beta1.DeploymentStatus"
};
const schema6 = {
  "format": "int32",
  "type": "integer",
...
const schema8 = {
  "items": {
    "$ref": "hjqNM9zCDsFSCZjRGY7UQDsA4PXMFm11MprQJc5kqBw"
  },
  "type": "array",
  "nullable": true
};
const schema9 = {
  "$ref": "io.k8s.api.apps.v1beta1.DeploymentCondition#"
};
const schema10 = {};
import { validate as validate27 } from "./IoK8sApiAppsV1beta1DeploymentCondition";
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.unavailableReplicas !== undefined) {
      if (!validate21(data.unavailableReplicas, {
