...
const schema8 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "wao70EzAUbQVNpXU0SSY16740IF622ZvlCZqvU0"
    },
    "currentReplicas": {
      "$ref": "Ccz0XZyNWiwVpe2nvsmnlMV1SnfQGMXuejl0yByE"
    },
  ...
  "required": ["replicas"],
  "type": "object",
  "$id": "io.k8s.api.apps.v1.StatefulSetStatus"
};
const schema6 = {
  "format": "int32",
  "type": "integer",
...
const schema9 = {
  "items": {
    "$ref": "zLdK1sYtD9243QcNTRywrxAcoCKmL52mZotnKQUVmc"
  },
  "type": "array",
  "nullable": true
};
...
const schema11 = {};
import { validate as validate28 } from "./IoK8sApiAppsV1StatefulSetCondition";
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.collisionCount !== undefined) {
      if (!validate21(data.collisionCount, {
    ...
    if (data.currentRevision !== undefined) {
      if (!validate22(data.currentRevision, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate34(data.observedGeneration, {
    ...
    if (data.updateRevision !== undefined) {
      if (!validate22(data.updateRevision, {
    ...
    if (data.updatedReplicas !== undefined) {
      if (!validate21(data.updatedReplicas, {
