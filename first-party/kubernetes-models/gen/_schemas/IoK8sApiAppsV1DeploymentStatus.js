...
const schema7 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "ogvpbsgNnGYAfqb0EMuEHWvhg2hN5cIC30OKjOVpGs"
    },
    "observedGeneration": {
  ...
  "type": "object",
  "$id": "io.k8s.api.apps.v1.DeploymentStatus"
};
const schema6 = {
  "format": "int32",
  "type": "integer",
...
const schema8 = {
  "items": {
    "$ref": "HoTzvlH2UIeQN0mnc5dEvuamQvFm8uFPRgi7pYzBHo0"
  },
  "type": "array",
  "nullable": true
};
...
const schema10 = {};
import { validate as validate27 } from "./IoK8sApiAppsV1DeploymentCondition";
