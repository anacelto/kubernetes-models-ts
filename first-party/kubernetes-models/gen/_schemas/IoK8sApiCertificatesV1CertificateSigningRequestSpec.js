...
const schema9 = {
  ...
  "type": "object",
  "$id": "io.k8s.api.certificates.v1.CertificateSigningRequestSpec"
};
const schema10 = {
  "format": "int32",
  "type": "integer",
...
function validate25(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.expirationSeconds !== undefined) {
      if (!validate26(data.expirationSeconds, {
