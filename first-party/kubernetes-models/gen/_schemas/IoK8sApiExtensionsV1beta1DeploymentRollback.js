...
const schema7 = {
  "properties": {
    ...
    "kind": {
      "$ref": "iwxLh2CLzuLd84gUbsTwbAOiOTRhlH91iTecgLPg3A"
    },
    "name": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    "rollbackTo": {
      "$ref": "9KWNkdam8FhksllYEU9c05soqiuNHLksmOAUpTngRqA"
    },
    "updatedAnnotations": {
      "$ref": "PjfGsuuTJKGenMIMVIBhy6BRB0YdhUzGFe2gewFJPT8"
    }
  },
  "required": ["name", "rollbackTo", "apiVersion", "kind"],
  "type": "object",
...
const schema10 = {
  "$ref": "io.k8s.api.extensions.v1beta1.RollbackConfig#"
};
const schema11 = {};
import { validate as validate29 } from "./IoK8sApiExtensionsV1beta1RollbackConfig";
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.updatedAnnotations !== undefined) {
      if (!validate32(data.updatedAnnotations, {
        instancePath: instancePath + "/updatedAnnotations",
        parentData: data,
        parentDataProperty: "updatedAnnotations",
        rootData
      })) {
