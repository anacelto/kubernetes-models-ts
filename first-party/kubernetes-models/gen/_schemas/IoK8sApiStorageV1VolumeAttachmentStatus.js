...
const schema8 = {
  "properties": {
    "attachError": {
      "$ref": "nRGmqgbVJHGcpjub7dKb8oeasPb5ZmzzDV1PENCXOk"
    },
    "attached": {
  ...
  "required": ["attached"],
  "type": "object",
  "$id": "io.k8s.api.storage.v1.VolumeAttachmentStatus"
};
const schema6 = {
  "nullableRef": "io.k8s.api.storage.v1.VolumeError#"
};
const schema7 = {};
import { validate as validate22 } from "./IoK8sApiStorageV1VolumeError";
