...
const schema6 = {
  "properties": {
    ...
    "scopeSelector": {
      "$ref": "DHD6ySgzvOoGwMqbxShQav6S9S21tmNZRiVam0OMdg"
    },
    "scopes": {
...
const schema10 = {
  "nullableRef": "io.k8s.api.core.v1.ScopeSelector#"
};
const schema11 = {};
import { validate as validate29 } from "./IoK8sApiCoreV1ScopeSelector";
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.scopeSelector !== undefined) {
      if (!validate28(data.scopeSelector, {
