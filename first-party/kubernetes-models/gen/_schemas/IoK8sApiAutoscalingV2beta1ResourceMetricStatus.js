...
const schema6 = {
  ...
  "type": "object",
  "$id": "io.k8s.api.autoscaling.v2beta1.ResourceMetricStatus"
};
const schema7 = {
  "format": "int32",
  "type": "integer",
...
const schema9 = {};
import { validate as validate25 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApiResourceQuantity";
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.currentAverageUtilization !== undefined) {
      if (!validate22(data.currentAverageUtilization, {
    ...
    if (data.currentAverageValue !== undefined) {
      if (!validate24(data.currentAverageValue, {
