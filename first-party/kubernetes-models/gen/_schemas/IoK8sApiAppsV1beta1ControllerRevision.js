...
const schema6 = {
  "properties": {
    ...
    "data": {
      "$ref": "rcK9iNic5wGDQJgXCEM6zSZqWSqZ9gNchRsbaNCSo7o"
    },
    "kind": {
      "$ref": "M0ddEoMvix8gzYQqOUT4yjIMOHdBBbiloalZ3VzLnU"
    },
    "metadata": {
  ...
  "required": ["revision", "apiVersion", "kind"],
  "type": "object",
...
const schema8 = {
  "nullableRef": "io.k8s.apimachinery.pkg.runtime.RawExtension#"
};
const schema9 = {};
import { validate as validate25 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgRuntimeRawExtension";
