...
const schema9 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "x1aahrGYiCHoH7qwjxSvkNgxD581R6ysgzpfce1UeQ"
    },
    "phase": {
      "$ref": "hnaTKZ5mpA86JDOJoSKdmY9KiwIkCzI8zi3bklwkXqY"
    },
    "resizeStatus": {
      "$ref": "qhjeQLmloQhaKqstGYoUkw4SBwVtXgEUn8YWUCJC6Q"
    }
  },
  "type": "object",
  "$id": "io.k8s.api.core.v1.PersistentVolumeClaimStatus"
};
const schema10 = {
  "items": {
...
const schema12 = {
  "items": {
    "$ref": "9vdwIq02CWDVKayjO7Bf5h4iZbVcdjGEatGZsSa6o"
  },
  "type": "array",
  "nullable": true
};
...
const schema14 = {};
import { validate as validate35 } from "./IoK8sApiCoreV1PersistentVolumeClaimCondition";
...
function validate39(data, {
  ...
  if (!(data === "Bound" || data === "Lost" || data === "Pending")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema16 = {
  "enum": ["", "ControllerExpansionFailed", "ControllerExpansionInProgress", "NodeExpansionFailed", "NodeExpansionInProgress", "NodeExpansionPending"],
  "type": "string",
  "nullable": true
};
function validate41(data, {
  ...
  if (!(data === "" || data === "ControllerExpansionFailed" || data === "ControllerExpansionInProgress" || data === "NodeExpansionFailed" || data === "NodeExpansionInProgress" || data === "NodeExpansionPending")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate26(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allocatedResources !== undefined) {
      if (!validate21(data.allocatedResources, {
    ...
    if (data.resizeStatus !== undefined) {
      if (!validate41(data.resizeStatus, {
