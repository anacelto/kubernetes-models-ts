...
const schema7 = {
  ...
  "type": "object",
  "$id": "io.k8s.api.discovery.v1.EndpointConditions"
};
const schema6 = {
  "type": "boolean",
  "nullable": true
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.serving !== undefined) {
      if (!validate21(data.serving, {
        instancePath: instancePath + "/serving",
        parentData: data,
        parentDataProperty: "serving",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.terminating !== undefined) {
      if (!validate21(data.terminating, {
