...
const schema6 = {
  ...
  "type": "object",
  "$id": "io.k8s.api.core.v1.ServiceStatus"
};
const schema7 = {
  "items": {
...
const schema9 = {};
import { validate as validate24 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1Condition";
...
const schema11 = {};
import { validate as validate29 } from "./IoK8sApiCoreV1LoadBalancerStatus";
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.loadBalancer !== undefined) {
      if (!validate28(data.loadBalancer, {
