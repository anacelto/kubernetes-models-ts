...
const schema6 = {
  "properties": {
    ...
    "kind": {
      "$ref": "IhbdLM1SZXUvMUYKeW5S7oveWWFrxqlmkbHJV5TIM"
    },
    "metadata": {
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.globalDefault !== undefined) {
      if (!validate24(data.globalDefault, {
        instancePath: instancePath + "/globalDefault",
        parentData: data,
        parentDataProperty: "globalDefault",
        rootData
      })) {
    ...
    if (data.preemptionPolicy !== undefined) {
      if (!validate32(data.preemptionPolicy, {
