...
const schema8 = {
  "properties": {
    ...
    "capabilities": {
      "$ref": "i927g5EQB1z0eyYazXzK4meH1BIGI35yA1EIpzeeto"
    },
    "privileged": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
    "procMount": {
      "$ref": "K0e4g417rsT1Q0hwvkaJP1vtTx6DSO4NuHjJOzFxQQ"
    },
...
const schema9 = {
  "nullableRef": "io.k8s.api.core.v1.Capabilities#"
};
const schema10 = {};
import { validate as validate26 } from "./IoK8sApiCoreV1Capabilities";
...
const schema13 = {};
import { validate as validate37 } from "./IoK8sApiCoreV1SELinuxOptions";
...
const schema15 = {};
import { validate as validate41 } from "./IoK8sApiCoreV1SeccompProfile";
...
const schema17 = {};
import { validate as validate45 } from "./IoK8sApiCoreV1WindowsSecurityContextOptions";
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.capabilities !== undefined) {
      if (!validate25(data.capabilities, {
    ...
    if (data.seLinuxOptions !== undefined) {
      if (!validate36(data.seLinuxOptions, {
    ...
    if (data.seccompProfile !== undefined) {
      if (!validate40(data.seccompProfile, {
    ...
    if (data.windowsOptions !== undefined) {
      if (!validate44(data.windowsOptions, {
