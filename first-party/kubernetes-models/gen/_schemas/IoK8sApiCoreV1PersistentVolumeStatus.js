...
const schema7 = {
  "properties": {
    ...
    "phase": {
      "$ref": "eQH0mFlgCDAKGHXtmINBlRNTqA2JCT2gCgbh6RY6qIo"
    },
    "reason": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
  ...
  "type": "object",
  "$id": "io.k8s.api.core.v1.PersistentVolumeStatus"
};
const schema6 = {
  "type": "string",
  "nullable": true
...
function validate24(data, {
  ...
  if (!(data === "Available" || data === "Bound" || data === "Failed" || data === "Pending" || data === "Released")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
