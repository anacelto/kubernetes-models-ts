...
const schema6 = {
  "properties": {
    ...
    "kind": {
      "$ref": "nSCEGGTvtui84tjPkzr1ZJyt4QIjdnGTsvPHQrYY"
    },
    "metadata": {
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.stringData !== undefined) {
      if (!validate36(data.stringData, {
        instancePath: instancePath + "/stringData",
        parentData: data,
        parentDataProperty: "stringData",
        rootData
      })) {
