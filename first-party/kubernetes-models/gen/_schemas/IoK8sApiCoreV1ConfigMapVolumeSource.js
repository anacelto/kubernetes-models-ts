...
const schema6 = {
  "properties": {
    ...
    "items": {
      "$ref": "J3Unr76S6r4H3Fp4gCAIFUiM4rBoHU9P7pRMoNh1c"
    },
    "name": {
...
const schema8 = {
  "items": {
    "$ref": "1rOcidHY2Pf0Cq356sdorz0gAly41Kxk5QuO4QEY"
  },
  "type": "array",
  "nullable": true
};
...
const schema10 = {};
import { validate as validate26 } from "./IoK8sApiCoreV1KeyToPath";
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.defaultMode !== undefined) {
      if (!validate22(data.defaultMode, {
