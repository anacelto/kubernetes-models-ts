...
const schema6 = {
  "properties": {
    ...
    "kind": {
      "$ref": "ngSGSFNzmYtJ4L6G0Vr5UGBAc2grcae1ASRVz6QXe1k"
    },
    "metadata": {
...
const schema11 = {};
import { validate as validate28 } from "./IoK8sApiCoreV1LocalObjectReference";
...
const schema17 = {};
import { validate as validate40 } from "./IoK8sApiCoreV1ObjectReference";
...
function validate21(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate26(data.imagePullSecrets, {
