...
const schema7 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "z2pDCQeYPJYSPjJIhQYlC0PzNpcONbHnhKPQIBrc"
    },
    "observedGeneration": {
  ...
  "type": "object",
  "$id": "io.k8s.api.apps.v1beta2.DeploymentStatus"
};
const schema6 = {
  "format": "int32",
  "type": "integer",
...
const schema8 = {
  "items": {
    "$ref": "nHojUiDGGecjwweMgwhKxMhvbiKynSchuSlO1gl40KI"
  },
  "type": "array",
  "nullable": true
};
const schema9 = {
  "$ref": "io.k8s.api.apps.v1beta2.DeploymentCondition#"
};
const schema10 = {};
import { validate as validate27 } from "./IoK8sApiAppsV1beta2DeploymentCondition";
