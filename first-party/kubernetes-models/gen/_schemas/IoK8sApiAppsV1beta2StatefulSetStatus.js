...
const schema8 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "p4K7sz9ieCz7AfI2odavtw8zbiGfJvMW5glzVdM68"
    },
    "currentReplicas": {
      "$ref": "Ccz0XZyNWiwVpe2nvsmnlMV1SnfQGMXuejl0yByE"
    },
  ...
  "required": ["replicas"],
  "type": "object",
  "$id": "io.k8s.api.apps.v1beta2.StatefulSetStatus"
};
const schema6 = {
  "format": "int32",
  "type": "integer",
...
const schema9 = {
  "items": {
    "$ref": "JkNgNs1zhtLQ6mAcKzhyOsrUcAwJFsKipQOwa0SUQ"
  },
  "type": "array",
  "nullable": true
};
...
const schema11 = {};
import { validate as validate27 } from "./IoK8sApiAppsV1beta2StatefulSetCondition";
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate33(data.observedGeneration, {
