...
const schema7 = {
  "properties": {
    ...
    "groups": {
      "$ref": "smy6umP9o5mxICuyxK4ySOcjwbSXv7t6B1jXmF0"
    },
    "kind": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
  ...
  "required": ["groups"],
  "type": "object",
  "$id": "io.k8s.apimachinery.pkg.apis.meta.v1.APIGroupList"
};
const schema6 = {
  "type": "string",
  "nullable": true
...
const schema8 = {
  "items": {
    "$ref": "pyKxqkcSsAExqUZ1IUvMjE0NBaq9zN0I8482mo3smY"
  },
  "type": "array"
};
const schema9 = {
...
const schema10 = {};
import { validate as validate26 } from "./IoK8sApimachineryPkgApisMetaV1APIGroup";
