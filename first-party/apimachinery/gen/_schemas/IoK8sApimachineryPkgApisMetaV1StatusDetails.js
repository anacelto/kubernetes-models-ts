...
const schema7 = {
  "properties": {
    "causes": {
      "$ref": "TSpcbao25fRByxYjNeqm07C656QKxIoDVntzEuEHcVU"
    },
    "group": {
...
const schema8 = {
  "items": {
    "$ref": "qYawK9roeSp5cg7dDLArAIpVYwAIAFC2Q70pdQLOM"
  },
  "type": "array",
  "nullable": true
};
...
const schema10 = {};
import { validate as validate25 } from "./IoK8sApimachineryPkgApisMetaV1StatusCause";
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.causes !== undefined) {
      if (!validate23(data.causes, {
        instancePath: instancePath + "/causes",
        parentData: data,
        parentDataProperty: "causes",
        rootData
      })) {
    ...
    if (data.retryAfterSeconds !== undefined) {
      if (!validate32(data.retryAfterSeconds, {
        instancePath: instancePath + "/retryAfterSeconds",
        parentData: data,
        parentDataProperty: "retryAfterSeconds",
        rootData
      })) {
