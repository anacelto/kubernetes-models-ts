...
function validate25(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaced !== undefined) {
      if (!validate30(data.namespaced, {
        instancePath: instancePath + "/namespaced",
        parentData: data,
        parentDataProperty: "namespaced",
        rootData
      })) {
    ...
    if (data.singularName !== undefined) {
      if (!validate21(data.singularName, {
        instancePath: instancePath + "/singularName",
        parentData: data,
        parentDataProperty: "singularName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.storageVersionHash !== undefined) {
      if (!validate24(data.storageVersionHash, {
        instancePath: instancePath + "/storageVersionHash",
        parentData: data,
        parentDataProperty: "storageVersionHash",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
