...
import { validate } from "../../_schemas/ShipwrightIoV1alpha1BuildRun";
...
export interface IBuildRun {
  ...
  "spec": {
    ...
    "buildSpec"?: {
      /**
       * Builder refers to the image containing the build tools inside which the source code would be built. 
       *  NOTICE: Builder is deprecated, and will be removed in a future release. Build strategies which rely on "builder" should provide an equivalent parameter instead.
       */
      "builder"?: {
        /**
       ...
       *  NOTICE: Dockerfile is deprecated, and will be removed in a future release. Build strategies which rely on "dockerfile" should provide an equivalent parameter instead.
       */
      "dockerfile"?: string;
      /**
      ...
      "source": {
        ...
        "contextDir"?: string;
        /**
         * Credentials references a Secret that contains credentials to access the repository.
         */
        "credentials"?: {
          /**
           * Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?
      ...
      /**
       * Sources slice of BuildSource, defining external build artifacts complementary to VCS (`.spec.source`) data. 
  ...
  "status"?: {
    ...
    /**
     * Sources holds the results emitted from the step definition of different sources
     */
    "sources"?: Array<{
      /**
       * Bundle holds the results emitted from from the step definition of bundle source
       */
      "bundle"?: {
        /**
      ...
      /**
       * Git holds the results emitted from from the step definition of a git source
       */
      "git"?: {
        /**
         * BranchName holds the default branch name of the git source this will be set only when revision is not specified in Build object
         */
        "branchName"?: string;
        /**
 ...
 * BuildRun is the Schema representing an instance of build execution
 */
export class BuildRun extends Model<IBuildRun> implements IBuildRun {
  "apiVersion": IBuildRun["apiVersion"];
  "kind": IBuildRun["kind"];
  "metadata"?: IBuildRun["metadata"];
  "spec": IBuildRun["spec"];
  "status"?: IBuildRun["status"];

static apiVersion: IBuildRun["apiVersion"] = "shipwright.io/v1alpha1";
static kind: IBuildRun["kind"] = "BuildRun";
static is = createTypeMetaGuard<IBuildRun>(BuildRun);

constructor(data?: ModelData<IBuildRun>) {
  super();

  this.setDefinedProps({
    apiVersion: BuildRun.apiVersion,
    kind: BuildRun.kind,
    ...data
  } as IBuildRun);
}
...
setValidateFunc(BuildRun, validate as ValidateFunc<IBuildRun>);
