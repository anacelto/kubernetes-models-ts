...
import { validate } from "../../_schemas/ShipwrightIoV1alpha1BuildStrategy";
 ...
 * BuildStrategy is the Schema representing a strategy in the namespace scope to build images from source code.
 */
export class BuildStrategy extends Model<IBuildStrategy> implements IBuildStrategy {
  "apiVersion": IBuildStrategy["apiVersion"];
  "kind": IBuildStrategy["kind"];
  "metadata"?: IBuildStrategy["metadata"];
  "spec"?: IBuildStrategy["spec"];
  "status"?: IBuildStrategy["status"];

static apiVersion: IBuildStrategy["apiVersion"] = "shipwright.io/v1alpha1";
static kind: IBuildStrategy["kind"] = "BuildStrategy";
static is = createTypeMetaGuard<IBuildStrategy>(BuildStrategy);

constructor(data?: ModelData<IBuildStrategy>) {
  super();

  this.setDefinedProps({
    apiVersion: BuildStrategy.apiVersion,
...
setValidateFunc(BuildStrategy, validate as ValidateFunc<IBuildStrategy>);
