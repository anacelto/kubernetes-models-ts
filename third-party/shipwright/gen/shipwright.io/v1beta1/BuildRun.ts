...
import { validate } from "../../_schemas/ShipwrightIoV1beta1BuildRun";
...
export interface IBuildRun {
  ...
  "spec": {
    /**
     * Build refers to an embedded build specification This field is mandatory
     */
    "build": {
      /**
    ...
    /**
     * Source refers to the location where the source code is, this could only be a local source
     */
    "source"?: {
      /**
       * LocalSource
      ...
      /**
       * Type is the BuildRunSource qualifier, the type of the data-source. Only LocalType is supported.
       */
      "type"?: string;
    };
    /**
  ...
  "status"?: {
    ...
    "source"?: {
      /**
       * Git holds the results emitted from the source step of type git
       */
      "git"?: {
        /**
      ...
      /**
       * OciArtifact holds the results emitted from the source step of type ociArtifact
       */
      "ociArtifact"?: {
        /**
...
static apiVersion: IBuildRun["apiVersion"] = "shipwright.io/v1beta1";
