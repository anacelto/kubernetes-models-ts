...
export const validate = validate402;
const schema100 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "3721TKxJcs12exGQtwkkufxehLOKxoUosgzaZaoXYg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "41FSJBSe0dYnQdW6Kw4mclryKUIsmPHqpgOwUHa8"
    },
    "status": {
      "$ref": "CjRZCG99wI2LTnCunv8tyyDldi4UeU0VEljncX2Y"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "shipwright.io.v1beta1.BuildRun"
};
const schema101 = {
  "type": "string",
...
const schema104 = {};
import { validate as validate408 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema105 = {
  "properties": {
    "build": {
      "$ref": "YEbYRTc8KR7wd1TFVIiIwNZFmNBVQWxqyM1AmslnNI"
    },
    "env": {
      "$ref": "3Jp76g3FDGxGCRhB4rdsXV0CN3ViAXzNmXiWQNaiI"
    },
    "output": {
      "$ref": "6OVrpHLR8FGa1AlEmXKNZF9CGeT6oINtVJP8EZh70"
    },
    "paramValues": {
      "$ref": "VUPVeI9kik0MrXiuftRokGFt3c0O1ZRQY9Zn336y7bc"
    },
    "retention": {
      "$ref": "ZlCX9x9seJmy7ySymerrd9C3Q4mdxVvBHpkbUBHqoY"
    },
    "serviceAccount": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "source": {
      "$ref": "xvuwofSmxkrH2ByudzIVjME2Dha6i9gsKAvzvUg4"
    },
    "state": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema106 = {
  "properties": {
    ...
    "spec": {
      "$ref": "icGjyjASr7MXcEXbChUoZZ1uelGfGOKkMLadRkjc68g"
    }
  },
  "type": "object"
};
...
const schema85 = {
  "properties": {
    ...
    "output": {
      "$ref": "zs3tlanJs0QaI4OcIWkhov3uWMdXpnQIYZhdnQXCzkY"
    },
    "paramValues": {
      "$ref": "VUPVeI9kik0MrXiuftRokGFt3c0O1ZRQY9Zn336y7bc"
    },
    "retention": {
      "$ref": "WD7riaMSC9bPQm8IuO9cPlLyuGyr8pswVzTw1pShL7A"
    },
    "source": {
      "$ref": "4lhfVdkleN1UMwLERB2DdbVeYT7KY1RnVs7G6YFA"
    },
    "strategy": {
    ...
    "trigger": {
      "$ref": "rXLtvdGNtDDUkBGxUd1GumgSujbkKnQK36fHyPl6gAc"
    },
    "volumes": {
      "$ref": "obaqnmwuGnbAfFhnKmrWql7xY4gvQVTgIVRdtZY8sPQ"
    }
  },
  "required": ["output", "source", "strategy"],
  "type": "object",
  "nullable": true
};
const schema28 = {
...
function validate342(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.pushSecret !== undefined) {
      if (!validate21(data.pushSecret, {
        instancePath: instancePath + "/pushSecret",
        parentData: data,
        parentDataProperty: "pushSecret",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema31 = {
  "items": {
    "$ref": "qWX2G1bfuIuwD8Knf64036pUO64bVymW6zjnkUmqsik"
  },
  "type": "array",
  "nullable": true
};
const schema32 = {
  "properties": {
    "configMapValue": {
      "$ref": "MWybFhX3hG7XVQDkWqBKep8wpHST1y2PXs1nDSh5Os"
    },
    "name": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    ...
    "values": {
      "$ref": "1yqUtg43zJgj2gMekE2vBGKWBa7TBC47ZDtBdJP4"
    }
  },
  "required": ["name"],
  "type": "object"
...
const schema33 = {
  "items": {
    "$ref": "3VZXbuz41MGU7a40DD3OjZdR9nLIKnTx0k7boL9gQ9M"
  },
  "type": "array",
  "nullable": true
};
...
function validate91(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configMapValue !== undefined) {
      if (!validate30(data.configMapValue, {
        instancePath: instancePath + "/configMapValue",
        parentData: data,
        parentDataProperty: "configMapValue",
        rootData
      })) {
    ...
    if (data.secretValue !== undefined) {
      if (!validate30(data.secretValue, {
        instancePath: instancePath + "/secretValue",
        parentData: data,
        parentDataProperty: "secretValue",
        rootData
      })) {
        vErrors = vErrors === null ? validate30.errors : vErrors.concat(validate30.errors);
        errors = vErrors.length;
...
const formats0 = /^P(?!$)(\d+(?:\.\d+)?Y)?(\d+(?:\.\d+)?M)?(\d+(?:\.\d+)?W)?(\d+(?:\.\d+)?D)?(T(?=\d)(\d+(?:\.\d+)?H)?(\d+(?:\.\d+)?M)?(\d+(?:\.\d+)?S)?)?$/;
...
function validate350(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.atBuildDeletion !== undefined) {
      if (!validate26(data.atBuildDeletion, {
        instancePath: instancePath + "/atBuildDeletion",
        parentData: data,
        parentDataProperty: "atBuildDeletion",
        rootData
      })) {
        vErrors = vErrors === null ? validate26.errors : vErrors.concat(validate26.errors);
        errors = vErrors.length;
    ...
    if (data.failedLimit !== undefined) {
      if (!validate34(data.failedLimit, {
        instancePath: instancePath + "/failedLimit",
        parentData: data,
        parentDataProperty: "failedLimit",
        rootData
      })) {
    ...
    if (data.succeededLimit !== undefined) {
      if (!validate34(data.succeededLimit, {
        instancePath: instancePath + "/succeededLimit",
        parentData: data,
        parentDataProperty: "succeededLimit",
        rootData
      })) {
        vErrors = vErrors === null ? validate34.errors : vErrors.concat(validate34.errors);
        errors = vErrors.length;
    ...
    if (data.ttlAfterFailed !== undefined) {
      if (!validate35(data.ttlAfterFailed, {
        instancePath: instancePath + "/ttlAfterFailed",
        parentData: data,
        parentDataProperty: "ttlAfterFailed",
        rootData
      })) {
    ...
    if (data.ttlAfterSucceeded !== undefined) {
      if (!validate35(data.ttlAfterSucceeded, {
        instancePath: instancePath + "/ttlAfterSucceeded",
        parentData: data,
        parentDataProperty: "ttlAfterSucceeded",
        rootData
      })) {
        vErrors = vErrors === null ? validate35.errors : vErrors.concat(validate35.errors);
        errors = vErrors.length;
...
const schema88 = {
  "properties": {
    ...
    "git": {
      "$ref": "BHIQyfgLsDMaEkXhdGyOVhecL7y8jtz9K4FbESuvw"
    },
    "local": {
      "$ref": "rg4XNH9nRjVHO6nJ8bx3jtNwPz9wKuRH4ygVoKjo"
    },
    "ociArtifact": {
      "$ref": "U4cSAPKwXAtrVFlGJprgNH2ImPrUXc3y59liycco"
    },
    "type": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
function validate359(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cloneSecret !== undefined) {
      if (!validate21(data.cloneSecret, {
        instancePath: instancePath + "/cloneSecret",
        parentData: data,
        parentDataProperty: "cloneSecret",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate365(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.pullSecret !== undefined) {
      if (!validate21(data.pullSecret, {
        instancePath: instancePath + "/pullSecret",
        parentData: data,
        parentDataProperty: "pullSecret",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate357(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.contextDir !== undefined) {
      if (!validate21(data.contextDir, {
        instancePath: instancePath + "/contextDir",
        parentData: data,
        parentDataProperty: "contextDir",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.ociArtifact !== undefined) {
      if (!validate365(data.ociArtifact, {
        instancePath: instancePath + "/ociArtifact",
        parentData: data,
        parentDataProperty: "ociArtifact",
        rootData
      })) {
...
const schema92 = {
  "properties": {
    ...
    "when": {
      "$ref": "OSwvE8SCJzaBVr4EMvcLb8tMcrT7DvgVvI2UVKKFY"
    }
  },
  "type": "object",
  "nullable": true
...
const schema93 = {
  "items": {
    "$ref": "gHvDN7jsFRwcnzuhJRNieimHF2IaDO7frzfWz8XRAA"
  },
  "type": "array",
  "nullable": true
};
const schema94 = {
  "properties": {
    "github": {
      "$ref": "5FmdAMEGLBXJHZ6D4DOZVjZ4eC42m2KJBGt3WCOD4"
    },
    "image": {
      "$ref": "13dCDvOfbYMMFIlEICvtfM0HcMwKuSarP3NDSBix8"
    },
    "name": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    "objectRef": {
      "$ref": "dZuAiUtu0Su1EuXKbcT1lq5CTrCJJvZfhc6wDFHM7g"
    },
    "type": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    }
...
const schema95 = {
  "properties": {
    ...
    "events": {
      "$ref": "IHzDrPy68yVJQK5S9PA47Z80Uu5YExa0FXPbDP50M"
    }
  },
  "type": "object",
  "nullable": true
...
function validate381(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.branches !== undefined) {
      if (!validate36(data.branches, {
        instancePath: instancePath + "/branches",
        parentData: data,
        parentDataProperty: "branches",
        rootData
      })) {
...
function validate380(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.objectRef !== undefined) {
      if (!validate391(data.objectRef, {
        instancePath: instancePath + "/objectRef",
        parentData: data,
        parentDataProperty: "objectRef",
        rootData
      })) {
...
function validate377(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.triggerSecret !== undefined) {
      if (!validate21(data.triggerSecret, {
        instancePath: instancePath + "/triggerSecret",
        parentData: data,
        parentDataProperty: "triggerSecret",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate142(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.volumeAttributes !== undefined) {
      if (!validate28(data.volumeAttributes, {
...
function validate183(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate184(data.matchExpressions, {
...
function validate161(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataSource !== undefined) {
      if (!validate163(data.dataSource, {
    ...
    if (data.dataSourceRef !== undefined) {
      if (!validate168(data.dataSourceRef, {
...
function validate157(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.volumeClaimTemplate !== undefined) {
      if (!validate158(data.volumeClaimTemplate, {
...
function validate279(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.expirationSeconds !== undefined) {
      if (!validate281(data.expirationSeconds, {
...
function validate273(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate275(data.downwardAPI, {
    ...
    if (data.serviceAccountToken !== undefined) {
      if (!validate279(data.serviceAccountToken, {
...
function validate102(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.awsElasticBlockStore !== undefined) {
      if (!validate103(data.awsElasticBlockStore, {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate149(data.downwardAPI, {
        instancePath: instancePath + "/downwardAPI",
        parentData: data,
        parentDataProperty: "downwardAPI",
        rootData
    ...
    if (data.flexVolume !== undefined) {
      if (!validate206(data.flexVolume, {
    ...
    if (data.gcePersistentDisk !== undefined) {
      if (!validate217(data.gcePersistentDisk, {
    ...
    if (data.persistentVolumeClaim !== undefined) {
      if (!validate257(data.persistentVolumeClaim, {
    ...
    if (data.photonPersistentDisk !== undefined) {
      if (!validate261(data.photonPersistentDisk, {
    ...
    if (data.portworxVolume !== undefined) {
      if (!validate265(data.portworxVolume, {
    ...
    if (data.vsphereVolume !== undefined) {
      if (!validate333(data.vsphereVolume, {
...
function validate340(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.paramValues !== undefined) {
      if (!validate84(data.paramValues, {
        instancePath: instancePath + "/paramValues",
        parentData: data,
        parentDataProperty: "paramValues",
        rootData
      })) {
...
const schema110 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "FRO9qEdusgnZI4Yxtjesj91wwz4Hf3av9mrilF5qA"
    },
    "failureDetails": {
      "$ref": "AvVvWzcMLAlXdCkOv1QG7WSAm6mIbqvLzChL2LBlim4"
    },
    "output": {
      "$ref": "InJcOnbC5JTYR5DdZvtWkzR9VwWD7IwUU8If8QyRA"
    },
    "source": {
      "$ref": "aju2PipErQZ6FCrhcGGS5MD86IgsSlVykrqAblL5TE"
    },
    "startTime": {
      "$ref": "thZzwpySeU7LsVtTYjwqN1mWUAwFAnezim8OMie8k"
    },
...
const schema111 = {
  "items": {
    "$ref": "nd8pvL5LamyC4JkIDGslBnrvreEpopc5ntx85uTA"
  },
  "type": "array",
  "nullable": true
};
...
function validate442(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate443(data.lastTransitionTime, {
...
const schema114 = {
  "properties": {
    "location": {
      "$ref": "gDt62zeK6k93vL9ES2KYtuEqpJaYIODUqozIhsENc"
    },
    "message": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema117 = {
  "properties": {
    "git": {
      "$ref": "AJ5ItoWxtALYjFHP4qQEZZQbapntmK8Wl53ErRZus"
    },
    "ociArtifact": {
      "$ref": "F7Pm9fHvF9vpCkVsKoUykk8kf1OEVQcXkRMQQhvtE"
    }
  },
  "type": "object",
  "nullable": true
...
function validate464(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.commitAuthor !== undefined) {
      if (!validate21(data.commitAuthor, {
        instancePath: instancePath + "/commitAuthor",
        parentData: data,
        parentDataProperty: "commitAuthor",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate463(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ociArtifact !== undefined) {
      if (!validate469(data.ociArtifact, {
        instancePath: instancePath + "/ociArtifact",
        parentData: data,
        parentDataProperty: "ociArtifact",
        rootData
...
function validate438(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.buildSpec !== undefined) {
      if (!validate340(data.buildSpec, {
        instancePath: instancePath + "/buildSpec",
        parentData: data,
        parentDataProperty: "buildSpec",
        rootData
      })) {
        vErrors = vErrors === null ? validate340.errors : vErrors.concat(validate340.errors);
        errors = vErrors.length;
    ...
    if (data.completionTime !== undefined) {
      if (!validate401(data.completionTime, {
    ...
    if (data.conditions !== undefined) {
      if (!validate441(data.conditions, {
    ...
    if (data.failureDetails !== undefined) {
      if (!validate451(data.failureDetails, {
        instancePath: instancePath + "/failureDetails",
        parentData: data,
        parentDataProperty: "failureDetails",
        rootData
      })) {
    ...
    if (data.taskRunName !== undefined) {
      if (!validate21(data.taskRunName, {
        instancePath: instancePath + "/taskRunName",
        parentData: data,
        parentDataProperty: "taskRunName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate402(data, {
  ...
  /*# sourceURL="shipwright.io.v1beta1.BuildRun" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.spec === undefined) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate403(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
