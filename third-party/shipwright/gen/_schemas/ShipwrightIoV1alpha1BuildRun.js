...
export const validate = validate413;
const schema102 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "spec": {
      "$ref": "Zjk4hRrCF84OWdTyoQUELsB4Ki8e2VZ4t94rmMyFMw"
    },
    "status": {
      "$ref": "ckm9enJUJ991DCWFIUeDmMvpDxd6WBUzZQDg3aspq8"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "shipwright.io.v1alpha1.BuildRun"
};
const schema103 = {
  "type": "string",
...
const schema106 = {};
import { validate as validate419 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema107 = {
  "properties": {
    "buildRef": {
      "$ref": "JvUJY2nEOnGimwEiARWVfJanMGBG4jsnqd3PbL92sKY"
    },
    "buildSpec": {
      "$ref": "z6wel5xR2bGjIfIgLeacyfN98CbU8d314zbTNK6P4"
    },
    "env": {
      "$ref": "3Jp76g3FDGxGCRhB4rdsXV0CN3ViAXzNmXiWQNaiI"
    },
    "output": {
      "$ref": "7ZsFeowmvnKHK4Fn8OrnyEjvc6iaPhzUtRflr0karb4"
    },
    "paramValues": {
    ...
    "serviceAccount": {
      "$ref": "Iqljtpol7DGIjPUT6BqeZCzlKJx6g7rMtCRXDwHE"
    },
    "sources": {
      "$ref": "KqOsR82WvcWCLeloWbgWcK6Zmdgdz7gy3vdlv85bfcQ"
    },
    "state": {
...
const schema87 = {
  "properties": {
    ...
    "output": {
      "$ref": "YC5obEcH4YirPRnh5z8YxU7y5W65QDkEglKQuG5N27w"
    },
    "paramValues": {
      "$ref": "VUPVeI9kik0MrXiuftRokGFt3c0O1ZRQY9Zn336y7bc"
    },
    "retention": {
      "$ref": "QwB8rAv4KCylesBcFl9Om97onsVMJTRYsH6knuOvDyA"
    },
    "source": {
      "$ref": "MlRbzmmVY2h00zCD4YjT6uvLshiWovfzWjIaPKVlDDQ"
    },
    "sources": {
      "$ref": "KqOsR82WvcWCLeloWbgWcK6Zmdgdz7gy3vdlv85bfcQ"
    },
    "strategy": {
      "$ref": "HamTSzXixNMDglATdxOzLTV5LTZqy1rdrkUoP91s"
    },
    "timeout": {
      "$ref": "gIihadtVzmZzsd7bW2vphcgvWDjJI8fRrmjCFBMzKk"
    },
    "trigger": {
      "$ref": "64dJcg17Hc0aMw8fCEOQogQs2ZubKeLqzeElBZZU"
    },
    "volumes": {
      "$ref": "obaqnmwuGnbAfFhnKmrWql7xY4gvQVTgIVRdtZY8sPQ"
    }
...
function validate84(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.credentials !== undefined) {
      if (!validate30(data.credentials, {
...
function validate97(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configMapValue !== undefined) {
      if (!validate32(data.configMapValue, {
    ...
    if (data.secretValue !== undefined) {
      if (!validate32(data.secretValue, {
...
function validate362(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.failedLimit !== undefined) {
      if (!validate36(data.failedLimit, {
    ...
    if (data.succeededLimit !== undefined) {
      if (!validate36(data.succeededLimit, {
    ...
    if (data.ttlAfterFailed !== undefined) {
      if (!validate37(data.ttlAfterFailed, {
    ...
    if (data.ttlAfterSucceeded !== undefined) {
      if (!validate37(data.ttlAfterSucceeded, {
...
const schema90 = {
  "properties": {
    "bundleContainer": {
      "$ref": "QceqTOMwbouzIcimefFw29A7BArijQV9u1nnqfOzTo"
    },
    "contextDir": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
function validate368(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.bundleContainer !== undefined) {
      if (!validate369(data.bundleContainer, {
        instancePath: instancePath + "/bundleContainer",
        parentData: data,
        parentDataProperty: "bundleContainer",
        rootData
      })) {
...
const schema36 = {
  "items": {
    "$ref": "HQMHMTdbgcskH791GqfdnTrD4S4SNgzaWjNYHtyZs"
  },
  "type": "array",
  "nullable": true
};
...
function validate152(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodePublishSecretRef !== undefined) {
      if (!validate30(data.nodePublishSecretRef, {
...
function validate193(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate194(data.matchExpressions, {
...
function validate171(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataSource !== undefined) {
      if (!validate173(data.dataSource, {
...
function validate167(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.volumeClaimTemplate !== undefined) {
      if (!validate168(data.volumeClaimTemplate, {
...
function validate289(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.expirationSeconds !== undefined) {
      if (!validate291(data.expirationSeconds, {
...
function validate283(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate285(data.downwardAPI, {
    ...
    if (data.serviceAccountToken !== undefined) {
      if (!validate289(data.serviceAccountToken, {
...
function validate112(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.awsElasticBlockStore !== undefined) {
      if (!validate113(data.awsElasticBlockStore, {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate159(data.downwardAPI, {
        instancePath: instancePath + "/downwardAPI",
        parentData: data,
        parentDataProperty: "downwardAPI",
        rootData
    ...
    if (data.flexVolume !== undefined) {
      if (!validate216(data.flexVolume, {
    ...
    if (data.gcePersistentDisk !== undefined) {
      if (!validate227(data.gcePersistentDisk, {
    ...
    if (data.persistentVolumeClaim !== undefined) {
      if (!validate267(data.persistentVolumeClaim, {
    ...
    if (data.photonPersistentDisk !== undefined) {
      if (!validate271(data.photonPersistentDisk, {
    ...
    if (data.portworxVolume !== undefined) {
      if (!validate275(data.portworxVolume, {
    ...
    if (data.vsphereVolume !== undefined) {
      if (!validate343(data.vsphereVolume, {
...
function validate350(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dockerfile !== undefined) {
      if (!validate22(data.dockerfile, {
        instancePath: instancePath + "/dockerfile",
        parentData: data,
        parentDataProperty: "dockerfile",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.paramValues !== undefined) {
      if (!validate90(data.paramValues, {
...
function validate422(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.buildRef !== undefined) {
      if (!validate423(data.buildRef, {
        instancePath: instancePath + "/buildRef",
        parentData: data,
        parentDataProperty: "buildRef",
        rootData
      })) {
    ...
    if (data.serviceAccount !== undefined) {
      if (!validate435(data.serviceAccount, {
...
const schema111 = {
  "properties": {
    ...
    "sources": {
      "$ref": "88sMYideoP6l3KXwAUY9iQYu6y05RzM1RyU49Ko20"
    },
    "startTime": {
      "$ref": "thZzwpySeU7LsVtTYjwqN1mWUAwFAnezim8OMie8k"
    }
...
function validate448(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate449(data.lastTransitionTime, {
...
const schema117 = {
  "items": {
    "$ref": "hv3WKqAQ0k2LqLgG5JOseVF5Wac07jWzFjtTMm9Go"
  },
  "type": "array",
  "nullable": true
};
...
function validate473(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.commitAuthor !== undefined) {
      if (!validate22(data.commitAuthor, {
...
function validate444(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.completionTime !== undefined) {
      if (!validate412(data.completionTime, {
    ...
    if (data.failedAt !== undefined) {
      if (!validate409(data.failedAt, {
        instancePath: instancePath + "/failedAt",
        parentData: data,
        parentDataProperty: "failedAt",
        rootData
      })) {
        vErrors = vErrors === null ? validate409.errors : vErrors.concat(validate409.errors);
        errors = vErrors.length;
    ...
    if (data.failureDetails !== undefined) {
      if (!validate458(data.failureDetails, {
    ...
    if (data.latestTaskRunRef !== undefined) {
      if (!validate22(data.latestTaskRunRef, {
        instancePath: instancePath + "/latestTaskRunRef",
        parentData: data,
        parentDataProperty: "latestTaskRunRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate413(data, {
  ...
  /*# sourceURL="shipwright.io.v1alpha1.BuildRun" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.spec === undefined) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate414(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
