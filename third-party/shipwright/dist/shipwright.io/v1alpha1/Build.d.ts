 ...
 * Build is the Schema representing a Build definition
 */
export declare class Build extends Model<IBuild> implements IBuild {
    "apiVersion": IBuild["apiVersion"];
    "kind": IBuild["kind"];
    "metadata"?: IBuild["metadata"];
    "spec": IBuild["spec"];
    "status"?: IBuild["status"];
    static apiVersion: IBuild["apiVersion"];
    static kind: IBuild["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBuild>;
