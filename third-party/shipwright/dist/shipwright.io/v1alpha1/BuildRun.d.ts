 ...
 * BuildRun is the Schema representing an instance of build execution
 */
export declare class BuildRun extends Model<IBuildRun> implements IBuildRun {
    "apiVersion": IBuildRun["apiVersion"];
    "kind": IBuildRun["kind"];
    "metadata"?: IBuildRun["metadata"];
    "spec": IBuildRun["spec"];
    "status"?: IBuildRun["status"];
    static apiVersion: IBuildRun["apiVersion"];
    static kind: IBuildRun["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBuildRun>;
