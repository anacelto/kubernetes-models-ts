 ...
 * ClusterBuildStrategy is the Schema representing a strategy in the cluster scope to build images from source code.
 */
export declare class ClusterBuildStrategy extends Model<IClusterBuildStrategy> implements IClusterBuildStrategy {
    ...
    static apiVersion: IClusterBuildStrategy["apiVersion"];
    static kind: IClusterBuildStrategy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterBuildStrategy>;
