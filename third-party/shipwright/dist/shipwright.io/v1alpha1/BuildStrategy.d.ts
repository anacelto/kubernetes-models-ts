 ...
 * BuildStrategy is the Schema representing a strategy in the namespace scope to build images from source code.
 */
export declare class BuildStrategy extends Model<IBuildStrategy> implements IBuildStrategy {
    ...
    static apiVersion: IBuildStrategy["apiVersion"];
    static kind: IBuildStrategy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBuildStrategy>;
