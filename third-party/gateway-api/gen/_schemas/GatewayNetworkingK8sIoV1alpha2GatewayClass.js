...
const schema6 = {
  ...
  "properties": {
    ...
    "status": {
      "$ref": "cxhMVzjoOhcm0wLgeAcOWNwX47Po4XwCdqNK61Xl0bY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "gateway.networking.k8s.io.v1alpha2.GatewayClass"
};
const schema7 = {
  "type": "string",
...
function validate21(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1alpha2.GatewayClass" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
