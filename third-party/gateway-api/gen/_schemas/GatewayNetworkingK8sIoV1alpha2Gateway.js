...
const schema22 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "y6fKv1val18K9ABfDTfWbx9xGAkZneacKiScx5N0Hc"
    },
    "status": {
      "$ref": "bPzCIwLZZ44eyWIaReLzWHLszSmPjZjh4a5UIhuPkE"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "gateway.networking.k8s.io.v1alpha2.Gateway"
};
const schema23 = {
  "type": "string",
...
const schema27 = {
  "properties": {
    "addresses": {
      "$ref": "KjSBOK8xD9nFYzklJgVJl9xsc6khx0sjpj3jxbjkM"
    },
    "gatewayClassName": {
      "$ref": "xwpijLRhjUEJllEse3cgJuQz6UsEYqfhm0t12sQjFe4"
    },
    "listeners": {
      "$ref": "MQx1iWiTuj5kYUE7iv0sJxaHzVkfhi3vwKGUZBXuE"
    }
  },
...
const schema8 = {
  "items": {
    "$ref": "nAnlnzZj7k6O8rrCl4ibVmsX5t5VUF3qXLcn99vdE0"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const pattern0 = new RegExp("^Hostname|IPAddress|NamedAddress|[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9\\/\\-._~%!$&'()*+,;=:]+$", "u");
...
const schema28 = {
  "items": {
    "$ref": "z281cWCXXkeKtUCV57KwC0sAJ1eo47F9escjU55g"
  },
  "maxItems": 64,
  "minItems": 1,
  "type": "array"
...
const schema29 = {
  "properties": {
    ...
    "protocol": {
      "$ref": "cPpyyfUHROn3V0lxBGMBSz3dwPwNqreOAyc1DAd7FA"
    },
    "tls": {
...
function validate69(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate70(data.matchExpressions, {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate79(data.matchLabels, {
...
const pattern7 = new RegExp("^[a-zA-Z0-9]([-a-zSA-Z0-9]*[a-zA-Z0-9])?$|[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9]+$", "u");
...
const pattern10 = new RegExp("^[a-z0-9]([-a-z0-9]*[a-z0-9])?$", "u");
...
function validate92(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificateRefs !== undefined) {
      if (!validate93(data.certificateRefs, {
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedRoutes !== undefined) {
      if (!validate62(data.allowedRoutes, {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.gatewayClassName !== undefined) {
      if (!validate21(data.gatewayClassName, {
...
function validate120(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.attachedRoutes !== undefined) {
      if (!validate121(data.attachedRoutes, {
    ...
    if (data.conditions !== undefined) {
      if (!validate123(data.conditions, {
    ...
    if (data.supportedKinds !== undefined) {
      if (!validate127(data.supportedKinds, {
...
function validate114(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate116(data.conditions, {
        instancePath: instancePath + "/conditions",
        parentData: data,
        parentDataProperty: "conditions",
        rootData
...
function validate48(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1alpha2.Gateway" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
