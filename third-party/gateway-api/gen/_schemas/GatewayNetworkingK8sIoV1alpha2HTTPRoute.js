...
const schema34 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "KSkWlEGRPs30OAHKiLlsY2mnG16LPTNH5kl7leMZs8w"
    },
    "status": {
      "$ref": "UOe8UUAJpAhbn7fN7bqiSkR0n5RvieBARQKBlCXVQ"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "gateway.networking.k8s.io.v1alpha2.HTTPRoute"
};
const schema35 = {
  "type": "string",
...
const schema38 = {};
import { validate as validate86 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema39 = {
  "properties": {
    ...
    "rules": {
      "$ref": "sW3sf7tEabudIe0V75MrbjLcUBUwsPr7cMYUaLIzkA"
    }
  },
  "type": "object"
};
...
const pattern9 = new RegExp("^(\\*\\.)?[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$", "u");
...
const schema43 = {
  ...
  "items": {
    "$ref": "C3Iz7N8Lyf9iJDdSjrrRcfTM35Keyb1jfrSyMhO1w"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema44 = {
  "properties": {
    "backendRefs": {
      "$ref": "WkXagNdPyUKgm6wsjvMu9cbBCJU2xoqyOk04sfHUIc"
    },
    "filters": {
      "$ref": "7CgqhkXup5FFU0ZL4BpLCes3ywMoW5lp9ZTB0pFs"
    },
    "matches": {
...
const schema45 = {
  "items": {
    "$ref": "tTZIUOVJokg3KrvhVyJDXhCmfdfBptUbRmfySa3UL8M"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema16 = {
  "items": {
    "$ref": "tUZdqRpzO9Zfllo0feNKziDCqu4378gFpjtHRxtGhU"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema17 = {
  "properties": {
    ...
    "requestRedirect": {
      "$ref": "sCapgUuJAE1hctgFmeXcFlV7k6KNsCFctJW3P9PGM"
    },
    "type": {
      "$ref": "PcTTXDF8a5qs95029ylXpIyH0rVtyinoPSZ0UO5LiY"
    }
  },
  "required": ["type"],
  "type": "object"
...
function validate68(data, {
  ...
  if (!(data === "RequestHeaderModifier" || data === "RequestMirror" || data === "RequestRedirect" || data === "ExtensionRef")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.extensionRef !== undefined) {
      if (!validate36(data.extensionRef, {
    ...
    if (data.requestHeaderModifier !== undefined) {
      if (!validate43(data.requestHeaderModifier, {
    ...
    if (data.requestMirror !== undefined) {
      if (!validate51(data.requestMirror, {
    ...
    if (data.requestRedirect !== undefined) {
      if (!validate60(data.requestRedirect, {
...
function validate98(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendRefs !== undefined) {
      if (!validate99(data.backendRefs, {
...
const schema60 = {
  "properties": {
    "parents": {
      "$ref": "0SorcZcF8WhYcKW50wyRyVRqgneQY3IYvfYnbR1G4"
    }
  },
  "required": ["parents"],
  "type": "object",
...
const schema61 = {
  "items": {
    "$ref": "jbWiXkByddp7pRfSATXpLQSxe2pLKoL92tXTDPofsHE"
  },
  "maxItems": 32,
  "type": "array"
};
...
function validate80(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1alpha2.HTTPRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
