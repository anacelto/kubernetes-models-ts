...
const schema32 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "2fOw5QAqWtJKhs97TRZXGaQha3TKLj6EnCCr1QiYk"
    },
    "status": {
  ...
  "$id": "gateway.networking.k8s.io.v1alpha2.GRPCRoute"
};
const schema33 = {
  "type": "string",
...
const schema37 = {
  "properties": {
    ...
    "rules": {
      "$ref": "r0bPIhNfW1XaTj29RD1JHo4l8Vygp68PBsOr8UJ1F0"
    }
  },
  "type": "object",
  "nullable": true
...
const schema41 = {
  "items": {
    "$ref": "5WzDhUzVGmlNcDVh8ls48YB1MtCSBbiiTtapTuMzVlI"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema42 = {
  "properties": {
    "backendRefs": {
      "$ref": "kPY3DeLmCBrI4OdbCbnachAzbBgbmgDI9YeM51E"
    },
    "filters": {
      "$ref": "38kNbHmvWrPzyl90k4BvY3RjEg9sOCtCerwFhumZVlA"
    },
    "matches": {
...
const schema43 = {
  "items": {
    "$ref": "75L7uj6MZJQqUWZ0IDfbSB4KFvmRSU6Eii6U9dzrM"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema18 = {
  "items": {
    "$ref": "QijCwp7Kh0uZYMyrTB4vD68SAqvcmWwKrriWotiTEl4"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendRefs !== undefined) {
      if (!validate94(data.backendRefs, {
...
function validate130(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate135(data.observedGeneration, {
...
function validate128(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate129(data.conditions, {
    ...
    if (data.controllerName !== undefined) {
      if (!validate145(data.controllerName, {
...
function validate75(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1alpha2.GRPCRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
