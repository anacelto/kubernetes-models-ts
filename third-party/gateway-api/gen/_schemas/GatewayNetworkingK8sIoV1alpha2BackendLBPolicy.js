...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "TvbAKhnaE8w3ZUiMsWLRJVClXiE8xUq9DbWX6GzOSok"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "g2rnNrqd2WaKdQNUYHb2bX54SOkXpoDWuSajQMgBL1I"
    },
    "status": {
  ...
  "$id": "gateway.networking.k8s.io.v1alpha2.BackendLBPolicy"
};
const schema9 = {
  "type": "string",
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.lifetimeType !== undefined) {
      if (!validate36(data.lifetimeType, {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cookieConfig !== undefined) {
      if (!validate35(data.cookieConfig, {
    ...
    if (data.sessionName !== undefined) {
      if (!validate40(data.sessionName, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sessionPersistence !== undefined) {
      if (!validate33(data.sessionPersistence, {
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sectionName !== undefined) {
      if (!validate68(data.sectionName, {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ancestorRef !== undefined) {
      if (!validate58(data.ancestorRef, {
...
function validate23(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1alpha2.BackendLBPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
