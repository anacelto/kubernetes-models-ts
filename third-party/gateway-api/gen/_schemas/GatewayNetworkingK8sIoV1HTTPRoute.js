...
export const validate = validate102;
const schema43 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "spec": {
      "$ref": "1tyHJrQJWuUVL4ta5EXWmVQSZjgPgSoJQ8rroLfoLw"
    },
    "status": {
      "$ref": "qvxakVMp7eaONEegeIttntjBGenu09FqoZGrzGg"
    }
  },
...
const schema47 = {};
import { validate as validate108 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema48 = {
  "properties": {
    ...
    "rules": {
      "$ref": "OipbS3RJp5y9ipZZ7aMkCtif0yw3vXuailUTls5uZQ"
    }
  },
  "type": "object"
};
...
const pattern10 = new RegExp("^(\\*\\.)?[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$", "u");
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sectionName !== undefined) {
      if (!validate31(data.sectionName, {
...
const schema52 = {
  ...
  "items": {
    "$ref": "kXgyMyUre9PKn2Bv68L0rNVJpNX0P7ErMcNHTaETfVY"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema53 = {
  "properties": {
    "backendRefs": {
      "$ref": "qly5TdujndE14jZ8PirdYe7BnZWK9SJ1gpHXqA6t3Aw"
    },
    "filters": {
      "$ref": "R6L6xmKvfTuz7UicWvXyq3XAEcahGyBVAQI3R2XiB08"
    },
    "matches": {
      "$ref": "oCD7WelSiobkqo5adpVM1ZhHLoBkJLNVRqVPgao"
    },
    "name": {
      "$ref": "q9ca0KFEUM7TMEh4mWmmFYB0OWEZN7fGsG5EzZTrt8"
    },
...
const schema54 = {
  "items": {
    "$ref": "eItm55VevUtfsumDq5Gj3wfuAV3w75wUg07SjOyxGiE"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema22 = {
  "items": {
    "$ref": "rly7F1tDQQuewsqdSdTfCooXqkXmqOZ1FEpu9uDBc"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema23 = {
  "properties": {
    ...
    "requestHeaderModifier": {
      "$ref": "pueQFRo3nGCSHnT8UOWqxoYi0Gg7R6iv9u4jrVNwaQ"
    },
    "requestMirror": {
      "$ref": "GRPHTPmSXWSGDjTf37rqX0v44E83deWyHwB5cRBk"
    },
    "requestRedirect": {
      "$ref": "iL3PyAeFn4cRhq3ssn1w1g3ZbXCTRC5q8Clx6SU"
    },
    "responseHeaderModifier": {
      "$ref": "pueQFRo3nGCSHnT8UOWqxoYi0Gg7R6iv9u4jrVNwaQ"
    },
    "type": {
      "$ref": "4ZUqR1uCKMb6V2iCg5T4TJ78Z9hpea9icDtlqiw"
    },
    "urlRewrite": {
...
const schema15 = {
  "properties": {
    "add": {
      "$ref": "6aefYtw6BEBKb5mm2o4YNMTLS6Gbc3gRNGuTqo4XRww"
    },
    "remove": {
...
const schema7 = {
  "items": {
    "$ref": "FfU3fbf97CIOd86YuzExyju6OOQCI0XRtWenE9xW6rk"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
function validate65(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.denominator !== undefined) {
      if (!validate66(data.denominator, {
...
function validate40(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.replaceFullPath !== undefined) {
      if (!validate32(data.replaceFullPath, {
    ...
    if (data.replacePrefixMatch !== undefined) {
      if (!validate32(data.replacePrefixMatch, {
...
function validate84(data, {
  ...
  if (!(data === "RequestHeaderModifier" || data === "ResponseHeaderModifier" || data === "RequestMirror" || data === "RequestRedirect" || data === "URLRewrite" || data === "ExtensionRef")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.extensionRef !== undefined) {
      if (!validate49(data.extensionRef, {
    ...
    if (data.requestHeaderModifier !== undefined) {
      if (!validate33(data.requestHeaderModifier, {
    ...
    if (data.requestMirror !== undefined) {
      if (!validate57(data.requestMirror, {
    ...
    if (data.requestRedirect !== undefined) {
      if (!validate74(data.requestRedirect, {
    ...
    if (data.responseHeaderModifier !== undefined) {
      if (!validate33(data.responseHeaderModifier, {
...
const schema57 = {
  ...
  "items": {
    "$ref": "sbQ7umoL3MsRB2bV0PnE5jihOcQ065JXeg47Wj7E5w"
  },
  "maxItems": 64,
  "type": "array",
  "nullable": true
...
function validate135(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.queryParams !== undefined) {
      if (!validate151(data.queryParams, {
...
const pattern7 = new RegExp("^([0-9]{1,5}(h|m|s|ms)){1,4}$", "u");
...
function validate173(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.lifetimeType !== undefined) {
      if (!validate174(data.lifetimeType, {
...
function validate171(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.absoluteTimeout !== undefined) {
      if (!validate92(data.absoluteTimeout, {
    ...
    if (data.cookieConfig !== undefined) {
      if (!validate173(data.cookieConfig, {
    ...
    if (data.idleTimeout !== undefined) {
      if (!validate92(data.idleTimeout, {
    ...
    if (data.sessionName !== undefined) {
      if (!validate178(data.sessionName, {
...
function validate183(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendRequest !== undefined) {
      if (!validate92(data.backendRequest, {
...
function validate120(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendRefs !== undefined) {
      if (!validate121(data.backendRefs, {
    ...
    if (data.sessionPersistence !== undefined) {
      if (!validate171(data.sessionPersistence, {
...
function validate111(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.parentRefs !== undefined) {
      if (!validate116(data.parentRefs, {
...
const schema78 = {
  "properties": {
    "parents": {
      "$ref": "URhX70vJwSopfzP7fht6BA0ndDGFkoUW5aKow3Qo"
    }
  },
  "required": ["parents"],
  "type": "object",
...
const schema79 = {
  "items": {
    "$ref": "VgaQcT1RCn3PtTxVX2dHUDx44HMrBBaddtvrB1wP5w"
  },
  "maxItems": 32,
  "type": "array"
};
...
const pattern11 = new RegExp("^[A-Za-z]([A-Za-z0-9_,:]*[A-Za-z0-9_])?$", "u");
...
const pattern12 = new RegExp("^([a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*/)?(([A-Za-z0-9][-A-Za-z0-9_.]*)?[A-Za-z0-9])$", "u");
...
function validate194(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate195(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate199(data.observedGeneration, {
...
const pattern13 = new RegExp("^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9\\/\\-._~%!$&'()*+,;=:]+$", "u");
...
function validate192(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.controllerName !== undefined) {
      if (!validate209(data.controllerName, {
...
function validate102(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate103(data.apiVersion, {
