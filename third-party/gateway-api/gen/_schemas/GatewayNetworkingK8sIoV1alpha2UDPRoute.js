...
const schema13 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "L348jbCMTlKxfAQuXugkZzGSoDIr8OTczqPBh2yIw"
    },
    "status": {
...
const schema18 = {
  "properties": {
    ...
    "rules": {
      "$ref": "IcLKK9ieHYzQoq5ObB6yN6kkERaFVGMnda90wLn3w"
    }
  },
  "required": ["rules"],
  "type": "object"
...
const schema20 = {
  "items": {
    "$ref": "CNmRCrSVdJEuNMXv9kKETwV5e2nEVO5E2yMefpj3Yw0"
  },
  "maxItems": 16,
  "minItems": 1,
  "type": "array"
...
const schema21 = {
  "properties": {
    "backendRefs": {
      "$ref": "JiDwOql7ONVmKr0TNmguC7TVjVmbSthhAuEELWbkzk"
    },
    "name": {
      "$ref": "q9ca0KFEUM7TMEh4mWmmFYB0OWEZN7fGsG5EzZTrt8"
    }
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate71(data.lastTransitionTime, {
...
function validate68(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.controllerName !== undefined) {
      if (!validate85(data.controllerName, {
