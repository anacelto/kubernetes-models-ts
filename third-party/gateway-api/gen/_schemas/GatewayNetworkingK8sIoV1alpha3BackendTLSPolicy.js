...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "Htod7hpMzb8xT9teHxOEbviZ1eDdnwDr707PVyc7Os"
    },
    "status": {
...
const schema15 = {
  "properties": {
    ...
    "validation": {
      "$ref": "ofdrwfDCtciFSJuEIEhjRQ6pkPflhseYEsW1rK6NUaM"
    }
  },
...
const schema20 = {
  "properties": {
    ...
    "wellKnownCACertificates": {
      "$ref": "XvfbU8arQwJZDgt0AAEe6f8AIMxrH1jyWIEy6LkcD4A"
    }
  },
  "required": ["hostname"],
  "type": "object"
...
const pattern8 = new RegExp("^[a-z0-9]([-a-z0-9]*[a-z0-9])?$", "u");
...
const pattern11 = new RegExp("^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9\\/\\-._~%!$&'()*+,;=:]+$", "u");
