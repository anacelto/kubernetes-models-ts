...
const schema37 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "DZXswLlNbUeni0hueuW9tEQvdspvepWntwi4lH3YzkQ"
    },
    "status": {
...
const schema42 = {
  "properties": {
    ...
    "rules": {
      "$ref": "hr9cJtzqQkCRTUNzP7GqS2nOkpk8PbqiAuebymFHXU"
    }
  },
  "type": "object",
  "nullable": true
...
const schema46 = {
  "items": {
    "$ref": "OKTE5gG6UfncWjuwGPRoHqFS75bqH35XIv5P6dcZows"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema47 = {
  "properties": {
    "backendRefs": {
      "$ref": "XWHOPZmPDxtNI07sXc6K6xnhqhX5xngVFgvmZsp6dw"
    },
    "filters": {
      "$ref": "pRVPaTalaDflbHITqxgpmRdqaONBsCcqu5lvvuC0"
    },
    "matches": {
      "$ref": "eCGMoSvKRhtD2zTIOT5OUgS7CFqaWoKHYP26f3lH8"
    },
    "name": {
      "$ref": "q9ca0KFEUM7TMEh4mWmmFYB0OWEZN7fGsG5EzZTrt8"
    },
...
const schema48 = {
  "items": {
    "$ref": "RwcHh5oBm3DaichfgRd2B93x1TX33Z8c8U57GsPbB0"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema18 = {
  "items": {
    "$ref": "wXN2CcKW1l9ked53Gk1dwo7JCcrP9CnKMX2hA3cg"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
function validate135(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.lifetimeType !== undefined) {
      if (!validate136(data.lifetimeType, {
...
function validate133(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cookieConfig !== undefined) {
      if (!validate135(data.cookieConfig, {
    ...
    if (data.sessionName !== undefined) {
      if (!validate140(data.sessionName, {
...
function validate102(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sessionPersistence !== undefined) {
      if (!validate133(data.sessionPersistence, {
...
function validate152(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate153(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate157(data.observedGeneration, {
...
function validate150(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate151(data.conditions, {
    ...
    if (data.controllerName !== undefined) {
      if (!validate167(data.controllerName, {
