...
const schema34 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "sSochvI00TaikaGRo4WzIZ40WXjwTPwnIYLQ5nszZM"
    },
    "status": {
      "$ref": "jB193bQZ39yWuYFR3QyRkLX7iiXfr3LaPJ3dGV7XsFs"
    }
  },
...
const schema39 = {
  "properties": {
    ...
    "infrastructure": {
      "$ref": "DfedNWnH36ZfujH2mCkFmSauTBmWyPqfBVDWpiVQaA"
    },
    "listeners": {
      "$ref": "J9ek7qiZZfSf5WhLyY4kPCTywyPL9JEqi63P4Q5mH5c"
    }
  },
...
const formats0 = /^(?:(?:25[0-5]|2[0-4]\d|[01]?\d\d?)\.){3}(?:25[0-5]|2[0-4]\d|[01]?\d\d?)$/;
...
const formats2 = /^((([0-9a-f]{1,4}:){7}([0-9a-f]{1,4}|:))|(([0-9a-f]{1,4}:){6}(:[0-9a-f]{1,4}|((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9a-f]{1,4}:){5}(((:[0-9a-f]{1,4}){1,2})|:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9a-f]{1,4}:){4}(((:[0-9a-f]{1,4}){1,3})|((:[0-9a-f]{1,4})?:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){3}(((:[0-9a-f]{1,4}){1,4})|((:[0-9a-f]{1,4}){0,2}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){2}(((:[0-9a-f]{1,4}){1,5})|((:[0-9a-f]{1,4}){0,3}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){1}(((:[0-9a-f]{1,4}){1,6})|((:[0-9a-f]{1,4}){0,4}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(:(((:[0-9a-f]{1,4}){1,7})|((:[0-9a-f]{1,4}){0,5}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:)))$/i;
...
function validate79(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.clientCertificateRef !== undefined) {
      if (!validate80(data.clientCertificateRef, {
...
const schema42 = {
  "properties": {
    "annotations": {
      "$ref": "oBVtMtmald4XDDPX56PUbk4zCe8DLuAZ5NrzfJ8lb7g"
    },
    "labels": {
...
function validate88(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.annotations !== undefined) {
      if (!validate89(data.annotations, {
    ...
    if (data.parametersRef !== undefined) {
      if (!validate96(data.parametersRef, {
...
const schema47 = {
  "items": {
    "$ref": "rOoTLAcqYsQPxp1niJJZyNyF5PV3aDsV8z77rieT4"
  },
  "maxItems": 64,
  "minItems": 1,
  "type": "array"
...
const schema48 = {
  "properties": {
    ...
    "tls": {
      "$ref": "BQMVrx07fvG8JGeFx3BGhp5gpGo4yWxwgFZ06suTck"
    }
  },
...
function validate111(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate112(data.matchExpressions, {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate121(data.matchLabels, {
...
function validate104(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaces !== undefined) {
      if (!validate108(data.namespaces, {
...
const schema61 = {
  "properties": {
    ...
    "frontendValidation": {
      "$ref": "XzjrtII89vfhxZmwJbuxyDQynLzLbwXykhtVDNn9N0"
    },
    "mode": {
...
const schema64 = {
  "properties": {
    "caCertificateRefs": {
      "$ref": "bTqG3hYaU1SDTpXQDGpBkqxScTZGFxxqozb7RiUTo"
    }
  },
  "type": "object",
  "nullable": true
...
function validate143(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.caCertificateRefs !== undefined) {
      if (!validate144(data.caCertificateRefs, {
...
function validate134(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificateRefs !== undefined) {
      if (!validate135(data.certificateRefs, {
    ...
    if (data.frontendValidation !== undefined) {
      if (!validate143(data.frontendValidation, {
        instancePath: instancePath + "/frontendValidation",
        parentData: data,
        parentDataProperty: "frontendValidation",
        rootData
      })) {
...
function validate103(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedRoutes !== undefined) {
      if (!validate104(data.allowedRoutes, {
...
function validate77(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.backendTLS !== undefined) {
      if (!validate79(data.backendTLS, {
        instancePath: instancePath + "/backendTLS",
        parentData: data,
        parentDataProperty: "backendTLS",
        rootData
      })) {
    ...
    if (data.gatewayClassName !== undefined) {
      if (!validate22(data.gatewayClassName, {
    ...
    if (data.infrastructure !== undefined) {
      if (!validate88(data.infrastructure, {
...
const schema69 = {
  ...
  "properties": {
    ...
    "listeners": {
      "$ref": "JovUBaNHGK5BhH6UzKIFm5zCBpR5ujUVHjzw9zykdE"
    }
  },
  "type": "object",
  "nullable": true
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate55(data.observedGeneration, {
...
const schema71 = {
  "items": {
    "$ref": "gUOLKekbLT2Yfj2HOnOn74cJFhqNNQt798WAJFbVI"
  },
  "maxItems": 64,
  "type": "array",
  "nullable": true
...
const schema72 = {
  "properties": {
    ...
    "supportedKinds": {
      "$ref": "VfU2L3aOIDdr7XGAdJE6DNHdrhS3oXROEN63zTWIh6Y"
    }
  },
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.supportedKinds === undefined) {
      const err3 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "supportedKinds"
        }
      };
      if (vErrors === null) {
        vErrors = [err3];
    ...
    if (data.attachedRoutes !== undefined) {
      if (!validate169(data.attachedRoutes, {
    ...
    if (data.conditions !== undefined) {
      if (!validate171(data.conditions, {
    ...
    if (data.supportedKinds !== undefined) {
      if (!validate175(data.supportedKinds, {
