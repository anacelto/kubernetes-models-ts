 ...
 * connects to a Backend via TLS.
 */
export declare class BackendTLSPolicy extends Model<IBackendTLSPolicy> implements IBackendTLSPolicy {
    ...
    static apiVersion: IBackendTLSPolicy["apiVersion"];
    static kind: IBackendTLSPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBackendTLSPolicy>;
