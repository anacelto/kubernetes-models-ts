 ...
 * GatewayClass is a Cluster level resource.
 */
export declare class GatewayClass extends Model<IGatewayClass> implements IGatewayClass {
    ...
    static apiVersion: IGatewayClass["apiVersion"];
    static kind: IGatewayClass["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGatewayClass>;
