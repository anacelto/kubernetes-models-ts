        ...
        "rules"?: Array<{
            ...
            "backendRefs"?: Array<{
                ...
                "filters"?: Array<{
                     ...
                     *
                     */
                    "type": "RequestHeaderModifier" | "RequestMirror" | "RequestRedirect" | "ExtensionRef";
                }>;
                /**
                 * Group is the group of the referent. For example, "gateway.networking.k8s.io". When unspecified or empty string, core API group is inferred.
                 */
 ...
 * HTTPRoute provides a way to route HTTP requests. This includes the capability to match requests by hostname, path, header, or query param. Filters can be used to specify additional processing steps. Backends specify where matching requests should be routed.
 */
export declare class HTTPRoute extends Model<IHTTPRoute> implements IHTTPRoute {
    ...
    static apiVersion: IHTTPRoute["apiVersion"];
    static kind: IHTTPRoute["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IHTTPRoute>;
