...
import { validate } from "../../_schemas/LonghornIoV1beta2SystemBackup";
 ...
 * SystemBackup is where Longhorn stores system backup object
 */
export class SystemBackup extends Model<ISystemBackup> implements ISystemBackup {
...
static apiVersion: ISystemBackup["apiVersion"] = "longhorn.io/v1beta2";
static kind: ISystemBackup["kind"] = "SystemBackup";
static is = createTypeMetaGuard<ISystemBackup>(SystemBackup);

constructor(data?: ModelData<ISystemBackup>) {
  super();

  this.setDefinedProps({
    apiVersion: SystemBackup.apiVersion,
    kind: SystemBackup.kind,
    ...data
  } as ISystemBackup);
}
}
...
setValidateFunc(SystemBackup, validate as ValidateFunc<ISystemBackup>);
