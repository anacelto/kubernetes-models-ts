...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "B8AkqvOkSFrFvCT7yKYDU6M4ITS6icq7BjdJdnzP8R8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "LLUj3dyHqw6v1upW5Ug9ROk4z7p5O3uC0qwFyKPdU"
    },
    "status": {
      "$ref": "k3k3QIUkl3DQDpdQT2crOXdB9v2IgxfdnIV8lmEE"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.Orphan"
};
const schema8 = {
  "type": "string",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.orphanType !== undefined) {
      if (!validate21(data.orphanType, {
        instancePath: instancePath + "/orphanType",
        parentData: data,
        parentDataProperty: "orphanType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.Orphan" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
