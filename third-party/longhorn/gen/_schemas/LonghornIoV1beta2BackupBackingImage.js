...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "umooeClWZ6sL93JhNq1SNgMaVNQHOK26g1e9472IU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "NMF9ZSbOLFBaC5sq2tmFtCZLEVSCtJmMJCpWnN8tGw"
    },
    "status": {
      "$ref": "UvMKYXfjNcJFtpbuDFLQJBE7xyirwznchng0icwljU"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.BackupBackingImage"
};
const schema11 = {
  "type": "string",
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.userCreated !== undefined) {
      if (!validate38(data.userCreated, {
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.managerAddress !== undefined) {
      if (!validate21(data.managerAddress, {
        instancePath: instancePath + "/managerAddress",
        parentData: data,
        parentDataProperty: "managerAddress",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate26(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.BackupBackingImage" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
