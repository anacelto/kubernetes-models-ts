...
const schema9 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "G2ro8oFHph4Y99REq0o7Fu1cdiHPO64a3SIG0RXNk"
    },
    "status": {
      "$ref": "uBYoEws5Ds0og7uXWkithPjzWwloRtCVkET6YTcUk8"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.VolumeAttachment"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    "attachmentTickets": {
      "$ref": "mNds7bnCLMWOVR7FU5Ux3dXJecqKGcApuMv7hufEX2g"
    },
    "volume": {
...
const schema15 = {
  "additionalProperties": {
    "$ref": "xsUSZdxFP8hKWTarB2Hnqy9RpSKwFXc6JtFbKpyWvY"
  },
  "type": "object",
  "properties": {},
  "nullable": true
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.attachmentTickets !== undefined) {
      if (!validate34(data.attachmentTickets, {
        instancePath: instancePath + "/attachmentTickets",
        parentData: data,
        parentDataProperty: "attachmentTickets",
        rootData
      })) {
...
const schema18 = {
  "properties": {
    "attachmentTicketStatuses": {
      "$ref": "TX316XhiSYoMHiYnzRhttdzjq0Q5Fed26xTR7eNwcIg"
    }
  },
  "type": "object",
  "nullable": true
...
const schema19 = {
  "additionalProperties": {
    "$ref": "uyuRQthKRErEa6E81DkGJ0W7NWKBO06QxtijYVNmQ"
  },
  "type": "object",
  "properties": {},
  "nullable": true
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.satisfied !== undefined) {
      if (!validate62(data.satisfied, {
        instancePath: instancePath + "/satisfied",
        parentData: data,
        parentDataProperty: "satisfied",
        rootData
      })) {
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.attachmentTicketStatuses !== undefined) {
      if (!validate48(data.attachmentTicketStatuses, {
        instancePath: instancePath + "/attachmentTicketStatuses",
        parentData: data,
        parentDataProperty: "attachmentTicketStatuses",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.VolumeAttachment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
