...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "MR0U5a9EIW62OoOuQdsMikxi3AqpqsY5ny7x0Cc"
    },
    "status": {
      "$ref": "CqLIKuYGfhaMq78xcAAbd4w47umoS5zXJ4vn57UoE8"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.BackupVolume"
};
const schema11 = {
  "type": "string",
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.syncRequestedAt !== undefined) {
      if (!validate22(data.syncRequestedAt, {
...
function validate38(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backingImageChecksum !== undefined) {
      if (!validate21(data.backingImageChecksum, {
        instancePath: instancePath + "/backingImageChecksum",
        parentData: data,
        parentDataProperty: "backingImageChecksum",
        rootData
      })) {
    ...
    if (data.backingImageName !== undefined) {
      if (!validate21(data.backingImageName, {
        instancePath: instancePath + "/backingImageName",
        parentData: data,
        parentDataProperty: "backingImageName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.dataStored !== undefined) {
      if (!validate21(data.dataStored, {
        instancePath: instancePath + "/dataStored",
        parentData: data,
        parentDataProperty: "dataStored",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.lastBackupName !== undefined) {
      if (!validate21(data.lastBackupName, {
        instancePath: instancePath + "/lastBackupName",
        parentData: data,
        parentDataProperty: "lastBackupName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.lastSyncedAt !== undefined) {
      if (!validate22(data.lastSyncedAt, {
...
function validate26(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.BackupVolume" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
