...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "GkVBzqignLZ8ov10rlepuOEUVzyLcvm0E4HwV1RKQw"
    },
    "kind": {
      "$ref": "47RmMJTyNnoFq7OwxvH3HCvoioi8X3wsRc7IPstiL4"
    },
    "metadata": {
  ...
  "$id": "longhorn.io.v1beta1.BackingImageDataSource"
};
const schema8 = {
  "type": "string",
  "enum": ["longhorn.io/v1beta1"]
};
...
function validate25(data, {
  ...
  if (!(data === "BackingImageDataSource")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta1.BackingImageDataSource" */;
  let vErrors = null;
  let errors = 0;
