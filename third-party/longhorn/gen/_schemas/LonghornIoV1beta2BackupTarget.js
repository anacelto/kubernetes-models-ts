...
const schema8 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "5zbqXRJK1KPKtfFco6YHqJ2sz9WSCYARuy3aSHNik"
    },
    "status": {
      "$ref": "IOh31CoO4BqZbquqOg7zR3ZCikpAnQJcvVmJNG9gvc"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.BackupTarget"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backupTargetURL !== undefined) {
      if (!validate21(data.backupTargetURL, {
        instancePath: instancePath + "/backupTargetURL",
        parentData: data,
        parentDataProperty: "backupTargetURL",
        rootData
      })) {
    ...
    if (data.credentialSecret !== undefined) {
      if (!validate21(data.credentialSecret, {
        instancePath: instancePath + "/credentialSecret",
        parentData: data,
        parentDataProperty: "credentialSecret",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.pollInterval !== undefined) {
      if (!validate21(data.pollInterval, {
        instancePath: instancePath + "/pollInterval",
        parentData: data,
        parentDataProperty: "pollInterval",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate38(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.available !== undefined) {
      if (!validate39(data.available, {
        instancePath: instancePath + "/available",
        parentData: data,
        parentDataProperty: "available",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.BackupTarget" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
