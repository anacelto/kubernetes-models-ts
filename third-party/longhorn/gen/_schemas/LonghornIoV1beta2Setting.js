...
const schema6 = {
  ...
  "properties": {
    ...
    "status": {
      "$ref": "KfekbuovvH5QRDe4YBicFv6LKtYDAUMs48D8LaNYq0"
    },
    "value": {
  ...
  "$id": "longhorn.io.v1beta2.Setting"
};
const schema7 = {
  "type": "string",
...
function validate30(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.applied !== undefined) {
      if (!validate31(data.applied, {
        instancePath: instancePath + "/applied",
        parentData: data,
        parentDataProperty: "applied",
        rootData
      })) {
...
function validate21(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.Setting" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
