...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "fMjXBmnfrg4KoPoHhSY3vjwG2U2WRX4qQUVxlf3hII4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ymKFFYFtqcIl8Wo5vr184gUO9s9foyz2DXEwro0ds"
    },
    "status": {
      "$ref": "pdjXl1SQR0A5atCjYXhzPM2Zbup02WSEsvLb3qcaM"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.SystemBackup"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.volumeBackupPolicy !== undefined) {
      if (!validate21(data.volumeBackupPolicy, {
        instancePath: instancePath + "/volumeBackupPolicy",
        parentData: data,
        parentDataProperty: "volumeBackupPolicy",
        rootData
      })) {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.managerImage !== undefined) {
      if (!validate21(data.managerImage, {
        instancePath: instancePath + "/managerImage",
        parentData: data,
        parentDataProperty: "managerImage",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.SystemBackup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
