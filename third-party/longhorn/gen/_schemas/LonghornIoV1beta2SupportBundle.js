...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "s0fFyuLSKHSdympdpI8Fdu1JgHboFoAzkGY9YyMRo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "I62VIAKYVWRErOqIHj3JgIHkZxdjwAo2gHvjSPKSA"
    },
    "status": {
      "$ref": "7JlSMIGVMEzV3xIUFYclWUOwJ7rSNbbIHTucTogGmEA"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.SupportBundle"
};
const schema8 = {
  "type": "string",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.issueURL !== undefined) {
      if (!validate21(data.issueURL, {
        instancePath: instancePath + "/issueURL",
        parentData: data,
        parentDataProperty: "issueURL",
        rootData
      })) {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.filesize !== undefined) {
      if (!validate47(data.filesize, {
        instancePath: instancePath + "/filesize",
        parentData: data,
        parentDataProperty: "filesize",
        rootData
      })) {
    ...
    if (data.managerIP !== undefined) {
      if (!validate21(data.managerIP, {
        instancePath: instancePath + "/managerIP",
        parentData: data,
        parentDataProperty: "managerIP",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.SupportBundle" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
