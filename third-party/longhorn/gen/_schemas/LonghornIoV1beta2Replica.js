...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "hqSAYKbShm0rSKNlkUvp26UBQUxUbYUnvxNWWfefNI"
    },
    "status": {
      "$ref": "vVYY0P6P8I9VRd80g05pqBe393Vk6zLE2KZG8ImPkXk"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.Replica"
};
const schema11 = {
  "type": "string",
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataDirectoryName !== undefined) {
      if (!validate21(data.dataDirectoryName, {
        instancePath: instancePath + "/dataDirectoryName",
        parentData: data,
        parentDataProperty: "dataDirectoryName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.diskID !== undefined) {
      if (!validate21(data.diskID, {
        instancePath: instancePath + "/diskID",
        parentData: data,
        parentDataProperty: "diskID",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.engineName !== undefined) {
      if (!validate21(data.engineName, {
        instancePath: instancePath + "/engineName",
        parentData: data,
        parentDataProperty: "engineName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.evictionRequested !== undefined) {
      if (!validate22(data.evictionRequested, {
    ...
    if (data.hardNodeAffinity !== undefined) {
      if (!validate21(data.hardNodeAffinity, {
        instancePath: instancePath + "/hardNodeAffinity",
        parentData: data,
        parentDataProperty: "hardNodeAffinity",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.healthyAt !== undefined) {
      if (!validate21(data.healthyAt, {
        instancePath: instancePath + "/healthyAt",
        parentData: data,
        parentDataProperty: "healthyAt",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.lastFailedAt !== undefined) {
      if (!validate21(data.lastFailedAt, {
        instancePath: instancePath + "/lastFailedAt",
        parentData: data,
        parentDataProperty: "lastFailedAt",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.lastHealthyAt !== undefined) {
      if (!validate21(data.lastHealthyAt, {
        instancePath: instancePath + "/lastHealthyAt",
        parentData: data,
        parentDataProperty: "lastHealthyAt",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.rebuildRetryCount !== undefined) {
      if (!validate23(data.rebuildRetryCount, {
        instancePath: instancePath + "/rebuildRetryCount",
        parentData: data,
        parentDataProperty: "rebuildRetryCount",
        rootData
      })) {
    ...
    if (data.snapshotMaxCount !== undefined) {
      if (!validate23(data.snapshotMaxCount, {
    ...
    if (data.snapshotMaxSize !== undefined) {
      if (!validate24(data.snapshotMaxSize, {
    ...
    if (data.unmapMarkDiskChainRemovedEnabled !== undefined) {
      if (!validate22(data.unmapMarkDiskChainRemovedEnabled, {
        instancePath: instancePath + "/unmapMarkDiskChainRemovedEnabled",
        parentData: data,
        parentDataProperty: "unmapMarkDiskChainRemovedEnabled",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate25(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.Replica" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
