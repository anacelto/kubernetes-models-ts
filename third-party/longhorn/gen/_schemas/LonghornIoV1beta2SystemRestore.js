...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "yfD8y0Wm0awf2EBesq0gw0cVY617ZQ7aqyCp7wfKmBs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ZRChExE0mPogWlDWQWjX3rPtBhTLE0M0yhDzGyyny7Q"
    },
    "status": {
      "$ref": "W2zetDidvaQTGlVJrgSHnr33nahyMWNk82y94MR3VI"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.SystemRestore"
};
const schema8 = {
  "type": "string",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.systemBackup === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "systemBackup"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.systemBackup !== undefined) {
      if (!validate32(data.systemBackup, {
        instancePath: instancePath + "/systemBackup",
        parentData: data,
        parentDataProperty: "systemBackup",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.SystemRestore" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
