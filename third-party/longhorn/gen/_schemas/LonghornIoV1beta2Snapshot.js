...
const schema11 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "bQPQPI2MVUlolkcx6ZMt9RGFTJQhzfGwcqtOssMaJ9w"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Hvrm4c9OcH5EN8yKK6gtHRPTaIo0gQmWdT7nTBj6E"
    },
    "status": {
      "$ref": "7Wjq7P6RPg7lQuYbx5abbMqrerkytYSIMZenqPZRw"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.Snapshot"
};
const schema12 = {
  "type": "string",
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.createSnapshot !== undefined) {
      if (!validate25(data.createSnapshot, {
        instancePath: instancePath + "/createSnapshot",
        parentData: data,
        parentDataProperty: "createSnapshot",
        rootData
      })) {
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.markRemoved !== undefined) {
      if (!validate25(data.markRemoved, {
        instancePath: instancePath + "/markRemoved",
        parentData: data,
        parentDataProperty: "markRemoved",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
    ...
    if (data.restoreSize !== undefined) {
      if (!validate26(data.restoreSize, {
    ...
    if (data.userCreated !== undefined) {
      if (!validate25(data.userCreated, {
...
function validate27(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.Snapshot" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
