...
const schema9 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "QSnF1dlWzyv2Q6K7lS4TuaQM54TnP15mM2WZcfAu68"
    },
    "status": {
      "$ref": "OhKfm7O8u25zdGwrxXfdXJ5RqrEZIA9hw1qg0"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "longhorn.io.v1beta2.BackingImageDataSource"
};
const schema10 = {
  "type": "string",
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.fileTransferred !== undefined) {
      if (!validate38(data.fileTransferred, {
        instancePath: instancePath + "/fileTransferred",
        parentData: data,
        parentDataProperty: "fileTransferred",
        rootData
      })) {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.runningParameters !== undefined) {
      if (!validate22(data.runningParameters, {
        instancePath: instancePath + "/runningParameters",
        parentData: data,
        parentDataProperty: "runningParameters",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate25(data, {
  ...
  /*# sourceURL="longhorn.io.v1beta2.BackingImageDataSource" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
