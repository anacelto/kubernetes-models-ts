 ...
 * or any other Prometheus-compatible storage system that supports the remote_write protocol.
 */
export declare class VMAgent extends Model<IVMAgent> implements IVMAgent {
    "apiVersion": IVMAgent["apiVersion"];
    "kind": IVMAgent["kind"];
    "metadata"?: IVMAgent["metadata"];
    "spec"?: IVMAgent["spec"];
    "status"?: IVMAgent["status"];
    static apiVersion: IVMAgent["apiVersion"];
    static kind: IVMAgent["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVMAgent>;
