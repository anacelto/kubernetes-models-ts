 ...
 * based on selectors.
 */
export declare class VMPodScrape extends Model<IVMPodScrape> implements IVMPodScrape {
    ...
    static apiVersion: IVMPodScrape["apiVersion"];
    static kind: IVMPodScrape["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVMPodScrape>;
