 ...
 * InternalIP is used as __address__ for scraping.
 */
export declare class VMNodeScrape extends Model<IVMNodeScrape> implements IVMNodeScrape {
    ...
    static apiVersion: IVMNodeScrape["apiVersion"];
    static kind: IVMNodeScrape["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVMNodeScrape>;
