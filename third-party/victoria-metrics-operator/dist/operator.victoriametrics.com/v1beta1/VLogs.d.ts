 ...
 * VLogs is the Schema for the vlogs API
 */
export declare class VLogs extends Model<IVLogs> implements IVLogs {
    "apiVersion": IVLogs["apiVersion"];
    "kind": IVLogs["kind"];
    "metadata"?: IVLogs["metadata"];
    "spec"?: IVLogs["spec"];
    "status"?: IVLogs["status"];
    static apiVersion: IVLogs["apiVersion"];
    static kind: IVLogs["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVLogs>;
