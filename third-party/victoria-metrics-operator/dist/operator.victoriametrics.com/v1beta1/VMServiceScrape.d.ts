 ...
 * result config will scrape service endpoints
 */
export declare class VMServiceScrape extends Model<IVMServiceScrape> implements IVMServiceScrape {
    ...
    static apiVersion: IVMServiceScrape["apiVersion"];
    static kind: IVMServiceScrape["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVMServiceScrape>;
