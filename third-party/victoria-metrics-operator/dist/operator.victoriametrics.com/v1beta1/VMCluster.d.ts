 ...
 * Cluster version with
 */
export declare class VMCluster extends Model<IVMCluster> implements IVMCluster {
    ...
    static apiVersion: IVMCluster["apiVersion"];
    static kind: IVMCluster["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVMCluster>;
