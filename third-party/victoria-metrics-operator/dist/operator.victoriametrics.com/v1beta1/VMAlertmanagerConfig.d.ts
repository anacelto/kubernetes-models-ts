 ...
 * VMAlertmanagerConfig is the Schema for the vmalertmanagerconfigs API
 */
export declare class VMAlertmanagerConfig extends Model<IVMAlertmanagerConfig> implements IVMAlertmanagerConfig {
    ...
    static apiVersion: IVMAlertmanagerConfig["apiVersion"];
    static kind: IVMAlertmanagerConfig["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVMAlertmanagerConfig>;
