...
export const validate = validate86;
const schema36 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "AhHpOw5DXD2LKPQX8ibfxgIcpCliTNffXVSMCsuXFI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Yw5TydGguT0EKxFGVKTk7Czn0yG2vD3wqcTIOi0S8"
    },
    "status": {
      "$ref": "ZRh4ktzqDWwNeXC6hPHBBL1dvYcUzPG2QsKHWqpllgg"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "operator.victoriametrics.com.v1beta1.VMAlert"
};
const schema37 = {
  "type": "string",
...
const schema40 = {};
import { validate as validate92 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema41 = {
  "properties": {
    ...
    "datasource": {
      "$ref": "8QDqS3L1uOkLVp1VPulk09nOs1NZCspiqIuqqrma0"
    },
    ...
    "notifier": {
      "$ref": "BF4ygBmRZpqbgtO6kprbpyo5p8NWkLsDcjgnQSnJ6L4"
    },
    "notifierConfigRef": {
      "$ref": "kyPWonKd9RiqYcLV5gZX8H1ko7ZDPDNnaoO3ShQds"
    },
    "notifiers": {
      "$ref": "wmRV5vweI8jU0zEppILPlr6tL8lS4Sc1Q8wndNjmGwQ"
    },
    "paused": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
    ...
    "remoteRead": {
      "$ref": "VMWIoZc95sKeUhjaNm5U3kFPInwhdpYyMWyfHv7q0"
    },
    "remoteWrite": {
      "$ref": "wiDcWwcaiVt3meLe9TjYPwJbydQ7MeFlF1j6YWA"
    },
    "replicaCount": {
      "$ref": "Ccz0XZyNWiwVpe2nvsmnlMV1SnfQGMXuejl0yByE"
    },
...
const schema42 = {
  "properties": {
    ...
    "oauth2": {
      "$ref": "hsboCOGTuZ8y5UNiCTrOSmNeOIAJOCTWm9aIWPtk"
    },
    "tlsConfig": {
      "$ref": "wnCl8zCvz1PLbyEivJTcktRgDZuzOGT9FYulvrA2T8w"
    },
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.password_file !== undefined) {
      if (!validate28(data.password_file, {
...
function validate102(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.bearerTokenFile !== undefined) {
      if (!validate28(data.bearerTokenFile, {
    ...
    if (data.bearerTokenSecret !== undefined) {
      if (!validate29(data.bearerTokenSecret, {
...
const schema55 = {
  "properties": {
    ...
    "selector": {
      "$ref": "i2oN0LODcJVtPWGJaK82UY2gsQts6mwFVjKRM3sM"
    },
    "tlsConfig": {
      "$ref": "wnCl8zCvz1PLbyEivJTcktRgDZuzOGT9FYulvrA2T8w"
    },
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate55(data.matchExpressions, {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.labelSelector !== undefined) {
      if (!validate54(data.labelSelector, {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate64(data.namespaceSelector, {
...
const schema56 = {
  "items": {
    "$ref": "MBzLsx7VFjsrNALXuqwxIHZTuj1fpNmfTtSmToU6GXU"
  },
  "type": "array",
  "nullable": true
};
...
function validate184(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.maxUnavailable !== undefined) {
      if (!validate68(data.maxUnavailable, {
    ...
    if (data.minAvailable !== undefined) {
      if (!validate68(data.minAvailable, {
    ...
    if (data.selectorLabels !== undefined) {
      if (!validate38(data.selectorLabels, {
...
function validate198(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lookback !== undefined) {
      if (!validate28(data.lookback, {
        instancePath: instancePath + "/lookback",
        parentData: data,
        parentDataProperty: "lookback",
        rootData
      })) {
        vErrors = vErrors === null ? validate28.errors : vErrors.concat(validate28.errors);
        errors = vErrors.length;
...
function validate208(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.concurrency !== undefined) {
      if (!validate71(data.concurrency, {
    ...
    if (data.flushInterval !== undefined) {
      if (!validate72(data.flushInterval, {
    ...
    if (data.maxBatchSize !== undefined) {
      if (!validate71(data.maxBatchSize, {
        instancePath: instancePath + "/maxBatchSize",
        parentData: data,
        parentDataProperty: "maxBatchSize",
        rootData
      })) {
        vErrors = vErrors === null ? validate71.errors : vErrors.concat(validate71.errors);
        errors = vErrors.length;
    ...
    if (data.maxQueueSize !== undefined) {
      if (!validate71(data.maxQueueSize, {
        instancePath: instancePath + "/maxQueueSize",
        parentData: data,
        parentDataProperty: "maxQueueSize",
        rootData
      })) {
        vErrors = vErrors === null ? validate71.errors : vErrors.concat(validate71.errors);
        errors = vErrors.length;
...
function validate239(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.useAsDefault !== undefined) {
      if (!validate33(data.useAsDefault, {
...
function validate248(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tolerationSeconds !== undefined) {
      if (!validate85(data.tolerationSeconds, {
...
function validate95(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.configReloaderExtraArgs !== undefined) {
      if (!validate38(data.configReloaderExtraArgs, {
    ...
    if (data.configReloaderResources !== undefined) {
      if (!validate73(data.configReloaderResources, {
    ...
    if (data.datasource !== undefined) {
      if (!validate102(data.datasource, {
    ...
    if (data.disableSelfServiceScrape !== undefined) {
      if (!validate33(data.disableSelfServiceScrape, {
    ...
    if (data.enforcedNamespaceLabel !== undefined) {
      if (!validate28(data.enforcedNamespaceLabel, {
    ...
    if (data.evaluationInterval !== undefined) {
      if (!validate72(data.evaluationInterval, {
    ...
    if (data.externalLabels !== undefined) {
      if (!validate38(data.externalLabels, {
    ...
    if (data.host_aliases !== undefined) {
      if (!validate40(data.host_aliases, {
    ...
    if (data.hostAliases !== undefined) {
      if (!validate40(data.hostAliases, {
    ...
    if (data.hostNetwork !== undefined) {
      if (!validate33(data.hostNetwork, {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate143(data.imagePullSecrets, {
    ...
    if (data.initContainers !== undefined) {
      if (!validate45(data.initContainers, {
    ...
    if (data.livenessProbe !== undefined) {
      if (!validate37(data.livenessProbe, {
    ...
    if (data.minReadySeconds !== undefined) {
      if (!validate71(data.minReadySeconds, {
    ...
    if (data.notifier !== undefined) {
      if (!validate160(data.notifier, {
        instancePath: instancePath + "/notifier",
        parentData: data,
        parentDataProperty: "notifier",
        rootData
      })) {
    ...
    if (data.notifierConfigRef !== undefined) {
      if (!validate29(data.notifierConfigRef, {
        instancePath: instancePath + "/notifierConfigRef",
        parentData: data,
        parentDataProperty: "notifierConfigRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate29.errors : vErrors.concat(validate29.errors);
        errors = vErrors.length;
    ...
    if (data.notifiers !== undefined) {
      if (!validate171(data.notifiers, {
        instancePath: instancePath + "/notifiers",
        parentData: data,
        parentDataProperty: "notifiers",
        rootData
      })) {
    ...
    if (data.podDisruptionBudget !== undefined) {
      if (!validate184(data.podDisruptionBudget, {
    ...
    if (data.podMetadata !== undefined) {
      if (!validate81(data.podMetadata, {
    ...
    if (data.readinessGates !== undefined) {
      if (!validate192(data.readinessGates, {
    ...
    if (data.readinessProbe !== undefined) {
      if (!validate37(data.readinessProbe, {
    ...
    if (data.remoteRead !== undefined) {
      if (!validate198(data.remoteRead, {
    ...
    if (data.remoteWrite !== undefined) {
      if (!validate208(data.remoteWrite, {
    ...
    if (data.replicaCount !== undefined) {
      if (!validate71(data.replicaCount, {
    ...
    if (data.revisionHistoryLimitCount !== undefined) {
      if (!validate71(data.revisionHistoryLimitCount, {
    ...
    if (data.rollingUpdate !== undefined) {
      if (!validate224(data.rollingUpdate, {
    ...
    if (data.ruleNamespaceSelector !== undefined) {
      if (!validate54(data.ruleNamespaceSelector, {
    ...
    if (data.rulePath !== undefined) {
      if (!validate35(data.rulePath, {
        instancePath: instancePath + "/rulePath",
        parentData: data,
        parentDataProperty: "rulePath",
        rootData
      })) {
        vErrors = vErrors === null ? validate35.errors : vErrors.concat(validate35.errors);
        errors = vErrors.length;
    ...
    if (data.ruleSelector !== undefined) {
      if (!validate54(data.ruleSelector, {
    ...
    if (data.securityContext !== undefined) {
      if (!validate37(data.securityContext, {
    ...
    if (data.selectAllByDefault !== undefined) {
      if (!validate33(data.selectAllByDefault, {
    ...
    if (data.serviceScrapeSpec !== undefined) {
      if (!validate237(data.serviceScrapeSpec, {
    ...
    if (data.serviceSpec !== undefined) {
      if (!validate239(data.serviceSpec, {
    ...
    if (data.startupProbe !== undefined) {
      if (!validate37(data.startupProbe, {
    ...
    if (data.terminationGracePeriodSeconds !== undefined) {
      if (!validate85(data.terminationGracePeriodSeconds, {
    ...
    if (data.updateStrategy !== undefined) {
      if (!validate260(data.updateStrategy, {
    ...
    if (data.useDefaultResources !== undefined) {
      if (!validate33(data.useDefaultResources, {
    ...
    if (data.useStrictSecurity !== undefined) {
      if (!validate33(data.useStrictSecurity, {
    ...
    if (data.useVMConfigReloader !== undefined) {
      if (!validate33(data.useVMConfigReloader, {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate265(data.volumeMounts, {
...
function validate278(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.availableReplicas !== undefined) {
      if (!validate71(data.availableReplicas, {
    ...
    if (data.unavailableReplicas !== undefined) {
      if (!validate71(data.unavailableReplicas, {
    ...
    if (data.updatedReplicas !== undefined) {
      if (!validate71(data.updatedReplicas, {
...
function validate86(data, {
  ...
  /*# sourceURL="operator.victoriametrics.com.v1beta1.VMAlert" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
