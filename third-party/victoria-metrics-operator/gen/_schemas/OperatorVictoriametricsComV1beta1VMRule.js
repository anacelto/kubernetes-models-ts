...
const schema12 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "sJhXP6HffJket0myMcAkYcICGVlimVdQqP8IJlrDyyI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "flkzbXvIU6DBV64pbgd7LAZMZb0xHFA5W8jV0jyc"
    },
    "status": {
  ...
  "$id": "operator.victoriametrics.com.v1beta1.VMRule"
};
const schema13 = {
  "type": "string",
...
const schema17 = {
  "properties": {
    "groups": {
      "$ref": "abydVgptPUIClqsunxG33jMUfSg0DbMgc7bSceN0"
    }
  },
  "required": ["groups"],
  "type": "object"
...
const schema18 = {
  "items": {
    "$ref": "ga7PjvQwllmI3pO5HZJ81nXS9dmaMXxx1doMLkECP8w"
  },
  "type": "array"
};
const schema19 = {
  "properties": {
    ...
    "rules": {
      "$ref": "LwqVtGYFEYOCPyZPh5Kw6yHg1hH5RwnPagD0jkRX1jM"
    },
    "tenant": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema22 = {
  "items": {
    "$ref": "J53kN5g0wXaEjXFlhFvRFqo5cOLxmuBenHCJ8NSQ"
  },
  "type": "array"
};
const schema23 = {
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.keep_firing_for !== undefined) {
      if (!validate21(data.keep_firing_for, {
        instancePath: instancePath + "/keep_firing_for",
        parentData: data,
        parentDataProperty: "keep_firing_for",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.update_entries_limit !== undefined) {
      if (!validate25(data.update_entries_limit, {
        instancePath: instancePath + "/update_entries_limit",
        parentData: data,
        parentDataProperty: "update_entries_limit",
        rootData
      })) {
...
function validate40(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.concurrency !== undefined) {
      if (!validate25(data.concurrency, {
    ...
    if (data.eval_alignment !== undefined) {
      if (!validate28(data.eval_alignment, {
        instancePath: instancePath + "/eval_alignment",
        parentData: data,
        parentDataProperty: "eval_alignment",
        rootData
      })) {
        vErrors = vErrors === null ? validate28.errors : vErrors.concat(validate28.errors);
        errors = vErrors.length;
    ...
    if (data.eval_delay !== undefined) {
      if (!validate21(data.eval_delay, {
        instancePath: instancePath + "/eval_delay",
        parentData: data,
        parentDataProperty: "eval_delay",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.eval_offset !== undefined) {
      if (!validate21(data.eval_offset, {
        instancePath: instancePath + "/eval_offset",
        parentData: data,
        parentDataProperty: "eval_offset",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.extra_filter_labels !== undefined) {
      if (!validate23(data.extra_filter_labels, {
        instancePath: instancePath + "/extra_filter_labels",
        parentData: data,
        parentDataProperty: "extra_filter_labels",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.notifier_headers !== undefined) {
      if (!validate26(data.notifier_headers, {
        instancePath: instancePath + "/notifier_headers",
        parentData: data,
        parentDataProperty: "notifier_headers",
        rootData
      })) {
        vErrors = vErrors === null ? validate26.errors : vErrors.concat(validate26.errors);
        errors = vErrors.length;
...
function validate29(data, {
  ...
  /*# sourceURL="operator.victoriametrics.com.v1beta1.VMRule" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
