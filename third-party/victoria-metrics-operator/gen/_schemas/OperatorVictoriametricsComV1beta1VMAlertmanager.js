...
export const validate = validate133;
const schema43 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "tES2QpsmnCxDK6hZXnmFOkRvseu2TU3RzhNYw5ncc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "qY1cH6mmVbB3VH8a5L3YZlysigDsVBsRc4gOWIZ2XI"
    },
    "status": {
      "$ref": "gSD54soDvICNOfWwJdZOxlO7XaIZG8oyZdK3yk8"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "operator.victoriametrics.com.v1beta1.VMAlertmanager"
};
const schema44 = {
  "type": "string",
...
const schema47 = {};
import { validate as validate139 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema48 = {
  "properties": {
    ...
    "gossipConfig": {
      "$ref": "sRvCSTlY1C9NfYT6dSrUTPrxDgu6u7Ny5tLUSn1wTw"
    },
    "host_aliases": {
    ...
    "logFormat": {
      "$ref": "G9QO1fG0n2yDvXPHrXrXxbsBESh0uz8Lk5UwaoTkYU"
    },
    "logLevel": {
      "$ref": "G673zssQWTH8fUBzxRAdTmAFO1Rmr1XXggnKh5LUBY"
    },
    "minReadySeconds": {
    ...
    "templates": {
      "$ref": "plfiKz8vvOv0cK70INhcb6zi7BsvowerrPNB59u5jIs"
    },
    ...
    "webConfig": {
      "$ref": "B941r50XITSO4ZkmIw2ychxGyw45A7qdNzG4vZLuaw"
    }
  },
  "type": "object"
};
...
function validate75(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataSourceRef !== undefined) {
      if (!validate82(data.dataSourceRef, {
...
function validate103(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastProbeTime !== undefined) {
      if (!validate34(data.lastProbeTime, {
...
function validate97(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allocatedResourceStatuses !== undefined) {
      if (!validate32(data.allocatedResourceStatuses, {
    ...
    if (data.conditions !== undefined) {
      if (!validate102(data.conditions, {
    ...
    if (data.modifyVolumeStatus !== undefined) {
      if (!validate113(data.modifyVolumeStatus, {
...
function validate168(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nameservers !== undefined) {
      if (!validate23(data.nameservers, {
...
const schema57 = {
  "properties": {
    "tls_client_config": {
      "$ref": "6BgtdViHrEF1ircWNVBy1E4jCK1t2tMC22kFeHHgsA"
    },
    "tls_server_config": {
      "$ref": "CYxLcR1WJW5P8bPuNUVGzQVHCDPxUTctnEkFkqMDIg"
    }
  },
  "type": "object",
  "nullable": true
...
function validate191(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ca_file !== undefined) {
      if (!validate21(data.ca_file, {
        instancePath: instancePath + "/ca_file",
        parentData: data,
        parentDataProperty: "ca_file",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.ca_secret_ref !== undefined) {
      if (!validate45(data.ca_secret_ref, {
        instancePath: instancePath + "/ca_secret_ref",
        parentData: data,
        parentDataProperty: "ca_secret_ref",
        rootData
      })) {
    ...
    if (data.cert_secret_ref !== undefined) {
      if (!validate45(data.cert_secret_ref, {
        instancePath: instancePath + "/cert_secret_ref",
        parentData: data,
        parentDataProperty: "cert_secret_ref",
        rootData
      })) {
        vErrors = vErrors === null ? validate45.errors : vErrors.concat(validate45.errors);
        errors = vErrors.length;
    ...
    if (data.insecure_skip_verify !== undefined) {
      if (!validate44(data.insecure_skip_verify, {
        instancePath: instancePath + "/insecure_skip_verify",
        parentData: data,
        parentDataProperty: "insecure_skip_verify",
        rootData
      })) {
        vErrors = vErrors === null ? validate44.errors : vErrors.concat(validate44.errors);
        errors = vErrors.length;
    ...
    if (data.key_secret_ref !== undefined) {
      if (!validate45(data.key_secret_ref, {
        instancePath: instancePath + "/key_secret_ref",
        parentData: data,
        parentDataProperty: "key_secret_ref",
        rootData
      })) {
        vErrors = vErrors === null ? validate45.errors : vErrors.concat(validate45.errors);
        errors = vErrors.length;
    ...
    if (data.server_name !== undefined) {
      if (!validate21(data.server_name, {
        instancePath: instancePath + "/server_name",
        parentData: data,
        parentDataProperty: "server_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema41 = {
  "properties": {
    ...
    "client_auth_type": {
      "$ref": "wXFJgOM72vG18UXuGBRyVqJ3htgVRdbokneV3sJU"
    },
    "client_ca_file": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    ...
    "max_version": {
      "$ref": "qQSaBcjVnFSWgNvUp3CYLe1Mkso6ArraFxd4wWKvQUY"
    },
    "min_version": {
      "$ref": "qQSaBcjVnFSWgNvUp3CYLe1Mkso6ArraFxd4wWKvQUY"
    },
...
const schema42 = {
  "enum": ["NoClientCert", "RequireAndVerifyClientCert"],
  "type": "string",
  "nullable": true
};
function validate123(data, {
  ...
  if (!(data === "NoClientCert" || data === "RequireAndVerifyClientCert")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate50(data, {
  ...
  if (!(data === "TLS10" || data === "TLS11" || data === "TLS12" || data === "TLS13")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate119(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cipher_suites !== undefined) {
      if (!validate23(data.cipher_suites, {
        instancePath: instancePath + "/cipher_suites",
        parentData: data,
        parentDataProperty: "cipher_suites",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.client_auth_type !== undefined) {
      if (!validate123(data.client_auth_type, {
        instancePath: instancePath + "/client_auth_type",
        parentData: data,
        parentDataProperty: "client_auth_type",
        rootData
      })) {
    ...
    if (data.client_ca_file !== undefined) {
      if (!validate21(data.client_ca_file, {
        instancePath: instancePath + "/client_ca_file",
        parentData: data,
        parentDataProperty: "client_ca_file",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.client_ca_secret_ref !== undefined) {
      if (!validate45(data.client_ca_secret_ref, {
        instancePath: instancePath + "/client_ca_secret_ref",
        parentData: data,
        parentDataProperty: "client_ca_secret_ref",
        rootData
      })) {
        vErrors = vErrors === null ? validate45.errors : vErrors.concat(validate45.errors);
        errors = vErrors.length;
    ...
    if (data.curve_preferences !== undefined) {
      if (!validate23(data.curve_preferences, {
        instancePath: instancePath + "/curve_preferences",
        parentData: data,
        parentDataProperty: "curve_preferences",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.max_version !== undefined) {
      if (!validate50(data.max_version, {
        instancePath: instancePath + "/max_version",
        parentData: data,
        parentDataProperty: "max_version",
        rootData
      })) {
    ...
    if (data.min_version !== undefined) {
      if (!validate50(data.min_version, {
        instancePath: instancePath + "/min_version",
        parentData: data,
        parentDataProperty: "min_version",
        rootData
      })) {
        vErrors = vErrors === null ? validate50.errors : vErrors.concat(validate50.errors);
        errors = vErrors.length;
    ...
    if (data.prefer_server_cipher_suites !== undefined) {
      if (!validate44(data.prefer_server_cipher_suites, {
        instancePath: instancePath + "/prefer_server_cipher_suites",
        parentData: data,
        parentDataProperty: "prefer_server_cipher_suites",
        rootData
      })) {
        vErrors = vErrors === null ? validate44.errors : vErrors.concat(validate44.errors);
        errors = vErrors.length;
...
function validate190(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.tls_client_config !== undefined) {
      if (!validate191(data.tls_client_config, {
        instancePath: instancePath + "/tls_client_config",
        parentData: data,
        parentDataProperty: "tls_client_config",
        rootData
      })) {
    ...
    if (data.tls_server_config !== undefined) {
      if (!validate119(data.tls_server_config, {
        instancePath: instancePath + "/tls_server_config",
        parentData: data,
        parentDataProperty: "tls_server_config",
        rootData
      })) {
...
function validate221(data, {
  ...
  if (!(data === "debug" || data === "info" || data === "warn" || data === "error" || data === "DEBUG" || data === "INFO" || data === "WARN" || data === "ERROR")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate226(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.maxUnavailable !== undefined) {
      if (!validate59(data.maxUnavailable, {
    ...
    if (data.minAvailable !== undefined) {
      if (!validate59(data.minAvailable, {
    ...
    if (data.selectorLabels !== undefined) {
      if (!validate32(data.selectorLabels, {
...
function validate256(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.useAsDefault !== undefined) {
      if (!validate44(data.useAsDefault, {
...
function validate263(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.disableMountSubPath !== undefined) {
      if (!validate44(data.disableMountSubPath, {
    ...
    if (data.volumeClaimTemplate !== undefined) {
      if (!validate269(data.volumeClaimTemplate, {
...
const schema74 = {
  "items": {
    "$ref": "SoVVGECNJb7K8LcTsMWOYJLeOsc3HkYvvlPacEA"
  },
  "type": "array",
  "nullable": true
};
...
function validate285(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tolerationSeconds !== undefined) {
      if (!validate118(data.tolerationSeconds, {
...
const schema82 = {
  "properties": {
    ...
    "http_server_config": {
      "$ref": "cjPEtkMDkjmE5iUkBaypoazj3HM1urrxbcdXUdZcTk4"
    },
    "tls_server_config": {
      "$ref": "CYxLcR1WJW5P8bPuNUVGzQVHCDPxUTctnEkFkqMDIg"
    }
...
function validate312(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.basic_auth_users !== undefined) {
      if (!validate32(data.basic_auth_users, {
        instancePath: instancePath + "/basic_auth_users",
        parentData: data,
        parentDataProperty: "basic_auth_users",
        rootData
      })) {
        vErrors = vErrors === null ? validate32.errors : vErrors.concat(validate32.errors);
        errors = vErrors.length;
    ...
    if (data.http_server_config !== undefined) {
      if (!validate314(data.http_server_config, {
        instancePath: instancePath + "/http_server_config",
        parentData: data,
        parentDataProperty: "http_server_config",
        rootData
      })) {
...
function validate142(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.additionalPeers !== undefined) {
      if (!validate23(data.additionalPeers, {
    ...
    if (data.claimTemplates !== undefined) {
      if (!validate145(data.claimTemplates, {
    ...
    if (data.clusterAdvertiseAddress !== undefined) {
      if (!validate21(data.clusterAdvertiseAddress, {
    ...
    if (data.configNamespaceSelector !== undefined) {
      if (!validate35(data.configNamespaceSelector, {
        instancePath: instancePath + "/configNamespaceSelector",
        parentData: data,
        parentDataProperty: "configNamespaceSelector",
        rootData
      })) {
        vErrors = vErrors === null ? validate35.errors : vErrors.concat(validate35.errors);
        errors = vErrors.length;
    ...
    if (data.configRawYaml !== undefined) {
      if (!validate21(data.configRawYaml, {
        instancePath: instancePath + "/configRawYaml",
        parentData: data,
        parentDataProperty: "configRawYaml",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.configReloaderExtraArgs !== undefined) {
      if (!validate32(data.configReloaderExtraArgs, {
    ...
    if (data.configReloaderResources !== undefined) {
      if (!validate63(data.configReloaderResources, {
    ...
    if (data.configSelector !== undefined) {
      if (!validate35(data.configSelector, {
        instancePath: instancePath + "/configSelector",
        parentData: data,
        parentDataProperty: "configSelector",
        rootData
      })) {
        vErrors = vErrors === null ? validate35.errors : vErrors.concat(validate35.errors);
        errors = vErrors.length;
    ...
    if (data.disableNamespaceMatcher !== undefined) {
      if (!validate44(data.disableNamespaceMatcher, {
        instancePath: instancePath + "/disableNamespaceMatcher",
        parentData: data,
        parentDataProperty: "disableNamespaceMatcher",
        rootData
      })) {
        vErrors = vErrors === null ? validate44.errors : vErrors.concat(validate44.errors);
        errors = vErrors.length;
    ...
    if (data.disableRouteContinueEnforce !== undefined) {
      if (!validate44(data.disableRouteContinueEnforce, {
        instancePath: instancePath + "/disableRouteContinueEnforce",
        parentData: data,
        parentDataProperty: "disableRouteContinueEnforce",
        rootData
      })) {
        vErrors = vErrors === null ? validate44.errors : vErrors.concat(validate44.errors);
        errors = vErrors.length;
    ...
    if (data.disableSelfServiceScrape !== undefined) {
      if (!validate44(data.disableSelfServiceScrape, {
    ...
    if (data.enforcedTopRouteMatchers !== undefined) {
      if (!validate23(data.enforcedTopRouteMatchers, {
        instancePath: instancePath + "/enforcedTopRouteMatchers",
        parentData: data,
        parentDataProperty: "enforcedTopRouteMatchers",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.externalURL !== undefined) {
      if (!validate21(data.externalURL, {
    ...
    if (data.gossipConfig !== undefined) {
      if (!validate190(data.gossipConfig, {
        instancePath: instancePath + "/gossipConfig",
        parentData: data,
        parentDataProperty: "gossipConfig",
        rootData
      })) {
    ...
    if (data.host_aliases !== undefined) {
      if (!validate51(data.host_aliases, {
    ...
    if (data.hostAliases !== undefined) {
      if (!validate51(data.hostAliases, {
    ...
    if (data.hostNetwork !== undefined) {
      if (!validate44(data.hostNetwork, {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate211(data.imagePullSecrets, {
    ...
    if (data.initContainers !== undefined) {
      if (!validate56(data.initContainers, {
    ...
    if (data.listenLocal !== undefined) {
      if (!validate44(data.listenLocal, {
    ...
    if (data.livenessProbe !== undefined) {
      if (!validate22(data.livenessProbe, {
    ...
    if (data.minReadySeconds !== undefined) {
      if (!validate62(data.minReadySeconds, {
    ...
    if (data.podDisruptionBudget !== undefined) {
      if (!validate226(data.podDisruptionBudget, {
    ...
    if (data.podMetadata !== undefined) {
      if (!validate71(data.podMetadata, {
    ...
    if (data.readinessGates !== undefined) {
      if (!validate235(data.readinessGates, {
    ...
    if (data.readinessProbe !== undefined) {
      if (!validate22(data.readinessProbe, {
    ...
    if (data.replicaCount !== undefined) {
      if (!validate62(data.replicaCount, {
    ...
    if (data.revisionHistoryLimitCount !== undefined) {
      if (!validate62(data.revisionHistoryLimitCount, {
    ...
    if (data.routePrefix !== undefined) {
      if (!validate21(data.routePrefix, {
    ...
    if (data.securityContext !== undefined) {
      if (!validate22(data.securityContext, {
    ...
    if (data.selectAllByDefault !== undefined) {
      if (!validate44(data.selectAllByDefault, {
    ...
    if (data.serviceScrapeSpec !== undefined) {
      if (!validate254(data.serviceScrapeSpec, {
    ...
    if (data.serviceSpec !== undefined) {
      if (!validate256(data.serviceSpec, {
    ...
    if (data.startupProbe !== undefined) {
      if (!validate22(data.startupProbe, {
    ...
    if (data.terminationGracePeriodSeconds !== undefined) {
      if (!validate118(data.terminationGracePeriodSeconds, {
    ...
    if (data.tolerations !== undefined) {
      if (!validate284(data.tolerations, {
    ...
    if (data.topologySpreadConstraints !== undefined) {
      if (!validate293(data.topologySpreadConstraints, {
    ...
    if (data.useDefaultResources !== undefined) {
      if (!validate44(data.useDefaultResources, {
    ...
    if (data.useStrictSecurity !== undefined) {
      if (!validate44(data.useStrictSecurity, {
    ...
    if (data.useVMConfigReloader !== undefined) {
      if (!validate44(data.useVMConfigReloader, {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate300(data.volumeMounts, {
    ...
    if (data.webConfig !== undefined) {
      if (!validate312(data.webConfig, {
        instancePath: instancePath + "/webConfig",
        parentData: data,
        parentDataProperty: "webConfig",
        rootData
      })) {
...
function validate133(data, {
  ...
  /*# sourceURL="operator.victoriametrics.com.v1beta1.VMAlertmanager" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.spec === undefined) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate134(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
