...
const schema21 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "zgQaX8csAfI2H591b3vmzWGNgnyDxxbzJQIc6v8tQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AeoIo80PrPePFuv7g9WNqLm7NiMbymVyrvq44p1es"
    },
    "status": {
  ...
  "$id": "operator.victoriametrics.com.v1beta1.VMServiceScrape"
};
const schema22 = {
  "type": "string",
...
const schema26 = {
  "properties": {
    ...
    "discoveryRole": {
      "$ref": "uBK93EPPpvbKuARpTe0eHlfenfu5gXeGJMCJMOyYMT0"
    },
    "endpoints": {
      "$ref": "QjV8YRtpaXhWCO2xm1Sbte0yV7A8RNeDtNytTyS7j0"
    },
    "jobLabel": {
...
const schema27 = {
  "enum": ["endpoints", "service", "endpointslices"],
  "type": "string",
  "nullable": true
};
function validate79(data, {
  ...
  if (!(data === "endpoints" || data === "service" || data === "endpointslices")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema28 = {
  "items": {
    "$ref": "zOsnX16ZjPHYll7ulmJXui5PZdiVlTgb9v3vwQPhko0"
  },
  "type": "array"
};
const schema29 = {
...
function validate136(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.bearer_token !== undefined) {
      if (!validate25(data.bearer_token, {
...
function validate131(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.disable_compression !== undefined) {
      if (!validate22(data.disable_compression, {
    ...
    if (data.disable_keep_alive !== undefined) {
      if (!validate22(data.disable_keep_alive, {
    ...
    if (data.no_stale_markers !== undefined) {
      if (!validate22(data.no_stale_markers, {
    ...
    if (data.proxy_client_config !== undefined) {
      if (!validate136(data.proxy_client_config, {
    ...
    if (data.scrape_align_interval !== undefined) {
      if (!validate24(data.scrape_align_interval, {
    ...
    if (data.scrape_offset !== undefined) {
      if (!validate24(data.scrape_offset, {
    ...
    if (data.stream_parse !== undefined) {
      if (!validate22(data.stream_parse, {
...
function validate82(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.attach_metadata !== undefined) {
      if (!validate21(data.attach_metadata, {
    ...
    if (data.authorization !== undefined) {
      if (!validate84(data.authorization, {
    ...
    if (data.follow_redirects !== undefined) {
      if (!validate22(data.follow_redirects, {
    ...
    if (data.max_scrape_size !== undefined) {
      if (!validate24(data.max_scrape_size, {
    ...
    if (data.scrape_interval !== undefined) {
      if (!validate24(data.scrape_interval, {
    ...
    if (data.scrapeTimeout !== undefined) {
      if (!validate24(data.scrapeTimeout, {
    ...
    if (data.targetPort !== undefined) {
      if (!validate125(data.targetPort, {
    ...
    if (data.vm_scrape_params !== undefined) {
      if (!validate131(data.vm_scrape_params, {
...
function validate155(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate156(data.matchExpressions, {
...
function validate77(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.discoveryRole !== undefined) {
      if (!validate79(data.discoveryRole, {
        instancePath: instancePath + "/discoveryRole",
        parentData: data,
        parentDataProperty: "discoveryRole",
        rootData
      })) {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate149(data.namespaceSelector, {
    ...
    if (data.targetLabels !== undefined) {
      if (!validate32(data.targetLabels, {
...
function validate68(data, {
  ...
  /*# sourceURL="operator.victoriametrics.com.v1beta1.VMServiceScrape" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
