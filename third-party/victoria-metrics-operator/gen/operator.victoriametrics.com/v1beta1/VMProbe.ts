...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMProbe";
 ...
 * It helps to monitor reachability of target with various checks.
 */
export class VMProbe extends Model<IVMProbe> implements IVMProbe {
...
static apiVersion: IVMProbe["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMProbe["kind"] = "VMProbe";
static is = createTypeMetaGuard<IVMProbe>(VMProbe);

constructor(data?: ModelData<IVMProbe>) {
  super();

  this.setDefinedProps({
    apiVersion: VMProbe.apiVersion,
    kind: VMProbe.kind,
    ...data
  } as IVMProbe);
}
...
setValidateFunc(VMProbe, validate as ValidateFunc<IVMProbe>);
