...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMPodScrape";
 ...
 * based on selectors.
 */
export class VMPodScrape extends Model<IVMPodScrape> implements IVMPodScrape {
  "apiVersion": IVMPodScrape["apiVersion"];
  "kind": IVMPodScrape["kind"];
  "metadata"?: IVMPodScrape["metadata"];
  "spec"?: IVMPodScrape["spec"];
  "status"?: IVMPodScrape["status"];

static apiVersion: IVMPodScrape["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMPodScrape["kind"] = "VMPodScrape";
static is = createTypeMetaGuard<IVMPodScrape>(VMPodScrape);

constructor(data?: ModelData<IVMPodScrape>) {
  super();

  this.setDefinedProps({
    apiVersion: VMPodScrape.apiVersion,
    kind: VMPodScrape.kind,
    ...data
  } as IVMPodScrape);
}
}
...
setValidateFunc(VMPodScrape, validate as ValidateFunc<IVMPodScrape>);
