...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMNodeScrape";
 ...
 */
export interface IVMNodeScrape {
  /**
 ...
 * InternalIP is used as __address__ for scraping.
 */
export class VMNodeScrape extends Model<IVMNodeScrape> implements IVMNodeScrape {
  "apiVersion": IVMNodeScrape["apiVersion"];
  "kind": IVMNodeScrape["kind"];
  "metadata"?: IVMNodeScrape["metadata"];
  "spec"?: IVMNodeScrape["spec"];
  "status"?: IVMNodeScrape["status"];

static apiVersion: IVMNodeScrape["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMNodeScrape["kind"] = "VMNodeScrape";
static is = createTypeMetaGuard<IVMNodeScrape>(VMNodeScrape);

constructor(data?: ModelData<IVMNodeScrape>) {
  super();

  this.setDefinedProps({
    apiVersion: VMNodeScrape.apiVersion,
    kind: VMNodeScrape.kind,
    ...data
  } as IVMNodeScrape);
}
}
...
setValidateFunc(VMNodeScrape, validate as ValidateFunc<IVMNodeScrape>);
