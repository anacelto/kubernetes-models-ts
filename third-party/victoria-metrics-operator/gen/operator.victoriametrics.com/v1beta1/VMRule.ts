...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMRule";
 ...
 * VMRule defines rule records for vmalert application
 */
export class VMRule extends Model<IVMRule> implements IVMRule {
...
static apiVersion: IVMRule["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMRule["kind"] = "VMRule";
static is = createTypeMetaGuard<IVMRule>(VMRule);

constructor(data?: ModelData<IVMRule>) {
  super();

  this.setDefinedProps({
    apiVersion: VMRule.apiVersion,
    kind: VMRule.kind,
    ...data
  } as IVMRule);
}
...
setValidateFunc(VMRule, validate as ValidateFunc<IVMRule>);
