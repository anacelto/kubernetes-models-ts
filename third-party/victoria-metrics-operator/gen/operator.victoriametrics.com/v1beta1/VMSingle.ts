...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMSingle";
 ...
 * VMSingle  is fast, cost-effective and scalable time-series database.
 */
export class VMSingle extends Model<IVMSingle> implements IVMSingle {
...
static apiVersion: IVMSingle["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMSingle["kind"] = "VMSingle";
static is = createTypeMetaGuard<IVMSingle>(VMSingle);

constructor(data?: ModelData<IVMSingle>) {
  super();

  this.setDefinedProps({
    apiVersion: VMSingle.apiVersion,
    kind: VMSingle.kind,
    ...data
  } as IVMSingle);
}
...
setValidateFunc(VMSingle, validate as ValidateFunc<IVMSingle>);
