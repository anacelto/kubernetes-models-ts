...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMAlert";
 ...
 * VMAlert  executes a list of given alerting or recording rules against configured address.
 */
export class VMAlert extends Model<IVMAlert> implements IVMAlert {
...
static apiVersion: IVMAlert["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMAlert["kind"] = "VMAlert";
static is = createTypeMetaGuard<IVMAlert>(VMAlert);

constructor(data?: ModelData<IVMAlert>) {
  super();

  this.setDefinedProps({
    apiVersion: VMAlert.apiVersion,
    kind: VMAlert.kind,
    ...data
  } as IVMAlert);
}
...
setValidateFunc(VMAlert, validate as ValidateFunc<IVMAlert>);
