...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMAlertmanager";
 ...
 * VMAlertmanager represents Victoria-Metrics deployment for Alertmanager.
 */
export class VMAlertmanager extends Model<IVMAlertmanager> implements IVMAlertmanager {
...
static apiVersion: IVMAlertmanager["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMAlertmanager["kind"] = "VMAlertmanager";
static is = createTypeMetaGuard<IVMAlertmanager>(VMAlertmanager);

constructor(data?: ModelData<IVMAlertmanager>) {
  super();

  this.setDefinedProps({
    apiVersion: VMAlertmanager.apiVersion,
    kind: VMAlertmanager.kind,
    ...data
  } as IVMAlertmanager);
}
}
...
setValidateFunc(VMAlertmanager, validate as ValidateFunc<IVMAlertmanager>);
