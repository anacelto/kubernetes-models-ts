...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMUser";
 ...
 * VMUser is the Schema for the vmusers API
 */
export class VMUser extends Model<IVMUser> implements IVMUser {
...
static apiVersion: IVMUser["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMUser["kind"] = "VMUser";
static is = createTypeMetaGuard<IVMUser>(VMUser);

constructor(data?: ModelData<IVMUser>) {
  super();

  this.setDefinedProps({
    apiVersion: VMUser.apiVersion,
    kind: VMUser.kind,
    ...data
  } as IVMUser);
}
...
setValidateFunc(VMUser, validate as ValidateFunc<IVMUser>);
