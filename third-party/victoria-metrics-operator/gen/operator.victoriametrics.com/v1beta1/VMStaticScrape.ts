...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMStaticScrape";
 ...
 * VMStaticScrape  defines static targets configuration for scraping.
 */
export class VMStaticScrape extends Model<IVMStaticScrape> implements IVMStaticScrape {
...
static apiVersion: IVMStaticScrape["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMStaticScrape["kind"] = "VMStaticScrape";
static is = createTypeMetaGuard<IVMStaticScrape>(VMStaticScrape);

constructor(data?: ModelData<IVMStaticScrape>) {
  super();

  this.setDefinedProps({
    apiVersion: VMStaticScrape.apiVersion,
    kind: VMStaticScrape.kind,
    ...data
  } as IVMStaticScrape);
}
}
...
setValidateFunc(VMStaticScrape, validate as ValidateFunc<IVMStaticScrape>);
