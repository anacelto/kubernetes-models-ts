...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMAuth";
 ...
 * VMAuth is the Schema for the vmauths API
 */
export class VMAuth extends Model<IVMAuth> implements IVMAuth {
...
static apiVersion: IVMAuth["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMAuth["kind"] = "VMAuth";
static is = createTypeMetaGuard<IVMAuth>(VMAuth);

constructor(data?: ModelData<IVMAuth>) {
  super();

  this.setDefinedProps({
    apiVersion: VMAuth.apiVersion,
    kind: VMAuth.kind,
    ...data
  } as IVMAuth);
}
...
setValidateFunc(VMAuth, validate as ValidateFunc<IVMAuth>);
