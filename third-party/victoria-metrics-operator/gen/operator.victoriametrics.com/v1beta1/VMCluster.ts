...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMCluster";

/**
 * VMCluster is fast, cost-effective and scalable time-series database.
 * Cluster version with
 */
export interface IVMCluster {
  /**
  ...
  "spec": {
    ...
    "vmstorage"?: {
       ...
       */
      "maintenanceInsertNodeIDs"?: Array<number>;
      /**
       ...
       */
      "maintenanceSelectNodeIDs"?: Array<number>;
      /**
       * MinReadySeconds defines a minim number os seconds to wait before starting update next pod
       * if previous in healthy state
       * Has no effect for VLogs and VMSingle
 ...
 * Cluster version with
 */
export class VMCluster extends Model<IVMCluster> implements IVMCluster {
  "apiVersion": IVMCluster["apiVersion"];
  "kind": IVMCluster["kind"];
  "metadata"?: IVMCluster["metadata"];
  "spec": IVMCluster["spec"];
  "status"?: IVMCluster["status"];

static apiVersion: IVMCluster["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMCluster["kind"] = "VMCluster";
static is = createTypeMetaGuard<IVMCluster>(VMCluster);

constructor(data?: ModelData<IVMCluster>) {
  super();

  this.setDefinedProps({
    apiVersion: VMCluster.apiVersion,
    kind: VMCluster.kind,
    ...data
  } as IVMCluster);
}
...
setValidateFunc(VMCluster, validate as ValidateFunc<IVMCluster>);
