...
import { validate } from "../../_schemas/OperatorVictoriametricsComV1beta1VMScrapeConfig";
 ...
 * VMScrapeConfig specifies a set of targets and parameters describing how to scrape them.
 */
export class VMScrapeConfig extends Model<IVMScrapeConfig> implements IVMScrapeConfig {
...
static apiVersion: IVMScrapeConfig["apiVersion"] = "operator.victoriametrics.com/v1beta1";
static kind: IVMScrapeConfig["kind"] = "VMScrapeConfig";
static is = createTypeMetaGuard<IVMScrapeConfig>(VMScrapeConfig);

constructor(data?: ModelData<IVMScrapeConfig>) {
  super();

  this.setDefinedProps({
    apiVersion: VMScrapeConfig.apiVersion,
    kind: VMScrapeConfig.kind,
    ...data
  } as IVMScrapeConfig);
}
}
...
setValidateFunc(VMScrapeConfig, validate as ValidateFunc<IVMScrapeConfig>);
