...
import { validate } from "../../_schemas/PackagingCarvelDevV1alpha1PackageInstall";
 ...
 * A Package Install is an actual installation of a package and its underlying resources on a Kubernetes cluster. It is represented in kapp-controller by a PackageInstall CR. A PackageInstall CR must reference a Package CR.
 */
export class PackageInstall extends Model<IPackageInstall> implements IPackageInstall {
...
static apiVersion: IPackageInstall["apiVersion"] = "packaging.carvel.dev/v1alpha1";
static kind: IPackageInstall["kind"] = "PackageInstall";
static is = createTypeMetaGuard<IPackageInstall>(PackageInstall);

constructor(data?: ModelData<IPackageInstall>) {
  super();

  this.setDefinedProps({
    apiVersion: PackageInstall.apiVersion,
    kind: PackageInstall.kind,
    ...data
  } as IPackageInstall);
}
}
...
setValidateFunc(PackageInstall, validate as ValidateFunc<IPackageInstall>);
