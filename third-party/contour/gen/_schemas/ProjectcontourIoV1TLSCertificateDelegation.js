...
const schema13 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "mdVttzOXS9TSFqiqpfh6FyvgKFPdi1GiMCXeShGTB3w"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "oCvx9VSXmQfBwj4XlkiSBGrtlsXddKnqyd4HdzOVEUk"
    },
    "status": {
  ...
  "$id": "projectcontour.io.v1.TLSCertificateDelegation"
};
const schema14 = {
  "type": "string",
...
function validate36(data, {
  ...
  if (!(data === "TLSCertificateDelegation")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema18 = {
  "properties": {
    "delegations": {
      "$ref": "1fWHwsFjgueBaqFzX72BqKrb5UmiXJaiK60N7nLGusQ"
    }
  },
...
const schema19 = {
  "items": {
    "$ref": "3oFo8N9ARv2ROnSNfmkrwIZXUegllR5x0h36RQvMOhs"
  },
  "type": "array"
};
const schema20 = {
  ...
  "required": ["secretName", "targetNamespaces"],
  "type": "object"
};
const schema6 = {
  "type": "string"
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.targetNamespaces === undefined) {
      const err1 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "targetNamespaces"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.targetNamespaces !== undefined) {
      if (!validate46(data.targetNamespaces, {
        instancePath: instancePath + "/targetNamespaces",
        parentData: data,
        parentDataProperty: "targetNamespaces",
        rootData
      })) {
...
function validate42(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.delegations === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "delegations"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.delegations !== undefined) {
      if (!validate43(data.delegations, {
        instancePath: instancePath + "/delegations",
        parentData: data,
        parentDataProperty: "delegations",
        rootData
      })) {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate56(data.lastTransitionTime, {
...
function validate33(data, {
  ...
  /*# sourceURL="projectcontour.io.v1.TLSCertificateDelegation" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
