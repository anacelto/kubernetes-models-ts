...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Py7lF9wdmZzWSoShhc64st6fPojDZJGRINHtbRtmxE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "lwz7knBna91gvFc4sn0vKhD8aP1WV4hNbpDofRsc"
    },
    "status": {
  ...
  "$id": "projectcontour.io.v1alpha1.ExtensionService"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    ...
    "protocol": {
      "$ref": "JlpjmP5YWciE1NwRv6TBsABp5ABaFWycfbvsFsPws4"
    },
    "protocolVersion": {
      "$ref": "yDeNk9RZDT70pFzS4ydVBqPs960byh2jid4T79KOSM"
    },
    "services": {
      "$ref": "EGmyMIiDg0D0eY2ZBL0eSFzFqD1LAHLZkuzKRimI"
    },
    "timeoutPolicy": {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.parameterName !== undefined) {
      if (!validate21(data.parameterName, {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.headerHashOptions !== undefined) {
      if (!validate50(data.headerHashOptions, {
    ...
    if (data.queryParameterHashOptions !== undefined) {
      if (!validate53(data.queryParameterHashOptions, {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.requestHashPolicies !== undefined) {
      if (!validate47(data.requestHashPolicies, {
...
const schema30 = {
  "items": {
    "$ref": "lMAQPRTTtEIcdRjCznkFtVXywFY9btxt7Kjy0GjwfXQ"
  },
  "minItems": 1,
  "type": "array"
};
...
const pattern0 = new RegExp("^(((\\d*(\\.\\d*)?h)|(\\d*(\\.\\d*)?m)|(\\d*(\\.\\d*)?s)|(\\d*(\\.\\d*)?ms)|(\\d*(\\.\\d*)?us)|(\\d*(\\.\\d*)?µs)|(\\d*(\\.\\d*)?ns))+|infinity|infinite)$", "u");
...
function validate75(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.idleConnection !== undefined) {
      if (!validate23(data.idleConnection, {
...
function validate80(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.subjectName !== undefined) {
      if (!validate24(data.subjectName, {
...
function validate45(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.loadBalancerPolicy !== undefined) {
      if (!validate46(data.loadBalancerPolicy, {
    ...
    if (data.protocolVersion !== undefined) {
      if (!validate64(data.protocolVersion, {
        instancePath: instancePath + "/protocolVersion",
        parentData: data,
        parentDataProperty: "protocolVersion",
        rootData
      })) {
    ...
    if (data.timeoutPolicy !== undefined) {
      if (!validate75(data.timeoutPolicy, {
...
function validate36(data, {
  ...
  /*# sourceURL="projectcontour.io.v1alpha1.ExtensionService" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
