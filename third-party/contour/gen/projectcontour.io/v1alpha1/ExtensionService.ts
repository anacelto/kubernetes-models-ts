...
import { validate } from "../../_schemas/ProjectcontourIoV1alpha1ExtensionService";
 ...
 * ExtensionService is the schema for the Contour extension services API. An ExtensionService resource binds a network service to the Contour API so that Contour API features can be implemented by collaborating components.
 */
export class ExtensionService extends Model<IExtensionService> implements IExtensionService {
...
static apiVersion: IExtensionService["apiVersion"] = "projectcontour.io/v1alpha1";
static kind: IExtensionService["kind"] = "ExtensionService";
static is = createTypeMetaGuard<IExtensionService>(ExtensionService);

constructor(data?: ModelData<IExtensionService>) {
  super();

  this.setDefinedProps({
    apiVersion: ExtensionService.apiVersion,
    kind: ExtensionService.kind,
    ...data
...
setValidateFunc(ExtensionService, validate as ValidateFunc<IExtensionService>);
