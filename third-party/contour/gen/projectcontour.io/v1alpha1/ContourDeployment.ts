...
import { validate } from "../../_schemas/ProjectcontourIoV1alpha1ContourDeployment";
 ...
 * ContourDeployment is the schema for a Contour Deployment.
 */
export class ContourDeployment extends Model<IContourDeployment> implements IContourDeployment {
...
static apiVersion: IContourDeployment["apiVersion"] = "projectcontour.io/v1alpha1";
static kind: IContourDeployment["kind"] = "ContourDeployment";
static is = createTypeMetaGuard<IContourDeployment>(ContourDeployment);

constructor(data?: ModelData<IContourDeployment>) {
  super();

  this.setDefinedProps({
    apiVersion: ContourDeployment.apiVersion,
    kind: ContourDeployment.kind,
    ...data
  } as IContourDeployment);
}
}


setValidateFunc(ContourDeployment, validate as ValidateFunc<IContourDeployment>);
