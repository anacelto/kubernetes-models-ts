...
import { validate } from "../../_schemas/ProjectcontourIoV1HTTPProxy";
 ...
 * HTTPProxy is an Ingress CRD specification.
 */
export class HTTPProxy extends Model<IHTTPProxy> implements IHTTPProxy {
...
static apiVersion: IHTTPProxy["apiVersion"] = "projectcontour.io/v1";
static kind: IHTTPProxy["kind"] = "HTTPProxy";
static is = createTypeMetaGuard<IHTTPProxy>(HTTPProxy);

constructor(data?: ModelData<IHTTPProxy>) {
  super();

  this.setDefinedProps({
    apiVersion: HTTPProxy.apiVersion,
    kind: HTTPProxy.kind,
    ...data
  } as IHTTPProxy);
}
...
setValidateFunc(HTTPProxy, validate as ValidateFunc<IHTTPProxy>);
