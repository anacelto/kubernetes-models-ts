 ...
 * ContourConfiguration is the schema for a Contour instance.
 */
export declare class ContourConfiguration extends Model<IContourConfiguration> implements IContourConfiguration {
    ...
    static apiVersion: IContourConfiguration["apiVersion"];
    static kind: IContourConfiguration["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IContourConfiguration>;
