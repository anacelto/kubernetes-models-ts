 ...
 * TLSCertificateDelegation is an TLS Certificate Delegation CRD specification. See design/tls-certificate-delegation.md for details.
 */
export declare class TLSCertificateDelegation extends Model<ITLSCertificateDelegation> implements ITLSCertificateDelegation {
    ...
    static apiVersion: ITLSCertificateDelegation["apiVersion"];
    static kind: ITLSCertificateDelegation["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ITLSCertificateDelegation>;
