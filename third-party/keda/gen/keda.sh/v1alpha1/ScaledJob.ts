...
import { validate } from "../../_schemas/KedaShV1alpha1ScaledJob";

/**
 * ScaledJob is the Schema for the scaledjobs API
 */
export interface IScaledJob {
  /**
 ...
 * ScaledJob is the Schema for the scaledjobs API
 */
export class ScaledJob extends Model<IScaledJob> implements IScaledJob {
  "apiVersion": IScaledJob["apiVersion"];
  "kind": IScaledJob["kind"];
  "metadata"?: IScaledJob["metadata"];
  "spec"?: IScaledJob["spec"];
  "status"?: IScaledJob["status"];

static apiVersion: IScaledJob["apiVersion"] = "keda.sh/v1alpha1";
static kind: IScaledJob["kind"] = "ScaledJob";
static is = createTypeMetaGuard<IScaledJob>(ScaledJob);

constructor(data?: ModelData<IScaledJob>) {
  super();

  this.setDefinedProps({
    apiVersion: ScaledJob.apiVersion,
    kind: ScaledJob.kind,
    ...data
  } as IScaledJob);
}
...
setValidateFunc(ScaledJob, validate as ValidateFunc<IScaledJob>);
