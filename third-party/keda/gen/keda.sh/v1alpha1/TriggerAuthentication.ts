...
import { validate } from "../../_schemas/KedaShV1alpha1TriggerAuthentication";
 ...
 * TriggerAuthentication defines how a trigger can authenticate
 */
export class TriggerAuthentication extends Model<ITriggerAuthentication> implements ITriggerAuthentication {
...
static apiVersion: ITriggerAuthentication["apiVersion"] = "keda.sh/v1alpha1";
static kind: ITriggerAuthentication["kind"] = "TriggerAuthentication";
static is = createTypeMetaGuard<ITriggerAuthentication>(TriggerAuthentication);
...
constructor(data?: ModelData<ITriggerAuthentication>) {
  ...
  this.setDefinedProps({
    ...
    ...data
  } as ITriggerAuthentication);
}
}


setValidateFunc(TriggerAuthentication, validate as ValidateFunc<ITriggerAuthentication>);
