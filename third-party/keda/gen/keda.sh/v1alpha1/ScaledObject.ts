...
import { validate } from "../../_schemas/KedaShV1alpha1ScaledObject";
 ...
 * ScaledObject is a specification for a ScaledObject resource
 */
export class ScaledObject extends Model<IScaledObject> implements IScaledObject {
...
static apiVersion: IScaledObject["apiVersion"] = "keda.sh/v1alpha1";
static kind: IScaledObject["kind"] = "ScaledObject";
static is = createTypeMetaGuard<IScaledObject>(ScaledObject);

constructor(data?: ModelData<IScaledObject>) {
  super();

  this.setDefinedProps({
    apiVersion: ScaledObject.apiVersion,
...
setValidateFunc(ScaledObject, validate as ValidateFunc<IScaledObject>);
