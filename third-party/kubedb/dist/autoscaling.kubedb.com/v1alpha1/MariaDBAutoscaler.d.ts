...
export declare class MariaDBAutoscaler extends Model<IMariaDBAutoscaler> implements IMariaDBAutoscaler {
    ...
    static apiVersion: IMariaDBAutoscaler["apiVersion"];
    static kind: IMariaDBAutoscaler["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMariaDBAutoscaler>;
