...
export declare class MySQLAutoscaler extends Model<IMySQLAutoscaler> implements IMySQLAutoscaler {
    ...
    static apiVersion: IMySQLAutoscaler["apiVersion"];
    static kind: IMySQLAutoscaler["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMySQLAutoscaler>;
