...
export declare class MongoDBAutoscaler extends Model<IMongoDBAutoscaler> implements IMongoDBAutoscaler {
    ...
    static apiVersion: IMongoDBAutoscaler["apiVersion"];
    static kind: IMongoDBAutoscaler["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMongoDBAutoscaler>;
