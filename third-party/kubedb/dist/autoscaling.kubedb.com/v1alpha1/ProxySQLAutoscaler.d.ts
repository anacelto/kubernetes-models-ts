...
export declare class ProxySQLAutoscaler extends Model<IProxySQLAutoscaler> implements IProxySQLAutoscaler {
    ...
    static apiVersion: IProxySQLAutoscaler["apiVersion"];
    static kind: IProxySQLAutoscaler["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IProxySQLAutoscaler>;
