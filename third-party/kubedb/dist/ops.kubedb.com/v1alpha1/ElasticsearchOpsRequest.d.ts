...
export declare class ElasticsearchOpsRequest extends Model<IElasticsearchOpsRequest> implements IElasticsearchOpsRequest {
    ...
    static apiVersion: IElasticsearchOpsRequest["apiVersion"];
    static kind: IElasticsearchOpsRequest["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IElasticsearchOpsRequest>;
