...
export declare class MongoDBOpsRequest extends Model<IMongoDBOpsRequest> implements IMongoDBOpsRequest {
    ...
    static apiVersion: IMongoDBOpsRequest["apiVersion"];
    static kind: IMongoDBOpsRequest["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMongoDBOpsRequest>;
