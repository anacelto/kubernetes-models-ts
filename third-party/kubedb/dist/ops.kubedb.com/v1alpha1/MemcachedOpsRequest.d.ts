...
export declare class MemcachedOpsRequest extends Model<IMemcachedOpsRequest> implements IMemcachedOpsRequest {
    ...
    static apiVersion: IMemcachedOpsRequest["apiVersion"];
    static kind: IMemcachedOpsRequest["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMemcachedOpsRequest>;
