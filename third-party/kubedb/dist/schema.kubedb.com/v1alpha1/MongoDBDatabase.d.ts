...
export declare class MongoDBDatabase extends Model<IMongoDBDatabase> implements IMongoDBDatabase {
    ...
    static apiVersion: IMongoDBDatabase["apiVersion"];
    static kind: IMongoDBDatabase["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMongoDBDatabase>;
