...
export declare class Redis extends Model<IRedis> implements IRedis {
    "apiVersion": IRedis["apiVersion"];
    "kind": IRedis["kind"];
    "metadata"?: IRedis["metadata"];
    "spec"?: IRedis["spec"];
    "status"?: IRedis["status"];
    static apiVersion: IRedis["apiVersion"];
    static kind: IRedis["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IRedis>;
