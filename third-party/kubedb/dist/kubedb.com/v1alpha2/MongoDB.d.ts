...
export declare class MongoDB extends Model<IMongoDB> implements IMongoDB {
    "apiVersion": IMongoDB["apiVersion"];
    "kind": IMongoDB["kind"];
    "metadata"?: IMongoDB["metadata"];
    "spec"?: IMongoDB["spec"];
    "status"?: IMongoDB["status"];
    static apiVersion: IMongoDB["apiVersion"];
    static kind: IMongoDB["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMongoDB>;
