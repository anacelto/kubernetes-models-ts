...
export declare class MariaDB extends Model<IMariaDB> implements IMariaDB {
    "apiVersion": IMariaDB["apiVersion"];
    "kind": IMariaDB["kind"];
    "metadata"?: IMariaDB["metadata"];
    "spec"?: IMariaDB["spec"];
    "status"?: IMariaDB["status"];
    static apiVersion: IMariaDB["apiVersion"];
    static kind: IMariaDB["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMariaDB>;
