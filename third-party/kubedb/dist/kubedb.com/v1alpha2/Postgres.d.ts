...
export declare class Postgres extends Model<IPostgres> implements IPostgres {
    "apiVersion": IPostgres["apiVersion"];
    "kind": IPostgres["kind"];
    "metadata"?: IPostgres["metadata"];
    "spec"?: IPostgres["spec"];
    "status"?: IPostgres["status"];
    static apiVersion: IPostgres["apiVersion"];
    static kind: IPostgres["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPostgres>;
