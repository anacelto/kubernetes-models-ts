...
import { validate } from "../../_schemas/AutoscalingKubedbComV1alpha1PerconaXtraDBAutoscaler";
...
export class PerconaXtraDBAutoscaler extends Model<IPerconaXtraDBAutoscaler> implements IPerconaXtraDBAutoscaler {
...
static apiVersion: IPerconaXtraDBAutoscaler["apiVersion"] = "autoscaling.kubedb.com/v1alpha1";
static kind: IPerconaXtraDBAutoscaler["kind"] = "PerconaXtraDBAutoscaler";
static is = createTypeMetaGuard<IPerconaXtraDBAutoscaler>(PerconaXtraDBAutoscaler);

constructor(data?: ModelData<IPerconaXtraDBAutoscaler>) {
  super();

  this.setDefinedProps({
    apiVersion: PerconaXtraDBAutoscaler.apiVersion,
    kind: PerconaXtraDBAutoscaler.kind,
    ...data
  } as IPerconaXtraDBAutoscaler);
}
}


setValidateFunc(PerconaXtraDBAutoscaler, validate as ValidateFunc<IPerconaXtraDBAutoscaler>);
