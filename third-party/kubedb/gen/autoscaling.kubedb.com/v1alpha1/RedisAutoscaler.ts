...
import { validate } from "../../_schemas/AutoscalingKubedbComV1alpha1RedisAutoscaler";
...
export class RedisAutoscaler extends Model<IRedisAutoscaler> implements IRedisAutoscaler {
...
static apiVersion: IRedisAutoscaler["apiVersion"] = "autoscaling.kubedb.com/v1alpha1";
static kind: IRedisAutoscaler["kind"] = "RedisAutoscaler";
static is = createTypeMetaGuard<IRedisAutoscaler>(RedisAutoscaler);

constructor(data?: ModelData<IRedisAutoscaler>) {
  super();

  this.setDefinedProps({
    apiVersion: RedisAutoscaler.apiVersion,
    kind: RedisAutoscaler.kind,
    ...data
  } as IRedisAutoscaler);
}
}
...
setValidateFunc(RedisAutoscaler, validate as ValidateFunc<IRedisAutoscaler>);
