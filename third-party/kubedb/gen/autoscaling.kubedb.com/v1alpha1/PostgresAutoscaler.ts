...
import { validate } from "../../_schemas/AutoscalingKubedbComV1alpha1PostgresAutoscaler";
...
export class PostgresAutoscaler extends Model<IPostgresAutoscaler> implements IPostgresAutoscaler {
...
static apiVersion: IPostgresAutoscaler["apiVersion"] = "autoscaling.kubedb.com/v1alpha1";
static kind: IPostgresAutoscaler["kind"] = "PostgresAutoscaler";
static is = createTypeMetaGuard<IPostgresAutoscaler>(PostgresAutoscaler);

constructor(data?: ModelData<IPostgresAutoscaler>) {
  super();

  this.setDefinedProps({
    apiVersion: PostgresAutoscaler.apiVersion,
    kind: PostgresAutoscaler.kind,
    ...data
  } as IPostgresAutoscaler);
}
}


setValidateFunc(PostgresAutoscaler, validate as ValidateFunc<IPostgresAutoscaler>);
