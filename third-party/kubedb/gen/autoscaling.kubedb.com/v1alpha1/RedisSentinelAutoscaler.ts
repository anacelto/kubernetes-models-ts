...
import { validate } from "../../_schemas/AutoscalingKubedbComV1alpha1RedisSentinelAutoscaler";
...
export class RedisSentinelAutoscaler extends Model<IRedisSentinelAutoscaler> implements IRedisSentinelAutoscaler {
...
static apiVersion: IRedisSentinelAutoscaler["apiVersion"] = "autoscaling.kubedb.com/v1alpha1";
static kind: IRedisSentinelAutoscaler["kind"] = "RedisSentinelAutoscaler";
static is = createTypeMetaGuard<IRedisSentinelAutoscaler>(RedisSentinelAutoscaler);

constructor(data?: ModelData<IRedisSentinelAutoscaler>) {
  super();

  this.setDefinedProps({
    apiVersion: RedisSentinelAutoscaler.apiVersion,
    kind: RedisSentinelAutoscaler.kind,
    ...data
  } as IRedisSentinelAutoscaler);
}
}


setValidateFunc(RedisSentinelAutoscaler, validate as ValidateFunc<IRedisSentinelAutoscaler>);
