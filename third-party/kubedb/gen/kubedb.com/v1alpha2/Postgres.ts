...
import { validate } from "../../_schemas/KubedbComV1alpha2Postgres";
...
export interface IPostgres {
  ...
  "spec"?: {
    ...
    "leaderElection"?: {
      ...
      "maximumLagBeforeFailover"?: number;
      "period"?: string;
      "renewDeadlineSeconds"?: number;
      "retryPeriodSeconds"?: number;
      "transferLeadershipInterval"?: string;
      "transferLeadershipTimeout"?: string;
    };
    "monitor"?: {
      "agent"?: string;
      "prometheus"?: {
...
export class Postgres extends Model<IPostgres> implements IPostgres {
  "apiVersion": IPostgres["apiVersion"];
  "kind": IPostgres["kind"];
  "metadata"?: IPostgres["metadata"];
  "spec"?: IPostgres["spec"];
  "status"?: IPostgres["status"];

static apiVersion: IPostgres["apiVersion"] = "kubedb.com/v1alpha2";
static kind: IPostgres["kind"] = "Postgres";
static is = createTypeMetaGuard<IPostgres>(Postgres);

constructor(data?: ModelData<IPostgres>) {
  super();
...
setValidateFunc(Postgres, validate as ValidateFunc<IPostgres>);
