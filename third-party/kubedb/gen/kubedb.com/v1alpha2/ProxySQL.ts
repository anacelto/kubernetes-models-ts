...
import { validate } from "../../_schemas/KubedbComV1alpha2ProxySQL";
...
export class ProxySQL extends Model<IProxySQL> implements IProxySQL {
...
static apiVersion: IProxySQL["apiVersion"] = "kubedb.com/v1alpha2";
static kind: IProxySQL["kind"] = "ProxySQL";
static is = createTypeMetaGuard<IProxySQL>(ProxySQL);

constructor(data?: ModelData<IProxySQL>) {
  super();

  this.setDefinedProps({
    apiVersion: ProxySQL.apiVersion,
    kind: ProxySQL.kind,
    ...data
  } as IProxySQL);
}
...
setValidateFunc(ProxySQL, validate as ValidateFunc<IProxySQL>);
