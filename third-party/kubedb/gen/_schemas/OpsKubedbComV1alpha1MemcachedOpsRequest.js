...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "ngyP6ClHMVYpeHWkJgfBralC1BtTU76n7lAA5iA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "09JltohDtoZ0BxdvYGyDmTv4K4XZO8E9BcWkIptw8"
    },
    "status": {
  ...
  "$id": "ops.kubedb.com.v1alpha1.MemcachedOpsRequest"
};
const schema15 = {
  "type": "string",
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificates !== undefined) {
      if (!validate54(data.certificates, {
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.databaseRef !== undefined) {
      if (!validate48(data.databaseRef, {
    ...
    if (data.verticalScaling !== undefined) {
      if (!validate89(data.verticalScaling, {
...
function validate96(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate97(data.lastTransitionTime, {
...
function validate35(data, {
  ...
  /*# sourceURL="ops.kubedb.com.v1alpha1.MemcachedOpsRequest" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
