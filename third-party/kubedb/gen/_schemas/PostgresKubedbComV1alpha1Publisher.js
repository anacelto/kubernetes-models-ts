...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "vfWvPqP7UCNURlRzKkrUm7KX28BPb7m98yJXfy6d9ak"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "FJMmaSJyswlx13RaiAJjd5qH5fiJypnMxgua1M0c"
    },
    "status": {
      "$ref": "SI5XDbij33JdXZK2lW4KPVZtuWMvvkGJJGBlv0PXA"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "postgres.kubedb.com.v1alpha1.Publisher"
};
const schema16 = {
  "type": "string",
...
const schema20 = {
  "properties": {
    ...
    "parameters": {
      "$ref": "wsyzzlokCE2iYesdYayQr1q0WWER9TLKIvlRquSPVI"
    },
    "publishAllTables": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
  ...
  "required": ["databaseName", "name", "serverRef"],
  "type": "object",
  "nullable": true
};
const schema21 = {
...
const schema25 = {
  "properties": {
    "operations": {
      "$ref": "NxjbyzmTqMAhFDdTii8axWFKci3ZvM6Nn3vkSNHQPg"
    },
...
const schema26 = {
  "items": {
    "$ref": "QnxDv40ojkbvmWbQxEJXPMgY7RWJ8QageqASGOtH0"
  },
  "type": "array",
  "nullable": true
};
...
function validate63(data, {
  ...
  if (!(data === "insert" || data === "update" || data === "delete" || data === "truncate")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.publishViaPartitionRoot !== undefined) {
      if (!validate35(data.publishViaPartitionRoot, {
        instancePath: instancePath + "/publishViaPartitionRoot",
        parentData: data,
        parentDataProperty: "publishViaPartitionRoot",
        rootData
      })) {
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedSubscribers !== undefined) {
      if (!validate48(data.allowedSubscribers, {
        instancePath: instancePath + "/allowedSubscribers",
        parentData: data,
        parentDataProperty: "allowedSubscribers",
        rootData
      })) {
    ...
    if (data.deletionPolicy !== undefined) {
      if (!validate57(data.deletionPolicy, {
    ...
    if (data.publishAllTables !== undefined) {
      if (!validate35(data.publishAllTables, {
        instancePath: instancePath + "/publishAllTables",
        parentData: data,
        parentDataProperty: "publishAllTables",
        rootData
      })) {
        vErrors = vErrors === null ? validate35.errors : vErrors.concat(validate35.errors);
        errors = vErrors.length;
...
function validate76(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate36(data.observedGeneration, {
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.subscribers !== undefined) {
      if (!validate89(data.subscribers, {
...
function validate38(data, {
  ...
  /*# sourceURL="postgres.kubedb.com.v1alpha1.Publisher" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
