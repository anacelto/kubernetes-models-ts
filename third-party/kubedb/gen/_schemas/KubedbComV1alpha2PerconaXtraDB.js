...
export const validate = validate384;
const schema99 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "dJV4jiWgcHWE0FkbozHkvNs4kiekJHkAAK0NrfIgRQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "mlbzHEknfVcD1axSaDdzJyHRShZNRGWrBppdfsvtFk"
    },
    "status": {
  ...
  "$id": "kubedb.com.v1alpha2.PerconaXtraDB"
};
const schema100 = {
  "type": "string",
...
const schema103 = {};
import { validate as validate390 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema104 = {
  "properties": {
    ...
    "systemUserSecrets": {
      "$ref": "h0zpRwbW4e3ZdoGZXN5Y4rVGZJNSpLYGZjjHkBhui4k"
    },
    "terminationPolicy": {
...
function validate394(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.namespaces !== undefined) {
      if (!validate395(data.namespaces, {
...
function validate685(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.monitorUserSecret !== undefined) {
      if (!validate381(data.monitorUserSecret, {
        instancePath: instancePath + "/monitorUserSecret",
        parentData: data,
        parentDataProperty: "monitorUserSecret",
        rootData
      })) {
    ...
    if (data.replicationUserSecret !== undefined) {
      if (!validate381(data.replicationUserSecret, {
        instancePath: instancePath + "/replicationUserSecret",
        parentData: data,
        parentDataProperty: "replicationUserSecret",
        rootData
      })) {
        vErrors = vErrors === null ? validate381.errors : vErrors.concat(validate381.errors);
        errors = vErrors.length;
...
function validate693(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.privateKey !== undefined) {
      if (!validate700(data.privateKey, {
...
function validate691(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificates !== undefined) {
      if (!validate692(data.certificates, {
...
function validate393(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedSchemas !== undefined) {
      if (!validate394(data.allowedSchemas, {
    ...
    if (data.authSecret !== undefined) {
      if (!validate381(data.authSecret, {
    ...
    if (data.systemUserSecrets !== undefined) {
      if (!validate685(data.systemUserSecrets, {
        instancePath: instancePath + "/systemUserSecrets",
        parentData: data,
        parentDataProperty: "systemUserSecrets",
        rootData
      })) {
    ...
    if (data.terminationPolicy !== undefined) {
      if (!validate689(data.terminationPolicy, {
...
function validate724(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.lastUpdateTimestamp !== undefined) {
      if (!validate725(data.lastUpdateTimestamp, {
...
function validate729(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate730(data.lastTransitionTime, {
...
function validate723(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authSecret !== undefined) {
      if (!validate724(data.authSecret, {
        instancePath: instancePath + "/authSecret",
        parentData: data,
        parentDataProperty: "authSecret",
        rootData
    ...
    if (data.conditions !== undefined) {
      if (!validate728(data.conditions, {
...
function validate384(data, {
  ...
  /*# sourceURL="kubedb.com.v1alpha2.PerconaXtraDB" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate385(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
