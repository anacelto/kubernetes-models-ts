...
const schema19 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "penfxoxkK4nhLdQhgVQSZcjZaCcLA9r5PmTemdNQl0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "iwiSIdj4E3xrc8Rs5hdRH7tF6OoDfNLvRYczzfqLIE8"
    },
    "status": {
  ...
  "$id": "autoscaling.kubedb.com.v1alpha1.MariaDBAutoscaler"
};
const schema20 = {
  "type": "string",
...
const schema24 = {
  "properties": {
    "compute": {
      "$ref": "lpdWtUy0u5pSax15ofdl6OKFHUzh2woVaOmzWNcVIM"
    },
    "databaseRef": {
    ...
    "storage": {
      "$ref": "NbwbDGQVCjAdpPjJGRRGttYPyKyRVW96ONn4C2rVk50"
    }
  },
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.mariadb !== undefined) {
      if (!validate54(data.mariadb, {
        instancePath: instancePath + "/mariadb",
        parentData: data,
        parentDataProperty: "mariadb",
        rootData
      })) {
...
function validate43(data, {
  ...
  /*# sourceURL="autoscaling.kubedb.com.v1alpha1.MariaDBAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
