...
const schema105 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "pEg1LAADi3FwSHxJx1iQLBKb3DRmuDFy5jDOjTCUA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "I1K3tR7IljGdkSws9DGyOtijHYl09THpgfWa8IMWmY"
    },
    "status": {
  ...
  "$id": "schema.kubedb.com.v1alpha1.PostgresDatabase"
};
const schema106 = {
  "type": "string",
...
const schema110 = {
  "properties": {
    ...
    "database": {
      "$ref": "VAWjoT3CRv0UFY8m6p9UcjvVDn75IQxtJBbST8p3Iw"
    },
    "deletionPolicy": {
...
const schema114 = {
  "properties": {
    "config": {
      "$ref": "F5W9Hu4GpIIUYZEfHF62lo7DdsSZEmiynObVKchm7g"
    },
    "serverRef": {
      "$ref": "djR0IiKxj20fIodNTVmExT7zNueAT3cy9fuVEwNlhI"
    }
...
const schema115 = {
  "properties": {
    ...
    "params": {
      "$ref": "xanFlWdmVTm0QAnffktB2ARQUVdJkpTacvXGgTqYuA"
    }
  },
  "required": ["name"],
  "type": "object"
...
const schema116 = {
  "items": {
    "$ref": "ylN0rD0zXivjoCdro6RF5jDUm4fwhpNVti8ZZqAYh74"
  },
  "type": "array",
  "nullable": true
};
const schema117 = {
  ...
  "required": ["configParameter", "value"],
  "type": "object"
};
function validate449(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configParameter === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "configParameter"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.configParameter !== undefined) {
      if (!validate22(data.configParameter, {
        instancePath: instancePath + "/configParameter",
        parentData: data,
        parentDataProperty: "configParameter",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate496(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelectorTerms !== undefined) {
      if (!validate497(data.nodeSelectorTerms, {
...
function validate489(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate490(data.preferredDuringSchedulingIgnoredDuringExecution, {
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate496(data.requiredDuringSchedulingIgnoredDuringExecution, {
...
function validate488(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nodeAffinity !== undefined) {
      if (!validate489(data.nodeAffinity, {
...
function validate582(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.supplementalGroups !== undefined) {
      if (!validate590(data.supplementalGroups, {
...
function validate486(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.containers !== undefined) {
      if (!validate506(data.containers, {
    ...
    if (data.ephemeralContainers !== undefined) {
      if (!validate521(data.ephemeralContainers, {
    ...
    if (data.hostAliases !== undefined) {
      if (!validate548(data.hostAliases, {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate559(data.imagePullSecrets, {
    ...
    if (data.initContainers !== undefined) {
      if (!validate562(data.initContainers, {
    ...
    if (data.readinessGates !== undefined) {
      if (!validate574(data.readinessGates, {
    ...
    if (data.securityContext !== undefined) {
      if (!validate582(data.securityContext, {
        instancePath: instancePath + "/securityContext",
        parentData: data,
        parentDataProperty: "securityContext",
        rootData
...
function validate462(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podTemplate !== undefined) {
      if (!validate484(data.podTemplate, {
...
function validate670(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.repository !== undefined) {
      if (!validate671(data.repository, {
        instancePath: instancePath + "/repository",
        parentData: data,
        parentDataProperty: "repository",
        rootData
    ...
    if (data.snapshotID !== undefined) {
      if (!validate677(data.snapshotID, {
...
function validate459(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.initialized !== undefined) {
      if (!validate460(data.initialized, {
...
function validate432(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deletionPolicy !== undefined) {
      if (!validate457(data.deletionPolicy, {
...
function validate686(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate687(data.lastTransitionTime, {
...
function validate683(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate685(data.conditions, {
...
function validate423(data, {
  ...
  /*# sourceURL="schema.kubedb.com.v1alpha1.PostgresDatabase" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
