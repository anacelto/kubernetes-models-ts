...
const schema25 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "ilfdOes580M5q93VlkVJwElO5R1WxANhLPVBk8dFXI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "e6FLT8QPmV6EcXKNc7mICKHooqOUXsGiOiJ6ORJeM"
    },
    "status": {
  ...
  "$id": "autoscaling.kubedb.com.v1alpha1.ElasticsearchAutoscaler"
};
const schema26 = {
  "type": "string",
...
function validate67(data, {
  ...
  if (!(data === "ElasticsearchAutoscaler")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema30 = {
  "properties": {
    "compute": {
      "$ref": "ou3T47VEMX7EgZFzURTfeOZWo4PvYRbUbvYgOuZew"
    },
    "databaseRef": {
    ...
    "storage": {
      "$ref": "FHnR6VY0dQ1sf2Pg6RIkGEw5dpz5JzKQh5yfx1B1c"
    }
  },
...
const schema31 = {
  "properties": {
    ...
    "topology": {
      "$ref": "i0peSuJtUCYaISUM5TorDFoXt86vpBaE5iEcOb3hw"
    }
  },
  "type": "object",
  "nullable": true
...
function validate85(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.readinessCriteria !== undefined) {
      if (!validate88(data.readinessCriteria, {
...
const schema37 = {
  "properties": {
    ...
    "topology": {
      "$ref": "dW7ysDTp044hKOkKu5Og5R6zS59IJc7jWn6O9B61jU"
    }
  },
  "type": "object",
  "nullable": true
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.databaseRef !== undefined) {
      if (!validate82(data.databaseRef, {
    ...
    if (data.opsRequestOptions !== undefined) {
      if (!validate85(data.opsRequestOptions, {
...
function validate103(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.totalSamplesCount !== undefined) {
      if (!validate113(data.totalSamplesCount, {
...
function validate119(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate120(data.lastTransitionTime, {
...
function validate143(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.containerRecommendations !== undefined) {
      if (!validate144(data.containerRecommendations, {
...
function validate133(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate134(data.conditions, {
    ...
    if (data.recommendation !== undefined) {
      if (!validate143(data.recommendation, {
...
function validate101(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.checkpoints !== undefined) {
      if (!validate102(data.checkpoints, {
...
function validate64(data, {
  ...
  /*# sourceURL="autoscaling.kubedb.com.v1alpha1.ElasticsearchAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
