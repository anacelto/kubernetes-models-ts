...
const schema13 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "QVANe3cPhN50Z5JQRJEyUThL1kBW1pZldw82lYaYrI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "i1YqpqlM6FyYsKIawRRKwHTpdugDHC7p8pZpeYx7uY"
    },
    "status": {
  ...
  "$id": "ops.kubedb.com.v1alpha1.PgBouncerOpsRequest"
};
const schema14 = {
  "type": "string",
...
const schema18 = {
  "properties": {
    ...
    "type": {
      "$ref": "lG3gC0IaNzL4jtbxgzul48Wtn5NuIfaN5XMvD9mtGnc"
    },
    "verticalScaling": {
      "$ref": "wSr6w4C7k9NgfY61HtC1RHsyCdKiZHIZULSNi5xGjRo"
    }
  },
  "required": ["serverRef", "type"],
  "type": "object",
  "nullable": true
};
const schema19 = {
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.targetVersion !== undefined) {
      if (!validate22(data.targetVersion, {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificates !== undefined) {
      if (!validate55(data.certificates, {
...
function validate86(data, {
  ...
  if (!(data === "UpdateVersion" || data === "HorizontalScaling" || data === "VerticalScaling" || data === "Restart" || data === "Reconfigure" || data === "ReconfigureTLS")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.UpdateVersion !== undefined) {
      if (!validate42(data.UpdateVersion, {
...
function validate94(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate95(data.lastTransitionTime, {
...
function validate32(data, {
  ...
  /*# sourceURL="ops.kubedb.com.v1alpha1.PgBouncerOpsRequest" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
