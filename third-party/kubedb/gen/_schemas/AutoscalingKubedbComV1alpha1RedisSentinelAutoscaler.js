...
const schema19 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "LeodZ1DUFbKpDFpWeaLwFBX6MJikQwfOJzIKME0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "uMlmOKQZ2nbhMwQybX9JtzYY7lGI1N99TEZioe4H1c4"
    },
    "status": {
  ...
  "$id": "autoscaling.kubedb.com.v1alpha1.RedisSentinelAutoscaler"
};
const schema20 = {
  "type": "string",
...
function validate46(data, {
  ...
  if (!(data === "RedisSentinelAutoscaler")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema24 = {
  "properties": {
    "compute": {
      "$ref": "75NNOKJSeNg5nJNkrCwmsF7Da04lQoMHdRJQSSBvg"
    },
    "databaseRef": {
...
function validate43(data, {
  ...
  /*# sourceURL="autoscaling.kubedb.com.v1alpha1.RedisSentinelAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
