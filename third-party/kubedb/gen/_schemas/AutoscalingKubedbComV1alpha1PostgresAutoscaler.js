...
const schema19 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "toeTyZKHQEOHqKb1XOxd9KefcdlAtOHDWMUEWDLAJo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "XeGBg259elOOGCLb3p3i8uUHxFvIZP8bJXAqMZyq0"
    },
    "status": {
  ...
  "$id": "autoscaling.kubedb.com.v1alpha1.PostgresAutoscaler"
};
const schema20 = {
  "type": "string",
...
const schema24 = {
  "properties": {
    "compute": {
      "$ref": "gKw7W1RjPnAFWjD7idWQLies32JbtbZrZWVZhBuU8"
    },
    "databaseRef": {
    ...
    "storage": {
      "$ref": "k7aNJ2NQ2ubJJQfXgD9OBFcmlfNQwtvzkBphnOL71w"
    }
  },
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.postgres !== undefined) {
      if (!validate54(data.postgres, {
        instancePath: instancePath + "/postgres",
        parentData: data,
        parentDataProperty: "postgres",
        rootData
      })) {
...
function validate80(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.expansionMode !== undefined) {
      if (!validate81(data.expansionMode, {
...
function validate91(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.totalSamplesCount !== undefined) {
      if (!validate101(data.totalSamplesCount, {
...
function validate107(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate108(data.lastTransitionTime, {
...
function validate131(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.containerRecommendations !== undefined) {
      if (!validate132(data.containerRecommendations, {
...
function validate121(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.recommendation !== undefined) {
      if (!validate131(data.recommendation, {
...
function validate89(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.checkpoints !== undefined) {
      if (!validate90(data.checkpoints, {
...
function validate43(data, {
  ...
  /*# sourceURL="autoscaling.kubedb.com.v1alpha1.PostgresAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
