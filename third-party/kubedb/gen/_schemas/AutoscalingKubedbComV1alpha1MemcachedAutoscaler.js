...
const schema30 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Xd23RYvK2HtwFEWRiGw3xelWzMOFFsQg5amFLFhm8"
    },
    "metadata": {
  ...
  "$id": "autoscaling.kubedb.com.v1alpha1.MemcachedAutoscaler"
};
const schema31 = {
  "type": "string",
...
function validate77(data, {
  ...
  /*# sourceURL="autoscaling.kubedb.com.v1alpha1.MemcachedAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
