...
const schema30 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "HoKv1wtM005JpIi2PLlltwhRStQyFYu7KV1lHi5NA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "rl4wBMJhwSwhfXyFoqdWO1jZyd3kdAdxjPIKQEj6Q"
    },
    "status": {
  ...
  "$id": "autoscaling.kubedb.com.v1alpha1.EtcdAutoscaler"
};
const schema31 = {
  "type": "string",
...
function validate86(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.scaleTargetRef !== undefined) {
      if (!validate118(data.scaleTargetRef, {
...
function validate77(data, {
  ...
  /*# sourceURL="autoscaling.kubedb.com.v1alpha1.EtcdAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
