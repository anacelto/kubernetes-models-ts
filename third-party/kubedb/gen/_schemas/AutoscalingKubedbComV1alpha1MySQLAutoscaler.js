...
const schema19 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "cyBgsJ0SHVuErwTRMsZWNEzf87lejx1edyjGdEuhss"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "PBLtYO6EoFab7dyebarSLcAt6nZFxKsp9YeW6XEdBs"
    },
    "status": {
  ...
  "$id": "autoscaling.kubedb.com.v1alpha1.MySQLAutoscaler"
};
const schema20 = {
  "type": "string",
...
const schema24 = {
  "properties": {
    "compute": {
      "$ref": "BCvGhJGRlcEbnOHeSRG2mOdcAxGzPleNqGtePJHwA"
    },
    "databaseRef": {
    ...
    "storage": {
      "$ref": "IUfkCXjJQy9Qj1RbCj2kZoQPODtDqeFnMb8z2PeULQ"
    }
  },
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.mysql !== undefined) {
      if (!validate54(data.mysql, {
        instancePath: instancePath + "/mysql",
        parentData: data,
        parentDataProperty: "mysql",
        rootData
      })) {
...
function validate43(data, {
  ...
  /*# sourceURL="autoscaling.kubedb.com.v1alpha1.MySQLAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
