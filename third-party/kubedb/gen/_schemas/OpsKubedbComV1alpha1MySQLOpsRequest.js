...
const schema18 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "rkhnQcPQRVd5giwB4k2jknss455emoQQvpTB9qbkRY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Ob2VwUPYzrnQyO8b8LgnUdIBeezpXI4KtMTx2PS4A"
    },
    "status": {
  ...
  "$id": "ops.kubedb.com.v1alpha1.MySQLOpsRequest"
};
const schema19 = {
  "type": "string",
...
const schema23 = {
  "properties": {
    ...
    "verticalScaling": {
      "$ref": "92DROZclzfSiYNn6BBAgQ2FIAiFZJ0oh7ZKsSOQmh0"
    },
    "volumeExpansion": {
      "$ref": "AIhSGFWoWORSHm4vrMwY2eZuKZGkUAPkoIX5AJWfGDc"
    }
  },
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configSecret !== undefined) {
      if (!validate57(data.configSecret, {
...
function validate72(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificates !== undefined) {
      if (!validate73(data.certificates, {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.readinessCriteria !== undefined) {
      if (!validate30(data.readinessCriteria, {
...
function validate109(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.coordinator !== undefined) {
      if (!validate40(data.coordinator, {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.configuration !== undefined) {
      if (!validate56(data.configuration, {
    ...
    if (data.databaseRef !== undefined) {
      if (!validate63(data.databaseRef, {
    ...
    if (data.horizontalScaling !== undefined) {
      if (!validate66(data.horizontalScaling, {
    ...
    if (data.verticalScaling !== undefined) {
      if (!validate109(data.verticalScaling, {
    ...
    if (data.volumeExpansion !== undefined) {
      if (!validate114(data.volumeExpansion, {
...
function validate122(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate123(data.lastTransitionTime, {
...
function validate44(data, {
  ...
  /*# sourceURL="ops.kubedb.com.v1alpha1.MySQLOpsRequest" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
