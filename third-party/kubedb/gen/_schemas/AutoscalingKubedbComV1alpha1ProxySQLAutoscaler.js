...
const schema19 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "VKMBKuplwYesQskcor8qIljKJsG25rNccmQt3lM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "cLovUzsTil88It628AMUJM7W1XtB09ANSSOgb1WE"
    },
    "status": {
  ...
  "$id": "autoscaling.kubedb.com.v1alpha1.ProxySQLAutoscaler"
};
const schema20 = {
  "type": "string",
...
const schema24 = {
  "properties": {
    "compute": {
      "$ref": "lVqrfKLo3pcCKbf1kexU9U7DfDv5VQQkj1OL5zgY"
    },
    "opsRequestOptions": {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.proxysql !== undefined) {
      if (!validate54(data.proxysql, {
        instancePath: instancePath + "/proxysql",
        parentData: data,
        parentDataProperty: "proxysql",
        rootData
      })) {
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.proxyRef === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "proxyRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.opsRequestOptions !== undefined) {
      if (!validate71(data.opsRequestOptions, {
    ...
    if (data.proxyRef !== undefined) {
      if (!validate76(data.proxyRef, {
        instancePath: instancePath + "/proxyRef",
        parentData: data,
        parentDataProperty: "proxyRef",
        rootData
      })) {
...
function validate82(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.totalSamplesCount !== undefined) {
      if (!validate92(data.totalSamplesCount, {
...
function validate98(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate99(data.lastTransitionTime, {
...
function validate122(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.containerRecommendations !== undefined) {
      if (!validate123(data.containerRecommendations, {
...
function validate112(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate113(data.conditions, {
    ...
    if (data.recommendation !== undefined) {
      if (!validate122(data.recommendation, {
...
function validate80(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.checkpoints !== undefined) {
      if (!validate81(data.checkpoints, {
...
function validate43(data, {
  ...
  /*# sourceURL="autoscaling.kubedb.com.v1alpha1.ProxySQLAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
