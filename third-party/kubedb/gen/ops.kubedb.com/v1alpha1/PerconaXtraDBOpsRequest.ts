...
import { validate } from "../../_schemas/OpsKubedbComV1alpha1PerconaXtraDBOpsRequest";
...
export class PerconaXtraDBOpsRequest extends Model<IPerconaXtraDBOpsRequest> implements IPerconaXtraDBOpsRequest {
...
static apiVersion: IPerconaXtraDBOpsRequest["apiVersion"] = "ops.kubedb.com/v1alpha1";
static kind: IPerconaXtraDBOpsRequest["kind"] = "PerconaXtraDBOpsRequest";
static is = createTypeMetaGuard<IPerconaXtraDBOpsRequest>(PerconaXtraDBOpsRequest);

constructor(data?: ModelData<IPerconaXtraDBOpsRequest>) {
  super();

  this.setDefinedProps({
    apiVersion: PerconaXtraDBOpsRequest.apiVersion,
    kind: PerconaXtraDBOpsRequest.kind,
    ...data
  } as IPerconaXtraDBOpsRequest);
}
}


setValidateFunc(PerconaXtraDBOpsRequest, validate as ValidateFunc<IPerconaXtraDBOpsRequest>);
