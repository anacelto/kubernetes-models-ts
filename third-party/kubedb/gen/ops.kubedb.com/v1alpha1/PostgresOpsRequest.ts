...
import { validate } from "../../_schemas/OpsKubedbComV1alpha1PostgresOpsRequest";
...
export class PostgresOpsRequest extends Model<IPostgresOpsRequest> implements IPostgresOpsRequest {
...
static apiVersion: IPostgresOpsRequest["apiVersion"] = "ops.kubedb.com/v1alpha1";
static kind: IPostgresOpsRequest["kind"] = "PostgresOpsRequest";
static is = createTypeMetaGuard<IPostgresOpsRequest>(PostgresOpsRequest);

constructor(data?: ModelData<IPostgresOpsRequest>) {
  super();

  this.setDefinedProps({
    apiVersion: PostgresOpsRequest.apiVersion,
    kind: PostgresOpsRequest.kind,
    ...data
  } as IPostgresOpsRequest);
}
}


setValidateFunc(PostgresOpsRequest, validate as ValidateFunc<IPostgresOpsRequest>);
