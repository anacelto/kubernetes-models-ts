...
import { validate } from "../../_schemas/OpsKubedbComV1alpha1MariaDBOpsRequest";
...
export class MariaDBOpsRequest extends Model<IMariaDBOpsRequest> implements IMariaDBOpsRequest {
...
static apiVersion: IMariaDBOpsRequest["apiVersion"] = "ops.kubedb.com/v1alpha1";
static kind: IMariaDBOpsRequest["kind"] = "MariaDBOpsRequest";
static is = createTypeMetaGuard<IMariaDBOpsRequest>(MariaDBOpsRequest);

constructor(data?: ModelData<IMariaDBOpsRequest>) {
  super();

  this.setDefinedProps({
    apiVersion: MariaDBOpsRequest.apiVersion,
    kind: MariaDBOpsRequest.kind,
    ...data
  } as IMariaDBOpsRequest);
}
}


setValidateFunc(MariaDBOpsRequest, validate as ValidateFunc<IMariaDBOpsRequest>);
