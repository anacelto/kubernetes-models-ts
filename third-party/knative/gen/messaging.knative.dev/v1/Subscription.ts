...
import { validate } from "../../_schemas/MessagingKnativeDevV1Subscription";
...
export class Subscription extends Model<ISubscription> implements ISubscription {
  "spec"?: ISubscription["spec"];
  "status"?: ISubscription["status"];
  "apiVersion": ISubscription["apiVersion"];
  "kind": ISubscription["kind"];
  "metadata"?: ISubscription["metadata"];

static apiVersion: ISubscription["apiVersion"] = "messaging.knative.dev/v1";
static kind: ISubscription["kind"] = "Subscription";
static is = createTypeMetaGuard<ISubscription>(Subscription);

constructor(data?: ModelData<ISubscription>) {
  super();
...
setValidateFunc(Subscription, validate as ValidateFunc<ISubscription>);
