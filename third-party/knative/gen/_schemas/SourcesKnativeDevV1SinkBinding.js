...
const schema9 = {
  ...
  "properties": {
    "spec": {
      "$ref": "KUnXLbUIwXTBaHpdh7X8DcV5xlQXllVeS3HdNH6kbs"
    },
    "status": {
    ...
    "kind": {
      "$ref": "vorCuWeN7fXhiyJI9fberwhWf4p7z2WpzDX5jxhQw"
    },
    "metadata": {
  ...
  "$id": "sources.knative.dev.v1.SinkBinding"
};
const schema10 = {
  "type": "object",
  "properties": {
    ...
    "subject": {
      "$ref": "sUeCqemZCgcaNYhX7NWUm5hSEA9faG4MYmU9dKX3KCM"
    }
  },
  "nullable": true
};
...
function validate25(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ceOverrides !== undefined) {
      if (!validate26(data.ceOverrides, {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ceAttributes !== undefined) {
      if (!validate59(data.ceAttributes, {
...
function validate24(data, {
  ...
  /*# sourceURL="sources.knative.dev.v1.SinkBinding" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
