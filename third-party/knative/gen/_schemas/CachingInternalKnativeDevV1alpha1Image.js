...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "EbfAdbtCsRVhsveS801TtgpnIuZrgXxEMOLnmS9IyF0"
    },
    "kind": {
      "$ref": "9llt4MIph5X6vYGYZ7U0gON5LUFOHMA8ujNh4j7CA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "QwfuEsPhGgQQjEaDyJft5DB3gVZ7CxvkyEdAl4hG0"
    },
    "status": {
  ...
  "$id": "caching.internal.knative.dev.v1alpha1.Image"
};
const schema9 = {
  "type": "string",
  "enum": ["caching.internal.knative.dev/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "caching.internal.knative.dev/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate34(data.imagePullSecrets, {
...
function validate23(data, {
  ...
  /*# sourceURL="caching.internal.knative.dev.v1alpha1.Image" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
