...
const schema8 = {
  ...
  "properties": {
    ...
    "apiVersion": {
      "$ref": "BOQnmnQkh6QqAvFPZJ6VCOxsTqhiq3Ih52L8yd91Y"
    },
    "kind": {
  ...
  "$id": "sources.knative.dev.v1beta2.PingSource"
};
const schema9 = {
  "type": "object",
  "properties": {
...
const schema21 = {
  "type": "string",
  "enum": ["sources.knative.dev/v1beta2"]
};
function validate68(data, {
  ...
  if (!(data === "sources.knative.dev/v1beta2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="sources.knative.dev.v1beta2.PingSource" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
