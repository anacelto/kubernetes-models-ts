...
const schema12 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "uTXHjHReW7iYsPOA0qwopkX5ogqis3s4tAX0F84BfOM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "yV1e52IEBmajTmivOMcihG8JO4iAPFuhnTyOUPzka8E"
    },
    "status": {
      "$ref": "RrvCC29IiceNtw96HxihpRAW1xKey2lV26cfays6E0"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "serving.knative.dev.v1.Route"
};
const schema13 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configurationName !== undefined) {
      if (!validate21(data.configurationName, {
    ...
    if (data.revisionName !== undefined) {
      if (!validate21(data.revisionName, {
...
function validate34(data, {
  ...
  /*# sourceURL="serving.knative.dev.v1.Route" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
