...
const schema8 = {
  ...
  "properties": {
    "spec": {
      "$ref": "W9Udji2y20sID8r7yfK5PUsX6QzAiFYZWkAVBfCYCc"
    },
    "status": {
      "$ref": "2jzwwjxMMrtDrwHcs3FltwJoQRHYkJiCwOTkEfsPBA8"
    },
    "apiVersion": {
      "$ref": "stJFvOo4cPur8P83miGTOVDAhjoxhpjf64Xfj4RhU"
    },
    "kind": {
      "$ref": "PVlztwyH95L3H2nmWZg0HGDOi4p2qbsmSIwuD6Ios"
    },
    "metadata": {
  ...
  "$id": "sources.knative.dev.v1.PingSource"
};
const schema9 = {
  "type": "object",
  "properties": {
    "ceOverrides": {
      "$ref": "D3o4p7xrSkocNjGWrLAhJ7oVnYeM4vIWoKUQnrJYa7I"
    },
    "contentType": {
    ...
    "sink": {
      "$ref": "dnJRlFUktMKzTCZAZEu2pTQWUDpHti8NlKpJQLgVok"
    },
    "timezone": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema12 = {
  ...
  "properties": {
    "ref": {
      "$ref": "rKSzQ1rXsFZstlbRPU9t0b893HgXb0t9b1ToAg"
    },
    "uri": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
function validate24(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ceOverrides !== undefined) {
      if (!validate25(data.ceOverrides, {
        instancePath: instancePath + "/ceOverrides",
        parentData: data,
        parentDataProperty: "ceOverrides",
        rootData
      })) {
    ...
    if (data.contentType !== undefined) {
      if (!validate21(data.contentType, {
    ...
    if (data.dataBase64 !== undefined) {
      if (!validate21(data.dataBase64, {
        instancePath: instancePath + "/dataBase64",
        parentData: data,
        parentDataProperty: "dataBase64",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.sink !== undefined) {
      if (!validate34(data.sink, {
        instancePath: instancePath + "/sink",
        parentData: data,
        parentDataProperty: "sink",
        rootData
      })) {
...
const schema14 = {
  ...
  "properties": {
    ...
    "ceAttributes": {
      "$ref": "JzdpVkreBs9yH84QTs0R75LeA8aBbtAkEL846UFPwjI"
    },
    "conditions": {
      "$ref": "SVBIYNS8VYeyXddMqjNWeGMoybNYEcULSuAUZBMMI"
    },
    "observedGeneration": {
...
const schema16 = {
  "type": "array",
  "items": {
    "$ref": "nU9QM0WAwT5T6nH2YewMDFzW8J4i4wumVhub6mi19A"
  },
  "nullable": true
};
const schema17 = {
...
const schema18 = {
  "type": "array",
  "items": {
    "$ref": "WtDKy7uhQ7uFj3BAKVNWtAPffnLT2PVVyqT4fLvwQ7o"
  },
  "nullable": true
};
const schema19 = {
...
function validate45(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ceAttributes !== undefined) {
      if (!validate48(data.ceAttributes, {
        instancePath: instancePath + "/ceAttributes",
        parentData: data,
        parentDataProperty: "ceAttributes",
        rootData
      })) {
    ...
    if (data.sinkUri !== undefined) {
      if (!validate21(data.sinkUri, {
        instancePath: instancePath + "/sinkUri",
        parentData: data,
        parentDataProperty: "sinkUri",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate68(data, {
  ...
  if (!(data === "sources.knative.dev/v1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="sources.knative.dev.v1.PingSource" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
