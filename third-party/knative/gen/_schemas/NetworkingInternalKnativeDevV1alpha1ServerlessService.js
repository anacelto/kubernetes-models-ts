...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "MtAKotJilvmcu93OIE2oiboZKPyqe3Rx5banY43kro"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "dPvmdQxHeCPl7anDzHUKQHIIE8MEElTNOlhG05zbhWg"
    },
    "status": {
      "$ref": "ySMz1tzRQ10pBnZAH20s7pNH2KQFOqNjptwHFlw0CAM"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "networking.internal.knative.dev.v1alpha1.ServerlessService"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.numActivators !== undefined) {
      if (!validate34(data.numActivators, {
        instancePath: instancePath + "/numActivators",
        parentData: data,
        parentDataProperty: "numActivators",
        rootData
      })) {
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.privateServiceName !== undefined) {
      if (!validate21(data.privateServiceName, {
        instancePath: instancePath + "/privateServiceName",
        parentData: data,
        parentDataProperty: "privateServiceName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="networking.internal.knative.dev.v1alpha1.ServerlessService" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
