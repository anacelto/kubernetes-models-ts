...
export const validate = validate164;
const schema61 = {
  "type": "object",
  "properties": {
    "apiVersion": {
      "$ref": "IJvUHKLJleLSTG3Zm2A2ewbH5z755jR4xysIqFao"
    },
    "kind": {
      "$ref": "sgnd1WOkM402PtzqLoOerY14e9W5l8K45u1FvpOI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "N2bw9RlXncAqWhIEWGAzANeXVhFFQRvEkoIUP8pskLA"
    },
    "status": {
      "$ref": "hK5MLIcWSSdHKDombEXAyb2BxUCZGqzGMbWe1yG1Q"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "operator.knative.dev.v1beta1.KnativeServing"
};
const schema62 = {
  "type": "string",
  "enum": ["operator.knative.dev/v1beta1"]
};
function validate165(data, {
  ...
  if (!(data === "operator.knative.dev/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema65 = {};
import { validate as validate170 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema66 = {
  "properties": {
    "additionalManifests": {
      "$ref": "JtIPU84cjvzBhFERISdNTwSCZQdw0ZawZpxO2a5RUCI"
    },
    "config": {
      "$ref": "K6sVCVNk6KuJIeSoURfshJEGRV2GEGeya7jyehrKc4"
    },
    "controller-custom-certs": {
      "$ref": "jSDVG7o2yavzV8QQx70GhCwYUYg3jcMnDtJwr5Nbyg"
    },
    "high-availability": {
      "$ref": "SrWQHvHxn5L8I7BBrhWc1hHDn69mLIkqJQGiUzUjgQ"
    },
    "workloads": {
      "$ref": "AbNgeEHaNxIwUUX6cDougKBXbnDkF77LS5b9dRFMdRo"
    },
    "deployments": {
      "$ref": "eeRkH5xlSKwZ5nlDUhF5yRUuNRqcsYSUJZW5KzOBX4"
    },
    "services": {
      "$ref": "gAg7RboTSNKVKfHjaJQIgCCMF2Z9CZp9pT2j0ZSRT4"
    },
    "podDisruptionBudgets": {
      "$ref": "rtIiawCa09PHh0KJMY3XYGk5kxpKcIScaF1NmrIdc"
    },
    "ingress": {
      "$ref": "lDH2l5COfEVQrLsFppeOf3lX0B16bdc2xZWXJq42Q"
    },
    "security": {
      "$ref": "xDJvzoTgoGyTnLpwL8Us6xEN7QMmXimpetWSblpdH0"
    },
    "manifests": {
      "$ref": "JtIPU84cjvzBhFERISdNTwSCZQdw0ZawZpxO2a5RUCI"
    },
    "registry": {
      "$ref": "SJvGOjRBHpAf0KS2Ey3q29bMiG8kPdIkZpHWGNiPjOI"
    },
    "version": {
...
const schema59 = {
  "items": {
    "$ref": "aRqyiP2ML62GLtBCS223SxQ7KIX3RNV7V0Fl5XszgGU"
  },
  "type": "array",
  "nullable": true
};
...
const schema69 = {
  "properties": {
    ...
    "type": {
      "$ref": "u28JvzpPfXcBVHSfYaNvfVmMeLluSvqngxQYrpjek"
    }
  },
  "type": "object",
  "nullable": true
...
function validate182(data, {
  ...
  if (!(data === "ConfigMap" || data === "Secret" || data === "")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema72 = {
  "type": "array",
  "items": {
    "$ref": "OKLeE6Asddj4jeYK9bDzgK2SVabFGboCAqf2MuM0"
  },
  "nullable": true
};
const schema73 = {
  ...
  "properties": {
    ...
    "livenessProbes": {
      "$ref": "0k2dgyyKArWClVxFyF9Ul9Fu61obgXmrfYJj3eM2N0s"
    },
    "annotations": {
      "$ref": "C53Ns4GLXWl74ijREqYSmV6XcmHYHGe7sMKYak37s"
    },
    "env": {
      "$ref": "yxnfQ8KU1dSq0ukzxBqZtRMsO5QwIJmqRPZyMJhXgS8"
    },
    "replicas": {
      "$ref": "ITjqUtBxFMhIL0CCAFrAl6QqD4mS4WHHo1GQBLww"
    },
    ...
    "resources": {
      "$ref": "ILAy5g6Fu9nyXJW9mP0TyLyGH0menix4XDCidPp4l5k"
    }
  }
};
const schema9 = {
...
const schema13 = {
  "items": {
    "$ref": "1d6hT5zVuuOk3Q5HjwTyBNJsWGUUZfCEXopWmJ8DI"
  },
  "type": "array",
  "nullable": true
};
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.terminationGracePeriodSeconds !== undefined) {
      if (!validate39(data.terminationGracePeriodSeconds, {
...
const schema29 = {
  "items": {
    "$ref": "TO74DdHw0CzG1ddm0LF83kKKpud9Vxz3hai6aupCX0"
  },
  "type": "array",
  "nullable": true
};
...
function validate83(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.resourceFieldRef !== undefined) {
      if (!validate89(data.resourceFieldRef, {
...
function validate77(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.envVars !== undefined) {
      if (!validate79(data.envVars, {
        instancePath: instancePath + "/envVars",
        parentData: data,
        parentDataProperty: "envVars",
        rootData
      })) {
...
function validate104(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tolerationSeconds !== undefined) {
      if (!validate39(data.tolerationSeconds, {
...
function validate126(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelectorTerms !== undefined) {
      if (!validate127(data.nodeSelectorTerms, {
...
function validate119(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate120(data.preferredDuringSchedulingIgnoredDuringExecution, {
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate126(data.requiredDuringSchedulingIgnoredDuringExecution, {
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podAffinityTerm !== undefined) {
      if (!validate58(data.podAffinityTerm, {
...
function validate118(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nodeAffinity !== undefined) {
      if (!validate119(data.nodeAffinity, {
...
const schema48 = {
  "items": {
    "$ref": "Go9AUpUfPezW4kd8yb62MVrhEi5wqPzXrjvf9G7iw"
  },
  "type": "array",
  "nullable": true
};
const schema49 = {
  "properties": {
    ...
    "limits": {
      "$ref": "SL9YCzyEaCBZHDMztG5TypgogMOoC6WSMJfYo"
    },
    "requests": {
      "$ref": "SL9YCzyEaCBZHDMztG5TypgogMOoC6WSMJfYo"
    }
...
const schema28 = {
  "properties": {
    "cpu": {
      "$ref": "2Bt35tboULrVuklfeqoGmLVndde6PNnWxdLGNGPeo"
    },
    "memory": {
      "$ref": "2Bt35tboULrVuklfeqoGmLVndde6PNnWxdLGNGPeo"
    }
...
const pattern0 = new RegExp("^([+-]?[0-9.]+)([eEinumkKMGTP]*[-+]?[0-9]*)$", "u");
...
function validate189(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.livenessProbes !== undefined) {
      if (!validate32(data.livenessProbes, {
        instancePath: instancePath + "/livenessProbes",
        parentData: data,
        parentDataProperty: "livenessProbes",
        rootData
      })) {
    ...
    if (data.readinessProbes !== undefined) {
      if (!validate32(data.readinessProbes, {
        instancePath: instancePath + "/readinessProbes",
        parentData: data,
        parentDataProperty: "readinessProbes",
        rootData
      })) {
        vErrors = vErrors === null ? validate32.errors : vErrors.concat(validate32.errors);
        errors = vErrors.length;
    ...
    if (data.tolerations !== undefined) {
      if (!validate103(data.tolerations, {
    ...
    if (data.topologySpreadConstraints !== undefined) {
      if (!validate111(data.topologySpreadConstraints, {
...
const schema76 = {
  "type": "array",
  "items": {
    "$ref": "A0blFFPl6SG522ZpIHIHCn4nbFnqfKI0qW1BKLQ"
  },
  "nullable": true
};
const schema77 = {
...
const schema78 = {
  "type": "array",
  "items": {
    "$ref": "Ke7eT2Ojz0cW7AS5XM6b6OPg8soYETTxgD4SJeK18k"
  },
  "nullable": true
};
const schema79 = {
...
const schema80 = {
  "type": "array",
  "items": {
    "$ref": "sGKSfuGCwC0lI6xCkLNn8aFJ7hl22FQd7IgxeKMA"
  },
  "nullable": true
};
const schema81 = {
...
function validate242(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.minAvailable !== undefined) {
      if (!validate244(data.minAvailable, {
...
const schema83 = {
  "properties": {
    ...
    "istio": {
      "$ref": "g8LXGJOyzAH0pGIlyRTuIuFvpSAwO5ewmLq0sLMv3Q"
    },
    "kourier": {
      "$ref": "67BVArxAU4qiAWOtVPQcwmQIeOStoEXxEdJCeROro"
    }
  },
  "type": "object",
  "nullable": true
...
const schema84 = {
  "properties": {
    ...
    "knative-ingress-gateway": {
      "$ref": "kyXQ6U8PW3DNB8inKEVEEXq8bf2pKoFOOKxjJQuwQ"
    },
...
const schema52 = {
  "properties": {
    ...
    "servers": {
      "$ref": "8r9Jli9g7XrIBSQ5a8MYsUTrCkzW3PXf1iaaYsEYA"
    }
  },
  "type": "object",
  "nullable": true
...
const schema53 = {
  "items": {
    "$ref": "ht6mFysmjhn0UkBJTHJEBYdGtWkcpdlePaGeUIk4MbI"
  },
  "type": "array",
  "nullable": true
};
const schema54 = {
  "properties": {
    ...
    "port": {
      "$ref": "sd2AIrn3dD0ZnkNvqAG0FQhLxITvoq5iYvhm9in2c"
    }
  },
  "type": "object"
};
...
function validate150(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.target_port !== undefined) {
      if (!validate140(data.target_port, {
        instancePath: instancePath + "/target_port",
        parentData: data,
        parentDataProperty: "target_port",
        rootData
      })) {
        vErrors = vErrors === null ? validate140.errors : vErrors.concat(validate140.errors);
        errors = vErrors.length;
...
function validate252(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data["knative-ingress-gateway"] !== undefined) {
      if (!validate142(data["knative-ingress-gateway"], {
        instancePath: instancePath + "/knative-ingress-gateway",
        parentData: data,
        parentDataProperty: "knative-ingress-gateway",
        rootData
      })) {
    ...
    if (data["knative-local-gateway"] !== undefined) {
      if (!validate142(data["knative-local-gateway"], {
        instancePath: instancePath + "/knative-local-gateway",
        parentData: data,
        parentDataProperty: "knative-local-gateway",
        rootData
      })) {
        vErrors = vErrors === null ? validate142.errors : vErrors.concat(validate142.errors);
        errors = vErrors.length;
...
function validate257(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data["service-type"] !== undefined) {
      if (!validate21(data["service-type"], {
        instancePath: instancePath + "/service-type",
        parentData: data,
        parentDataProperty: "service-type",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data["bootstrap-configmap"] !== undefined) {
      if (!validate21(data["bootstrap-configmap"], {
        instancePath: instancePath + "/bootstrap-configmap",
        parentData: data,
        parentDataProperty: "bootstrap-configmap",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate250(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.kourier !== undefined) {
      if (!validate257(data.kourier, {
        instancePath: instancePath + "/kourier",
        parentData: data,
        parentDataProperty: "kourier",
        rootData
      })) {
...
function validate263(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.securityGuard !== undefined) {
      if (!validate158(data.securityGuard, {
        instancePath: instancePath + "/securityGuard",
        parentData: data,
        parentDataProperty: "securityGuard",
        rootData
      })) {
        vErrors = vErrors === null ? validate158.errors : vErrors.concat(validate158.errors);
        errors = vErrors.length;
...
function validate267(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate269(data.imagePullSecrets, {
...
function validate173(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.additionalManifests !== undefined) {
      if (!validate160(data.additionalManifests, {
        instancePath: instancePath + "/additionalManifests",
        parentData: data,
        parentDataProperty: "additionalManifests",
        rootData
      })) {
    ...
    if (data["controller-custom-certs"] !== undefined) {
      if (!validate180(data["controller-custom-certs"], {
        instancePath: instancePath + "/controller-custom-certs",
        parentData: data,
        parentDataProperty: "controller-custom-certs",
        rootData
      })) {
    ...
    if (data["high-availability"] !== undefined) {
      if (!validate185(data["high-availability"], {
        instancePath: instancePath + "/high-availability",
        parentData: data,
        parentDataProperty: "high-availability",
        rootData
      })) {
    ...
    if (data.workloads !== undefined) {
      if (!validate188(data.workloads, {
        instancePath: instancePath + "/workloads",
        parentData: data,
        parentDataProperty: "workloads",
        rootData
      })) {
    ...
    if (data.deployments !== undefined) {
      if (!validate216(data.deployments, {
        instancePath: instancePath + "/deployments",
        parentData: data,
        parentDataProperty: "deployments",
        rootData
      })) {
    ...
    if (data.podDisruptionBudgets !== undefined) {
      if (!validate241(data.podDisruptionBudgets, {
        instancePath: instancePath + "/podDisruptionBudgets",
        parentData: data,
        parentDataProperty: "podDisruptionBudgets",
        rootData
      })) {
...
function validate278(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate279(data.conditions, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate140(data.observedGeneration, {
...
function validate164(data, {
  ...
  /*# sourceURL="operator.knative.dev.v1beta1.KnativeServing" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate165(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
