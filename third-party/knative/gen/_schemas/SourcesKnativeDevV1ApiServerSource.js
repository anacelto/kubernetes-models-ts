...
const schema13 = {
  ...
  "properties": {
    "spec": {
      "$ref": "8s0N1ApihAWA3G9yIbD3VCiBO7bXyiZgrudTUIKn8"
    },
    "status": {
      "$ref": "71RqLDR9kCGljIcxL5WjlGfgXk609O36hz9zOkE8"
    },
    "apiVersion": {
      "$ref": "stJFvOo4cPur8P83miGTOVDAhjoxhpjf64Xfj4RhU"
    },
    "kind": {
      "$ref": "8LnS7y3Jwzm5k8hvmi3VyXOWvUZx9tUinvjO5LlkcT4"
    },
    "metadata": {
  ...
  "$id": "sources.knative.dev.v1.ApiServerSource"
};
const schema14 = {
  "type": "object",
  "required": ["resources"],
  "properties": {
    "ceOverrides": {
      "$ref": "GKLuC7umEGkSEhbIIALntDKmuiS17vuBM23cXQd5m3I"
    },
    "mode": {
    ...
    "resources": {
      "$ref": "pBL3lDHoGjF3iIw6IlDER6ECgL0V3FQahA1c5yyk6V4"
    },
    "serviceAccountName": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    ...
    "namespaceSelector": {
      "$ref": "RVmLrT3JPACxquE4mJXhVLKnGCnR4XKsgM1Yjf9gEhg"
    }
  },
  "nullable": true
};
...
const schema17 = {
  "type": "array",
  "items": {
    "$ref": "Rai2qrUyad0TPfpGaKdhYCROIA06mjicq2tZSucQPN0"
  }
};
const schema18 = {
  "type": "object",
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ceOverrides !== undefined) {
      if (!validate37(data.ceOverrides, {
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ceAttributes !== undefined) {
      if (!validate66(data.ceAttributes, {
...
function validate35(data, {
  ...
  /*# sourceURL="sources.knative.dev.v1.ApiServerSource" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
