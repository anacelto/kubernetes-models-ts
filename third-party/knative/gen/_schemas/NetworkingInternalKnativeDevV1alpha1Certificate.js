...
const schema8 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "ohYkK4PZOtS7Xv18oRYf58tsjVdruyLEgGATAMtlcOo"
    },
    "status": {
      "$ref": "CJYwCdk2elyGGnZBSsfI9kLzSAFgeYvdb6cvQNzPw"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "networking.internal.knative.dev.v1alpha1.Certificate"
};
const schema9 = {
  "type": "string",
...
const schema15 = {
  ...
  "properties": {
    ...
    "http01Challenges": {
      "$ref": "7uKXIN1nP2YeocqEyTjmJ2h5MucZy57S42bs1oPI1Y"
    },
    "notAfter": {
...
const schema19 = {
  "type": "array",
  "items": {
    "$ref": "XOX5qC6ZYKDZawtCvyQaLhNPmJMHw32noYjZ5R8YCkQ"
  },
  "nullable": true
};
const schema20 = {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.serviceNamespace !== undefined) {
      if (!validate22(data.serviceNamespace, {
    ...
    if (data.servicePort !== undefined) {
      if (!validate57(data.servicePort, {
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.annotations !== undefined) {
      if (!validate40(data.annotations, {
    ...
    if (data.http01Challenges !== undefined) {
      if (!validate53(data.http01Challenges, {
        instancePath: instancePath + "/http01Challenges",
        parentData: data,
        parentDataProperty: "http01Challenges",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="networking.internal.knative.dev.v1alpha1.Certificate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
