...
const schema8 = {
  ...
  "properties": {
    "spec": {
      "$ref": "BCVPRSB0cnh7rXFtVf0ett9DIX01CmWd5Cm5owo4xyA"
    },
    "status": {
      "$ref": "5pnuxMxtL8jk4lAwZkou5liphtg0NaJQPxn9fI7WfM"
    },
    "apiVersion": {
      "$ref": "Bhn8mFTNTnsVEGrMUU6y02Zn94ok49siSLajGpmo"
    },
    "kind": {
      "$ref": "rrdokNVzGPvwbtzOcak7zpk9OUJIiizWfiOAyrr7E"
    },
    "metadata": {
  ...
  "$id": "eventing.knative.dev.v1beta1.EventType"
};
const schema9 = {
  "type": "object",
  "properties": {
...
function validate24(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.schemaData !== undefined) {
      if (!validate21(data.schemaData, {
        instancePath: instancePath + "/schemaData",
        parentData: data,
        parentDataProperty: "schemaData",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema15 = {
  "type": "string",
  "enum": ["eventing.knative.dev/v1beta1"]
};
function validate47(data, {
  ...
  if (!(data === "eventing.knative.dev/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="eventing.knative.dev.v1beta1.EventType" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
