...
export const validate = validate94;
const schema33 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "spec": {
      "$ref": "iNKcqkG4L4ajhwi4FBG1X8Hqugqn1pVNMhWQKfjSc"
    },
    "status": {
      "$ref": "SibiTlWauQrJkZYuCaYgewvilUoMMD5AemyT7Jo9k"
    }
  },
...
const schema37 = {};
import { validate as validate100 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema38 = {
  ...
  "properties": {
    ...
    "traffic": {
      "$ref": "94gWgS8RpfeVYwC45jQHv3t1uO9KvpSlO9oDrW2R0Q"
    }
  },
  "nullable": true
};
...
function validate144(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.containerPort !== undefined) {
      if (!validate145(data.containerPort, {
...
function validate157(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.capabilities !== undefined) {
      if (!validate159(data.capabilities, {
    ...
    if (data.seccompProfile !== undefined) {
      if (!validate167(data.seccompProfile, {
...
function validate117(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.securityContext !== undefined) {
      if (!validate157(data.securityContext, {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate174(data.volumeMounts, {
...
function validate224(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.resourceFieldRef !== undefined) {
      if (!validate231(data.resourceFieldRef, {
        instancePath: instancePath + "/resourceFieldRef",
        parentData: data,
        parentDataProperty: "resourceFieldRef",
        rootData
...
function validate220(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate222(data.downwardAPI, {
    ...
    if (data.serviceAccountToken !== undefined) {
      if (!validate240(data.serviceAccountToken, {
...
function validate112(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.containers !== undefined) {
      if (!validate116(data.containers, {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate190(data.imagePullSecrets, {
...
const schema31 = {
  "type": "array",
  "items": {
    "$ref": "aA8RU0fzYf8DCcaxvmNLMH01KOVXB4GgXx6YXEpaJg"
  },
  "nullable": true
};
const schema32 = {
...
function validate86(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configurationName !== undefined) {
      if (!validate24(data.configurationName, {
        instancePath: instancePath + "/configurationName",
        parentData: data,
        parentDataProperty: "configurationName",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.latestRevision !== undefined) {
      if (!validate27(data.latestRevision, {
        instancePath: instancePath + "/latestRevision",
        parentData: data,
        parentDataProperty: "latestRevision",
        rootData
      })) {
        vErrors = vErrors === null ? validate27.errors : vErrors.concat(validate27.errors);
        errors = vErrors.length;
    ...
    if (data.revisionName !== undefined) {
      if (!validate24(data.revisionName, {
        instancePath: instancePath + "/revisionName",
        parentData: data,
        parentDataProperty: "revisionName",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
function validate260(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate267(data.conditions, {
...
function validate94(data, {
  ...
  /*# sourceURL="serving.knative.dev.v1.Service" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
