...
export const validate = validate146;
const schema53 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "wA9TnOhjxXooXvOWwQjKTAQOchhJX7xdf8q3sWQeRv0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "wIBpqATM7VqA3xC64WHbbtA6dSX2L46SglEqj2PYRY"
    },
    "status": {
  ...
  "$id": "operator.knative.dev.v1beta1.KnativeEventing"
};
const schema54 = {
  "type": "string",
...
const schema57 = {};
import { validate as validate152 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema58 = {
  "properties": {
    ...
    "source": {
      "$ref": "Vnl7iCpJRO0KZnabb7FwGTuFMGo1pDRSLFlazjPhe8"
    },
    "manifests": {
      "$ref": "JtIPU84cjvzBhFERISdNTwSCZQdw0ZawZpxO2a5RUCI"
    },
...
function validate167(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate180(data.volumeMounts, {
...
function validate220(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.minAvailable !== undefined) {
      if (!validate222(data.minAvailable, {
...
function validate228(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ceph !== undefined) {
      if (!validate140(data.ceph, {
        instancePath: instancePath + "/ceph",
        parentData: data,
        parentDataProperty: "ceph",
        rootData
      })) {
...
function validate237(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate239(data.imagePullSecrets, {
...
function validate155(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.additionalManifests !== undefined) {
      if (!validate142(data.additionalManifests, {
    ...
    if (data.defaultBrokerClass !== undefined) {
      if (!validate21(data.defaultBrokerClass, {
        instancePath: instancePath + "/defaultBrokerClass",
        parentData: data,
        parentDataProperty: "defaultBrokerClass",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data["high-availability"] !== undefined) {
      if (!validate163(data["high-availability"], {
    ...
    if (data.deployments !== undefined) {
      if (!validate194(data.deployments, {
    ...
    if (data.podDisruptionBudgets !== undefined) {
      if (!validate219(data.podDisruptionBudgets, {
    ...
    if (data.sinkBindingSelectionMode !== undefined) {
      if (!validate21(data.sinkBindingSelectionMode, {
        instancePath: instancePath + "/sinkBindingSelectionMode",
        parentData: data,
        parentDataProperty: "sinkBindingSelectionMode",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate249(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate261(data.observedGeneration, {
...
function validate146(data, {
  ...
  /*# sourceURL="operator.knative.dev.v1beta1.KnativeEventing" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate147(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
