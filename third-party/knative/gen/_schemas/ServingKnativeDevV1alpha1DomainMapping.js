...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "HrhdIHsPGxFYHFCEfYTfw7Zrxhi1tmUy7Bkbncho"
    },
    "kind": {
  ...
  "$id": "serving.knative.dev.v1alpha1.DomainMapping"
};
const schema9 = {
  "type": "string",
...
function validate24(data, {
  ...
  if (!(data === "serving.knative.dev/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="serving.knative.dev.v1alpha1.DomainMapping" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
