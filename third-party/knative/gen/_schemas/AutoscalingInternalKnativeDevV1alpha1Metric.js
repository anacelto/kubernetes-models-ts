...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "E4TZ0xt9ymafTlEKPF0HHSJy5DEZKCaJkVMgrEusR8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "s2cYZH1nIpEcK5ZIRInP2NIBx0L3waBYnzgC2nwy38"
    },
    "status": {
      "$ref": "7wd2RqSwDvCLCLk7extiLEIeBxIB7f9bmYgvgk5Ri4"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "autoscaling.internal.knative.dev.v1alpha1.Metric"
};
const schema10 = {
  "type": "string",
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.panicWindow === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "panicWindow"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.scrapeTarget === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "scrapeTarget"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.stableWindow === undefined) {
      const err3 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "stableWindow"
        }
      };
      if (vErrors === null) {
        vErrors = [err3];
    ...
    if (data.panicWindow !== undefined) {
      if (!validate21(data.panicWindow, {
        instancePath: instancePath + "/panicWindow",
        parentData: data,
        parentDataProperty: "panicWindow",
        rootData
      })) {
    ...
    if (data.scrapeTarget !== undefined) {
      if (!validate22(data.scrapeTarget, {
        instancePath: instancePath + "/scrapeTarget",
        parentData: data,
        parentDataProperty: "scrapeTarget",
        rootData
      })) {
    ...
    if (data.stableWindow !== undefined) {
      if (!validate21(data.stableWindow, {
        instancePath: instancePath + "/stableWindow",
        parentData: data,
        parentDataProperty: "stableWindow",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="autoscaling.internal.knative.dev.v1alpha1.Metric" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
