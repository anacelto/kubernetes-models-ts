...
import { validate } from "../../_schemas/EventingKnativeDevV1beta1EventType";
 ...
 * EventType represents a type of event that can be consumed from a Broker.
 */
export class EventType extends Model<IEventType> implements IEventType {
...
static apiVersion: IEventType["apiVersion"] = "eventing.knative.dev/v1beta1";
static kind: IEventType["kind"] = "EventType";
static is = createTypeMetaGuard<IEventType>(EventType);

constructor(data?: ModelData<IEventType>) {
  super();

  this.setDefinedProps({
    apiVersion: EventType.apiVersion,
    kind: EventType.kind,
    ...data
  } as IEventType);
}
...
setValidateFunc(EventType, validate as ValidateFunc<IEventType>);
