...
import { validate } from "../../_schemas/OperatorKnativeDevV1beta1KnativeServing";

/**
 * Schema for the knativeservings API
 */
export interface IKnativeServing {
  /**
 ...
 * Schema for the knativeservings API
 */
export class KnativeServing extends Model<IKnativeServing> implements IKnativeServing {
  "apiVersion": IKnativeServing["apiVersion"];
  "kind": IKnativeServing["kind"];
  "metadata"?: IKnativeServing["metadata"];
  "spec"?: IKnativeServing["spec"];
  "status"?: IKnativeServing["status"];

static apiVersion: IKnativeServing["apiVersion"] = "operator.knative.dev/v1beta1";
static kind: IKnativeServing["kind"] = "KnativeServing";
static is = createTypeMetaGuard<IKnativeServing>(KnativeServing);

constructor(data?: ModelData<IKnativeServing>) {
  super();

  this.setDefinedProps({
    apiVersion: KnativeServing.apiVersion,
    kind: KnativeServing.kind,
    ...data
  } as IKnativeServing);
}
}
...
setValidateFunc(KnativeServing, validate as ValidateFunc<IKnativeServing>);
