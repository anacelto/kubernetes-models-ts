...
import { validate } from "../../_schemas/ServingKnativeDevV1Configuration";
 ...
 * Configuration represents the "floating HEAD" of a linear history of Revisions. Users create new Revisions by updating the Configuration's spec. The "latest created" revision's name is available under status, as is the "latest ready" revision's name. See also: https://github.com/knative/serving/blob/main/docs/spec/overview.md#configuration
 */
export class Configuration extends Model<IConfiguration> implements IConfiguration {
...
static apiVersion: IConfiguration["apiVersion"] = "serving.knative.dev/v1";
static kind: IConfiguration["kind"] = "Configuration";
static is = createTypeMetaGuard<IConfiguration>(Configuration);
...
setValidateFunc(Configuration, validate as ValidateFunc<IConfiguration>);
