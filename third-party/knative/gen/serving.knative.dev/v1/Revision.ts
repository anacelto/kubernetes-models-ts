...
import { validate } from "../../_schemas/ServingKnativeDevV1Revision";
 ...
 *  See also: https://github.com/knative/serving/blob/main/docs/spec/overview.md#revision
 */
export class Revision extends Model<IRevision> implements IRevision {
  "apiVersion": IRevision["apiVersion"];
  "kind": IRevision["kind"];
  "metadata"?: IRevision["metadata"];
  "spec"?: IRevision["spec"];
  "status"?: IRevision["status"];

static apiVersion: IRevision["apiVersion"] = "serving.knative.dev/v1";
static kind: IRevision["kind"] = "Revision";
static is = createTypeMetaGuard<IRevision>(Revision);

constructor(data?: ModelData<IRevision>) {
  super();
...
setValidateFunc(Revision, validate as ValidateFunc<IRevision>);
