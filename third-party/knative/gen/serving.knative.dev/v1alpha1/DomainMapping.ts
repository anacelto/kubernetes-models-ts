...
import { validate } from "../../_schemas/ServingKnativeDevV1alpha1DomainMapping";
 ...
 * DomainMapping is a mapping from a custom hostname to an Addressable.
 */
export class DomainMapping extends Model<IDomainMapping> implements IDomainMapping {
...
static apiVersion: IDomainMapping["apiVersion"] = "serving.knative.dev/v1alpha1";
static kind: IDomainMapping["kind"] = "DomainMapping";
static is = createTypeMetaGuard<IDomainMapping>(DomainMapping);

constructor(data?: ModelData<IDomainMapping>) {
  super();

  this.setDefinedProps({
    apiVersion: DomainMapping.apiVersion,
    kind: DomainMapping.kind,
    ...data
  } as IDomainMapping);
}
}
...
setValidateFunc(DomainMapping, validate as ValidateFunc<IDomainMapping>);
