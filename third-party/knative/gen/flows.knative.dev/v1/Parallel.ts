...
import { validate } from "../../_schemas/FlowsKnativeDevV1Parallel";
 ...
 * Parallel defines conditional branches that will be wired in series through Channels and Subscriptions.
 */
export class Parallel extends Model<IParallel> implements IParallel {
  "spec"?: IParallel["spec"];
...
static apiVersion: IParallel["apiVersion"] = "flows.knative.dev/v1";
static kind: IParallel["kind"] = "Parallel";
static is = createTypeMetaGuard<IParallel>(Parallel);

constructor(data?: ModelData<IParallel>) {
  super();

  this.setDefinedProps({
    apiVersion: Parallel.apiVersion,
    kind: Parallel.kind,
    ...data
  } as IParallel);
}
...
setValidateFunc(Parallel, validate as ValidateFunc<IParallel>);
