...
import { validate } from "../../_schemas/NetworkingInternalKnativeDevV1alpha1Certificate";
...
static apiVersion: ICertificate["apiVersion"] = "networking.internal.knative.dev/v1alpha1";
