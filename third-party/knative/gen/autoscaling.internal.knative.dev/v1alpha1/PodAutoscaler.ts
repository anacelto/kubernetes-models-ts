...
import { validate } from "../../_schemas/AutoscalingInternalKnativeDevV1alpha1PodAutoscaler";
 ...
 * PodAutoscaler is a Knative abstraction that encapsulates the interface by which Knative components instantiate autoscalers.  This definition is an abstraction that may be backed by multiple definitions.  For more information, see the Knative Pluggability presentation: https://docs.google.com/presentation/d/19vW9HFZ6Puxt31biNZF3uLRejDmu82rxJIk1cWmxF7w/edit
 */
export class PodAutoscaler extends Model<IPodAutoscaler> implements IPodAutoscaler {
...
static apiVersion: IPodAutoscaler["apiVersion"] = "autoscaling.internal.knative.dev/v1alpha1";
static kind: IPodAutoscaler["kind"] = "PodAutoscaler";
static is = createTypeMetaGuard<IPodAutoscaler>(PodAutoscaler);

constructor(data?: ModelData<IPodAutoscaler>) {
  super();

  this.setDefinedProps({
    apiVersion: PodAutoscaler.apiVersion,
    kind: PodAutoscaler.kind,
    ...data
  } as IPodAutoscaler);
}
}
...
setValidateFunc(PodAutoscaler, validate as ValidateFunc<IPodAutoscaler>);
