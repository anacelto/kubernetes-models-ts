...
import { validate } from "../../_schemas/AutoscalingInternalKnativeDevV1alpha1Metric";
...
static apiVersion: IMetric["apiVersion"] = "autoscaling.internal.knative.dev/v1alpha1";
static kind: IMetric["kind"] = "Metric";
static is = createTypeMetaGuard<IMetric>(Metric);
...
setValidateFunc(Metric, validate as ValidateFunc<IMetric>);
