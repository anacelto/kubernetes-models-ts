 ...
 * Sequence defines a sequence of Subscribers that will be wired in series through Channels and Subscriptions.
 */
export declare class Sequence extends Model<ISequence> implements ISequence {
    "spec"?: ISequence["spec"];
    "status"?: ISequence["status"];
    "apiVersion": ISequence["apiVersion"];
    "kind": ISequence["kind"];
    "metadata"?: ISequence["metadata"];
    static apiVersion: ISequence["apiVersion"];
    static kind: ISequence["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISequence>;
