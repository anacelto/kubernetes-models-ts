 ...
 *  See also: https://github.com/knative/serving/blob/main/docs/spec/overview.md#revision
 */
export declare class Revision extends Model<IRevision> implements IRevision {
    "apiVersion": IRevision["apiVersion"];
    "kind": IRevision["kind"];
    "metadata"?: IRevision["metadata"];
    "spec"?: IRevision["spec"];
    "status"?: IRevision["status"];
    static apiVersion: IRevision["apiVersion"];
    static kind: IRevision["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IRevision>;
