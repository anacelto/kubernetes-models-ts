 ...
 * ContainerSource is an event source that starts a container image which generates events under certain situations and sends messages to a sink URI
 */
export declare class ContainerSource extends Model<IContainerSource> implements IContainerSource {
    ...
    static apiVersion: IContainerSource["apiVersion"];
    static kind: IContainerSource["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IContainerSource>;
