 ...
 * ApiServerSource is an event source that brings Kubernetes API server events into Knative.
 */
export declare class ApiServerSource extends Model<IApiServerSource> implements IApiServerSource {
    ...
    static apiVersion: IApiServerSource["apiVersion"];
    static kind: IApiServerSource["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IApiServerSource>;
