 ...
 * PingSource describes an event source with a fixed payload produced on a specified cron schedule.
 */
export declare class PingSource extends Model<IPingSource> implements IPingSource {
    ...
    static apiVersion: IPingSource["apiVersion"];
    static kind: IPingSource["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPingSource>;
