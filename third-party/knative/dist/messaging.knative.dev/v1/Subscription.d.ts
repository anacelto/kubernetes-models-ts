 ...
 * Subscription routes events received on a Channel to a DNS name and corresponds to the subscriptions.channels.knative.dev CRD.
 */
export declare class Subscription extends Model<ISubscription> implements ISubscription {
    ...
    static apiVersion: ISubscription["apiVersion"];
    static kind: ISubscription["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISubscription>;
