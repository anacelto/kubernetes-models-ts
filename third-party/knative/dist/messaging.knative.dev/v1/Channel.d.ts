 ...
 * Channel represents a generic Channel. It is normally used when we want a Channel, but do not need a specific Channel implementation.
 */
export declare class Channel extends Model<IChannel> implements IChannel {
    "spec"?: IChannel["spec"];
    "status"?: IChannel["status"];
    "apiVersion": IChannel["apiVersion"];
    "kind": IChannel["kind"];
    "metadata"?: IChannel["metadata"];
    static apiVersion: IChannel["apiVersion"];
    static kind: IChannel["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IChannel>;
