 ...
 * Schema for the knativeservings API
 */
export declare class KnativeServing extends Model<IKnativeServing> implements IKnativeServing {
    ...
    static apiVersion: IKnativeServing["apiVersion"];
    static kind: IKnativeServing["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IKnativeServing>;
