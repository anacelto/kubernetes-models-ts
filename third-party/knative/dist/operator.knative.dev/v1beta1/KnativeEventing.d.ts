 ...
 * Schema for the knativeeventings API
 */
export declare class KnativeEventing extends Model<IKnativeEventing> implements IKnativeEventing {
    ...
    static apiVersion: IKnativeEventing["apiVersion"];
    static kind: IKnativeEventing["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IKnativeEventing>;
