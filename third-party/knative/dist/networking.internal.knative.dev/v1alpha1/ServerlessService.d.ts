 ...
 * ServerlessService is a proxy for the K8s service objects containing the endpoints for the revision, whether those are endpoints of the activator or revision pods. See: https://knative.page.link/naxz for details.
 */
export declare class ServerlessService extends Model<IServerlessService> implements IServerlessService {
    ...
    static apiVersion: IServerlessService["apiVersion"];
    static kind: IServerlessService["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IServerlessService>;
