...
export const validate = validate274;
const schema80 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "GzpDuEpLhObhbmAqWXrYW3QK4zTwQDY15RmrgEMc3U"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "fvGFLfBMMGIku7LzbxB0IThj4lBruDRWrHiiq5yADQ"
    },
    "status": {
      "$ref": "KdldZeLcjOwI3BRIJ1yb3CDK6Eg47hV1IYsrIr9FH4"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "rabbitmq.com.v1beta1.RabbitmqCluster"
};
const schema81 = {
  "type": "string",
...
const schema84 = {};
import { validate as validate280 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema85 = {
  "properties": {
    ...
    "override": {
      "$ref": "cENSRSCZPZ341kxiigotqIXMP1b5BSXSL3DojUYD1c"
    },
    "persistence": {
      "$ref": "Eb0B07ZgDuAnMQSMYnCw0geTz7iiue65PjvpcxcTJ8"
    },
    "rabbitmq": {
      "$ref": "b5VW0VHSCAbC4YmjLyYuqNN0Af1EvljPNFNT6YDFEQ"
    },
    "replicas": {
      "$ref": "BrKctPJmiycijAtdnozoD25qrdUCdBbn8oRYDo7O3nA"
    },
    "resources": {
      "$ref": "SU8OWCJiP2w4tGewa07RE5VSktfFWohZyFk42JtYw"
    },
    "secretBackend": {
      "$ref": "zCEEESsCX6NUIyRTKQ9Wzmq3aEjx5D5pMHkGRE4bQ"
    },
    "service": {
      "$ref": "LgeHzq7ENtTL6p6yeqw9zwxeH5aCe2bOaiM08Dr5en8"
    },
    "skipPostDeploySteps": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
    "terminationGracePeriodSeconds": {
      "$ref": "Yqq5PD5iN1WxOSboOFI5hMzaEjuBMzy3yhStlZlTx0"
    },
    "tls": {
      "$ref": "ixXsRbW7x5WpkLcdxa84hpAWuyEKVdAi4Z4a0pIvD4"
    },
    "tolerations": {
...
function validate68(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelectorTerms !== undefined) {
      if (!validate69(data.nodeSelectorTerms, {
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate68(data.requiredDuringSchedulingIgnoredDuringExecution, {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nodeAffinity !== undefined) {
      if (!validate61(data.nodeAffinity, {
...
const schema86 = {
  "properties": {
    ...
    "statefulSet": {
      "$ref": "iSYrtr4snfebX8ZuqSSElbDgHDXZ5NhbkuCMCsjrzw"
    }
  },
  "type": "object",
  "nullable": true
...
function validate305(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.appProtocol !== undefined) {
      if (!validate54(data.appProtocol, {
...
function validate318(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.timeoutSeconds !== undefined) {
      if (!validate55(data.timeoutSeconds, {
...
function validate290(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allocateLoadBalancerNodePorts !== undefined) {
      if (!validate56(data.allocateLoadBalancerNodePorts, {
    ...
    if (data.externalIPs !== undefined) {
      if (!validate26(data.externalIPs, {
    ...
    if (data.externalName !== undefined) {
      if (!validate54(data.externalName, {
    ...
    if (data.externalTrafficPolicy !== undefined) {
      if (!validate54(data.externalTrafficPolicy, {
    ...
    if (data.healthCheckNodePort !== undefined) {
      if (!validate55(data.healthCheckNodePort, {
    ...
    if (data.internalTrafficPolicy !== undefined) {
      if (!validate54(data.internalTrafficPolicy, {
    ...
    if (data.ipFamilyPolicy !== undefined) {
      if (!validate54(data.ipFamilyPolicy, {
    ...
    if (data.loadBalancerClass !== undefined) {
      if (!validate54(data.loadBalancerClass, {
    ...
    if (data.loadBalancerIP !== undefined) {
      if (!validate54(data.loadBalancerIP, {
    ...
    if (data.publishNotReadyAddresses !== undefined) {
      if (!validate56(data.publishNotReadyAddresses, {
    ...
    if (data.sessionAffinity !== undefined) {
      if (!validate54(data.sessionAffinity, {
    ...
    if (data.sessionAffinityConfig !== undefined) {
      if (!validate317(data.sessionAffinityConfig, {
...
const schema93 = {
  "properties": {
    ...
    "spec": {
      "$ref": "iLBpANiUZTJe66fCW5HXVzYCBUJdhsMJ6TvnfZh7k"
    }
  },
  "type": "object",
  "nullable": true
...
const schema94 = {
  "properties": {
    ...
    "template": {
      "$ref": "tSE3ti6hxOb2hNgB70Ziu78PJGroSVtUO4OOQnTqc0Y"
    },
    "updateStrategy": {
      "$ref": "RZYVu0x9ssF6e6BbrssVRFZY5x0x9divx8z6o5hV8"
    },
    "volumeClaimTemplates": {
      "$ref": "JNly1ZvUr1PVifUqRZMPVXDTnzaiOdTeuIUBJpGVI"
    }
  },
  "type": "object",
  "nullable": true
...
const schema95 = {
  "properties": {
    "metadata": {
      "$ref": "ZyPZ8BdIklvzTWZOq0P64ChQWaAl1oHxcmFupXsoPas"
    },
    "spec": {
      "$ref": "gewGpgscVINWPq9RTezXCYOlm1sBYJhccJC399IZo"
    }
  },
  "type": "object",
  "nullable": true
...
function validate132(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configMapKeyRef !== undefined) {
      if (!validate77(data.configMapKeyRef, {
    ...
    if (data.secretKeyRef !== undefined) {
      if (!validate77(data.secretKeyRef, {
...
function validate147(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configMapRef !== undefined) {
      if (!validate81(data.configMapRef, {
...
function validate91(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.httpHeaders !== undefined) {
      if (!validate93(data.httpHeaders, {
...
function validate109(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.failureThreshold !== undefined) {
      if (!validate55(data.failureThreshold, {
    ...
    if (data.initialDelaySeconds !== undefined) {
      if (!validate55(data.initialDelaySeconds, {
    ...
    if (data.periodSeconds !== undefined) {
      if (!validate55(data.periodSeconds, {
    ...
    if (data.successThreshold !== undefined) {
      if (!validate55(data.successThreshold, {
...
function validate188(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.hostProcess !== undefined) {
      if (!validate56(data.hostProcess, {
...
function validate166(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowPrivilegeEscalation !== undefined) {
      if (!validate56(data.allowPrivilegeEscalation, {
    ...
    if (data.capabilities !== undefined) {
      if (!validate168(data.capabilities, {
    ...
    if (data.readOnlyRootFilesystem !== undefined) {
      if (!validate56(data.readOnlyRootFilesystem, {
    ...
    if (data.runAsNonRoot !== undefined) {
      if (!validate56(data.runAsNonRoot, {
    ...
    if (data.seLinuxOptions !== undefined) {
      if (!validate178(data.seLinuxOptions, {
    ...
    if (data.seccompProfile !== undefined) {
      if (!validate184(data.seccompProfile, {
    ...
    if (data.windowsOptions !== undefined) {
      if (!validate188(data.windowsOptions, {
...
function validate212(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.livenessProbe !== undefined) {
      if (!validate109(data.livenessProbe, {
    ...
    if (data.readinessProbe !== undefined) {
      if (!validate109(data.readinessProbe, {
    ...
    if (data.securityContext !== undefined) {
      if (!validate166(data.securityContext, {
    ...
    if (data.startupProbe !== undefined) {
      if (!validate109(data.startupProbe, {
    ...
    if (data.volumeDevices !== undefined) {
      if (!validate194(data.volumeDevices, {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate199(data.volumeMounts, {
...
function validate354(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.targetContainerName !== undefined) {
      if (!validate54(data.targetContainerName, {
...
function validate412(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.supplementalGroups !== undefined) {
      if (!validate420(data.supplementalGroups, {
...
function validate435(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.matchLabelKeys !== undefined) {
      if (!validate26(data.matchLabelKeys, {
...
function validate487(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodePublishSecretRef !== undefined) {
      if (!validate235(data.nodePublishSecretRef, {
...
function validate506(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataSource !== undefined) {
      if (!validate237(data.dataSource, {
    ...
    if (data.dataSourceRef !== undefined) {
      if (!validate237(data.dataSourceRef, {
...
function validate502(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.volumeClaimTemplate !== undefined) {
      if (!validate503(data.volumeClaimTemplate, {
...
function validate556(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.chapAuthDiscovery !== undefined) {
      if (!validate56(data.chapAuthDiscovery, {
    ...
    if (data.chapAuthSession !== undefined) {
      if (!validate56(data.chapAuthSession, {
...
function validate591(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate593(data.downwardAPI, {
    ...
    if (data.serviceAccountToken !== undefined) {
      if (!validate597(data.serviceAccountToken, {
...
function validate447(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.awsElasticBlockStore !== undefined) {
      if (!validate448(data.awsElasticBlockStore, {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate494(data.downwardAPI, {
        instancePath: instancePath + "/downwardAPI",
        parentData: data,
        parentDataProperty: "downwardAPI",
        rootData
    ...
    if (data.flexVolume !== undefined) {
      if (!validate525(data.flexVolume, {
    ...
    if (data.gcePersistentDisk !== undefined) {
      if (!validate536(data.gcePersistentDisk, {
    ...
    if (data.persistentVolumeClaim !== undefined) {
      if (!validate575(data.persistentVolumeClaim, {
    ...
    if (data.photonPersistentDisk !== undefined) {
      if (!validate579(data.photonPersistentDisk, {
    ...
    if (data.portworxVolume !== undefined) {
      if (!validate583(data.portworxVolume, {
    ...
    if (data.vsphereVolume !== undefined) {
      if (!validate648(data.vsphereVolume, {
...
function validate334(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.activeDeadlineSeconds !== undefined) {
      if (!validate107(data.activeDeadlineSeconds, {
    ...
    if (data.automountServiceAccountToken !== undefined) {
      if (!validate56(data.automountServiceAccountToken, {
    ...
    if (data.containers !== undefined) {
      if (!validate338(data.containers, {
    ...
    if (data.enableServiceLinks !== undefined) {
      if (!validate56(data.enableServiceLinks, {
    ...
    if (data.hostNetwork !== undefined) {
      if (!validate56(data.hostNetwork, {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate208(data.imagePullSecrets, {
    ...
    if (data.initContainers !== undefined) {
      if (!validate392(data.initContainers, {
    ...
    if (data.preemptionPolicy !== undefined) {
      if (!validate54(data.preemptionPolicy, {
    ...
    if (data.readinessGates !== undefined) {
      if (!validate404(data.readinessGates, {
    ...
    if (data.restartPolicy !== undefined) {
      if (!validate54(data.restartPolicy, {
    ...
    if (data.runtimeClassName !== undefined) {
      if (!validate54(data.runtimeClassName, {
    ...
    if (data.schedulerName !== undefined) {
      if (!validate54(data.schedulerName, {
    ...
    if (data.securityContext !== undefined) {
      if (!validate412(data.securityContext, {
        instancePath: instancePath + "/securityContext",
        parentData: data,
        parentDataProperty: "securityContext",
        rootData
    ...
    if (data.serviceAccount !== undefined) {
      if (!validate54(data.serviceAccount, {
    ...
    if (data.setHostnameAsFQDN !== undefined) {
      if (!validate56(data.setHostnameAsFQDN, {
    ...
    if (data.shareProcessNamespace !== undefined) {
      if (!validate56(data.shareProcessNamespace, {
    ...
    if (data.tolerations !== undefined) {
      if (!validate266(data.tolerations, {
    ...
    if (data.topologySpreadConstraints !== undefined) {
      if (!validate434(data.topologySpreadConstraints, {
...
const schema152 = {
  "properties": {
    "rollingUpdate": {
      "$ref": "tHtti3rVKhyqR4w81dw6Yb4C8fFbEeP4WOuzQhcRtjw"
    },
    "type": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
function validate659(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.maxUnavailable !== undefined) {
      if (!validate84(data.maxUnavailable, {
...
function validate658(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.rollingUpdate !== undefined) {
      if (!validate659(data.rollingUpdate, {
...
const schema154 = {
  "items": {
    "$ref": "evXFaTpFGVJ2EUymhshH1GZyI4F4x6eLp5bAJjSwuQ"
  },
  "type": "array",
  "nullable": true
};
...
function validate327(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.podManagementPolicy !== undefined) {
      if (!validate54(data.podManagementPolicy, {
    ...
    if (data.serviceName !== undefined) {
      if (!validate54(data.serviceName, {
    ...
    if (data.updateStrategy !== undefined) {
      if (!validate658(data.updateStrategy, {
    ...
    if (data.volumeClaimTemplates !== undefined) {
      if (!validate665(data.volumeClaimTemplates, {
...
function validate287(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.statefulSet !== undefined) {
      if (!validate325(data.statefulSet, {
...
const schema159 = {
  "properties": {
    "additionalConfig": {
      "$ref": "IEbEpItzOX9HhPOnoeVT8wNvIF417d1J4R7BS7CLLpo"
    },
    "additionalPlugins": {
      "$ref": "G6RDLZxKn7nWcmpu0iX5SQ5AtJgY32iDBzbw92bIVM"
    },
    "advancedConfig": {
      "$ref": "r0vOOXqsARtAJBek1W5qyeSEpF9iXyysexdg0j2Oc"
    },
    "envConfig": {
      "$ref": "r0vOOXqsARtAJBek1W5qyeSEpF9iXyysexdg0j2Oc"
    }
...
const schema161 = {
  "items": {
    "$ref": "tRdA2PL6xL16pA71DKdYrRDFDQDTK5kMRAyovmkGdM"
  },
  "maxItems": 100,
  "type": "array",
  "nullable": true
...
function validate692(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.additionalConfig !== undefined) {
      if (!validate693(data.additionalConfig, {
        instancePath: instancePath + "/additionalConfig",
        parentData: data,
        parentDataProperty: "additionalConfig",
        rootData
      })) {
    ...
    if (data.additionalPlugins !== undefined) {
      if (!validate695(data.additionalPlugins, {
        instancePath: instancePath + "/additionalPlugins",
        parentData: data,
        parentDataProperty: "additionalPlugins",
        rootData
      })) {
    ...
    if (data.advancedConfig !== undefined) {
      if (!validate265(data.advancedConfig, {
        instancePath: instancePath + "/advancedConfig",
        parentData: data,
        parentDataProperty: "advancedConfig",
        rootData
      })) {
    ...
    if (data.envConfig !== undefined) {
      if (!validate265(data.envConfig, {
        instancePath: instancePath + "/envConfig",
        parentData: data,
        parentDataProperty: "envConfig",
        rootData
      })) {
        vErrors = vErrors === null ? validate265.errors : vErrors.concat(validate265.errors);
        errors = vErrors.length;
...
const schema165 = {
  "properties": {
    "vault": {
      "$ref": "azSFuPiA07VIMB5u5KbiX31jud0bdZPAk5GTuOtDOoU"
    }
  },
  "type": "object",
  "nullable": true
...
const schema166 = {
  "properties": {
    ...
    "tls": {
      "$ref": "vkfl10htwRWjjSx2nkKSlAr5oAuMYH0uZEiaVsGleo"
    }
  },
  "type": "object",
  "nullable": true
...
function validate714(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.altNames !== undefined) {
      if (!validate54(data.altNames, {
        instancePath: instancePath + "/altNames",
        parentData: data,
        parentDataProperty: "altNames",
        rootData
      })) {
        vErrors = vErrors === null ? validate54.errors : vErrors.concat(validate54.errors);
        errors = vErrors.length;
    ...
    if (data.ipSans !== undefined) {
      if (!validate54(data.ipSans, {
        instancePath: instancePath + "/ipSans",
        parentData: data,
        parentDataProperty: "ipSans",
        rootData
      })) {
        vErrors = vErrors === null ? validate54.errors : vErrors.concat(validate54.errors);
        errors = vErrors.length;
    ...
    if (data.pkiIssuerPath !== undefined) {
      if (!validate54(data.pkiIssuerPath, {
        instancePath: instancePath + "/pkiIssuerPath",
        parentData: data,
        parentDataProperty: "pkiIssuerPath",
        rootData
      })) {
        vErrors = vErrors === null ? validate54.errors : vErrors.concat(validate54.errors);
        errors = vErrors.length;
...
function validate709(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultUserPath !== undefined) {
      if (!validate54(data.defaultUserPath, {
        instancePath: instancePath + "/defaultUserPath",
        parentData: data,
        parentDataProperty: "defaultUserPath",
        rootData
      })) {
        vErrors = vErrors === null ? validate54.errors : vErrors.concat(validate54.errors);
        errors = vErrors.length;
    ...
    if (data.defaultUserUpdaterImage !== undefined) {
      if (!validate54(data.defaultUserUpdaterImage, {
        instancePath: instancePath + "/defaultUserUpdaterImage",
        parentData: data,
        parentDataProperty: "defaultUserUpdaterImage",
        rootData
      })) {
        vErrors = vErrors === null ? validate54.errors : vErrors.concat(validate54.errors);
        errors = vErrors.length;
...
const schema168 = {
  ...
  "properties": {
    ...
    "type": {
      "$ref": "gbkb5Tz7xctWi741obbaJh59guAyOk0VxXqmhKR3zg"
    }
  },
  "type": "object",
  "nullable": true
...
function validate730(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.caSecretName !== undefined) {
      if (!validate54(data.caSecretName, {
    ...
    if (data.disableNonTLSListeners !== undefined) {
      if (!validate56(data.disableNonTLSListeners, {
        instancePath: instancePath + "/disableNonTLSListeners",
        parentData: data,
        parentDataProperty: "disableNonTLSListeners",
        rootData
      })) {
        vErrors = vErrors === null ? validate56.errors : vErrors.concat(validate56.errors);
        errors = vErrors.length;
...
function validate283(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.override !== undefined) {
      if (!validate287(data.override, {
        instancePath: instancePath + "/override",
        parentData: data,
        parentDataProperty: "override",
        rootData
      })) {
    ...
    if (data.persistence !== undefined) {
      if (!validate685(data.persistence, {
        instancePath: instancePath + "/persistence",
        parentData: data,
        parentDataProperty: "persistence",
        rootData
      })) {
    ...
    if (data.rabbitmq !== undefined) {
      if (!validate692(data.rabbitmq, {
        instancePath: instancePath + "/rabbitmq",
        parentData: data,
        parentDataProperty: "rabbitmq",
        rootData
      })) {
    ...
    if (data.secretBackend !== undefined) {
      if (!validate708(data.secretBackend, {
        instancePath: instancePath + "/secretBackend",
        parentData: data,
        parentDataProperty: "secretBackend",
        rootData
      })) {
    ...
    if (data.skipPostDeploySteps !== undefined) {
      if (!validate56(data.skipPostDeploySteps, {
        instancePath: instancePath + "/skipPostDeploySteps",
        parentData: data,
        parentDataProperty: "skipPostDeploySteps",
        rootData
      })) {
        vErrors = vErrors === null ? validate56.errors : vErrors.concat(validate56.errors);
        errors = vErrors.length;
    ...
    if (data.terminationGracePeriodSeconds !== undefined) {
      if (!validate728(data.terminationGracePeriodSeconds, {
        instancePath: instancePath + "/terminationGracePeriodSeconds",
        parentData: data,
        parentDataProperty: "terminationGracePeriodSeconds",
        rootData
...
const schema172 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "xid9d0MWFVAM96uQlAG7vJ6nujK0A47D65gTAbD8K54"
    },
    "defaultUser": {
      "$ref": "nZtOZisMbBMCdHuFSsVrhJ3IKb7r50bDCRemuJssV0"
    },
    "observedGeneration": {
      "$ref": "NW88HfrvS38u8Yy207QW6S7qFs2gsa0jBgSYGvqPw"
    }
...
function validate740(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate741(data.lastTransitionTime, {
...
const schema176 = {
  "properties": {
    "secretReference": {
      "$ref": "AjSLe531Ldhi3BehKGJ0An2iOaYC042rJ88nlRcWyY"
    },
    "serviceReference": {
...
function validate749(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretReference !== undefined) {
      if (!validate750(data.secretReference, {
        instancePath: instancePath + "/secretReference",
        parentData: data,
        parentDataProperty: "secretReference",
        rootData
      })) {
    ...
    if (data.serviceReference !== undefined) {
      if (!validate757(data.serviceReference, {
        instancePath: instancePath + "/serviceReference",
        parentData: data,
        parentDataProperty: "serviceReference",
        rootData
      })) {
...
function validate737(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate739(data.conditions, {
    ...
    if (data.defaultUser !== undefined) {
      if (!validate749(data.defaultUser, {
        instancePath: instancePath + "/defaultUser",
        parentData: data,
        parentDataProperty: "defaultUser",
        rootData
      })) {
...
function validate274(data, {
  ...
  /*# sourceURL="rabbitmq.com.v1beta1.RabbitmqCluster" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate275(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
