...
import { validate } from "../../_schemas/RabbitmqComV1beta1RabbitmqCluster";
 ...
 * RabbitmqCluster is the Schema for the RabbitmqCluster API. Each instance of this object corresponds to a single RabbitMQ cluster.
 */
export class RabbitmqCluster extends Model<IRabbitmqCluster> implements IRabbitmqCluster {
...
static apiVersion: IRabbitmqCluster["apiVersion"] = "rabbitmq.com/v1beta1";
static kind: IRabbitmqCluster["kind"] = "RabbitmqCluster";
static is = createTypeMetaGuard<IRabbitmqCluster>(RabbitmqCluster);

constructor(data?: ModelData<IRabbitmqCluster>) {
  super();

  this.setDefinedProps({
    apiVersion: RabbitmqCluster.apiVersion,
...
setValidateFunc(RabbitmqCluster, validate as ValidateFunc<IRabbitmqCluster>);
