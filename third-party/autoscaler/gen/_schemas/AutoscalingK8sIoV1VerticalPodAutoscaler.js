...
const schema11 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "OwOkBuCgKsocNza9gn21oSydtmw0obe2FGNnu59m9M"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "xEYCGToYrpNJnAAO3fvqNrxvrCQyIhu5jSfOgcrnYWQ"
    },
    "status": {
  ...
  "$id": "autoscaling.k8s.io.v1.VerticalPodAutoscaler"
};
const schema12 = {
  "type": "string",
  "enum": ["autoscaling.k8s.io/v1"]
};
...
const schema16 = {
  "properties": {
    ...
    "resourcePolicy": {
      "$ref": "cmpdoGWj3vfOo0XxYwa3PJStma0aTnrlfUe9MFng0w4"
    },
    "targetRef": {
      "$ref": "36oHgK9AYPuHkZgpX8JUstwE02TUfMTTo0isPAjojO4"
    },
    "updatePolicy": {
      "$ref": "9hNDBnSuy8xX1cLyG3vQcePOizigLKg8xk0wHWrUS8"
    }
  },
  "required": ["targetRef"],
  "type": "object"
...
const schema19 = {
  "properties": {
    "containerPolicies": {
      "$ref": "Ba59J2fYbdDzYPAmxu0pxSFTpj4eQBZiy5h12dy21U"
    }
  },
  "type": "object",
  "nullable": true
...
const schema20 = {
  "items": {
    "$ref": "6xOadQ8ZbN7EBIOtz3Ft54XG6BPSyOPt9nk9vKy04Y"
  },
  "type": "array",
  "nullable": true
};
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.controlledResources !== undefined) {
      if (!validate48(data.controlledResources, {
    ...
    if (data.controlledValues !== undefined) {
      if (!validate51(data.controlledValues, {
        instancePath: instancePath + "/controlledValues",
        parentData: data,
        parentDataProperty: "controlledValues",
        rootData
      })) {
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.containerPolicies !== undefined) {
      if (!validate45(data.containerPolicies, {
...
function validate65(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.minReplicas !== undefined) {
      if (!validate66(data.minReplicas, {
...
function validate38(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.recommenders !== undefined) {
      if (!validate39(data.recommenders, {
        instancePath: instancePath + "/recommenders",
        parentData: data,
        parentDataProperty: "recommenders",
        rootData
      })) {
    ...
    if (data.resourcePolicy !== undefined) {
      if (!validate44(data.resourcePolicy, {
    ...
    if (data.updatePolicy !== undefined) {
      if (!validate65(data.updatePolicy, {
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate75(data.lastTransitionTime, {
...
function validate85(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.uncappedTarget !== undefined) {
      if (!validate22(data.uncappedTarget, {
...
function validate83(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.containerRecommendations !== undefined) {
      if (!validate84(data.containerRecommendations, {
...
function validate72(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.recommendation !== undefined) {
      if (!validate83(data.recommendation, {
...
function validate29(data, {
  ...
  /*# sourceURL="autoscaling.k8s.io.v1.VerticalPodAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
