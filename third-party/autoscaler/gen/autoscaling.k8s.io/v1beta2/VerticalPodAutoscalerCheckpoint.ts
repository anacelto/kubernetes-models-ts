...
import { validate } from "../../_schemas/AutoscalingK8sIoV1beta2VerticalPodAutoscalerCheckpoint";
 ...
 * VerticalPodAutoscalerCheckpoint is the checkpoint of the internal state of VPA that is used for recovery after recommender's restart.
 */
export class VerticalPodAutoscalerCheckpoint extends Model<IVerticalPodAutoscalerCheckpoint> implements IVerticalPodAutoscalerCheckpoint {
...
static apiVersion: IVerticalPodAutoscalerCheckpoint["apiVersion"] = "autoscaling.k8s.io/v1beta2";
static kind: IVerticalPodAutoscalerCheckpoint["kind"] = "VerticalPodAutoscalerCheckpoint";
static is = createTypeMetaGuard<IVerticalPodAutoscalerCheckpoint>(VerticalPodAutoscalerCheckpoint);

constructor(data?: ModelData<IVerticalPodAutoscalerCheckpoint>) {
  super();

  this.setDefinedProps({
    apiVersion: VerticalPodAutoscalerCheckpoint.apiVersion,
    kind: VerticalPodAutoscalerCheckpoint.kind,
    ...data
  } as IVerticalPodAutoscalerCheckpoint);
}
}


setValidateFunc(VerticalPodAutoscalerCheckpoint, validate as ValidateFunc<IVerticalPodAutoscalerCheckpoint>);
