...
import { validate } from "../../_schemas/ArgoprojIoV1alpha1AnalysisTemplate";
...
export class AnalysisTemplate extends Model<IAnalysisTemplate> implements IAnalysisTemplate {
...
static apiVersion: IAnalysisTemplate["apiVersion"] = "argoproj.io/v1alpha1";
static kind: IAnalysisTemplate["kind"] = "AnalysisTemplate";
static is = createTypeMetaGuard<IAnalysisTemplate>(AnalysisTemplate);

constructor(data?: ModelData<IAnalysisTemplate>) {
  super();

  this.setDefinedProps({
    apiVersion: AnalysisTemplate.apiVersion,
    kind: AnalysisTemplate.kind,
    ...data
  } as IAnalysisTemplate);
}
}


setValidateFunc(AnalysisTemplate, validate as ValidateFunc<IAnalysisTemplate>);
