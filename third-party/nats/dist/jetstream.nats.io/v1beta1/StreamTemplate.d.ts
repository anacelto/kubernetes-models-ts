...
export declare class StreamTemplate extends Model<IStreamTemplate> implements IStreamTemplate {
    ...
    static apiVersion: IStreamTemplate["apiVersion"];
    static kind: IStreamTemplate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IStreamTemplate>;
