...
const schema8 = {
  ...
  "properties": {
    "spec": {
      "$ref": "SOV8EVCMrd1vJP670zsoO7FA9uR2Hpryi7j7l1rgjE"
    },
    "apiVersion": {
      "$ref": "OHqGNMuxQBJiVRkvkoJWg1tx5ZsmHMozRkzpJEIB3k"
    },
    "kind": {
      "$ref": "j3v2TLIepEvV8sGkVpJ4yytLYmLaQmI0srnbx0"
    },
    "metadata": {
  ...
  "$id": "jetstream.nats.io.v1beta2.Account"
};
const schema9 = {
  "type": "object",
  "properties": {
    ...
    "tls": {
      "$ref": "mcneHShF4vdyA9TzyXO2vFZDIzKdmXXq4uyYx6JAM"
    },
    "creds": {
      "$ref": "2EHxz5Exum6gnUA2MjU5A0J6QNZhweYY6x8nrLAoU8"
    }
  },
  "nullable": true
};
...
function validate24(data, {
  ...
  /*# sourceURL="jetstream.nats.io.v1beta2.Account" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
