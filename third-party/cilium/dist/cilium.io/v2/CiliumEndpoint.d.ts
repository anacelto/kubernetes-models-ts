 ...
 * CiliumEndpoint is the status of a Cilium policy rule.
 */
export declare class CiliumEndpoint extends Model<ICiliumEndpoint> implements ICiliumEndpoint {
    ...
    static apiVersion: ICiliumEndpoint["apiVersion"];
    static kind: ICiliumEndpoint["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumEndpoint>;
