 ...
 * CiliumLocalRedirectPolicy is a Kubernetes Custom Resource that contains a specification to redirect traffic locally within a node.
 */
export declare class CiliumLocalRedirectPolicy extends Model<ICiliumLocalRedirectPolicy> implements ICiliumLocalRedirectPolicy {
    ...
    static apiVersion: ICiliumLocalRedirectPolicy["apiVersion"];
    static kind: ICiliumLocalRedirectPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumLocalRedirectPolicy>;
