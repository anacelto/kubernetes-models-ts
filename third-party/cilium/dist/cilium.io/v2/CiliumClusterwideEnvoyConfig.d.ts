...
export declare class CiliumClusterwideEnvoyConfig extends Model<ICiliumClusterwideEnvoyConfig> implements ICiliumClusterwideEnvoyConfig {
    ...
    static apiVersion: ICiliumClusterwideEnvoyConfig["apiVersion"];
    static kind: ICiliumClusterwideEnvoyConfig["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumClusterwideEnvoyConfig>;
