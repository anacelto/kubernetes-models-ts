 ...
 * CiliumNetworkPolicy is a Kubernetes third-party resource with an extended version of NetworkPolicy.
 */
export declare class CiliumNetworkPolicy extends Model<ICiliumNetworkPolicy> implements ICiliumNetworkPolicy {
    ...
    static apiVersion: ICiliumNetworkPolicy["apiVersion"];
    static kind: ICiliumNetworkPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumNetworkPolicy>;
