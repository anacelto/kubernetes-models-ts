 ...
 * CiliumNode represents a node managed by Cilium. It contains a specification to control various node specific configuration aspects and a status section to represent the status of the node.
 */
export declare class CiliumNode extends Model<ICiliumNode> implements ICiliumNode {
    ...
    static apiVersion: ICiliumNode["apiVersion"];
    static kind: ICiliumNode["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumNode>;
