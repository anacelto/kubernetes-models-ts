...
export declare class CiliumEnvoyConfig extends Model<ICiliumEnvoyConfig> implements ICiliumEnvoyConfig {
    ...
    static apiVersion: ICiliumEnvoyConfig["apiVersion"];
    static kind: ICiliumEnvoyConfig["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumEnvoyConfig>;
