 ...
 * CiliumClusterwideNetworkPolicy is a Kubernetes third-party resource with an modified version of CiliumNetworkPolicy which is cluster scoped rather than namespace scoped.
 */
export declare class CiliumClusterwideNetworkPolicy extends Model<ICiliumClusterwideNetworkPolicy> implements ICiliumClusterwideNetworkPolicy {
    ...
    static apiVersion: ICiliumClusterwideNetworkPolicy["apiVersion"];
    static kind: ICiliumClusterwideNetworkPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumClusterwideNetworkPolicy>;
