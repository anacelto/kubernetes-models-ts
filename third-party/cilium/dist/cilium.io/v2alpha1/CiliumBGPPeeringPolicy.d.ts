 ...
 * CiliumBGPPeeringPolicy is a Kubernetes third-party resource for instructing Cilium's BGP control plane to create virtual BGP routers.
 */
export declare class CiliumBGPPeeringPolicy extends Model<ICiliumBGPPeeringPolicy> implements ICiliumBGPPeeringPolicy {
    ...
    static apiVersion: ICiliumBGPPeeringPolicy["apiVersion"];
    static kind: ICiliumBGPPeeringPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumBGPPeeringPolicy>;
