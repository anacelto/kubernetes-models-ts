 ...
 * CiliumEndpointSlice contains a group of CoreCiliumendpoints.
 */
export declare class CiliumEndpointSlice extends Model<ICiliumEndpointSlice> implements ICiliumEndpointSlice {
    ...
    static apiVersion: ICiliumEndpointSlice["apiVersion"];
    static kind: ICiliumEndpointSlice["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICiliumEndpointSlice>;
