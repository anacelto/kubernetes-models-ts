...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "bPpTzgmlN1dwBUsTH5UzX1l6MrRMNRhdLQOBPC1Ls"
    },
    "metadata": {
  ...
  "$id": "cilium.io.v2.CiliumClusterwideEnvoyConfig"
};
const schema9 = {
  "type": "string",
  "enum": ["cilium.io/v2"]
...
const schema10 = {
  "type": "string",
  "enum": ["CiliumClusterwideEnvoyConfig"]
};
function validate26(data, {
  ...
  if (!(data === "CiliumClusterwideEnvoyConfig")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="cilium.io.v2.CiliumClusterwideEnvoyConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
