...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "85lTgkRqoBhRwqWZfZc0NZ0GpHApmOzHjKWWb8tLwE8"
    },
    "kind": {
      "$ref": "lJLy3fAmsVpkdpnEgfQQhBXCSqInQbaMG3t2bb6GV4"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "arKVmM5Mw4rDkmqAR6CuKYHirfpMyWL7CxpJSKFAyQ"
    }
  },
  "required": ["metadata", "apiVersion", "kind"],
  "$id": "cilium.io.v2alpha1.CiliumBGPPeeringPolicy"
};
const schema9 = {
  "type": "string",
  "enum": ["cilium.io/v2alpha1"]
};
...
function validate26(data, {
  ...
  if (!(data === "CiliumBGPPeeringPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    ...
    "virtualRouters": {
      "$ref": "7qLEPCSAgQmb8idoke2PBeLNWYLrapqgDslWbAhzcI"
    }
  },
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate44(data.matchLabels, {
...
const schema21 = {
  "items": {
    "$ref": "34RM5ybk3wXLzOQW79oALz2ePJN4P8dVqibopAQkaU"
  },
  "minItems": 1,
  "type": "array"
};
const schema22 = {
  "properties": {
    ...
    "localASN": {
      "$ref": "W112HN6ILKH6FosqedBd3udbBwYWuGp09N6hGvmdYcg"
    },
    "neighbors": {
      "$ref": "a4d2gVq0Dz3rnmSr9PBH6yM8i73kk8qnXUplDIgkE"
    }
  },
...
const schema24 = {
  "items": {
    "$ref": "NzEpRBySz9N2lNEaTd1KZGJjBQFObjZ4jRgssDf0v4"
  },
  "minItems": 1,
  "type": "array"
};
const schema25 = {
  "properties": {
    ...
    "peerAddress": {
      "$ref": "RbnRug7lqhXSsRJ1RzGbimvieDquGnkCkxGpNLWTOOw"
    }
  },
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.peerAddress !== undefined) {
      if (!validate57(data.peerAddress, {
        instancePath: instancePath + "/peerAddress",
        parentData: data,
        parentDataProperty: "peerAddress",
        rootData
      })) {
...
function validate50(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.localASN === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "localASN"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.exportPodCIDR !== undefined) {
      if (!validate51(data.exportPodCIDR, {
        instancePath: instancePath + "/exportPodCIDR",
        parentData: data,
        parentDataProperty: "exportPodCIDR",
        rootData
      })) {
    ...
    if (data.localASN !== undefined) {
      if (!validate22(data.localASN, {
        instancePath: instancePath + "/localASN",
        parentData: data,
        parentDataProperty: "localASN",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.neighbors !== undefined) {
      if (!validate54(data.neighbors, {
        instancePath: instancePath + "/neighbors",
        parentData: data,
        parentDataProperty: "neighbors",
        rootData
      })) {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.virtualRouters === undefined) {
      const err1 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "virtualRouters"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.nodeSelector !== undefined) {
      if (!validate33(data.nodeSelector, {
    ...
    if (data.virtualRouters !== undefined) {
      if (!validate49(data.virtualRouters, {
        instancePath: instancePath + "/virtualRouters",
        parentData: data,
        parentDataProperty: "virtualRouters",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="cilium.io.v2alpha1.CiliumBGPPeeringPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
