...
const schema16 = {
  ...
  "properties": {
    ...
    "status": {
      "$ref": "25bqWthl2WsIMVqs5pZiUnLKOK6jkPamRg5jpcdjA"
    }
  },
...
const schema21 = {
  "properties": {
    ...
    "policy": {
      "$ref": "5E7NqjM5T2ZUGRvUy4NUnTzEdCCHlfGYr5tCJpZBR8"
    },
    "state": {
...
function validate112(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.addressing !== undefined) {
      if (!validate113(data.addressing, {
...
const schema38 = {
  "properties": {
    "egress": {
      "$ref": "ZV7K7fF1zxzPnloq5svt71nwCotx0Rix9DDrMn4kmVs"
    },
    "ingress": {
      "$ref": "ZV7K7fF1zxzPnloq5svt71nwCotx0Rix9DDrMn4kmVs"
    }
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.controllers !== undefined) {
      if (!validate53(data.controllers, {
    ...
    if (data["external-identifiers"] !== undefined) {
      if (!validate75(data["external-identifiers"], {
    ...
    if (data["named-ports"] !== undefined) {
      if (!validate105(data["named-ports"], {
    ...
    if (data.networking !== undefined) {
      if (!validate112(data.networking, {
