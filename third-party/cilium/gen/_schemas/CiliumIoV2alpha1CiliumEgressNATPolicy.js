...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "qf6S4fx9e5oNq9a7dKC5RMqQEkAyTBEec7VXF3jPic"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "kHCMjroSqhW1BlZDeoJkSA27k8dXNU54EYsGk40sv4I"
    }
  },
  "required": ["metadata", "apiVersion", "kind"],
  "$id": "cilium.io.v2alpha1.CiliumEgressNATPolicy"
};
const schema15 = {
  "type": "string",
...
const schema19 = {
  ...
  "required": ["destinationCIDRs", "egress", "egressSourceIP"],
  "type": "object",
  "nullable": true
};
const schema20 = {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.egressSourceIP === undefined) {
      const err3 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "egressSourceIP"
        }
      };
      if (vErrors === null) {
        vErrors = [err3];
    ...
    if (data.egressSourceIP !== undefined) {
      if (!validate57(data.egressSourceIP, {
        instancePath: instancePath + "/egressSourceIP",
        parentData: data,
        parentDataProperty: "egressSourceIP",
        rootData
      })) {
...
function validate37(data, {
  ...
  /*# sourceURL="cilium.io.v2alpha1.CiliumEgressNATPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
