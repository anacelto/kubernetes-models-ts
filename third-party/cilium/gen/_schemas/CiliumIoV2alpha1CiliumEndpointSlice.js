...
const schema8 = {
  ...
  "properties": {
    ...
    "endpoints": {
      "$ref": "GkJnu4DpIC3Zn5IvJMqk5mAPx35eaxR3YkLmg6VZjwk"
    },
    "kind": {
      "$ref": "xjPcwlgIYA3Jy9fZ03xVfhYuAWtqnbQWpqaChiH53ZY"
    },
    "metadata": {
  ...
  "required": ["endpoints", "metadata", "apiVersion", "kind"],
  "$id": "cilium.io.v2alpha1.CiliumEndpointSlice"
};
const schema9 = {
  "type": "string",
...
const schema10 = {
  "items": {
    "$ref": "e4aUu23kK1wQTCtMPwsLwEJwUAwqDH1J3cuJ41JOzAQ"
  },
  "type": "array"
};
const schema11 = {
...
function validate27(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data["named-ports"] !== undefined) {
      if (!validate34(data["named-ports"], {
...
function validate23(data, {
  ...
  /*# sourceURL="cilium.io.v2alpha1.CiliumEndpointSlice" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
