...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "B7zYiANXq0itRUO1C6IDTb1KHcBHVOShd2Qz4AYg"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "dyYQ0fDkynuj6C0VGF0raHIdTcOFRYRtLqQNlyTJQ"
    }
  },
  "required": ["metadata", "apiVersion", "kind"],
  "$id": "cilium.io.v2alpha1.CiliumBGPLoadBalancerIPPool"
};
const schema15 = {
  "type": "string",
...
const schema16 = {
  "type": "string",
  "enum": ["CiliumBGPLoadBalancerIPPool"]
};
function validate40(data, {
  ...
  if (!(data === "CiliumBGPLoadBalancerIPPool")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lbSelector !== undefined) {
      if (!validate22(data.lbSelector, {
        instancePath: instancePath + "/lbSelector",
        parentData: data,
        parentDataProperty: "lbSelector",
        rootData
      })) {
...
function validate37(data, {
  ...
  /*# sourceURL="cilium.io.v2alpha1.CiliumBGPLoadBalancerIPPool" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
