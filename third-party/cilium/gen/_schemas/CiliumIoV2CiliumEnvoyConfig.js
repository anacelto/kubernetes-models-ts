...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "jA5p3bPn7np1tuTMsy27ByKe0kOPMpEJMMWEBdrBg"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "s78KoIbGTEXxt0Ty4Nr8xMqRB7av5OKXPwqXwJBGM"
    }
  },
  "required": ["metadata", "apiVersion", "kind"],
  "$id": "cilium.io.v2.CiliumEnvoyConfig"
};
const schema9 = {
  "type": "string",
  "enum": ["cilium.io/v2"]
...
const schema13 = {
  "properties": {
    "backendServices": {
      "$ref": "ibMr12e3QhdOErwrZYSKmYmAf88XVWFu5WOb58DI"
    },
    "resources": {
      "$ref": "TvsDOhdSgsJPYJYYOLR0VS9CTDl7VugOo2gQX7MeM"
    },
    "services": {
      "$ref": "6s8blkorHPmHPvptygYZWEE0VRSU6iB8ws4bOxM9U"
    }
  },
  "type": "object",
  "nullable": true
...
const schema14 = {
  "items": {
    "$ref": "ZFNFwTD2CLu1fzoJjhxATABgcwOFyqO0n5ETF6WGE"
  },
  "type": "array",
  "nullable": true
};
...
const schema19 = {
  "items": {
    "$ref": "QsbmRIFiL6aPRrmGOnPMSC7r76guosXjj0PpHNe2s"
  },
  "type": "array",
  "nullable": true
};
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendServices !== undefined) {
      if (!validate33(data.backendServices, {
        instancePath: instancePath + "/backendServices",
        parentData: data,
        parentDataProperty: "backendServices",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="cilium.io.v2.CiliumEnvoyConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
