...
const schema83 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "OXNHKOauuGiZbFtIdmoeTAXKrXFkmqSyx7OBr54tcmI"
    },
    "specs": {
      "$ref": "k80z5hVmXlW2gvyJxhNArKOb9lPta2JpGbDxFvyUuS8"
    },
    "status": {
...
const schema88 = {
  ...
  "properties": {
    "egress": {
      "$ref": "PmyDI4y5gTpqsmVJnjxz8Aq6MdY1ySibYbdhfw1g"
    },
    "egressDeny": {
      "$ref": "Squ1o09B0fagO9zuMc9pdcVlXqr5b2mYAUaeCq8N7w"
    },
    "endpointSelector": {
      "$ref": "MoGDayu8Ocv96tQKxfapfjS5FyHfwdRTT6IHaYmM"
    },
    "ingress": {
      "$ref": "GT8lxpYS3KsLh4IK9oO8PkiBZqRrtsFslayaGb3AsrQ"
    },
    "ingressDeny": {
      "$ref": "SiGNX51gVBbdJCUMADjTrY8UBin0NJTQtVzMBnsKw"
    },
    "labels": {
...
const schema66 = {
  "items": {
    "$ref": "g4FFjPcfAPkN6y8phex0xjdOxhMSrxAFTBji5gnXY"
  },
  "type": "array",
  "nullable": true
};
const schema67 = {
  "properties": {
    ...
    "toEntities": {
      "$ref": "98WP4d7de7Ko8hr4MJWPl1zAhBbc01gjiht3HNTjpGw"
    },
    "toFQDNs": {
...
const schema32 = {
  "items": {
    "$ref": "eislAOb4f5Y5VlCYwkqLPPSCDObYyNOUhVFtIy2yEg"
  },
  "type": "array",
  "nullable": true
};
...
function validate75(data, {
  ...
  if (!(data === "all" || data === "world" || data === "cluster" || data === "host" || data === "init" || data === "ingress" || data === "unmanaged" || data === "remote-node" || data === "health" || data === "none" || data === "kube-apiserver")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema68 = {
  "items": {
    "$ref": "5Db8NTvuIdRyaXYasB28RAf0K2wD7cp1aNSno2UNoI4"
  },
  "type": "array",
  "nullable": true
};
...
const schema70 = {
  "items": {
    "$ref": "e2C5ZeacaBrWJe7lI2lYKXkKo9rjgeMwiRx1c3F7zjQ"
  },
  "type": "array",
  "nullable": true
};
...
const schema72 = {
  "items": {
    "$ref": "0d6di7SRmojecKDpj4CXI2hjJkNN7xmMkx420z9wN4"
  },
  "type": "array",
  "nullable": true
};
...
const schema89 = {
  "items": {
    "$ref": "CjCyHJJkummONUF5bBzZC8ihq0uKRecZZycYLyYD50"
  },
  "type": "array",
  "nullable": true
};
