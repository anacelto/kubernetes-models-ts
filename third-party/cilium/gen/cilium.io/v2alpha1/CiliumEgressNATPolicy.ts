...
import { validate } from "../../_schemas/CiliumIoV2alpha1CiliumEgressNATPolicy";
...
export class CiliumEgressNATPolicy extends Model<ICiliumEgressNATPolicy> implements ICiliumEgressNATPolicy {
...
static apiVersion: ICiliumEgressNATPolicy["apiVersion"] = "cilium.io/v2alpha1";
static kind: ICiliumEgressNATPolicy["kind"] = "CiliumEgressNATPolicy";
static is = createTypeMetaGuard<ICiliumEgressNATPolicy>(CiliumEgressNATPolicy);

constructor(data?: ModelData<ICiliumEgressNATPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: CiliumEgressNATPolicy.apiVersion,
    kind: CiliumEgressNATPolicy.kind,
    ...data
  } as ICiliumEgressNATPolicy);
}
}


setValidateFunc(CiliumEgressNATPolicy, validate as ValidateFunc<ICiliumEgressNATPolicy>);
