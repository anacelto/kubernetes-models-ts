...
import { validate } from "../../_schemas/CiliumIoV2alpha1CiliumBGPLoadBalancerIPPool";
 ...
 * CiliumBGPLoadBalancerIPPool is a Kubernetes third-party resource which instructs the BGP control plane to allocate and advertise IPs for Services of type LoadBalancer.
 */
export class CiliumBGPLoadBalancerIPPool extends Model<ICiliumBGPLoadBalancerIPPool> implements ICiliumBGPLoadBalancerIPPool {
...
static apiVersion: ICiliumBGPLoadBalancerIPPool["apiVersion"] = "cilium.io/v2alpha1";
static kind: ICiliumBGPLoadBalancerIPPool["kind"] = "CiliumBGPLoadBalancerIPPool";
static is = createTypeMetaGuard<ICiliumBGPLoadBalancerIPPool>(CiliumBGPLoadBalancerIPPool);

constructor(data?: ModelData<ICiliumBGPLoadBalancerIPPool>) {
  super();

  this.setDefinedProps({
    apiVersion: CiliumBGPLoadBalancerIPPool.apiVersion,
    kind: CiliumBGPLoadBalancerIPPool.kind,
    ...data
  } as ICiliumBGPLoadBalancerIPPool);
}
}


setValidateFunc(CiliumBGPLoadBalancerIPPool, validate as ValidateFunc<ICiliumBGPLoadBalancerIPPool>);
