...
import { validate } from "../../_schemas/CiliumIoV2CiliumEgressGatewayPolicy";
...
export class CiliumEgressGatewayPolicy extends Model<ICiliumEgressGatewayPolicy> implements ICiliumEgressGatewayPolicy {
...
static apiVersion: ICiliumEgressGatewayPolicy["apiVersion"] = "cilium.io/v2";
static kind: ICiliumEgressGatewayPolicy["kind"] = "CiliumEgressGatewayPolicy";
static is = createTypeMetaGuard<ICiliumEgressGatewayPolicy>(CiliumEgressGatewayPolicy);

constructor(data?: ModelData<ICiliumEgressGatewayPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: CiliumEgressGatewayPolicy.apiVersion,
    kind: CiliumEgressGatewayPolicy.kind,
    ...data
  } as ICiliumEgressGatewayPolicy);
}
}


setValidateFunc(CiliumEgressGatewayPolicy, validate as ValidateFunc<ICiliumEgressGatewayPolicy>);
