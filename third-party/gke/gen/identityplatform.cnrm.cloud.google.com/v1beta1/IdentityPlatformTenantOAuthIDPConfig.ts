...
import { validate } from "../../_schemas/IdentityplatformCnrmCloudGoogleComV1beta1IdentityPlatformTenantOAuthIDPConfig";
...
export class IdentityPlatformTenantOAuthIDPConfig extends Model<IIdentityPlatformTenantOAuthIDPConfig> implements IIdentityPlatformTenantOAuthIDPConfig {
...
static apiVersion: IIdentityPlatformTenantOAuthIDPConfig["apiVersion"] = "identityplatform.cnrm.cloud.google.com/v1beta1";
static kind: IIdentityPlatformTenantOAuthIDPConfig["kind"] = "IdentityPlatformTenantOAuthIDPConfig";
static is = createTypeMetaGuard<IIdentityPlatformTenantOAuthIDPConfig>(IdentityPlatformTenantOAuthIDPConfig);

constructor(data?: ModelData<IIdentityPlatformTenantOAuthIDPConfig>) {
  super();

  this.setDefinedProps({
    apiVersion: IdentityPlatformTenantOAuthIDPConfig.apiVersion,
    kind: IdentityPlatformTenantOAuthIDPConfig.kind,
    ...data
  } as IIdentityPlatformTenantOAuthIDPConfig);
}
}


setValidateFunc(IdentityPlatformTenantOAuthIDPConfig, validate as ValidateFunc<IIdentityPlatformTenantOAuthIDPConfig>);
