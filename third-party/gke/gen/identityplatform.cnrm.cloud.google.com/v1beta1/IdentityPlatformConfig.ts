...
import { validate } from "../../_schemas/IdentityplatformCnrmCloudGoogleComV1beta1IdentityPlatformConfig";
...
export class IdentityPlatformConfig extends Model<IIdentityPlatformConfig> implements IIdentityPlatformConfig {
...
static apiVersion: IIdentityPlatformConfig["apiVersion"] = "identityplatform.cnrm.cloud.google.com/v1beta1";
static kind: IIdentityPlatformConfig["kind"] = "IdentityPlatformConfig";
static is = createTypeMetaGuard<IIdentityPlatformConfig>(IdentityPlatformConfig);

constructor(data?: ModelData<IIdentityPlatformConfig>) {
  super();

  this.setDefinedProps({
    apiVersion: IdentityPlatformConfig.apiVersion,
    kind: IdentityPlatformConfig.kind,
    ...data
  } as IIdentityPlatformConfig);
}
}


setValidateFunc(IdentityPlatformConfig, validate as ValidateFunc<IIdentityPlatformConfig>);
