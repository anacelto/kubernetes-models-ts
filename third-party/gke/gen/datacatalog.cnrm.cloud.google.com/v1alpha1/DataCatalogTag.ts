...
import { validate } from "../../_schemas/DatacatalogCnrmCloudGoogleComV1alpha1DataCatalogTag";
...
export class DataCatalogTag extends Model<IDataCatalogTag> implements IDataCatalogTag {
...
static apiVersion: IDataCatalogTag["apiVersion"] = "datacatalog.cnrm.cloud.google.com/v1alpha1";
static kind: IDataCatalogTag["kind"] = "DataCatalogTag";
static is = createTypeMetaGuard<IDataCatalogTag>(DataCatalogTag);

constructor(data?: ModelData<IDataCatalogTag>) {
  super();

  this.setDefinedProps({
    apiVersion: DataCatalogTag.apiVersion,
    kind: DataCatalogTag.kind,
    ...data
  } as IDataCatalogTag);
}
}
...
setValidateFunc(DataCatalogTag, validate as ValidateFunc<IDataCatalogTag>);
