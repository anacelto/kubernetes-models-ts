...
import { validate } from "../../_schemas/DataprocCnrmCloudGoogleComV1beta1DataprocWorkflowTemplate";
...
export class DataprocWorkflowTemplate extends Model<IDataprocWorkflowTemplate> implements IDataprocWorkflowTemplate {
  "apiVersion": IDataprocWorkflowTemplate["apiVersion"];
  "kind": IDataprocWorkflowTemplate["kind"];
  "metadata"?: IDataprocWorkflowTemplate["metadata"];
  "spec": IDataprocWorkflowTemplate["spec"];
  "status"?: IDataprocWorkflowTemplate["status"];

static apiVersion: IDataprocWorkflowTemplate["apiVersion"] = "dataproc.cnrm.cloud.google.com/v1beta1";
static kind: IDataprocWorkflowTemplate["kind"] = "DataprocWorkflowTemplate";
static is = createTypeMetaGuard<IDataprocWorkflowTemplate>(DataprocWorkflowTemplate);

constructor(data?: ModelData<IDataprocWorkflowTemplate>) {
  super();

  this.setDefinedProps({
    apiVersion: DataprocWorkflowTemplate.apiVersion,
    kind: DataprocWorkflowTemplate.kind,
    ...data
  } as IDataprocWorkflowTemplate);
}
}


setValidateFunc(DataprocWorkflowTemplate, validate as ValidateFunc<IDataprocWorkflowTemplate>);
