...
import { validate } from "../../_schemas/DataprocCnrmCloudGoogleComV1beta1DataprocAutoscalingPolicy";

export interface IDataprocAutoscalingPolicy {
  /**
...
export class DataprocAutoscalingPolicy extends Model<IDataprocAutoscalingPolicy> implements IDataprocAutoscalingPolicy {
  "apiVersion": IDataprocAutoscalingPolicy["apiVersion"];
  "kind": IDataprocAutoscalingPolicy["kind"];
  "metadata"?: IDataprocAutoscalingPolicy["metadata"];
  "spec": IDataprocAutoscalingPolicy["spec"];
  "status"?: IDataprocAutoscalingPolicy["status"];

static apiVersion: IDataprocAutoscalingPolicy["apiVersion"] = "dataproc.cnrm.cloud.google.com/v1beta1";
static kind: IDataprocAutoscalingPolicy["kind"] = "DataprocAutoscalingPolicy";
static is = createTypeMetaGuard<IDataprocAutoscalingPolicy>(DataprocAutoscalingPolicy);

constructor(data?: ModelData<IDataprocAutoscalingPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: DataprocAutoscalingPolicy.apiVersion,
    kind: DataprocAutoscalingPolicy.kind,
    ...data
  } as IDataprocAutoscalingPolicy);
}
}


setValidateFunc(DataprocAutoscalingPolicy, validate as ValidateFunc<IDataprocAutoscalingPolicy>);
