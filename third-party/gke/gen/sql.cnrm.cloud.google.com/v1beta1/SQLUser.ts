...
import { validate } from "../../_schemas/SqlCnrmCloudGoogleComV1beta1SQLUser";
...
export class SQLUser extends Model<ISQLUser> implements ISQLUser {
...
static apiVersion: ISQLUser["apiVersion"] = "sql.cnrm.cloud.google.com/v1beta1";
static kind: ISQLUser["kind"] = "SQLUser";
static is = createTypeMetaGuard<ISQLUser>(SQLUser);

constructor(data?: ModelData<ISQLUser>) {
  super();

  this.setDefinedProps({
    apiVersion: SQLUser.apiVersion,
    kind: SQLUser.kind,
    ...data
  } as ISQLUser);
}
...
setValidateFunc(SQLUser, validate as ValidateFunc<ISQLUser>);
