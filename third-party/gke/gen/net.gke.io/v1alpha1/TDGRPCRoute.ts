...
import { validate } from "../../_schemas/NetGkeIoV1alpha1TDGRPCRoute";
 ...
 * TDGRPCRoute is the Schema for the Traffic Director GRPCRoute resource.
 */
export class TDGRPCRoute extends Model<ITDGRPCRoute> implements ITDGRPCRoute {
...
static apiVersion: ITDGRPCRoute["apiVersion"] = "net.gke.io/v1alpha1";
static kind: ITDGRPCRoute["kind"] = "TDGRPCRoute";
static is = createTypeMetaGuard<ITDGRPCRoute>(TDGRPCRoute);

constructor(data?: ModelData<ITDGRPCRoute>) {
  super();

  this.setDefinedProps({
    apiVersion: TDGRPCRoute.apiVersion,
    kind: TDGRPCRoute.kind,
    ...data
  } as ITDGRPCRoute);
}
}
...
setValidateFunc(TDGRPCRoute, validate as ValidateFunc<ITDGRPCRoute>);
