...
import { validate } from "../../_schemas/NetGkeIoV1alpha1TDMesh";
 ...
 * TDMesh represents an instantiation of a Traffic Director service mesh.
 */
export class TDMesh extends Model<ITDMesh> implements ITDMesh {
...
static apiVersion: ITDMesh["apiVersion"] = "net.gke.io/v1alpha1";
static kind: ITDMesh["kind"] = "TDMesh";
static is = createTypeMetaGuard<ITDMesh>(TDMesh);

constructor(data?: ModelData<ITDMesh>) {
  super();

  this.setDefinedProps({
    apiVersion: TDMesh.apiVersion,
    kind: TDMesh.kind,
    ...data
  } as ITDMesh);
}
...
setValidateFunc(TDMesh, validate as ValidateFunc<ITDMesh>);
