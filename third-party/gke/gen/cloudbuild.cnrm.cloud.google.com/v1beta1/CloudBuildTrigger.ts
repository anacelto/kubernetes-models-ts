...
import { validate } from "../../_schemas/CloudbuildCnrmCloudGoogleComV1beta1CloudBuildTrigger";
...
export class CloudBuildTrigger extends Model<ICloudBuildTrigger> implements ICloudBuildTrigger {
...
static apiVersion: ICloudBuildTrigger["apiVersion"] = "cloudbuild.cnrm.cloud.google.com/v1beta1";
static kind: ICloudBuildTrigger["kind"] = "CloudBuildTrigger";
static is = createTypeMetaGuard<ICloudBuildTrigger>(CloudBuildTrigger);

constructor(data?: ModelData<ICloudBuildTrigger>) {
  super();

  this.setDefinedProps({
    apiVersion: CloudBuildTrigger.apiVersion,
    kind: CloudBuildTrigger.kind,
    ...data
  } as ICloudBuildTrigger);
}
}


setValidateFunc(CloudBuildTrigger, validate as ValidateFunc<ICloudBuildTrigger>);
