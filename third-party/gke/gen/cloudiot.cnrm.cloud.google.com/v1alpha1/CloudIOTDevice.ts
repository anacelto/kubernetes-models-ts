...
import { validate } from "../../_schemas/CloudiotCnrmCloudGoogleComV1alpha1CloudIOTDevice";
...
export class CloudIOTDevice extends Model<ICloudIOTDevice> implements ICloudIOTDevice {
...
static apiVersion: ICloudIOTDevice["apiVersion"] = "cloudiot.cnrm.cloud.google.com/v1alpha1";
static kind: ICloudIOTDevice["kind"] = "CloudIOTDevice";
static is = createTypeMetaGuard<ICloudIOTDevice>(CloudIOTDevice);

constructor(data?: ModelData<ICloudIOTDevice>) {
  super();

  this.setDefinedProps({
    apiVersion: CloudIOTDevice.apiVersion,
    kind: CloudIOTDevice.kind,
    ...data
  } as ICloudIOTDevice);
}
}
...
setValidateFunc(CloudIOTDevice, validate as ValidateFunc<ICloudIOTDevice>);
