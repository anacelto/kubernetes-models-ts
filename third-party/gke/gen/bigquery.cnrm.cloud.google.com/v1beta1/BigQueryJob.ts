...
import { validate } from "../../_schemas/BigqueryCnrmCloudGoogleComV1beta1BigQueryJob";
...
export class BigQueryJob extends Model<IBigQueryJob> implements IBigQueryJob {
...
static apiVersion: IBigQueryJob["apiVersion"] = "bigquery.cnrm.cloud.google.com/v1beta1";
static kind: IBigQueryJob["kind"] = "BigQueryJob";
static is = createTypeMetaGuard<IBigQueryJob>(BigQueryJob);

constructor(data?: ModelData<IBigQueryJob>) {
  super();

  this.setDefinedProps({
    apiVersion: BigQueryJob.apiVersion,
    kind: BigQueryJob.kind,
    ...data
  } as IBigQueryJob);
}
}
...
setValidateFunc(BigQueryJob, validate as ValidateFunc<IBigQueryJob>);
