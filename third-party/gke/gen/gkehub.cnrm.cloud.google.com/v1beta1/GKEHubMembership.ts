...
import { validate } from "../../_schemas/GkehubCnrmCloudGoogleComV1beta1GKEHubMembership";
...
export class GKEHubMembership extends Model<IGKEHubMembership> implements IGKEHubMembership {
...
static apiVersion: IGKEHubMembership["apiVersion"] = "gkehub.cnrm.cloud.google.com/v1beta1";
static kind: IGKEHubMembership["kind"] = "GKEHubMembership";
static is = createTypeMetaGuard<IGKEHubMembership>(GKEHubMembership);

constructor(data?: ModelData<IGKEHubMembership>) {
  super();

  this.setDefinedProps({
    apiVersion: GKEHubMembership.apiVersion,
    kind: GKEHubMembership.kind,
    ...data
  } as IGKEHubMembership);
}
}


setValidateFunc(GKEHubMembership, validate as ValidateFunc<IGKEHubMembership>);
