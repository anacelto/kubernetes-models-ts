...
import { validate } from "../../_schemas/GkehubCnrmCloudGoogleComV1beta1GKEHubFeatureMembership";
...
export class GKEHubFeatureMembership extends Model<IGKEHubFeatureMembership> implements IGKEHubFeatureMembership {
...
static apiVersion: IGKEHubFeatureMembership["apiVersion"] = "gkehub.cnrm.cloud.google.com/v1beta1";
static kind: IGKEHubFeatureMembership["kind"] = "GKEHubFeatureMembership";
static is = createTypeMetaGuard<IGKEHubFeatureMembership>(GKEHubFeatureMembership);

constructor(data?: ModelData<IGKEHubFeatureMembership>) {
  super();

  this.setDefinedProps({
    apiVersion: GKEHubFeatureMembership.apiVersion,
    kind: GKEHubFeatureMembership.kind,
    ...data
  } as IGKEHubFeatureMembership);
}
}


setValidateFunc(GKEHubFeatureMembership, validate as ValidateFunc<IGKEHubFeatureMembership>);
