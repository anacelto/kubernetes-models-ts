...
import { validate } from "../../_schemas/BigqueryanalyticshubCnrmCloudGoogleComV1alpha1BigQueryAnalyticsHubListing";
...
export class BigQueryAnalyticsHubListing extends Model<IBigQueryAnalyticsHubListing> implements IBigQueryAnalyticsHubListing {
...
static apiVersion: IBigQueryAnalyticsHubListing["apiVersion"] = "bigqueryanalyticshub.cnrm.cloud.google.com/v1alpha1";
static kind: IBigQueryAnalyticsHubListing["kind"] = "BigQueryAnalyticsHubListing";
static is = createTypeMetaGuard<IBigQueryAnalyticsHubListing>(BigQueryAnalyticsHubListing);

constructor(data?: ModelData<IBigQueryAnalyticsHubListing>) {
  super();

  this.setDefinedProps({
    apiVersion: BigQueryAnalyticsHubListing.apiVersion,
    kind: BigQueryAnalyticsHubListing.kind,
    ...data
  } as IBigQueryAnalyticsHubListing);
}
}


setValidateFunc(BigQueryAnalyticsHubListing, validate as ValidateFunc<IBigQueryAnalyticsHubListing>);
