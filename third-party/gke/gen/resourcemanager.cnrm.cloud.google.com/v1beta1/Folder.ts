...
import { validate } from "../../_schemas/ResourcemanagerCnrmCloudGoogleComV1beta1Folder";
...
export class Folder extends Model<IFolder> implements IFolder {
  "apiVersion": IFolder["apiVersion"];
  "kind": IFolder["kind"];
  "metadata"?: IFolder["metadata"];
  "spec": IFolder["spec"];
  "status"?: IFolder["status"];

static apiVersion: IFolder["apiVersion"] = "resourcemanager.cnrm.cloud.google.com/v1beta1";
static kind: IFolder["kind"] = "Folder";
static is = createTypeMetaGuard<IFolder>(Folder);

constructor(data?: ModelData<IFolder>) {
  super();
...
setValidateFunc(Folder, validate as ValidateFunc<IFolder>);
