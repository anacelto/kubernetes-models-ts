...
import { validate } from "../../_schemas/ResourcemanagerCnrmCloudGoogleComV1beta1ResourceManagerLien";
...
export class ResourceManagerLien extends Model<IResourceManagerLien> implements IResourceManagerLien {
...
static apiVersion: IResourceManagerLien["apiVersion"] = "resourcemanager.cnrm.cloud.google.com/v1beta1";
static kind: IResourceManagerLien["kind"] = "ResourceManagerLien";
static is = createTypeMetaGuard<IResourceManagerLien>(ResourceManagerLien);

constructor(data?: ModelData<IResourceManagerLien>) {
  super();

  this.setDefinedProps({
    apiVersion: ResourceManagerLien.apiVersion,
    kind: ResourceManagerLien.kind,
    ...data
  } as IResourceManagerLien);
}
}


setValidateFunc(ResourceManagerLien, validate as ValidateFunc<IResourceManagerLien>);
