...
import { validate } from "../../_schemas/ContainerCnrmCloudGoogleComV1beta1ContainerCluster";
...
export class ContainerCluster extends Model<IContainerCluster> implements IContainerCluster {
...
static apiVersion: IContainerCluster["apiVersion"] = "container.cnrm.cloud.google.com/v1beta1";
static kind: IContainerCluster["kind"] = "ContainerCluster";
static is = createTypeMetaGuard<IContainerCluster>(ContainerCluster);

constructor(data?: ModelData<IContainerCluster>) {
  super();

  this.setDefinedProps({
    apiVersion: ContainerCluster.apiVersion,
    kind: ContainerCluster.kind,
    ...data
  } as IContainerCluster);
}
}


setValidateFunc(ContainerCluster, validate as ValidateFunc<IContainerCluster>);
