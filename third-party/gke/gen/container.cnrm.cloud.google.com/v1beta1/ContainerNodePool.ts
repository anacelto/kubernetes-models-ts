...
import { validate } from "../../_schemas/ContainerCnrmCloudGoogleComV1beta1ContainerNodePool";
...
export class ContainerNodePool extends Model<IContainerNodePool> implements IContainerNodePool {
...
static apiVersion: IContainerNodePool["apiVersion"] = "container.cnrm.cloud.google.com/v1beta1";
static kind: IContainerNodePool["kind"] = "ContainerNodePool";
static is = createTypeMetaGuard<IContainerNodePool>(ContainerNodePool);

constructor(data?: ModelData<IContainerNodePool>) {
  super();

  this.setDefinedProps({
    apiVersion: ContainerNodePool.apiVersion,
    kind: ContainerNodePool.kind,
    ...data
  } as IContainerNodePool);
}
}


setValidateFunc(ContainerNodePool, validate as ValidateFunc<IContainerNodePool>);
