...
import { validate } from "../../_schemas/DlpCnrmCloudGoogleComV1beta1DLPDeidentifyTemplate";

export interface IDLPDeidentifyTemplate {
  /**
...
export class DLPDeidentifyTemplate extends Model<IDLPDeidentifyTemplate> implements IDLPDeidentifyTemplate {
  "apiVersion": IDLPDeidentifyTemplate["apiVersion"];
  "kind": IDLPDeidentifyTemplate["kind"];
  "metadata"?: IDLPDeidentifyTemplate["metadata"];
  "spec"?: IDLPDeidentifyTemplate["spec"];
  "status"?: IDLPDeidentifyTemplate["status"];

static apiVersion: IDLPDeidentifyTemplate["apiVersion"] = "dlp.cnrm.cloud.google.com/v1beta1";
static kind: IDLPDeidentifyTemplate["kind"] = "DLPDeidentifyTemplate";
static is = createTypeMetaGuard<IDLPDeidentifyTemplate>(DLPDeidentifyTemplate);

constructor(data?: ModelData<IDLPDeidentifyTemplate>) {
  super();

  this.setDefinedProps({
    apiVersion: DLPDeidentifyTemplate.apiVersion,
    kind: DLPDeidentifyTemplate.kind,
    ...data
  } as IDLPDeidentifyTemplate);
}
}


setValidateFunc(DLPDeidentifyTemplate, validate as ValidateFunc<IDLPDeidentifyTemplate>);
