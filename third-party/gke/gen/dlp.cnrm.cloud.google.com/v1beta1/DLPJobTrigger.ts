...
import { validate } from "../../_schemas/DlpCnrmCloudGoogleComV1beta1DLPJobTrigger";
...
export class DLPJobTrigger extends Model<IDLPJobTrigger> implements IDLPJobTrigger {
...
static apiVersion: IDLPJobTrigger["apiVersion"] = "dlp.cnrm.cloud.google.com/v1beta1";
static kind: IDLPJobTrigger["kind"] = "DLPJobTrigger";
static is = createTypeMetaGuard<IDLPJobTrigger>(DLPJobTrigger);

constructor(data?: ModelData<IDLPJobTrigger>) {
  super();

  this.setDefinedProps({
    apiVersion: DLPJobTrigger.apiVersion,
    kind: DLPJobTrigger.kind,
    ...data
  } as IDLPJobTrigger);
}
}
...
setValidateFunc(DLPJobTrigger, validate as ValidateFunc<IDLPJobTrigger>);
