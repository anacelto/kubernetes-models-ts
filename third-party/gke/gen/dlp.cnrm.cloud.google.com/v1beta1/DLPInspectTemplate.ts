...
import { validate } from "../../_schemas/DlpCnrmCloudGoogleComV1beta1DLPInspectTemplate";

export interface IDLPInspectTemplate {
  /**
...
export class DLPInspectTemplate extends Model<IDLPInspectTemplate> implements IDLPInspectTemplate {
  "apiVersion": IDLPInspectTemplate["apiVersion"];
  "kind": IDLPInspectTemplate["kind"];
  "metadata"?: IDLPInspectTemplate["metadata"];
  "spec"?: IDLPInspectTemplate["spec"];
  "status"?: IDLPInspectTemplate["status"];

static apiVersion: IDLPInspectTemplate["apiVersion"] = "dlp.cnrm.cloud.google.com/v1beta1";
static kind: IDLPInspectTemplate["kind"] = "DLPInspectTemplate";
static is = createTypeMetaGuard<IDLPInspectTemplate>(DLPInspectTemplate);

constructor(data?: ModelData<IDLPInspectTemplate>) {
  super();

  this.setDefinedProps({
    apiVersion: DLPInspectTemplate.apiVersion,
    kind: DLPInspectTemplate.kind,
    ...data
  } as IDLPInspectTemplate);
}
}


setValidateFunc(DLPInspectTemplate, validate as ValidateFunc<IDLPInspectTemplate>);
