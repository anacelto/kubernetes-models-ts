...
import { validate } from "../../_schemas/HealthcareCnrmCloudGoogleComV1alpha1HealthcareFHIRStore";
...
export class HealthcareFHIRStore extends Model<IHealthcareFHIRStore> implements IHealthcareFHIRStore {
...
static apiVersion: IHealthcareFHIRStore["apiVersion"] = "healthcare.cnrm.cloud.google.com/v1alpha1";
static kind: IHealthcareFHIRStore["kind"] = "HealthcareFHIRStore";
static is = createTypeMetaGuard<IHealthcareFHIRStore>(HealthcareFHIRStore);

constructor(data?: ModelData<IHealthcareFHIRStore>) {
  super();

  this.setDefinedProps({
    apiVersion: HealthcareFHIRStore.apiVersion,
    kind: HealthcareFHIRStore.kind,
    ...data
  } as IHealthcareFHIRStore);
}
}


setValidateFunc(HealthcareFHIRStore, validate as ValidateFunc<IHealthcareFHIRStore>);
