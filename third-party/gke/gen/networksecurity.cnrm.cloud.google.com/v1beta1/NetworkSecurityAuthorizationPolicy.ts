...
import { validate } from "../../_schemas/NetworksecurityCnrmCloudGoogleComV1beta1NetworkSecurityAuthorizationPolicy";
...
export class NetworkSecurityAuthorizationPolicy extends Model<INetworkSecurityAuthorizationPolicy> implements INetworkSecurityAuthorizationPolicy {
...
static apiVersion: INetworkSecurityAuthorizationPolicy["apiVersion"] = "networksecurity.cnrm.cloud.google.com/v1beta1";
static kind: INetworkSecurityAuthorizationPolicy["kind"] = "NetworkSecurityAuthorizationPolicy";
static is = createTypeMetaGuard<INetworkSecurityAuthorizationPolicy>(NetworkSecurityAuthorizationPolicy);

constructor(data?: ModelData<INetworkSecurityAuthorizationPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: NetworkSecurityAuthorizationPolicy.apiVersion,
    kind: NetworkSecurityAuthorizationPolicy.kind,
    ...data
  } as INetworkSecurityAuthorizationPolicy);
}
}


setValidateFunc(NetworkSecurityAuthorizationPolicy, validate as ValidateFunc<INetworkSecurityAuthorizationPolicy>);
