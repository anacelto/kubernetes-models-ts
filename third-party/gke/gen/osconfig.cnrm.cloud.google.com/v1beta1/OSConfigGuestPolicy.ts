...
import { validate } from "../../_schemas/OsconfigCnrmCloudGoogleComV1beta1OSConfigGuestPolicy";

export interface IOSConfigGuestPolicy {
  /**
...
export class OSConfigGuestPolicy extends Model<IOSConfigGuestPolicy> implements IOSConfigGuestPolicy {
  "apiVersion": IOSConfigGuestPolicy["apiVersion"];
  "kind": IOSConfigGuestPolicy["kind"];
  "metadata"?: IOSConfigGuestPolicy["metadata"];
  "spec"?: IOSConfigGuestPolicy["spec"];
  "status"?: IOSConfigGuestPolicy["status"];

static apiVersion: IOSConfigGuestPolicy["apiVersion"] = "osconfig.cnrm.cloud.google.com/v1beta1";
static kind: IOSConfigGuestPolicy["kind"] = "OSConfigGuestPolicy";
static is = createTypeMetaGuard<IOSConfigGuestPolicy>(OSConfigGuestPolicy);

constructor(data?: ModelData<IOSConfigGuestPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: OSConfigGuestPolicy.apiVersion,
    kind: OSConfigGuestPolicy.kind,
    ...data
  } as IOSConfigGuestPolicy);
}
}


setValidateFunc(OSConfigGuestPolicy, validate as ValidateFunc<IOSConfigGuestPolicy>);
