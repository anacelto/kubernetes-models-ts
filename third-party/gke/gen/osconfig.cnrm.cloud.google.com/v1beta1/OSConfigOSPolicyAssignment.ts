...
import { validate } from "../../_schemas/OsconfigCnrmCloudGoogleComV1beta1OSConfigOSPolicyAssignment";
...
export class OSConfigOSPolicyAssignment extends Model<IOSConfigOSPolicyAssignment> implements IOSConfigOSPolicyAssignment {
...
static apiVersion: IOSConfigOSPolicyAssignment["apiVersion"] = "osconfig.cnrm.cloud.google.com/v1beta1";
static kind: IOSConfigOSPolicyAssignment["kind"] = "OSConfigOSPolicyAssignment";
static is = createTypeMetaGuard<IOSConfigOSPolicyAssignment>(OSConfigOSPolicyAssignment);

constructor(data?: ModelData<IOSConfigOSPolicyAssignment>) {
  super();

  this.setDefinedProps({
    apiVersion: OSConfigOSPolicyAssignment.apiVersion,
    kind: OSConfigOSPolicyAssignment.kind,
    ...data
  } as IOSConfigOSPolicyAssignment);
}
}


setValidateFunc(OSConfigOSPolicyAssignment, validate as ValidateFunc<IOSConfigOSPolicyAssignment>);
