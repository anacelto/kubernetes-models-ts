...
import { validate } from "../../_schemas/OsconfigCnrmCloudGoogleComV1alpha1OSConfigPatchDeployment";
...
export class OSConfigPatchDeployment extends Model<IOSConfigPatchDeployment> implements IOSConfigPatchDeployment {
...
static apiVersion: IOSConfigPatchDeployment["apiVersion"] = "osconfig.cnrm.cloud.google.com/v1alpha1";
static kind: IOSConfigPatchDeployment["kind"] = "OSConfigPatchDeployment";
static is = createTypeMetaGuard<IOSConfigPatchDeployment>(OSConfigPatchDeployment);

constructor(data?: ModelData<IOSConfigPatchDeployment>) {
  super();

  this.setDefinedProps({
    apiVersion: OSConfigPatchDeployment.apiVersion,
    kind: OSConfigPatchDeployment.kind,
    ...data
  } as IOSConfigPatchDeployment);
}
}


setValidateFunc(OSConfigPatchDeployment, validate as ValidateFunc<IOSConfigPatchDeployment>);
