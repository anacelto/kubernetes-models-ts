...
import { validate } from "../../_schemas/KmsCnrmCloudGoogleComV1alpha1KMSCryptoKeyVersion";
...
export class KMSCryptoKeyVersion extends Model<IKMSCryptoKeyVersion> implements IKMSCryptoKeyVersion {
...
static apiVersion: IKMSCryptoKeyVersion["apiVersion"] = "kms.cnrm.cloud.google.com/v1alpha1";
static kind: IKMSCryptoKeyVersion["kind"] = "KMSCryptoKeyVersion";
static is = createTypeMetaGuard<IKMSCryptoKeyVersion>(KMSCryptoKeyVersion);

constructor(data?: ModelData<IKMSCryptoKeyVersion>) {
  super();

  this.setDefinedProps({
    apiVersion: KMSCryptoKeyVersion.apiVersion,
    kind: KMSCryptoKeyVersion.kind,
    ...data
  } as IKMSCryptoKeyVersion);
}
}


setValidateFunc(KMSCryptoKeyVersion, validate as ValidateFunc<IKMSCryptoKeyVersion>);
