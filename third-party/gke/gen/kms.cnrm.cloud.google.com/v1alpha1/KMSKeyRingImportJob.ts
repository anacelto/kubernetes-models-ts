...
import { validate } from "../../_schemas/KmsCnrmCloudGoogleComV1alpha1KMSKeyRingImportJob";
...
export class KMSKeyRingImportJob extends Model<IKMSKeyRingImportJob> implements IKMSKeyRingImportJob {
...
static apiVersion: IKMSKeyRingImportJob["apiVersion"] = "kms.cnrm.cloud.google.com/v1alpha1";
static kind: IKMSKeyRingImportJob["kind"] = "KMSKeyRingImportJob";
static is = createTypeMetaGuard<IKMSKeyRingImportJob>(KMSKeyRingImportJob);

constructor(data?: ModelData<IKMSKeyRingImportJob>) {
  super();

  this.setDefinedProps({
    apiVersion: KMSKeyRingImportJob.apiVersion,
    kind: KMSKeyRingImportJob.kind,
    ...data
  } as IKMSKeyRingImportJob);
}
}


setValidateFunc(KMSKeyRingImportJob, validate as ValidateFunc<IKMSKeyRingImportJob>);
