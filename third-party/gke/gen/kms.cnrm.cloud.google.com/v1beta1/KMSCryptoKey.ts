...
import { validate } from "../../_schemas/KmsCnrmCloudGoogleComV1beta1KMSCryptoKey";
...
export class KMSCryptoKey extends Model<IKMSCryptoKey> implements IKMSCryptoKey {
...
static apiVersion: IKMSCryptoKey["apiVersion"] = "kms.cnrm.cloud.google.com/v1beta1";
static kind: IKMSCryptoKey["kind"] = "KMSCryptoKey";
static is = createTypeMetaGuard<IKMSCryptoKey>(KMSCryptoKey);

constructor(data?: ModelData<IKMSCryptoKey>) {
  super();

  this.setDefinedProps({
    apiVersion: KMSCryptoKey.apiVersion,
    kind: KMSCryptoKey.kind,
    ...data
  } as IKMSCryptoKey);
}
}
...
setValidateFunc(KMSCryptoKey, validate as ValidateFunc<IKMSCryptoKey>);
