...
import { validate } from "../../_schemas/PrivatecaCnrmCloudGoogleComV1beta1PrivateCACertificate";
...
export class PrivateCACertificate extends Model<IPrivateCACertificate> implements IPrivateCACertificate {
...
static apiVersion: IPrivateCACertificate["apiVersion"] = "privateca.cnrm.cloud.google.com/v1beta1";
static kind: IPrivateCACertificate["kind"] = "PrivateCACertificate";
static is = createTypeMetaGuard<IPrivateCACertificate>(PrivateCACertificate);

constructor(data?: ModelData<IPrivateCACertificate>) {
  super();

  this.setDefinedProps({
    apiVersion: PrivateCACertificate.apiVersion,
    kind: PrivateCACertificate.kind,
    ...data
  } as IPrivateCACertificate);
}
}


setValidateFunc(PrivateCACertificate, validate as ValidateFunc<IPrivateCACertificate>);
