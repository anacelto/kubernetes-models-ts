...
import { validate } from "../../_schemas/StorageCnrmCloudGoogleComV1beta1StorageNotification";
...
export class StorageNotification extends Model<IStorageNotification> implements IStorageNotification {
...
static apiVersion: IStorageNotification["apiVersion"] = "storage.cnrm.cloud.google.com/v1beta1";
static kind: IStorageNotification["kind"] = "StorageNotification";
static is = createTypeMetaGuard<IStorageNotification>(StorageNotification);

constructor(data?: ModelData<IStorageNotification>) {
  super();

  this.setDefinedProps({
    apiVersion: StorageNotification.apiVersion,
    kind: StorageNotification.kind,
    ...data
  } as IStorageNotification);
}
}


setValidateFunc(StorageNotification, validate as ValidateFunc<IStorageNotification>);
