...
import { validate } from "../../_schemas/CloudGoogleComV1ComputeClass";
 ...
 * which will be used for workloads not specifying any preferences.
 */
export class ComputeClass extends Model<IComputeClass> implements IComputeClass {
...
static apiVersion: IComputeClass["apiVersion"] = "cloud.google.com/v1";
static kind: IComputeClass["kind"] = "ComputeClass";
static is = createTypeMetaGuard<IComputeClass>(ComputeClass);

constructor(data?: ModelData<IComputeClass>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeClass.apiVersion,
    kind: ComputeClass.kind,
    ...data
  } as IComputeClass);
}
}
...
setValidateFunc(ComputeClass, validate as ValidateFunc<IComputeClass>);
