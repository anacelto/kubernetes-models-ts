...
import { validate } from "../../_schemas/AlloydbCnrmCloudGoogleComV1alpha1AlloyDBCluster";
...
export class AlloyDBCluster extends Model<IAlloyDBCluster> implements IAlloyDBCluster {
...
static apiVersion: IAlloyDBCluster["apiVersion"] = "alloydb.cnrm.cloud.google.com/v1alpha1";
static kind: IAlloyDBCluster["kind"] = "AlloyDBCluster";
static is = createTypeMetaGuard<IAlloyDBCluster>(AlloyDBCluster);

constructor(data?: ModelData<IAlloyDBCluster>) {
  super();

  this.setDefinedProps({
    apiVersion: AlloyDBCluster.apiVersion,
    kind: AlloyDBCluster.kind,
    ...data
  } as IAlloyDBCluster);
}
}
...
setValidateFunc(AlloyDBCluster, validate as ValidateFunc<IAlloyDBCluster>);
