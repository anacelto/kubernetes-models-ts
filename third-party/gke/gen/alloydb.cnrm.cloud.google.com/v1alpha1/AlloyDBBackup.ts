...
import { validate } from "../../_schemas/AlloydbCnrmCloudGoogleComV1alpha1AlloyDBBackup";
...
export class AlloyDBBackup extends Model<IAlloyDBBackup> implements IAlloyDBBackup {
...
static apiVersion: IAlloyDBBackup["apiVersion"] = "alloydb.cnrm.cloud.google.com/v1alpha1";
static kind: IAlloyDBBackup["kind"] = "AlloyDBBackup";
static is = createTypeMetaGuard<IAlloyDBBackup>(AlloyDBBackup);

constructor(data?: ModelData<IAlloyDBBackup>) {
  super();

  this.setDefinedProps({
    apiVersion: AlloyDBBackup.apiVersion,
    kind: AlloyDBBackup.kind,
    ...data
  } as IAlloyDBBackup);
}
}
...
setValidateFunc(AlloyDBBackup, validate as ValidateFunc<IAlloyDBBackup>);
