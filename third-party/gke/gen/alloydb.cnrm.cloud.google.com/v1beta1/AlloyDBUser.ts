...
import { validate } from "../../_schemas/AlloydbCnrmCloudGoogleComV1beta1AlloyDBUser";
...
export class AlloyDBUser extends Model<IAlloyDBUser> implements IAlloyDBUser {
...
static apiVersion: IAlloyDBUser["apiVersion"] = "alloydb.cnrm.cloud.google.com/v1beta1";
static kind: IAlloyDBUser["kind"] = "AlloyDBUser";
static is = createTypeMetaGuard<IAlloyDBUser>(AlloyDBUser);

constructor(data?: ModelData<IAlloyDBUser>) {
  super();

  this.setDefinedProps({
    apiVersion: AlloyDBUser.apiVersion,
    kind: AlloyDBUser.kind,
    ...data
  } as IAlloyDBUser);
}
}
...
setValidateFunc(AlloyDBUser, validate as ValidateFunc<IAlloyDBUser>);
