...
import { validate } from "../../_schemas/NetworkservicesCnrmCloudGoogleComV1alpha1NetworkServicesEdgeCacheService";

export interface INetworkServicesEdgeCacheService {
  /**
...
export class NetworkServicesEdgeCacheService extends Model<INetworkServicesEdgeCacheService> implements INetworkServicesEdgeCacheService {
  "apiVersion": INetworkServicesEdgeCacheService["apiVersion"];
  "kind": INetworkServicesEdgeCacheService["kind"];
  "metadata"?: INetworkServicesEdgeCacheService["metadata"];
  "spec": INetworkServicesEdgeCacheService["spec"];
  "status"?: INetworkServicesEdgeCacheService["status"];

static apiVersion: INetworkServicesEdgeCacheService["apiVersion"] = "networkservices.cnrm.cloud.google.com/v1alpha1";
static kind: INetworkServicesEdgeCacheService["kind"] = "NetworkServicesEdgeCacheService";
static is = createTypeMetaGuard<INetworkServicesEdgeCacheService>(NetworkServicesEdgeCacheService);

constructor(data?: ModelData<INetworkServicesEdgeCacheService>) {
  super();

  this.setDefinedProps({
    apiVersion: NetworkServicesEdgeCacheService.apiVersion,
    kind: NetworkServicesEdgeCacheService.kind,
    ...data
  } as INetworkServicesEdgeCacheService);
}
}


setValidateFunc(NetworkServicesEdgeCacheService, validate as ValidateFunc<INetworkServicesEdgeCacheService>);
