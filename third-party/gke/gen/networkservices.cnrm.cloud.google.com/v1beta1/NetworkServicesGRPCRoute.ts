...
import { validate } from "../../_schemas/NetworkservicesCnrmCloudGoogleComV1beta1NetworkServicesGRPCRoute";

export interface INetworkServicesGRPCRoute {
  /**
...
export class NetworkServicesGRPCRoute extends Model<INetworkServicesGRPCRoute> implements INetworkServicesGRPCRoute {
  "apiVersion": INetworkServicesGRPCRoute["apiVersion"];
  "kind": INetworkServicesGRPCRoute["kind"];
  "metadata"?: INetworkServicesGRPCRoute["metadata"];
  "spec": INetworkServicesGRPCRoute["spec"];
  "status"?: INetworkServicesGRPCRoute["status"];

static apiVersion: INetworkServicesGRPCRoute["apiVersion"] = "networkservices.cnrm.cloud.google.com/v1beta1";
static kind: INetworkServicesGRPCRoute["kind"] = "NetworkServicesGRPCRoute";
static is = createTypeMetaGuard<INetworkServicesGRPCRoute>(NetworkServicesGRPCRoute);

constructor(data?: ModelData<INetworkServicesGRPCRoute>) {
  super();

  this.setDefinedProps({
    apiVersion: NetworkServicesGRPCRoute.apiVersion,
    kind: NetworkServicesGRPCRoute.kind,
    ...data
  } as INetworkServicesGRPCRoute);
}
}


setValidateFunc(NetworkServicesGRPCRoute, validate as ValidateFunc<INetworkServicesGRPCRoute>);
