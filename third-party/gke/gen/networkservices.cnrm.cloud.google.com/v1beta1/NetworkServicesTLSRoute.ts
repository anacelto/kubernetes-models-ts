...
import { validate } from "../../_schemas/NetworkservicesCnrmCloudGoogleComV1beta1NetworkServicesTLSRoute";
...
export class NetworkServicesTLSRoute extends Model<INetworkServicesTLSRoute> implements INetworkServicesTLSRoute {
...
static apiVersion: INetworkServicesTLSRoute["apiVersion"] = "networkservices.cnrm.cloud.google.com/v1beta1";
static kind: INetworkServicesTLSRoute["kind"] = "NetworkServicesTLSRoute";
static is = createTypeMetaGuard<INetworkServicesTLSRoute>(NetworkServicesTLSRoute);

constructor(data?: ModelData<INetworkServicesTLSRoute>) {
  super();

  this.setDefinedProps({
    apiVersion: NetworkServicesTLSRoute.apiVersion,
    kind: NetworkServicesTLSRoute.kind,
    ...data
  } as INetworkServicesTLSRoute);
}
}


setValidateFunc(NetworkServicesTLSRoute, validate as ValidateFunc<INetworkServicesTLSRoute>);
