...
import { validate } from "../../_schemas/IamCnrmCloudGoogleComV1beta1IAMAuditConfig";
 ...
 * IAMAuditConfig is the schema for the IAM audit logging API.
 */
export class IAMAuditConfig extends Model<IIAMAuditConfig> implements IIAMAuditConfig {
...
static apiVersion: IIAMAuditConfig["apiVersion"] = "iam.cnrm.cloud.google.com/v1beta1";
static kind: IIAMAuditConfig["kind"] = "IAMAuditConfig";
static is = createTypeMetaGuard<IIAMAuditConfig>(IAMAuditConfig);

constructor(data?: ModelData<IIAMAuditConfig>) {
  super();

  this.setDefinedProps({
    apiVersion: IAMAuditConfig.apiVersion,
    kind: IAMAuditConfig.kind,
    ...data
  } as IIAMAuditConfig);
}
}
...
setValidateFunc(IAMAuditConfig, validate as ValidateFunc<IIAMAuditConfig>);
