...
import { validate } from "../../_schemas/IamCnrmCloudGoogleComV1beta1IAMPartialPolicy";
 ...
 * IAMPartialPolicy is the Schema for the iampartialpolicy API
 */
export class IAMPartialPolicy extends Model<IIAMPartialPolicy> implements IIAMPartialPolicy {
...
static apiVersion: IIAMPartialPolicy["apiVersion"] = "iam.cnrm.cloud.google.com/v1beta1";
static kind: IIAMPartialPolicy["kind"] = "IAMPartialPolicy";
static is = createTypeMetaGuard<IIAMPartialPolicy>(IAMPartialPolicy);

constructor(data?: ModelData<IIAMPartialPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: IAMPartialPolicy.apiVersion,
    kind: IAMPartialPolicy.kind,
    ...data
  } as IIAMPartialPolicy);
}
}


setValidateFunc(IAMPartialPolicy, validate as ValidateFunc<IIAMPartialPolicy>);
