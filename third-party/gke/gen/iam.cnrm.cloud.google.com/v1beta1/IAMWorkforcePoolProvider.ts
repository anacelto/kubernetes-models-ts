...
import { validate } from "../../_schemas/IamCnrmCloudGoogleComV1beta1IAMWorkforcePoolProvider";

export interface IIAMWorkforcePoolProvider {
  /**
...
export class IAMWorkforcePoolProvider extends Model<IIAMWorkforcePoolProvider> implements IIAMWorkforcePoolProvider {
  "apiVersion": IIAMWorkforcePoolProvider["apiVersion"];
  "kind": IIAMWorkforcePoolProvider["kind"];
  "metadata"?: IIAMWorkforcePoolProvider["metadata"];
  "spec": IIAMWorkforcePoolProvider["spec"];
  "status"?: IIAMWorkforcePoolProvider["status"];

static apiVersion: IIAMWorkforcePoolProvider["apiVersion"] = "iam.cnrm.cloud.google.com/v1beta1";
static kind: IIAMWorkforcePoolProvider["kind"] = "IAMWorkforcePoolProvider";
static is = createTypeMetaGuard<IIAMWorkforcePoolProvider>(IAMWorkforcePoolProvider);

constructor(data?: ModelData<IIAMWorkforcePoolProvider>) {
  super();

  this.setDefinedProps({
    apiVersion: IAMWorkforcePoolProvider.apiVersion,
    kind: IAMWorkforcePoolProvider.kind,
    ...data
  } as IIAMWorkforcePoolProvider);
}
}


setValidateFunc(IAMWorkforcePoolProvider, validate as ValidateFunc<IIAMWorkforcePoolProvider>);
