...
import { validate } from "../../_schemas/IamCnrmCloudGoogleComV1beta1IAMServiceAccount";
...
export class IAMServiceAccount extends Model<IIAMServiceAccount> implements IIAMServiceAccount {
...
static apiVersion: IIAMServiceAccount["apiVersion"] = "iam.cnrm.cloud.google.com/v1beta1";
static kind: IIAMServiceAccount["kind"] = "IAMServiceAccount";
static is = createTypeMetaGuard<IIAMServiceAccount>(IAMServiceAccount);

constructor(data?: ModelData<IIAMServiceAccount>) {
  super();

  this.setDefinedProps({
    apiVersion: IAMServiceAccount.apiVersion,
    kind: IAMServiceAccount.kind,
    ...data
  } as IIAMServiceAccount);
}
}


setValidateFunc(IAMServiceAccount, validate as ValidateFunc<IIAMServiceAccount>);
