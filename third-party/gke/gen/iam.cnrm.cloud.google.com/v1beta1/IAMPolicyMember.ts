...
import { validate } from "../../_schemas/IamCnrmCloudGoogleComV1beta1IAMPolicyMember";
 ...
 * IAMPolicyMember is the Schema for the iampolicies API
 */
export class IAMPolicyMember extends Model<IIAMPolicyMember> implements IIAMPolicyMember {
...
static apiVersion: IIAMPolicyMember["apiVersion"] = "iam.cnrm.cloud.google.com/v1beta1";
static kind: IIAMPolicyMember["kind"] = "IAMPolicyMember";
static is = createTypeMetaGuard<IIAMPolicyMember>(IAMPolicyMember);

constructor(data?: ModelData<IIAMPolicyMember>) {
  super();

  this.setDefinedProps({
    apiVersion: IAMPolicyMember.apiVersion,
    kind: IAMPolicyMember.kind,
    ...data
  } as IIAMPolicyMember);
}
}
...
setValidateFunc(IAMPolicyMember, validate as ValidateFunc<IIAMPolicyMember>);
