...
import { validate } from "../../_schemas/IamCnrmCloudGoogleComV1beta1IAMWorkloadIdentityPoolProvider";

export interface IIAMWorkloadIdentityPoolProvider {
  /**
...
export class IAMWorkloadIdentityPoolProvider extends Model<IIAMWorkloadIdentityPoolProvider> implements IIAMWorkloadIdentityPoolProvider {
  "apiVersion": IIAMWorkloadIdentityPoolProvider["apiVersion"];
  "kind": IIAMWorkloadIdentityPoolProvider["kind"];
  "metadata"?: IIAMWorkloadIdentityPoolProvider["metadata"];
  "spec": IIAMWorkloadIdentityPoolProvider["spec"];
  "status"?: IIAMWorkloadIdentityPoolProvider["status"];

static apiVersion: IIAMWorkloadIdentityPoolProvider["apiVersion"] = "iam.cnrm.cloud.google.com/v1beta1";
static kind: IIAMWorkloadIdentityPoolProvider["kind"] = "IAMWorkloadIdentityPoolProvider";
static is = createTypeMetaGuard<IIAMWorkloadIdentityPoolProvider>(IAMWorkloadIdentityPoolProvider);

constructor(data?: ModelData<IIAMWorkloadIdentityPoolProvider>) {
  super();

  this.setDefinedProps({
    apiVersion: IAMWorkloadIdentityPoolProvider.apiVersion,
    kind: IAMWorkloadIdentityPoolProvider.kind,
    ...data
  } as IIAMWorkloadIdentityPoolProvider);
}
}


setValidateFunc(IAMWorkloadIdentityPoolProvider, validate as ValidateFunc<IIAMWorkloadIdentityPoolProvider>);
