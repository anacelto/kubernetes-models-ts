...
import { validate } from "../../_schemas/ContaineranalysisCnrmCloudGoogleComV1beta1ContainerAnalysisNote";
...
export class ContainerAnalysisNote extends Model<IContainerAnalysisNote> implements IContainerAnalysisNote {
...
static apiVersion: IContainerAnalysisNote["apiVersion"] = "containeranalysis.cnrm.cloud.google.com/v1beta1";
static kind: IContainerAnalysisNote["kind"] = "ContainerAnalysisNote";
static is = createTypeMetaGuard<IContainerAnalysisNote>(ContainerAnalysisNote);

constructor(data?: ModelData<IContainerAnalysisNote>) {
  super();

  this.setDefinedProps({
    apiVersion: ContainerAnalysisNote.apiVersion,
    kind: ContainerAnalysisNote.kind,
    ...data
  } as IContainerAnalysisNote);
}
}


setValidateFunc(ContainerAnalysisNote, validate as ValidateFunc<IContainerAnalysisNote>);
