...
import { validate } from "../../_schemas/SpannerCnrmCloudGoogleComV1beta1SpannerDatabase";
...
export class SpannerDatabase extends Model<ISpannerDatabase> implements ISpannerDatabase {
...
static apiVersion: ISpannerDatabase["apiVersion"] = "spanner.cnrm.cloud.google.com/v1beta1";
static kind: ISpannerDatabase["kind"] = "SpannerDatabase";
static is = createTypeMetaGuard<ISpannerDatabase>(SpannerDatabase);

constructor(data?: ModelData<ISpannerDatabase>) {
  super();

  this.setDefinedProps({
    apiVersion: SpannerDatabase.apiVersion,
    kind: SpannerDatabase.kind,
    ...data
  } as ISpannerDatabase);
}
}
...
setValidateFunc(SpannerDatabase, validate as ValidateFunc<ISpannerDatabase>);
