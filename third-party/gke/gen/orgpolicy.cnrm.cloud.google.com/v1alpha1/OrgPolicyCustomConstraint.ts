...
import { validate } from "../../_schemas/OrgpolicyCnrmCloudGoogleComV1alpha1OrgPolicyCustomConstraint";
...
export class OrgPolicyCustomConstraint extends Model<IOrgPolicyCustomConstraint> implements IOrgPolicyCustomConstraint {
...
static apiVersion: IOrgPolicyCustomConstraint["apiVersion"] = "orgpolicy.cnrm.cloud.google.com/v1alpha1";
static kind: IOrgPolicyCustomConstraint["kind"] = "OrgPolicyCustomConstraint";
static is = createTypeMetaGuard<IOrgPolicyCustomConstraint>(OrgPolicyCustomConstraint);

constructor(data?: ModelData<IOrgPolicyCustomConstraint>) {
  super();

  this.setDefinedProps({
    apiVersion: OrgPolicyCustomConstraint.apiVersion,
    kind: OrgPolicyCustomConstraint.kind,
    ...data
  } as IOrgPolicyCustomConstraint);
}
}


setValidateFunc(OrgPolicyCustomConstraint, validate as ValidateFunc<IOrgPolicyCustomConstraint>);
