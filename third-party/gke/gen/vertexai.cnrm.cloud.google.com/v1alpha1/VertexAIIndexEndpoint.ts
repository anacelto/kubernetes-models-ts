...
import { validate } from "../../_schemas/VertexaiCnrmCloudGoogleComV1alpha1VertexAIIndexEndpoint";
...
export class VertexAIIndexEndpoint extends Model<IVertexAIIndexEndpoint> implements IVertexAIIndexEndpoint {
...
static apiVersion: IVertexAIIndexEndpoint["apiVersion"] = "vertexai.cnrm.cloud.google.com/v1alpha1";
static kind: IVertexAIIndexEndpoint["kind"] = "VertexAIIndexEndpoint";
static is = createTypeMetaGuard<IVertexAIIndexEndpoint>(VertexAIIndexEndpoint);

constructor(data?: ModelData<IVertexAIIndexEndpoint>) {
  super();

  this.setDefinedProps({
    apiVersion: VertexAIIndexEndpoint.apiVersion,
    kind: VertexAIIndexEndpoint.kind,
    ...data
  } as IVertexAIIndexEndpoint);
}
}


setValidateFunc(VertexAIIndexEndpoint, validate as ValidateFunc<IVertexAIIndexEndpoint>);
