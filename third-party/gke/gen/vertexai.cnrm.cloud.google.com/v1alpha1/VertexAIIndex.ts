...
import { validate } from "../../_schemas/VertexaiCnrmCloudGoogleComV1alpha1VertexAIIndex";
...
export class VertexAIIndex extends Model<IVertexAIIndex> implements IVertexAIIndex {
...
static apiVersion: IVertexAIIndex["apiVersion"] = "vertexai.cnrm.cloud.google.com/v1alpha1";
static kind: IVertexAIIndex["kind"] = "VertexAIIndex";
static is = createTypeMetaGuard<IVertexAIIndex>(VertexAIIndex);

constructor(data?: ModelData<IVertexAIIndex>) {
  super();

  this.setDefinedProps({
    apiVersion: VertexAIIndex.apiVersion,
    kind: VertexAIIndex.kind,
    ...data
  } as IVertexAIIndex);
}
}
...
setValidateFunc(VertexAIIndex, validate as ValidateFunc<IVertexAIIndex>);
