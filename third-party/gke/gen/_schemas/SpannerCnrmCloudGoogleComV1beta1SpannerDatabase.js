...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "v9p5lnq1RiGenJ4LBmFmhq2wJJKay6v2djmKK87mg"
    },
    "kind": {
      "$ref": "nH5n9rNAW0rBiR02CSIT0bf5aUQp75eENId3DULtYmg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "kQYfKTZ9TxHphcHNoKHsI18Fe4LsUeG7XUWNXsZ24"
    },
    "status": {
  ...
  "$id": "spanner.cnrm.cloud.google.com.v1beta1.SpannerDatabase"
};
const schema15 = {
  "type": "string",
...
function validate39(data, {
  ...
  if (!(data === "spanner.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.databaseDialect !== undefined) {
      if (!validate21(data.databaseDialect, {
        instancePath: instancePath + "/databaseDialect",
        parentData: data,
        parentDataProperty: "databaseDialect",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.ddl !== undefined) {
      if (!validate49(data.ddl, {
        instancePath: instancePath + "/ddl",
        parentData: data,
        parentDataProperty: "ddl",
        rootData
      })) {
    ...
    if (data.enableDropProtection !== undefined) {
      if (!validate53(data.enableDropProtection, {
        instancePath: instancePath + "/enableDropProtection",
        parentData: data,
        parentDataProperty: "enableDropProtection",
        rootData
      })) {
    ...
    if (data.encryptionConfig !== undefined) {
      if (!validate55(data.encryptionConfig, {
    ...
    if (data.instanceRef !== undefined) {
      if (!validate22(data.instanceRef, {
    ...
    if (data.versionRetentionPeriod !== undefined) {
      if (!validate21(data.versionRetentionPeriod, {
        instancePath: instancePath + "/versionRetentionPeriod",
        parentData: data,
        parentDataProperty: "versionRetentionPeriod",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate38(data, {
  ...
  /*# sourceURL="spanner.cnrm.cloud.google.com.v1beta1.SpannerDatabase" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
