...
const schema7 = {
  ...
  "properties": {
    "status": {
      "$ref": "GCrsCrxJb24FJl1lYBn4e7GoVAuwZvjbJpOJP0ipg"
    },
    "apiVersion": {
  ...
  "$id": "net.gke.io.v1.ServiceExport"
};
const schema8 = {
  "properties": {
    "conditions": {
      "$ref": "NfVU5x8sNSIRN9lsgXiHsB0qZ93FSi9wEtuN4uUang"
    }
  },
  "type": "object",
  "nullable": true
...
const schema9 = {
  "items": {
    "$ref": "W9FmciOLWoMFKuzWXxBHzctNeYVebkphqLHAI99M8Q"
  },
  "type": "array",
  "nullable": true
};
...
function validate22(data, {
  ...
  /*# sourceURL="net.gke.io.v1.ServiceExport" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
