...
const schema22 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "DAmEzGBeLR2ZDhP5lDMXo7pilpd3cKAikZG16Iuo"
    },
    "kind": {
      "$ref": "m9MPdHtxeE1CBMfKWp2kJ3jmT3APH8xNdzK6CmnFo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "6VWIvd9R57DRJE8QhHTdgEPwS85vPFqX5vaPg4IHU"
    },
    "status": {
  ...
  "$id": "certificatemanager.cnrm.cloud.google.com.v1alpha1.CertificateManagerCertificate"
};
const schema23 = {
  "type": "string",
  "enum": ["certificatemanager.cnrm.cloud.google.com/v1alpha1"]
};
function validate56(data, {
  ...
  if (!(data === "certificatemanager.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema24 = {
  "type": "string",
  "enum": ["CertificateManagerCertificate"]
};
function validate58(data, {
  ...
  if (!(data === "CertificateManagerCertificate")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema26 = {};
import { validate as validate61 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema27 = {
  "properties": {
    ...
    "managed": {
      "$ref": "MwbSgckvY17yCoamT3GVhi5aWMj6a6sqpssarrdKQ"
    },
    "projectRef": {
    ...
    "selfManaged": {
      "$ref": "2NbyOGJpsB34Tua5mSXRpLWTMu8r5uLHDZ9fyuf5c"
    }
  },
...
const schema28 = {
  "properties": {
    "authorizationAttemptInfo": {
      "$ref": "El9pKrkwnT4J7YkYMQcKZD6S5MU7QQonf55SdZ71g"
    },
    ...
    "provisioningIssue": {
      "$ref": "lGRCS7VqkXoLL2XsPRC3cYl3TZEZA0MkAHsWcyBuVo"
    },
    "state": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema29 = {
  "items": {
    "$ref": "jKG4zYFQbqdFPaX8j2idmiZjYQvizqJDTIpfG0l5jgQ"
  },
  "type": "array",
  "nullable": true
};
...
function validate68(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.failureReason !== undefined) {
      if (!validate21(data.failureReason, {
        instancePath: instancePath + "/failureReason",
        parentData: data,
        parentDataProperty: "failureReason",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema34 = {
  "items": {
    "$ref": "4puxsWUkjUCQHjEpprjywPlgl8kmMVvRRcR4bqsaO8"
  },
  "type": "array",
  "nullable": true
};
...
function validate66(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authorizationAttemptInfo !== undefined) {
      if (!validate67(data.authorizationAttemptInfo, {
        instancePath: instancePath + "/authorizationAttemptInfo",
        parentData: data,
        parentDataProperty: "authorizationAttemptInfo",
        rootData
      })) {
    ...
    if (data.dnsAuthorizationsRefs !== undefined) {
      if (!validate75(data.dnsAuthorizationsRefs, {
        instancePath: instancePath + "/dnsAuthorizationsRefs",
        parentData: data,
        parentDataProperty: "dnsAuthorizationsRefs",
        rootData
      })) {
    ...
    if (data.issuanceConfigRef !== undefined) {
      if (!validate81(data.issuanceConfigRef, {
        instancePath: instancePath + "/issuanceConfigRef",
        parentData: data,
        parentDataProperty: "issuanceConfigRef",
        rootData
      })) {
    ...
    if (data.provisioningIssue !== undefined) {
      if (!validate88(data.provisioningIssue, {
        instancePath: instancePath + "/provisioningIssue",
        parentData: data,
        parentDataProperty: "provisioningIssue",
        rootData
      })) {
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretKeyRef !== undefined) {
      if (!validate50(data.secretKeyRef, {
...
function validate99(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificatePem !== undefined) {
      if (!validate39(data.certificatePem, {
        instancePath: instancePath + "/certificatePem",
        parentData: data,
        parentDataProperty: "certificatePem",
        rootData
      })) {
    ...
    if (data.pemCertificate !== undefined) {
      if (!validate21(data.pemCertificate, {
        instancePath: instancePath + "/pemCertificate",
        parentData: data,
        parentDataProperty: "pemCertificate",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.pemPrivateKey !== undefined) {
      if (!validate39(data.pemPrivateKey, {
        instancePath: instancePath + "/pemPrivateKey",
        parentData: data,
        parentDataProperty: "pemPrivateKey",
        rootData
      })) {
        vErrors = vErrors === null ? validate39.errors : vErrors.concat(validate39.errors);
        errors = vErrors.length;
    ...
    if (data.privateKeyPem !== undefined) {
      if (!validate39(data.privateKeyPem, {
        instancePath: instancePath + "/privateKeyPem",
        parentData: data,
        parentDataProperty: "privateKeyPem",
        rootData
      })) {
        vErrors = vErrors === null ? validate39.errors : vErrors.concat(validate39.errors);
        errors = vErrors.length;
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.managed !== undefined) {
      if (!validate66(data.managed, {
        instancePath: instancePath + "/managed",
        parentData: data,
        parentDataProperty: "managed",
        rootData
      })) {
    ...
    if (data.selfManaged !== undefined) {
      if (!validate99(data.selfManaged, {
        instancePath: instancePath + "/selfManaged",
        parentData: data,
        parentDataProperty: "selfManaged",
        rootData
      })) {
...
function validate55(data, {
  ...
  /*# sourceURL="certificatemanager.cnrm.cloud.google.com.v1alpha1.CertificateManagerCertificate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
