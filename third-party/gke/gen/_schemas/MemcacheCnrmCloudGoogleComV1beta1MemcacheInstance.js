...
const schema10 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "SYNbo2ikRTmOwfyZZzqlL18VhxQiRLUGif2HtLbQO3M"
    },
    "kind": {
      "$ref": "yqJPKyzVmhKNUn4MquQCkM47X5PlGL7HgTDQKuenLnY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "kcVwDx8mk2aQR0MRFKS4RO4LNNI2xjCeFA3dyNpHI"
    },
    "status": {
      "$ref": "G7p1UsdJBVqNRQ0nyOC4c1acNKj5SLCnYNPrmNPxK0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "memcache.cnrm.cloud.google.com.v1beta1.MemcacheInstance"
};
const schema11 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "memcache.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "properties": {
    ...
    "maintenancePolicy": {
      "$ref": "dIB5ZvpTKvx4GOdNKOovEPtywVZ4kIQJ1ThvLte8"
    },
    "memcacheParameters": {
      "$ref": "b5IkBzAN9D2qBbBb2g7tGzMJhSrmz8D60Svwy7wCQ"
    },
    "memcacheVersion": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    ...
    "nodeConfig": {
      "$ref": "3Z8pRWByfr1bZFrtjMWNOASZEujub2mf5wayPzTNSNk"
    },
    "nodeCount": {
...
const schema16 = {
  "properties": {
    ...
    "weeklyMaintenanceWindow": {
      "$ref": "BPFduyJYHNPZP5crCStEer226ZWo4UNMlhDtHZTgA"
    }
  },
  "required": ["weeklyMaintenanceWindow"],
  "type": "object",
  "nullable": true
};
const schema17 = {
  "items": {
    "$ref": "qPdDeaAr1MlqxokwqQVRHnqHTf2WLDqpZPaRUOV5P64"
  },
  "type": "array"
};
const schema18 = {
  ...
  "required": ["day", "duration", "startTime"],
  "type": "object"
};
const schema7 = {
  "type": "string"
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.weeklyMaintenanceWindow === undefined) {
      const err1 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "weeklyMaintenanceWindow"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.weeklyMaintenanceWindow !== undefined) {
      if (!validate39(data.weeklyMaintenanceWindow, {
...
function validate76(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.memorySizeMb === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "memorySizeMb"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.memorySizeMb !== undefined) {
      if (!validate24(data.memorySizeMb, {
        instancePath: instancePath + "/memorySizeMb",
        parentData: data,
        parentDataProperty: "memorySizeMb",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.maintenancePolicy !== undefined) {
      if (!validate36(data.maintenancePolicy, {
    ...
    if (data.memcacheParameters !== undefined) {
      if (!validate52(data.memcacheParameters, {
        instancePath: instancePath + "/memcacheParameters",
        parentData: data,
        parentDataProperty: "memcacheParameters",
        rootData
      })) {
    ...
    if (data.memcacheVersion !== undefined) {
      if (!validate21(data.memcacheVersion, {
        instancePath: instancePath + "/memcacheVersion",
        parentData: data,
        parentDataProperty: "memcacheVersion",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema31 = {
  "properties": {
    ...
    "memcacheNodes": {
      "$ref": "VOAPgJGneDLoGejTZU2dfiKB5HvRqQFvZU72YXpOE"
    },
    "observedGeneration": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    }
...
const schema36 = {
  "items": {
    "$ref": "uyXmUT9Pd2c6chPBTo2I0M5nQGRwJemS6Kafc"
  },
  "type": "array",
  "nullable": true
};
...
function validate87(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.discoveryEndpoint !== undefined) {
      if (!validate21(data.discoveryEndpoint, {
        instancePath: instancePath + "/discoveryEndpoint",
        parentData: data,
        parentDataProperty: "discoveryEndpoint",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.maintenanceSchedule !== undefined) {
      if (!validate99(data.maintenanceSchedule, {
    ...
    if (data.memcacheFullVersion !== undefined) {
      if (!validate21(data.memcacheFullVersion, {
        instancePath: instancePath + "/memcacheFullVersion",
        parentData: data,
        parentDataProperty: "memcacheFullVersion",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.memcacheNodes !== undefined) {
      if (!validate107(data.memcacheNodes, {
        instancePath: instancePath + "/memcacheNodes",
        parentData: data,
        parentDataProperty: "memcacheNodes",
        rootData
      })) {
...
function validate25(data, {
  ...
  /*# sourceURL="memcache.cnrm.cloud.google.com.v1beta1.MemcacheInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
