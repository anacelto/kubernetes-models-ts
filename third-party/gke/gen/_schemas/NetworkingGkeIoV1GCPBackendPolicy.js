...
const schema17 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "tuKuMYpjioRuONjVBHpRy7Eqsx7q48Nxx3FWAPbt4Lc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "7cB4qLRRmMHmpcmwBAi6tUdYxh8oIGLTDPUlDonnhCg"
    },
    "status": {
      "$ref": "IAElkhRDDLoMuX5NmdNAfqdLfWLhpnx52lYFtkuY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "networking.gke.io.v1.GCPBackendPolicy"
};
const schema18 = {
  "type": "string",
...
const schema22 = {
  "properties": {
    "default": {
      "$ref": "TMKf90hDnWTZoveKoe00dYYXAtbQxVMMmvk48COrnU"
    },
    "targetRef": {
...
const schema23 = {
  "properties": {
    "backendPreference": {
      "$ref": "0HZzxcC7eGuLpSZyDuAjsSctnpHoTY0H0uK6LHQwg"
    },
    "connectionDraining": {
      "$ref": "6IdQFzLqAweD5evTx7VitqAN5G8WXrxGPvNQpS3jrU"
    },
    "iap": {
      "$ref": "MrE0Zms8OWFkM6c9WN4Xl7Vf4bfwlvbBBInf7DdIs"
    },
    "logging": {
      "$ref": "iEQpx6fSJD5liatrPyQUlogy4ZbY7yb545A8F402Pw"
    },
    "maxRatePerEndpoint": {
      "$ref": "9BJ8ZR0XwFa1DSSnUag2zhYbr9hSvYcmpnNewVqpG4"
    },
    "securityPolicy": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "sessionAffinity": {
      "$ref": "R2dxPsvlR7ifCDotjK68tOpdwasVCuwqQywTrbOo"
    },
    "timeoutSec": {
      "$ref": "c2r7nQhHDCpjKVz27MglDlwSP4AcctDKZGrbtFzPCfo"
    }
  },
  "type": "object",
  "nullable": true
...
function validate49(data, {
  ...
  if (!(data === "DEFAULT" || data === "PREFERRED")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema25 = {
  "properties": {
    "drainingTimeoutSec": {
      "$ref": "4A3I6pCPPv7gQMp2iVXwkFh65I17RmzFJKRCHVjbE"
    }
  },
  "type": "object",
  "nullable": true
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.drainingTimeoutSec !== undefined) {
      if (!validate52(data.drainingTimeoutSec, {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.oauth2ClientSecret !== undefined) {
      if (!validate58(data.oauth2ClientSecret, {
...
const schema29 = {
  "properties": {
    ...
    "sampleRate": {
      "$ref": "TgOanzRLLh2xyzK4TWHz8qgHTxaO2RWw3Wg3YJXs"
    }
  },
  "type": "object",
  "nullable": true
...
const schema32 = {
  "properties": {
    "cookieTtlSec": {
      "$ref": "Au62xc759P5AefRyUjSZtkUv78JX98anWk1LAma8yc"
    },
    "type": {
      "$ref": "G9PEL7RpG8YzoyJ7gf8gwl4STkMFXfD2PDtRiArOFw"
    }
  },
  "type": "object",
  "nullable": true
...
function validate73(data, {
  ...
  if (!(data === "CLIENT_IP" || data === "CLIENT_IP_PORT_PROTO" || data === "CLIENT_IP_PROTO" || data === "GENERATED_COOKIE" || data === "HEADER_FIELD" || data === "HTTP_COOKIE" || data === "NONE")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cookieTtlSec !== undefined) {
      if (!validate71(data.cookieTtlSec, {
        instancePath: instancePath + "/cookieTtlSec",
        parentData: data,
        parentDataProperty: "cookieTtlSec",
        rootData
      })) {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendPreference !== undefined) {
      if (!validate49(data.backendPreference, {
        instancePath: instancePath + "/backendPreference",
        parentData: data,
        parentDataProperty: "backendPreference",
        rootData
      })) {
    ...
    if (data.connectionDraining !== undefined) {
      if (!validate51(data.connectionDraining, {
    ...
    if (data.maxRatePerEndpoint !== undefined) {
      if (!validate67(data.maxRatePerEndpoint, {
    ...
    if (data.sessionAffinity !== undefined) {
      if (!validate70(data.sessionAffinity, {
...
const schema39 = {
  "properties": {
    "ancestors": {
      "$ref": "KhaLq9VG3UzMhzudSRta1bxbWN3ylw7FSRaHbMo4gQ"
    },
    "conditions": {
...
function validate91(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sectionName !== undefined) {
      if (!validate100(data.sectionName, {
...
function validate90(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ancestorRef !== undefined) {
      if (!validate91(data.ancestorRef, {
    ...
    if (data.controllerName !== undefined) {
      if (!validate106(data.controllerName, {
...
function validate38(data, {
  ...
  /*# sourceURL="networking.gke.io.v1.GCPBackendPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
