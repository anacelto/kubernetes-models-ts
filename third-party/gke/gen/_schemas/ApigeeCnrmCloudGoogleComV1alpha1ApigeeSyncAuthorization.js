...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "UitrdLlugbGVGZDIR5RCieGG8BrRyEpGEJE7O898EIM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "yJpITMBA4kNj4Wc8TBvOVphZ724kXEjVHyOPZ4nlIg4"
    },
    "status": {
  ...
  "$id": "apigee.cnrm.cloud.google.com.v1alpha1.ApigeeSyncAuthorization"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "ApigeeSyncAuthorization")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="apigee.cnrm.cloud.google.com.v1alpha1.ApigeeSyncAuthorization" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
