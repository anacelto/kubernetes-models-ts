...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "GRJrlZMzZYeQIrJxzxqFOgljEOJAaqwSpxMEquPrww"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "sm24fqYzQJPnMwvEg87sklduOVcXuAAhNSvWsPh4vg"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeInstanceGroupNamedPort"
};
const schema15 = {
  "type": "string",
...
const schema16 = {
  "type": "string",
  "enum": ["ComputeInstanceGroupNamedPort"]
};
function validate41(data, {
  ...
  if (!(data === "ComputeInstanceGroupNamedPort")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  ...
  "required": ["groupRef", "port", "projectRef", "zone"],
  "type": "object"
};
const schema7 = {
  "oneOf": [{
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.groupRef !== undefined) {
      if (!validate22(data.groupRef, {
        instancePath: instancePath + "/groupRef",
        parentData: data,
        parentDataProperty: "groupRef",
        rootData
      })) {
...
function validate38(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeInstanceGroupNamedPort" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
