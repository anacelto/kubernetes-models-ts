...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "hjkeYDe6W48DUEB1AkOB79zgJkUhgsd0OeR7NDGQg0"
    },
    "kind": {
      "$ref": "IaVhiw3dByVBx0C3fajpxAVDCcSUS8luuXHdVYMww94"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "2I8xrycNgXGNo7q0LHipyKjg1dp0ZrI5PaL5SkMPNcw"
    },
    "status": {
      "$ref": "hKIx0Ze8gMIa4KO5WQdH5q2EUMjUhRqZHgAsOdlk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "apigateway.cnrm.cloud.google.com.v1alpha1.APIGatewayGateway"
};
const schema9 = {
  "type": "string",
  "enum": ["apigateway.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "apigateway.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["apiConfig", "projectRef", "region"],
  "type": "object"
};
const schema7 = {
  "type": "string"
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiConfig !== undefined) {
      if (!validate22(data.apiConfig, {
        instancePath: instancePath + "/apiConfig",
        parentData: data,
        parentDataProperty: "apiConfig",
        rootData
      })) {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultHostname !== undefined) {
      if (!validate21(data.defaultHostname, {
        instancePath: instancePath + "/defaultHostname",
        parentData: data,
        parentDataProperty: "defaultHostname",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="apigateway.cnrm.cloud.google.com.v1alpha1.APIGatewayGateway" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
