...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "x8YXnVMPeqcZMjZ2BfmVbd8axIbrLsHVwctqnnyouko"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "2mmljAxlGV7Zm9eYcpF0jVwZUsYSY241GTKeDXtY"
    },
    "status": {
      "$ref": "LQRaIZwv70zhi3rZdqyWUf7yPgirq9YVpa9HqmaKj0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "vertexai.cnrm.cloud.google.com.v1alpha1.VertexAITensorboard"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    ...
    "encryptionSpec": {
      "$ref": "RRVD6cIfKCF2nXGhsy2CpvOa7tLLV6cGr1rsHb7kJNs"
    },
    "projectRef": {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.encryptionSpec !== undefined) {
      if (!validate34(data.encryptionSpec, {
        instancePath: instancePath + "/encryptionSpec",
        parentData: data,
        parentDataProperty: "encryptionSpec",
        rootData
      })) {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.blobStoragePathPrefix !== undefined) {
      if (!validate22(data.blobStoragePathPrefix, {
        instancePath: instancePath + "/blobStoragePathPrefix",
        parentData: data,
        parentDataProperty: "blobStoragePathPrefix",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.runCount !== undefined) {
      if (!validate22(data.runCount, {
        instancePath: instancePath + "/runCount",
        parentData: data,
        parentDataProperty: "runCount",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="vertexai.cnrm.cloud.google.com.v1alpha1.VertexAITensorboard" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
