...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "t3opB0Zv9D5jwL9vCAhENvuN85Xyv0eMAvj5qugcCU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "POXAuMwRcD1WJ9xVO0nsHqFh6hIRtWBiuzOqoofD6Y"
    },
    "status": {
  ...
  "$id": "identityplatform.cnrm.cloud.google.com.v1beta1.IdentityPlatformTenantOAuthIDPConfig"
};
const schema10 = {
  "type": "string",
...
function validate27(data, {
  ...
  if (!(data === "IdentityPlatformTenantOAuthIDPConfig")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    ...
    "responseType": {
      "$ref": "G6Asuaw11tvBFZsMJxMp04XfnwECD0aBnqQeqykKABQ"
    },
    "tenantRef": {
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.idToken !== undefined) {
      if (!validate23(data.idToken, {
        instancePath: instancePath + "/idToken",
        parentData: data,
        parentDataProperty: "idToken",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate33(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.tenantRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "tenantRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.clientSecret !== undefined) {
      if (!validate35(data.clientSecret, {
    ...
    if (data.responseType !== undefined) {
      if (!validate56(data.responseType, {
    ...
    if (data.tenantRef !== undefined) {
      if (!validate61(data.tenantRef, {
        instancePath: instancePath + "/tenantRef",
        parentData: data,
        parentDataProperty: "tenantRef",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="identityplatform.cnrm.cloud.google.com.v1beta1.IdentityPlatformTenantOAuthIDPConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
