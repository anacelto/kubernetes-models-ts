...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "O6u6SL87Kz9MMUVEknYqwXOAcDsxGMoXacrM9Omc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "UqSoLj5uaDP22hLvE6cwfPRQcJMWLAe3b4AfX0M5tsg"
    },
    "status": {
  ...
  "$id": "alloydb.cnrm.cloud.google.com.v1beta1.AlloyDBUser"
};
const schema9 = {
  "type": "string",
...
function validate63(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretKeyRef !== undefined) {
      if (!validate64(data.secretKeyRef, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.databaseRoles !== undefined) {
      if (!validate50(data.databaseRoles, {
        instancePath: instancePath + "/databaseRoles",
        parentData: data,
        parentDataProperty: "databaseRoles",
        rootData
      })) {
    ...
    if (data.userType !== undefined) {
      if (!validate22(data.userType, {
        instancePath: instancePath + "/userType",
        parentData: data,
        parentDataProperty: "userType",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="alloydb.cnrm.cloud.google.com.v1beta1.AlloyDBUser" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
