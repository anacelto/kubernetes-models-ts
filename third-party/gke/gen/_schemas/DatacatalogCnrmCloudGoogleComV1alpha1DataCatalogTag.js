...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Eud8J7OFMi54l3n3ARFyOEmSLHKHZwppWvr2deb37M8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "R6O4vVdUX0PkjRNbspXmedrW2j3676JniJGlDeG1oz8"
    },
    "status": {
      "$ref": "Mi8uqK9m7aK1GrghCanfjuvveNUFNQtwocHNESUUDI"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "datacatalog.cnrm.cloud.google.com.v1alpha1.DataCatalogTag"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    ...
    "fields": {
      "$ref": "iw1sYkhP4df54IRIJodwAdTG1VwgSOkUqi7dvEqR48"
    },
    "parent": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema15 = {
  "items": {
    "$ref": "hNNzmpfvSjX3rLZtts3KGrSBhHnOHISBrVvtNYX4"
  },
  "type": "array"
};
const schema16 = {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.boolValue !== undefined) {
      if (!validate37(data.boolValue, {
        instancePath: instancePath + "/boolValue",
        parentData: data,
        parentDataProperty: "boolValue",
        rootData
      })) {
    ...
    if (data.doubleValue !== undefined) {
      if (!validate40(data.doubleValue, {
        instancePath: instancePath + "/doubleValue",
        parentData: data,
        parentDataProperty: "doubleValue",
        rootData
      })) {
    ...
    if (data.enumValue !== undefined) {
      if (!validate21(data.enumValue, {
        instancePath: instancePath + "/enumValue",
        parentData: data,
        parentDataProperty: "enumValue",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.stringValue !== undefined) {
      if (!validate21(data.stringValue, {
    ...
    if (data.timestampValue !== undefined) {
      if (!validate21(data.timestampValue, {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.templateDisplayname !== undefined) {
      if (!validate21(data.templateDisplayname, {
        instancePath: instancePath + "/templateDisplayname",
        parentData: data,
        parentDataProperty: "templateDisplayname",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="datacatalog.cnrm.cloud.google.com.v1alpha1.DataCatalogTag" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
