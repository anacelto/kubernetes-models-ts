...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "LS6W5GsFOQXLrJRMCY5gRQCFkIFxMx9fFlLTdBmzrE"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "8D1CuWdGZfxpT5Ij63aMKgFFv71FTfxPaX8cEeatA"
    },
    "status": {
      "$ref": "rH64QM4AOtyfwMZc1f0tKhrz0kwBQ947vzaTdBHixk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "monitoring.gke.io.v1alpha1.PodMonitor"
};
const schema10 = {
  "type": "string",
  "enum": ["monitoring.gke.io/v1alpha1"]
};
function validate26(data, {
  ...
  if (!(data === "monitoring.gke.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    ...
    "podMetricsEndpoints": {
      "$ref": "vWmOFHCE2fuHVN61u9SxqqdmfKy9NeFjJrTvoUwSo"
    },
    "selector": {
...
const schema17 = {
  "items": {
    "$ref": "GoiLS3AMESmM5kOL6IGffv6Jcmvaa1MAiQWIlfxsE8"
  },
  "type": "array"
};
const schema18 = {
  "properties": {
    ...
    "metricRelabelings": {
      "$ref": "wIoY9ZKR1XcQHSSWqdeABMyODNuN7PLxPt9Pq23oSQ"
    },
    "path": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema19 = {
  "items": {
    "$ref": "rWB2G2WzUBZvcWnr54tPqiGja3kWnv72F4Tyspbs"
  },
  "type": "array",
  "nullable": true
};
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sourceLabels !== undefined) {
      if (!validate22(data.sourceLabels, {
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.metricRelabelings !== undefined) {
      if (!validate43(data.metricRelabelings, {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate58(data.matchExpressions, {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate65(data.matchLabels, {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podMetricsEndpoints !== undefined) {
      if (!validate40(data.podMetricsEndpoints, {
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.generatedConfigMap !== undefined) {
      if (!validate87(data.generatedConfigMap, {
        instancePath: instancePath + "/generatedConfigMap",
        parentData: data,
        parentDataProperty: "generatedConfigMap",
        rootData
      })) {
...
function validate25(data, {
  ...
  /*# sourceURL="monitoring.gke.io.v1alpha1.PodMonitor" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
