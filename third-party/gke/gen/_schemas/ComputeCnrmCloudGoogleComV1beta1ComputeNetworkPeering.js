...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "tdNi6tsVC9QjWu075QeEufc4tG3sA9MUdkaCnOU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "BJnhxxrhXCwL7L7tzv2vZjDKpN8qsqPy1mOSq5G2o"
    },
    "status": {
      "$ref": "YiTHpCGdsiuFVletbJvH23mSjPx4K1ajaYdV7Ba6Vk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeNetworkPeering"
};
const schema16 = {
  "type": "string",
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.peerNetworkRef === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "peerNetworkRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.exportCustomRoutes !== undefined) {
      if (!validate21(data.exportCustomRoutes, {
        instancePath: instancePath + "/exportCustomRoutes",
        parentData: data,
        parentDataProperty: "exportCustomRoutes",
        rootData
      })) {
    ...
    if (data.exportSubnetRoutesWithPublicIp !== undefined) {
      if (!validate21(data.exportSubnetRoutesWithPublicIp, {
        instancePath: instancePath + "/exportSubnetRoutesWithPublicIp",
        parentData: data,
        parentDataProperty: "exportSubnetRoutesWithPublicIp",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.importCustomRoutes !== undefined) {
      if (!validate21(data.importCustomRoutes, {
        instancePath: instancePath + "/importCustomRoutes",
        parentData: data,
        parentDataProperty: "importCustomRoutes",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.importSubnetRoutesWithPublicIp !== undefined) {
      if (!validate21(data.importSubnetRoutesWithPublicIp, {
        instancePath: instancePath + "/importSubnetRoutesWithPublicIp",
        parentData: data,
        parentDataProperty: "importSubnetRoutesWithPublicIp",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.peerNetworkRef !== undefined) {
      if (!validate23(data.peerNetworkRef, {
        instancePath: instancePath + "/peerNetworkRef",
        parentData: data,
        parentDataProperty: "peerNetworkRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate68(data.observedGeneration, {
    ...
    if (data.stateDetails !== undefined) {
      if (!validate22(data.stateDetails, {
        instancePath: instancePath + "/stateDetails",
        parentData: data,
        parentDataProperty: "stateDetails",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate39(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeNetworkPeering" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
