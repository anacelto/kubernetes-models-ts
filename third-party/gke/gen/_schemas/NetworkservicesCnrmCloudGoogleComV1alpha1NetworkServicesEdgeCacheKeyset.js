...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "JLUl74a3Qk1hspY1PMJQG46dmXW7FONjXFRl6si9g"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "4njIuvoxuhUfUmAnRJ6zEFB4jAvMSRL6niAxXE5kA"
    },
    "status": {
  ...
  "$id": "networkservices.cnrm.cloud.google.com.v1alpha1.NetworkServicesEdgeCacheKeyset"
};
const schema9 = {
  "type": "string",
...
const schema10 = {
  "type": "string",
  "enum": ["NetworkServicesEdgeCacheKeyset"]
};
function validate26(data, {
  ...
  if (!(data === "NetworkServicesEdgeCacheKeyset")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    ...
    "publicKey": {
      "$ref": "ns0GvEibic6ZRnZOpe3dd4O5WLmijcxb1IefL0V30s"
    },
    "resourceID": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "validationSharedKeys": {
      "$ref": "a8G4APk2DaLcljiOiPqAoVn8D5i1CsUyhAQgxQDRG0"
    }
  },
  "required": ["projectRef"],
  "type": "object"
...
const schema21 = {
  "items": {
    "$ref": "xluuwblQHSBP5JVnVDGn9PJucUomVJkbTZe8oMice4"
  },
  "type": "array",
  "nullable": true
};
...
const schema31 = {
  "items": {
    "$ref": "bRNGypCnWXNzgvsbModSXg2K3iLlK710WrUMErj6E"
  },
  "type": "array",
  "nullable": true
};
...
function validate76(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretVersion === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "secretVersion"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.secretVersion !== undefined) {
      if (!validate22(data.secretVersion, {
        instancePath: instancePath + "/secretVersion",
        parentData: data,
        parentDataProperty: "secretVersion",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.validationSharedKeys !== undefined) {
      if (!validate75(data.validationSharedKeys, {
        instancePath: instancePath + "/validationSharedKeys",
        parentData: data,
        parentDataProperty: "validationSharedKeys",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="networkservices.cnrm.cloud.google.com.v1alpha1.NetworkServicesEdgeCacheKeyset" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
