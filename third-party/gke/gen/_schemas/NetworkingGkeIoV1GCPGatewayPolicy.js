...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "8diBzka0SZlZQDB1fCeU9ZIVdCnt3Df8sBpYijC9x1A"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AcY0CgScWjRiuM9H0gOYWdwgz87x9xTq2LaYlwWpDo"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1.GCPGatewayPolicy"
};
const schema8 = {
  "type": "string",
...
const schema12 = {
  "properties": {
    "default": {
      "$ref": "ZUVdOzpFdrHXMekgU6iUV7okWbkeHxPSWy9oz4Ig"
    },
    "targetRef": {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowGlobalAccess !== undefined) {
      if (!validate33(data.allowGlobalAccess, {
    ...
    if (data.sslPolicy !== undefined) {
      if (!validate21(data.sslPolicy, {
        instancePath: instancePath + "/sslPolicy",
        parentData: data,
        parentDataProperty: "sslPolicy",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="networking.gke.io.v1.GCPGatewayPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
