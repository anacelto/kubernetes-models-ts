...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "3Sru1vpNHfzjiNFj7D2DNLedRt7yxOR1r8V2EeCUoBw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Ww5Fl1v3GE8iFalpp7DJURoofjx5sO2pr05cuD2jbB8"
    },
    "status": {
      "$ref": "InGTuX5xGsQXco04vhgUYBLMg1ilWEbEKoH2uh6VE"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeOrganizationSecurityPolicyAssociation"
};
const schema9 = {
  "type": "string",
...
const schema10 = {
  "type": "string",
  "enum": ["ComputeOrganizationSecurityPolicyAssociation"]
};
function validate26(data, {
  ...
  if (!(data === "ComputeOrganizationSecurityPolicyAssociation")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["attachmentId", "policyId"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.attachmentId !== undefined) {
      if (!validate21(data.attachmentId, {
        instancePath: instancePath + "/attachmentId",
        parentData: data,
        parentDataProperty: "attachmentId",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeOrganizationSecurityPolicyAssociation" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
