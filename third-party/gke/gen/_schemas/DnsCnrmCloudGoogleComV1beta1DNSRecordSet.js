...
const schema12 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Uvluuf2Xl1H8QQu03QyPeunAKsx5Peawr8s0H7ZsY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "4ahpxsPN89vQFEt9jL0GXkJWrwc3GrFfUA1xcKJSs"
    },
    "status": {
  ...
  "$id": "dns.cnrm.cloud.google.com.v1beta1.DNSRecordSet"
};
const schema13 = {
  "type": "string",
...
const schema17 = {
  "oneOf": [{
    "$ref": "cLCd1mNIR1PWK4jF1mMCWDvGFHEglrKEShtI3tTvE"
  }, {
    "$ref": "WpdOebzjzzWAPefQ16plK6tNcq6CNyZakKVNe3Es"
  }],
  "properties": {
    "managedZoneRef": {
    ...
    "rrdatasRefs": {
      "$ref": "lYyHqxTf4y2wH7t7nEN0oC5SuAeHlF3DxEEUfnkXpM"
    },
    "ttl": {
  ...
  "required": ["managedZoneRef", "name", "type"],
  "type": "object"
};
const schema18 = {
  "required": ["rrdatas"]
...
function validate39(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.rrdatasRefs === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "rrdatasRefs"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.managedZoneRef === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "managedZoneRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.managedZoneRef !== undefined) {
      if (!validate41(data.managedZoneRef, {
        instancePath: instancePath + "/managedZoneRef",
        parentData: data,
        parentDataProperty: "managedZoneRef",
        rootData
      })) {
    ...
    if (data.rrdatasRefs !== undefined) {
      if (!validate59(data.rrdatasRefs, {
        instancePath: instancePath + "/rrdatasRefs",
        parentData: data,
        parentDataProperty: "rrdatasRefs",
        rootData
      })) {
...
function validate27(data, {
  ...
  /*# sourceURL="dns.cnrm.cloud.google.com.v1beta1.DNSRecordSet" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
