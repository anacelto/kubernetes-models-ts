...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "hhatIAVx9EIkMuDMPSBXla9NZoe38TtYbluWHQnTY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "mZCEEM1fRP4LnaUqrOaMJ8WPP0Y3mTOgDcVmbU7lD70"
    },
    "status": {
      "$ref": "JOcTt5mD2gyj9gljHxj73jgkXwwI6HXyAzSDxF6u9Eo"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeTargetSSLProxy"
};
const schema17 = {
  "type": "string",
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.backendServiceRef !== undefined) {
      if (!validate32(data.backendServiceRef, {
    ...
    if (data.certificateMapRef !== undefined) {
      if (!validate38(data.certificateMapRef, {
        instancePath: instancePath + "/certificateMapRef",
        parentData: data,
        parentDataProperty: "certificateMapRef",
        rootData
      })) {
    ...
    if (data.proxyHeader !== undefined) {
      if (!validate21(data.proxyHeader, {
        instancePath: instancePath + "/proxyHeader",
        parentData: data,
        parentDataProperty: "proxyHeader",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.sslCertificates !== undefined) {
      if (!validate59(data.sslCertificates, {
        instancePath: instancePath + "/sslCertificates",
        parentData: data,
        parentDataProperty: "sslCertificates",
        rootData
      })) {
    ...
    if (data.sslPolicyRef !== undefined) {
      if (!validate38(data.sslPolicyRef, {
        instancePath: instancePath + "/sslPolicyRef",
        parentData: data,
        parentDataProperty: "sslPolicyRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate38.errors : vErrors.concat(validate38.errors);
        errors = vErrors.length;
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.creationTimestamp !== undefined) {
      if (!validate21(data.creationTimestamp, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate44(data.observedGeneration, {
    ...
    if (data.proxyId !== undefined) {
      if (!validate44(data.proxyId, {
        instancePath: instancePath + "/proxyId",
        parentData: data,
        parentDataProperty: "proxyId",
        rootData
      })) {
        vErrors = vErrors === null ? validate44.errors : vErrors.concat(validate44.errors);
        errors = vErrors.length;
...
function validate45(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeTargetSSLProxy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
