...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "yY24AG8buy7etrtdpn3DZE2oS8gzh6raAV5F1BkQHxA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "htZlaUVw1G0rGoWkgff8oPvpIRcXw8kLN2YuKBNM4"
    },
    "status": {
  ...
  "$id": "datacatalog.cnrm.cloud.google.com.v1beta1.DataCatalogTaxonomy"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.activatedPolicyTypes !== undefined) {
      if (!validate33(data.activatedPolicyTypes, {
        instancePath: instancePath + "/activatedPolicyTypes",
        parentData: data,
        parentDataProperty: "activatedPolicyTypes",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="datacatalog.cnrm.cloud.google.com.v1beta1.DataCatalogTaxonomy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
