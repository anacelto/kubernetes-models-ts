...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "bKvA0mm1hyht0BikjtUf0TdzAESFaIqNnHxOV70Ssk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "7LLg05HTpJ0KtPikoXoQxfe5ZWdTjkuYelg6pOcfLs"
    },
    "status": {
  ...
  "$id": "logging.cnrm.cloud.google.com.v1beta1.LoggingLogView"
};
const schema16 = {
  "type": "string",
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.billingAccountRef !== undefined) {
      if (!validate32(data.billingAccountRef, {
    ...
    if (data.organizationRef !== undefined) {
      if (!validate32(data.organizationRef, {
...
function validate39(data, {
  ...
  /*# sourceURL="logging.cnrm.cloud.google.com.v1beta1.LoggingLogView" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
