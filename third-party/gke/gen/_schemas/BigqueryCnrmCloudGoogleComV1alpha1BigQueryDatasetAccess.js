...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "qJRXku7sZMYIaagcRTsdWfeFmr6tDZlWRtV6FhEAQS8"
    },
    "kind": {
      "$ref": "TZnxJZuZHZbaDNxd7gCwE3R9re6s2vM53Ncmre3kJM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "086UV9xqeY6ibkrGAdJyjik2pz4nDEaUsPwPsCsPAs"
    },
    "status": {
      "$ref": "mjJfDGDYeQsMDeKNCZb0ELaORauhz95L2M8FLbKuQ"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "bigquery.cnrm.cloud.google.com.v1alpha1.BigQueryDatasetAccess"
};
const schema9 = {
  "type": "string",
  "enum": ["bigquery.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "bigquery.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.targetTypes !== undefined) {
      if (!validate38(data.targetTypes, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.iamMember !== undefined) {
      if (!validate22(data.iamMember, {
        instancePath: instancePath + "/iamMember",
        parentData: data,
        parentDataProperty: "iamMember",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiUpdatedMember !== undefined) {
      if (!validate74(data.apiUpdatedMember, {
        instancePath: instancePath + "/apiUpdatedMember",
        parentData: data,
        parentDataProperty: "apiUpdatedMember",
        rootData
      })) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate85(data.observedGeneration, {
...
function validate23(data, {
  ...
  /*# sourceURL="bigquery.cnrm.cloud.google.com.v1alpha1.BigQueryDatasetAccess" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
