...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "zZjp3lgOclMWgSu6MLST8jBiLvsZNuGSZOx4ptsU"
    },
    "kind": {
      "$ref": "Lh9hvxAY5FhEYv0FbeBSRYuPlFTCvtnwS6b9TcAFtw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "qflWnMDe9BRFpYMRmhH2KjgzF2DlsKHhRW0jFw44I"
    },
    "status": {
  ...
  "$id": "securitycenter.cnrm.cloud.google.com.v1alpha1.SecurityCenterSource"
};
const schema8 = {
  "type": "string",
  "enum": ["securitycenter.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "securitycenter.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  ...
  "required": ["displayName", "organizationRef"],
  "type": "object"
};
const schema13 = {
  "type": "string"
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.organizationRef !== undefined) {
      if (!validate34(data.organizationRef, {
...
function validate22(data, {
  ...
  /*# sourceURL="securitycenter.cnrm.cloud.google.com.v1alpha1.SecurityCenterSource" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
