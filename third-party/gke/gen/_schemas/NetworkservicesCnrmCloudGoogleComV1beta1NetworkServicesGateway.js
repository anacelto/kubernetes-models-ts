...
const schema15 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "WJOI2m7ICLJX73UYc8f7CztpIQCbFtlOJRBkbfRI9B4"
    },
    "kind": {
      "$ref": "jyKqBFcI8PzvyUYaBnaH2JZ6VE6YkefMnb9EXuop9Q"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Q8d662nwhxnLh3JqOZ7uycVyXJVZ9MbbuD9lc6jQ1E"
    },
    "status": {
      "$ref": "Sj5EMik2CTfgbL69406wdPBfvMwSi3UARp08BfKLVA"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesGateway"
};
const schema16 = {
  "type": "string",
...
function validate35(data, {
  ...
  if (!(data === "networkservices.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate37(data, {
  ...
  if (!(data === "NetworkServicesGateway")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema20 = {
  "properties": {
    ...
    "ports": {
      "$ref": "2flKxUFmivSMNEQv4VCMxk4QeFrmEyNLR75XzWtmmc"
    },
    "projectRef": {
...
function validate43(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.serverTlsPolicyRef !== undefined) {
      if (!validate61(data.serverTlsPolicyRef, {
        instancePath: instancePath + "/serverTlsPolicyRef",
        parentData: data,
        parentDataProperty: "serverTlsPolicyRef",
        rootData
      })) {
...
function validate34(data, {
  ...
  /*# sourceURL="networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesGateway" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
