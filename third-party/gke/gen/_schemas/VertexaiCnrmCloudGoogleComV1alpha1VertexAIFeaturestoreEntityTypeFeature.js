...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "BWhY2Dg8dKJLoUJD9sBkT0CGzbALOM9Oa2A9maLQck4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "oHtTHLVnXqPKOXiv3bw0RZbizixlRQni0uOUXeIGkNk"
    },
    "status": {
  ...
  "$id": "vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIFeaturestoreEntityTypeFeature"
};
const schema9 = {
  "type": "string",
...
const schema10 = {
  "type": "string",
  "enum": ["VertexAIFeaturestoreEntityTypeFeature"]
};
function validate26(data, {
  ...
  if (!(data === "VertexAIFeaturestoreEntityTypeFeature")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIFeaturestoreEntityTypeFeature" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
