...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "z0WQYCYovvdFAHaxhMGXeDbkjTdE20XVaDKLJHsuW4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "yebNPToPhhA2wbOJHSBSoKFpa993Ck9dVmhZ2QA6Ic"
    },
    "status": {
  ...
  "$id": "bigqueryreservation.cnrm.cloud.google.com.v1alpha1.BigQueryReservationReservation"
};
const schema10 = {
  "type": "string",
...
const schema11 = {
  "type": "string",
  "enum": ["BigQueryReservationReservation"]
};
function validate27(data, {
  ...
  if (!(data === "BigQueryReservationReservation")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    "autoscale": {
      "$ref": "4vAUPu7FdidrdwqJ0urMxcy9jTKVq1vceKCbKKpnJMg"
    },
    "concurrency": {
  ...
  "required": ["location", "projectRef", "slotCapacity"],
  "type": "object"
};
const schema15 = {
  "properties": {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.currentSlots !== undefined) {
      if (!validate21(data.currentSlots, {
        instancePath: instancePath + "/currentSlots",
        parentData: data,
        parentDataProperty: "currentSlots",
        rootData
      })) {
    ...
    if (data.maxSlots !== undefined) {
      if (!validate21(data.maxSlots, {
        instancePath: instancePath + "/maxSlots",
        parentData: data,
        parentDataProperty: "maxSlots",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ignoreIdleSlots !== undefined) {
      if (!validate22(data.ignoreIdleSlots, {
        instancePath: instancePath + "/ignoreIdleSlots",
        parentData: data,
        parentDataProperty: "ignoreIdleSlots",
        rootData
      })) {
    ...
    if (data.multiRegionAuxiliary !== undefined) {
      if (!validate22(data.multiRegionAuxiliary, {
        instancePath: instancePath + "/multiRegionAuxiliary",
        parentData: data,
        parentDataProperty: "multiRegionAuxiliary",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.slotCapacity !== undefined) {
      if (!validate62(data.slotCapacity, {
        instancePath: instancePath + "/slotCapacity",
        parentData: data,
        parentDataProperty: "slotCapacity",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="bigqueryreservation.cnrm.cloud.google.com.v1alpha1.BigQueryReservationReservation" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
