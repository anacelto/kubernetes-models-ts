...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "s9Un3OKmemorFSJD1BQLfEsbjiYtxEjBWxGZRBHFbo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Prh3XmAa7ybSnpGzqx64ajlZHUXKZYWQjweDt5CU"
    },
    "status": {
  ...
  "$id": "networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesMesh"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.interceptionPort !== undefined) {
      if (!validate33(data.interceptionPort, {
        instancePath: instancePath + "/interceptionPort",
        parentData: data,
        parentDataProperty: "interceptionPort",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesMesh" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
