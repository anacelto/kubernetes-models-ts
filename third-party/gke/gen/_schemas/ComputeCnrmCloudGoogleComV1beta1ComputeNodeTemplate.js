...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "3eeMtesxKTvleykoMn9yOPHHqvR0GTLqIPxwYAHoPs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "gZ74mpGL5eNwm03HHgmJDHxcy6Yxr58LHeNRv5jGw4I"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeNodeTemplate"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    ...
    "nodeTypeFlexibility": {
      "$ref": "uoLvnpnVpAyBSBVAojmm9DcLBSgPj4OekmnGrs4I0"
    },
    "region": {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cpus !== undefined) {
      if (!validate21(data.cpus, {
        instancePath: instancePath + "/cpus",
        parentData: data,
        parentDataProperty: "cpus",
        rootData
      })) {
    ...
    if (data.localSsd !== undefined) {
      if (!validate21(data.localSsd, {
        instancePath: instancePath + "/localSsd",
        parentData: data,
        parentDataProperty: "localSsd",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cpuOvercommitType !== undefined) {
      if (!validate21(data.cpuOvercommitType, {
        instancePath: instancePath + "/cpuOvercommitType",
        parentData: data,
        parentDataProperty: "cpuOvercommitType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.nodeType !== undefined) {
      if (!validate21(data.nodeType, {
        instancePath: instancePath + "/nodeType",
        parentData: data,
        parentDataProperty: "nodeType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.nodeTypeFlexibility !== undefined) {
      if (!validate35(data.nodeTypeFlexibility, {
        instancePath: instancePath + "/nodeTypeFlexibility",
        parentData: data,
        parentDataProperty: "nodeTypeFlexibility",
        rootData
      })) {
    ...
    if (data.serverBinding !== undefined) {
      if (!validate42(data.serverBinding, {
        instancePath: instancePath + "/serverBinding",
        parentData: data,
        parentDataProperty: "serverBinding",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeNodeTemplate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
