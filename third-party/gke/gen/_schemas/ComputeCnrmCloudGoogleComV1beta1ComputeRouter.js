...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "fXbEQWyQ9JNGBCBYTv2G6nTZmOmyhiTdwEI2r2pm1d0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Co7BadX9ZMCr1zMHEYuhrulZrEqWrnNUlhaUny3V8"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeRouter"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    "bgp": {
      "$ref": "SF7bwx6yW4ZOg8lQpfEYjd3zF7bBXlKRfiVVALGXc"
    },
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.advertiseMode !== undefined) {
      if (!validate22(data.advertiseMode, {
    ...
    if (data.advertisedGroups !== undefined) {
      if (!validate36(data.advertisedGroups, {
    ...
    if (data.advertisedIpRanges !== undefined) {
      if (!validate39(data.advertisedIpRanges, {
    ...
    if (data.asn !== undefined) {
      if (!validate44(data.asn, {
        instancePath: instancePath + "/asn",
        parentData: data,
        parentDataProperty: "asn",
        rootData
      })) {
    ...
    if (data.keepaliveInterval !== undefined) {
      if (!validate23(data.keepaliveInterval, {
        instancePath: instancePath + "/keepaliveInterval",
        parentData: data,
        parentDataProperty: "keepaliveInterval",
        rootData
      })) {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.bgp !== undefined) {
      if (!validate34(data.bgp, {
        instancePath: instancePath + "/bgp",
        parentData: data,
        parentDataProperty: "bgp",
        rootData
      })) {
    ...
    if (data.encryptedInterconnectRouter !== undefined) {
      if (!validate48(data.encryptedInterconnectRouter, {
        instancePath: instancePath + "/encryptedInterconnectRouter",
        parentData: data,
        parentDataProperty: "encryptedInterconnectRouter",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeRouter" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
