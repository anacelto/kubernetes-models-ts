...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "k5pVwX1pFU1X7C8464TF6O3DsPuJQrzHPFgxnUUUkB4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "BY3ZqQ8SCk5F6wj4PsIhg47hYn57AAxYNLdEFGqYWqQ"
    },
    "status": {
      "$ref": "DfkFd1cIT8VYXkE4SigVStYS0949hDATVeNWULuyxdA"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "iam.cnrm.cloud.google.com.v1beta1.IAMPartialPolicy"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    "bindings": {
      "$ref": "9Fvo8s1DO8IMOCdDBeCfs36PQX5Yd69Qiy57NuNv9k"
    },
    "resourceRef": {
      "$ref": "4cnELzIWYPYdXMGFsZboygoO6ezjaCAx4v17x5CTak"
    }
  },
...
const schema22 = {
  "items": {
    "$ref": "p4yB1cyQ1KcOmKuj54BEgTRBOQ07e4j4JPgtEJ84U"
  },
  "type": "array",
  "nullable": true
};
const schema23 = {
  "properties": {
    "condition": {
      "$ref": "4XPR3IgnaHaVJqgXUIPByzj3Fe69EKTG9jCUo8VLgSY"
    },
    "members": {
      "$ref": "AkRAKZUiZIm1CZAl0J0D0W7LsiQ0iE8HCcswXJsbe7A"
    },
    "role": {
      "$ref": "s3KBwCmrUk9DoWvtjFyvaGyUFrH7RXWus61jqSgN0Q"
    }
  },
  "required": ["role"],
  "type": "object"
...
const schema24 = {
  "items": {
    "$ref": "wUGBixs3KIscfNJfLP01BIeOkYd3EwIKnQtrwf3V5c"
  },
  "type": "array",
  "nullable": true
};
const schema25 = {
  "oneOf": [{
    "$ref": "7JpFn0KO0I77k7K7QSUsqKc4s9XNJvd5lKH0l52JCo"
  }, {
    "$ref": "YSu1wvqoOba4P6glwAtckY72niSmpBochxGqMVEW5E"
  }],
  "properties": {
    "member": {
    ...
    "memberFrom": {
      "$ref": "HwRlEFUsispQUfj9dYpSRUPqm3wQCnfntFlKzw"
    }
  },
  "type": "object"
};
...
function validate57(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.memberFrom === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "memberFrom"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
const schema28 = {
  "oneOf": [{
    "$ref": "B6LKpwUGWtMxO27LTGpIvbomaRZ2PnPAFmLWFE96SI"
  }, {
    "$ref": "y0kKZOxnpkwWF11X4N86q07yn98XTrTkaVwRVEXMk"
  }, {
    "$ref": "H5ife9uherNe29BcxDwAyshoOejPyaRvMvy3nBt6TTY"
  }, {
    "$ref": "monVUzFoZ9ISbaMdXQRstIxF0TW60bj4tUDVPvMGeA"
  }],
  "properties": {
    "logSinkRef": {
...
function validate61(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.logSinkRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "logSinkRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
function validate65(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.serviceIdentityRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "serviceIdentityRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
function validate67(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.sqlInstanceRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "sqlInstanceRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.logSinkRef !== undefined) {
      if (!validate23(data.logSinkRef, {
        instancePath: instancePath + "/logSinkRef",
        parentData: data,
        parentDataProperty: "logSinkRef",
        rootData
      })) {
    ...
    if (data.serviceIdentityRef !== undefined) {
      if (!validate23(data.serviceIdentityRef, {
        instancePath: instancePath + "/serviceIdentityRef",
        parentData: data,
        parentDataProperty: "serviceIdentityRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.sqlInstanceRef !== undefined) {
      if (!validate23(data.sqlInstanceRef, {
        instancePath: instancePath + "/sqlInstanceRef",
        parentData: data,
        parentDataProperty: "sqlInstanceRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.memberFrom !== undefined) {
      if (!validate60(data.memberFrom, {
        instancePath: instancePath + "/memberFrom",
        parentData: data,
        parentDataProperty: "memberFrom",
        rootData
      })) {
...
const pattern0 = new RegExp("^((projects|organizations)/[^/]+/)?roles/[\\w_\\.]+$", "u");
...
const schema34 = {
  "oneOf": [{
    ...
    "$ref": "VjE7MqC7hR0FQlHZk4CF6t0mrSdP8hP6kMj7HToYDHk"
  }],
  "properties": {
    "apiVersion": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
...
const schema38 = {
  "not": {
    "$ref": "8IfPxPjLa29e3Dh851AtrH8unSJh9h5MNbfDo37Bg"
  }
};
const schema39 = {
  "anyOf": [{
    ...
    "$ref": "FEVwEAqjVfxWIpqBaUKKzgjAD8FHQPbf2M6BryK8K8"
  }, {
    "$ref": "E3gBqlpCwbMTBUs4tUySAeMS9H0IGajx8nJUP5kbI"
  }]
};
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.bindings !== undefined) {
      if (!validate50(data.bindings, {
        instancePath: instancePath + "/bindings",
        parentData: data,
        parentDataProperty: "bindings",
        rootData
      })) {
    ...
    if (data.resourceRef !== undefined) {
      if (!validate80(data.resourceRef, {
...
const schema41 = {
  "properties": {
    "allBindings": {
      "$ref": "9Gp5YfbtRrN3n3ABUZXiOHwdOpNqbjnlaysBypIIC8"
    },
    "conditions": {
...
const schema13 = {
  "items": {
    "$ref": "uGPAVXgzXY184E8n5g9uZyjTZOlekvmmf7F0ZRrE"
  },
  "type": "array",
  "nullable": true
};
...
function validate106(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allBindings !== undefined) {
      if (!validate32(data.allBindings, {
        instancePath: instancePath + "/allBindings",
        parentData: data,
        parentDataProperty: "allBindings",
        rootData
      })) {
    ...
    if (data.lastAppliedBindings !== undefined) {
      if (!validate32(data.lastAppliedBindings, {
        instancePath: instancePath + "/lastAppliedBindings",
        parentData: data,
        parentDataProperty: "lastAppliedBindings",
        rootData
      })) {
        vErrors = vErrors === null ? validate32.errors : vErrors.concat(validate32.errors);
        errors = vErrors.length;
...
function validate40(data, {
  ...
  /*# sourceURL="iam.cnrm.cloud.google.com.v1beta1.IAMPartialPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
