...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "jgu08YzzmcIPiFgyYLP0Qb77wS4HGGWqS13h9t6k"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "iXG2q4nIehNb0FZPHMl6wKAcY6dxR31Q1BxEpi2SS0"
    },
    "status": {
      "$ref": "3fad45smjk4cs3eYFyH4L4SEJaM5iwITXYjMwf9wutI"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeManagedSSLCertificate"
};
const schema10 = {
  "type": "string",
...
const schema11 = {
  "type": "string",
  "enum": ["ComputeManagedSSLCertificate"]
};
function validate27(data, {
  ...
  if (!(data === "ComputeManagedSSLCertificate")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    "managed": {
      "$ref": "0hlyQ86D6HQAzOXQ5RrkKeUFLhFQShhXcYWYeVhM"
    },
    "projectRef": {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificateId !== undefined) {
      if (!validate22(data.certificateId, {
    ...
    if (data.subjectAlternativeNames !== undefined) {
      if (!validate74(data.subjectAlternativeNames, {
        instancePath: instancePath + "/subjectAlternativeNames",
        parentData: data,
        parentDataProperty: "subjectAlternativeNames",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeManagedSSLCertificate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
