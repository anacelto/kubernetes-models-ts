...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "SEyaYM9qEuyZdcK13N01S8i8Q1qCifogBMXlSTIVM4"
    },
    "kind": {
      "$ref": "LERsiuwOsfsb8WoISaMMwq2DVBmlRBFGU1tJzmHT3E"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Ysq6Pagn22OUcWs1HPsMbo3myWebW0eT0b21ERtHTGg"
    },
    "status": {
  ...
  "$id": "bigtable.cnrm.cloud.google.com.v1beta1.BigtableTable"
};
const schema9 = {
  "type": "string",
...
function validate24(data, {
  ...
  if (!(data === "bigtable.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    ...
    "columnFamily": {
      "$ref": "hs0vJyOcAJ1TwpWHytGOxe7yKRIjXvw9G5X90h4SUc"
    },
    "deletionProtection": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema14 = {
  "items": {
    "$ref": "CD1vsQRUNKGa43nWeAdQ6OJ0cyXxCDsY8SPjmrb4E"
  },
  "type": "array",
  "nullable": true
};
...
function validate32(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.instanceRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "instanceRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.changeStreamRetention !== undefined) {
      if (!validate21(data.changeStreamRetention, {
        instancePath: instancePath + "/changeStreamRetention",
        parentData: data,
        parentDataProperty: "changeStreamRetention",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.columnFamily !== undefined) {
      if (!validate34(data.columnFamily, {
        instancePath: instancePath + "/columnFamily",
        parentData: data,
        parentDataProperty: "columnFamily",
        rootData
      })) {
    ...
    if (data.deletionProtection !== undefined) {
      if (!validate21(data.deletionProtection, {
        instancePath: instancePath + "/deletionProtection",
        parentData: data,
        parentDataProperty: "deletionProtection",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.instanceRef !== undefined) {
      if (!validate40(data.instanceRef, {
        instancePath: instancePath + "/instanceRef",
        parentData: data,
        parentDataProperty: "instanceRef",
        rootData
      })) {
    ...
    if (data.splitKeys !== undefined) {
      if (!validate58(data.splitKeys, {
        instancePath: instancePath + "/splitKeys",
        parentData: data,
        parentDataProperty: "splitKeys",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="bigtable.cnrm.cloud.google.com.v1beta1.BigtableTable" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
