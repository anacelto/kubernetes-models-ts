...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "yjXmWNU6nwSCnfhb7FEmaKmYK4MEctRdwaaLZFXneQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "rZOWF0c0Yl7PGxOBJlBvWoHdorx75Rd8tgbDbYkI"
    },
    "status": {
  ...
  "$id": "documentai.cnrm.cloud.google.com.v1alpha1.DocumentAIProcessorDefaultVersion"
};
const schema8 = {
  "type": "string",
...
const schema9 = {
  "type": "string",
  "enum": ["DocumentAIProcessorDefaultVersion"]
};
function validate25(data, {
  ...
  if (!(data === "DocumentAIProcessorDefaultVersion")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="documentai.cnrm.cloud.google.com.v1alpha1.DocumentAIProcessorDefaultVersion" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
