...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "x9joMStRcLVHJxI1hXZsFxTzQN1Ag7MO6aEqjUM6lc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "pNlBm8X0k5oSefLRM3J0n4q38Pg8znkroCHiQglJKbs"
    },
    "status": {
  ...
  "$id": "spanner.cnrm.cloud.google.com.v1beta1.SpannerInstance"
};
const schema10 = {
  "type": "string",
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.processingUnits !== undefined) {
      if (!validate22(data.processingUnits, {
        instancePath: instancePath + "/processingUnits",
        parentData: data,
        parentDataProperty: "processingUnits",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="spanner.cnrm.cloud.google.com.v1beta1.SpannerInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
