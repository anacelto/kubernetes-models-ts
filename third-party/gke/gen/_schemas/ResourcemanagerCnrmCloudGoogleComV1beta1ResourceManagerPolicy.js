...
const schema20 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "m2jbU6cPJ81sOXqL9hR5XrNEEusmvzPKk5WG70nmk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "aBuhHmHht2B9EQ8GdlPaz87QcE5QXldIL5jjMackEY"
    },
    "status": {
      "$ref": "4r9XOSTdzCUz0K8P8fOBXDLb6qOxv2xFcd3SJz4c"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "resourcemanager.cnrm.cloud.google.com.v1beta1.ResourceManagerPolicy"
};
const schema21 = {
  "type": "string",
...
const schema25 = {
  "properties": {
    "booleanPolicy": {
      "$ref": "ZucsJDjff8ogjMXvxc2Mm4VrLv7Kxo0zAOwORgGsF8"
    },
    "constraint": {
    ...
    "listPolicy": {
      "$ref": "TH6DVjkc6MpH6I1lY36clPuI829RHDWRMtQX0Kf20"
    },
    "organizationRef": {
      "$ref": "FqwG3fNQDV94n3ssyud4YO0vSjAbQTxNuU0XWG96Y"
    },
    ...
    "restorePolicy": {
      "$ref": "JS2lCAXYq6IrfaPsWCkzsc1aS7AoizSVJQsEtiazn4"
    },
    "version": {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.enforced !== undefined) {
      if (!validate45(data.enforced, {
        instancePath: instancePath + "/enforced",
        parentData: data,
        parentDataProperty: "enforced",
        rootData
      })) {
...
const schema27 = {
  "properties": {
    "allow": {
      "$ref": "oKggogFITAEJp3tYUM1B1BLhwmxihGIjYTDYU8hP6EM"
    },
    "deny": {
      "$ref": "oKggogFITAEJp3tYUM1B1BLhwmxihGIjYTDYU8hP6EM"
    },
...
function validate62(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.inheritFromParent !== undefined) {
      if (!validate24(data.inheritFromParent, {
        instancePath: instancePath + "/inheritFromParent",
        parentData: data,
        parentDataProperty: "inheritFromParent",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.suggestedValue !== undefined) {
      if (!validate21(data.suggestedValue, {
        instancePath: instancePath + "/suggestedValue",
        parentData: data,
        parentDataProperty: "suggestedValue",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.booleanPolicy !== undefined) {
      if (!validate57(data.booleanPolicy, {
        instancePath: instancePath + "/booleanPolicy",
        parentData: data,
        parentDataProperty: "booleanPolicy",
        rootData
      })) {
    ...
    if (data.constraint !== undefined) {
      if (!validate22(data.constraint, {
        instancePath: instancePath + "/constraint",
        parentData: data,
        parentDataProperty: "constraint",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.listPolicy !== undefined) {
      if (!validate62(data.listPolicy, {
        instancePath: instancePath + "/listPolicy",
        parentData: data,
        parentDataProperty: "listPolicy",
        rootData
      })) {
    ...
    if (data.organizationRef !== undefined) {
      if (!validate29(data.organizationRef, {
    ...
    if (data.restorePolicy !== undefined) {
      if (!validate70(data.restorePolicy, {
        instancePath: instancePath + "/restorePolicy",
        parentData: data,
        parentDataProperty: "restorePolicy",
        rootData
      })) {
...
function validate47(data, {
  ...
  /*# sourceURL="resourcemanager.cnrm.cloud.google.com.v1beta1.ResourceManagerPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
