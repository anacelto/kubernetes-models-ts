...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Dau4mwd2GsoS95PcgE2Lu9j6aWjeNYjacFuYrqnyMA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Ig8AwdvGloVrGqTmeTUSsGvbz9Rf2IPmHYZdHANqsXI"
    },
    "status": {
  ...
  "$id": "kms.cnrm.cloud.google.com.v1beta1.KMSCryptoKey"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    ...
    "versionTemplate": {
      "$ref": "f0jtamNj6gR9I9So55PTHac64PgLxp45LJHGaK0gw4"
    }
  },
  "required": ["keyRingRef"],
  "type": "object"
...
function validate32(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.keyRingRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "keyRingRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.destroyScheduledDuration !== undefined) {
      if (!validate21(data.destroyScheduledDuration, {
        instancePath: instancePath + "/destroyScheduledDuration",
        parentData: data,
        parentDataProperty: "destroyScheduledDuration",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.importOnly !== undefined) {
      if (!validate22(data.importOnly, {
        instancePath: instancePath + "/importOnly",
        parentData: data,
        parentDataProperty: "importOnly",
        rootData
      })) {
    ...
    if (data.keyRingRef !== undefined) {
      if (!validate35(data.keyRingRef, {
        instancePath: instancePath + "/keyRingRef",
        parentData: data,
        parentDataProperty: "keyRingRef",
        rootData
      })) {
    ...
    if (data.skipInitialVersionCreation !== undefined) {
      if (!validate22(data.skipInitialVersionCreation, {
        instancePath: instancePath + "/skipInitialVersionCreation",
        parentData: data,
        parentDataProperty: "skipInitialVersionCreation",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.versionTemplate !== undefined) {
      if (!validate56(data.versionTemplate, {
        instancePath: instancePath + "/versionTemplate",
        parentData: data,
        parentDataProperty: "versionTemplate",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="kms.cnrm.cloud.google.com.v1beta1.KMSCryptoKey" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
