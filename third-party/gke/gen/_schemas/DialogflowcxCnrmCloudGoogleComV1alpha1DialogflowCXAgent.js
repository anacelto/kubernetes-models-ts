...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "I5PTOREthJdW5lP4JHzcw41mO74gJYPJ4fX56Raco"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "GyBVmNAXDrXyGpPJGEE3nSWZ9IAxwuNwGZ6a3EmZg0"
    },
    "status": {
      "$ref": "D0bJ7T5MKtUxem8LePfJJ7pcTQISSO3YZRgtrv7740"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "dialogflowcx.cnrm.cloud.google.com.v1alpha1.DialogflowCXAgent"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    ...
    "speechToTextSettings": {
      "$ref": "1zqnP0S3o0bDMeK0C5c0Hi73Zheto2McZP9eyyPZLY"
    },
  ...
  "required": ["defaultLanguageCode", "displayName", "location", "projectRef", "timeZone"],
  "type": "object"
};
const schema8 = {
  "type": "string",
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.enableSpeechAdaptation !== undefined) {
      if (!validate22(data.enableSpeechAdaptation, {
        instancePath: instancePath + "/enableSpeechAdaptation",
        parentData: data,
        parentDataProperty: "enableSpeechAdaptation",
        rootData
      })) {
...
function validate33(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.defaultLanguageCode === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "defaultLanguageCode"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.avatarUri !== undefined) {
      if (!validate23(data.avatarUri, {
        instancePath: instancePath + "/avatarUri",
        parentData: data,
        parentDataProperty: "avatarUri",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.defaultLanguageCode !== undefined) {
      if (!validate21(data.defaultLanguageCode, {
        instancePath: instancePath + "/defaultLanguageCode",
        parentData: data,
        parentDataProperty: "defaultLanguageCode",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.enableSpellCorrection !== undefined) {
      if (!validate22(data.enableSpellCorrection, {
        instancePath: instancePath + "/enableSpellCorrection",
        parentData: data,
        parentDataProperty: "enableSpellCorrection",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.securitySettings !== undefined) {
      if (!validate23(data.securitySettings, {
    ...
    if (data.speechToTextSettings !== undefined) {
      if (!validate59(data.speechToTextSettings, {
        instancePath: instancePath + "/speechToTextSettings",
        parentData: data,
        parentDataProperty: "speechToTextSettings",
        rootData
      })) {
    ...
    if (data.supportedLanguageCodes !== undefined) {
      if (!validate62(data.supportedLanguageCodes, {
        instancePath: instancePath + "/supportedLanguageCodes",
        parentData: data,
        parentDataProperty: "supportedLanguageCodes",
        rootData
      })) {
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.startFlow !== undefined) {
      if (!validate23(data.startFlow, {
        instancePath: instancePath + "/startFlow",
        parentData: data,
        parentDataProperty: "startFlow",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="dialogflowcx.cnrm.cloud.google.com.v1alpha1.DialogflowCXAgent" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
