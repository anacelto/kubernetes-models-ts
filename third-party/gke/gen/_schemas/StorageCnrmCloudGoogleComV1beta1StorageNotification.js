...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "dzUGf7Zpn0fw6WdxcxRsMME83i2QIUCLSBBy6jv5k"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "SPS7qI6yE6aESMuoLkzDIO1fAoWJGzcNtzM6KLTLb4c"
    },
    "status": {
      "$ref": "pVyzsdMMWL5kJQk64NuMkLnWwaIKFH2HTHAbt82KMnM"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "storage.cnrm.cloud.google.com.v1beta1.StorageNotification"
};
const schema16 = {
  "type": "string",
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.customAttributes !== undefined) {
      if (!validate50(data.customAttributes, {
        instancePath: instancePath + "/customAttributes",
        parentData: data,
        parentDataProperty: "customAttributes",
        rootData
      })) {
    ...
    if (data.objectNamePrefix !== undefined) {
      if (!validate21(data.objectNamePrefix, {
        instancePath: instancePath + "/objectNamePrefix",
        parentData: data,
        parentDataProperty: "objectNamePrefix",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.payloadFormat !== undefined) {
      if (!validate22(data.payloadFormat, {
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.notificationId !== undefined) {
      if (!validate21(data.notificationId, {
        instancePath: instancePath + "/notificationId",
        parentData: data,
        parentDataProperty: "notificationId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate39(data, {
  ...
  /*# sourceURL="storage.cnrm.cloud.google.com.v1beta1.StorageNotification" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
