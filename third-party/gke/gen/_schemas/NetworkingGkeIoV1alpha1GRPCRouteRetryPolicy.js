...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "xRZdeBAvUvGHMAkn6Q3RqeKJHnvAb6NXGnK7jol8"
    },
    "metadata": {
  ...
  "$id": "networking.gke.io.v1alpha1.GRPCRouteRetryPolicy"
};
const schema7 = {
  "type": "string",
...
function validate21(data, {
  ...
  /*# sourceURL="networking.gke.io.v1alpha1.GRPCRouteRetryPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
