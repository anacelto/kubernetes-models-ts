...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "kmZjLnfpcHEYiLT4buQOVbZO2SR0Mh3LGHiKQi2XbWc"
    },
    "kind": {
      "$ref": "uBVR2ZmKv9tlQdbQ4w9S94mYOYnHP259chx8Qna4"
    },
    "metadata": {
    ...
    "status": {
      "$ref": "1PUdXd7HKQimXm7TPQm6PUIcWY3Y5MSkU2KyQj4bhbg"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "firebase.cnrm.cloud.google.com.v1alpha1.FirebaseProject"
};
const schema8 = {
  "type": "string",
  "enum": ["firebase.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "firebase.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.projectNumber !== undefined) {
      if (!validate21(data.projectNumber, {
        instancePath: instancePath + "/projectNumber",
        parentData: data,
        parentDataProperty: "projectNumber",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="firebase.cnrm.cloud.google.com.v1alpha1.FirebaseProject" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
