...
const schema17 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "QDML1HmLsn6oxxEkmbxwnPSiT2ZiGDkvR9GRKjldDE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "gWPkvbbasqEDUJoLlo4utZN6FtRnW49s1tJCQxlXg"
    },
    "status": {
  ...
  "$id": "networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesTCPRoute"
};
const schema18 = {
  "type": "string",
...
function validate45(data, {
  ...
  if (!(data === "NetworkServicesTCPRoute")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema22 = {
  "properties": {
    ...
    "rules": {
      "$ref": "Afjj4C4GHEm21gP6vpfgzIAPPX4E49xtnvtEFg4Q"
    }
  },
...
const schema23 = {
  "items": {
    "$ref": "vgUWbgIU75BURYLILs6K6KvaafE4hpQDbXer2SajU"
  },
  "type": "array"
};
const schema24 = {
  "properties": {
    "action": {
      "$ref": "HveUmyxwcsnyPn1Lzgs57cG3UrAifQgKI56ESD6Mctg"
    },
    "matches": {
      "$ref": "xbo9bnUtPZczBdwTmueTTIn8UmglWnxt6kbDb58jpU"
    }
  },
  "required": ["action"],
  "type": "object"
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.destinations !== undefined) {
      if (!validate60(data.destinations, {
    ...
    if (data.originalDestination !== undefined) {
      if (!validate67(data.originalDestination, {
        instancePath: instancePath + "/originalDestination",
        parentData: data,
        parentDataProperty: "originalDestination",
        rootData
      })) {
...
const schema30 = {
  "items": {
    "$ref": "OIVeSo6FySC0d9T6fFBRQITS7vhG6UxHRv3EkAzkHI"
  },
  "type": "array",
  "nullable": true
};
...
function validate42(data, {
  ...
  /*# sourceURL="networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesTCPRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
