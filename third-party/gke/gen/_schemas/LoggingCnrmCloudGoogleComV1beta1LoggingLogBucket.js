...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "1UdqJVO4tactmkuu7pEn6HMKxII7AK8b5u8Vp0f0k"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "CbbrQckgIXp0zbaqkDT1l9pESZO24BhgbYqq0pfFg"
    },
    "status": {
      "$ref": "HGlbAoweSd67ZuL0fX5mEXPwbxWadDOETbAOo1FvU0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "logging.cnrm.cloud.google.com.v1beta1.LoggingLogBucket"
};
const schema16 = {
  "type": "string",
...
const schema20 = {
  "oneOf": [{
    "$ref": "jiw8HqPCtIbcfc7A0ZlkYDbB2RVlIT8EStD9GWEY"
  }, {
    "$ref": "0GCkP4BVpwHWi9718w3rYoDAt9WDTgdUoz9nh7RMvCk"
  }, {
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.billingAccountRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "billingAccountRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.billingAccountRef !== undefined) {
      if (!validate22(data.billingAccountRef, {
        instancePath: instancePath + "/billingAccountRef",
        parentData: data,
        parentDataProperty: "billingAccountRef",
        rootData
      })) {
    ...
    if (data.retentionDays !== undefined) {
      if (!validate66(data.retentionDays, {
        instancePath: instancePath + "/retentionDays",
        parentData: data,
        parentDataProperty: "retentionDays",
        rootData
      })) {
...
function validate69(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lifecycleState !== undefined) {
      if (!validate21(data.lifecycleState, {
        instancePath: instancePath + "/lifecycleState",
        parentData: data,
        parentDataProperty: "lifecycleState",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate39(data, {
  ...
  /*# sourceURL="logging.cnrm.cloud.google.com.v1beta1.LoggingLogBucket" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
