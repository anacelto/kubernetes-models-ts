...
const schema8 = {
  ...
  "properties": {
    "spec": {
      "$ref": "T4XLeEByjsWuAVH1oKJiguKSrktwH7TNBiCMUvyjdSM"
    },
    "status": {
      "$ref": "VeELodJYTZIAvCo8j0WgSYPSbzKm7pGccYz4OKr4"
    },
    "apiVersion": {
      "$ref": "XZqPFMfV5dMjnMvOdJicfxDdlXnyuGtwbyfK8SR7jE"
    },
    "kind": {
      "$ref": "N6M1Ppm5W3xzB2mG0Ke5w4LSHmpYcULzBmP7Qykfc8"
    },
    "metadata": {
  ...
  "$id": "net.gke.io.v1.ServiceImport"
};
const schema9 = {
  "properties": {
    "ips": {
      "$ref": "2cboPcXUaOLx7xFjAiWT85NMTw466sSKdRy9DCZ38"
    },
    "ports": {
      "$ref": "1gmvGmpYjvm987jH4IWinEib8SRa3NWa05TuelQOHw"
    },
    "sessionAffinity": {
...
const schema11 = {
  "items": {
    "$ref": "b3FEiPPtNPOXDT9dv49F8CI8Dp9pnBU5kIIOVGUiA8"
  },
  "type": "array"
};
const schema12 = {
...
function validate24(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ips !== undefined) {
      if (!validate25(data.ips, {
        instancePath: instancePath + "/ips",
        parentData: data,
        parentDataProperty: "ips",
        rootData
      })) {
    ...
    if (data.sessionAffinityConfig !== undefined) {
      if (!validate38(data.sessionAffinityConfig, {
...
const schema17 = {
  "properties": {
    "clusters": {
      "$ref": "AzZtau3qzxWB91V5EBSfvYoGsjlsNGfZZHMDpvz1Fk"
    }
  },
  "type": "object",
  "nullable": true
...
const schema18 = {
  "items": {
    "$ref": "yJUUHHp4qVvSASx88rm0QhXyM3Y2gnjGiFYQfg2Ut4"
  },
  "type": "array",
  "nullable": true
};
...
const schema23 = {};
import { validate as validate58 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
function validate23(data, {
  ...
  /*# sourceURL="net.gke.io.v1.ServiceImport" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
