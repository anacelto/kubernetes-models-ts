...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "6uhso5JtpvCdjsFxswwIPX5gfOMZxmNKm73OtRdlpw4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "cFRWgGnDAs1Zve7eBTLkKQe7FhwYt5ZvzmxYztXtqU"
    },
    "status": {
      "$ref": "VBmSPsSXyt4LZHsf0jHV2KsJEqisyo4fsLwbENw"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "firebase.cnrm.cloud.google.com.v1alpha1.FirebaseAndroidApp"
};
const schema10 = {
  "type": "string",
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiKeyId !== undefined) {
      if (!validate21(data.apiKeyId, {
        instancePath: instancePath + "/apiKeyId",
        parentData: data,
        parentDataProperty: "apiKeyId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.packageName !== undefined) {
      if (!validate21(data.packageName, {
        instancePath: instancePath + "/packageName",
        parentData: data,
        parentDataProperty: "packageName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.sha1Hashes !== undefined) {
      if (!validate23(data.sha1Hashes, {
        instancePath: instancePath + "/sha1Hashes",
        parentData: data,
        parentDataProperty: "sha1Hashes",
        rootData
      })) {
    ...
    if (data.sha256Hashes !== undefined) {
      if (!validate23(data.sha256Hashes, {
        instancePath: instancePath + "/sha256Hashes",
        parentData: data,
        parentDataProperty: "sha256Hashes",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate25(data, {
  ...
  /*# sourceURL="firebase.cnrm.cloud.google.com.v1alpha1.FirebaseAndroidApp" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
