...
const schema25 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "VdZbLdLLsvcjgqzzFduUugr0pc2h2AyURA94CEykU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "C1MxXmZ7ozd2PXT1bvbgpxnHkRaUfOlenZjF0FIjdeg"
    },
    "status": {
      "$ref": "OzF0HZ6ZA6RQmb7JD8XPtkxR0ns7fYzBtZSNNSdY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "run.cnrm.cloud.google.com.v1beta1.RunJob"
};
const schema26 = {
  "type": "string",
...
const schema30 = {
  "properties": {
    ...
    "template": {
      "$ref": "dDwDYksbCGAX95nqBLwXezjcxpGb237B2EttpkrUL8"
    }
  },
...
const schema32 = {
  "properties": {
    ...
    "template": {
      "$ref": "TfP1h53nlUpr7giyJwxdBf9kVvPLjSIziy6bqfl48eU"
    }
  },
  "required": ["template"],
  "type": "object"
...
const schema33 = {
  "properties": {
    "containers": {
      "$ref": "DduPmbkGbXD4RUSmqimvkpK14knwCvP4g9MnNOyXkU"
    },
    "encryptionKeyRef": {
    ...
    "volumes": {
      "$ref": "zM4ue2d9J1Ix6zrIO4VKTcERRPxolIHMGjbtWYVbcQ"
    },
    "vpcAccess": {
      "$ref": "7htDbxtnnkcV7jLMwK1mNUk1d9bqRQpkVlJeRPmcA"
    }
  },
  "type": "object"
};
const schema34 = {
  "items": {
    "$ref": "wq51L5JLMG962w9rL986J3halMaIyrBy4sN5PEg3YE"
  },
  "type": "array",
  "nullable": true
};
const schema35 = {
  "properties": {
    ...
    "env": {
      "$ref": "ihxorjJa7womjwBBmpZFe9aYGhYmSEHNq9kXcNI"
    },
    "image": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    "livenessProbe": {
      "$ref": "shesz6n5T7nxA8NUHuJb60wYJh4wCdLbyQD0AZ5A"
    },
    "name": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    ...
    "resources": {
      "$ref": "i1iaOyEhgZiN5oldp6a5t4R2T8WX2kkRx5b7yH23g4"
    },
    "startupProbe": {
      "$ref": "shesz6n5T7nxA8NUHuJb60wYJh4wCdLbyQD0AZ5A"
    },
...
const schema36 = {
  "items": {
    "$ref": "Imkxiovx4xo9q4kP0MiaZq6aceghIXOZdULVPaPQyzw"
  },
  "type": "array",
  "nullable": true
};
const schema37 = {
  "properties": {
    ...
    "valueSource": {
      "$ref": "DH9hLyOV0mGa5c1IcugzRQB2tWY3euQ9fAGk9WlDjM"
    }
  },
  "required": ["name"],
  "type": "object"
...
const schema38 = {
  "properties": {
    "secretKeyRef": {
      "$ref": "rym3rDpNcfF1srKglVdLtqqTMpbLSMX5AjcOeSrimhQ"
    }
  },
  "type": "object",
  "nullable": true
...
function validate102(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretKeyRef !== undefined) {
      if (!validate103(data.secretKeyRef, {
...
function validate99(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.valueSource !== undefined) {
      if (!validate102(data.valueSource, {
...
const schema18 = {
  "properties": {
    ...
    "httpGet": {
      "$ref": "ZGOfjC9YRmxJXCNcGAbCAbXrJWCVIyhfzPduiCnzo"
    },
    "initialDelaySeconds": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    },
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.httpHeaders !== undefined) {
      if (!validate47(data.httpHeaders, {
...
function validate114(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.containerPort !== undefined) {
      if (!validate25(data.containerPort, {
...
function validate95(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.livenessProbe !== undefined) {
      if (!validate44(data.livenessProbe, {
    ...
    if (data.startupProbe !== undefined) {
      if (!validate44(data.startupProbe, {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate123(data.volumeMounts, {
...
const schema45 = {
  "items": {
    "$ref": "78KNDwCPK2OCzWQB7g0aWB62oDeipTsChs8vG32CQ"
  },
  "type": "array",
  "nullable": true
};
const schema46 = {
  "properties": {
    ...
    "secret": {
      "$ref": "mhaT7jWlOMqGadAjOWTrjfywSrJxftYuKTeylL0WO0"
    }
  },
  "required": ["name"],
  "type": "object"
...
const schema48 = {
  "properties": {
    ...
    "items": {
      "$ref": "44tRS9yp0kDQinIEFBiRCqdIIDp0yZSKjlfiVcTY0"
    },
    "secretRef": {
      "$ref": "jO1fsDyaXk8R682yU9au3UFcW8lqIiAbXrerzENnRTc"
    }
...
const schema49 = {
  "items": {
    "$ref": "4MlatOsgH0CT7oZsRjW5ydxRMnuM4PkNbJivUaeAk"
  },
  "type": "array",
  "nullable": true
};
...
function validate144(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultMode !== undefined) {
      if (!validate25(data.defaultMode, {
...
function validate160(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.subnetworkRef !== undefined) {
      if (!validate61(data.subnetworkRef, {
...
function validate157(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.networkInterfaces !== undefined) {
      if (!validate159(data.networkInterfaces, {
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.encryptionKeyRef !== undefined) {
      if (!validate61(data.encryptionKeyRef, {
    ...
    if (data.serviceAccountRef !== undefined) {
      if (!validate61(data.serviceAccountRef, {
...
function validate89(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.parallelism !== undefined) {
      if (!validate25(data.parallelism, {
    ...
    if (data.taskCount !== undefined) {
      if (!validate25(data.taskCount, {
        instancePath: instancePath + "/taskCount",
        parentData: data,
        parentDataProperty: "taskCount",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
...
function validate77(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.binaryAuthorization !== undefined) {
      if (!validate79(data.binaryAuthorization, {
...
const schema54 = {
  "properties": {
    ...
    "latestCreatedExecution": {
      "$ref": "mhrs2iMHe86CpfOYKxlWtZBoKvKdow3fho2mRXh1q8"
    },
    "observedGeneration": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    },
    ...
    "terminalCondition": {
      "$ref": "Qkk10x8xCHJ5pE3OORswiWKW8iibLtLZmtD9LwPlU"
    },
    "uid": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema57 = {
  "items": {
    "$ref": "SC03qD5QaaIBEJ12BRUVn4c4ZeI0YsNRUo4HlI1o"
  },
  "type": "array",
  "nullable": true
};
...
function validate188(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.completionTime !== undefined) {
      if (!validate21(data.completionTime, {
...
const schema59 = {
  "items": {
    "$ref": "JECG390HbF30SASP91G9BY9phVk0yAkQnU6r3BRcUg"
  },
  "type": "array",
  "nullable": true
};
...
function validate197(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.executionReason !== undefined) {
      if (!validate21(data.executionReason, {
        instancePath: instancePath + "/executionReason",
        parentData: data,
        parentDataProperty: "executionReason",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate170(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.executionCount !== undefined) {
      if (!validate25(data.executionCount, {
        instancePath: instancePath + "/executionCount",
        parentData: data,
        parentDataProperty: "executionCount",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
    ...
    if (data.latestCreatedExecution !== undefined) {
      if (!validate187(data.latestCreatedExecution, {
        instancePath: instancePath + "/latestCreatedExecution",
        parentData: data,
        parentDataProperty: "latestCreatedExecution",
        rootData
      })) {
    ...
    if (data.reconciling !== undefined) {
      if (!validate67(data.reconciling, {
    ...
    if (data.terminalCondition !== undefined) {
      if (!validate196(data.terminalCondition, {
...
function validate68(data, {
  ...
  /*# sourceURL="run.cnrm.cloud.google.com.v1beta1.RunJob" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
