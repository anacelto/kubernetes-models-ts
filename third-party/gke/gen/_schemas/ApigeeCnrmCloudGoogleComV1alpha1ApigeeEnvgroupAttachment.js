...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "aGPqZSzyvYyoINfibfgQF36r2ZnQRZOPVrvN53ZcHE"
    },
    "kind": {
      "$ref": "enyVCdYh9LHZuBkvY4QP1dMhRb9aXQFP9hCmUWLKn4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "oz9C7ItJXOjLGenh9ysrYSMBe9S3ht4xt8Gr6q7gw"
    },
    "status": {
  ...
  "$id": "apigee.cnrm.cloud.google.com.v1alpha1.ApigeeEnvgroupAttachment"
};
const schema9 = {
  "type": "string",
  "enum": ["apigee.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "apigee.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate26(data, {
  ...
  if (!(data === "ApigeeEnvgroupAttachment")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["envgroupId", "environment"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.envgroupId === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "envgroupId"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.envgroupId !== undefined) {
      if (!validate21(data.envgroupId, {
        instancePath: instancePath + "/envgroupId",
        parentData: data,
        parentDataProperty: "envgroupId",
        rootData
      })) {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate48(data.observedGeneration, {
...
function validate23(data, {
  ...
  /*# sourceURL="apigee.cnrm.cloud.google.com.v1alpha1.ApigeeEnvgroupAttachment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
