...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "JKohsN3C7EuqTGr3TrHtjGcjq82ZhdVnv9eJAMhLS0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "UjYlAUzGYCqjoKbEYg2HbP4jRM5PPKePfoCkvRBfusY"
    },
    "status": {
      "$ref": "BuGO2ACr4OHB61L9Er7upokpHkdt8Q20ijTYWtSpum4"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "iam.cnrm.cloud.google.com.v1beta1.IAMAccessBoundaryPolicy"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "IAMAccessBoundaryPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    ...
    "rules": {
      "$ref": "dX5AgD1lYNOmAms1xcZ1DSwFWfefudBBm0fmCA4MlY"
    }
  },
  "required": ["projectRef", "rules"],
  "type": "object"
};
const schema6 = {
  "type": "string",
...
const schema21 = {
  "items": {
    "$ref": "CWBzmCPzNlE3rkcK1dYyVvMhkkoQ0IaHzxXqhLzsIjU"
  },
  "type": "array"
};
const schema22 = {
  "properties": {
    "accessBoundaryRule": {
      "$ref": "wfeV4PsgLTvEDhr4hq8isrcHbeFkKkQq6eInqOXAc"
    }
  },
  "type": "object"
};
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.availabilityCondition !== undefined) {
      if (!validate55(data.availabilityCondition, {
        instancePath: instancePath + "/availabilityCondition",
        parentData: data,
        parentDataProperty: "availabilityCondition",
        rootData
      })) {
    ...
    if (data.availablePermissions !== undefined) {
      if (!validate60(data.availablePermissions, {
        instancePath: instancePath + "/availablePermissions",
        parentData: data,
        parentDataProperty: "availablePermissions",
        rootData
      })) {
    ...
    if (data.availableResource !== undefined) {
      if (!validate21(data.availableResource, {
        instancePath: instancePath + "/availableResource",
        parentData: data,
        parentDataProperty: "availableResource",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate53(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.accessBoundaryRule !== undefined) {
      if (!validate54(data.accessBoundaryRule, {
        instancePath: instancePath + "/accessBoundaryRule",
        parentData: data,
        parentDataProperty: "accessBoundaryRule",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="iam.cnrm.cloud.google.com.v1beta1.IAMAccessBoundaryPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
