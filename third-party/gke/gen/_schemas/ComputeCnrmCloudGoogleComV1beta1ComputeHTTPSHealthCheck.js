...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "7juafLXKcNO10tuWb9FG4veqhQC42xWsoSAqPakuc"
    },
    "metadata": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeHTTPSHealthCheck"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "ComputeHTTPSHealthCheck")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeHTTPSHealthCheck" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
