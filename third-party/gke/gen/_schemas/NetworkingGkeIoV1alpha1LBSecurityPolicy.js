...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "btxS6LMZu7JTcuBDszhQsDHDgD4MBPhlsjHhDPuQ5E"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "p5YpVtVWg9J1PbnnTWLrdR9Qzps8vonr1vcM3IQkxs"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1alpha1.LBSecurityPolicy"
};
const schema7 = {
  "type": "string",
...
const schema11 = {
  "properties": {
    "default": {
      "$ref": "DTTeMp452eExne75dDsk7y2kAbwTqydWY09JT2ubgF8"
    },
    "targetRef": {
...
const schema12 = {
  "properties": {
    "name": {
      "$ref": "C40oPn8Z6QKW1zROceOFRtywq3aqWg7EHeilKAonzY"
    }
  },
  "required": ["name"],
  "type": "object",
...
const pattern0 = new RegExp("[a-z][a-z0-9-]{0,61}[a-z0-9]", "u");
...
function validate21(data, {
  ...
  /*# sourceURL="networking.gke.io.v1alpha1.LBSecurityPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
