...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "emfq5bQKzjSNVO51m6RCaL0SIZk38UJwVU1mcyayAY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "zenVkLe5RoHJq9wPKUlhQq6dOpfLRP55C5qSYwea0"
    },
    "status": {
  ...
  "$id": "datacatalog.cnrm.cloud.google.com.v1alpha1.DataCatalogTagTemplate"
};
const schema11 = {
  "type": "string",
...
function validate28(data, {
  ...
  if (!(data === "DataCatalogTagTemplate")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "properties": {
    ...
    "fields": {
      "$ref": "6PdNkkNCvkVoPY6En6TfG4jMKVKzoRRSDiP8dH51w"
    },
    "forceDelete": {
  ...
  "required": ["fields", "projectRef", "tagTemplateId"],
  "type": "object"
};
const schema6 = {
  "type": "string",
...
const schema16 = {
  "items": {
    "$ref": "4z2j2uvhREMLFJxPMtRdRVwufySoQyEh9oZ2r1r524U"
  },
  "type": "array"
};
const schema17 = {
  "properties": {
    ...
    "type": {
      "$ref": "bmGhRA8JicvXkXuKcDCEPoNJUOpxv8sQvw296NuvZQ"
    }
  },
...
const schema18 = {
  "properties": {
    "enumType": {
      "$ref": "w2BlKrbJQ6ofi3akn0fr3HfPFfnJVscJrfCNJ4CHNGI"
    },
    "primitiveType": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema19 = {
  "properties": {
    "allowedValues": {
      "$ref": "nxF4ZCVaxJi0IXIDL1qhHg0OJEgdgD1n3HR14J6DE"
    }
  },
...
const schema20 = {
  "items": {
    "$ref": "mXXTHXffltUf3akeXWA9MEyldDHknPBGDWi5nARoA7o"
  },
  "type": "array"
};
const schema21 = {
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedValues !== undefined) {
      if (!validate45(data.allowedValues, {
        instancePath: instancePath + "/allowedValues",
        parentData: data,
        parentDataProperty: "allowedValues",
        rootData
      })) {
...
function validate43(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.enumType !== undefined) {
      if (!validate44(data.enumType, {
        instancePath: instancePath + "/enumType",
        parentData: data,
        parentDataProperty: "enumType",
        rootData
      })) {
    ...
    if (data.primitiveType !== undefined) {
      if (!validate21(data.primitiveType, {
        instancePath: instancePath + "/primitiveType",
        parentData: data,
        parentDataProperty: "primitiveType",
        rootData
      })) {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.fieldId !== undefined) {
      if (!validate22(data.fieldId, {
        instancePath: instancePath + "/fieldId",
        parentData: data,
        parentDataProperty: "fieldId",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.isRequired !== undefined) {
      if (!validate23(data.isRequired, {
        instancePath: instancePath + "/isRequired",
        parentData: data,
        parentDataProperty: "isRequired",
        rootData
      })) {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tagTemplateId === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "tagTemplateId"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.forceDelete !== undefined) {
      if (!validate23(data.forceDelete, {
        instancePath: instancePath + "/forceDelete",
        parentData: data,
        parentDataProperty: "forceDelete",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.tagTemplateId !== undefined) {
      if (!validate22(data.tagTemplateId, {
        instancePath: instancePath + "/tagTemplateId",
        parentData: data,
        parentDataProperty: "tagTemplateId",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate25(data, {
  ...
  /*# sourceURL="datacatalog.cnrm.cloud.google.com.v1alpha1.DataCatalogTagTemplate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
