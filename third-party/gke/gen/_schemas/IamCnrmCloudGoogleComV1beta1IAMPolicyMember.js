...
const schema12 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "EMZokO1COvU7kBdi9257tyd5bhMjHq0rEJ7KZPJW8A"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "yRzcuWv19C3aHMGAjOWunfPbM6xzISJNNths0tFDzw"
    },
    "status": {
      "$ref": "iM074ib0KwXXBoEEO7Np8EVHUqcbHgRw2sHCVcKTuw"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "iam.cnrm.cloud.google.com.v1beta1.IAMPolicyMember"
};
const schema13 = {
  "type": "string",
...
function validate38(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.resourceRef !== undefined) {
      if (!validate62(data.resourceRef, {
...
function validate29(data, {
  ...
  /*# sourceURL="iam.cnrm.cloud.google.com.v1beta1.IAMPolicyMember" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
