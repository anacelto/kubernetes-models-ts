...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "aFmHmwkkU0xxeftS76QuoqGRInoKRvW5cJMIhkidM"
    },
    "kind": {
      "$ref": "llPF0UGHg7Nba898H7W7yVvXnrF2vQ9ARo69I71l0C0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "uMcy7GXn05ocmxzGYvxnKEkaitf9iUgJxxpOYIORWYI"
    },
    "status": {
  ...
  "$id": "documentai.cnrm.cloud.google.com.v1alpha1.DocumentAIProcessor"
};
const schema9 = {
  "type": "string",
  "enum": ["documentai.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "documentai.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["displayName", "location", "projectRef", "type"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate23(data, {
  ...
  /*# sourceURL="documentai.cnrm.cloud.google.com.v1alpha1.DocumentAIProcessor" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
