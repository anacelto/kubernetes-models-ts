...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "2sp9CCEwkxv3BatI2lwW3FTZcdtRdeJZ1MIzMNUngvk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "mqGHBggwbBiyfQUkZxjqnCxijt2jodJg4mw8qvIM"
    },
    "status": {
      "$ref": "YBriiz45M87EBbsHxr0ruvKB7JfG2AZzJWSC4Usus"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeTargetGRPCProxy"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "ComputeTargetGRPCProxy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.urlMapRef !== undefined) {
      if (!validate33(data.urlMapRef, {
        instancePath: instancePath + "/urlMapRef",
        parentData: data,
        parentDataProperty: "urlMapRef",
        rootData
      })) {
    ...
    if (data.validateForProxyless !== undefined) {
      if (!validate50(data.validateForProxyless, {
        instancePath: instancePath + "/validateForProxyless",
        parentData: data,
        parentDataProperty: "validateForProxyless",
        rootData
      })) {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.fingerprint !== undefined) {
      if (!validate21(data.fingerprint, {
    ...
    if (data.selfLinkWithId !== undefined) {
      if (!validate21(data.selfLinkWithId, {
        instancePath: instancePath + "/selfLinkWithId",
        parentData: data,
        parentDataProperty: "selfLinkWithId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeTargetGRPCProxy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
