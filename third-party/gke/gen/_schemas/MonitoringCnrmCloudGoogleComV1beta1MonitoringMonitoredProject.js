...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "a6PluQF0y0lkH8MzISp2qNsokcP3nMAtl2aWdqXlEcQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "vwvwH2GgTyxnYhyGKryjiqtBTEzjLZyuJocrV4oyc"
    },
    "status": {
  ...
  "$id": "monitoring.cnrm.cloud.google.com.v1beta1.MonitoringMonitoredProject"
};
const schema8 = {
  "type": "string",
...
const schema9 = {
  "type": "string",
  "enum": ["MonitoringMonitoredProject"]
};
function validate25(data, {
  ...
  if (!(data === "MonitoringMonitoredProject")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.metricsScope === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "metricsScope"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.metricsScope !== undefined) {
      if (!validate32(data.metricsScope, {
        instancePath: instancePath + "/metricsScope",
        parentData: data,
        parentDataProperty: "metricsScope",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="monitoring.cnrm.cloud.google.com.v1beta1.MonitoringMonitoredProject" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
