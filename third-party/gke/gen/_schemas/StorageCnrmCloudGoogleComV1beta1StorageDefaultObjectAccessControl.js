...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "dNATniLllr3TQ8w59GZfkVWvbC2KiiGdCfdtWyqkHI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "zZXrOoeZVmzxKnh0I6dzJPmSGdKwXyCUR88R4GPbbFY"
    },
    "status": {
      "$ref": "Howcs4KDh9u1Y3iBSq4M3eU3MuZWwLTgKJtt6KChR6I"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "storage.cnrm.cloud.google.com.v1beta1.StorageDefaultObjectAccessControl"
};
const schema10 = {
  "type": "string",
...
function validate27(data, {
  ...
  if (!(data === "StorageDefaultObjectAccessControl")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema22 = {
  "properties": {
    ...
    "projectTeam": {
      "$ref": "gYwAKypBifd7yomDwSgisGdGR1L6ASutOL2yq98YU"
    }
  },
  "type": "object",
  "nullable": true
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.team !== undefined) {
      if (!validate21(data.team, {
        instancePath: instancePath + "/team",
        parentData: data,
        parentDataProperty: "team",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.entityId !== undefined) {
      if (!validate21(data.entityId, {
        instancePath: instancePath + "/entityId",
        parentData: data,
        parentDataProperty: "entityId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.projectTeam !== undefined) {
      if (!validate70(data.projectTeam, {
        instancePath: instancePath + "/projectTeam",
        parentData: data,
        parentDataProperty: "projectTeam",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="storage.cnrm.cloud.google.com.v1beta1.StorageDefaultObjectAccessControl" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
