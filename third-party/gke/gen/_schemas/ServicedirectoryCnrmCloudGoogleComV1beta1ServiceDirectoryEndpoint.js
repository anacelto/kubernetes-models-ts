...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "krENay0XwWInek9JfYJXQpM72G45MA5oOoxKl8QJY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ipSyuSJWXmqP6nHCKP1XRDKAp3TS4wcy8Ar6993IZ0"
    },
    "status": {
  ...
  "$id": "servicedirectory.cnrm.cloud.google.com.v1beta1.ServiceDirectoryEndpoint"
};
const schema16 = {
  "type": "string",
...
function validate42(data, {
  ...
  if (!(data === "ServiceDirectoryEndpoint")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate39(data, {
  ...
  /*# sourceURL="servicedirectory.cnrm.cloud.google.com.v1beta1.ServiceDirectoryEndpoint" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
