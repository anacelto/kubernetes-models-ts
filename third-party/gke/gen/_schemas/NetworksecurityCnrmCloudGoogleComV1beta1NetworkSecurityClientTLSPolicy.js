...
const schema11 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "ZVR2cC4OxCbbEL7rkD7mLLgZ351RCK4U45sww8q17Jc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "RsU50F4p212Ftzb1ib0XcWQ60lBgC1pkFAHRDkI"
    },
    "status": {
  ...
  "$id": "networksecurity.cnrm.cloud.google.com.v1beta1.NetworkSecurityClientTLSPolicy"
};
const schema12 = {
  "type": "string",
...
function validate31(data, {
  ...
  if (!(data === "NetworkSecurityClientTLSPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema16 = {
  "properties": {
    ...
    "serverValidationCa": {
      "$ref": "qZvCdse2yTaMamAdYKus7bBlXUj0EUqt8nBb0C2rQ"
    },
    "sni": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clientCertificate !== undefined) {
      if (!validate38(data.clientCertificate, {
    ...
    if (data.serverValidationCa !== undefined) {
      if (!validate61(data.serverValidationCa, {
        instancePath: instancePath + "/serverValidationCa",
        parentData: data,
        parentDataProperty: "serverValidationCa",
        rootData
      })) {
...
function validate28(data, {
  ...
  /*# sourceURL="networksecurity.cnrm.cloud.google.com.v1beta1.NetworkSecurityClientTLSPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
