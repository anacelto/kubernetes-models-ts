...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "1i7vnBMYSwL2b206FsZmNq7ztlWdEMyIccV6CmHag"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "aCS92EdwyCV2GCjmAuuhX4z4kl01gb58sX0Rlg6fVAY"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeTargetHTTPProxy"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "ComputeTargetHTTPProxy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.httpKeepAliveTimeoutSec !== undefined) {
      if (!validate22(data.httpKeepAliveTimeoutSec, {
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeTargetHTTPProxy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
