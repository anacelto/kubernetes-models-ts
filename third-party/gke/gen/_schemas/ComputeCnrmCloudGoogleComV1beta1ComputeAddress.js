...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "OQH5B07YuHyWDf95lF757KMOE6lTAVSnksyzJgmWg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "eEB3EkumhmobI1xNNRd2N1c86SZSjDMygOvyujc0"
    },
    "status": {
      "$ref": "NTNbH2a8YXQR9nol0aUWoM361BRaSahe9XIRTuVXY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeAddress"
};
const schema17 = {
  "type": "string",
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.addressType !== undefined) {
      if (!validate21(data.addressType, {
    ...
    if (data.ipv6EndpointType !== undefined) {
      if (!validate21(data.ipv6EndpointType, {
        instancePath: instancePath + "/ipv6EndpointType",
        parentData: data,
        parentDataProperty: "ipv6EndpointType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.networkTier !== undefined) {
      if (!validate21(data.networkTier, {
    ...
    if (data.prefixLength !== undefined) {
      if (!validate38(data.prefixLength, {
        instancePath: instancePath + "/prefixLength",
        parentData: data,
        parentDataProperty: "prefixLength",
        rootData
      })) {
...
function validate40(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeAddress" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
