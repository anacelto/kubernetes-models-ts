...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "v0QDwVG1LwXXBhiyEivy4NCoo6Nb8gCsCoOKs6qdKw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "NNZ7LxikkHA9iMJAokue26QedqolWg2SX6IhSjkxI"
    },
    "status": {
      "$ref": "8QUHfVa5fdn5Xqaqb0OmC1e6arCfDbC0mzADEbM8mU"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "iap.cnrm.cloud.google.com.v1beta1.IAPBrand"
};
const schema8 = {
  "type": "string",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.applicationTitle !== undefined) {
      if (!validate21(data.applicationTitle, {
        instancePath: instancePath + "/applicationTitle",
        parentData: data,
        parentDataProperty: "applicationTitle",
        rootData
      })) {
    ...
    if (data.supportEmail !== undefined) {
      if (!validate21(data.supportEmail, {
        instancePath: instancePath + "/supportEmail",
        parentData: data,
        parentDataProperty: "supportEmail",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.orgInternalOnly !== undefined) {
      if (!validate48(data.orgInternalOnly, {
        instancePath: instancePath + "/orgInternalOnly",
        parentData: data,
        parentDataProperty: "orgInternalOnly",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="iap.cnrm.cloud.google.com.v1beta1.IAPBrand" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
