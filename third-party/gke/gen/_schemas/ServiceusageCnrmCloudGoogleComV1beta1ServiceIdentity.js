...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "9LL0Y8zoqEupABsEjTa87ag0emeOUhbXHUvDSxBY"
    },
    "kind": {
      "$ref": "JNbC7B5hj0RwH5nGZyNuWEzEbfP2TwBE3oQUzWCmuqk"
    },
    "metadata": {
    ...
    "status": {
      "$ref": "SFno4GVlxrEyxrCVTGFPACEcYWKiBsVziHzNM930h5k"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "serviceusage.cnrm.cloud.google.com.v1beta1.ServiceIdentity"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "serviceusage.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="serviceusage.cnrm.cloud.google.com.v1beta1.ServiceIdentity" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
