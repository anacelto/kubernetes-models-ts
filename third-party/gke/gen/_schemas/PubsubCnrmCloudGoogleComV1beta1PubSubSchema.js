...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "4xZ1x1it3kmDwf1bo0FNwiR2pobrPfaSZWd5qGcQ"
    },
    "kind": {
      "$ref": "ATlctIiuKIUFske8NiW4lZCxHPBQN7ESAs4dTjUcaO8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "RqkkS47Cuovg4t8yHLmkHp7wfm2Q0q8Yu7Zp3rl4c"
    },
    "status": {
  ...
  "$id": "pubsub.cnrm.cloud.google.com.v1beta1.PubSubSchema"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "pubsub.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.definition !== undefined) {
      if (!validate21(data.definition, {
        instancePath: instancePath + "/definition",
        parentData: data,
        parentDataProperty: "definition",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="pubsub.cnrm.cloud.google.com.v1beta1.PubSubSchema" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
