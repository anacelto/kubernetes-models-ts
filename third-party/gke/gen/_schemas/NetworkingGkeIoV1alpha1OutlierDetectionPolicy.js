...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "r9tA1ORoCMuIwuwX33Gjbr51icGmFM6m5ZERHmyAY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "PykDo5I9H1J1veQ73IQ4r5IZJguLgZSngWmoGBDdzIE"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1alpha1.OutlierDetectionPolicy"
};
const schema11 = {
  "type": "string",
...
function validate28(data, {
  ...
  if (!(data === "OutlierDetectionPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "properties": {
    "default": {
      "$ref": "w4sN6VnEnRaEthdyn5KLntxL1VBIAcyWeH8FoQBg"
    },
    "targetRef": {
...
const schema16 = {
  "properties": {
    "baseEjectionTime": {
      "$ref": "MTOUjRLmlmwNaStUZsK7zTCMPBCNeYYC4kVlgvORtD8"
    },
    "consecutiveErrors": {
      "$ref": "O6HPGQLPliuq7dVqjJRK9KomgPvvx8BnY2ukWe5GTE"
    },
    "consecutiveGatewayFailure": {
      "$ref": "J1yDLbmgXiCkfpTFywXqZJboPrEEkzIzutwH1Edg"
    },
    "enforcingConsecutiveErrors": {
      "$ref": "O03i4c1WO8UIEeoRj8TqnQuVC9dhIryL2YWduxGBRQ"
    },
    "enforcingConsecutiveGatewayFailure": {
      "$ref": "G9f5c3hpV9iSDCnIEBRqU0crGurSV2G16VZRpOU"
    },
    "enforcingSuccessRate": {
      "$ref": "G9f5c3hpV9iSDCnIEBRqU0crGurSV2G16VZRpOU"
    },
    "interval": {
      "$ref": "2OoBjY1RPU3CfW8yUG04Qe9C3HsKtDjdNPNyKG57SQ"
    },
    "maxEjectionPercent": {
      "$ref": "gQVoOcBKcU0F41KqRR116Ip22bMDLyWXQtkgUcz4c"
    },
    "successRateMinimumHosts": {
      "$ref": "O6HPGQLPliuq7dVqjJRK9KomgPvvx8BnY2ukWe5GTE"
    },
    "successRateRequestVolume": {
      "$ref": "SyEG6K0UYT4BKCBuEV5eXpNHXhq8lBJbrgBPdi3Eg"
    },
    "successRateStdevFactor": {
      "$ref": "Vyhisyt5In1wvJPPG1ugAvkyvU9bvvtOLykkbriVW68"
    }
  },
  "type": "object",
  "nullable": true
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.baseEjectionTime !== undefined) {
      if (!validate36(data.baseEjectionTime, {
    ...
    if (data.consecutiveErrors !== undefined) {
      if (!validate24(data.consecutiveErrors, {
    ...
    if (data.consecutiveGatewayFailure !== undefined) {
      if (!validate41(data.consecutiveGatewayFailure, {
    ...
    if (data.enforcingConsecutiveErrors !== undefined) {
      if (!validate43(data.enforcingConsecutiveErrors, {
    ...
    if (data.enforcingConsecutiveGatewayFailure !== undefined) {
      if (!validate21(data.enforcingConsecutiveGatewayFailure, {
    ...
    if (data.enforcingSuccessRate !== undefined) {
      if (!validate21(data.enforcingSuccessRate, {
    ...
    if (data.maxEjectionPercent !== undefined) {
      if (!validate51(data.maxEjectionPercent, {
    ...
    if (data.successRateMinimumHosts !== undefined) {
      if (!validate24(data.successRateMinimumHosts, {
    ...
    if (data.successRateRequestVolume !== undefined) {
      if (!validate54(data.successRateRequestVolume, {
    ...
    if (data.successRateStdevFactor !== undefined) {
      if (!validate56(data.successRateStdevFactor, {
...
function validate25(data, {
  ...
  /*# sourceURL="networking.gke.io.v1alpha1.OutlierDetectionPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
