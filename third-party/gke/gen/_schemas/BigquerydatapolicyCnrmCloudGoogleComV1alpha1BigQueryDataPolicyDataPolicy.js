...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "tAnSlrQZernCOtJUtS5sx8fuOLWwADkVc7Poaoo3T4"
    },
    "kind": {
      "$ref": "ZgiOXXXjrf9x874cChhQp7r5QeEv6RFDbqfIwzrtk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "fTTxDubBT7idLymCyVKoucX7w6zqT5bbTzyIGOAf44"
    },
    "status": {
  ...
  "$id": "bigquerydatapolicy.cnrm.cloud.google.com.v1alpha1.BigQueryDataPolicyDataPolicy"
};
const schema9 = {
  "type": "string",
  "enum": ["bigquerydatapolicy.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "bigquerydatapolicy.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema10 = {
  "type": "string",
  "enum": ["BigQueryDataPolicyDataPolicy"]
};
function validate26(data, {
  ...
  if (!(data === "BigQueryDataPolicyDataPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    "dataMaskingPolicy": {
      "$ref": "c5iEtq8L0hk9AIPfaW5XTnCrvq3qAUUFSDamed8xs"
    },
    "dataPolicyType": {
  ...
  "required": ["dataPolicyType", "location", "policyTag", "projectRef"],
  "type": "object"
};
const schema14 = {
  "properties": {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.predefinedExpression === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "predefinedExpression"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.predefinedExpression !== undefined) {
      if (!validate21(data.predefinedExpression, {
        instancePath: instancePath + "/predefinedExpression",
        parentData: data,
        parentDataProperty: "predefinedExpression",
        rootData
      })) {
...
function validate32(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.dataPolicyType === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "dataPolicyType"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.policyTag === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "policyTag"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.dataMaskingPolicy !== undefined) {
      if (!validate33(data.dataMaskingPolicy, {
        instancePath: instancePath + "/dataMaskingPolicy",
        parentData: data,
        parentDataProperty: "dataMaskingPolicy",
        rootData
      })) {
    ...
    if (data.dataPolicyType !== undefined) {
      if (!validate21(data.dataPolicyType, {
        instancePath: instancePath + "/dataPolicyType",
        parentData: data,
        parentDataProperty: "dataPolicyType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.policyTag !== undefined) {
      if (!validate21(data.policyTag, {
        instancePath: instancePath + "/policyTag",
        parentData: data,
        parentDataProperty: "policyTag",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="bigquerydatapolicy.cnrm.cloud.google.com.v1alpha1.BigQueryDataPolicyDataPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
