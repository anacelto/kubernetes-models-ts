...
const schema17 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "CP5e09tHIUHGqesfQFVC8RU53kAdVOJWzpILNIX3Q"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "CcEP5kaQ1z8JNNdlfvkKLHCHII0x12XCwOhjRJzthjI"
    },
    "status": {
      "$ref": "2L5JyrmEA0AjRHL3jl5fvrcTGLjHfRHrhv4kqGZp4"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "filestore.cnrm.cloud.google.com.v1beta1.FilestoreInstance"
};
const schema18 = {
  "type": "string",
...
const schema22 = {
  "properties": {
    "fileShares": {
      "$ref": "uHPx4y4nGArRvfkpgZJ4Fx1ejLotZOP6KNUcZw19aq0"
    },
    "location": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    "networks": {
      "$ref": "8P7oNIlNCan8UwyyYIxSgyNIfctwMZi2ST9suHk8A8"
    },
    "projectRef": {
...
const schema23 = {
  "items": {
    "$ref": "nlBRV0LwX0XPxUVeSF8O8a2pugDro9pzWBIH89Dlo"
  },
  "type": "array",
  "nullable": true
};
const schema24 = {
  "properties": {
    ...
    "nfsExportOptions": {
      "$ref": "w8HU4B7Vxny2v40wgqNfh69DSucNDUz5xcUwZzaOY"
    },
    "sourceBackupRef": {
...
const schema25 = {
  "items": {
    "$ref": "7mFeQeV62PB3g4vXHbOx1zZOUHkX81aMUJW2BTSLSQ"
  },
  "type": "array",
  "nullable": true
};
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.anonGid !== undefined) {
      if (!validate22(data.anonGid, {
        instancePath: instancePath + "/anonGid",
        parentData: data,
        parentDataProperty: "anonGid",
        rootData
      })) {
    ...
    if (data.anonUid !== undefined) {
      if (!validate22(data.anonUid, {
        instancePath: instancePath + "/anonUid",
        parentData: data,
        parentDataProperty: "anonUid",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.ipRanges !== undefined) {
      if (!validate24(data.ipRanges, {
        instancePath: instancePath + "/ipRanges",
        parentData: data,
        parentDataProperty: "ipRanges",
        rootData
      })) {
    ...
    if (data.squashMode !== undefined) {
      if (!validate21(data.squashMode, {
        instancePath: instancePath + "/squashMode",
        parentData: data,
        parentDataProperty: "squashMode",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nfsExportOptions !== undefined) {
      if (!validate56(data.nfsExportOptions, {
        instancePath: instancePath + "/nfsExportOptions",
        parentData: data,
        parentDataProperty: "nfsExportOptions",
        rootData
      })) {
    ...
    if (data.sourceBackupRef !== undefined) {
      if (!validate26(data.sourceBackupRef, {
        instancePath: instancePath + "/sourceBackupRef",
        parentData: data,
        parentDataProperty: "sourceBackupRef",
        rootData
      })) {
...
const schema27 = {
  "items": {
    "$ref": "VkSdTPEnpxC3ml0vDwN2UzKmT3a3EwRdjWtIR7H8"
  },
  "type": "array",
  "nullable": true
};
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.modes !== undefined) {
      if (!validate24(data.modes, {
        instancePath: instancePath + "/modes",
        parentData: data,
        parentDataProperty: "modes",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.fileShares !== undefined) {
      if (!validate52(data.fileShares, {
        instancePath: instancePath + "/fileShares",
        parentData: data,
        parentDataProperty: "fileShares",
        rootData
      })) {
...
function validate87(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.statusMessage !== undefined) {
      if (!validate21(data.statusMessage, {
...
function validate42(data, {
  ...
  /*# sourceURL="filestore.cnrm.cloud.google.com.v1beta1.FilestoreInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
