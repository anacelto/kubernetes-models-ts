...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "xJ9U2VSVPZzlqvXmnI52JA2wvWFc46eawVZOutfupDc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "oVahVmeB76AK3UuQXrWg4zTWBJT00whPKcNUgHkD4s"
    },
    "status": {
      "$ref": "1yTMYaGkVhYvWilSu5JJ7n6Y0HFnCeSKZD05EDWg"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "iam.cnrm.cloud.google.com.v1beta1.IAMWorkforcePool"
};
const schema8 = {
  "type": "string",
...
const schema12 = {
  ...
  "required": ["location", "organizationRef"],
  "type": "object"
};
const schema13 = {
  "type": "boolean",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sessionDuration !== undefined) {
      if (!validate21(data.sessionDuration, {
...
function validate22(data, {
  ...
  /*# sourceURL="iam.cnrm.cloud.google.com.v1beta1.IAMWorkforcePool" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
