...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "x02nseh10JgVlyUP1BVAAYk2vJzuBFGLZ9AI0achtQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "E6z4IIkaqCJACGfFfT2fgtPZvdrZjuBytyHyYQ934"
    },
    "status": {
      "$ref": "ev4i8tnczQBPE3J4ESIdpeU4lR4ME9fM3FRNA9gupY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeRegionSSLPolicy"
};
const schema10 = {
  "type": "string",
...
function validate28(data, {
  ...
  if (!(data === "ComputeRegionSSLPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.customFeatures !== undefined) {
      if (!validate23(data.customFeatures, {
        instancePath: instancePath + "/customFeatures",
        parentData: data,
        parentDataProperty: "customFeatures",
        rootData
      })) {
    ...
    if (data.minTlsVersion !== undefined) {
      if (!validate21(data.minTlsVersion, {
        instancePath: instancePath + "/minTlsVersion",
        parentData: data,
        parentDataProperty: "minTlsVersion",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.enabledFeatures !== undefined) {
      if (!validate23(data.enabledFeatures, {
        instancePath: instancePath + "/enabledFeatures",
        parentData: data,
        parentDataProperty: "enabledFeatures",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate25(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeRegionSSLPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
