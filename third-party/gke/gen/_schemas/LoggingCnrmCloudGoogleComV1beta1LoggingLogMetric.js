...
const schema11 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "l2e2xXpgGcvXnEbK3te4fRPE50fKcmn4s7uCnSpIBOc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "EPfRcxbWRHzynA99T3p8fSAGim0X9AmY8P7lHjkVjl4"
    },
    "status": {
      "$ref": "NhUTnRKg18yobXzGg91EkdZ0mKbuS1IYsE4f2qxk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "logging.cnrm.cloud.google.com.v1beta1.LoggingLogMetric"
};
const schema12 = {
  "type": "string",
...
const schema16 = {
  "properties": {
    "bucketOptions": {
      "$ref": "lOtYAkjjCn2qiMKDC5MfSKrHWYx3xOOvQESn4giDhQ"
    },
    "disabled": {
    ...
    "metricDescriptor": {
      "$ref": "2Vp2ek7TQAPFEdvLCE83Y8Z9wrWig1ZubLv5j8"
    },
    "projectRef": {
...
const schema17 = {
  "properties": {
    "explicitBuckets": {
      "$ref": "9sjABkaefsrhRBN9as35rBDPf7aGi6o36ZxFBJ8rJv8"
    },
    "exponentialBuckets": {
      "$ref": "6GWWBN7WHsMXcdotoAN014BHGvIPrV2gmm90OBiNyE"
    },
    "linearBuckets": {
      "$ref": "dGULRHNLJtp2pSOTisBay11BzRzAxgL4cu2RU4KroJA"
    }
  },
  "type": "object",
  "nullable": true
...
const schema18 = {
  "properties": {
    "bounds": {
      "$ref": "N4ZqS98HIdC9Lj1gHi35fFvjCh0RE1TcwFPC0sHUlM"
    }
  },
  "type": "object",
  "nullable": true
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.bounds !== undefined) {
      if (!validate38(data.bounds, {
        instancePath: instancePath + "/bounds",
        parentData: data,
        parentDataProperty: "bounds",
        rootData
      })) {
...
function validate43(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.growthFactor !== undefined) {
      if (!validate21(data.growthFactor, {
        instancePath: instancePath + "/growthFactor",
        parentData: data,
        parentDataProperty: "growthFactor",
        rootData
      })) {
    ...
    if (data.numFiniteBuckets !== undefined) {
      if (!validate22(data.numFiniteBuckets, {
        instancePath: instancePath + "/numFiniteBuckets",
        parentData: data,
        parentDataProperty: "numFiniteBuckets",
        rootData
      })) {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.explicitBuckets !== undefined) {
      if (!validate37(data.explicitBuckets, {
        instancePath: instancePath + "/explicitBuckets",
        parentData: data,
        parentDataProperty: "explicitBuckets",
        rootData
      })) {
    ...
    if (data.exponentialBuckets !== undefined) {
      if (!validate43(data.exponentialBuckets, {
        instancePath: instancePath + "/exponentialBuckets",
        parentData: data,
        parentDataProperty: "exponentialBuckets",
        rootData
      })) {
    ...
    if (data.linearBuckets !== undefined) {
      if (!validate48(data.linearBuckets, {
        instancePath: instancePath + "/linearBuckets",
        parentData: data,
        parentDataProperty: "linearBuckets",
        rootData
      })) {
...
const schema25 = {
  "properties": {
    ...
    "labels": {
      "$ref": "xUOQINukl0IMU5aK5Ls293ZXtOveIhNoovyl1kFCP0"
    },
    "launchStage": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "metadata": {
      "$ref": "EQ6SBb4iGuvOi479RQhcegubysYgy64cLkmCcgQzQ"
    },
    "metricKind": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema26 = {
  "items": {
    "$ref": "EzdeLxNUSLnLnRnNeHO6bOKOwylkn1CaBty0IGkPQ"
  },
  "type": "array",
  "nullable": true
};
...
function validate63(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.valueType !== undefined) {
      if (!validate24(data.valueType, {
        instancePath: instancePath + "/valueType",
        parentData: data,
        parentDataProperty: "valueType",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
function validate69(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ingestDelay !== undefined) {
      if (!validate24(data.ingestDelay, {
        instancePath: instancePath + "/ingestDelay",
        parentData: data,
        parentDataProperty: "ingestDelay",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.samplePeriod !== undefined) {
      if (!validate24(data.samplePeriod, {
        instancePath: instancePath + "/samplePeriod",
        parentData: data,
        parentDataProperty: "samplePeriod",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.launchStage !== undefined) {
      if (!validate24(data.launchStage, {
    ...
    if (data.metricKind !== undefined) {
      if (!validate24(data.metricKind, {
        instancePath: instancePath + "/metricKind",
        parentData: data,
        parentDataProperty: "metricKind",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.bucketOptions !== undefined) {
      if (!validate36(data.bucketOptions, {
        instancePath: instancePath + "/bucketOptions",
        parentData: data,
        parentDataProperty: "bucketOptions",
        rootData
      })) {
    ...
    if (data.labelExtractors !== undefined) {
      if (!validate57(data.labelExtractors, {
    ...
    if (data.metricDescriptor !== undefined) {
      if (!validate60(data.metricDescriptor, {
        instancePath: instancePath + "/metricDescriptor",
        parentData: data,
        parentDataProperty: "metricDescriptor",
        rootData
      })) {
    ...
    if (data.valueExtractor !== undefined) {
      if (!validate24(data.valueExtractor, {
        instancePath: instancePath + "/valueExtractor",
        parentData: data,
        parentDataProperty: "valueExtractor",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
const schema36 = {
  "properties": {
    ...
    "metricDescriptor": {
      "$ref": "d7a3MzTypCWdb1qDafRUWQdbqZqMieq4ywPeZVu8xw"
    },
    "observedGeneration": {
...
function validate108(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.monitoredResourceTypes !== undefined) {
      if (!validate109(data.monitoredResourceTypes, {
        instancePath: instancePath + "/monitoredResourceTypes",
        parentData: data,
        parentDataProperty: "monitoredResourceTypes",
        rootData
      })) {
...
function validate97(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.metricDescriptor !== undefined) {
      if (!validate108(data.metricDescriptor, {
        instancePath: instancePath + "/metricDescriptor",
        parentData: data,
        parentDataProperty: "metricDescriptor",
        rootData
...
function validate26(data, {
  ...
  /*# sourceURL="logging.cnrm.cloud.google.com.v1beta1.LoggingLogMetric" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
