...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "N4OBqQ2NyTMpZcSq41N3J1ITvRJgnSTa1kzqKVo8sM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "2RjlYJGRIg4sCzoru5A0u7do4cIyesYBoW0Z94NIpo"
    },
    "status": {
      "$ref": "QaHzLZ4SyXwdMo1HSo4BPMLT7RZoEJPz4ccqN9emQ"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "kms.cnrm.cloud.google.com.v1alpha1.KMSSecretCiphertext"
};
const schema15 = {
  "type": "string",
...
function validate43(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.additionalAuthenticatedData !== undefined) {
      if (!validate44(data.additionalAuthenticatedData, {
        instancePath: instancePath + "/additionalAuthenticatedData",
        parentData: data,
        parentDataProperty: "additionalAuthenticatedData",
        rootData
      })) {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ciphertext !== undefined) {
      if (!validate22(data.ciphertext, {
        instancePath: instancePath + "/ciphertext",
        parentData: data,
        parentDataProperty: "ciphertext",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate34(data, {
  ...
  /*# sourceURL="kms.cnrm.cloud.google.com.v1alpha1.KMSSecretCiphertext" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
