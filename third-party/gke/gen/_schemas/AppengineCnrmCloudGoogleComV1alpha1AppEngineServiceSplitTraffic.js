...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "lNZbIC5PHn5ekBVKkYhP5TQHxbCJBGrrRtsb74fIME"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "76Z5gyno7bCctjo6epLe5iEygtY5hIYeN4gf63G16l0"
    },
    "status": {
  ...
  "$id": "appengine.cnrm.cloud.google.com.v1alpha1.AppEngineServiceSplitTraffic"
};
const schema8 = {
  "type": "string",
...
const schema9 = {
  "type": "string",
  "enum": ["AppEngineServiceSplitTraffic"]
};
function validate25(data, {
  ...
  if (!(data === "AppEngineServiceSplitTraffic")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "properties": {
    ...
    "split": {
      "$ref": "NsX1uzaIV7mXdpalft9i5AjTTAjZwwMvu0mmtInA"
    }
  },
  "required": ["split"],
  "type": "object"
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allocations !== undefined) {
      if (!validate37(data.allocations, {
        instancePath: instancePath + "/allocations",
        parentData: data,
        parentDataProperty: "allocations",
        rootData
      })) {
    ...
    if (data.shardBy !== undefined) {
      if (!validate21(data.shardBy, {
        instancePath: instancePath + "/shardBy",
        parentData: data,
        parentDataProperty: "shardBy",
        rootData
      })) {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.migrateTraffic !== undefined) {
      if (!validate32(data.migrateTraffic, {
        instancePath: instancePath + "/migrateTraffic",
        parentData: data,
        parentDataProperty: "migrateTraffic",
        rootData
      })) {
    ...
    if (data.split !== undefined) {
      if (!validate36(data.split, {
        instancePath: instancePath + "/split",
        parentData: data,
        parentDataProperty: "split",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="appengine.cnrm.cloud.google.com.v1alpha1.AppEngineServiceSplitTraffic" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
