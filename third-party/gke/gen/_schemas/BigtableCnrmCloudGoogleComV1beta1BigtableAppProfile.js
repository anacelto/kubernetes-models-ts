...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "UxIWkVpkHuhBpdwD8KRlU5kS6cXto1A9KmElzp95oP0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "3YsjaUVp78Xx0BHqBtR5kw00SIN3kW5jasUu4ydQ"
    },
    "status": {
  ...
  "$id": "bigtable.cnrm.cloud.google.com.v1beta1.BigtableAppProfile"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    ...
    "singleClusterRouting": {
      "$ref": "EjwJpNMYBuBoMpSFgUvsnHMAHX7PZfzUziyUCORwkY"
    },
    "standardIsolation": {
      "$ref": "EovgoVTL1tHnHjXTuui5F04n58DVugxL6xrO7tEisM"
    }
  },
  "type": "object",
  "nullable": true
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowTransactionalWrites !== undefined) {
      if (!validate22(data.allowTransactionalWrites, {
        instancePath: instancePath + "/allowTransactionalWrites",
        parentData: data,
        parentDataProperty: "allowTransactionalWrites",
        rootData
      })) {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.multiClusterRoutingClusterIds !== undefined) {
      if (!validate51(data.multiClusterRoutingClusterIds, {
        instancePath: instancePath + "/multiClusterRoutingClusterIds",
        parentData: data,
        parentDataProperty: "multiClusterRoutingClusterIds",
        rootData
      })) {
    ...
    if (data.multiClusterRoutingUseAny !== undefined) {
      if (!validate22(data.multiClusterRoutingUseAny, {
        instancePath: instancePath + "/multiClusterRoutingUseAny",
        parentData: data,
        parentDataProperty: "multiClusterRoutingUseAny",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.singleClusterRouting !== undefined) {
      if (!validate56(data.singleClusterRouting, {
        instancePath: instancePath + "/singleClusterRouting",
        parentData: data,
        parentDataProperty: "singleClusterRouting",
        rootData
      })) {
    ...
    if (data.standardIsolation !== undefined) {
      if (!validate60(data.standardIsolation, {
        instancePath: instancePath + "/standardIsolation",
        parentData: data,
        parentDataProperty: "standardIsolation",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="bigtable.cnrm.cloud.google.com.v1beta1.BigtableAppProfile" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
