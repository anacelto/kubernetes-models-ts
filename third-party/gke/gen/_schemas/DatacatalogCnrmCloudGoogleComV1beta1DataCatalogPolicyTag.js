...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "bJCbO3mTGoWl5jJOJdRdCbxPQJc2Jn1B4ciSCh26G3s"
    },
    "kind": {
      "$ref": "TsJvkwLm7RfLqUyveuD2tcEbXFM23fFyygre3o0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "VhevzbiWJKQjjKYdKzygeGCepW8S7pVTj4DeKB5Mg"
    },
    "status": {
      "$ref": "zKOj7fIjV2iBCYzGnSkpEDIFdCyggZJlrfPlCYueI"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "datacatalog.cnrm.cloud.google.com.v1beta1.DataCatalogPolicyTag"
};
const schema15 = {
  "type": "string",
  "enum": ["datacatalog.cnrm.cloud.google.com/v1beta1"]
};
function validate34(data, {
  ...
  if (!(data === "datacatalog.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  ...
  "required": ["displayName", "taxonomyRef"],
  "type": "object"
};
const schema13 = {
  "type": "string"
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.taxonomyRef === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "taxonomyRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.displayName !== undefined) {
      if (!validate32(data.displayName, {
    ...
    if (data.parentPolicyTagRef !== undefined) {
      if (!validate44(data.parentPolicyTagRef, {
        instancePath: instancePath + "/parentPolicyTagRef",
        parentData: data,
        parentDataProperty: "parentPolicyTagRef",
        rootData
      })) {
    ...
    if (data.taxonomyRef !== undefined) {
      if (!validate52(data.taxonomyRef, {
        instancePath: instancePath + "/taxonomyRef",
        parentData: data,
        parentDataProperty: "taxonomyRef",
        rootData
      })) {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.childPolicyTags !== undefined) {
      if (!validate61(data.childPolicyTags, {
        instancePath: instancePath + "/childPolicyTags",
        parentData: data,
        parentDataProperty: "childPolicyTags",
        rootData
      })) {
...
function validate33(data, {
  ...
  /*# sourceURL="datacatalog.cnrm.cloud.google.com.v1beta1.DataCatalogPolicyTag" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
