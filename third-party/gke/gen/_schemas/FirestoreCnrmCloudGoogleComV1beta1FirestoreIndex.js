...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "48RNxPooZxNjH4yCI46uddXkgl2QkUZ33O68mslkkME"
    },
    "kind": {
      "$ref": "QJXvYosTdYBRlWFzDy655Qipp3epZzjoKhdy6bhI8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "TGCNSNxYIKobwnEYgp6GkJF58jaUye9ESxIylvASPo"
    },
    "status": {
  ...
  "$id": "firestore.cnrm.cloud.google.com.v1beta1.FirestoreIndex"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "firestore.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "properties": {
    ...
    "fields": {
      "$ref": "REIy6jPFbGuzpjRwPWH7DjKGZIFcS8CzuiRCdTpZU"
    },
    "queryScope": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema14 = {
  "items": {
    "$ref": "ULMieQ5wqtLgTjVqjKK7RgUsW06MPBIKYF1P0QjDU3s"
  },
  "type": "array"
};
const schema15 = {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.arrayConfig !== undefined) {
      if (!validate21(data.arrayConfig, {
        instancePath: instancePath + "/arrayConfig",
        parentData: data,
        parentDataProperty: "arrayConfig",
        rootData
      })) {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.collection !== undefined) {
      if (!validate32(data.collection, {
        instancePath: instancePath + "/collection",
        parentData: data,
        parentDataProperty: "collection",
        rootData
      })) {
    ...
    if (data.queryScope !== undefined) {
      if (!validate21(data.queryScope, {
        instancePath: instancePath + "/queryScope",
        parentData: data,
        parentDataProperty: "queryScope",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="firestore.cnrm.cloud.google.com.v1beta1.FirestoreIndex" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
