...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "6T3vOa2uXuyiBNzPylLRYi3qYkeacpLrSokCCxpfM"
    },
    "kind": {
      "$ref": "Aw7UyompJCyiEVNEPkirYqUbuTAs83R2Pc6OCqnOE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "t8qhHmPdwRRUIQzSk7WmWTuVEyWUdLt0VSn6MunLo"
    },
    "status": {
      "$ref": "rF99NGhKnHl2kECDBNhLAmgWrhrqBRSWwZFVGGc3Q"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "firebasehosting.cnrm.cloud.google.com.v1alpha1.FirebaseHostingSite"
};
const schema8 = {
  "type": "string",
  "enum": ["firebasehosting.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "firebasehosting.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultUrl !== undefined) {
      if (!validate21(data.defaultUrl, {
        instancePath: instancePath + "/defaultUrl",
        parentData: data,
        parentDataProperty: "defaultUrl",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="firebasehosting.cnrm.cloud.google.com.v1alpha1.FirebaseHostingSite" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
