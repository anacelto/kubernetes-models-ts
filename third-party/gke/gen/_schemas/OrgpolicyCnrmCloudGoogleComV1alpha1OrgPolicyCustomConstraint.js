...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "ZkxDX0Ap7lUWvhwNOGsjyXJr0PL38s25U3HuD4LWao"
    },
    "kind": {
      "$ref": "Sfmzz74EwVThnspy3q8HKZovaBllPeGVR1E11p4Ic"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "1w238zjh9qfucJ8NJMeMFZCZa1ZbnZckZB8MkUg5HA"
    },
    "status": {
      "$ref": "W9CCkFFgtFMKDeGUhxvuyDiTlwzo0vZqAoSdmtmaXc0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "orgpolicy.cnrm.cloud.google.com.v1alpha1.OrgPolicyCustomConstraint"
};
const schema10 = {
  "type": "string",
  "enum": ["orgpolicy.cnrm.cloud.google.com/v1alpha1"]
};
function validate26(data, {
  ...
  if (!(data === "orgpolicy.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema11 = {
  "type": "string",
  "enum": ["OrgPolicyCustomConstraint"]
};
function validate28(data, {
  ...
  if (!(data === "OrgPolicyCustomConstraint")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  ...
  "required": ["actionType", "condition", "methodTypes", "parent", "resourceTypes"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.methodTypes === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "methodTypes"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.actionType !== undefined) {
      if (!validate21(data.actionType, {
        instancePath: instancePath + "/actionType",
        parentData: data,
        parentDataProperty: "actionType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.methodTypes !== undefined) {
      if (!validate23(data.methodTypes, {
        instancePath: instancePath + "/methodTypes",
        parentData: data,
        parentDataProperty: "methodTypes",
        rootData
      })) {
    ...
    if (data.resourceTypes !== undefined) {
      if (!validate23(data.resourceTypes, {
...
function validate25(data, {
  ...
  /*# sourceURL="orgpolicy.cnrm.cloud.google.com.v1alpha1.OrgPolicyCustomConstraint" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
