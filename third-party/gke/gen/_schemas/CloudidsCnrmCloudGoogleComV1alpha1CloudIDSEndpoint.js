...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "9mv5bjPBpBg2cTga5xiaCn1SaeUIUKUeCBxIzBjysc"
    },
    "kind": {
      "$ref": "3QRtEt9bOQNTINI0mDZ8q6tvCK9RNkhlHyLfo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "1MmblJYU3TjCPleWsYOVwLZgT5QpudMSSvoGMOoiEUc"
    },
    "status": {
      "$ref": "u755M5VeKGc0lo9qw76fgaYsVSvpiz87Z96OtB41w"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "cloudids.cnrm.cloud.google.com.v1alpha1.CloudIDSEndpoint"
};
const schema9 = {
  "type": "string",
  "enum": ["cloudids.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "cloudids.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["location", "network", "projectRef", "severity"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.threatExceptions !== undefined) {
      if (!validate54(data.threatExceptions, {
        instancePath: instancePath + "/threatExceptions",
        parentData: data,
        parentDataProperty: "threatExceptions",
        rootData
      })) {
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.endpointForwardingRule !== undefined) {
      if (!validate22(data.endpointForwardingRule, {
        instancePath: instancePath + "/endpointForwardingRule",
        parentData: data,
        parentDataProperty: "endpointForwardingRule",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.endpointIp !== undefined) {
      if (!validate22(data.endpointIp, {
        instancePath: instancePath + "/endpointIp",
        parentData: data,
        parentDataProperty: "endpointIp",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="cloudids.cnrm.cloud.google.com.v1alpha1.CloudIDSEndpoint" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
