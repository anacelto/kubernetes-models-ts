...
const schema21 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "lrk2jBNvb3cawKZAhBEGbn3ufnYI6eGOCVIbJG4TAE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "PwPNMyCQ7V4YbhkjURUWdYjWwmB9vEd4RikfI53x4"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeFirewall"
};
const schema22 = {
  "type": "string",
...
const schema26 = {
  "properties": {
    "allow": {
      "$ref": "yaEyw2M2mjesQaJ8tLmAZT2y64F1tOQGQg15KEHbw"
    },
    "deny": {
      "$ref": "yaEyw2M2mjesQaJ8tLmAZT2y64F1tOQGQg15KEHbw"
    },
    ...
    "logConfig": {
      "$ref": "PTHTkcHzB3m3Lltz8BR3on0i2TB1mrxMMvUKXA4Q"
    },
    "networkRef": {
...
const schema7 = {
  "items": {
    "$ref": "Z1ul6LtdoWUwBy0OosfIAv87yIzSYc5dqgAnMgld0"
  },
  "type": "array",
  "nullable": true
};
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.destinationRanges !== undefined) {
      if (!validate24(data.destinationRanges, {
        instancePath: instancePath + "/destinationRanges",
        parentData: data,
        parentDataProperty: "destinationRanges",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.enableLogging !== undefined) {
      if (!validate29(data.enableLogging, {
    ...
    if (data.sourceRanges !== undefined) {
      if (!validate24(data.sourceRanges, {
        instancePath: instancePath + "/sourceRanges",
        parentData: data,
        parentDataProperty: "sourceRanges",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.sourceServiceAccounts !== undefined) {
      if (!validate47(data.sourceServiceAccounts, {
        instancePath: instancePath + "/sourceServiceAccounts",
        parentData: data,
        parentDataProperty: "sourceServiceAccounts",
        rootData
      })) {
    ...
    if (data.sourceTags !== undefined) {
      if (!validate24(data.sourceTags, {
        instancePath: instancePath + "/sourceTags",
        parentData: data,
        parentDataProperty: "sourceTags",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.targetServiceAccounts !== undefined) {
      if (!validate47(data.targetServiceAccounts, {
    ...
    if (data.targetTags !== undefined) {
      if (!validate24(data.targetTags, {
        instancePath: instancePath + "/targetTags",
        parentData: data,
        parentDataProperty: "targetTags",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
function validate78(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.creationTimestamp !== undefined) {
      if (!validate30(data.creationTimestamp, {
...
function validate50(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeFirewall" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
