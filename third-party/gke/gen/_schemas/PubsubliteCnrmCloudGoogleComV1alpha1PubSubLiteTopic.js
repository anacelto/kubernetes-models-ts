...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "hB2jp5aW9GkAyZT6jhtPrUkj0FBpMM8R0gsrAnT67xM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "5MeAXfFto8pqDaONb7GM6WCz0vXTTqLg4NFBy00"
    },
    "status": {
  ...
  "$id": "pubsublite.cnrm.cloud.google.com.v1alpha1.PubSubLiteTopic"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    "partitionConfig": {
      "$ref": "jhZgUVw4QO3MhHDJNJrWHQcBpulc07CnPO7kTXz0"
    },
    "projectRef": {
    ...
    "reservationConfig": {
      "$ref": "iJjFpZ6aEfT2JkxaeL2QkJNj2LceerGPLlJ8IMBHY"
    },
    "resourceID": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "retentionConfig": {
      "$ref": "SoYfv2tWoN1UaaLDg1stSvbDbupe2v2bmgpr25Y8U40"
    },
    "zone": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    }
  },
  "required": ["projectRef", "zone"],
  "type": "object"
};
const schema15 = {
  "properties": {
    "capacity": {
      "$ref": "S2211uXUN9uR3pHJUaSKRdyw7NkgioeQNPnpnSDKis"
    },
    "count": {
...
const schema16 = {
  ...
  "required": ["publishMibPerSec", "subscribeMibPerSec"],
  "type": "object",
  "nullable": true
};
const schema6 = {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.publishMibPerSec === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "publishMibPerSec"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.subscribeMibPerSec === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "subscribeMibPerSec"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.publishMibPerSec !== undefined) {
      if (!validate21(data.publishMibPerSec, {
        instancePath: instancePath + "/publishMibPerSec",
        parentData: data,
        parentDataProperty: "publishMibPerSec",
        rootData
      })) {
    ...
    if (data.subscribeMibPerSec !== undefined) {
      if (!validate21(data.subscribeMibPerSec, {
        instancePath: instancePath + "/subscribeMibPerSec",
        parentData: data,
        parentDataProperty: "subscribeMibPerSec",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.throughputReservation !== undefined) {
      if (!validate22(data.throughputReservation, {
        instancePath: instancePath + "/throughputReservation",
        parentData: data,
        parentDataProperty: "throughputReservation",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate63(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.perPartitionBytes === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "perPartitionBytes"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.perPartitionBytes !== undefined) {
      if (!validate23(data.perPartitionBytes, {
        instancePath: instancePath + "/perPartitionBytes",
        parentData: data,
        parentDataProperty: "perPartitionBytes",
        rootData
      })) {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.partitionConfig !== undefined) {
      if (!validate34(data.partitionConfig, {
        instancePath: instancePath + "/partitionConfig",
        parentData: data,
        parentDataProperty: "partitionConfig",
        rootData
      })) {
    ...
    if (data.reservationConfig !== undefined) {
      if (!validate59(data.reservationConfig, {
        instancePath: instancePath + "/reservationConfig",
        parentData: data,
        parentDataProperty: "reservationConfig",
        rootData
      })) {
    ...
    if (data.retentionConfig !== undefined) {
      if (!validate63(data.retentionConfig, {
        instancePath: instancePath + "/retentionConfig",
        parentData: data,
        parentDataProperty: "retentionConfig",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="pubsublite.cnrm.cloud.google.com.v1alpha1.PubSubLiteTopic" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
