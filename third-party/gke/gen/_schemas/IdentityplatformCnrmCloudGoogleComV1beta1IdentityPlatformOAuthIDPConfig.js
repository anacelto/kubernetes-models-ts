...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "kF4AigQPqZtVrpS4wIXQDKsiOidjYRVS9EISqjivo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Nykw5L3i2Myy2ODPOTaLsDVCGuyFI0m8pLzzoKGiVo"
    },
    "status": {
  ...
  "$id": "identityplatform.cnrm.cloud.google.com.v1beta1.IdentityPlatformOAuthIDPConfig"
};
const schema10 = {
  "type": "string",
...
function validate27(data, {
  ...
  if (!(data === "IdentityPlatformOAuthIDPConfig")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate24(data, {
  ...
  /*# sourceURL="identityplatform.cnrm.cloud.google.com.v1beta1.IdentityPlatformOAuthIDPConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
