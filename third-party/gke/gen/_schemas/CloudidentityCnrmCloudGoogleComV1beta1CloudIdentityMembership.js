...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "awaP4YcSpjcgdwCUD6dxoWQa8hE9zBXv6f9FalYuu4"
    },
    "kind": {
      "$ref": "TriHBJgWOsLhZIU2MQL6YDYcbLpjMVSROjKbkNTKkpw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "JLdKAlYroVRwwS8FeWTv4BAIXx9sAbwviY0k9Klm4"
    },
    "status": {
      "$ref": "O4PwmjxWd73YcSd4PaSErfU0S3UBgYRG2hpiMCbX1yk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "cloudidentity.cnrm.cloud.google.com.v1beta1.CloudIdentityMembership"
};
const schema10 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "cloudidentity.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate27(data, {
  ...
  if (!(data === "CloudIdentityMembership")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    ...
    "memberKey": {
      "$ref": "e0zOsgUNP9YJ0LGCEFQrgKpBqQIZ4y2HpJKNM4"
    },
    "preferredMemberKey": {
      "$ref": "q1Ph5IbLDMKlkgfojOu6XAOu8rKE1nswoSEoPfQT8KQ"
    },
    "resourceID": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "roles": {
      "$ref": "fpZNbZR1ay7wbFShWGIBOcLmWGIcDM11cYkWPhfD84"
    }
  },
...
const schema24 = {
  "items": {
    "$ref": "LBsXteMhjouOYwfJ9Q6v9PpqDXb820pHuEnpKxSthU"
  },
  "type": "array"
};
const schema25 = {
  "properties": {
    "expiryDetail": {
      "$ref": "XOcxcqyjzltc0tA3rT6zNs8jPpElkO6q46cHMyzUHvI"
    },
    "name": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    "restrictionEvaluations": {
      "$ref": "C360GJRWBMhzlRfChjWwB1uqFzAzK9kHmtVsnHq8mg"
    }
  },
  "required": ["name"],
  "type": "object"
...
function validate66(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.memberRestrictionEvaluation !== undefined) {
      if (!validate67(data.memberRestrictionEvaluation, {
        instancePath: instancePath + "/memberRestrictionEvaluation",
        parentData: data,
        parentDataProperty: "memberRestrictionEvaluation",
        rootData
      })) {
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.expiryDetail !== undefined) {
      if (!validate62(data.expiryDetail, {
        instancePath: instancePath + "/expiryDetail",
        parentData: data,
        parentDataProperty: "expiryDetail",
        rootData
      })) {
    ...
    if (data.restrictionEvaluations !== undefined) {
      if (!validate66(data.restrictionEvaluations, {
        instancePath: instancePath + "/restrictionEvaluations",
        parentData: data,
        parentDataProperty: "restrictionEvaluations",
        rootData
      })) {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.preferredMemberKey === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "preferredMemberKey"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.memberKey !== undefined) {
      if (!validate51(data.memberKey, {
        instancePath: instancePath + "/memberKey",
        parentData: data,
        parentDataProperty: "memberKey",
        rootData
      })) {
    ...
    if (data.preferredMemberKey !== undefined) {
      if (!validate55(data.preferredMemberKey, {
        instancePath: instancePath + "/preferredMemberKey",
        parentData: data,
        parentDataProperty: "preferredMemberKey",
        rootData
      })) {
...
const schema29 = {
  "properties": {
    ...
    "displayName": {
      "$ref": "wgwYuAHUeBVk9fgGB2eXOlTv0j0pLYGtFEJKVpNf68"
    },
    "observedGeneration": {
...
function validate86(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.familyName !== undefined) {
      if (!validate21(data.familyName, {
        instancePath: instancePath + "/familyName",
        parentData: data,
        parentDataProperty: "familyName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.givenName !== undefined) {
      if (!validate21(data.givenName, {
        instancePath: instancePath + "/givenName",
        parentData: data,
        parentDataProperty: "givenName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deliverySetting !== undefined) {
      if (!validate21(data.deliverySetting, {
        instancePath: instancePath + "/deliverySetting",
        parentData: data,
        parentDataProperty: "deliverySetting",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.displayName !== undefined) {
      if (!validate86(data.displayName, {
...
function validate24(data, {
  ...
  /*# sourceURL="cloudidentity.cnrm.cloud.google.com.v1beta1.CloudIdentityMembership" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
