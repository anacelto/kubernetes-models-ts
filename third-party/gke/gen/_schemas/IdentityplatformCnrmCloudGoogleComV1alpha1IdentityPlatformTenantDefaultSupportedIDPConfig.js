...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Qgg8se1AS03DIMpRLP1Wlhci9mN7FeaoXIH5t4ur6g"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AnQlCYTuqt64SnXPt19T6Ar6wnPpsJ5A697RJvCs5E"
    },
    "status": {
  ...
  "$id": "identityplatform.cnrm.cloud.google.com.v1alpha1.IdentityPlatformTenantDefaultSupportedIDPConfig"
};
const schema9 = {
  "type": "string",
...
const schema10 = {
  "type": "string",
  "enum": ["IdentityPlatformTenantDefaultSupportedIDPConfig"]
};
function validate26(data, {
  ...
  if (!(data === "IdentityPlatformTenantDefaultSupportedIDPConfig")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["clientId", "clientSecret", "projectRef", "tenant"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate23(data, {
  ...
  /*# sourceURL="identityplatform.cnrm.cloud.google.com.v1alpha1.IdentityPlatformTenantDefaultSupportedIDPConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
