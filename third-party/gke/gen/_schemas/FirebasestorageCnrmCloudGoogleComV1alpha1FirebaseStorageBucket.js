...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "XsGjcSMB8idnqLCQt0bOiOHsSTgQcfTfSrh9IQ8bOk"
    },
    "kind": {
      "$ref": "oW1Bv5UIHLKL8Q75wIdaJ5LMiyHmerXGXOIq0ng"
    },
    "metadata": {
  ...
  "$id": "firebasestorage.cnrm.cloud.google.com.v1alpha1.FirebaseStorageBucket"
};
const schema8 = {
  "type": "string",
  "enum": ["firebasestorage.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "firebasestorage.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="firebasestorage.cnrm.cloud.google.com.v1alpha1.FirebaseStorageBucket" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
