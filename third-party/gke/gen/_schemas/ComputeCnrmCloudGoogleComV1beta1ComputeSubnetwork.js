...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "JguBha2MPhRJ0xmhe5utwyEvvUATwFbd7hGIQ4GG3M"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "NyYKi8pPOjFkk6Y8li4uSSCxpc65yshADvg95tY4PE"
    },
    "status": {
      "$ref": "8cnNyjYkku6iFhn6JN6fW4Se51cmri0oVgKkfbmCmxI"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeSubnetwork"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    ...
    "logConfig": {
      "$ref": "bX3ZVyCe9lgSeVBBY8uelTzuF5huEy0dliKXaVGvVU"
    },
    "networkRef": {
    ...
    "secondaryIpRange": {
      "$ref": "TfLZLWWmMRTKtmecdm4CXMCuN5Y0BXtUdSxvyeEblU"
    },
    "stackType": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.aggregationInterval !== undefined) {
      if (!validate21(data.aggregationInterval, {
        instancePath: instancePath + "/aggregationInterval",
        parentData: data,
        parentDataProperty: "aggregationInterval",
        rootData
      })) {
    ...
    if (data.filterExpr !== undefined) {
      if (!validate21(data.filterExpr, {
        instancePath: instancePath + "/filterExpr",
        parentData: data,
        parentDataProperty: "filterExpr",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.flowSampling !== undefined) {
      if (!validate38(data.flowSampling, {
        instancePath: instancePath + "/flowSampling",
        parentData: data,
        parentDataProperty: "flowSampling",
        rootData
      })) {
    ...
    if (data.metadataFields !== undefined) {
      if (!validate41(data.metadataFields, {
        instancePath: instancePath + "/metadataFields",
        parentData: data,
        parentDataProperty: "metadataFields",
        rootData
      })) {
...
const schema25 = {
  "items": {
    "$ref": "839kRTGg9iW43AxRpTiT6RiqgjZIcxMTUNcrqE4U"
  },
  "type": "array",
  "nullable": true
};
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.rangeName === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "rangeName"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.ipCidrRange !== undefined) {
      if (!validate22(data.ipCidrRange, {
    ...
    if (data.rangeName !== undefined) {
      if (!validate22(data.rangeName, {
        instancePath: instancePath + "/rangeName",
        parentData: data,
        parentDataProperty: "rangeName",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ipv6AccessType !== undefined) {
      if (!validate21(data.ipv6AccessType, {
    ...
    if (data.privateIpGoogleAccess !== undefined) {
      if (!validate62(data.privateIpGoogleAccess, {
        instancePath: instancePath + "/privateIpGoogleAccess",
        parentData: data,
        parentDataProperty: "privateIpGoogleAccess",
        rootData
      })) {
    ...
    if (data.secondaryIpRange !== undefined) {
      if (!validate69(data.secondaryIpRange, {
...
function validate77(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.externalIpv6Prefix !== undefined) {
      if (!validate21(data.externalIpv6Prefix, {
        instancePath: instancePath + "/externalIpv6Prefix",
        parentData: data,
        parentDataProperty: "externalIpv6Prefix",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.internalIpv6Prefix !== undefined) {
      if (!validate21(data.internalIpv6Prefix, {
        instancePath: instancePath + "/internalIpv6Prefix",
        parentData: data,
        parentDataProperty: "internalIpv6Prefix",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.ipv6CidrRange !== undefined) {
      if (!validate21(data.ipv6CidrRange, {
        instancePath: instancePath + "/ipv6CidrRange",
        parentData: data,
        parentDataProperty: "ipv6CidrRange",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeSubnetwork" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
