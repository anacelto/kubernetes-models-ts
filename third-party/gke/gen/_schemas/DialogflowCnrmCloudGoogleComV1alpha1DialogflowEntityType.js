...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "0X79lQuTP7i06hs99HBzvVassZAyQn9uR0BezYfmA"
    },
    "kind": {
      "$ref": "8Znau7dBD65Sa5eWSRSP0qBp6XuQlOINXWBo73JcuXo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "80J6A8GoCy6cxJwZzrImIACwMof4L2CtxHSfit3GqI"
    },
    "status": {
  ...
  "$id": "dialogflow.cnrm.cloud.google.com.v1alpha1.DialogflowEntityType"
};
const schema9 = {
  "type": "string",
  "enum": ["dialogflow.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "dialogflow.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    ...
    "entities": {
      "$ref": "5VHCX67OQJVLGVsbnDEe6lT18fZGktjXJbCMSFkG5eI"
    },
    "kind": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
  ...
  "required": ["displayName", "kind", "projectRef"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
const schema15 = {
  "items": {
    "$ref": "pIptG5YxWq36QaZjuTfK5Um0qINUBNTW8CyIviP8ru8"
  },
  "type": "array",
  "nullable": true
};
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.synonyms !== undefined) {
      if (!validate38(data.synonyms, {
        instancePath: instancePath + "/synonyms",
        parentData: data,
        parentDataProperty: "synonyms",
        rootData
      })) {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.enableFuzzyExtraction !== undefined) {
      if (!validate34(data.enableFuzzyExtraction, {
        instancePath: instancePath + "/enableFuzzyExtraction",
        parentData: data,
        parentDataProperty: "enableFuzzyExtraction",
        rootData
      })) {
    ...
    if (data.entities !== undefined) {
      if (!validate36(data.entities, {
        instancePath: instancePath + "/entities",
        parentData: data,
        parentDataProperty: "entities",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="dialogflow.cnrm.cloud.google.com.v1alpha1.DialogflowEntityType" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
