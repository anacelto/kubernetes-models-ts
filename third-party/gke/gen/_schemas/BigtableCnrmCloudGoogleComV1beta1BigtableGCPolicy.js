...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "UySzKT4qUEBRVOm6B93lZX9kZABNJcskJR624KpTOA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "89Dyqmt3vYWDVNTV6AMhmo84BvX1ik8ODPU3oywoVZ4"
    },
    "status": {
  ...
  "$id": "bigtable.cnrm.cloud.google.com.v1beta1.BigtableGCPolicy"
};
const schema16 = {
  "type": "string",
...
const schema20 = {
  "properties": {
    ...
    "maxAge": {
      "$ref": "xEtRehY9ITLuDBYytnpFS1BFwnhRpm6BqWkCzjt9ET8"
    },
    "maxVersion": {
      "$ref": "qSIfxidXQbBx4iPTyfQTsNUaiOCkQpyR5asw224"
    },
    "mode": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema22 = {
  "items": {
    "$ref": "8AQ2BN8izNm9dIlG1XNTMq02WeH9d0LbYO8K1SYfs"
  },
  "type": "array",
  "nullable": true
};
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.days !== undefined) {
      if (!validate38(data.days, {
        instancePath: instancePath + "/days",
        parentData: data,
        parentDataProperty: "days",
        rootData
      })) {
...
const schema24 = {
  "items": {
    "$ref": "qWAHXpo9sIVvWs21N50AulfbahzS1lLju4G3v0GM"
  },
  "type": "array",
  "nullable": true
};
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.columnFamily !== undefined) {
      if (!validate49(data.columnFamily, {
    ...
    if (data.gcRules !== undefined) {
      if (!validate21(data.gcRules, {
        instancePath: instancePath + "/gcRules",
        parentData: data,
        parentDataProperty: "gcRules",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate39(data, {
  ...
  /*# sourceURL="bigtable.cnrm.cloud.google.com.v1beta1.BigtableGCPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
