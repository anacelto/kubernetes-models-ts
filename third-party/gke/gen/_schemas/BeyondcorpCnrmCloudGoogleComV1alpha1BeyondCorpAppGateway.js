...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "SPk7ktW3vhpxPQiPHxOz0wDbWntLm7WPJALAFUPS7GE"
    },
    "kind": {
      "$ref": "TmeSV86LtDrli7LyQfl5CL9fDIWvTX2qSP7x4r5H9E"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "vBCzQk5PlO2rv0AfPsJZnMIDyuhXTV5ILicMqdnRz0"
    },
    "status": {
      "$ref": "iEoji0LSTWJjkuxjA1e9GBupow2lTG9WjkHpVgM6s"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "beyondcorp.cnrm.cloud.google.com.v1alpha1.BeyondCorpAppGateway"
};
const schema9 = {
  "type": "string",
  "enum": ["beyondcorp.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "beyondcorp.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.hostType !== undefined) {
      if (!validate21(data.hostType, {
        instancePath: instancePath + "/hostType",
        parentData: data,
        parentDataProperty: "hostType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema22 = {
  "properties": {
    "allocatedConnections": {
      "$ref": "ZVaTNKv7KPzUbHwBgGRcKwPbBhLl41j9jtUafBU8"
    },
    "conditions": {
...
const schema23 = {
  "items": {
    "$ref": "Lvh4P0iCznGsAwI0wRHEjyt82Lk9WNY6aQk2QhlSA"
  },
  "type": "array",
  "nullable": true
};
...
function validate59(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ingressPort !== undefined) {
      if (!validate22(data.ingressPort, {
        instancePath: instancePath + "/ingressPort",
        parentData: data,
        parentDataProperty: "ingressPort",
        rootData
      })) {
    ...
    if (data.pscUri !== undefined) {
      if (!validate21(data.pscUri, {
        instancePath: instancePath + "/pscUri",
        parentData: data,
        parentDataProperty: "pscUri",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allocatedConnections !== undefined) {
      if (!validate58(data.allocatedConnections, {
        instancePath: instancePath + "/allocatedConnections",
        parentData: data,
        parentDataProperty: "allocatedConnections",
        rootData
      })) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate22(data.observedGeneration, {
...
function validate23(data, {
  ...
  /*# sourceURL="beyondcorp.cnrm.cloud.google.com.v1alpha1.BeyondCorpAppGateway" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
