...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "ZP3GYGzEOIbGgooQ9IDF5yVfiGulDgSz83oNE9dg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "lrlFiagXMAIMT9mS75Qgmo4XjVWrDx0bCxOWvwcBOw"
    },
    "status": {
  ...
  "$id": "identityplatform.cnrm.cloud.google.com.v1alpha1.IdentityPlatformDefaultSupportedIDPConfig"
};
const schema9 = {
  "type": "string",
...
const schema10 = {
  "type": "string",
  "enum": ["IdentityPlatformDefaultSupportedIDPConfig"]
};
function validate26(data, {
  ...
  if (!(data === "IdentityPlatformDefaultSupportedIDPConfig")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["clientId", "clientSecret", "projectRef"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate23(data, {
  ...
  /*# sourceURL="identityplatform.cnrm.cloud.google.com.v1alpha1.IdentityPlatformDefaultSupportedIDPConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
