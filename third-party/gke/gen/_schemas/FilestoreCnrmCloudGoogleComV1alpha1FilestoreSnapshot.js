...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "BtzL6pSPKFNdvg2W2P75wtCj3ZWmzGlfhwqTSgY28"
    },
    "kind": {
      "$ref": "pEyu4CQ4kMo3swiNAsjzqojydZFd1rqOXvrakRk2v4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "0eh9WElO9KzVzRf0E2fl72gJwrTjwxJ5Ynf065bUec"
    },
    "status": {
      "$ref": "QbFbDynhGxySfa3bMJx5w4D0UbXjuw4dXpEfB6GTs"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "filestore.cnrm.cloud.google.com.v1alpha1.FilestoreSnapshot"
};
const schema9 = {
  "type": "string",
  "enum": ["filestore.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "filestore.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["instance", "location", "projectRef"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.instance !== undefined) {
      if (!validate21(data.instance, {
        instancePath: instancePath + "/instance",
        parentData: data,
        parentDataProperty: "instance",
        rootData
      })) {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.filesystemUsedBytes !== undefined) {
      if (!validate22(data.filesystemUsedBytes, {
        instancePath: instancePath + "/filesystemUsedBytes",
        parentData: data,
        parentDataProperty: "filesystemUsedBytes",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="filestore.cnrm.cloud.google.com.v1alpha1.FilestoreSnapshot" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
