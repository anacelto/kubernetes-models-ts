...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "0RSrGnc40n8EXjGnoEZrrPsFbqdurTMqP1JHC7O1U"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "BxqJA4nMbvkDCblrHeKibpdwSH64IGf7mkhGR2zw"
    },
    "status": {
      "$ref": "rGp17XWJQg3DVTjlOaCKMsywYEbVehSLNGyy20g95Ec"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "net.gke.io.v1alpha1.TDMesh"
};
const schema8 = {
  "type": "string",
...
const schema12 = {
  "properties": {
    "allowedRoutes": {
      "$ref": "Bw2qQH0NgzjU1TN1qO2FhVSUe531aAP71QG8qVIc40"
    },
    "gatewayClassName": {
...
const schema13 = {
  ...
  "properties": {
    "kinds": {
      "$ref": "937g56UluxwXP3hfjxgHt4RVF4oV99agrMhq8ESI3c"
    },
    "namespaces": {
      "$ref": "clNf26TXYB0skistAQwZLqTeKV5qWmzrXMUm7soo"
    }
  },
  "type": "object",
  "nullable": true
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedRoutes !== undefined) {
      if (!validate32(data.allowedRoutes, {
    ...
    if (data.gatewayClassName !== undefined) {
      if (!validate60(data.gatewayClassName, {
...
const schema26 = {
  "properties": {
    "conditions": {
      "$ref": "jTYpQK0fXRcEAWqWbLZFkB4I49x2op9pO3pZxXcbkw"
    }
  },
  "type": "object",
  "nullable": true
...
function validate22(data, {
  ...
  /*# sourceURL="net.gke.io.v1alpha1.TDMesh" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
