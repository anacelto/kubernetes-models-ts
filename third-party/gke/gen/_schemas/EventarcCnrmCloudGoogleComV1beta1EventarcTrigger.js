...
const schema17 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "pGUoYGUhCVyvbPuCyySMZjijFFvREWS5BiCbCo"
    },
    "kind": {
      "$ref": "wmYpHNPFKWDZarQrjZ6hOXQYqTSRdEJgDy8t1j4B4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "y3snDEXAKat8XBTwEdZaPmiKiT4eDMuLX3hEtUc7Fw"
    },
    "status": {
      "$ref": "8gKoXYO8JYRsPYrZ1Lku60NV4sHr8umbTX9Rh8uBw"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "eventarc.cnrm.cloud.google.com.v1beta1.EventarcTrigger"
};
const schema18 = {
  "type": "string",
  "enum": ["eventarc.cnrm.cloud.google.com/v1beta1"]
};
function validate47(data, {
  ...
  if (!(data === "eventarc.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema22 = {
  "properties": {
    ...
    "destination": {
      "$ref": "0WwhuhbOYrf3k2VBZ9kmM491trDNuyx1aTDd6woyrw"
    },
    ...
    "matchingCriteria": {
      "$ref": "YsuljIGFssKBJz7UmOfubOXdo8zu4I98tXNBJfEr1ow"
    },
    "projectRef": {
    ...
    "transport": {
      "$ref": "L55s4Vossx5uT0GYAhwRJ1vXTF48EwZcdBlTWDSg"
    }
  },
  "required": ["destination", "location", "matchingCriteria", "projectRef"],
  "type": "object"
};
const schema7 = {
  "oneOf": [{
...
const schema23 = {
  "properties": {
    ...
    "cloudRunService": {
      "$ref": "wxGqVGETUknO3jNmTNhDDZWADTJecFigjVZtDIrZY"
    },
    "gke": {
      "$ref": "1f7olcA3iDkWCPOBUn1IcERHvQ9KJRDLXZHYZz708wo"
    },
    "workflowRef": {
      "$ref": "FqwG3fNQDV94n3ssyud4YO0vSjAbQTxNuU0XWG96Y"
    }
...
const schema25 = {
  ...
  "required": ["clusterRef", "location", "namespace", "service"],
  "type": "object",
  "nullable": true
};
...
function validate57(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cloudFunctionRef !== undefined) {
      if (!validate22(data.cloudFunctionRef, {
        instancePath: instancePath + "/cloudFunctionRef",
        parentData: data,
        parentDataProperty: "cloudFunctionRef",
        rootData
      })) {
    ...
    if (data.cloudRunService !== undefined) {
      if (!validate59(data.cloudRunService, {
        instancePath: instancePath + "/cloudRunService",
        parentData: data,
        parentDataProperty: "cloudRunService",
        rootData
      })) {
    ...
    if (data.gke !== undefined) {
      if (!validate64(data.gke, {
        instancePath: instancePath + "/gke",
        parentData: data,
        parentDataProperty: "gke",
        rootData
      })) {
    ...
    if (data.workflowRef !== undefined) {
      if (!validate22(data.workflowRef, {
        instancePath: instancePath + "/workflowRef",
        parentData: data,
        parentDataProperty: "workflowRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.matchingCriteria === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "matchingCriteria"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.channelRef !== undefined) {
      if (!validate22(data.channelRef, {
        instancePath: instancePath + "/channelRef",
        parentData: data,
        parentDataProperty: "channelRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.destination !== undefined) {
      if (!validate57(data.destination, {
    ...
    if (data.eventDataContentType !== undefined) {
      if (!validate21(data.eventDataContentType, {
        instancePath: instancePath + "/eventDataContentType",
        parentData: data,
        parentDataProperty: "eventDataContentType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.matchingCriteria !== undefined) {
      if (!validate75(data.matchingCriteria, {
        instancePath: instancePath + "/matchingCriteria",
        parentData: data,
        parentDataProperty: "matchingCriteria",
        rootData
      })) {
...
const schema30 = {
  "properties": {
    ...
    "transport": {
      "$ref": "GXQakFBW8XMUnIBQaAEWNPG6D9jAcOENPVHwB2PXw"
    },
    "uid": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema35 = {
  "properties": {
    "pubsub": {
      "$ref": "5VbwEcSsjWevIEpO38hmMpYw2QQ64wrWYlfu3Ptts0"
    }
  },
  "type": "object",
  "nullable": true
...
function validate91(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.resourceConditions !== undefined) {
      if (!validate105(data.resourceConditions, {
...
function validate46(data, {
  ...
  /*# sourceURL="eventarc.cnrm.cloud.google.com.v1beta1.EventarcTrigger" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
