...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "AReE57iGdZ4WmLUlMnCFmEjH3JzLRwHhcY39a8twpk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "dtz0JWlwmWTOj5PKzX6frplN3JlfZfEsJe8w6poYs"
    },
    "status": {
  ...
  "$id": "iam.cnrm.cloud.google.com.v1beta1.IAMWorkloadIdentityPoolProvider"
};
const schema17 = {
  "type": "string",
...
function validate44(data, {
  ...
  if (!(data === "IAMWorkloadIdentityPoolProvider")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema21 = {
  "properties": {
    ...
    "aws": {
      "$ref": "SZqsnKJd4poaAEm1jsj4ZJJQ8NUkeh1d99TeMrdO704"
    },
    "disabled": {
    ...
    "oidc": {
      "$ref": "HufCP1hRaPP06PRggkdlHPEuyWlV9YytvYGxNaFkTM"
    },
    "projectRef": {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.accountId !== undefined) {
      if (!validate21(data.accountId, {
        instancePath: instancePath + "/accountId",
        parentData: data,
        parentDataProperty: "accountId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.stsUri !== undefined) {
      if (!validate23(data.stsUri, {
        instancePath: instancePath + "/stsUri",
        parentData: data,
        parentDataProperty: "stsUri",
        rootData
      })) {
...
function validate63(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedAudiences !== undefined) {
      if (!validate23(data.allowedAudiences, {
        instancePath: instancePath + "/allowedAudiences",
        parentData: data,
        parentDataProperty: "allowedAudiences",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.workloadIdentityPoolRef === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "workloadIdentityPoolRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.attributeCondition !== undefined) {
      if (!validate22(data.attributeCondition, {
    ...
    if (data.attributeMapping !== undefined) {
      if (!validate52(data.attributeMapping, {
    ...
    if (data.workloadIdentityPoolRef !== undefined) {
      if (!validate25(data.workloadIdentityPoolRef, {
        instancePath: instancePath + "/workloadIdentityPoolRef",
        parentData: data,
        parentDataProperty: "workloadIdentityPoolRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
...
function validate41(data, {
  ...
  /*# sourceURL="iam.cnrm.cloud.google.com.v1beta1.IAMWorkloadIdentityPoolProvider" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
