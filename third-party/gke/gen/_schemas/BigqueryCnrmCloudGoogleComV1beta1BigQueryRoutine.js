...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "OoFVDQ1SYEMj74ozdJ6RLtnJfUK1snDFhx09Suv8zA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "CRhxuAaTcY8PJu8osZXRqHIiTfZqTAaqWmf4Z6I"
    },
    "status": {
      "$ref": "3jZWtGCgSoe8B7cwxfu4DFaXbzsxAtmzvhBIyoB6Ou4"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "bigquery.cnrm.cloud.google.com.v1beta1.BigQueryRoutine"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    "arguments": {
      "$ref": "OR8wh8rLPVvoJm81rQhJAkJsriwCQrlLTWcXKfwjpE"
    },
    "datasetRef": {
  ...
  "required": ["datasetRef", "definitionBody", "projectRef"],
  "type": "object"
};
const schema22 = {
  "items": {
    "$ref": "zIHzxjQFOqNwJMbqof2rUEDLyIEiZaaUUlmVzHB2o"
  },
  "type": "array",
  "nullable": true
};
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.argumentKind !== undefined) {
      if (!validate21(data.argumentKind, {
        instancePath: instancePath + "/argumentKind",
        parentData: data,
        parentDataProperty: "argumentKind",
        rootData
      })) {
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.definitionBody === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "definitionBody"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.definitionBody !== undefined) {
      if (!validate22(data.definitionBody, {
        instancePath: instancePath + "/definitionBody",
        parentData: data,
        parentDataProperty: "definitionBody",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.determinismLevel !== undefined) {
      if (!validate21(data.determinismLevel, {
        instancePath: instancePath + "/determinismLevel",
        parentData: data,
        parentDataProperty: "determinismLevel",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.importedLibraries !== undefined) {
      if (!validate61(data.importedLibraries, {
        instancePath: instancePath + "/importedLibraries",
        parentData: data,
        parentDataProperty: "importedLibraries",
        rootData
      })) {
    ...
    if (data.language !== undefined) {
      if (!validate21(data.language, {
        instancePath: instancePath + "/language",
        parentData: data,
        parentDataProperty: "language",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.returnTableType !== undefined) {
      if (!validate21(data.returnTableType, {
        instancePath: instancePath + "/returnTableType",
        parentData: data,
        parentDataProperty: "returnTableType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.returnType !== undefined) {
      if (!validate21(data.returnType, {
        instancePath: instancePath + "/returnType",
        parentData: data,
        parentDataProperty: "returnType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.routineType !== undefined) {
      if (!validate21(data.routineType, {
        instancePath: instancePath + "/routineType",
        parentData: data,
        parentDataProperty: "routineType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate71(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.creationTime !== undefined) {
      if (!validate39(data.creationTime, {
    ...
    if (data.lastModifiedTime !== undefined) {
      if (!validate39(data.lastModifiedTime, {
...
function validate40(data, {
  ...
  /*# sourceURL="bigquery.cnrm.cloud.google.com.v1beta1.BigQueryRoutine" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
