...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "21roX41hqGsjiZ0I97Td5x7ckMT8x04iZTNkxX2L5c"
    },
    "kind": {
      "$ref": "noBMFfZuN0AFR1I7ibRD7yEoP2OOTdgE26CFYFq648"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "JjACobWaaMHa7mfGAcWjRHqxSmdfW2zyaYpd3BcYGY"
    },
    "status": {
  ...
  "$id": "kms.cnrm.cloud.google.com.v1beta1.KMSKeyRing"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "kms.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="kms.cnrm.cloud.google.com.v1beta1.KMSKeyRing" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
