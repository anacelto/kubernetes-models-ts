...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "DJdW4hJAVxxNHFTbY3xXS7T5P4mUHhW3UEnhdRirTAQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Zh88u4jppkRpLiz2v4vKSQTMqvPAqHrPeP6fyYubRo"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeTargetInstance"
};
const schema15 = {
  "type": "string",
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.instanceRef !== undefined) {
      if (!validate48(data.instanceRef, {
    ...
    if (data.natPolicy !== undefined) {
      if (!validate21(data.natPolicy, {
        instancePath: instancePath + "/natPolicy",
        parentData: data,
        parentDataProperty: "natPolicy",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.securityPolicyRef !== undefined) {
      if (!validate32(data.securityPolicyRef, {
...
function validate38(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeTargetInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
