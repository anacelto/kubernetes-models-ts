...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "edqqVby6avsuN0tbkmhUbvHzW1u8qN7UDtxnrRY0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "6caDhP0IqNGigk7nS6x9OnAqvTn0SNKkl4HbfzXYI"
    },
    "status": {
  ...
  "$id": "bigtable.cnrm.cloud.google.com.v1beta1.BigtableInstance"
};
const schema11 = {
  "type": "string",
...
const schema15 = {
  "properties": {
    "cluster": {
      "$ref": "1QXwQRowQe1lPBYtXsZvhatCp4237l9LC99oZ2Hwg"
    },
    "deletionProtection": {
...
const schema16 = {
  "items": {
    "$ref": "9jrokd0Zb0xHcluHOaAsVn2CPJNgsP4ZGQSIcLHM"
  },
  "type": "array",
  "nullable": true
};
const schema17 = {
  "properties": {
    "autoscalingConfig": {
      "$ref": "bclqmYKHGe5PMUAwsTg6hjxG077rnE5iNvdTATfvlQ"
    },
    "clusterId": {
...
const schema18 = {
  ...
  "required": ["cpuTarget", "maxNodes", "minNodes"],
  "type": "object",
  "nullable": true
};
const schema6 = {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cpuTarget === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "cpuTarget"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.cpuTarget !== undefined) {
      if (!validate21(data.cpuTarget, {
        instancePath: instancePath + "/cpuTarget",
        parentData: data,
        parentDataProperty: "cpuTarget",
        rootData
      })) {
    ...
    if (data.storageTarget !== undefined) {
      if (!validate23(data.storageTarget, {
        instancePath: instancePath + "/storageTarget",
        parentData: data,
        parentDataProperty: "storageTarget",
        rootData
      })) {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.autoscalingConfig !== undefined) {
      if (!validate37(data.autoscalingConfig, {
    ...
    if (data.storageType !== undefined) {
      if (!validate22(data.storageType, {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deletionProtection !== undefined) {
      if (!validate66(data.deletionProtection, {
    ...
    if (data.instanceType !== undefined) {
      if (!validate22(data.instanceType, {
...
function validate25(data, {
  ...
  /*# sourceURL="bigtable.cnrm.cloud.google.com.v1beta1.BigtableInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
