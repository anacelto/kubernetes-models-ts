...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "1IFJDRF4k1UgQvRCnFpNfTxxSilfmAXRrOYgb3yXc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "OBEFkRbYOw9W4WCnHfo9dpsafeAlWNamWOwh8R0sA"
    },
    "status": {
      "$ref": "rntshyBUkKmB3bYNkI8FBM6Bj5ycX3E4QXW5aLpHt4"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeExternalVPNGateway"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "ComputeExternalVPNGateway")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    "interface": {
      "$ref": "6diRLpoObmgBl2kRwp9HdtbiFFm8cE2qwCeiPl3SImk"
    },
    "redundancyType": {
...
const schema14 = {
  "items": {
    "$ref": "EzrMgqSUFVxyx372CMgwnm8TI4AzLAbEq2DaarIWhB8"
  },
  "type": "array",
  "nullable": true
};
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.redundancyType !== undefined) {
      if (!validate21(data.redundancyType, {
        instancePath: instancePath + "/redundancyType",
        parentData: data,
        parentDataProperty: "redundancyType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeExternalVPNGateway" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
