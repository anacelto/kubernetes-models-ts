...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "CZi8txScLvmnz3KEJYDxEG0fvULAxzHxMroPuEfI5w"
    },
    "kind": {
      "$ref": "nGyZhVy3zijG1jOD8LyIT50gY7U7Xwxhlm7zWQwqEfA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "mDPpBc15fqRkZdt6rIG6s97dyn9XHHfAj8uOj5XYFhc"
    },
    "status": {
  ...
  "$id": "cloudtasks.cnrm.cloud.google.com.v1alpha1.CloudTasksQueue"
};
const schema9 = {
  "type": "string",
  "enum": ["cloudtasks.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "cloudtasks.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    "appEngineRoutingOverride": {
      "$ref": "GNgJQAi0kppggEn9klEIy3UZafvllH8aWR5JfbdSPU"
    },
    "location": {
    ...
    "rateLimits": {
      "$ref": "M9CavO1wAYscirTRZRmNMZ2Yu7eKsTn7bzFLC6Ht6Q"
    },
    "resourceID": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "retryConfig": {
      "$ref": "Q0k6FnVAgd1gzEkp7QpTAFoyua7CZYrcSDdQOdifU"
    },
    "stackdriverLoggingConfig": {
      "$ref": "EgPqAgLh2e4xN9uXprR59EaGBoL00fyha1R5J0Y1RA"
    }
  },
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.maxBurstSize !== undefined) {
      if (!validate22(data.maxBurstSize, {
        instancePath: instancePath + "/maxBurstSize",
        parentData: data,
        parentDataProperty: "maxBurstSize",
        rootData
      })) {
    ...
    if (data.maxConcurrentDispatches !== undefined) {
      if (!validate22(data.maxConcurrentDispatches, {
        instancePath: instancePath + "/maxConcurrentDispatches",
        parentData: data,
        parentDataProperty: "maxConcurrentDispatches",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.maxDispatchesPerSecond !== undefined) {
      if (!validate61(data.maxDispatchesPerSecond, {
        instancePath: instancePath + "/maxDispatchesPerSecond",
        parentData: data,
        parentDataProperty: "maxDispatchesPerSecond",
        rootData
      })) {
...
function validate65(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.maxAttempts !== undefined) {
      if (!validate22(data.maxAttempts, {
    ...
    if (data.maxDoublings !== undefined) {
      if (!validate22(data.maxDoublings, {
...
function validate72(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.samplingRatio === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "samplingRatio"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.samplingRatio !== undefined) {
      if (!validate73(data.samplingRatio, {
        instancePath: instancePath + "/samplingRatio",
        parentData: data,
        parentDataProperty: "samplingRatio",
        rootData
      })) {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.appEngineRoutingOverride !== undefined) {
      if (!validate33(data.appEngineRoutingOverride, {
        instancePath: instancePath + "/appEngineRoutingOverride",
        parentData: data,
        parentDataProperty: "appEngineRoutingOverride",
        rootData
      })) {
    ...
    if (data.rateLimits !== undefined) {
      if (!validate58(data.rateLimits, {
        instancePath: instancePath + "/rateLimits",
        parentData: data,
        parentDataProperty: "rateLimits",
        rootData
      })) {
    ...
    if (data.retryConfig !== undefined) {
      if (!validate65(data.retryConfig, {
    ...
    if (data.stackdriverLoggingConfig !== undefined) {
      if (!validate72(data.stackdriverLoggingConfig, {
        instancePath: instancePath + "/stackdriverLoggingConfig",
        parentData: data,
        parentDataProperty: "stackdriverLoggingConfig",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="cloudtasks.cnrm.cloud.google.com.v1alpha1.CloudTasksQueue" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
