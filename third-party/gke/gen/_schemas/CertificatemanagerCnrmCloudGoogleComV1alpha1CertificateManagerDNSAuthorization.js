...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "JZYh7PNGyvQyiMXQrcGwyqD2tsVXJHC7tupZIy0VU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "iXkwQoCS8ieuav36NopHb6SpRSiRQjyz3eQeIDDC0"
    },
    "status": {
      "$ref": "VIMigUxNkBwTjPerUEEvlgOhG9bUjlwVaoqvWYV8"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "certificatemanager.cnrm.cloud.google.com.v1alpha1.CertificateManagerDNSAuthorization"
};
const schema8 = {
  "type": "string",
...
const schema9 = {
  "type": "string",
  "enum": ["CertificateManagerDNSAuthorization"]
};
function validate25(data, {
  ...
  if (!(data === "CertificateManagerDNSAuthorization")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema21 = {
  "properties": {
    ...
    "dnsResourceRecord": {
      "$ref": "RzfDa7sKItM20oWDnpYvpYpJbF6RazOmkHydV0Sm3zY"
    },
    "observedGeneration": {
...
const schema24 = {
  "items": {
    "$ref": "rUf8jIoWBYK8hJAjgAEm1bDZ68H7bB46j2cS65A"
  },
  "type": "array",
  "nullable": true
};
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dnsResourceRecord !== undefined) {
      if (!validate63(data.dnsResourceRecord, {
        instancePath: instancePath + "/dnsResourceRecord",
        parentData: data,
        parentDataProperty: "dnsResourceRecord",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="certificatemanager.cnrm.cloud.google.com.v1alpha1.CertificateManagerDNSAuthorization" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
