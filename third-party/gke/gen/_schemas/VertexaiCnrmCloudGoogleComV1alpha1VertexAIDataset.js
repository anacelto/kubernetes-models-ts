...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "eQCGsszemd7us5UfNbM1vfVVvocSTfaYvIvYjjs4c"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "gtI3jHWTVdh7s3ke8lF4KI2mU2rf2Ge1NRtJVxi9654"
    },
    "status": {
  ...
  "$id": "vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIDataset"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  ...
  "required": ["displayName", "metadataSchemaUri", "projectRef"],
  "type": "object"
};
const schema6 = {
  "type": "string"
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.metadataSchemaUri === undefined) {
      const err1 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "metadataSchemaUri"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.metadataSchemaUri !== undefined) {
      if (!validate21(data.metadataSchemaUri, {
...
function validate23(data, {
  ...
  /*# sourceURL="vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIDataset" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
