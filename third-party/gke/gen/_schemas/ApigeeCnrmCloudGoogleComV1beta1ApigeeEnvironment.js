...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "npc5n0nqjaHIdC0RQrD91B4w3x76sOnX1FfeYPs"
    },
    "kind": {
      "$ref": "p5SCV3ZcBYrnJhzj6sA2aSS8ByeGmbDjLLyIHVpYkuY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "b4uiL1SGypFXcpbDwUcfIqtIDeQX813qQDQL6Tm5M"
    },
    "status": {
      "$ref": "I7eKfzOX0qDahilsiFLv7DwsslpRMjTfbuIg1DAwnts"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "apigee.cnrm.cloud.google.com.v1beta1.ApigeeEnvironment"
};
const schema9 = {
  "type": "string",
  "enum": ["apigee.cnrm.cloud.google.com/v1beta1"]
};
function validate24(data, {
  ...
  if (!(data === "apigee.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["apigeeOrganizationRef"],
  "type": "object"
};
const schema14 = {
  "oneOf": [{
...
function validate32(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apigeeOrganizationRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "apigeeOrganizationRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.apigeeOrganizationRef !== undefined) {
      if (!validate33(data.apigeeOrganizationRef, {
        instancePath: instancePath + "/apigeeOrganizationRef",
        parentData: data,
        parentDataProperty: "apigeeOrganizationRef",
        rootData
      })) {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastModifiedAt !== undefined) {
      if (!validate22(data.lastModifiedAt, {
        instancePath: instancePath + "/lastModifiedAt",
        parentData: data,
        parentDataProperty: "lastModifiedAt",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="apigee.cnrm.cloud.google.com.v1beta1.ApigeeEnvironment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
