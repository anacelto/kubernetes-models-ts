...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "knQtkgf9KHXfKRRb0h5BJAe9SjaM5SR1tKqfkthQhM"
    },
    "kind": {
      "$ref": "eLwcizYomd5Adn5Lad7KRMxDOszu5a3cBLozNnNieW4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "WuqoN2K1gtbMLFSEspjv3jFB9GhTdG96DoxfUXR5oI"
    },
    "status": {
      "$ref": "HhJQUwTV9hegRh0f61EGgf5BChIOtDtCY2RCLTet78"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "bigqueryanalyticshub.cnrm.cloud.google.com.v1alpha1.BigQueryAnalyticsHubDataExchange"
};
const schema10 = {
  "type": "string",
  "enum": ["bigqueryanalyticshub.cnrm.cloud.google.com/v1alpha1"]
};
function validate25(data, {
  ...
  if (!(data === "bigqueryanalyticshub.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema11 = {
  "type": "string",
  "enum": ["BigQueryAnalyticsHubDataExchange"]
};
function validate27(data, {
  ...
  if (!(data === "BigQueryAnalyticsHubDataExchange")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  ...
  "required": ["displayName", "location", "projectRef"],
  "type": "object"
};
const schema7 = {
  "type": "string"
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.documentation !== undefined) {
      if (!validate21(data.documentation, {
        instancePath: instancePath + "/documentation",
        parentData: data,
        parentDataProperty: "documentation",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.icon !== undefined) {
      if (!validate21(data.icon, {
        instancePath: instancePath + "/icon",
        parentData: data,
        parentDataProperty: "icon",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.primaryContact !== undefined) {
      if (!validate21(data.primaryContact, {
        instancePath: instancePath + "/primaryContact",
        parentData: data,
        parentDataProperty: "primaryContact",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.listingCount !== undefined) {
      if (!validate23(data.listingCount, {
        instancePath: instancePath + "/listingCount",
        parentData: data,
        parentDataProperty: "listingCount",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="bigqueryanalyticshub.cnrm.cloud.google.com.v1alpha1.BigQueryAnalyticsHubDataExchange" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
