...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "pppP0rH5zRwscgQjujMb9ydRR8iu5FUhMzirEORcY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Hrand2sIjEV1UwGZHkE7ThnhWXjWIkgCM2dVVtZPJ4"
    },
    "status": {
      "$ref": "azAngQQgVJiL43hYUOq0WQIpftG5eJpSktXk5jQoQQ"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "iam.cnrm.cloud.google.com.v1beta1.IAMCustomRole"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.permissions !== undefined) {
      if (!validate33(data.permissions, {
...
function validate23(data, {
  ...
  /*# sourceURL="iam.cnrm.cloud.google.com.v1beta1.IAMCustomRole" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
