...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "olr0mulXpsmzldq7vlWcQH9zhMJm4gTNvqCRJEXs"
    },
    "kind": {
      "$ref": "VKiB72tVore3aVLIW4WzC1FbpYwQYaWdXecI2G3kY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "vIHS8h9sgKpYu05nfWRw5CvhYP5UJrrKRX1cllVRQ"
    },
    "status": {
      "$ref": "yNm8XeSOAvJOF7MNZ4pjyeclMAB1EXwiOVGW5H3tGk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "storagetransfer.cnrm.cloud.google.com.v1alpha1.StorageTransferAgentPool"
};
const schema8 = {
  "type": "string",
  "enum": ["storagetransfer.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "storagetransfer.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate25(data, {
  ...
  if (!(data === "StorageTransferAgentPool")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "properties": {
    "bandwidthLimit": {
      "$ref": "sXGyQFcnEqQs6wCq6ZT1aOFoX40cXk2y1vV0sWCkw"
    },
    "displayName": {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.limitMbps === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "limitMbps"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.limitMbps !== undefined) {
      if (!validate33(data.limitMbps, {
        instancePath: instancePath + "/limitMbps",
        parentData: data,
        parentDataProperty: "limitMbps",
        rootData
      })) {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.bandwidthLimit !== undefined) {
      if (!validate32(data.bandwidthLimit, {
        instancePath: instancePath + "/bandwidthLimit",
        parentData: data,
        parentDataProperty: "bandwidthLimit",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="storagetransfer.cnrm.cloud.google.com.v1alpha1.StorageTransferAgentPool" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
