...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "rGtri0GsHySy843dBuIR3TW6Zc1izH3rGTM5v6WG2o"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "u8M9wf26edz6hRBSBHT9aNFAxPPwJMvNvCjEh4C1pI"
    },
    "status": {
  ...
  "$id": "apigateway.cnrm.cloud.google.com.v1alpha1.APIGatewayAPI"
};
const schema8 = {
  "type": "string",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.managedService !== undefined) {
      if (!validate21(data.managedService, {
        instancePath: instancePath + "/managedService",
        parentData: data,
        parentDataProperty: "managedService",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="apigateway.cnrm.cloud.google.com.v1alpha1.APIGatewayAPI" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
