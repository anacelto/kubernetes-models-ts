...
const schema15 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "cWZBmpNJyNTAHnKYABjEJXL5JvzzeCvYKY7MtSWJV8"
    },
    "kind": {
      "$ref": "1HFtinxlj3qUdLFreDoNFJxazVoG18S2KDJ4SpQ3uE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "r1fD2ALtYKJoKiUm1owPi5ryrqA7zdmSfijKM"
    },
    "status": {
  ...
  "$id": "net.gke.io.v1alpha1.TDGRPCRoute"
};
const schema16 = {
  "type": "string",
  "enum": ["net.gke.io/v1alpha1"]
};
...
const schema20 = {
  "properties": {
    ...
    "rules": {
      "$ref": "wh0JgBtX7Od5qHPcK0o2rMNrUcS2nFVx9B83wRQTc"
    }
  },
  "required": ["rules"],
  "type": "object",
...
function validate26(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sectionName !== undefined) {
      if (!validate34(data.sectionName, {
...
const schema24 = {
  "items": {
    "$ref": "XNP77j8QHA1C3C4aBJGx141sKO6TGg3vJhojE"
  },
  "maxItems": 16,
  "minItems": 1,
  "type": "array"
...
const schema25 = {
  "properties": {
    "backendRefs": {
      "$ref": "s5hnTk2Gk2n7v4pV4vBsnLcCcw8VlwDuaIWybjY"
    },
    "matches": {
      "$ref": "8Ly9sh0YNROQvHU0gZN4G3BjdxNo2M5d6VkWWhmg"
    }
  },
  "type": "object"
};
...
const schema31 = {
  "items": {
    "$ref": "Sh7zPOqdkkn6rnvoXgmqZ3Hl21WtO9kj6vgUv7igvVg"
  },
  "maxItems": 8,
  "type": "array",
  "nullable": true
...
const schema32 = {
  "properties": {
    "headers": {
      "$ref": "jGMoqoYy6auuI2MdKv0MueHUVAds4ZtKPRPezaYjU"
    },
    "method": {
      "$ref": "MFIhGThVvJEEooadnYxX5UrY6L7aLDpuZHPxKXsFA"
    }
  },
  "type": "object"
};
const schema33 = {
  "items": {
    "$ref": "mL1EbpsN61JEYuUNgluodieLAlQqMFX4jJ5CTTQA0"
  },
  "type": "array",
  "nullable": true
};
const schema34 = {
  "properties": {
    ...
    "type": {
      "$ref": "SxbgC0RHX3ZMnFuBfijyndJQIpZNPPQiKbI0mE38g"
    },
    "value": {
...
const schema10 = {
  "default": "Exact",
  "enum": ["Exact", "RegularExpression", "ImplementationSpecific"],
  "type": "string",
  "nullable": true
};
function validate25(data, {
  ...
  if (!(data === "Exact" || data === "RegularExpression" || data === "ImplementationSpecific")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendRefs !== undefined) {
      if (!validate55(data.backendRefs, {
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate94(data.lastTransitionTime, {
...
function validate91(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.controllerName !== undefined) {
      if (!validate108(data.controllerName, {
...
function validate36(data, {
  ...
  /*# sourceURL="net.gke.io.v1alpha1.TDGRPCRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
