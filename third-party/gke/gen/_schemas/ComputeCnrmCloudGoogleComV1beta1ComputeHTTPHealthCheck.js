...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "ivHBUaUCfnfWhSYNidp255aSWRS4i4obC8WmH8ejzJs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "mpUSvkuT2nnWQ389dcARHZ7iUWHSfqqsTOgdJ9GmU"
    },
    "status": {
      "$ref": "DpFp1Zkfj8xi6WPkXfwN9Qay2ojBbRerb3fcrwtLU"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeHTTPHealthCheck"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "ComputeHTTPHealthCheck")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.checkIntervalSec !== undefined) {
      if (!validate21(data.checkIntervalSec, {
        instancePath: instancePath + "/checkIntervalSec",
        parentData: data,
        parentDataProperty: "checkIntervalSec",
        rootData
      })) {
    ...
    if (data.healthyThreshold !== undefined) {
      if (!validate21(data.healthyThreshold, {
    ...
    if (data.requestPath !== undefined) {
      if (!validate22(data.requestPath, {
        instancePath: instancePath + "/requestPath",
        parentData: data,
        parentDataProperty: "requestPath",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.timeoutSec !== undefined) {
      if (!validate21(data.timeoutSec, {
        instancePath: instancePath + "/timeoutSec",
        parentData: data,
        parentDataProperty: "timeoutSec",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.unhealthyThreshold !== undefined) {
      if (!validate21(data.unhealthyThreshold, {
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeHTTPHealthCheck" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
