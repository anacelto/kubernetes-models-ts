...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "t2BJxcWJtFJhCnImW2S3yVY9icdtxtELniOPoa8Fs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "4D6GrPoVPppOjPTPrUrqafpp3WcmNpdkBt8OfwoQAkg"
    },
    "status": {
  ...
  "$id": "apigee.cnrm.cloud.google.com.v1alpha1.ApigeeInstanceAttachment"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "ApigeeInstanceAttachment")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["environment", "instanceId"],
  "type": "object"
};
const schema6 = {
  "type": "string"
...
function validate23(data, {
  ...
  /*# sourceURL="apigee.cnrm.cloud.google.com.v1alpha1.ApigeeInstanceAttachment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
