...
const schema13 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "70mQPqwX9P5vetmU405giszawGGBQv4XocJjLmsBY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "QK6U5Xr0zeg2jXtMbluZj1FWHNJzfpKr1ccVEJJg"
    },
    "status": {
  ...
  "$id": "pubsub.cnrm.cloud.google.com.v1beta1.PubSubTopic"
};
const schema14 = {
  "type": "string",
...
const schema18 = {
  "properties": {
    ...
    "messageStoragePolicy": {
      "$ref": "u0OJjwIlUqMEkJfWbapAW8hFm9VKK2si0o1yJiDgKE"
    },
    "resourceID": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "schemaSettings": {
      "$ref": "W0vfdtLXZF95D0ojMZpiMYAck3om65ohabGl37dCA"
    }
  },
  "type": "object",
  "nullable": true
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowedPersistenceRegions === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "allowedPersistenceRegions"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.allowedPersistenceRegions !== undefined) {
      if (!validate51(data.allowedPersistenceRegions, {
        instancePath: instancePath + "/allowedPersistenceRegions",
        parentData: data,
        parentDataProperty: "allowedPersistenceRegions",
        rootData
      })) {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.schemaRef !== undefined) {
      if (!validate59(data.schemaRef, {
        instancePath: instancePath + "/schemaRef",
        parentData: data,
        parentDataProperty: "schemaRef",
        rootData
      })) {
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.messageStoragePolicy !== undefined) {
      if (!validate50(data.messageStoragePolicy, {
        instancePath: instancePath + "/messageStoragePolicy",
        parentData: data,
        parentDataProperty: "messageStoragePolicy",
        rootData
      })) {
    ...
    if (data.schemaSettings !== undefined) {
      if (!validate57(data.schemaSettings, {
        instancePath: instancePath + "/schemaSettings",
        parentData: data,
        parentDataProperty: "schemaSettings",
        rootData
      })) {
...
function validate32(data, {
  ...
  /*# sourceURL="pubsub.cnrm.cloud.google.com.v1beta1.PubSubTopic" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
