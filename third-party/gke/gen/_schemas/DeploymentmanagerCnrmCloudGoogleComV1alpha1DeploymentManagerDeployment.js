...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "HyLIDze5MeeRiODHp0Blqx5WFnx2fUeEZRrxbY2YxfI"
    },
    "kind": {
      "$ref": "cTLfbM3szlBzVP6CnggqedwBQ5pV6efricuiInMhQfw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "WfgVpXNiSOscF7nazrkWRJZtlM5vnCp0DbFFy6rQ"
    },
    "status": {
      "$ref": "m67k7JVFWqUlz607FbxRM0KQjHSW41QkB5HsYstcycc"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "deploymentmanager.cnrm.cloud.google.com.v1alpha1.DeploymentManagerDeployment"
};
const schema8 = {
  "type": "string",
  "enum": ["deploymentmanager.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "deploymentmanager.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema9 = {
  "type": "string",
  "enum": ["DeploymentManagerDeployment"]
};
function validate25(data, {
  ...
  if (!(data === "DeploymentManagerDeployment")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "properties": {
    ...
    "target": {
      "$ref": "5MC69MBAqSyiXvANjSj67x5s26BxDAtvcdsw8ErzsHM"
    }
  },
  "required": ["projectRef", "target"],
  "type": "object"
};
const schema6 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    "config": {
      "$ref": "akzI87EGAiJjz7NXvvDoy3M9Nrhs06cjUQuXzIAJw"
    },
    "imports": {
      "$ref": "QL2FHxfn6e8xX2BxT2HpV15TgSeal4Iu14fX78uJo"
    }
  },
  "required": ["config"],
  "type": "object"
...
const schema24 = {
  "items": {
    "$ref": "xDzheRXaXxScj5qeKII91qN6peBd5TD9hi3bFLpHg"
  },
  "type": "array",
  "nullable": true
};
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imports !== undefined) {
      if (!validate59(data.imports, {
        instancePath: instancePath + "/imports",
        parentData: data,
        parentDataProperty: "imports",
        rootData
      })) {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.createPolicy !== undefined) {
      if (!validate21(data.createPolicy, {
        instancePath: instancePath + "/createPolicy",
        parentData: data,
        parentDataProperty: "createPolicy",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.deletePolicy !== undefined) {
      if (!validate21(data.deletePolicy, {
        instancePath: instancePath + "/deletePolicy",
        parentData: data,
        parentDataProperty: "deletePolicy",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deploymentId !== undefined) {
      if (!validate21(data.deploymentId, {
        instancePath: instancePath + "/deploymentId",
        parentData: data,
        parentDataProperty: "deploymentId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="deploymentmanager.cnrm.cloud.google.com.v1alpha1.DeploymentManagerDeployment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
