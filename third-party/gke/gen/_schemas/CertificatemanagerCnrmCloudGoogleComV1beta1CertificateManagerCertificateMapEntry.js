...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "pOZV4Fpmd3T0vpVGZYqhiTHOVJOxY0iDGUEyk0Xa6Q"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "LN7gxqlyyC59HxOC2Ho6AqnPAXZuLYnbFFqS7Lu3Kc"
    },
    "status": {
      "$ref": "KJbR92pBX7uu1nxV62xgS4DDUxItxzmgeQKiBDfdvo0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "certificatemanager.cnrm.cloud.google.com.v1beta1.CertificateManagerCertificateMapEntry"
};
const schema15 = {
  "type": "string",
...
const schema16 = {
  "type": "string",
  "enum": ["CertificateManagerCertificateMapEntry"]
};
function validate41(data, {
  ...
  if (!(data === "CertificateManagerCertificateMapEntry")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  "properties": {
    "certificatesRefs": {
      "$ref": "4Lhf67rBh9m1QNeGTC6nckCaCJ6FP55meQBKiIFvqA"
    },
    "hostname": {
  ...
  "required": ["certificatesRefs", "mapRef", "projectRef"],
  "type": "object"
};
const schema20 = {
  "items": {
...
function validate47(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificatesRefs === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "certificatesRefs"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.mapRef === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "mapRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.certificatesRefs !== undefined) {
      if (!validate48(data.certificatesRefs, {
        instancePath: instancePath + "/certificatesRefs",
        parentData: data,
        parentDataProperty: "certificatesRefs",
        rootData
      })) {
    ...
    if (data.mapRef !== undefined) {
      if (!validate22(data.mapRef, {
        instancePath: instancePath + "/mapRef",
        parentData: data,
        parentDataProperty: "mapRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.matcher !== undefined) {
      if (!validate21(data.matcher, {
        instancePath: instancePath + "/matcher",
        parentData: data,
        parentDataProperty: "matcher",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate38(data, {
  ...
  /*# sourceURL="certificatemanager.cnrm.cloud.google.com.v1beta1.CertificateManagerCertificateMapEntry" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
