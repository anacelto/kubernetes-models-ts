...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "0qfaOKbXikIyBvYr9gwODzeyTQpdlB6NdWweEcu0fo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "bP5bRW9zD1QT49OoW7JgVotEMwQCL24DoItpQRZC4"
    },
    "status": {
      "$ref": "F1pxf25ydDUvUHvheDrFs40or2JWkFksCOYQ10k2zc"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "apigee.cnrm.cloud.google.com.v1alpha1.ApigeeNATAddress"
};
const schema8 = {
  "type": "string",
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate47(data.observedGeneration, {
...
function validate22(data, {
  ...
  /*# sourceURL="apigee.cnrm.cloud.google.com.v1alpha1.ApigeeNATAddress" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
