...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "y1agT8UI5y69Li5cbgaKQohjlQlzjOByftuoNMkYK8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ZCAqiqo3xIZW1hrFGIQ5OgK3tJJiCQdchbXolI9IXvk"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeNetworkPeeringRoutesConfig"
};
const schema16 = {
  "type": "string",
...
const schema17 = {
  "type": "string",
  "enum": ["ComputeNetworkPeeringRoutesConfig"]
};
function validate42(data, {
  ...
  if (!(data === "ComputeNetworkPeeringRoutesConfig")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema20 = {
  ...
  "required": ["exportCustomRoutes", "importCustomRoutes", "networkRef", "projectRef"],
  "type": "object"
};
const schema6 = {
  "type": "boolean"
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.exportCustomRoutes === undefined) {
      const err0 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "exportCustomRoutes"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.importCustomRoutes === undefined) {
      const err1 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "importCustomRoutes"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
...
function validate39(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeNetworkPeeringRoutesConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
