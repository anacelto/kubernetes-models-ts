...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "mzzF5keK4t3UhLH4eSb9NCGp0slJjcybPYukVCFNM"
    },
    "kind": {
      "$ref": "oPYoYpyKS3V7gP8rkdZ8vjSKAXVJRKJMWs5lNV59ebc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "594fQTXxtHVTN9mzZE1KA99IjxNohyjEcp0RTg8"
    },
    "status": {
  ...
  "$id": "networkmanagement.cnrm.cloud.google.com.v1alpha1.NetworkManagementConnectivityTest"
};
const schema9 = {
  "type": "string",
  "enum": ["networkmanagement.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "networkmanagement.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema10 = {
  "type": "string",
  "enum": ["NetworkManagementConnectivityTest"]
};
function validate26(data, {
  ...
  if (!(data === "NetworkManagementConnectivityTest")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    "destination": {
      "$ref": "5bG6oYjzyvrgjm9CBi0b9Vcg4uHTmn3hquojqM91BXo"
    },
    "projectRef": {
    ...
    "source": {
      "$ref": "2fRAC4CqNNhvPRORh5UQMobCbK9sKkP4zkvgvassCPw"
    }
  },
  "required": ["destination", "projectRef", "source"],
  "type": "object"
};
const schema14 = {
  "properties": {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.destination !== undefined) {
      if (!validate33(data.destination, {
    ...
    if (data.relatedProjects !== undefined) {
      if (!validate58(data.relatedProjects, {
        instancePath: instancePath + "/relatedProjects",
        parentData: data,
        parentDataProperty: "relatedProjects",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="networkmanagement.cnrm.cloud.google.com.v1alpha1.NetworkManagementConnectivityTest" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
