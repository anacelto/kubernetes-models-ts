...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "bGuFcQHBQp8MHdAO4cCE5tN1KxmFmrkhdohg29BOiM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "nqqfoqXf8Vu0NCmK4ra7omIKljQ3yrbRnswR7QhGvG0"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeRouterInterface"
};
const schema15 = {
  "type": "string",
...
function validate41(data, {
  ...
  if (!(data === "ComputeRouterInterface")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.interconnectAttachmentRef !== undefined) {
      if (!validate22(data.interconnectAttachmentRef, {
    ...
    if (data.privateIpAddressRef !== undefined) {
      if (!validate22(data.privateIpAddressRef, {
        instancePath: instancePath + "/privateIpAddressRef",
        parentData: data,
        parentDataProperty: "privateIpAddressRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.redundantInterfaceRef !== undefined) {
      if (!validate22(data.redundantInterfaceRef, {
        instancePath: instancePath + "/redundantInterfaceRef",
        parentData: data,
        parentDataProperty: "redundantInterfaceRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.vpnTunnelRef !== undefined) {
      if (!validate22(data.vpnTunnelRef, {
        instancePath: instancePath + "/vpnTunnelRef",
        parentData: data,
        parentDataProperty: "vpnTunnelRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate38(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeRouterInterface" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
