...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "F4CPIg2EMpTu9CnMuk5Ewaq4nHrgZGlmouacmk6mE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "GBBnQal3w5EkN0BN4gI1OGc9BHyzWnl8vX8LdRfDWaY"
    },
    "status": {
  ...
  "$id": "healthcare.cnrm.cloud.google.com.v1alpha1.HealthcareConsentStore"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "HealthcareConsentStore")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultConsentTtl !== undefined) {
      if (!validate21(data.defaultConsentTtl, {
        instancePath: instancePath + "/defaultConsentTtl",
        parentData: data,
        parentDataProperty: "defaultConsentTtl",
        rootData
      })) {
    ...
    if (data.enableConsentCreateOnUpdate !== undefined) {
      if (!validate35(data.enableConsentCreateOnUpdate, {
        instancePath: instancePath + "/enableConsentCreateOnUpdate",
        parentData: data,
        parentDataProperty: "enableConsentCreateOnUpdate",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="healthcare.cnrm.cloud.google.com.v1alpha1.HealthcareConsentStore" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
