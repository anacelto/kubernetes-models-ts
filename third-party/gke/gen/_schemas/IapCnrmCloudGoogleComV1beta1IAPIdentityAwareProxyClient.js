...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "csoIdn1rmWObSzQNt7IfZhiEDuhCWlRG6JUoqT1kvs"
    },
    "kind": {
      "$ref": "Vmbc6WKzI30DrVLaUmzxROTDF4ydEOP8Zn17B4damNs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "t8uocn9q9vYinQh6RWr8LxV6JO0igr9tyUS9pdo"
    },
    "status": {
      "$ref": "vL3o74z36LGKZ7DTqJUUkiFB9LX7dSaQTTtNL61zFZM"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "iap.cnrm.cloud.google.com.v1beta1.IAPIdentityAwareProxyClient"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "iap.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate25(data, {
  ...
  if (!(data === "IAPIdentityAwareProxyClient")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.brandRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "brandRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.brandRef !== undefined) {
      if (!validate32(data.brandRef, {
        instancePath: instancePath + "/brandRef",
        parentData: data,
        parentDataProperty: "brandRef",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="iap.cnrm.cloud.google.com.v1beta1.IAPIdentityAwareProxyClient" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
