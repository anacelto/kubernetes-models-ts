...
const schema7 = {
  ...
  "properties": {
    "spec": {
      "$ref": "a9ypmZr6CjPtd7fV5w3zhEcYak1M4U4HVK2X7oUu1w"
    },
    "status": {
      "$ref": "v2ezyFZ0zS2vQIHV1Jy9kQgtGYJqSG7q6nOsVMZCpw4"
    },
    "apiVersion": {
      "$ref": "cWZBmpNJyNTAHnKYABjEJXL5JvzzeCvYKY7MtSWJV8"
    },
    "kind": {
      "$ref": "JxBEMIMdNVPX9PETBgo8jxmv1FpWLZ9akyN8r7mL8"
    },
    "metadata": {
  ...
  "$id": "net.gke.io.v1alpha1.ServiceExport"
};
const schema8 = {
  "properties": {
    "superclusterIP": {
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.superclusterIP !== undefined) {
      if (!validate21(data.superclusterIP, {
        instancePath: instancePath + "/superclusterIP",
        parentData: data,
        parentDataProperty: "superclusterIP",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="net.gke.io.v1alpha1.ServiceExport" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
