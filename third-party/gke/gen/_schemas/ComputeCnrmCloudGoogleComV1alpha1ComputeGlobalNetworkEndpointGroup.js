...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "1hxyjhawfLVMWcm94IrjPNyCD1Zj3k8ieqiGuFIKEY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "dFKVTLjkQirZE02RrflXusUjdncoHLeoCR8qEDYAqQY"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeGlobalNetworkEndpointGroup"
};
const schema9 = {
  "type": "string",
...
const schema10 = {
  "type": "string",
  "enum": ["ComputeGlobalNetworkEndpointGroup"]
};
function validate26(data, {
  ...
  if (!(data === "ComputeGlobalNetworkEndpointGroup")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["networkEndpointType", "projectRef"],
  "type": "object"
};
const schema7 = {
  "type": "integer",
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.networkEndpointType === undefined) {
      const err0 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "networkEndpointType"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.defaultPort !== undefined) {
      if (!validate22(data.defaultPort, {
        instancePath: instancePath + "/defaultPort",
        parentData: data,
        parentDataProperty: "defaultPort",
        rootData
      })) {
    ...
    if (data.networkEndpointType !== undefined) {
      if (!validate34(data.networkEndpointType, {
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeGlobalNetworkEndpointGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
