...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "2Qj5TCrcCcWt24rk2dc0iPgXjXZdjBy14m1dFLdTkk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "dj61ZIFV9n91GJU69dmMH3goGULa4Rrr9dCb85sr6sk"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeNodeGroup"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    "autoscalingPolicy": {
      "$ref": "DIAq9S4LP42d1hX4s8uNhZSwSTp5wGGQenDv5I30LM"
    },
    "initialSize": {
    ...
    "maintenanceWindow": {
      "$ref": "E7XV8vsI7HhgvtmLoYuzVHCnfKESx5lIcqmaOaHhJM"
    },
    "nodeTemplateRef": {
    ...
    "shareSettings": {
      "$ref": "4QhBvsEm4LnSX5WOBFglZ1Ui5ldk2pcYniTXr6RJjxA"
    },
    "size": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    },
...
const schema24 = {
  "properties": {
    "projectMap": {
      "$ref": "YAC4u9vICyFK0rOKdts9jxoleMUVYchPCdnJkm2VI"
    },
    "shareType": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    }
...
const schema25 = {
  "items": {
    "$ref": "0wFXRrRq1Py1e3OSVvGIO5li5qaQruOyvWaHwQkNArg"
  },
  "type": "array",
  "nullable": true
};
...
function validate64(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.idRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "idRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.projectIdRef === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "projectIdRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.idRef !== undefined) {
      if (!validate23(data.idRef, {
        instancePath: instancePath + "/idRef",
        parentData: data,
        parentDataProperty: "idRef",
        rootData
      })) {
    ...
    if (data.projectIdRef !== undefined) {
      if (!validate23(data.projectIdRef, {
        instancePath: instancePath + "/projectIdRef",
        parentData: data,
        parentDataProperty: "projectIdRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate62(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.projectMap !== undefined) {
      if (!validate63(data.projectMap, {
        instancePath: instancePath + "/projectMap",
        parentData: data,
        parentDataProperty: "projectMap",
        rootData
      })) {
    ...
    if (data.shareType !== undefined) {
      if (!validate39(data.shareType, {
        instancePath: instancePath + "/shareType",
        parentData: data,
        parentDataProperty: "shareType",
        rootData
      })) {
        vErrors = vErrors === null ? validate39.errors : vErrors.concat(validate39.errors);
        errors = vErrors.length;
...
function validate49(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nodeTemplateRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "nodeTemplateRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.autoscalingPolicy !== undefined) {
      if (!validate50(data.autoscalingPolicy, {
    ...
    if (data.initialSize !== undefined) {
      if (!validate21(data.initialSize, {
        instancePath: instancePath + "/initialSize",
        parentData: data,
        parentDataProperty: "initialSize",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.maintenancePolicy !== undefined) {
      if (!validate22(data.maintenancePolicy, {
    ...
    if (data.maintenanceWindow !== undefined) {
      if (!validate57(data.maintenanceWindow, {
    ...
    if (data.nodeTemplateRef !== undefined) {
      if (!validate23(data.nodeTemplateRef, {
        instancePath: instancePath + "/nodeTemplateRef",
        parentData: data,
        parentDataProperty: "nodeTemplateRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.shareSettings !== undefined) {
      if (!validate62(data.shareSettings, {
        instancePath: instancePath + "/shareSettings",
        parentData: data,
        parentDataProperty: "shareSettings",
        rootData
      })) {
...
function validate40(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeNodeGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
