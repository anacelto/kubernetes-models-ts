...
const schema10 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "HaneeJ12nXdnKLzuAQkxqB4jTf1DH42BoTIkwDY"
    },
    "kind": {
      "$ref": "B3CZaEU4vncbEmYjRmswlbpcwxp2mAPpmEX709iSQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "zloW997j2bJLMkAhxxg0MNgZ1g358xE8kcTLPW6t0"
    },
    "status": {
  ...
  "$id": "bigquerydatatransfer.cnrm.cloud.google.com.v1alpha1.BigQueryDataTransferConfig"
};
const schema11 = {
  "type": "string",
  "enum": ["bigquerydatatransfer.cnrm.cloud.google.com/v1alpha1"]
};
function validate26(data, {
  ...
  if (!(data === "bigquerydatatransfer.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "type": "string",
  "enum": ["BigQueryDataTransferConfig"]
};
function validate28(data, {
  ...
  if (!(data === "BigQueryDataTransferConfig")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "properties": {
    ...
    "emailPreferences": {
      "$ref": "WdZC5WWimV6McZp6HCdb3STp7FzZ2tERU35qcYLrdY"
    },
    "location": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    ...
    "scheduleOptions": {
      "$ref": "hxlHQiiNB7eujnlIWXXbbgOX6NUfQCpMs0PAPkwxE"
    },
    "sensitiveParams": {
      "$ref": "vRNULhWFYjH2VpTXOCmD57iHdaXGVhOt0HtpPC4aYoU"
    },
    "serviceAccountName": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
  },
  "required": ["dataSourceId", "displayName", "params", "projectRef"],
  "type": "object"
};
const schema9 = {
  "type": "integer",
...
function validate40(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.enableFailureEmail === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "enableFailureEmail"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.enableFailureEmail !== undefined) {
      if (!validate41(data.enableFailureEmail, {
        instancePath: instancePath + "/enableFailureEmail",
        parentData: data,
        parentDataProperty: "enableFailureEmail",
        rootData
      })) {
...
function validate68(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.disableAutoScheduling !== undefined) {
      if (!validate23(data.disableAutoScheduling, {
        instancePath: instancePath + "/disableAutoScheduling",
        parentData: data,
        parentDataProperty: "disableAutoScheduling",
        rootData
      })) {
...
function validate84(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretKeyRef !== undefined) {
      if (!validate85(data.secretKeyRef, {
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.secretAccessKey !== undefined) {
      if (!validate74(data.secretAccessKey, {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataRefreshWindowDays !== undefined) {
      if (!validate24(data.dataRefreshWindowDays, {
        instancePath: instancePath + "/dataRefreshWindowDays",
        parentData: data,
        parentDataProperty: "dataRefreshWindowDays",
        rootData
      })) {
    ...
    if (data.dataSourceId !== undefined) {
      if (!validate21(data.dataSourceId, {
        instancePath: instancePath + "/dataSourceId",
        parentData: data,
        parentDataProperty: "dataSourceId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.destinationDatasetId !== undefined) {
      if (!validate22(data.destinationDatasetId, {
        instancePath: instancePath + "/destinationDatasetId",
        parentData: data,
        parentDataProperty: "destinationDatasetId",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.emailPreferences !== undefined) {
      if (!validate40(data.emailPreferences, {
        instancePath: instancePath + "/emailPreferences",
        parentData: data,
        parentDataProperty: "emailPreferences",
        rootData
      })) {
    ...
    if (data.notificationPubsubTopic !== undefined) {
      if (!validate22(data.notificationPubsubTopic, {
        instancePath: instancePath + "/notificationPubsubTopic",
        parentData: data,
        parentDataProperty: "notificationPubsubTopic",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.scheduleOptions !== undefined) {
      if (!validate68(data.scheduleOptions, {
        instancePath: instancePath + "/scheduleOptions",
        parentData: data,
        parentDataProperty: "scheduleOptions",
        rootData
      })) {
    ...
    if (data.sensitiveParams !== undefined) {
      if (!validate73(data.sensitiveParams, {
        instancePath: instancePath + "/sensitiveParams",
        parentData: data,
        parentDataProperty: "sensitiveParams",
        rootData
      })) {
...
function validate25(data, {
  ...
  /*# sourceURL="bigquerydatatransfer.cnrm.cloud.google.com.v1alpha1.BigQueryDataTransferConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
