...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "xZ9BVxNVX6FCb1ZwgHPEae4FLDqWG4pXrrv4rQy85oE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "eRwpD2vn68TQrkwnT5lyT9hIfS1iVYX7BvA76hE0PE0"
    },
    "status": {
  ...
  "$id": "resourcemanager.cnrm.cloud.google.com.v1beta1.ResourceManagerLien"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.restrictions !== undefined) {
      if (!validate55(data.restrictions, {
        instancePath: instancePath + "/restrictions",
        parentData: data,
        parentDataProperty: "restrictions",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="resourcemanager.cnrm.cloud.google.com.v1beta1.ResourceManagerLien" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
