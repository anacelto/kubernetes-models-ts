...
const schema18 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Dh5dJMh57KPEatlfCLRfKrru40PUJAaUT3GDBZQG7Ag"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "1lFLH482VtpqkocxmikxHTk2GCNR6XcBMV9oVgHGYQ"
    },
    "status": {
  ...
  "$id": "networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesTLSRoute"
};
const schema19 = {
  "type": "string",
...
function validate47(data, {
  ...
  if (!(data === "NetworkServicesTLSRoute")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema23 = {
  "properties": {
    ...
    "rules": {
      "$ref": "hfCPwJFiiOjHsZA0HQMmzzbVwaVcdRXkO403zujOg"
    }
  },
...
const schema24 = {
  "items": {
    "$ref": "ecmsx6IXIaPeogivAdJrbIyVk0JO33r1mhbBmuIc"
  },
  "type": "array"
};
const schema25 = {
  "properties": {
    "action": {
      "$ref": "MZptVuyTmLI70jt1BmLlVSLkDdy31Q6RYrcIX9KU"
    },
    "matches": {
      "$ref": "FzypguIJE4em645VfiiomWWn9tXDKztcFrz7Nwyg"
    }
  },
...
const schema26 = {
  "properties": {
    "destinations": {
      "$ref": "9dnE8EixQGsHPPtpPleVMjpAwvXhckIgqUaS0upxl8w"
    }
  },
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.destinations !== undefined) {
      if (!validate62(data.destinations, {
...
const schema30 = {
  "items": {
    "$ref": "i2KPHK36j9F6xCpeQLsVXu5HK7gJEfdCQLervIMvM4"
  },
  "type": "array"
};
const schema31 = {
...
function validate71(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.alpn !== undefined) {
      if (!validate41(data.alpn, {
        instancePath: instancePath + "/alpn",
        parentData: data,
        parentDataProperty: "alpn",
        rootData
      })) {
    ...
    if (data.sniHost !== undefined) {
      if (!validate41(data.sniHost, {
        instancePath: instancePath + "/sniHost",
        parentData: data,
        parentDataProperty: "sniHost",
        rootData
      })) {
        vErrors = vErrors === null ? validate41.errors : vErrors.concat(validate41.errors);
        errors = vErrors.length;
...
function validate44(data, {
  ...
  /*# sourceURL="networkservices.cnrm.cloud.google.com.v1beta1.NetworkServicesTLSRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
