...
const schema10 = {
  ...
  "properties": {
    "spec": {
      "$ref": "vtuWRX6vQ48I5Y8LLoFbFfqWhaNXPk5TIRW7DSQNN8"
    },
    "status": {
      "$ref": "wnCl8zCvz1PLbyEivJTcktRgDZuzOGT9FYulvrA2T8w"
    },
    "apiVersion": {
      "$ref": "If3JcX6Lu0mOC669VotNfjUi8t6Kgp0D7NUqsDSD4BA"
    },
    "kind": {
      "$ref": "09E7GiroPfRC9rvQnahGGN3DNOCskpydTbjwQAZBQY"
    },
    "metadata": {
  ...
  "$id": "autoscaling.gke.io.v1beta1.MultidimPodAutoscaler"
};
const schema11 = {
  "properties": {
    "constraints": {
      "$ref": "VArX72ESIkyv6BQTqN32tCnQjsBiIKSaQNiTh3L1ug"
    },
    "goals": {
      "$ref": "OyVFndTextCyEqX2DtWqzaueDOuovEETzNNmW8pNJlQ"
    },
    "policy": {
      "$ref": "JdptANVkcWqZEZmONERbOQ8wo2rSnMQgLFEfjj97Gw"
    },
    "scaleTargetRef": {
      "$ref": "hcDTLkCT5mXTZqoze1unZGSabcfNXFlreQV2Lpuzg"
    }
  },
  "required": ["scaleTargetRef", "goals", "constraints"],
  "type": "object"
};
const schema12 = {
  "properties": {
    "container": {
      "$ref": "uG4kEB2Bba1SHRba0rzKcUEmHHorQxGrEbCalpT368"
    },
    "containerControlledResources": {
      "$ref": "Axkja3nFxZbJr0WKVDdVNxpBMl0W2FG5MRhO1swxE"
    },
    "global": {
      "$ref": "u0ifgKTIJvw3BZaxwReCa6k2WRNHGm7bWFs3h7gBqAE"
    },
    "pod": {
      "$ref": "UlbeVsG6bzsafv0yevrsXHGOi2EHbKVFM4wZUkiS5S8"
    }
  },
  "required": ["containerControlledResources"],
  "type": "object"
};
const schema13 = {
  "items": {
    "$ref": "AS7QEk36TEPE5kC1LU5EYEOWLZNh3xFKrX3bM8OOs"
  },
  "type": "array",
  "nullable": true
};
const schema14 = {
  "properties": {
    ...
    "requests": {
      "$ref": "E7TKpb3QDrclcqnBOMmyr8APdHwzlwhQIkT3QU4N8"
    }
  },
  "type": "object"
};
...
const schema15 = {
  "items": {
    "$ref": "lvoLnsPoi4ba2lUBzKIpl8CMqyy8i4Dkdcase0CkBEI"
  },
  "type": "array"
};
const schema16 = {
...
const schema17 = {
  "properties": {
    ...
    "minReplicas": {
      "$ref": "dQ8RCynVCpuRRmU00zAiLAAzsBQvZXhh0M1eLzJW0"
    },
    "requests": {
      "$ref": "E7TKpb3QDrclcqnBOMmyr8APdHwzlwhQIkT3QU4N8"
    }
...
function validate40(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.minReplicas !== undefined) {
      if (!validate43(data.minReplicas, {
...
function validate29(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.containerControlledResources === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "containerControlledResources"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.containerControlledResources !== undefined) {
      if (!validate36(data.containerControlledResources, {
        instancePath: instancePath + "/containerControlledResources",
        parentData: data,
        parentDataProperty: "containerControlledResources",
        rootData
      })) {
...
const schema21 = {
  "properties": {
    "metrics": {
      "$ref": "NdvSKkvyS3VLKpZ2KvoDCEjJfH4bRExH43vojnSEu4"
    }
  },
  "required": ["metrics"],
  "type": "object"
...
const schema22 = {
  "items": {
    "$ref": "3NHZJ7JjakRdrriKDaFTCV2NWgSYEts651TDEBILc"
  },
  "type": "array"
};
const schema23 = {
  "properties": {
    "resource": {
      "$ref": "bEFyH5aubMnwFhG4BnUuIPO7VLAYA8361IDm0ncn6o"
    },
    "type": {
      "$ref": "TLBnAIXYZnnIcXWxEQjMZTPmbrR9FRkYYC46a1Qd8"
    }
  },
...
const schema24 = {
  "properties": {
    "name": {
      "$ref": "RSyJB3mKlGEFYS0ihvqhfQ09MJrwmcDJ8yYBpDorvA"
    },
    "target": {
      "$ref": "uU7aoXHr4s43ygFFkKwa2Ao7KJXiCtgNF2aOPdcIs"
    }
  },
...
const schema26 = {
  "properties": {
    ...
    "type": {
      "$ref": "rZP5a2rwVaPpdU15A8NtuZ7gTZrOvI2dGB3Eqw7PAI"
    },
    "value": {
      "$ref": "PV5SIH4Pb4Rd3cOKB0TmpocWXJ4M8i9zrFifAtVgtUQ"
    }
...
function validate61(data, {
  ...
  if (!(data === "Utilization" || data === "Value" || data === "AverageValue")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.averageUtilization !== undefined) {
      if (!validate58(data.averageUtilization, {
...
const schema30 = {
  "properties": {
    "updateMode": {
      "$ref": "GEZTJf9zZBD8XIto7AJL9nFSU5SvuXrhHcnwr03Ocw8"
    }
  },
  "type": "object",
  "nullable": true
...
function validate28(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.constraints !== undefined) {
      if (!validate29(data.constraints, {
    ...
    if (data.goals !== undefined) {
      if (!validate51(data.goals, {
        instancePath: instancePath + "/goals",
        parentData: data,
        parentDataProperty: "goals",
        rootData
      })) {
    ...
    if (data.scaleTargetRef !== undefined) {
      if (!validate75(data.scaleTargetRef, {
...
const schema33 = {
  "type": "string",
  "enum": ["autoscaling.gke.io/v1beta1"]
};
function validate82(data, {
  ...
  if (!(data === "autoscaling.gke.io/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate27(data, {
  ...
  /*# sourceURL="autoscaling.gke.io.v1beta1.MultidimPodAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
