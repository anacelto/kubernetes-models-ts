...
const schema10 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "SlI2U8FuqeeKQS36nTPZDvpBY5o65efakv292C4adhQ"
    },
    "kind": {
      "$ref": "O1k9HKlsW6V2FSf2jsJZSzA1faLHZ3ZwOkI0O4wWfE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "R6lEz6KMSFVPNbjnFSuYpCcC7pslh2lMtkcu9SeY"
    },
    "status": {
      "$ref": "YJgXaGjLQPYSdBSpZpoqWmGVL5ZjeYBIS6830AE5EU"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "alloydb.cnrm.cloud.google.com.v1alpha1.AlloyDBInstance"
};
const schema11 = {
  "type": "string",
  "enum": ["alloydb.cnrm.cloud.google.com/v1alpha1"]
};
function validate27(data, {
  ...
  if (!(data === "alloydb.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "properties": {
    ...
    "machineConfig": {
      "$ref": "rwbdPtkhxF1Nb7wTenzcSdfajLpisJbbf7x9Tw7mFs"
    },
    "readPoolConfig": {
      "$ref": "mOL1NH7w1Rbl9TyqOyJbGycZ2tF0pgppiC0s8HhJgs"
    },
    "resourceID": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
  },
  "required": ["clusterRef", "instanceType"],
  "type": "object"
};
const schema7 = {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cpuCount !== undefined) {
      if (!validate25(data.cpuCount, {
        instancePath: instancePath + "/cpuCount",
        parentData: data,
        parentDataProperty: "cpuCount",
        rootData
      })) {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.availabilityType !== undefined) {
      if (!validate21(data.availabilityType, {
        instancePath: instancePath + "/availabilityType",
        parentData: data,
        parentDataProperty: "availabilityType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.databaseFlags !== undefined) {
      if (!validate22(data.databaseFlags, {
        instancePath: instancePath + "/databaseFlags",
        parentData: data,
        parentDataProperty: "databaseFlags",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.gceZone !== undefined) {
      if (!validate21(data.gceZone, {
        instancePath: instancePath + "/gceZone",
        parentData: data,
        parentDataProperty: "gceZone",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.instanceType !== undefined) {
      if (!validate23(data.instanceType, {
        instancePath: instancePath + "/instanceType",
        parentData: data,
        parentDataProperty: "instanceType",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.machineConfig !== undefined) {
      if (!validate59(data.machineConfig, {
        instancePath: instancePath + "/machineConfig",
        parentData: data,
        parentDataProperty: "machineConfig",
        rootData
      })) {
    ...
    if (data.readPoolConfig !== undefined) {
      if (!validate62(data.readPoolConfig, {
        instancePath: instancePath + "/readPoolConfig",
        parentData: data,
        parentDataProperty: "readPoolConfig",
        rootData
      })) {
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.reconciling !== undefined) {
      if (!validate81(data.reconciling, {
        instancePath: instancePath + "/reconciling",
        parentData: data,
        parentDataProperty: "reconciling",
        rootData
      })) {
...
function validate26(data, {
  ...
  /*# sourceURL="alloydb.cnrm.cloud.google.com.v1alpha1.AlloyDBInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
