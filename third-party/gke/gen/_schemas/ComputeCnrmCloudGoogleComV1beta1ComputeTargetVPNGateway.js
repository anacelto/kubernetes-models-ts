...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "315bUskXsJlx9rkbrDSoM2bgp4IS6jzdSSFfJvAA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "zizFRFq2Q8M1Jxj2xmwbnOrYJOTaUkDhlB0Fkd2qx2s"
    },
    "status": {
      "$ref": "HjewTr2l9t91tgAWE3cSm2KlXfZu9ezcjA6KEo"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeTargetVPNGateway"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "ComputeTargetVPNGateway")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.gatewayId !== undefined) {
      if (!validate22(data.gatewayId, {
        instancePath: instancePath + "/gatewayId",
        parentData: data,
        parentDataProperty: "gatewayId",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeTargetVPNGateway" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
