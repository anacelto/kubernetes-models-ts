...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "gprOQ5T0J89biYsOd5LhZmi2hRrxzAyGEXIsL8F3DpM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ED7EqXUE2iNJo1f2tuqbR9HpNLtbJPx6SCXoYbKU6g"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeNetworkEndpoint"
};
const schema16 = {
  "type": "string",
...
function validate42(data, {
  ...
  if (!(data === "ComputeNetworkEndpoint")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema20 = {
  ...
  "required": ["ipAddress", "networkEndpointGroupRef", "projectRef", "zone"],
  "type": "object"
};
const schema21 = {
  "oneOf": [{
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.instanceRef !== undefined) {
      if (!validate49(data.instanceRef, {
    ...
    if (data.networkEndpointGroupRef !== undefined) {
      if (!validate32(data.networkEndpointGroupRef, {
...
function validate39(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeNetworkEndpoint" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
