...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "rnSiYxPT6zSPAHlMbMVYzchxgQOnCuWdBJrjFDdrdQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "d5JUcVLYBt8okR2XEGEK57HKglaLenkH8uAo3qhVX3U"
    },
    "status": {
  ...
  "$id": "healthcare.cnrm.cloud.google.com.v1alpha1.HealthcareDICOMStore"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    ...
    "streamConfigs": {
      "$ref": "38eDpF8Xd5Dk1LzB6cUIMcOHSUeQN6RZucZHwZA"
    }
  },
  "required": ["dataset"],
  "type": "object"
...
const schema15 = {
  "items": {
    "$ref": "Ma0AR6j2epANYYHp7gFsUPURSd8hdwC15fL7GDnxA60"
  },
  "type": "array",
  "nullable": true
};
const schema16 = {
  "properties": {
    "bigqueryDestination": {
      "$ref": "8bDV3kV3AP7xGveJkbYXG8MJt7ZgHVhuOwxY0wz7w"
    }
  },
...
function validate40(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.tableUri === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "tableUri"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.tableUri !== undefined) {
      if (!validate21(data.tableUri, {
        instancePath: instancePath + "/tableUri",
        parentData: data,
        parentDataProperty: "tableUri",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.bigqueryDestination !== undefined) {
      if (!validate40(data.bigqueryDestination, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.streamConfigs !== undefined) {
      if (!validate38(data.streamConfigs, {
...
function validate23(data, {
  ...
  /*# sourceURL="healthcare.cnrm.cloud.google.com.v1alpha1.HealthcareDICOMStore" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
