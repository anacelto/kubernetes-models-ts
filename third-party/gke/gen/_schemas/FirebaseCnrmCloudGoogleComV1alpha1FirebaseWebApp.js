...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "PoKOhvo9ZA6ShZiHbOKm6UGiiIdyXRAiwC9SvlK0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "3AvgJMGRiUVU8ET1fUmv5eyFHr0wsmC8sd6GJGVEvOY"
    },
    "status": {
      "$ref": "JPIWI4rYe71ysdw518qMHoKbruE5fKqCIwGZuARtDKo"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "firebase.cnrm.cloud.google.com.v1alpha1.FirebaseWebApp"
};
const schema9 = {
  "type": "string",
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.appUrls !== undefined) {
      if (!validate41(data.appUrls, {
        instancePath: instancePath + "/appUrls",
        parentData: data,
        parentDataProperty: "appUrls",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="firebase.cnrm.cloud.google.com.v1alpha1.FirebaseWebApp" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
