...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "qXaPONYntH195EZRl6oX8xbfcwgoTWZSONMPHq4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Q44wbq7SKqdKmBZkssFXaju1lYicAOVxLK0aL7oRhPs"
    },
    "status": {
  ...
  "$id": "accesscontextmanager.cnrm.cloud.google.com.v1alpha1.AccessContextManagerAccessLevelCondition"
};
const schema11 = {
  "type": "string",
...
const schema12 = {
  "type": "string",
  "enum": ["AccessContextManagerAccessLevelCondition"]
};
function validate29(data, {
  ...
  if (!(data === "AccessContextManagerAccessLevelCondition")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "properties": {
    ...
    "devicePolicy": {
      "$ref": "Wy2tMNDlHQfCY6MUl2xj0WRrjS05IneOMjMe7MPef2Y"
    },
    "ipSubnetworks": {
...
const schema23 = {
  "properties": {
    ...
    "osConstraints": {
      "$ref": "xhFETa0bBdEzM1OJ3moYehEiQ42LoodjXpgaVOEXaXA"
    },
...
const schema24 = {
  "items": {
    "$ref": "5gLa8Wlw6SFuKKA1jQOPUnpkn1g22sznXmTO2HhtU"
  },
  "type": "array",
  "nullable": true
};
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.osConstraints !== undefined) {
      if (!validate56(data.osConstraints, {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.accessLevelRef !== undefined) {
      if (!validate36(data.accessLevelRef, {
    ...
    if (data.devicePolicy !== undefined) {
      if (!validate53(data.devicePolicy, {
    ...
    if (data.requiredAccessLevels !== undefined) {
      if (!validate22(data.requiredAccessLevels, {
...
function validate26(data, {
  ...
  /*# sourceURL="accesscontextmanager.cnrm.cloud.google.com.v1alpha1.AccessContextManagerAccessLevelCondition" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
