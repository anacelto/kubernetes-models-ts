...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "bMCIhWbOEYjEiD7jLjZtiJAT6l4Jr1KUw8nQNQNowQ"
    },
    "kind": {
      "$ref": "yQwUeKuIEsNGnXxHt1pjXJu1u2SETwJ682Do856FV0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "GZRlGgrkSVfyUcDpNZgYYAE4heysscyaHf6JEU4KGY"
    },
    "status": {
  ...
  "$id": "pubsublite.cnrm.cloud.google.com.v1beta1.PubSubLiteReservation"
};
const schema8 = {
  "type": "string",
  "enum": ["pubsublite.cnrm.cloud.google.com/v1beta1"]
};
function validate23(data, {
  ...
  if (!(data === "pubsublite.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  ...
  "required": ["projectRef", "region", "throughputCapacity"],
  "type": "object"
};
const schema13 = {
  "oneOf": [{
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.throughputCapacity === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "throughputCapacity"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.throughputCapacity !== undefined) {
      if (!validate52(data.throughputCapacity, {
        instancePath: instancePath + "/throughputCapacity",
        parentData: data,
        parentDataProperty: "throughputCapacity",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="pubsublite.cnrm.cloud.google.com.v1beta1.PubSubLiteReservation" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
