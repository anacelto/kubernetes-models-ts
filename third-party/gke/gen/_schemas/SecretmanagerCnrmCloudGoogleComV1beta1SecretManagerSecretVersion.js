...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "0OzALYSUk8IUrtOVMn6FHCEgy7iMaHTPWwXbg580bPQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "3y44wtQa172E1sKAqY3WXVUm1rCKJ0Xe8T5hlGoqv4"
    },
    "status": {
      "$ref": "buITvrqsEjkFcTdvOhpGlkcCTZBUqEKMP9FzuawgI"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "secretmanager.cnrm.cloud.google.com.v1beta1.SecretManagerSecretVersion"
};
const schema10 = {
  "type": "string",
...
function validate27(data, {
  ...
  if (!(data === "SecretManagerSecretVersion")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.isSecretDataBase64 !== undefined) {
      if (!validate21(data.isSecretDataBase64, {
        instancePath: instancePath + "/isSecretDataBase64",
        parentData: data,
        parentDataProperty: "isSecretDataBase64",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.secretData !== undefined) {
      if (!validate38(data.secretData, {
        instancePath: instancePath + "/secretData",
        parentData: data,
        parentDataProperty: "secretData",
        rootData
      })) {
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.destroyTime !== undefined) {
      if (!validate22(data.destroyTime, {
        instancePath: instancePath + "/destroyTime",
        parentData: data,
        parentDataProperty: "destroyTime",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="secretmanager.cnrm.cloud.google.com.v1beta1.SecretManagerSecretVersion" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
