...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "tkyc2myqdwSnOl6vTnM26lEPKWegL1cgbrrBSrZvuoc"
    },
    "metadata": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeSharedVPCHostProject"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "ComputeSharedVPCHostProject")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeSharedVPCHostProject" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
