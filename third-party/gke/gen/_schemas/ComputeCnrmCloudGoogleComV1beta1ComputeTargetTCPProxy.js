...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Pu3qrMdipgq0ThhR526C4XMBKbrJtIK2WlSCr719gZw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "BRWl8AkSDp5rbQ76dNzWhdOIyiOIYEcxS9AU4tD8yo"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeTargetTCPProxy"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.backendServiceRef !== undefined) {
      if (!validate33(data.backendServiceRef, {
    ...
    if (data.proxyBind !== undefined) {
      if (!validate50(data.proxyBind, {
        instancePath: instancePath + "/proxyBind",
        parentData: data,
        parentDataProperty: "proxyBind",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeTargetTCPProxy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
