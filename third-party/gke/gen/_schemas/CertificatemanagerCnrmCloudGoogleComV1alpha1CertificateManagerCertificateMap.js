...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "UuuXs3cADPYvjfD2drZC4eKYmJHYKTtjLPUbmI9I"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "IhYYC0kCW0AUBfdQMnEWiyOYn3puyfWkGxRCr8HyE"
    },
    "status": {
      "$ref": "PwVEoqAurcY2tlDDwls3NvAeovmsyhSTsV0HtYTk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "certificatemanager.cnrm.cloud.google.com.v1alpha1.CertificateManagerCertificateMap"
};
const schema8 = {
  "type": "string",
...
const schema9 = {
  "type": "string",
  "enum": ["CertificateManagerCertificateMap"]
};
function validate25(data, {
  ...
  if (!(data === "CertificateManagerCertificateMap")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema20 = {
  "properties": {
    ...
    "gclbTargets": {
      "$ref": "yDq3VkVquft2zxK32Td81cIEV6YpNnJrNnpnop24c0"
    },
    "observedGeneration": {
...
const schema23 = {
  "items": {
    "$ref": "mV24eLmWTK2psMgJNNO7LGiAcrF0YdBmYxXwpSf2M"
  },
  "type": "array",
  "nullable": true
};
const schema24 = {
  "properties": {
    "ipConfigs": {
      "$ref": "MG9Y4SNK7moMZiWgKxzihPePAIlk8cZNS1mHQKc"
    },
    "targetHttpsProxy": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema25 = {
  "items": {
    "$ref": "s9L0n7nOIKFkeQbHacInI1skHXezztCZ64bhABd1Ls"
  },
  "type": "array",
  "nullable": true
};
...
function validate63(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ipConfigs !== undefined) {
      if (!validate64(data.ipConfigs, {
        instancePath: instancePath + "/ipConfigs",
        parentData: data,
        parentDataProperty: "ipConfigs",
        rootData
      })) {
    ...
    if (data.targetHttpsProxy !== undefined) {
      if (!validate21(data.targetHttpsProxy, {
        instancePath: instancePath + "/targetHttpsProxy",
        parentData: data,
        parentDataProperty: "targetHttpsProxy",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.targetSslProxy !== undefined) {
      if (!validate21(data.targetSslProxy, {
        instancePath: instancePath + "/targetSslProxy",
        parentData: data,
        parentDataProperty: "targetSslProxy",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.gclbTargets !== undefined) {
      if (!validate62(data.gclbTargets, {
        instancePath: instancePath + "/gclbTargets",
        parentData: data,
        parentDataProperty: "gclbTargets",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="certificatemanager.cnrm.cloud.google.com.v1alpha1.CertificateManagerCertificateMap" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
