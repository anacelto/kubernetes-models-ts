...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "qMtMSM9699uj9eokjAmx2fNn4xmlInHYbtqZsdyHt8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "sj3pkiMDuVhE7RF1Z8Z9iyL51epFZeMOoWB40K4p3Q"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1alpha1.IAPPolicy"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    "default": {
      "$ref": "Mj93eWW7PYOPDenmGZw0Px9EyGZScyQATV3quJr7qg"
    },
    "targetRef": {
...
const schema14 = {
  "properties": {
    "oauthclientCredentials": {
      "$ref": "x3UaIRP2MNip7jzEGOA15TlTrAVa140YS3iBvEGscw"
    }
  },
...
const schema15 = {
  "properties": {
    "clientID": {
      "$ref": "qFscms1R1H74qkM4MSmAQiuVQlmaPb0IBWJrRY3uww"
    },
    "clientSecret": {
      "$ref": "qFscms1R1H74qkM4MSmAQiuVQlmaPb0IBWJrRY3uww"
    },
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.oauthclientCredentials !== undefined) {
      if (!validate34(data.oauthclientCredentials, {
...
function validate23(data, {
  ...
  /*# sourceURL="networking.gke.io.v1alpha1.IAPPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
