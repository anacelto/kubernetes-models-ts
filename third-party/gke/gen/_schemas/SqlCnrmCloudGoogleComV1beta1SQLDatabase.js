...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "AJCBbSIA4xxJXfLMma7WAjhcpsbHSywMpl5LRwE9KeE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "epWzjg4BjB9Dmf8q29NtVC766Y9X9J0FRRnyO59148"
    },
    "status": {
  ...
  "$id": "sql.cnrm.cloud.google.com.v1beta1.SQLDatabase"
};
const schema8 = {
  "type": "string",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.charset !== undefined) {
      if (!validate21(data.charset, {
        instancePath: instancePath + "/charset",
        parentData: data,
        parentDataProperty: "charset",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.deletionPolicy !== undefined) {
      if (!validate21(data.deletionPolicy, {
    ...
    if (data.instanceRef !== undefined) {
      if (!validate35(data.instanceRef, {
...
function validate22(data, {
  ...
  /*# sourceURL="sql.cnrm.cloud.google.com.v1beta1.SQLDatabase" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
