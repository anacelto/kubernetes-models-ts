...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "GYaT2CrCGk13Jp54CuifpHcQ4YwJreN8CVe7C2k4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "VHGsAEUcty7kh2IiAkAOsTEUMl0Vn05alONFbxaJIk"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeDiskResourcePolicyAttachment"
};
const schema15 = {
  "type": "string",
...
const schema16 = {
  "type": "string",
  "enum": ["ComputeDiskResourcePolicyAttachment"]
};
function validate41(data, {
  ...
  if (!(data === "ComputeDiskResourcePolicyAttachment")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  ...
  "required": ["diskRef", "projectRef", "zone"],
  "type": "object"
};
const schema7 = {
  "oneOf": [{
...
function validate38(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeDiskResourcePolicyAttachment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
