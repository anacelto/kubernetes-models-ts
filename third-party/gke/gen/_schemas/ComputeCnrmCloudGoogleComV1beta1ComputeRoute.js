...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "AgIY3o2GXG1BNbk2NIft1vE9EXWbkcvsLQXmMptgjG4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "vrjNontuvuCWOYvAKtIBA3tuGovvR1wsPRH6ndF0"
    },
    "status": {
      "$ref": "IKZIRgEa9P5YDX1CFDoSZqnq9DLzN6EDHixwJC4A"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeRoute"
};
const schema17 = {
  "type": "string",
...
function validate49(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.destRange === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "destRange"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.destRange !== undefined) {
      if (!validate38(data.destRange, {
        instancePath: instancePath + "/destRange",
        parentData: data,
        parentDataProperty: "destRange",
        rootData
      })) {
        vErrors = vErrors === null ? validate38.errors : vErrors.concat(validate38.errors);
        errors = vErrors.length;
    ...
    if (data.nextHopGateway !== undefined) {
      if (!validate21(data.nextHopGateway, {
        instancePath: instancePath + "/nextHopGateway",
        parentData: data,
        parentDataProperty: "nextHopGateway",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.nextHopILBRef !== undefined) {
      if (!validate32(data.nextHopILBRef, {
        instancePath: instancePath + "/nextHopILBRef",
        parentData: data,
        parentDataProperty: "nextHopILBRef",
        rootData
      })) {
    ...
    if (data.nextHopInstanceRef !== undefined) {
      if (!validate32(data.nextHopInstanceRef, {
        instancePath: instancePath + "/nextHopInstanceRef",
        parentData: data,
        parentDataProperty: "nextHopInstanceRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate32.errors : vErrors.concat(validate32.errors);
        errors = vErrors.length;
    ...
    if (data.nextHopIp !== undefined) {
      if (!validate21(data.nextHopIp, {
        instancePath: instancePath + "/nextHopIp",
        parentData: data,
        parentDataProperty: "nextHopIp",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.nextHopVPNTunnelRef !== undefined) {
      if (!validate32(data.nextHopVPNTunnelRef, {
        instancePath: instancePath + "/nextHopVPNTunnelRef",
        parentData: data,
        parentDataProperty: "nextHopVPNTunnelRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate32.errors : vErrors.concat(validate32.errors);
        errors = vErrors.length;
...
function validate69(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nextHopNetwork !== undefined) {
      if (!validate21(data.nextHopNetwork, {
        instancePath: instancePath + "/nextHopNetwork",
        parentData: data,
        parentDataProperty: "nextHopNetwork",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate40(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
