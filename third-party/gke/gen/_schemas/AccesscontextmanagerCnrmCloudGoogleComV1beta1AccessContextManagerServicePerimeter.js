...
const schema41 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "4bxOUfvJTrSvZJKvikCThswUqzCFpVLh2xvcBj7Oc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "yCGQ9sPLpcw6Wx9f9NRvDcJASEfwTzlzo9Btygko"
    },
    "status": {
      "$ref": "wmg86EY75NSJFoQ3cIlQBWbU2l59PiTOmBFW1BZY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "accesscontextmanager.cnrm.cloud.google.com.v1beta1.AccessContextManagerServicePerimeter"
};
const schema42 = {
  "type": "string",
...
function validate115(data, {
  ...
  if (!(data === "AccessContextManagerServicePerimeter")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema46 = {
  "properties": {
    ...
    "spec": {
      "$ref": "b8qzX53vIlUjpvSQl0R5KLaellOl3X4DF0BN6u0b8"
    },
    "status": {
      "$ref": "b8qzX53vIlUjpvSQl0R5KLaellOl3X4DF0BN6u0b8"
    },
...
const schema27 = {
  "properties": {
    ...
    "egressPolicies": {
      "$ref": "ImgKuRWMYA2FLcX4bdiI40cYNhhP4DRyR2qTORXOI"
    },
    "ingressPolicies": {
      "$ref": "1oTqVtdXZPkPfVOETkN50nATRl3dQf6oF5CXiuI"
    },
    "resources": {
      "$ref": "iszJygdL5P71lZfhQxMgG9cE8Clgs9CBpJvqnGpBc"
    },
    "restrictedServices": {
      "$ref": "aRQtgAls8PT3219P8mxz6PPEAVWN1SvmCHi6z12UM"
    },
    "vpcAccessibleServices": {
      "$ref": "HJmppnUmbxlrwxn2PWkVvscq2tJbLgX6HOKvdiqW5JE"
    }
  },
  "type": "object",
  "nullable": true
...
const schema29 = {
  "items": {
    "$ref": "dCPseByPTJzVTy5vj5au3cm6BJRSmovI11JPx76NYA"
  },
  "type": "array",
  "nullable": true
};
const schema30 = {
  "properties": {
    "egressFrom": {
      "$ref": "ibHp9h1EAS8tWcLW7WpPFJVNyQjKyWSleGC7nVaWY"
    },
    "egressTo": {
      "$ref": "yk8Gac4JtVoIGQfdp4mOvqfVuGnX9M2xmsDXRE1FpA"
    }
  },
  "type": "object"
};
...
function validate45(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.serviceAccountRef !== undefined) {
      if (!validate38(data.serviceAccountRef, {
...
function validate76(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.identityType !== undefined) {
      if (!validate21(data.identityType, {
        instancePath: instancePath + "/identityType",
        parentData: data,
        parentDataProperty: "identityType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema32 = {
  "properties": {
    ...
    "operations": {
      "$ref": "y31bVWA6N4rIMxQBwkFOMqmPc7sPM63trfoQvnliAks"
    },
    "resources": {
      "$ref": "iszJygdL5P71lZfhQxMgG9cE8Clgs9CBpJvqnGpBc"
    }
...
const schema19 = {
  "items": {
    "$ref": "TL9U70HtXznhevNcPsoZRdY0rrCikbLSa8ijLLKoNA"
  },
  "type": "array",
  "nullable": true
};
const schema20 = {
  "properties": {
    "methodSelectors": {
      "$ref": "7QHbxtwXDWrvw7vbesixFIHsWRLUGTI5kBTQpGndyzU"
    },
    "serviceName": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema21 = {
  "items": {
    "$ref": "itsGu0XQHiJdB0iKN0enZmGvcdTEnNNF7hhkNAnfQ"
  },
  "type": "array",
  "nullable": true
};
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.permission !== undefined) {
      if (!validate21(data.permission, {
        instancePath: instancePath + "/permission",
        parentData: data,
        parentDataProperty: "permission",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate54(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.methodSelectors !== undefined) {
      if (!validate55(data.methodSelectors, {
        instancePath: instancePath + "/methodSelectors",
        parentData: data,
        parentDataProperty: "methodSelectors",
        rootData
      })) {
...
const schema23 = {
  "items": {
    "$ref": "3t0HCmqavtUxuD7PVov5xVYyXxIul8CThMxyTumF78U"
  },
  "type": "array",
  "nullable": true
};
...
function validate80(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.externalResources !== undefined) {
      if (!validate67(data.externalResources, {
        instancePath: instancePath + "/externalResources",
        parentData: data,
        parentDataProperty: "externalResources",
        rootData
      })) {
...
function validate75(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.egressFrom !== undefined) {
      if (!validate76(data.egressFrom, {
        instancePath: instancePath + "/egressFrom",
        parentData: data,
        parentDataProperty: "egressFrom",
        rootData
      })) {
    ...
    if (data.egressTo !== undefined) {
      if (!validate80(data.egressTo, {
        instancePath: instancePath + "/egressTo",
        parentData: data,
        parentDataProperty: "egressTo",
        rootData
      })) {
...
const schema33 = {
  "items": {
    "$ref": "Cxm75irzyH8bVj90WDcAoK5rUETZa3r8LId6XkWMg8"
  },
  "type": "array",
  "nullable": true
};
const schema34 = {
  "properties": {
    "ingressFrom": {
      "$ref": "KWnizHHchLITrTw4IEZppq3n99OPRVQE5Pguce8n7gI"
    },
    "ingressTo": {
      "$ref": "3o5k2rS6GESNAIwUb540pSlaSZSTjhHlGk2CZ7QvHo"
    }
  },
  "type": "object"
};
const schema35 = {
  "properties": {
    ...
    "sources": {
      "$ref": "dqdapn4GnR5B9OFvGCf2zh3Hjb0y8iaOMkdTVZ0rg"
    }
  },
  "type": "object",
  "nullable": true
...
const schema36 = {
  "items": {
    "$ref": "90HUAD5KcAhbmkScbn1U2kP6nlKidLTCvvnD7ZnxM"
  },
  "type": "array",
  "nullable": true
};
...
function validate93(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.accessLevelRef !== undefined) {
      if (!validate38(data.accessLevelRef, {
        instancePath: instancePath + "/accessLevelRef",
        parentData: data,
        parentDataProperty: "accessLevelRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate38.errors : vErrors.concat(validate38.errors);
        errors = vErrors.length;
...
function validate88(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ingressFrom !== undefined) {
      if (!validate89(data.ingressFrom, {
        instancePath: instancePath + "/ingressFrom",
        parentData: data,
        parentDataProperty: "ingressFrom",
        rootData
      })) {
    ...
    if (data.ingressTo !== undefined) {
      if (!validate99(data.ingressTo, {
        instancePath: instancePath + "/ingressTo",
        parentData: data,
        parentDataProperty: "ingressTo",
        rootData
      })) {
...
function validate107(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowedServices !== undefined) {
      if (!validate67(data.allowedServices, {
        instancePath: instancePath + "/allowedServices",
        parentData: data,
        parentDataProperty: "allowedServices",
        rootData
      })) {
        vErrors = vErrors === null ? validate67.errors : vErrors.concat(validate67.errors);
        errors = vErrors.length;
    ...
    if (data.enableRestriction !== undefined) {
      if (!validate109(data.enableRestriction, {
        instancePath: instancePath + "/enableRestriction",
        parentData: data,
        parentDataProperty: "enableRestriction",
        rootData
      })) {
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.accessLevels !== undefined) {
      if (!validate71(data.accessLevels, {
    ...
    if (data.egressPolicies !== undefined) {
      if (!validate74(data.egressPolicies, {
        instancePath: instancePath + "/egressPolicies",
        parentData: data,
        parentDataProperty: "egressPolicies",
        rootData
      })) {
    ...
    if (data.ingressPolicies !== undefined) {
      if (!validate87(data.ingressPolicies, {
        instancePath: instancePath + "/ingressPolicies",
        parentData: data,
        parentDataProperty: "ingressPolicies",
        rootData
      })) {
    ...
    if (data.restrictedServices !== undefined) {
      if (!validate67(data.restrictedServices, {
        instancePath: instancePath + "/restrictedServices",
        parentData: data,
        parentDataProperty: "restrictedServices",
        rootData
      })) {
        vErrors = vErrors === null ? validate67.errors : vErrors.concat(validate67.errors);
        errors = vErrors.length;
    ...
    if (data.vpcAccessibleServices !== undefined) {
      if (!validate107(data.vpcAccessibleServices, {
        instancePath: instancePath + "/vpcAccessibleServices",
        parentData: data,
        parentDataProperty: "vpcAccessibleServices",
        rootData
      })) {
...
function validate121(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.accessPolicyRef !== undefined) {
      if (!validate22(data.accessPolicyRef, {
    ...
    if (data.perimeterType !== undefined) {
      if (!validate21(data.perimeterType, {
        instancePath: instancePath + "/perimeterType",
        parentData: data,
        parentDataProperty: "perimeterType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.useExplicitDryRunSpec !== undefined) {
      if (!validate109(data.useExplicitDryRunSpec, {
        instancePath: instancePath + "/useExplicitDryRunSpec",
        parentData: data,
        parentDataProperty: "useExplicitDryRunSpec",
        rootData
      })) {
        vErrors = vErrors === null ? validate109.errors : vErrors.concat(validate109.errors);
        errors = vErrors.length;
...
function validate130(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate141(data.observedGeneration, {
...
function validate112(data, {
  ...
  /*# sourceURL="accesscontextmanager.cnrm.cloud.google.com.v1beta1.AccessContextManagerServicePerimeter" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.spec === undefined) {
