...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "AlI71x69OCL3Dlc6rXGVxPLT3c7jfmOXGLDtM32Q"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "VpG7Wze6AyEpaqDlOFbLv6ABKTpRntIoJWp6StUGA"
    },
    "status": {
      "$ref": "BJ3Dg9Ht8xnHZyyQiMhKN0DYu3iLbcPsJoBHcas73c"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeRegionNetworkEndpointGroup"
};
const schema15 = {
  "type": "string",
...
const schema16 = {
  "type": "string",
  "enum": ["ComputeRegionNetworkEndpointGroup"]
};
function validate41(data, {
  ...
  if (!(data === "ComputeRegionNetworkEndpointGroup")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  "properties": {
    "cloudFunction": {
      "$ref": "qFyRDllQIgDrL8fJWcPFzybVIMMmAOf7Y6NuourmM"
    },
    "cloudRun": {
      "$ref": "JbNftd4QQvZ12YhPJ6YBXfPdwBjFUQdSvuQozmDjOsY"
    },
    "networkEndpointType": {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.functionRef !== undefined) {
      if (!validate22(data.functionRef, {
        instancePath: instancePath + "/functionRef",
        parentData: data,
        parentDataProperty: "functionRef",
        rootData
      })) {
    ...
    if (data.urlMask !== undefined) {
      if (!validate21(data.urlMask, {
        instancePath: instancePath + "/urlMask",
        parentData: data,
        parentDataProperty: "urlMask",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cloudFunction !== undefined) {
      if (!validate48(data.cloudFunction, {
        instancePath: instancePath + "/cloudFunction",
        parentData: data,
        parentDataProperty: "cloudFunction",
        rootData
      })) {
    ...
    if (data.cloudRun !== undefined) {
      if (!validate52(data.cloudRun, {
        instancePath: instancePath + "/cloudRun",
        parentData: data,
        parentDataProperty: "cloudRun",
        rootData
      })) {
    ...
    if (data.networkEndpointType !== undefined) {
      if (!validate21(data.networkEndpointType, {
        instancePath: instancePath + "/networkEndpointType",
        parentData: data,
        parentDataProperty: "networkEndpointType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.pscTargetService !== undefined) {
      if (!validate21(data.pscTargetService, {
        instancePath: instancePath + "/pscTargetService",
        parentData: data,
        parentDataProperty: "pscTargetService",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.subnetworkRef !== undefined) {
      if (!validate22(data.subnetworkRef, {
...
function validate38(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeRegionNetworkEndpointGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
