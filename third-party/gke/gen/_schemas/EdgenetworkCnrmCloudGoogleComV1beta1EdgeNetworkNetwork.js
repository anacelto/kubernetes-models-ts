...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "xw6kgZFcOcNf6lJe7XyNUAuCcdC9ye94gMLYGhJob0"
    },
    "kind": {
      "$ref": "WvY8ThKO5rsYo7wRTwWJMrlpOJM50sqFYs41tKXNVY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "nvACkgexmsi7wCYygbGASFVXqz6WIYPjUdBBYBJQJM"
    },
    "status": {
      "$ref": "x2zvGzKIgfx1c1FKy1jMYusQ8DDzSFPtJLZUSEchyg"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "edgenetwork.cnrm.cloud.google.com.v1beta1.EdgeNetworkNetwork"
};
const schema10 = {
  "type": "string",
  "enum": ["edgenetwork.cnrm.cloud.google.com/v1beta1"]
};
function validate25(data, {
  ...
  if (!(data === "edgenetwork.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  ...
  "required": ["location", "projectRef", "zone"],
  "type": "object"
};
const schema7 = {
  "type": "string"
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.mtu !== undefined) {
      if (!validate23(data.mtu, {
        instancePath: instancePath + "/mtu",
        parentData: data,
        parentDataProperty: "mtu",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="edgenetwork.cnrm.cloud.google.com.v1beta1.EdgeNetworkNetwork" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
