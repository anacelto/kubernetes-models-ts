...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "J0uBhpisAHs79ScrBfN6iyQGwSpEc9UksaQwc2xa6Q"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "3ZN9VXserrovbxbb2PYE5yBc1ZgJyBPvWzpGDQOmMK4"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeVPNGateway"
};
const schema15 = {
  "type": "string",
...
const schema19 = {
  "properties": {
    ...
    "vpnInterfaces": {
      "$ref": "EK1WxQ2Aq9WZWj9Aeth3GdI3Q0NpkDY84PqlroBk"
    }
  },
...
const schema22 = {
  "items": {
    "$ref": "bs1OsDYPG1CtrznFfnbKpWrNPqE0BveF3DcIYAq8"
  },
  "type": "array",
  "nullable": true
};
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.interconnectAttachmentRef !== undefined) {
      if (!validate57(data.interconnectAttachmentRef, {
        instancePath: instancePath + "/interconnectAttachmentRef",
        parentData: data,
        parentDataProperty: "interconnectAttachmentRef",
        rootData
      })) {
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.vpnInterfaces !== undefined) {
      if (!validate54(data.vpnInterfaces, {
        instancePath: instancePath + "/vpnInterfaces",
        parentData: data,
        parentDataProperty: "vpnInterfaces",
        rootData
      })) {
...
function validate33(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeVPNGateway" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
