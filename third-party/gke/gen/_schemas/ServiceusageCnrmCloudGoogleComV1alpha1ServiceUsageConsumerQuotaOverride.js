...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "mJAJsyX9N434Q5oA4mkQmPvhneNvxhW8IhKfxZzFSg"
    },
    "kind": {
      "$ref": "UfgrpeYcf7sUcrSZccQ1JhucOjgMmeJDDo5EUWQw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "lC2dTBN7cCnmnZatsyegK9ak78dITYjSLEtR210kE"
    },
    "status": {
  ...
  "$id": "serviceusage.cnrm.cloud.google.com.v1alpha1.ServiceUsageConsumerQuotaOverride"
};
const schema9 = {
  "type": "string",
  "enum": ["serviceusage.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "serviceusage.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema10 = {
  "type": "string",
  "enum": ["ServiceUsageConsumerQuotaOverride"]
};
function validate26(data, {
  ...
  if (!(data === "ServiceUsageConsumerQuotaOverride")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["limit", "metric", "overrideValue", "projectRef", "service"],
  "type": "object"
};
const schema14 = {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.overrideValue !== undefined) {
      if (!validate21(data.overrideValue, {
        instancePath: instancePath + "/overrideValue",
        parentData: data,
        parentDataProperty: "overrideValue",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="serviceusage.cnrm.cloud.google.com.v1alpha1.ServiceUsageConsumerQuotaOverride" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
