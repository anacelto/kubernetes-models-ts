...
const schema17 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "hBH7wcO1XzjtNb1orW9SdavNM3HR4OnO8GrFJOykwQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "A9OwQ41unmTz1a8GIixjLZV5KX71YpvVqlnyntn3g"
    },
    "status": {
  ...
  "$id": "dataflow.cnrm.cloud.google.com.v1beta1.DataflowJob"
};
const schema18 = {
  "type": "string",
...
function validate50(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.tempGcsLocation === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "tempGcsLocation"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.templateGcsPath === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "templateGcsPath"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.enableStreamingEngine !== undefined) {
      if (!validate54(data.enableStreamingEngine, {
    ...
    if (data.ipConfiguration !== undefined) {
      if (!validate21(data.ipConfiguration, {
    ...
    if (data.tempGcsLocation !== undefined) {
      if (!validate38(data.tempGcsLocation, {
        instancePath: instancePath + "/tempGcsLocation",
        parentData: data,
        parentDataProperty: "tempGcsLocation",
        rootData
      })) {
        vErrors = vErrors === null ? validate38.errors : vErrors.concat(validate38.errors);
        errors = vErrors.length;
    ...
    if (data.templateGcsPath !== undefined) {
      if (!validate38(data.templateGcsPath, {
        instancePath: instancePath + "/templateGcsPath",
        parentData: data,
        parentDataProperty: "templateGcsPath",
        rootData
      })) {
        vErrors = vErrors === null ? validate38.errors : vErrors.concat(validate38.errors);
        errors = vErrors.length;
    ...
    if (data.transformNameMapping !== undefined) {
      if (!validate39(data.transformNameMapping, {
...
function validate41(data, {
  ...
  /*# sourceURL="dataflow.cnrm.cloud.google.com.v1beta1.DataflowJob" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
