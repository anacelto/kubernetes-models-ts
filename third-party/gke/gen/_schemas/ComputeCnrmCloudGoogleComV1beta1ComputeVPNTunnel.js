...
const schema17 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "kjtSw32JResisee5q6lXD7w10r1i7s427dfqf3YomUU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "mgSjyuCC8nqV8a4qExhqtcQtxodBMPfufC8lkM8"
    },
    "status": {
      "$ref": "VaLP0Y6GbWq0po7oe0geCLXlQZwCUFwLd9AcvuQ0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeVPNTunnel"
};
const schema18 = {
  "type": "string",
...
function validate72(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretKeyRef !== undefined) {
      if (!validate73(data.secretKeyRef, {
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ikeVersion !== undefined) {
      if (!validate21(data.ikeVersion, {
        instancePath: instancePath + "/ikeVersion",
        parentData: data,
        parentDataProperty: "ikeVersion",
        rootData
      })) {
    ...
    if (data.localTrafficSelector !== undefined) {
      if (!validate40(data.localTrafficSelector, {
        instancePath: instancePath + "/localTrafficSelector",
        parentData: data,
        parentDataProperty: "localTrafficSelector",
        rootData
      })) {
    ...
    if (data.peerExternalGatewayInterface !== undefined) {
      if (!validate21(data.peerExternalGatewayInterface, {
        instancePath: instancePath + "/peerExternalGatewayInterface",
        parentData: data,
        parentDataProperty: "peerExternalGatewayInterface",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.peerExternalGatewayRef !== undefined) {
      if (!validate23(data.peerExternalGatewayRef, {
        instancePath: instancePath + "/peerExternalGatewayRef",
        parentData: data,
        parentDataProperty: "peerExternalGatewayRef",
        rootData
      })) {
    ...
    if (data.peerGCPGatewayRef !== undefined) {
      if (!validate23(data.peerGCPGatewayRef, {
        instancePath: instancePath + "/peerGCPGatewayRef",
        parentData: data,
        parentDataProperty: "peerGCPGatewayRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.peerIp !== undefined) {
      if (!validate22(data.peerIp, {
        instancePath: instancePath + "/peerIp",
        parentData: data,
        parentDataProperty: "peerIp",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.remoteTrafficSelector !== undefined) {
      if (!validate40(data.remoteTrafficSelector, {
        instancePath: instancePath + "/remoteTrafficSelector",
        parentData: data,
        parentDataProperty: "remoteTrafficSelector",
        rootData
      })) {
        vErrors = vErrors === null ? validate40.errors : vErrors.concat(validate40.errors);
        errors = vErrors.length;
    ...
    if (data.sharedSecret !== undefined) {
      if (!validate62(data.sharedSecret, {
        instancePath: instancePath + "/sharedSecret",
        parentData: data,
        parentDataProperty: "sharedSecret",
        rootData
      })) {
    ...
    if (data.vpnGatewayInterface !== undefined) {
      if (!validate21(data.vpnGatewayInterface, {
        instancePath: instancePath + "/vpnGatewayInterface",
        parentData: data,
        parentDataProperty: "vpnGatewayInterface",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.vpnGatewayRef !== undefined) {
      if (!validate23(data.vpnGatewayRef, {
        instancePath: instancePath + "/vpnGatewayRef",
        parentData: data,
        parentDataProperty: "vpnGatewayRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate83(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.detailedStatus !== undefined) {
      if (!validate22(data.detailedStatus, {
        instancePath: instancePath + "/detailedStatus",
        parentData: data,
        parentDataProperty: "detailedStatus",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.sharedSecretHash !== undefined) {
      if (!validate22(data.sharedSecretHash, {
        instancePath: instancePath + "/sharedSecretHash",
        parentData: data,
        parentDataProperty: "sharedSecretHash",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.tunnelId !== undefined) {
      if (!validate22(data.tunnelId, {
        instancePath: instancePath + "/tunnelId",
        parentData: data,
        parentDataProperty: "tunnelId",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate42(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeVPNTunnel" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
