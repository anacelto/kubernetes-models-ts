...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "GkD27qi2jaH6EfaRRYT4JzvzMjMLiw1QXMmAaEcXM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "l3Zv5Uk2bWX2QDXMHE9w6HxsRNgrHpdLCMpK1VysvGI"
    },
    "status": {
  ...
  "$id": "servicedirectory.cnrm.cloud.google.com.v1beta1.ServiceDirectoryService"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "ServiceDirectoryService")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.namespaceRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "namespaceRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.namespaceRef !== undefined) {
      if (!validate32(data.namespaceRef, {
        instancePath: instancePath + "/namespaceRef",
        parentData: data,
        parentDataProperty: "namespaceRef",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="servicedirectory.cnrm.cloud.google.com.v1beta1.ServiceDirectoryService" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
