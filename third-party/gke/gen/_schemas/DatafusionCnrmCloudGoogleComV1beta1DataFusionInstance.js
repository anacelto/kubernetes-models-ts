...
const schema17 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "yHlE7orOmNHAcQVbX3hu6vJAyVAKhkHk9mA4XdjgI"
    },
    "kind": {
      "$ref": "e4Mr4U0dvNK3jDcl0LHvOFSRdzWiJwl7ASygTPM2So"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "jhPUzA2ehyvOIkB7vS3dFzgEqkl6yNHGqya7Znbfgk"
    },
    "status": {
      "$ref": "1Fwo9WblJAPEItDwpSx40nxLm0fKxx9vPCkrZdoc28"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "datafusion.cnrm.cloud.google.com.v1beta1.DataFusionInstance"
};
const schema18 = {
  "type": "string",
...
function validate42(data, {
  ...
  if (!(data === "datafusion.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema22 = {
  "properties": {
    ...
    "networkConfig": {
      "$ref": "5nTKp8eEUWCuQZrLDvugcxgEM3VRzbOnqr1tcgmgk"
    },
    "options": {
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ipAllocation !== undefined) {
      if (!validate21(data.ipAllocation, {
        instancePath: instancePath + "/ipAllocation",
        parentData: data,
        parentDataProperty: "ipAllocation",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataprocServiceAccountRef !== undefined) {
      if (!validate23(data.dataprocServiceAccountRef, {
        instancePath: instancePath + "/dataprocServiceAccountRef",
        parentData: data,
        parentDataProperty: "dataprocServiceAccountRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.enableStackdriverLogging !== undefined) {
      if (!validate22(data.enableStackdriverLogging, {
        instancePath: instancePath + "/enableStackdriverLogging",
        parentData: data,
        parentDataProperty: "enableStackdriverLogging",
        rootData
      })) {
    ...
    if (data.enableStackdriverMonitoring !== undefined) {
      if (!validate22(data.enableStackdriverMonitoring, {
        instancePath: instancePath + "/enableStackdriverMonitoring",
        parentData: data,
        parentDataProperty: "enableStackdriverMonitoring",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.networkConfig !== undefined) {
      if (!validate56(data.networkConfig, {
    ...
    if (data.privateInstance !== undefined) {
      if (!validate22(data.privateInstance, {
        instancePath: instancePath + "/privateInstance",
        parentData: data,
        parentDataProperty: "privateInstance",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
const schema25 = {
  "properties": {
    ...
    "availableVersion": {
      "$ref": "MY4ih4OBMMBvyIv5QR9yrNKomGFrNGFzfYIjdqiw"
    },
    "conditions": {
...
const schema26 = {
  "items": {
    "$ref": "BI8EHHGVwkoizD142n9Rsp4xaLZIq58EguR5qPHiXE"
  },
  "type": "array",
  "nullable": true
};
...
function validate72(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.availableFeatures !== undefined) {
      if (!validate73(data.availableFeatures, {
        instancePath: instancePath + "/availableFeatures",
        parentData: data,
        parentDataProperty: "availableFeatures",
        rootData
      })) {
    ...
    if (data.defaultVersion !== undefined) {
      if (!validate22(data.defaultVersion, {
        instancePath: instancePath + "/defaultVersion",
        parentData: data,
        parentDataProperty: "defaultVersion",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.versionNumber !== undefined) {
      if (!validate21(data.versionNumber, {
        instancePath: instancePath + "/versionNumber",
        parentData: data,
        parentDataProperty: "versionNumber",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate69(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiEndpoint !== undefined) {
      if (!validate21(data.apiEndpoint, {
    ...
    if (data.availableVersion !== undefined) {
      if (!validate71(data.availableVersion, {
        instancePath: instancePath + "/availableVersion",
        parentData: data,
        parentDataProperty: "availableVersion",
        rootData
      })) {
    ...
    if (data.gcsBucket !== undefined) {
      if (!validate21(data.gcsBucket, {
        instancePath: instancePath + "/gcsBucket",
        parentData: data,
        parentDataProperty: "gcsBucket",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.p4ServiceAccount !== undefined) {
      if (!validate21(data.p4ServiceAccount, {
        instancePath: instancePath + "/p4ServiceAccount",
        parentData: data,
        parentDataProperty: "p4ServiceAccount",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.serviceEndpoint !== undefined) {
      if (!validate21(data.serviceEndpoint, {
        instancePath: instancePath + "/serviceEndpoint",
        parentData: data,
        parentDataProperty: "serviceEndpoint",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.stateMessage !== undefined) {
      if (!validate21(data.stateMessage, {
    ...
    if (data.tenantProjectId !== undefined) {
      if (!validate21(data.tenantProjectId, {
        instancePath: instancePath + "/tenantProjectId",
        parentData: data,
        parentDataProperty: "tenantProjectId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate41(data, {
  ...
  /*# sourceURL="datafusion.cnrm.cloud.google.com.v1beta1.DataFusionInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
