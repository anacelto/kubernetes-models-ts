...
const schema16 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "bNxFhUTTKmQKQPBiJc7YN1EubuO2yNBegopRASThf0M"
    },
    "kind": {
      "$ref": "SOAGlhyHauD2GBh685S74RxVveyEr5YpP2q5BHTmDXg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Kq8dEx97NUfNPzkNY6HOOs2K4t7qQxvc9Ex4r4RlY"
    },
    "status": {
      "$ref": "DRBPHfDTNf11G0IIetyUUiqf0wrcE7TIYDN1oEHfIw"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "filestore.cnrm.cloud.google.com.v1beta1.FilestoreBackup"
};
const schema17 = {
  "type": "string",
...
function validate41(data, {
  ...
  if (!(data === "filestore.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema21 = {
  ...
  "required": ["location", "projectRef", "sourceFileShare", "sourceInstanceRef"],
  "type": "object"
};
const schema7 = {
  "type": "string"
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sourceFileShare === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "sourceFileShare"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.sourceInstanceRef === undefined) {
      const err3 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "sourceInstanceRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err3];
    ...
    if (data.sourceFileShare !== undefined) {
      if (!validate22(data.sourceFileShare, {
        instancePath: instancePath + "/sourceFileShare",
        parentData: data,
        parentDataProperty: "sourceFileShare",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.sourceInstanceRef !== undefined) {
      if (!validate23(data.sourceInstanceRef, {
        instancePath: instancePath + "/sourceInstanceRef",
        parentData: data,
        parentDataProperty: "sourceInstanceRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.capacityGb !== undefined) {
      if (!validate39(data.capacityGb, {
        instancePath: instancePath + "/capacityGb",
        parentData: data,
        parentDataProperty: "capacityGb",
        rootData
      })) {
    ...
    if (data.downloadBytes !== undefined) {
      if (!validate39(data.downloadBytes, {
        instancePath: instancePath + "/downloadBytes",
        parentData: data,
        parentDataProperty: "downloadBytes",
        rootData
      })) {
        vErrors = vErrors === null ? validate39.errors : vErrors.concat(validate39.errors);
        errors = vErrors.length;
    ...
    if (data.sourceInstanceTier !== undefined) {
      if (!validate21(data.sourceInstanceTier, {
        instancePath: instancePath + "/sourceInstanceTier",
        parentData: data,
        parentDataProperty: "sourceInstanceTier",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.storageBytes !== undefined) {
      if (!validate39(data.storageBytes, {
        instancePath: instancePath + "/storageBytes",
        parentData: data,
        parentDataProperty: "storageBytes",
        rootData
      })) {
        vErrors = vErrors === null ? validate39.errors : vErrors.concat(validate39.errors);
        errors = vErrors.length;
...
function validate40(data, {
  ...
  /*# sourceURL="filestore.cnrm.cloud.google.com.v1beta1.FilestoreBackup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
