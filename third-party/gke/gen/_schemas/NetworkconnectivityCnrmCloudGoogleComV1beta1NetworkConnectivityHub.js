...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "rSbudsqLx98gufduR06bgDrsxUBPBksQ5pv2FN9Q"
    },
    "metadata": {
    ...
    "status": {
      "$ref": "hJs6K42I8TMSkGPJPZYkGuCs9BuF1yuDhWnDlRb7E"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "networkconnectivity.cnrm.cloud.google.com.v1beta1.NetworkConnectivityHub"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "NetworkConnectivityHub")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema21 = {
  "properties": {
    ...
    "routingVpcs": {
      "$ref": "Z7TAPtUqIgNQlF27sZhwAU7CIPL86kowsOKsswicLlA"
    },
    "state": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema25 = {
  "items": {
    "$ref": "WchOmyFXkmgUUnub6gWSb7IHKB7o3YamBtXly1FmmU"
  },
  "type": "array",
  "nullable": true
};
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.routingVpcs !== undefined) {
      if (!validate65(data.routingVpcs, {
        instancePath: instancePath + "/routingVpcs",
        parentData: data,
        parentDataProperty: "routingVpcs",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="networkconnectivity.cnrm.cloud.google.com.v1beta1.NetworkConnectivityHub" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
