...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "NJ3Q5eeqMA0z2y9JwDuqJgDGLx6OSRuMlNwgJI7JUJw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ThcG5ycojSkqoSAeBQUmWYeAW2wrNsTl6uWPwOONg"
    },
    "status": {
  ...
  "$id": "dialogflowcx.cnrm.cloud.google.com.v1alpha1.DialogflowCXIntent"
};
const schema11 = {
  "type": "string",
...
const schema15 = {
  "properties": {
    ...
    "parameters": {
      "$ref": "taW0xeyhuZXKV3a1Dg3owpmPCiNICUXDMKTzFPX5c"
    },
    "parent": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    ...
    "trainingPhrases": {
      "$ref": "GUiAO5T4dnabxbhKt5W23P6rOn2NzEKlGiuXMR6599M"
    }
  },
...
const schema16 = {
  "items": {
    "$ref": "lGwA5Qa7di2zRIyqxwuynnqQvex5DzkLCFOgYKEEfc"
  },
  "type": "array",
  "nullable": true
};
...
const schema18 = {
  "items": {
    "$ref": "w7VMCNhyNGAl1fJZ4slh3b09bChTberPDOXZKIOD4"
  },
  "type": "array",
  "nullable": true
};
const schema19 = {
  "properties": {
    ...
    "parts": {
      "$ref": "myRGVuLJFwpPv5pGiaWdhSdbwys4KIf8Gir1aORp4"
    },
    "repeatCount": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    }
...
const schema20 = {
  "items": {
    "$ref": "8bGe5GFn7mz2qFSniSjINJ70bhTIMzW8MwVMSiL5Jfc"
  },
  "type": "array"
};
const schema21 = {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.parameterId !== undefined) {
      if (!validate23(data.parameterId, {
        instancePath: instancePath + "/parameterId",
        parentData: data,
        parentDataProperty: "parameterId",
        rootData
      })) {
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.parts !== undefined) {
      if (!validate52(data.parts, {
        instancePath: instancePath + "/parts",
        parentData: data,
        parentDataProperty: "parts",
        rootData
      })) {
    ...
    if (data.repeatCount !== undefined) {
      if (!validate24(data.repeatCount, {
        instancePath: instancePath + "/repeatCount",
        parentData: data,
        parentDataProperty: "repeatCount",
        rootData
      })) {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.languageCode !== undefined) {
      if (!validate23(data.languageCode, {
    ...
    if (data.trainingPhrases !== undefined) {
      if (!validate49(data.trainingPhrases, {
        instancePath: instancePath + "/trainingPhrases",
        parentData: data,
        parentDataProperty: "trainingPhrases",
        rootData
      })) {
...
function validate25(data, {
  ...
  /*# sourceURL="dialogflowcx.cnrm.cloud.google.com.v1alpha1.DialogflowCXIntent" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
