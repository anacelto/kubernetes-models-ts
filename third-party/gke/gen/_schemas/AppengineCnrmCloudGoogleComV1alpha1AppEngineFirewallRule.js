...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "Xv4yHGXGDrwxxjCebNGf0ZQf4txbx53K5s7ob6AYSo8"
    },
    "kind": {
      "$ref": "P59k3oPr4XTDkXdiHg5K0TmEiP6MUBiypEV1xrpnc7M"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AK7upMLHhlkWFmrFbHHWPj6QihoeXIQdxI0GRx3xk"
    },
    "status": {
  ...
  "$id": "appengine.cnrm.cloud.google.com.v1alpha1.AppEngineFirewallRule"
};
const schema9 = {
  "type": "string",
  "enum": ["appengine.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "appengine.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sourceRange !== undefined) {
      if (!validate22(data.sourceRange, {
...
function validate23(data, {
  ...
  /*# sourceURL="appengine.cnrm.cloud.google.com.v1alpha1.AppEngineFirewallRule" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
