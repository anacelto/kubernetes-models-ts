...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "t3EXVcFhdsWQYTmoonRAd1UJRaLXlZsVGsENBJbBhg"
    },
    "kind": {
      "$ref": "jGjuLw7cdORFSHV3iJw7mZ9C0cEhQrY054Lw5IYgA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "NRYulTfmbhdJiB8wEc8j2ybOLBf48yB39Ny6F3O8"
    },
    "status": {
      "$ref": "5Z8u4hKgsP45Kn6N841J6YbhnMpcVH76rR4kiIBdyQ"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "workflows.cnrm.cloud.google.com.v1alpha1.WorkflowsWorkflow"
};
const schema8 = {
  "type": "string",
  "enum": ["workflows.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "workflows.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cryptoKeyName !== undefined) {
      if (!validate21(data.cryptoKeyName, {
        instancePath: instancePath + "/cryptoKeyName",
        parentData: data,
        parentDataProperty: "cryptoKeyName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.sourceContents !== undefined) {
      if (!validate21(data.sourceContents, {
        instancePath: instancePath + "/sourceContents",
        parentData: data,
        parentDataProperty: "sourceContents",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="workflows.cnrm.cloud.google.com.v1alpha1.WorkflowsWorkflow" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
