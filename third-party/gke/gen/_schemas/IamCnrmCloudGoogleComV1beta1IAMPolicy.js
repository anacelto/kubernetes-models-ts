...
const schema12 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "XTUYWjgnFU4cYn5udkZMXAEjJdSMdE2wW8EPva7E"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "FHRQAwXxgG9WbHI50jnT6E5PQaU9VnSitlCRO81E"
    },
    "status": {
  ...
  "$id": "iam.cnrm.cloud.google.com.v1beta1.IAMPolicy"
};
const schema13 = {
  "type": "string",
...
const schema17 = {
  "properties": {
    "auditConfigs": {
      "$ref": "c1arKgQi2iDKBbTNA0YW7WyEOrN5dK6SSeQPc2ViyU"
    },
    "bindings": {
      "$ref": "49t1GC5pDa7tN9sroNi7ja6qbZFw2Iu85qN07s"
    },
    "resourceRef": {
...
const schema18 = {
  "items": {
    "$ref": "F8bvexQKT2OHaILlamNoManKQHioFYMKttsDAg0kCM"
  },
  "type": "array",
  "nullable": true
};
const schema19 = {
  "properties": {
    "auditLogConfigs": {
      "$ref": "6LjXJX73BMW3rpUvC1eHol1IIiOQhG82nc2uWNoI8w"
    },
    "service": {
...
const schema20 = {
  "items": {
    "$ref": "0nXUpMdouaDu0AwMx8rllGjrKb7QYt3oAxgUzEo7ak"
  },
  "type": "array"
};
const schema21 = {
  "properties": {
    ...
    "logType": {
      "$ref": "kdhkbnUl29bsROBOAn6a3sXSzIefolxsN8Um44oQGQ"
    }
  },
  "required": ["logType"],
  "type": "object"
...
const pattern0 = new RegExp("^(DATA_READ|DATA_WRITE|ADMIN_READ)$", "u");
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.exemptedMembers !== undefined) {
      if (!validate22(data.exemptedMembers, {
        instancePath: instancePath + "/exemptedMembers",
        parentData: data,
        parentDataProperty: "exemptedMembers",
        rootData
      })) {
    ...
    if (data.logType !== undefined) {
      if (!validate43(data.logType, {
        instancePath: instancePath + "/logType",
        parentData: data,
        parentDataProperty: "logType",
        rootData
      })) {
...
function validate39(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.auditLogConfigs === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "auditLogConfigs"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.auditLogConfigs !== undefined) {
      if (!validate40(data.auditLogConfigs, {
        instancePath: instancePath + "/auditLogConfigs",
        parentData: data,
        parentDataProperty: "auditLogConfigs",
        rootData
      })) {
...
const schema23 = {
  "items": {
    "$ref": "PAxHRtYCfhD9JGaU0TrKEP9fZ0XZh1VHkkWQ4pfAWs"
  },
  "type": "array",
  "nullable": true
};
...
const pattern1 = new RegExp("^((projects|organizations)/[^/]+/)?roles/[\\w_\\.]+$", "u");
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.auditConfigs !== undefined) {
      if (!validate38(data.auditConfigs, {
        instancePath: instancePath + "/auditConfigs",
        parentData: data,
        parentDataProperty: "auditConfigs",
        rootData
      })) {
    ...
    if (data.resourceRef !== undefined) {
      if (!validate61(data.resourceRef, {
...
function validate28(data, {
  ...
  /*# sourceURL="iam.cnrm.cloud.google.com.v1beta1.IAMPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
