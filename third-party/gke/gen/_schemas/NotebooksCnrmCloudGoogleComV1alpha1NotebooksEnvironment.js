...
const schema15 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "yhs2lO2A9IKoPucPbQmwlVYj6fszsBTb2HSz8fQ25g"
    },
    "kind": {
      "$ref": "E7HOF9ZujT3UdWLJneW5JnOKM29bRs7h6ZohnLwWM6Q"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Le0I4ye4EPWK4T2BYIV67tEMdA7k8qTVUwnJ9E7kA"
    },
    "status": {
      "$ref": "EXIUeXoHdBUNpl16qJWgFgXkvnzbs4OFCAPGM8UtD8"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "notebooks.cnrm.cloud.google.com.v1alpha1.NotebooksEnvironment"
};
const schema16 = {
  "type": "string",
  "enum": ["notebooks.cnrm.cloud.google.com/v1alpha1"]
};
function validate40(data, {
  ...
  if (!(data === "notebooks.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema20 = {
  "properties": {
    "containerImage": {
      "$ref": "iqEaODb1QLBHAuzMN6XOHGI8fwPLAbXLdcwE92EQEqA"
    },
    "displayName": {
    ...
    "vmImage": {
      "$ref": "ma7dx49J1PbMZnuVflTmajP0kL9qD4VZrjJnoxb9utQ"
    }
  },
  "required": ["locationRef", "projectRef"],
  "type": "object"
};
const schema21 = {
  "properties": {
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imageFamily !== undefined) {
      if (!validate21(data.imageFamily, {
        instancePath: instancePath + "/imageFamily",
        parentData: data,
        parentDataProperty: "imageFamily",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate48(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.locationRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "locationRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.containerImage !== undefined) {
      if (!validate49(data.containerImage, {
    ...
    if (data.locationRef !== undefined) {
      if (!validate22(data.locationRef, {
        instancePath: instancePath + "/locationRef",
        parentData: data,
        parentDataProperty: "locationRef",
        rootData
      })) {
    ...
    if (data.postStartupScript !== undefined) {
      if (!validate21(data.postStartupScript, {
        instancePath: instancePath + "/postStartupScript",
        parentData: data,
        parentDataProperty: "postStartupScript",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.vmImage !== undefined) {
      if (!validate58(data.vmImage, {
        instancePath: instancePath + "/vmImage",
        parentData: data,
        parentDataProperty: "vmImage",
        rootData
      })) {
...
function validate39(data, {
  ...
  /*# sourceURL="notebooks.cnrm.cloud.google.com.v1alpha1.NotebooksEnvironment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
