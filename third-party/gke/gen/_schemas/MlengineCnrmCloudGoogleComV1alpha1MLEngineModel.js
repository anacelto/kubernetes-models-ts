...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "JyacFyQDsFdpX1zcbutr0h3s3DAJ94DBzaFvhMfuFU"
    },
    "kind": {
      "$ref": "MgPQ2L9kr7zH2L66rIdofQ7mVteWMlLgkE9h1f3K7aU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "chTDtmcBRslJquXx2wSnAmJnypDr0GBFGTMEodMYXc"
    },
    "status": {
  ...
  "$id": "mlengine.cnrm.cloud.google.com.v1alpha1.MLEngineModel"
};
const schema10 = {
  "type": "string",
  "enum": ["mlengine.cnrm.cloud.google.com/v1alpha1"]
};
function validate25(data, {
  ...
  if (!(data === "mlengine.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultVersion !== undefined) {
      if (!validate34(data.defaultVersion, {
    ...
    if (data.onlinePredictionConsoleLogging !== undefined) {
      if (!validate21(data.onlinePredictionConsoleLogging, {
        instancePath: instancePath + "/onlinePredictionConsoleLogging",
        parentData: data,
        parentDataProperty: "onlinePredictionConsoleLogging",
        rootData
      })) {
    ...
    if (data.onlinePredictionLogging !== undefined) {
      if (!validate21(data.onlinePredictionLogging, {
        instancePath: instancePath + "/onlinePredictionLogging",
        parentData: data,
        parentDataProperty: "onlinePredictionLogging",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="mlengine.cnrm.cloud.google.com.v1alpha1.MLEngineModel" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
