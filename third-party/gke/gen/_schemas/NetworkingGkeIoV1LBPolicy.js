...
const schema6 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "mEIlhDCIG867yF20r9HnablUiCbzoNMV8TwQfIhs"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1.LBPolicy"
};
const schema7 = {
  "type": "string",
...
const schema11 = {
  "properties": {
    "default": {
      "$ref": "Bl5IgVRZiZDxFROWEdTjmWD0LUQNn9242hpkz0I2qY"
    },
    "targetRef": {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.drainingTimeoutSec !== undefined) {
      if (!validate33(data.drainingTimeoutSec, {
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cookieTtlSec !== undefined) {
      if (!validate43(data.cookieTtlSec, {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.connectionDraining !== undefined) {
      if (!validate32(data.connectionDraining, {
    ...
    if (data.sessionAffinity !== undefined) {
      if (!validate42(data.sessionAffinity, {
...
function validate21(data, {
  ...
  /*# sourceURL="networking.gke.io.v1.LBPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
