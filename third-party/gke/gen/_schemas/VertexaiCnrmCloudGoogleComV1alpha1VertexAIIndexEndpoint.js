...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "aswciwz25WjTkxVH4DPFXJrBIgWYnpbKquGBX9qUXg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "3Y1AytKpkLFZvwgwjYPeNOY2xB4vt8WmU6kVWQzpVA"
    },
    "status": {
      "$ref": "xHltjNHueMmRvT1nFAtl9I47QP5W7yJV6xOJxkJg"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIIndexEndpoint"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.publicEndpointEnabled !== undefined) {
      if (!validate52(data.publicEndpointEnabled, {
        instancePath: instancePath + "/publicEndpointEnabled",
        parentData: data,
        parentDataProperty: "publicEndpointEnabled",
        rootData
      })) {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.publicEndpointDomainName !== undefined) {
      if (!validate21(data.publicEndpointDomainName, {
        instancePath: instancePath + "/publicEndpointDomainName",
        parentData: data,
        parentDataProperty: "publicEndpointDomainName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIIndexEndpoint" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
