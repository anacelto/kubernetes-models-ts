...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Y8Ib0qXXResqN1ZpibreCSt3XAEi7xZPNn3ss8UGla8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "XXEHHcdYiUq0xw07UnGw9yUCvlNzP9IWqHdvO6GasZk"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeTargetPool"
};
const schema15 = {
  "type": "string",
...
const schema19 = {
  "properties": {
    ...
    "healthChecks": {
      "$ref": "OWtecPqIZls1ScdPrEXaFWy7vItVVHeKdrskTuYNk"
    },
    "instances": {
...
const schema21 = {
  "items": {
    "$ref": "xhriTx9MyiXFAJDp7Mb9YoYkPCzRPdTZaUp9qroXS20"
  },
  "type": "array",
  "nullable": true
};
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.backupTargetPoolRef !== undefined) {
      if (!validate22(data.backupTargetPoolRef, {
        instancePath: instancePath + "/backupTargetPoolRef",
        parentData: data,
        parentDataProperty: "backupTargetPoolRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.failoverRatio !== undefined) {
      if (!validate49(data.failoverRatio, {
    ...
    if (data.healthChecks !== undefined) {
      if (!validate51(data.healthChecks, {
...
function validate38(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeTargetPool" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
