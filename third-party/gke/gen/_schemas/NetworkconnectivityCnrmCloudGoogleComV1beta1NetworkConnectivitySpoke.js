...
const schema19 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "5hEecXDk6KBeGdKAVr3c2parBHJ5wcd4YKoNdeQ8g0"
    },
    "kind": {
      "$ref": "YI9QJVK71VAJ3n51GhIiglox5jDxO4T9QkGFCQw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "1GOpxRtxcduOETnqFKjaKcQHIfkJlnyfS3q4wIxsOE"
    },
    "status": {
      "$ref": "4e5Jd9zW3lfZASa4CeAViXxqKF0MRdkF6qGwmNhEwuQ"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "networkconnectivity.cnrm.cloud.google.com.v1beta1.NetworkConnectivitySpoke"
};
const schema20 = {
  "type": "string",
...
function validate47(data, {
  ...
  if (!(data === "networkconnectivity.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate49(data, {
  ...
  if (!(data === "NetworkConnectivitySpoke")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema24 = {
  "properties": {
    ...
    "linkedInterconnectAttachments": {
      "$ref": "lHemlO26oxygUVsrgqcLQLmbfXhNqY6NKMBzY7Hc"
    },
    "linkedRouterApplianceInstances": {
      "$ref": "CrBMMWeX9Cbr78KbjlniEq8ALKd7DGGmjggMS0ODg"
    },
    "linkedVPCNetwork": {
      "$ref": "hxqginGnJYV6c1t7v3h40H8m9RZsyTz7aktfU04hs"
    },
    "linkedVpnTunnels": {
      "$ref": "lHemlO26oxygUVsrgqcLQLmbfXhNqY6NKMBzY7Hc"
    },
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.siteToSiteDataTransfer === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "siteToSiteDataTransfer"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.siteToSiteDataTransfer !== undefined) {
      if (!validate38(data.siteToSiteDataTransfer, {
        instancePath: instancePath + "/siteToSiteDataTransfer",
        parentData: data,
        parentDataProperty: "siteToSiteDataTransfer",
        rootData
      })) {
...
const schema25 = {
  "properties": {
    "instances": {
      "$ref": "9vypOuZPx8kAPheMo5f3341WXndmcorpetuZAHgoxE"
    },
    "siteToSiteDataTransfer": {
      "$ref": "384TuUg7xQOu4Fi6u32QopECSxjPv91aOGoUUSEznpE"
    }
...
const schema26 = {
  "items": {
    "$ref": "V0lQhNZ7anIIwoFGawkKYMuaN5XrxOXMd2lnu1mmAIQ"
  },
  "type": "array"
};
const schema27 = {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.virtualMachineRef !== undefined) {
      if (!validate62(data.virtualMachineRef, {
        instancePath: instancePath + "/virtualMachineRef",
        parentData: data,
        parentDataProperty: "virtualMachineRef",
        rootData
      })) {
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.uriRef === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "uriRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.excludeExportRanges !== undefined) {
      if (!validate74(data.excludeExportRanges, {
        instancePath: instancePath + "/excludeExportRanges",
        parentData: data,
        parentDataProperty: "excludeExportRanges",
        rootData
      })) {
    ...
    if (data.uriRef !== undefined) {
      if (!validate22(data.uriRef, {
        instancePath: instancePath + "/uriRef",
        parentData: data,
        parentDataProperty: "uriRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate55(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.hubRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "hubRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.hubRef !== undefined) {
      if (!validate22(data.hubRef, {
        instancePath: instancePath + "/hubRef",
        parentData: data,
        parentDataProperty: "hubRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.linkedInterconnectAttachments !== undefined) {
      if (!validate39(data.linkedInterconnectAttachments, {
        instancePath: instancePath + "/linkedInterconnectAttachments",
        parentData: data,
        parentDataProperty: "linkedInterconnectAttachments",
        rootData
      })) {
    ...
    if (data.linkedRouterApplianceInstances !== undefined) {
      if (!validate58(data.linkedRouterApplianceInstances, {
        instancePath: instancePath + "/linkedRouterApplianceInstances",
        parentData: data,
        parentDataProperty: "linkedRouterApplianceInstances",
        rootData
      })) {
    ...
    if (data.linkedVPCNetwork !== undefined) {
      if (!validate73(data.linkedVPCNetwork, {
        instancePath: instancePath + "/linkedVPCNetwork",
        parentData: data,
        parentDataProperty: "linkedVPCNetwork",
        rootData
      })) {
    ...
    if (data.linkedVpnTunnels !== undefined) {
      if (!validate39(data.linkedVpnTunnels, {
        instancePath: instancePath + "/linkedVpnTunnels",
        parentData: data,
        parentDataProperty: "linkedVpnTunnels",
        rootData
      })) {
        vErrors = vErrors === null ? validate39.errors : vErrors.concat(validate39.errors);
        errors = vErrors.length;
...
function validate46(data, {
  ...
  /*# sourceURL="networkconnectivity.cnrm.cloud.google.com.v1beta1.NetworkConnectivitySpoke" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
