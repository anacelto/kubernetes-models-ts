...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "siCdvH8vNCmUeNAZGvM1mrY4dXXtNZTzhLfjrRGabU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "EB0oaejScldcvn8ddJpBSqhpm0kH6uvoMdWJv9pSAIk"
    },
    "status": {
  ...
  "$id": "dlp.cnrm.cloud.google.com.v1beta1.DLPStoredInfoType"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  ...
  "properties": {
    "dictionary": {
      "$ref": "mq2aAWivOVTS74eelEDk5qzKWvhk4mMdyWI6a9Dyk"
    },
    "displayName": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "largeCustomDictionary": {
      "$ref": "GIh2F65WL84JceTvSQJo4AwHaiorg0MRCdBtBIhkMCQ"
    },
    "location": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    ...
    "regex": {
      "$ref": "R3yOEQGW1K0r1pfLYoHlm2bjHM3cy29XHkAFkanMc"
    },
    "resourceID": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema24 = {
  "properties": {
    "cloudStoragePath": {
      "$ref": "JRWuXY0cmNZ8f9hBMSDiCO2QZg7wby10ZADCmZ15o"
    },
    "wordList": {
      "$ref": "UfnBz8EUUBloc1xpzwrKa552zKMz0J0nmnEnqi3zinM"
    }
  },
  "type": "object",
  "nullable": true
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cloudStoragePath !== undefined) {
      if (!validate39(data.cloudStoragePath, {
...
const schema27 = {
  "properties": {
    "bigQueryField": {
      "$ref": "cxaFeyIWesfmHUbCCLvs2E0pBPClZxHUPXwlJyaN3TI"
    },
    "cloudStorageFileSet": {
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.bigQueryField !== undefined) {
      if (!validate65(data.bigQueryField, {
        instancePath: instancePath + "/bigQueryField",
        parentData: data,
        parentDataProperty: "bigQueryField",
        rootData
      })) {
    ...
    if (data.cloudStorageFileSet !== undefined) {
      if (!validate75(data.cloudStorageFileSet, {
        instancePath: instancePath + "/cloudStorageFileSet",
        parentData: data,
        parentDataProperty: "cloudStorageFileSet",
        rootData
      })) {
    ...
    if (data.outputPath !== undefined) {
      if (!validate39(data.outputPath, {
        instancePath: instancePath + "/outputPath",
        parentData: data,
        parentDataProperty: "outputPath",
        rootData
      })) {
        vErrors = vErrors === null ? validate39.errors : vErrors.concat(validate39.errors);
        errors = vErrors.length;
...
function validate83(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.groupIndexes !== undefined) {
      if (!validate84(data.groupIndexes, {
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.largeCustomDictionary !== undefined) {
      if (!validate64(data.largeCustomDictionary, {
        instancePath: instancePath + "/largeCustomDictionary",
        parentData: data,
        parentDataProperty: "largeCustomDictionary",
        rootData
      })) {
    ...
    if (data.organizationRef !== undefined) {
      if (!validate23(data.organizationRef, {
...
function validate41(data, {
  ...
  /*# sourceURL="dlp.cnrm.cloud.google.com.v1beta1.DLPStoredInfoType" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
