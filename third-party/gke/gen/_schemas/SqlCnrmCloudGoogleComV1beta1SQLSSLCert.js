...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "zybxWXWjT8OEyaX0rE0gLn2ry75SKByCmzJyuESxHWo"
    },
    "kind": {
      "$ref": "WV2kZdK1QMusI80MXwWK9fDXFgqHVQVM6j3Tpbn4c"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "2cUnLdSOzi84cQUWccGe1noClA1uypNacuTwC0YtGo"
    },
    "status": {
      "$ref": "baoS4bjS6kmvEsn0srEi3YgAxoJGjd49E8zYp2RZp0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "sql.cnrm.cloud.google.com.v1beta1.SQLSSLCert"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "sql.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.instanceRef !== undefined) {
      if (!validate34(data.instanceRef, {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.certSerialNumber !== undefined) {
      if (!validate21(data.certSerialNumber, {
        instancePath: instancePath + "/certSerialNumber",
        parentData: data,
        parentDataProperty: "certSerialNumber",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.expirationTime !== undefined) {
      if (!validate21(data.expirationTime, {
        instancePath: instancePath + "/expirationTime",
        parentData: data,
        parentDataProperty: "expirationTime",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.serverCaCert !== undefined) {
      if (!validate21(data.serverCaCert, {
        instancePath: instancePath + "/serverCaCert",
        parentData: data,
        parentDataProperty: "serverCaCert",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="sql.cnrm.cloud.google.com.v1beta1.SQLSSLCert" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
