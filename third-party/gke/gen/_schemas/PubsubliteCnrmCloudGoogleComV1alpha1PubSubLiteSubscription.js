...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "Qa0Iq5tqXFilPJNdMYhkCsMvSf0tuHaCpt7rm0x7NsM"
    },
    "kind": {
      "$ref": "IjwZj5gSFkPrGxM44qDSyVB7KvmdF47tZNogsHkGo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "xIdj5D1F9vEokiCrpp4clnGgCbBs2Of0bhuAZObZA"
    },
    "status": {
  ...
  "$id": "pubsublite.cnrm.cloud.google.com.v1alpha1.PubSubLiteSubscription"
};
const schema9 = {
  "type": "string",
  "enum": ["pubsublite.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "pubsublite.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate26(data, {
  ...
  if (!(data === "PubSubLiteSubscription")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    "deliveryConfig": {
      "$ref": "9onH0KpfxcBsEOVIVri3HmS7XMwZ0JT8ZwoiMr2fU6o"
    },
    "projectRef": {
  ...
  "required": ["projectRef", "topic", "zone"],
  "type": "object"
};
const schema14 = {
  "properties": {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.deliveryRequirement === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "deliveryRequirement"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.deliveryRequirement !== undefined) {
      if (!validate22(data.deliveryRequirement, {
        instancePath: instancePath + "/deliveryRequirement",
        parentData: data,
        parentDataProperty: "deliveryRequirement",
        rootData
      })) {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deliveryConfig !== undefined) {
      if (!validate33(data.deliveryConfig, {
        instancePath: instancePath + "/deliveryConfig",
        parentData: data,
        parentDataProperty: "deliveryConfig",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="pubsublite.cnrm.cloud.google.com.v1alpha1.PubSubLiteSubscription" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
