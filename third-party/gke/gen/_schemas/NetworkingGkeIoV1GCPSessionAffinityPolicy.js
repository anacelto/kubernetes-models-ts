...
const schema6 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "yqJOH5rGMSQQ7RPtPnENpviz13Byf5q2sSJy2lV4"
    },
    "kind": {
      "$ref": "3dwvS7pq76b9Tn4GsafoX4k7YGCnVLz3zikcxqnls"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "MNgbPy7PJtlGb4zNWXukvrYUQ1YGfb8c5Sm3kyUVcGU"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1.GCPSessionAffinityPolicy"
};
const schema7 = {
  "type": "string",
...
function validate24(data, {
  ...
  if (!(data === "GCPSessionAffinityPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema11 = {
  "properties": {
    "statefulGeneratedCookie": {
      "$ref": "xC032HCtFobdy57SYkRGdcB9ZJZb1YFq2XouvwssyMQ"
    },
    "targetRef": {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cookieTtlSeconds === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "cookieTtlSeconds"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.cookieTtlSeconds !== undefined) {
      if (!validate32(data.cookieTtlSeconds, {
        instancePath: instancePath + "/cookieTtlSeconds",
        parentData: data,
        parentDataProperty: "cookieTtlSeconds",
        rootData
      })) {
...
function validate30(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.statefulGeneratedCookie !== undefined) {
      if (!validate31(data.statefulGeneratedCookie, {
        instancePath: instancePath + "/statefulGeneratedCookie",
        parentData: data,
        parentDataProperty: "statefulGeneratedCookie",
        rootData
      })) {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate49(data.lastTransitionTime, {
...
function validate21(data, {
  ...
  /*# sourceURL="networking.gke.io.v1.GCPSessionAffinityPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
