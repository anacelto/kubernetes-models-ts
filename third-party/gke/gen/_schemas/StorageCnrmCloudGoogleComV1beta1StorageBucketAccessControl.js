...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "4k7oRfhrWASi9hn5yDP1Ni4VEwrKFHImjkpQaLt3U"
    },
    "kind": {
      "$ref": "qSgESmXOpi29bmYNx5GqygUwvN7vD17nmvio2bM64"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "lDESw124rrlGATr5uLVr8fTwcrHOa6wS1JHJ4dPwU"
    },
    "status": {
      "$ref": "hrThvfeLA68uXFT2jw7k7nPAKsQfS5ZgTLReDD8c3I"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "storage.cnrm.cloud.google.com.v1beta1.StorageBucketAccessControl"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "storage.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate25(data, {
  ...
  if (!(data === "StorageBucketAccessControl")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="storage.cnrm.cloud.google.com.v1beta1.StorageBucketAccessControl" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
