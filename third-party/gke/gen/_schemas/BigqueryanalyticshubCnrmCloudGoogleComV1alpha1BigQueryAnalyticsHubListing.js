...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "EjmOdIi6Tj3K5w2vnyRoFa2jUeagwQ17Xmk1tJZmE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "2gTx54BJO6SHks7iz66AkRVsr4UCW13eXXXKJb1Ha9c"
    },
    "status": {
  ...
  "$id": "bigqueryanalyticshub.cnrm.cloud.google.com.v1alpha1.BigQueryAnalyticsHubListing"
};
const schema10 = {
  "type": "string",
...
const schema11 = {
  "type": "string",
  "enum": ["BigQueryAnalyticsHubListing"]
};
function validate29(data, {
  ...
  if (!(data === "BigQueryAnalyticsHubListing")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    "bigqueryDataset": {
      "$ref": "IYYHWTnBAZuHR7YP7HgLInPb44dYDKkStJg6UJBNs"
    },
    "categories": {
    ...
    "dataProvider": {
      "$ref": "qMcgPH9FjANcLWDwIcy919F8kjhdFoCQhb6WI"
    },
    "displayName": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
  ...
  "required": ["bigqueryDataset", "dataExchangeId", "displayName", "location", "projectRef"],
  "type": "object"
};
const schema15 = {
  "properties": {
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.primaryContact !== undefined) {
      if (!validate22(data.primaryContact, {
...
function validate35(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.bigqueryDataset === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "bigqueryDataset"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.dataExchangeId === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "dataExchangeId"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.bigqueryDataset !== undefined) {
      if (!validate36(data.bigqueryDataset, {
        instancePath: instancePath + "/bigqueryDataset",
        parentData: data,
        parentDataProperty: "bigqueryDataset",
        rootData
      })) {
    ...
    if (data.dataExchangeId !== undefined) {
      if (!validate21(data.dataExchangeId, {
        instancePath: instancePath + "/dataExchangeId",
        parentData: data,
        parentDataProperty: "dataExchangeId",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.dataProvider !== undefined) {
      if (!validate23(data.dataProvider, {
        instancePath: instancePath + "/dataProvider",
        parentData: data,
        parentDataProperty: "dataProvider",
        rootData
      })) {
    ...
    if (data.documentation !== undefined) {
      if (!validate22(data.documentation, {
    ...
    if (data.requestAccess !== undefined) {
      if (!validate22(data.requestAccess, {
        instancePath: instancePath + "/requestAccess",
        parentData: data,
        parentDataProperty: "requestAccess",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate26(data, {
  ...
  /*# sourceURL="bigqueryanalyticshub.cnrm.cloud.google.com.v1alpha1.BigQueryAnalyticsHubListing" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
