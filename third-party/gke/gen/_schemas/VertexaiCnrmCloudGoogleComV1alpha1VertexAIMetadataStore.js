...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "PS2Q3Hrpv1s9yc9XEti45umjvlP5nQPopcr9Ldg5Gc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "nszxaeWdi0hCgO9Apa1rQkgswXeFbecVVG7ScnUe8"
    },
    "status": {
      "$ref": "LZWt7QvHbsn3JnY0jYhClIGga5cCCEtG5ruBNz9ChL8"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIMetadataStore"
};
const schema8 = {
  "type": "string",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.encryptionSpec !== undefined) {
      if (!validate32(data.encryptionSpec, {
...
const schema22 = {
  "properties": {
    ...
    "state": {
      "$ref": "ypRbPKmKC8F0QIzrLPG7WwzPiUcXp12JUrkRiuHfaz0"
    },
    "updateTime": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema26 = {
  "items": {
    "$ref": "8lRXjZCYfy21hFK4RmnWlrdv1EntTHgCrpVRpc4no"
  },
  "type": "array",
  "nullable": true
};
...
function validate70(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.diskUtilizationBytes !== undefined) {
      if (!validate21(data.diskUtilizationBytes, {
        instancePath: instancePath + "/diskUtilizationBytes",
        parentData: data,
        parentDataProperty: "diskUtilizationBytes",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIMetadataStore" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
