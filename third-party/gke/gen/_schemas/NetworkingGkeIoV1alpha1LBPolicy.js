...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "21OiREBUrdk28aVa1mKiGoCU9xieowM4yYymFRNmR0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "WrSkh1DXStFJI2amzG4dOTPqDzA6KZihLuYMKawc8"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1alpha1.LBPolicy"
};
const schema8 = {
  "type": "string",
...
const schema12 = {
  "properties": {
    "default": {
      "$ref": "gyaklXe9e4OCyH8TAHHyU7fdq93wrd9dJGfoV4eMEA"
    },
    "targetRef": {
...
const schema13 = {
  "properties": {
    ...
    "healthCheck": {
      "$ref": "tFSRP1KoRtRJZ92GVeOV3jty5IJuZhTHsKVNooQ"
    },
    "logging": {
      "$ref": "MrvldcxNN6wqTez3vg4q2LlB8857fs0HmDI80yJbeFM"
    },
    "sessionAffinity": {
      "$ref": "eVA7GDQMY4PBrA26HHpJdo8TYmyNQhIgeadDABdk"
    },
    "timeoutSec": {
...
const schema15 = {
  "properties": {
    ...
    "requestPath": {
      "$ref": "fa9fVXWiUesSMGAnXrC3NuCYApyyoax59kC571p4CQ"
    },
    "timeoutSec": {
      "$ref": "Sg5VMnp9PeciTWOOocDxVZ8KL974mKlNPE7Z3LxfFY"
    },
    "type": {
      "$ref": "nGjLM1cQGZvb7Wn7AVyA7dALpw5edKfxwxkcVFtkT0"
    },
    "unhealthyThreshold": {
      "$ref": "Sg5VMnp9PeciTWOOocDxVZ8KL974mKlNPE7Z3LxfFY"
    }
...
function validate43(data, {
  ...
  if (!(data === "HTTP" || data === "HTTPS" || data === "HTTP2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.requestPath !== undefined) {
      if (!validate40(data.requestPath, {
...
const schema22 = {
  "properties": {
    "affinityCookieTtlSec": {
      "$ref": "sgw1feRizFxtalssJLyp2nxbTf6aKcXM0tgGKG1IBjI"
    },
    "affinityType": {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.affinityCookieTtlSec !== undefined) {
      if (!validate54(data.affinityCookieTtlSec, {
    ...
    if (data.affinityType !== undefined) {
      if (!validate56(data.affinityType, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.connectionDrainingTimeoutSec !== undefined) {
      if (!validate33(data.connectionDrainingTimeoutSec, {
    ...
    if (data.healthCheck !== undefined) {
      if (!validate35(data.healthCheck, {
...
function validate75(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate76(data.lastTransitionTime, {
...
function validate22(data, {
  ...
  /*# sourceURL="networking.gke.io.v1alpha1.LBPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
