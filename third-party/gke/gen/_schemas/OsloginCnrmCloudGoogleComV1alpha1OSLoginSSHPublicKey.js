...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "ANlDK6NUEw3f6y6oTfYPTzJ1TWrT3Sg1qXIxOESaqyE"
    },
    "kind": {
      "$ref": "OtLg0ufIm9oiuCHUBXNZav045r0FwPgHR4S8cn3lM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "c94yZZWCKLNEoiNp9yFi9Pkf7cs4aONloIN2vuo44"
    },
    "status": {
      "$ref": "mFJEjx56SKzBsM5gVtMSB8qoSZdvXo6UOl3LUH42s"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "oslogin.cnrm.cloud.google.com.v1alpha1.OSLoginSSHPublicKey"
};
const schema9 = {
  "type": "string",
  "enum": ["oslogin.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "oslogin.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.expirationTimeUsec !== undefined) {
      if (!validate21(data.expirationTimeUsec, {
        instancePath: instancePath + "/expirationTimeUsec",
        parentData: data,
        parentDataProperty: "expirationTimeUsec",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="oslogin.cnrm.cloud.google.com.v1alpha1.OSLoginSSHPublicKey" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
