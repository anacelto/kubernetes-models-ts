...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "n8SzCCEO1UTZGuv2Z0LcvL04vsUUAAqfv0OTTtnTZTY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "w53jo5ZzpoaoikFDYeDcSNMfi0OT7jXpkqtVdmmnVs"
    },
    "status": {
      "$ref": "B49k6iJOHjgI0Z2uaD5Tk9LPdLQYY7WUJNMU2SoPqlo"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeMachineImage"
};
const schema15 = {
  "type": "string",
...
const schema19 = {
  "properties": {
    ...
    "machineImageEncryptionKey": {
      "$ref": "CmlHNLcErgnP3OE5auAmuFmNuCql9gdNzuaVt3Vy65I"
    },
    "projectRef": {
  ...
  "required": ["projectRef", "sourceInstanceRef"],
  "type": "object"
};
const schema20 = {
  "type": "boolean",
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.kmsKeyServiceAccount !== undefined) {
      if (!validate21(data.kmsKeyServiceAccount, {
        instancePath: instancePath + "/kmsKeyServiceAccount",
        parentData: data,
        parentDataProperty: "kmsKeyServiceAccount",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.machineImageEncryptionKey !== undefined) {
      if (!validate50(data.machineImageEncryptionKey, {
        instancePath: instancePath + "/machineImageEncryptionKey",
        parentData: data,
        parentDataProperty: "machineImageEncryptionKey",
        rootData
      })) {
    ...
    if (data.sourceInstanceRef !== undefined) {
      if (!validate22(data.sourceInstanceRef, {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.storageLocations !== undefined) {
      if (!validate73(data.storageLocations, {
...
function validate38(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeMachineImage" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
