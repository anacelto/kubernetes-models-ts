...
const schema24 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "rEH4seSHdjrd4YCl7daFe9oWTVmkOLVyiSkwn1XBXVM"
    },
    "kind": {
      "$ref": "YKG4cORUKhU79S5THmzCK0nEZkN0BasFLaOlDDIytj4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "k7pFNiQkiv53ywu4JM44PqJUQZ2xya6yyiWaHOdBxg"
    },
    "status": {
      "$ref": "fdq8PpKtvyHXv8qjTvYi9rwrBpMFeUsw7vBCD7BZ20"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "run.cnrm.cloud.google.com.v1beta1.RunService"
};
const schema25 = {
  "type": "string",
...
function validate64(data, {
  ...
  if (!(data === "run.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema29 = {
  "properties": {
    ...
    "binaryAuthorization": {
      "$ref": "UGlvCMwxla3PnArh09jlk92B5WT1nITo22fQyWrIKg"
    },
    "client": {
    ...
    "template": {
      "$ref": "3lUuclv987dqe7Y0LZGlVp25QiOc5G1mizVPRPhAHKk"
    },
    "traffic": {
      "$ref": "5wqXZPynogmXGkfp0cbXJCh06pVzpUWPUNMv0BjTE"
    }
  },
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.breakglassJustification !== undefined) {
      if (!validate21(data.breakglassJustification, {
        instancePath: instancePath + "/breakglassJustification",
        parentData: data,
        parentDataProperty: "breakglassJustification",
        rootData
      })) {
    ...
    if (data.useDefault !== undefined) {
      if (!validate44(data.useDefault, {
        instancePath: instancePath + "/useDefault",
        parentData: data,
        parentDataProperty: "useDefault",
        rootData
      })) {
...
const schema31 = {
  "properties": {
    ...
    "containers": {
      "$ref": "cHMo3qRc7oTF2HWzXf1rRTBFMoVl0FpIVqQ5tKiWk"
    },
    "encryptionKeyRef": {
    ...
    "scaling": {
      "$ref": "kHQ4Get5PyDxiLvQhPgO2he0WWjXCAwOu4k22aIds"
    },
    "serviceAccountRef": {
      "$ref": "FqwG3fNQDV94n3ssyud4YO0vSjAbQTxNuU0XWG96Y"
    },
    ...
    "volumes": {
      "$ref": "QT31V1EvR781mQmtFbTRe3YQH082LS6augAyDPg"
    },
    "vpcAccess": {
      "$ref": "34jAYpTgeSziFeuFUUM1r35ziYPNeU8G3lzTYluzg"
    }
  },
  "type": "object"
};
const schema32 = {
  "items": {
    "$ref": "BVkGrERwRF1KLbJK446et9DVCBoPmw1lsnHiJ8sqI"
  },
  "type": "array",
  "nullable": true
};
const schema33 = {
  "properties": {
    ...
    "env": {
      "$ref": "Em8RYqkypTwee2eIubCxi1ZEV6fLtA25aTtEqhkc"
    },
    "image": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    "livenessProbe": {
      "$ref": "biVblM5mJFgbK1GzFT4ZW5Gc8Lhui3S2e3kg5Dr3I"
    },
    "name": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "ports": {
      "$ref": "eWnokKudMQDaKGvv30owh4Igefkw8b1EnPAdZueWv4"
    },
    "resources": {
      "$ref": "iaWs8l5D0xJvYYbiIO9ZRjCJKtjstl0Yan4tmuJc2Q"
    },
    "startupProbe": {
      "$ref": "QK9pwxlTbZHPs8AWnendBmLlHbt1qEDXVCMGeLltbs"
    },
    "volumeMounts": {
...
const schema34 = {
  "items": {
    "$ref": "gtqvvXvGv34DT8BlISCfbJjp7pHbSGPN5I6ZzSKCaM"
  },
  "type": "array",
  "nullable": true
};
const schema35 = {
  "properties": {
    ...
    "valueSource": {
      "$ref": "7ZVkZyxrxV5YsaTJ7GnL9SFSWsBEGm2sCn1H23K4mo"
    }
  },
  "required": ["name"],
  "type": "object"
...
const schema36 = {
  "properties": {
    "secretKeyRef": {
      "$ref": "LeEKVJnnanNUUZtQcsA8DLd471C7ps0YiN2wPlstY"
    }
  },
  "type": "object",
  "nullable": true
...
function validate97(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretKeyRef !== undefined) {
      if (!validate98(data.secretKeyRef, {
...
function validate94(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.valueSource !== undefined) {
      if (!validate97(data.valueSource, {
        instancePath: instancePath + "/valueSource",
        parentData: data,
        parentDataProperty: "valueSource",
        rootData
      })) {
...
const schema38 = {
  "properties": {
    ...
    "grpc": {
      "$ref": "jLW85M9QfTrlSogQMRCqbTrz2Wj1SE5StsBvDWWwec"
    },
    "httpGet": {
      "$ref": "Y1mxtjRMpEsosTBXzER8wFj7zosG2jIIegpiwZdRFY"
    },
    "initialDelaySeconds": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    },
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.httpHeaders !== undefined) {
      if (!validate49(data.httpHeaders, {
...
function validate106(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.failureThreshold !== undefined) {
      if (!validate43(data.failureThreshold, {
    ...
    if (data.initialDelaySeconds !== undefined) {
      if (!validate43(data.initialDelaySeconds, {
    ...
    if (data.periodSeconds !== undefined) {
      if (!validate43(data.periodSeconds, {
    ...
    if (data.timeoutSeconds !== undefined) {
      if (!validate43(data.timeoutSeconds, {
...
const schema39 = {
  "items": {
    "$ref": "0BfBxULJFfaLwmoe4O3fKOdemvhu3mvO5eehOZAwE"
  },
  "type": "array",
  "nullable": true
};
...
function validate116(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.containerPort !== undefined) {
      if (!validate43(data.containerPort, {
...
function validate121(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cpuIdle !== undefined) {
      if (!validate44(data.cpuIdle, {
        instancePath: instancePath + "/cpuIdle",
        parentData: data,
        parentDataProperty: "cpuIdle",
        rootData
      })) {
        vErrors = vErrors === null ? validate44.errors : vErrors.concat(validate44.errors);
        errors = vErrors.length;
    ...
    if (data.startupCpuBoost !== undefined) {
      if (!validate44(data.startupCpuBoost, {
        instancePath: instancePath + "/startupCpuBoost",
        parentData: data,
        parentDataProperty: "startupCpuBoost",
        rootData
      })) {
        vErrors = vErrors === null ? validate44.errors : vErrors.concat(validate44.errors);
        errors = vErrors.length;
...
const schema42 = {
  "properties": {
    ...
    "tcpSocket": {
      "$ref": "9zaR4RhAWYGS4xaBPJFjyj3vVAx3tx9AnEH42wSE"
    },
    "timeoutSeconds": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    }
...
function validate89(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.livenessProbe !== undefined) {
      if (!validate106(data.livenessProbe, {
    ...
    if (data.startupProbe !== undefined) {
      if (!validate126(data.startupProbe, {
...
function validate151(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.maxInstanceCount !== undefined) {
      if (!validate43(data.maxInstanceCount, {
        instancePath: instancePath + "/maxInstanceCount",
        parentData: data,
        parentDataProperty: "maxInstanceCount",
        rootData
      })) {
        vErrors = vErrors === null ? validate43.errors : vErrors.concat(validate43.errors);
        errors = vErrors.length;
    ...
    if (data.minInstanceCount !== undefined) {
      if (!validate43(data.minInstanceCount, {
        instancePath: instancePath + "/minInstanceCount",
        parentData: data,
        parentDataProperty: "minInstanceCount",
        rootData
      })) {
        vErrors = vErrors === null ? validate43.errors : vErrors.concat(validate43.errors);
        errors = vErrors.length;
...
const schema47 = {
  "items": {
    "$ref": "RfxPRavuLYvRR9XWgPIbXBojiIUIcPkvKDHV0RH4"
  },
  "type": "array",
  "nullable": true
};
const schema48 = {
  "properties": {
    "cloudSqlInstance": {
      "$ref": "g99cRDBeb0H5NhOTddlq0HAh8IZZxvmaDVBfYy2X4xA"
    },
    "emptyDir": {
      "$ref": "978Ywm80V0T5RohZB0fq9O8fmvrWTXmu13sfn4Ah40"
    },
    "name": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    "secret": {
      "$ref": "8tpFsHBC0KeQ84J2FKlJ33IuvF03dPBZe0eJ7HtuY"
    }
  },
  "required": ["name"],
  "type": "object"
...
const schema52 = {
  "properties": {
    ...
    "items": {
      "$ref": "ah4LT1gbQPOMaaSPBfJv6YnOjfshRW6HEzFNgMuQc"
    },
    "secretRef": {
      "$ref": "jO1fsDyaXk8R682yU9au3UFcW8lqIiAbXrerzENnRTc"
    }
...
const schema53 = {
  "items": {
    "$ref": "vJtEzYUVEH2tvbctp3Gh00TJuZI5rpm66Cbx0Ehg"
  },
  "type": "array",
  "nullable": true
};
...
function validate170(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultMode !== undefined) {
      if (!validate43(data.defaultMode, {
...
function validate159(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cloudSqlInstance !== undefined) {
      if (!validate160(data.cloudSqlInstance, {
        instancePath: instancePath + "/cloudSqlInstance",
        parentData: data,
        parentDataProperty: "cloudSqlInstance",
        rootData
      })) {
...
const schema55 = {
  "properties": {
    ...
    "networkInterfaces": {
      "$ref": "X31hltzkVb4l5bvV4iTv216jdXllI1BZIsra1Fn8"
    }
  },
  "type": "object",
  "nullable": true
...
const schema56 = {
  "items": {
    "$ref": "cj6sDPW6p7Bv2jLIHFoSM0VFRqUQRaA4fMZIF3Z5WPk"
  },
  "type": "array",
  "nullable": true
};
...
function validate187(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.subnetworkRef !== undefined) {
      if (!validate57(data.subnetworkRef, {
...
function validate183(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.connectorRef !== undefined) {
      if (!validate57(data.connectorRef, {
        instancePath: instancePath + "/connectorRef",
        parentData: data,
        parentDataProperty: "connectorRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate57.errors : vErrors.concat(validate57.errors);
        errors = vErrors.length;
    ...
    if (data.networkInterfaces !== undefined) {
      if (!validate186(data.networkInterfaces, {
        instancePath: instancePath + "/networkInterfaces",
        parentData: data,
        parentDataProperty: "networkInterfaces",
        rootData
      })) {
...
function validate86(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.encryptionKeyRef !== undefined) {
      if (!validate57(data.encryptionKeyRef, {
        instancePath: instancePath + "/encryptionKeyRef",
        parentData: data,
        parentDataProperty: "encryptionKeyRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate57.errors : vErrors.concat(validate57.errors);
        errors = vErrors.length;
    ...
    if (data.executionEnvironment !== undefined) {
      if (!validate21(data.executionEnvironment, {
        instancePath: instancePath + "/executionEnvironment",
        parentData: data,
        parentDataProperty: "executionEnvironment",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.maxInstanceRequestConcurrency !== undefined) {
      if (!validate43(data.maxInstanceRequestConcurrency, {
        instancePath: instancePath + "/maxInstanceRequestConcurrency",
        parentData: data,
        parentDataProperty: "maxInstanceRequestConcurrency",
        rootData
      })) {
        vErrors = vErrors === null ? validate43.errors : vErrors.concat(validate43.errors);
        errors = vErrors.length;
    ...
    if (data.scaling !== undefined) {
      if (!validate151(data.scaling, {
        instancePath: instancePath + "/scaling",
        parentData: data,
        parentDataProperty: "scaling",
        rootData
      })) {
    ...
    if (data.serviceAccountRef !== undefined) {
      if (!validate57(data.serviceAccountRef, {
    ...
    if (data.sessionAffinity !== undefined) {
      if (!validate44(data.sessionAffinity, {
    ...
    if (data.vpcAccess !== undefined) {
      if (!validate183(data.vpcAccess, {
        instancePath: instancePath + "/vpcAccess",
        parentData: data,
        parentDataProperty: "vpcAccess",
        rootData
      })) {
...
const schema58 = {
  "items": {
    "$ref": "uuQHvrtGutlnPlsmCffPHxkGBn6mKNhPf73ORAtQ"
  },
  "type": "array",
  "nullable": true
};
...
function validate72(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.binaryAuthorization !== undefined) {
      if (!validate74(data.binaryAuthorization, {
    ...
    if (data.clientVersion !== undefined) {
      if (!validate21(data.clientVersion, {
        instancePath: instancePath + "/clientVersion",
        parentData: data,
        parentDataProperty: "clientVersion",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.customAudiences !== undefined) {
      if (!validate25(data.customAudiences, {
        instancePath: instancePath + "/customAudiences",
        parentData: data,
        parentDataProperty: "customAudiences",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
    ...
    if (data.launchStage !== undefined) {
      if (!validate21(data.launchStage, {
        instancePath: instancePath + "/launchStage",
        parentData: data,
        parentDataProperty: "launchStage",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema60 = {
  "properties": {
    ...
    "terminalCondition": {
      "$ref": "gtviubbVCUISqKDvujp0XljqPc6xEBINmaC2g2A3IU"
    },
    "trafficStatuses": {
      "$ref": "2mJCYUQp4XiEa2Aot9qAZBmq3DMkh7iOnfR8aP2tGk"
    },
    "uid": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
function validate224(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.revisionReason !== undefined) {
      if (!validate21(data.revisionReason, {
        instancePath: instancePath + "/revisionReason",
        parentData: data,
        parentDataProperty: "revisionReason",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
const schema64 = {
  "items": {
    "$ref": "D27GSsr05lG6dscPAiAD3DndDUYhL5aLLlZfco674"
  },
  "type": "array",
  "nullable": true
};
...
function validate204(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate205(data.conditions, {
    ...
    if (data.creator !== undefined) {
      if (!validate21(data.creator, {
        instancePath: instancePath + "/creator",
        parentData: data,
        parentDataProperty: "creator",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.lastModifier !== undefined) {
      if (!validate21(data.lastModifier, {
        instancePath: instancePath + "/lastModifier",
        parentData: data,
        parentDataProperty: "lastModifier",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.latestCreatedRevision !== undefined) {
      if (!validate21(data.latestCreatedRevision, {
        instancePath: instancePath + "/latestCreatedRevision",
        parentData: data,
        parentDataProperty: "latestCreatedRevision",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.latestReadyRevision !== undefined) {
      if (!validate21(data.latestReadyRevision, {
        instancePath: instancePath + "/latestReadyRevision",
        parentData: data,
        parentDataProperty: "latestReadyRevision",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.reconciling !== undefined) {
      if (!validate44(data.reconciling, {
    ...
    if (data.terminalCondition !== undefined) {
      if (!validate224(data.terminalCondition, {
        instancePath: instancePath + "/terminalCondition",
        parentData: data,
        parentDataProperty: "terminalCondition",
        rootData
      })) {
    ...
    if (data.trafficStatuses !== undefined) {
      if (!validate233(data.trafficStatuses, {
        instancePath: instancePath + "/trafficStatuses",
        parentData: data,
        parentDataProperty: "trafficStatuses",
        rootData
      })) {
...
function validate63(data, {
  ...
  /*# sourceURL="run.cnrm.cloud.google.com.v1beta1.RunService" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
