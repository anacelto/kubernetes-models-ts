...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "8GHJQbdPLcN9uhsbBvD4m3jPloLj7r4HSItgfSinVs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "dtUVLGoi7iEBqIbASAosqb6uir03AB8QqjjC6W5c"
    },
    "status": {
      "$ref": "hN5HI4vJMnQHfJPrEHB1F8vEabvVttveW82IQHc2noo"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeSSLCertificate"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    "certificate": {
      "$ref": "pPHCiI9M7cVAFrivBRH54drqpY71RckQO0XToBejnA"
    },
    "location": {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificateId !== undefined) {
      if (!validate39(data.certificateId, {
    ...
    if (data.creationTimestamp !== undefined) {
      if (!validate31(data.creationTimestamp, {
...
function validate40(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeSSLCertificate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
