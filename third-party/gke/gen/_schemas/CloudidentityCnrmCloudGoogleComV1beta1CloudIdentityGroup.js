...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "EuP3WNi88qRMo3ZXwwla6PUtFZZTx2JoZ3NTgIcEmT4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "lZbBq1E2I4udKchPYvtymCplJdS08Z6TmsJwuU7KYo"
    },
    "status": {
  ...
  "$id": "cloudidentity.cnrm.cloud.google.com.v1beta1.CloudIdentityGroup"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.initialGroupConfig !== undefined) {
      if (!validate21(data.initialGroupConfig, {
        instancePath: instancePath + "/initialGroupConfig",
        parentData: data,
        parentDataProperty: "initialGroupConfig",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="cloudidentity.cnrm.cloud.google.com.v1beta1.CloudIdentityGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
