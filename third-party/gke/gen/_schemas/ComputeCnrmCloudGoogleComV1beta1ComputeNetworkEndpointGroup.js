...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "4vMeE5BNYeWMG2oD286EqwTzLvbpGE3K5R7LzjGxM0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "0OkmE8xs3zONJwWsDhjtVkuzBoaWikNXV0xvnkRQ"
    },
    "status": {
      "$ref": "SOw2caViYfn6ckap6ejE9GRdxGGJ7NqJoag8GnXTg"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeNetworkEndpointGroup"
};
const schema15 = {
  "type": "string",
...
function validate36(data, {
  ...
  if (!(data === "ComputeNetworkEndpointGroup")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.defaultPort !== undefined) {
      if (!validate32(data.defaultPort, {
    ...
    if (data.subnetworkRef !== undefined) {
      if (!validate55(data.subnetworkRef, {
...
function validate33(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeNetworkEndpointGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
