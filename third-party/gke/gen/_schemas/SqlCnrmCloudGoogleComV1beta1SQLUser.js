...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "rMPdGlVRLhkNsn9udqNJvGv911OObLkXpZQLzckHIqY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "wgB9G7KCv0IyRVrHqY1ZUbq57PKb0tZLguck3KZPv3o"
    },
    "status": {
      "$ref": "r03AeDx5rXl8gw3Hk9D5RbJqWC1kQ8T4nNfeVdI"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "sql.cnrm.cloud.google.com.v1beta1.SQLUser"
};
const schema11 = {
  "type": "string",
...
const schema15 = {
  "properties": {
    ...
    "passwordPolicy": {
      "$ref": "BzxO4F3oQd2xSYRcLWXStI0ZZYEdMjJ3hJnRBcuSoY"
    },
    "resourceID": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema30 = {
  "properties": {
    ...
    "status": {
      "$ref": "S8qYSFZiirDoglQ0sDpup02SsY5R0ot3MO59lVjUNo"
    }
  },
  "type": "object",
  "nullable": true
...
const schema31 = {
  "items": {
    "$ref": "XNg9ZkIDc673EOSvlfIWjkcRXxzF6SoiDohq6Vgq8k"
  },
  "type": "array",
  "nullable": true
};
...
function validate76(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.passwordExpirationTime !== undefined) {
      if (!validate21(data.passwordExpirationTime, {
        instancePath: instancePath + "/passwordExpirationTime",
        parentData: data,
        parentDataProperty: "passwordExpirationTime",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowedFailedAttempts !== undefined) {
      if (!validate24(data.allowedFailedAttempts, {
        instancePath: instancePath + "/allowedFailedAttempts",
        parentData: data,
        parentDataProperty: "allowedFailedAttempts",
        rootData
      })) {
    ...
    if (data.enableFailedAttemptsCheck !== undefined) {
      if (!validate23(data.enableFailedAttemptsCheck, {
        instancePath: instancePath + "/enableFailedAttemptsCheck",
        parentData: data,
        parentDataProperty: "enableFailedAttemptsCheck",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.enablePasswordVerification !== undefined) {
      if (!validate23(data.enablePasswordVerification, {
        instancePath: instancePath + "/enablePasswordVerification",
        parentData: data,
        parentDataProperty: "enablePasswordVerification",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.passwordExpirationDuration !== undefined) {
      if (!validate21(data.passwordExpirationDuration, {
        instancePath: instancePath + "/passwordExpirationDuration",
        parentData: data,
        parentDataProperty: "passwordExpirationDuration",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.instanceRef !== undefined) {
      if (!validate36(data.instanceRef, {
    ...
    if (data.passwordPolicy !== undefined) {
      if (!validate70(data.passwordPolicy, {
        instancePath: instancePath + "/passwordPolicy",
        parentData: data,
        parentDataProperty: "passwordPolicy",
        rootData
      })) {
...
const schema33 = {
  "properties": {
    ...
    "sqlServerUserDetails": {
      "$ref": "BroNZYNOhI5DdMEeiky52FRkNiOg71tuJPw8h4Y60"
    }
  },
  "type": "object",
  "nullable": true
...
const schema36 = {
  "items": {
    "$ref": "f0ctFVQr7RpfU0zFmK0ZyNo8lGZ9iS80vTz61IGxKk"
  },
  "type": "array",
  "nullable": true
};
...
function validate97(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.serverRoles !== undefined) {
      if (!validate99(data.serverRoles, {
        instancePath: instancePath + "/serverRoles",
        parentData: data,
        parentDataProperty: "serverRoles",
        rootData
      })) {
...
function validate85(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sqlServerUserDetails !== undefined) {
      if (!validate96(data.sqlServerUserDetails, {
        instancePath: instancePath + "/sqlServerUserDetails",
        parentData: data,
        parentDataProperty: "sqlServerUserDetails",
        rootData
      })) {
...
function validate25(data, {
  ...
  /*# sourceURL="sql.cnrm.cloud.google.com.v1beta1.SQLUser" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
