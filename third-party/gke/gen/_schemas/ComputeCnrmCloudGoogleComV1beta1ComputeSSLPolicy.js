...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "TV9zCumsqXsbluLk0tEkraasSgHLcBJi92FZ8lNt4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "FqCArh4bnIcWYx4AXMmMefMdNXJn47JMeCJ1IZPYA"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeSSLPolicy"
};
const schema10 = {
  "type": "string",
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.customFeatures !== undefined) {
      if (!validate22(data.customFeatures, {
...
function validate40(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.enabledFeatures !== undefined) {
      if (!validate22(data.enabledFeatures, {
...
function validate25(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeSSLPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
