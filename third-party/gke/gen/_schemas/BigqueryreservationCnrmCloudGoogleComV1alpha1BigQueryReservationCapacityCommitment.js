...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "v5NddisiBVBwxO1Z1miAKZrMUxuWFH5X1X4gqQwdM"
    },
    "kind": {
      "$ref": "XzUYEpJbZDQ1bH6wS1yjyPifkyIZm7cGqMilbn2Ceo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "uOdxukpbvzRFqiCqadJugjUaBKNXo0BHgCEageuqZY"
    },
    "status": {
      "$ref": "Wh0WGYImS87N1zaCKJDTnACR7Ul1BOdonymLv4e2v64"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "bigqueryreservation.cnrm.cloud.google.com.v1alpha1.BigQueryReservationCapacityCommitment"
};
const schema9 = {
  "type": "string",
  "enum": ["bigqueryreservation.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "bigqueryreservation.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema10 = {
  "type": "string",
  "enum": ["BigQueryReservationCapacityCommitment"]
};
function validate26(data, {
  ...
  if (!(data === "BigQueryReservationCapacityCommitment")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["location", "plan", "projectRef", "slotCount"],
  "type": "object"
};
const schema6 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.edition !== undefined) {
      if (!validate21(data.edition, {
        instancePath: instancePath + "/edition",
        parentData: data,
        parentDataProperty: "edition",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.enforceSingleAdminProjectPerOrg !== undefined) {
      if (!validate21(data.enforceSingleAdminProjectPerOrg, {
        instancePath: instancePath + "/enforceSingleAdminProjectPerOrg",
        parentData: data,
        parentDataProperty: "enforceSingleAdminProjectPerOrg",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.renewalPlan !== undefined) {
      if (!validate21(data.renewalPlan, {
        instancePath: instancePath + "/renewalPlan",
        parentData: data,
        parentDataProperty: "renewalPlan",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.slotCount !== undefined) {
      if (!validate56(data.slotCount, {
        instancePath: instancePath + "/slotCount",
        parentData: data,
        parentDataProperty: "slotCount",
        rootData
      })) {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.commitmentEndTime !== undefined) {
      if (!validate21(data.commitmentEndTime, {
        instancePath: instancePath + "/commitmentEndTime",
        parentData: data,
        parentDataProperty: "commitmentEndTime",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.commitmentStartTime !== undefined) {
      if (!validate21(data.commitmentStartTime, {
        instancePath: instancePath + "/commitmentStartTime",
        parentData: data,
        parentDataProperty: "commitmentStartTime",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate23(data, {
  ...
  /*# sourceURL="bigqueryreservation.cnrm.cloud.google.com.v1alpha1.BigQueryReservationCapacityCommitment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
