...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "Nmhab53LnLWFFHjJHR5N15BBa2TBnHzLVsxNc26NVM"
    },
    "kind": {
      "$ref": "fQdWSXCypz9O8HRhsNmcLVJnETzJZNI7h3bCJdxGU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "famScd9jcgMTSAhPycyB3Ure9hm0GNsTKe1ugjf0MM"
    },
    "status": {
      "$ref": "Mo05DUcN5zLoABWY48CgLoq1HN08Jz2RYveRw5kNzk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "firebasedatabase.cnrm.cloud.google.com.v1alpha1.FirebaseDatabaseInstance"
};
const schema8 = {
  "type": "string",
  "enum": ["firebasedatabase.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "firebasedatabase.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate25(data, {
  ...
  if (!(data === "FirebaseDatabaseInstance")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.databaseUrl !== undefined) {
      if (!validate21(data.databaseUrl, {
        instancePath: instancePath + "/databaseUrl",
        parentData: data,
        parentDataProperty: "databaseUrl",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="firebasedatabase.cnrm.cloud.google.com.v1alpha1.FirebaseDatabaseInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
