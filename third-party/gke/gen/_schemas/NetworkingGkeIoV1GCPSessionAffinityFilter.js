...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "dpxqjnVulfH42KUHpBx0aWb56OAboRfUzVOckSaSHM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "hde4G6cxAOKyZWmFVYBVWNyLib1x3Nwr8BxsPAhMOg"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1.GCPSessionAffinityFilter"
};
const schema7 = {
  "type": "string",
...
function validate24(data, {
  ...
  if (!(data === "GCPSessionAffinityFilter")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  /*# sourceURL="networking.gke.io.v1.GCPSessionAffinityFilter" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
