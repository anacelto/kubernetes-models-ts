...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "iGMlGa1xVbWRrC0r8IybiOtOZYrwGGEhzCHX2nnVQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "7XfOdJwHZB3y6wcoaQS3VhTOaNYYCeLmF0fsCQoLdd0"
    },
    "status": {
  ...
  "$id": "networking.gke.io.v1.GCPTrafficDistributionPolicy"
};
const schema8 = {
  "type": "string",
...
const schema9 = {
  "type": "string",
  "enum": ["GCPTrafficDistributionPolicy"]
};
function validate25(data, {
  ...
  if (!(data === "GCPTrafficDistributionPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "properties": {
    "default": {
      "$ref": "1V2OZrawylDUoIW751N7HWozFwDk1RmD0wGGMK1s"
    },
    "targetRefs": {
...
const schema13 = {
  "properties": {
    "autoCapacityDrain": {
      "$ref": "s2YSfGwb4s5rhaXiaaqGKRg1X9wMO2mAGk20hLKM0OM"
    },
    "failoverConfig": {
      "$ref": "7r0JvtohuKJ4h1VdjFxsLed0gTQJWBGNtEUNuJ3NSs"
    },
    "localityLbAlgorithm": {
      "$ref": "i8PticpezZlGMfvGViN6qORZBufAxLx8pbVHFtzdAkU"
    },
    "serviceLbAlgorithm": {
      "$ref": "xSpAMztmkCR178C5LJ2c7GGkIuOW9JfHwn3NnxQmZM"
    }
  },
  "type": "object",
  "nullable": true
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.enableAutoCapacityDrain !== undefined) {
      if (!validate34(data.enableAutoCapacityDrain, {
        instancePath: instancePath + "/enableAutoCapacityDrain",
        parentData: data,
        parentDataProperty: "enableAutoCapacityDrain",
        rootData
      })) {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.failoverHealthThreshold !== undefined) {
      if (!validate38(data.failoverHealthThreshold, {
        instancePath: instancePath + "/failoverHealthThreshold",
        parentData: data,
        parentDataProperty: "failoverHealthThreshold",
        rootData
      })) {
...
const schema18 = {
  "enum": ["ROUND_ROBIN", "LEAST_REQUEST", "RING_HASH", "RANDOM", "ORIGINAL_DESTINATION", "MAGLEV", "WEIGHTED_ROUND_ROBIN"],
  "type": "string",
  "nullable": true
};
function validate41(data, {
  ...
  if (!(data === "ROUND_ROBIN" || data === "LEAST_REQUEST" || data === "RING_HASH" || data === "RANDOM" || data === "ORIGINAL_DESTINATION" || data === "MAGLEV" || data === "WEIGHTED_ROUND_ROBIN")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  "enum": ["SPRAY_TO_REGION", "WATERFALL_BY_ZONE", "WATERFALL_BY_REGION"],
  "type": "string",
  "nullable": true
};
function validate43(data, {
  ...
  if (!(data === "SPRAY_TO_REGION" || data === "WATERFALL_BY_ZONE" || data === "WATERFALL_BY_REGION")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.autoCapacityDrain !== undefined) {
      if (!validate33(data.autoCapacityDrain, {
        instancePath: instancePath + "/autoCapacityDrain",
        parentData: data,
        parentDataProperty: "autoCapacityDrain",
        rootData
      })) {
    ...
    if (data.failoverConfig !== undefined) {
      if (!validate37(data.failoverConfig, {
        instancePath: instancePath + "/failoverConfig",
        parentData: data,
        parentDataProperty: "failoverConfig",
        rootData
      })) {
    ...
    if (data.localityLbAlgorithm !== undefined) {
      if (!validate41(data.localityLbAlgorithm, {
        instancePath: instancePath + "/localityLbAlgorithm",
        parentData: data,
        parentDataProperty: "localityLbAlgorithm",
        rootData
      })) {
    ...
    if (data.serviceLbAlgorithm !== undefined) {
      if (!validate43(data.serviceLbAlgorithm, {
        instancePath: instancePath + "/serviceLbAlgorithm",
        parentData: data,
        parentDataProperty: "serviceLbAlgorithm",
        rootData
      })) {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sectionName !== undefined) {
      if (!validate69(data.sectionName, {
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate74(data.lastTransitionTime, {
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ancestorRef !== undefined) {
      if (!validate59(data.ancestorRef, {
    ...
    if (data.controllerName !== undefined) {
      if (!validate88(data.controllerName, {
...
function validate22(data, {
  ...
  /*# sourceURL="networking.gke.io.v1.GCPTrafficDistributionPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
