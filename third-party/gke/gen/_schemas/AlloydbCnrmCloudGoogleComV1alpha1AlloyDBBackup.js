...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "X0Z4qr3oGGCzUNMtkxm9PXaTGANMIKXBJi2hqogPu9g"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "LfvoeRZlMYN52YOsxckKz6zU4gi1QXC4Q9nQ9Hd2k"
    },
    "status": {
      "$ref": "SnPE44hbD915MzQgmLxsZXqf0uAA2M0ZYPo4mvPXjCc"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "alloydb.cnrm.cloud.google.com.v1alpha1.AlloyDBBackup"
};
const schema16 = {
  "type": "string",
...
const schema20 = {
  "properties": {
    ...
    "encryptionConfig": {
      "$ref": "Lf0RxpwIs4RcWbHiVb1I71C8AiWDrQXC63ACBkcGSo"
    },
    "location": {
  ...
  "required": ["clusterNameRef", "location", "projectRef"],
  "type": "object"
};
const schema7 = {
  "oneOf": [{
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.kmsKeyName !== undefined) {
      if (!validate21(data.kmsKeyName, {
        instancePath: instancePath + "/kmsKeyName",
        parentData: data,
        parentDataProperty: "kmsKeyName",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate48(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.clusterNameRef === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "clusterNameRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.clusterNameRef !== undefined) {
      if (!validate22(data.clusterNameRef, {
        instancePath: instancePath + "/clusterNameRef",
        parentData: data,
        parentDataProperty: "clusterNameRef",
        rootData
      })) {
    ...
    if (data.encryptionConfig !== undefined) {
      if (!validate50(data.encryptionConfig, {
...
function validate69(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.kmsKeyVersions !== undefined) {
      if (!validate71(data.kmsKeyVersions, {
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.encryptionInfo !== undefined) {
      if (!validate68(data.encryptionInfo, {
    ...
    if (data.reconciling !== undefined) {
      if (!validate80(data.reconciling, {
...
function validate39(data, {
  ...
  /*# sourceURL="alloydb.cnrm.cloud.google.com.v1alpha1.AlloyDBBackup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
