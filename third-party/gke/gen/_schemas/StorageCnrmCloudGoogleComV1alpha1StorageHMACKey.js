...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "VSj5IaHI41ns9FejNkuxWpy1PGTIBsoatqZfAisDo"
    },
    "kind": {
      "$ref": "KjheNdXoIba2GnEPcFBi9ipJ1cEDfLRBb9cYwHbyc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "83uA55y0ASNArBHrM0djm7ewkFAfhYCzTkQgHBjzZ3Q"
    },
    "status": {
      "$ref": "NOELOX8xJamW35pTmez7XeVvsbmg9B0p2Ekn7o8t0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "storage.cnrm.cloud.google.com.v1alpha1.StorageHMACKey"
};
const schema8 = {
  "type": "string",
  "enum": ["storage.cnrm.cloud.google.com/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "storage.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  ...
  "required": ["projectRef", "serviceAccountEmail"],
  "type": "object"
};
const schema13 = {
  "oneOf": [{
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.serviceAccountEmail === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "serviceAccountEmail"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.serviceAccountEmail !== undefined) {
      if (!validate50(data.serviceAccountEmail, {
        instancePath: instancePath + "/serviceAccountEmail",
        parentData: data,
        parentDataProperty: "serviceAccountEmail",
        rootData
      })) {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.timeCreated !== undefined) {
      if (!validate21(data.timeCreated, {
        instancePath: instancePath + "/timeCreated",
        parentData: data,
        parentDataProperty: "timeCreated",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.updated !== undefined) {
      if (!validate21(data.updated, {
        instancePath: instancePath + "/updated",
        parentData: data,
        parentDataProperty: "updated",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate22(data, {
  ...
  /*# sourceURL="storage.cnrm.cloud.google.com.v1alpha1.StorageHMACKey" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
