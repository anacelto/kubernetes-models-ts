...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "QuSZbDRJFFCCo3NN2RaEjb6831XmsQ9T85vsV8WHiE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "tJiiLAZqNbdLtYZEEMhbbWrUGkFzBRusgFwtheHaag"
    },
    "status": {
  ...
  "$id": "networksecurity.cnrm.cloud.google.com.v1beta1.NetworkSecurityAuthorizationPolicy"
};
const schema11 = {
  "type": "string",
...
function validate29(data, {
  ...
  if (!(data === "NetworkSecurityAuthorizationPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "properties": {
    ...
    "rules": {
      "$ref": "MXloKqPVx4iP3pD8vHeWN8lswKMLviU47tohYkAVM"
    }
  },
...
const schema23 = {
  "items": {
    "$ref": "e3JRTcrSSqzGzuc6oNRyyEVHXj4iR1Ak0iCOTTg"
  },
  "type": "array",
  "nullable": true
};
const schema24 = {
  "properties": {
    "destinations": {
      "$ref": "PNGvCiZ4HWFLg19Y7oBFufAoITDqMyUKAy2E73vPs"
    },
    "sources": {
      "$ref": "I8RmwXpjjSFx2nsiGhV4ZbXaUmUQ5YmUFqyAXymYly4"
    }
  },
  "type": "object"
};
const schema25 = {
  "items": {
    "$ref": "FOiJfycC4pryp7ZJLCsxaKjBwvz2K6pac9MzKdMu0o"
  },
  "type": "array",
  "nullable": true
};
const schema26 = {
  "properties": {
    ...
    "httpHeaderMatch": {
      "$ref": "XfnXpgp4ddaBRu7bw31Nel7eAYcyrjsFeRgEOW0rI"
    },
    "methods": {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.httpHeaderMatch !== undefined) {
      if (!validate63(data.httpHeaderMatch, {
        instancePath: instancePath + "/httpHeaderMatch",
        parentData: data,
        parentDataProperty: "httpHeaderMatch",
        rootData
      })) {
...
const schema31 = {
  "items": {
    "$ref": "R32o1zPBTP7qwv7hCGfyCDlryAN7YEk7jJcqydR0LH8"
  },
  "type": "array",
  "nullable": true
};
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.destinations !== undefined) {
      if (!validate58(data.destinations, {
...
function validate26(data, {
  ...
  /*# sourceURL="networksecurity.cnrm.cloud.google.com.v1beta1.NetworkSecurityAuthorizationPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
