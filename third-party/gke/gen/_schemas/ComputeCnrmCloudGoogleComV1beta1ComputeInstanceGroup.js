...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "IPF19dqzdygjXdXzWuEtm7hnUBuzFR6N8o0mrn2dd0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "622d6FsLaWgvoxaWJKFBw2LB60Bydlpm1VQMnor2s"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeInstanceGroup"
};
const schema16 = {
  "type": "string",
...
const schema20 = {
  "properties": {
    ...
    "namedPort": {
      "$ref": "wW6u0OfODkAzpmFPdSdGwNDZ1wNe9GASaBhPqAbVM"
    },
    "networkRef": {
...
const schema23 = {
  "items": {
    "$ref": "4qjPv8tc4WqrKR5chfUE6nLxNS4S7mFoOlE9aAQI"
  },
  "type": "array",
  "nullable": true
};
...
function validate43(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namedPort !== undefined) {
      if (!validate53(data.namedPort, {
        instancePath: instancePath + "/namedPort",
        parentData: data,
        parentDataProperty: "namedPort",
        rootData
      })) {
...
function validate34(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeInstanceGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
