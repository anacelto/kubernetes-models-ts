...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "RslQ79oNxvK6RYeSuSwKG8apDGfy76l3LOJRPHHEc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "RfPiZfIMPRgi4CAvBBR9LvW5Zr3tzywapfsf9rIuZSg"
    },
    "status": {
      "$ref": "TVBPqfHzgACNZ8fyDqHxgpnwXAIdNUg2N2bdBjalY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeFirewallPolicy"
};
const schema15 = {
  "type": "string",
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ruleTupleCount !== undefined) {
      if (!validate73(data.ruleTupleCount, {
...
function validate38(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeFirewallPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
