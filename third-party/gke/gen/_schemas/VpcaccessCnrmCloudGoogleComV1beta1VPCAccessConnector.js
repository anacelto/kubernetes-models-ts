...
const schema16 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "v2BoxsePkG2SoBcpoJNvUXrBqySofZJmVRTdtajPgg"
    },
    "kind": {
      "$ref": "IjNvYvu9gmWG4BJcCTXnfQ5XppAm242ERXBc1n5G6Hw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ADoh8bFJD0HHvGWldlUdIqeqW7X9yrIDch6tsmiZY"
    },
    "status": {
      "$ref": "HbmDxHOAR9ih6sN0Q0Yo6rxbnNqw5dwkfuehqIvqi0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "vpcaccess.cnrm.cloud.google.com.v1beta1.VPCAccessConnector"
};
const schema17 = {
  "type": "string",
...
function validate41(data, {
  ...
  if (!(data === "vpcaccess.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema21 = {
  "properties": {
    ...
    "subnet": {
      "$ref": "1hwI1pLD0Z7lHVZSgqN10aclkwcfY00tzof2WAPlW0"
    }
  },
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ipCidrRange !== undefined) {
      if (!validate21(data.ipCidrRange, {
    ...
    if (data.maxInstances !== undefined) {
      if (!validate22(data.maxInstances, {
    ...
    if (data.maxThroughput !== undefined) {
      if (!validate22(data.maxThroughput, {
        instancePath: instancePath + "/maxThroughput",
        parentData: data,
        parentDataProperty: "maxThroughput",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.minInstances !== undefined) {
      if (!validate22(data.minInstances, {
    ...
    if (data.minThroughput !== undefined) {
      if (!validate22(data.minThroughput, {
        instancePath: instancePath + "/minThroughput",
        parentData: data,
        parentDataProperty: "minThroughput",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate71(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.connectedProjects !== undefined) {
      if (!validate81(data.connectedProjects, {
        instancePath: instancePath + "/connectedProjects",
        parentData: data,
        parentDataProperty: "connectedProjects",
        rootData
      })) {
...
function validate40(data, {
  ...
  /*# sourceURL="vpcaccess.cnrm.cloud.google.com.v1beta1.VPCAccessConnector" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
