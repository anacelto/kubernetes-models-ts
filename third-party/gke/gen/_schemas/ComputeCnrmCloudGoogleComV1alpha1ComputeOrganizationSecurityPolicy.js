...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "yIqKPm6ZKeAyYP0ArJeCUo5nZsAr3Ow76c9O4xTfDQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "CunuHyhMb4rROjnDjpSM86086mcPZ1vwR4iUjCOoM"
    },
    "status": {
      "$ref": "wJj3g7poaargw0JuRBRyr2UEkXOGWb6w9w27oBlaRI"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeOrganizationSecurityPolicy"
};
const schema9 = {
  "type": "string",
...
const schema10 = {
  "type": "string",
  "enum": ["ComputeOrganizationSecurityPolicy"]
};
function validate26(data, {
  ...
  if (!(data === "ComputeOrganizationSecurityPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeOrganizationSecurityPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
