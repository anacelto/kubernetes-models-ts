...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "hsL6aH4LGVV1Swd76acL67AYrD3PmXdcvrm72gD6iSU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ynQrZXW6ElszRChF5XSaKaKDd7evSysCAe3wbsKwThg"
    },
    "status": {
      "$ref": "wNuxmArtDBRsaSMsZH4g0qxtZWVY013Mqb59O3R7U"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "gkehub.cnrm.cloud.google.com.v1beta1.GKEHubFeature"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    ...
    "spec": {
      "$ref": "fGbCBluLwIS9hRxTTVt3BlJJQt1jZSrRQ6MwhhMAI"
    }
  },
...
const schema23 = {
  "properties": {
    "fleetobservability": {
      "$ref": "xKRUa3dJ2I0u6i7glxpIxVhLNjGK7ulKwdQo1EWwsg"
    },
    "multiclusteringress": {
      "$ref": "eZhQYnWHMb7RBKWAaGM3ZmVjea0ayKCkcDKpR29c"
    }
  },
  "type": "object",
  "nullable": true
...
const schema24 = {
  "properties": {
    "loggingConfig": {
      "$ref": "yOBcrxe4OCsQ4RFy5UkSQ1KZo9HMKDbc5jI1YKSlZk"
    }
  },
  "type": "object",
  "nullable": true
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.defaultConfig !== undefined) {
      if (!validate22(data.defaultConfig, {
        instancePath: instancePath + "/defaultConfig",
        parentData: data,
        parentDataProperty: "defaultConfig",
        rootData
      })) {
    ...
    if (data.fleetScopeLogsConfig !== undefined) {
      if (!validate22(data.fleetScopeLogsConfig, {
        instancePath: instancePath + "/fleetScopeLogsConfig",
        parentData: data,
        parentDataProperty: "fleetScopeLogsConfig",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.loggingConfig !== undefined) {
      if (!validate57(data.loggingConfig, {
...
function validate62(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configMembershipRef === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "configMembershipRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.configMembershipRef !== undefined) {
      if (!validate24(data.configMembershipRef, {
        instancePath: instancePath + "/configMembershipRef",
        parentData: data,
        parentDataProperty: "configMembershipRef",
        rootData
      })) {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.fleetobservability !== undefined) {
      if (!validate56(data.fleetobservability, {
        instancePath: instancePath + "/fleetobservability",
        parentData: data,
        parentDataProperty: "fleetobservability",
        rootData
      })) {
    ...
    if (data.multiclusteringress !== undefined) {
      if (!validate62(data.multiclusteringress, {
        instancePath: instancePath + "/multiclusteringress",
        parentData: data,
        parentDataProperty: "multiclusteringress",
        rootData
      })) {
...
const schema27 = {
  "properties": {
    ...
    "resourceState": {
      "$ref": "OX3hDlS6Zx2fjmZwZSgxQIQGzw6cSX7OSed1mNzZ6A"
    },
    "state": {
      "$ref": "3fRW6Sqd2wm9OqBBMDsO2br9GHP2p61otrr04jkYE"
    },
    "updateTime": {
      "$ref": "thZzwpySeU7LsVtTYjwqN1mWUAwFAnezim8OMie8k"
    }
...
function validate81(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.hasResources !== undefined) {
      if (!validate82(data.hasResources, {
        instancePath: instancePath + "/hasResources",
        parentData: data,
        parentDataProperty: "hasResources",
        rootData
      })) {
...
const schema33 = {
  "properties": {
    "state": {
      "$ref": "FXmBwKoc05yGt40nciWlae2VQznQf4lvwaPcHHc0vk"
    }
  },
  "type": "object",
  "nullable": true
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.resourceState !== undefined) {
      if (!validate81(data.resourceState, {
        instancePath: instancePath + "/resourceState",
        parentData: data,
        parentDataProperty: "resourceState",
        rootData
      })) {
...
function validate41(data, {
  ...
  /*# sourceURL="gkehub.cnrm.cloud.google.com.v1beta1.GKEHubFeature" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.spec === undefined) {
