...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "z9mcQzO5fVpH7wvJxCZxl5QfVqGlKPxOK5H1HNBtw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Mo7OX1X6q3NU6ZuTs93NuhlxuuGiDW4SP2GyryUH8bk"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeBackendBucketSignedURLKey"
};
const schema16 = {
  "type": "string",
...
const schema17 = {
  "type": "string",
  "enum": ["ComputeBackendBucketSignedURLKey"]
};
function validate42(data, {
  ...
  if (!(data === "ComputeBackendBucketSignedURLKey")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema20 = {
  ...
  "required": ["backendBucketRef", "keyValue", "projectRef"],
  "type": "object"
};
const schema8 = {
  "oneOf": [{
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretKeyRef !== undefined) {
      if (!validate61(data.secretKeyRef, {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.backendBucketRef !== undefined) {
      if (!validate23(data.backendBucketRef, {
    ...
    if (data.keyValue !== undefined) {
      if (!validate50(data.keyValue, {
        instancePath: instancePath + "/keyValue",
        parentData: data,
        parentDataProperty: "keyValue",
        rootData
      })) {
...
function validate39(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeBackendBucketSignedURLKey" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
