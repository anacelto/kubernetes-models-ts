...
const schema18 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "fL7onAU0Yh4ZOvKusj2IGF09kKBcSD6yt6J5nhAwaZA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "DojRA4J9qmt9sSUO2L3MZ5dZaIrRnERJ98xFKgY4FM"
    },
    "status": {
      "$ref": "qOEcP0vdhs5IPhcViA16wgYhvK98lNALon8xMerko"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "apigee.cnrm.cloud.google.com.v1beta1.ApigeeOrganization"
};
const schema19 = {
  "type": "string",
...
const schema23 = {
  "properties": {
    "addonsConfig": {
      "$ref": "QIFg68PCm7aa2VTw5yD1gDA2YN08vLezHzTNrUIuehQ"
    },
    "analyticsRegion": {
  ...
  "required": ["analyticsRegion", "projectRef", "runtimeType"],
  "type": "object"
};
const schema24 = {
  "properties": {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.advancedApiOpsConfig !== undefined) {
      if (!validate21(data.advancedApiOpsConfig, {
        instancePath: instancePath + "/advancedApiOpsConfig",
        parentData: data,
        parentDataProperty: "advancedApiOpsConfig",
        rootData
      })) {
    ...
    if (data.monetizationConfig !== undefined) {
      if (!validate21(data.monetizationConfig, {
        instancePath: instancePath + "/monetizationConfig",
        parentData: data,
        parentDataProperty: "monetizationConfig",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate52(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.analyticsRegion === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "analyticsRegion"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.addonsConfig !== undefined) {
      if (!validate53(data.addonsConfig, {
    ...
    if (data.analyticsRegion !== undefined) {
      if (!validate35(data.analyticsRegion, {
        instancePath: instancePath + "/analyticsRegion",
        parentData: data,
        parentDataProperty: "analyticsRegion",
        rootData
      })) {
        vErrors = vErrors === null ? validate35.errors : vErrors.concat(validate35.errors);
        errors = vErrors.length;
    ...
    if (data.authorizedNetworkRef !== undefined) {
      if (!validate36(data.authorizedNetworkRef, {
    ...
    if (data.runtimeDatabaseEncryptionKeyRef !== undefined) {
      if (!validate36(data.runtimeDatabaseEncryptionKeyRef, {
        instancePath: instancePath + "/runtimeDatabaseEncryptionKeyRef",
        parentData: data,
        parentDataProperty: "runtimeDatabaseEncryptionKeyRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate36.errors : vErrors.concat(validate36.errors);
        errors = vErrors.length;
    ...
    if (data.runtimeType !== undefined) {
      if (!validate35(data.runtimeType, {
        instancePath: instancePath + "/runtimeType",
        parentData: data,
        parentDataProperty: "runtimeType",
        rootData
      })) {
        vErrors = vErrors === null ? validate35.errors : vErrors.concat(validate35.errors);
        errors = vErrors.length;
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.billingType !== undefined) {
      if (!validate24(data.billingType, {
        instancePath: instancePath + "/billingType",
        parentData: data,
        parentDataProperty: "billingType",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.caCertificate !== undefined) {
      if (!validate24(data.caCertificate, {
    ...
    if (data.environments !== undefined) {
      if (!validate87(data.environments, {
        instancePath: instancePath + "/environments",
        parentData: data,
        parentDataProperty: "environments",
        rootData
      })) {
    ...
    if (data.lastModifiedAt !== undefined) {
      if (!validate42(data.lastModifiedAt, {
    ...
    if (data.subscriptionType !== undefined) {
      if (!validate24(data.subscriptionType, {
        instancePath: instancePath + "/subscriptionType",
        parentData: data,
        parentDataProperty: "subscriptionType",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
...
function validate43(data, {
  ...
  /*# sourceURL="apigee.cnrm.cloud.google.com.v1beta1.ApigeeOrganization" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
