...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "i8WAm8fVYrwn1av2BZys1PUGjtRyIiRFsTAGcsVsU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "v25QU3ckewVkHb91sLoVdJfZF41rBBsKDRL5d5MSo"
    },
    "status": {
      "$ref": "ccSgXja8PI0ZlDDeS7BSvOQX6Fp3TChmJ6lRQJ6a2cA"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIFeaturestore"
};
const schema11 = {
  "type": "string",
...
const schema15 = {
  "properties": {
    ...
    "onlineServingConfig": {
      "$ref": "NQ8ebtU4c6DcALPpNwKuOUeZi996GDyelJcnojLCK4"
    },
...
const schema18 = {
  "properties": {
    ...
    "scaling": {
      "$ref": "L24vCNcRjedyYnO1YRetV6NIzJkhGmqERqurXaOniWw"
    }
  },
  "type": "object",
  "nullable": true
...
function validate40(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.fixedNodeCount !== undefined) {
      if (!validate22(data.fixedNodeCount, {
        instancePath: instancePath + "/fixedNodeCount",
        parentData: data,
        parentDataProperty: "fixedNodeCount",
        rootData
      })) {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.encryptionSpec !== undefined) {
      if (!validate35(data.encryptionSpec, {
    ...
    if (data.forceDestroy !== undefined) {
      if (!validate38(data.forceDestroy, {
        instancePath: instancePath + "/forceDestroy",
        parentData: data,
        parentDataProperty: "forceDestroy",
        rootData
      })) {
    ...
    if (data.onlineServingConfig !== undefined) {
      if (!validate40(data.onlineServingConfig, {
        instancePath: instancePath + "/onlineServingConfig",
        parentData: data,
        parentDataProperty: "onlineServingConfig",
        rootData
      })) {
    ...
    if (data.onlineStorageTtlDays !== undefined) {
      if (!validate22(data.onlineStorageTtlDays, {
        instancePath: instancePath + "/onlineStorageTtlDays",
        parentData: data,
        parentDataProperty: "onlineStorageTtlDays",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate25(data, {
  ...
  /*# sourceURL="vertexai.cnrm.cloud.google.com.v1alpha1.VertexAIFeaturestore" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
