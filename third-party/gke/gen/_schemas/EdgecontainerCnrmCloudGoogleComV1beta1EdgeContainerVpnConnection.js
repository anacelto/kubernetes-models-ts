...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "0tS1vvUUJ2iENaMzyQkXFtCJr1WlOmYKZ3LW6sxgVQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "MXqwUp6LSXF17N9NHvWQ2qONAMKMWpxWnNogvSDYAA"
    },
    "status": {
      "$ref": "NRjXnpp2TiLBU4hd0Kq8FPWvQTcAjzUjogvM3VAvJk"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "edgecontainer.cnrm.cloud.google.com.v1beta1.EdgeContainerVpnConnection"
};
const schema15 = {
  "type": "string",
...
const schema16 = {
  "type": "string",
  "enum": ["EdgeContainerVpnConnection"]
};
function validate41(data, {
  ...
  if (!(data === "EdgeContainerVpnConnection")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  "properties": {
    ...
    "vpcProject": {
      "$ref": "LUlnWd1zr3uvawrF7t5ELr3tAgLcA18l0NKNPYJ50"
    }
  },
  "required": ["clusterRef", "location", "projectRef"],
  "type": "object"
};
const schema7 = {
  "oneOf": [{
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.enableHighAvailability !== undefined) {
      if (!validate49(data.enableHighAvailability, {
        instancePath: instancePath + "/enableHighAvailability",
        parentData: data,
        parentDataProperty: "enableHighAvailability",
        rootData
      })) {
    ...
    if (data.natGatewayIp !== undefined) {
      if (!validate21(data.natGatewayIp, {
        instancePath: instancePath + "/natGatewayIp",
        parentData: data,
        parentDataProperty: "natGatewayIp",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.vpcProject !== undefined) {
      if (!validate58(data.vpcProject, {
        instancePath: instancePath + "/vpcProject",
        parentData: data,
        parentDataProperty: "vpcProject",
        rootData
      })) {
...
const schema23 = {
  "properties": {
    ...
    "details": {
      "$ref": "tQ4zaFRVnKFnPrPmQL5Me1eC2YBjhGgBiJqSuXvOzo"
    },
    "observedGeneration": {
...
const schema26 = {
  "items": {
    "$ref": "azkfGPPKqAfKqVgbSK6m0k6US2O4ktQmzBezSisv7gM"
  },
  "type": "array",
  "nullable": true
};
const schema27 = {
  "properties": {
    ...
    "cloudVpns": {
      "$ref": "RjlRvKaXjbWC6PakRMhL8H40261E7Fk7byxUmi8IM"
    },
    "error": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema30 = {
  "items": {
    "$ref": "kRO3O37Dx255deEXsPVWMnEa0TxvWczJGLw37N8o"
  },
  "type": "array",
  "nullable": true
};
...
function validate74(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cloudRouter !== undefined) {
      if (!validate75(data.cloudRouter, {
        instancePath: instancePath + "/cloudRouter",
        parentData: data,
        parentDataProperty: "cloudRouter",
        rootData
      })) {
    ...
    if (data.cloudVpns !== undefined) {
      if (!validate80(data.cloudVpns, {
        instancePath: instancePath + "/cloudVpns",
        parentData: data,
        parentDataProperty: "cloudVpns",
        rootData
      })) {
...
function validate38(data, {
  ...
  /*# sourceURL="edgecontainer.cnrm.cloud.google.com.v1beta1.EdgeContainerVpnConnection" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
