...
const schema16 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "SzVe03V9f0S5e0zOmPT3aPUzojVXktT1685o0WyfJw8"
    },
    "kind": {
      "$ref": "duPkAQuFL9l2jDTT90UHvM5XMDB5jPe6b5mH39bcM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AJFEip3lhdJjlIBrugC45MrvgLJY8nyYhE08E3AIu0"
    },
    "status": {
      "$ref": "vzLT7y3ovGrLnS97eYK9mge8Zj1AVh7SMZ9LzfFg7Y"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "resourcemanager.cnrm.cloud.google.com.v1beta1.Folder"
};
const schema17 = {
  "type": "string",
...
function validate41(data, {
  ...
  if (!(data === "resourcemanager.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema21 = {
  "oneOf": [{
    ...
    "$ref": "YbRuTjitiac1caS2y8GLymXZ1Lqj6ATS6DIe5zp29ds"
  }],
  "properties": {
    "displayName": {
...
const schema22 = {
  "not": {
    "$ref": "X3yG2L6UXQ6fok2PBnUOlqjje9CCGz6wdisSxVNVs"
  }
};
const schema23 = {
  "anyOf": [{
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.displayName !== undefined) {
      if (!validate58(data.displayName, {
...
function validate40(data, {
  ...
  /*# sourceURL="resourcemanager.cnrm.cloud.google.com.v1beta1.Folder" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
