...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "1bXP4Vq3vSMw4sTks0Pl4j65Is9cKjJcJhAnNIVSoc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "nSvtDv1m1Ftl5Gyb9Wzi7WVdVeVp0u3cQwa7zHHUs"
    },
    "status": {
  ...
  "$id": "iam.cnrm.cloud.google.com.v1beta1.IAMWorkloadIdentityPool"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "IAMWorkloadIdentityPool")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="iam.cnrm.cloud.google.com.v1beta1.IAMWorkloadIdentityPool" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
