...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "cWPBvfHDYonZR4lHudHJ6p68GZwf784j3Oppd2szc"
    },
    "kind": {
      "$ref": "OxgRMXWMZGc9ms6iSE8mHqoLK1v2B8n7M2YMeDL4vk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "1YOV0GeESIhEG8rkSS7OlHBDdtTxtZz8uf3wDWstmM4"
    },
    "status": {
      "$ref": "1XFjRxLfcRitx5CroAp2H4NFnvSlJdKEu4Qycls8Y4k"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "servicenetworking.cnrm.cloud.google.com.v1beta1.ServiceNetworkingConnection"
};
const schema15 = {
  "type": "string",
...
function validate39(data, {
  ...
  if (!(data === "servicenetworking.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate41(data, {
  ...
  if (!(data === "ServiceNetworkingConnection")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.reservedPeeringRanges === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "reservedPeeringRanges"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.reservedPeeringRanges !== undefined) {
      if (!validate49(data.reservedPeeringRanges, {
        instancePath: instancePath + "/reservedPeeringRanges",
        parentData: data,
        parentDataProperty: "reservedPeeringRanges",
        rootData
      })) {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.peering !== undefined) {
      if (!validate21(data.peering, {
        instancePath: instancePath + "/peering",
        parentData: data,
        parentDataProperty: "peering",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate38(data, {
  ...
  /*# sourceURL="servicenetworking.cnrm.cloud.google.com.v1beta1.ServiceNetworkingConnection" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
