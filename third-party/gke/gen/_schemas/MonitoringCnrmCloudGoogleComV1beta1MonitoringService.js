...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "H9aTJj2zFoT7OUhLDd4T9UY7Ekfw88X5m9Viwik2uY"
    },
    "kind": {
      "$ref": "MrrcITv0r7ZG6b8UPiPyPliPRGlyvYR4CTQRx1nAbKE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "bjSitUFAfFBhGESENInRVeMGuhk465OFkClFQrMe50"
    },
    "status": {
  ...
  "$id": "monitoring.cnrm.cloud.google.com.v1beta1.MonitoringService"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "monitoring.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "properties": {
    ...
    "telemetry": {
      "$ref": "wf24fKhQWnFYxbd4RMPB0vGMW61Ek3Fsqh74QKQnQ"
    }
  },
  "required": ["projectRef"],
  "type": "object"
...
function validate22(data, {
  ...
  /*# sourceURL="monitoring.cnrm.cloud.google.com.v1beta1.MonitoringService" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
