...
const schema17 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "wSI51m61YrIoStbeDHbPirb3qXURTBd3isaBiQA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "o9pJG98pJ9bDqPyLcPZqf08Jq9TZYccPAHdG889wg"
    },
    "status": {
      "$ref": "FzVJ7BbVd6TTErhSpAtnyKd8ba7LY1CC5nlvapUuao"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "edgenetwork.cnrm.cloud.google.com.v1beta1.EdgeNetworkSubnet"
};
const schema18 = {
  "type": "string",
...
const schema22 = {
  ...
  "required": ["location", "networkRef", "projectRef", "zone"],
  "type": "object"
};
const schema6 = {
  "items": {
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ipv4Cidr !== undefined) {
      if (!validate21(data.ipv4Cidr, {
        instancePath: instancePath + "/ipv4Cidr",
        parentData: data,
        parentDataProperty: "ipv4Cidr",
        rootData
      })) {
    ...
    if (data.ipv6Cidr !== undefined) {
      if (!validate21(data.ipv6Cidr, {
        instancePath: instancePath + "/ipv6Cidr",
        parentData: data,
        parentDataProperty: "ipv6Cidr",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.vlanId !== undefined) {
      if (!validate41(data.vlanId, {
        instancePath: instancePath + "/vlanId",
        parentData: data,
        parentDataProperty: "vlanId",
        rootData
      })) {
...
function validate42(data, {
  ...
  /*# sourceURL="edgenetwork.cnrm.cloud.google.com.v1beta1.EdgeNetworkSubnet" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
