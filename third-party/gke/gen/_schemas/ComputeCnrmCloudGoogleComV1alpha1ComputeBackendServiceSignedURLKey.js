...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "k4bpFNKm2vez5wdhQEO0sQRKrnjnryYpx88FLOAM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "80ivErkP86XCyxdkp1HvxO44nIHgvF3WfCkhICpbw"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1alpha1.ComputeBackendServiceSignedURLKey"
};
const schema16 = {
  "type": "string",
...
const schema17 = {
  "type": "string",
  "enum": ["ComputeBackendServiceSignedURLKey"]
};
function validate42(data, {
  ...
  if (!(data === "ComputeBackendServiceSignedURLKey")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema20 = {
  ...
  "required": ["backendServiceRef", "keyValue", "projectRef"],
  "type": "object"
};
const schema8 = {
  "oneOf": [{
...
function validate39(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1alpha1.ComputeBackendServiceSignedURLKey" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
