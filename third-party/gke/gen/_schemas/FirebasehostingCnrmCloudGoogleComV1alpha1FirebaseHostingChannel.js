...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "AKA4clQEXeu03z1vqjMP7WEccuRJSWn1ulyBKHMsYrk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "IDO0IqctcLrmA5f7XGl53WGCg0wpzPTSPxXV6fAK3Dw"
    },
    "status": {
  ...
  "$id": "firebasehosting.cnrm.cloud.google.com.v1alpha1.FirebaseHostingChannel"
};
const schema9 = {
  "type": "string",
...
function validate26(data, {
  ...
  if (!(data === "FirebaseHostingChannel")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.retainedReleaseCount !== undefined) {
      if (!validate22(data.retainedReleaseCount, {
        instancePath: instancePath + "/retainedReleaseCount",
        parentData: data,
        parentDataProperty: "retainedReleaseCount",
        rootData
      })) {
    ...
    if (data.siteId !== undefined) {
      if (!validate36(data.siteId, {
        instancePath: instancePath + "/siteId",
        parentData: data,
        parentDataProperty: "siteId",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="firebasehosting.cnrm.cloud.google.com.v1alpha1.FirebaseHostingChannel" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
