...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "WgOQjFrIFnuNhF6qKkclPm38Qf7cRxt8wAq6WvNJQ4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "RSl9TBg6rx5j5vtIRQaUfsF1Kcxi1eI1Wn7DOLQSU"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeProjectMetadata"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "ComputeProjectMetadata")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeProjectMetadata" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
