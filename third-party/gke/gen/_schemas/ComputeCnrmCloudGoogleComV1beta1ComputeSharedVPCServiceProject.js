...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "u2718FIqFXTeKbbhk1LROV9y9lh0amQaJ3bd0ax4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "JvY0U2xsfdptiWfkJpXSJoC9RZ3L2NJwAb1bV4z8Gs"
    },
    "status": {
  ...
  "$id": "compute.cnrm.cloud.google.com.v1beta1.ComputeSharedVPCServiceProject"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "ComputeSharedVPCServiceProject")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="compute.cnrm.cloud.google.com.v1beta1.ComputeSharedVPCServiceProject" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
