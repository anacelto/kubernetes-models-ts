...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "xlWFZ6w2295dSNDtxsdH5oamVtdKICrLMQmlaaFGdk"
    },
    "kind": {
      "$ref": "Gg913U8zJDCxgvkufV4DX3z9xq4C9lyV6c415Rh4pk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "GBkXhVjR3WYz0aBFVUAn792yiKnkyuy0d2WKhBHl7o"
    },
    "status": {
  ...
  "$id": "accesscontextmanager.cnrm.cloud.google.com.v1alpha1.AccessContextManagerGCPUserAccessBinding"
};
const schema9 = {
  "type": "string",
  "enum": ["accesscontextmanager.cnrm.cloud.google.com/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "accesscontextmanager.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema10 = {
  "type": "string",
  "enum": ["AccessContextManagerGCPUserAccessBinding"]
};
function validate26(data, {
  ...
  if (!(data === "AccessContextManagerGCPUserAccessBinding")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["accessLevels", "groupKey", "organizationRef"],
  "type": "object"
};
const schema14 = {
  "items": {
...
function validate32(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.accessLevels === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "accessLevels"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.accessLevels !== undefined) {
      if (!validate33(data.accessLevels, {
        instancePath: instancePath + "/accessLevels",
        parentData: data,
        parentDataProperty: "accessLevels",
        rootData
      })) {
    ...
    if (data.groupKey !== undefined) {
      if (!validate21(data.groupKey, {
        instancePath: instancePath + "/groupKey",
        parentData: data,
        parentDataProperty: "groupKey",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.organizationRef !== undefined) {
      if (!validate37(data.organizationRef, {
...
function validate23(data, {
  ...
  /*# sourceURL="accesscontextmanager.cnrm.cloud.google.com.v1alpha1.AccessContextManagerGCPUserAccessBinding" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
