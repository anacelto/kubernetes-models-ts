...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "r4fqhsowTTgvzhztNlYMnNNeJdMV99zlFDptCPRou0"
    },
    "kind": {
  ...
  "$id": "certificatemanager.cnrm.cloud.google.com.v1beta1.CertificateManagerCertificateMap"
};
const schema8 = {
  "type": "string",
  "enum": ["certificatemanager.cnrm.cloud.google.com/v1beta1"]
};
function validate23(data, {
  ...
  if (!(data === "certificatemanager.cnrm.cloud.google.com/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="certificatemanager.cnrm.cloud.google.com.v1beta1.CertificateManagerCertificateMap" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
