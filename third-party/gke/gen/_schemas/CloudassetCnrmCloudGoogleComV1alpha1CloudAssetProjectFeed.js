...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "DEXoHjxiTRnz00Qd8caV2Z6hU0gdUvnnSmSFpaoUkAs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "PTJQGp3iTcpL18XUY2sfznqWbw96yZk4OY9xVfBRQ"
    },
    "status": {
  ...
  "$id": "cloudasset.cnrm.cloud.google.com.v1alpha1.CloudAssetProjectFeed"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  ...
  "required": ["feedId", "feedOutputConfig", "projectRef"],
  "type": "object"
};
const schema6 = {
  "items": {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.billingProject !== undefined) {
      if (!validate24(data.billingProject, {
...
function validate25(data, {
  ...
  /*# sourceURL="cloudasset.cnrm.cloud.google.com.v1alpha1.CloudAssetProjectFeed" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
