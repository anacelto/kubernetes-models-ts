...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Xy324Kz19p96lqfND8oasfRimJ2hsIeCqXa03zR8I"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ajI8MfqFWg8rKfkFngcUsfDKxrntHpAFtIMhjSdE"
    },
    "status": {
  ...
  "$id": "accesscontextmanager.cnrm.cloud.google.com.v1beta1.AccessContextManagerAccessPolicy"
};
const schema8 = {
  "type": "string",
...
function validate25(data, {
  ...
  if (!(data === "AccessContextManagerAccessPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="accesscontextmanager.cnrm.cloud.google.com.v1beta1.AccessContextManagerAccessPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
