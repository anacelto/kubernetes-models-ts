...
const schema15 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "7FKsW30oZq3gYgwPoP276WX7zgYR4FBHYiempdO3vk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "p8QIEOq1QJ8DnfVfzdeX8dRyKBOO2yYfUAFxnn09Lc"
    },
    "status": {
      "$ref": "Clk9gd3sPTkNaQCyM2b8ea5XW7wZ0bMYNv07rBBM"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "edgecontainer.cnrm.cloud.google.com.v1beta1.EdgeContainerNodePool"
};
const schema16 = {
  "type": "string",
...
const schema20 = {
  "properties": {
    ...
    "localDiskEncryption": {
      "$ref": "1aIgIJSU4yMzVeE0u4H3t8O25ts2t6LhJ8xVLoso0"
    },
    "location": {
  ...
  "required": ["clusterRef", "location", "nodeCount", "nodeLocation", "projectRef"],
  "type": "object"
};
const schema14 = {
  "oneOf": [{
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.localDiskEncryption !== undefined) {
      if (!validate50(data.localDiskEncryption, {
        instancePath: instancePath + "/localDiskEncryption",
        parentData: data,
        parentDataProperty: "localDiskEncryption",
        rootData
      })) {
    ...
    if (data.nodeLocation !== undefined) {
      if (!validate32(data.nodeLocation, {
...
function validate39(data, {
  ...
  /*# sourceURL="edgecontainer.cnrm.cloud.google.com.v1beta1.EdgeContainerNodePool" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
