...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "8oJaCDY0Rx2q0YKsFulzEuwQ6d2rkOr7ajlnNGKLk"
    },
    "kind": {
      "$ref": "O4hUXYEc2pfp3QukRi8OkZEBVEwVDzy5aMWFtEB8zY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Pl4vhkrOkWf9udxLLSfiK8WTo3QP1ZyRIR6GUe3NYA"
    },
    "status": {
      "$ref": "S8Y1FTJEUJWllKOyaM2i4X7bqV9wsPItTNVixgDu0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "tpu.cnrm.cloud.google.com.v1alpha1.TPUNode"
};
const schema10 = {
  "type": "string",
  "enum": ["tpu.cnrm.cloud.google.com/v1alpha1"]
};
function validate25(data, {
  ...
  if (!(data === "tpu.cnrm.cloud.google.com/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    ...
    "schedulingConfig": {
      "$ref": "DL9n9kryZV70OaZaK3l1FKWRef7vq0Pq2JXuy8TM"
    },
    "tensorflowVersion": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
  ...
  "required": ["acceleratorType", "projectRef", "tensorflowVersion", "zone"],
  "type": "object"
};
const schema7 = {
  "type": "string"
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.preemptible !== undefined) {
      if (!validate56(data.preemptible, {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tensorflowVersion === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "tensorflowVersion"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.schedulingConfig !== undefined) {
      if (!validate55(data.schedulingConfig, {
        instancePath: instancePath + "/schedulingConfig",
        parentData: data,
        parentDataProperty: "schedulingConfig",
        rootData
      })) {
    ...
    if (data.tensorflowVersion !== undefined) {
      if (!validate22(data.tensorflowVersion, {
        instancePath: instancePath + "/tensorflowVersion",
        parentData: data,
        parentDataProperty: "tensorflowVersion",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.useServiceNetworking !== undefined) {
      if (!validate60(data.useServiceNetworking, {
        instancePath: instancePath + "/useServiceNetworking",
        parentData: data,
        parentDataProperty: "useServiceNetworking",
        rootData
      })) {
...
const schema25 = {
  "properties": {
    ...
    "networkEndpoints": {
      "$ref": "OhNZCNu7DVnqxlft99bkIqbLaOOB5QqWbKWPId7KcBg"
    },
    "observedGeneration": {
...
const schema28 = {
  "items": {
    "$ref": "kuAG13qONCdY5oNs0grMfVbUOgvcSx1HLOeRWcevs"
  },
  "type": "array",
  "nullable": true
};
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.networkEndpoints !== undefined) {
      if (!validate74(data.networkEndpoints, {
        instancePath: instancePath + "/networkEndpoints",
        parentData: data,
        parentDataProperty: "networkEndpoints",
        rootData
      })) {
...
function validate24(data, {
  ...
  /*# sourceURL="tpu.cnrm.cloud.google.com.v1alpha1.TPUNode" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
