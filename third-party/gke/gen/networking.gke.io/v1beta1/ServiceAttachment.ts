...
import { validate } from "../../_schemas/NetworkingGkeIoV1beta1ServiceAttachment";
 ...
 * ServiceAttachment represents a Service Attachment associated with a service/ingress/gateway class
 */
export class ServiceAttachment extends Model<IServiceAttachment> implements IServiceAttachment {
...
static apiVersion: IServiceAttachment["apiVersion"] = "networking.gke.io/v1beta1";
static kind: IServiceAttachment["kind"] = "ServiceAttachment";
static is = createTypeMetaGuard<IServiceAttachment>(ServiceAttachment);

constructor(data?: ModelData<IServiceAttachment>) {
  super();

  this.setDefinedProps({
    apiVersion: ServiceAttachment.apiVersion,
    kind: ServiceAttachment.kind,
    ...data
  } as IServiceAttachment);
}
}


setValidateFunc(ServiceAttachment, validate as ValidateFunc<IServiceAttachment>);
