...
import { validate } from "../../_schemas/NetworkingGkeIoV1beta1ServiceNetworkEndpointGroup";
...
export class ServiceNetworkEndpointGroup extends Model<IServiceNetworkEndpointGroup> implements IServiceNetworkEndpointGroup {
...
static apiVersion: IServiceNetworkEndpointGroup["apiVersion"] = "networking.gke.io/v1beta1";
static kind: IServiceNetworkEndpointGroup["kind"] = "ServiceNetworkEndpointGroup";
static is = createTypeMetaGuard<IServiceNetworkEndpointGroup>(ServiceNetworkEndpointGroup);

constructor(data?: ModelData<IServiceNetworkEndpointGroup>) {
  super();

  this.setDefinedProps({
    apiVersion: ServiceNetworkEndpointGroup.apiVersion,
    kind: ServiceNetworkEndpointGroup.kind,
    ...data
  } as IServiceNetworkEndpointGroup);
}
}


setValidateFunc(ServiceNetworkEndpointGroup, validate as ValidateFunc<IServiceNetworkEndpointGroup>);
