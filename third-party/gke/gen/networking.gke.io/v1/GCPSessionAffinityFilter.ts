...
import { validate } from "../../_schemas/NetworkingGkeIoV1GCPSessionAffinityFilter";
 ...
 * GCPSessionAffinityFilter provides a way to configure session affinity for a RouteAction.
 */
export class GCPSessionAffinityFilter extends Model<IGCPSessionAffinityFilter> implements IGCPSessionAffinityFilter {
...
static apiVersion: IGCPSessionAffinityFilter["apiVersion"] = "networking.gke.io/v1";
static kind: IGCPSessionAffinityFilter["kind"] = "GCPSessionAffinityFilter";
static is = createTypeMetaGuard<IGCPSessionAffinityFilter>(GCPSessionAffinityFilter);

constructor(data?: ModelData<IGCPSessionAffinityFilter>) {
  super();

  this.setDefinedProps({
    apiVersion: GCPSessionAffinityFilter.apiVersion,
    kind: GCPSessionAffinityFilter.kind,
    ...data
  } as IGCPSessionAffinityFilter);
}
}


setValidateFunc(GCPSessionAffinityFilter, validate as ValidateFunc<IGCPSessionAffinityFilter>);
