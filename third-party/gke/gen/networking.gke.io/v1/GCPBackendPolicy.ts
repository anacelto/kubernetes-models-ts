 ...
 * the GKE implementation of the Gateway API.
 */
export class GCPBackendPolicy extends Model<IGCPBackendPolicy> implements IGCPBackendPolicy {
  "apiVersion": IGCPBackendPolicy["apiVersion"];
  "kind": IGCPBackendPolicy["kind"];
  "metadata"?: IGCPBackendPolicy["metadata"];
  "spec": IGCPBackendPolicy["spec"];
  "status"?: IGCPBackendPolicy["status"];

static apiVersion: IGCPBackendPolicy["apiVersion"] = "networking.gke.io/v1";
static kind: IGCPBackendPolicy["kind"] = "GCPBackendPolicy";
static is = createTypeMetaGuard<IGCPBackendPolicy>(GCPBackendPolicy);

constructor(data?: ModelData<IGCPBackendPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: GCPBackendPolicy.apiVersion,
    kind: GCPBackendPolicy.kind,
    ...data
  } as IGCPBackendPolicy);
}
}


setValidateFunc(GCPBackendPolicy, validate as ValidateFunc<IGCPBackendPolicy>);
