...
import { validate } from "../../_schemas/NetworkingGkeIoV1HealthCheckPolicy";
 ...
 * the GKE implementation of the Gateway API. This policy can only be attached to a BackendService.
 */
export class HealthCheckPolicy extends Model<IHealthCheckPolicy> implements IHealthCheckPolicy {
...
static apiVersion: IHealthCheckPolicy["apiVersion"] = "networking.gke.io/v1";
static kind: IHealthCheckPolicy["kind"] = "HealthCheckPolicy";
static is = createTypeMetaGuard<IHealthCheckPolicy>(HealthCheckPolicy);

constructor(data?: ModelData<IHealthCheckPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: HealthCheckPolicy.apiVersion,
    kind: HealthCheckPolicy.kind,
    ...data
  } as IHealthCheckPolicy);
}
}


setValidateFunc(HealthCheckPolicy, validate as ValidateFunc<IHealthCheckPolicy>);
