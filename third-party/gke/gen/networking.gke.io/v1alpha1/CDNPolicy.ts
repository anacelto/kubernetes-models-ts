...
import { validate } from "../../_schemas/NetworkingGkeIoV1alpha1CDNPolicy";
 ...
 * CDNPolicy provides a way to apply CDN policy configuration with the GKE implementation of the Gateway API.
 */
export class CDNPolicy extends Model<ICDNPolicy> implements ICDNPolicy {
...
static apiVersion: ICDNPolicy["apiVersion"] = "networking.gke.io/v1alpha1";
static kind: ICDNPolicy["kind"] = "CDNPolicy";
static is = createTypeMetaGuard<ICDNPolicy>(CDNPolicy);

constructor(data?: ModelData<ICDNPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: CDNPolicy.apiVersion,
    kind: CDNPolicy.kind,
    ...data
  } as ICDNPolicy);
}
...
setValidateFunc(CDNPolicy, validate as ValidateFunc<ICDNPolicy>);
