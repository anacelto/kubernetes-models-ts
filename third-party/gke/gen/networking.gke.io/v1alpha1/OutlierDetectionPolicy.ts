...
import { validate } from "../../_schemas/NetworkingGkeIoV1alpha1OutlierDetectionPolicy";
 ...
 * OutlierDetectionPolicy provides a way to apply LoadBalancer policy configuration with the GKE implementation of the Gateway API.
 */
export class OutlierDetectionPolicy extends Model<IOutlierDetectionPolicy> implements IOutlierDetectionPolicy {
...
static apiVersion: IOutlierDetectionPolicy["apiVersion"] = "networking.gke.io/v1alpha1";
static kind: IOutlierDetectionPolicy["kind"] = "OutlierDetectionPolicy";
static is = createTypeMetaGuard<IOutlierDetectionPolicy>(OutlierDetectionPolicy);

constructor(data?: ModelData<IOutlierDetectionPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: OutlierDetectionPolicy.apiVersion,
    kind: OutlierDetectionPolicy.kind,
    ...data
  } as IOutlierDetectionPolicy);
}
}


setValidateFunc(OutlierDetectionPolicy, validate as ValidateFunc<IOutlierDetectionPolicy>);
