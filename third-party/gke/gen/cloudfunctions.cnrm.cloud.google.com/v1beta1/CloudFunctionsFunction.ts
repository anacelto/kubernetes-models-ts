...
import { validate } from "../../_schemas/CloudfunctionsCnrmCloudGoogleComV1beta1CloudFunctionsFunction";

export interface ICloudFunctionsFunction {
  /**
...
export class CloudFunctionsFunction extends Model<ICloudFunctionsFunction> implements ICloudFunctionsFunction {
  "apiVersion": ICloudFunctionsFunction["apiVersion"];
  "kind": ICloudFunctionsFunction["kind"];
  "metadata"?: ICloudFunctionsFunction["metadata"];
  "spec": ICloudFunctionsFunction["spec"];
  "status"?: ICloudFunctionsFunction["status"];

static apiVersion: ICloudFunctionsFunction["apiVersion"] = "cloudfunctions.cnrm.cloud.google.com/v1beta1";
static kind: ICloudFunctionsFunction["kind"] = "CloudFunctionsFunction";
static is = createTypeMetaGuard<ICloudFunctionsFunction>(CloudFunctionsFunction);

constructor(data?: ModelData<ICloudFunctionsFunction>) {
  super();

  this.setDefinedProps({
    apiVersion: CloudFunctionsFunction.apiVersion,
    kind: CloudFunctionsFunction.kind,
    ...data
  } as ICloudFunctionsFunction);
}
}


setValidateFunc(CloudFunctionsFunction, validate as ValidateFunc<ICloudFunctionsFunction>);
