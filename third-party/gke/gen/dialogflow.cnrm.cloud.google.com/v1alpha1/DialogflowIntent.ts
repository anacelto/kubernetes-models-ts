...
import { validate } from "../../_schemas/DialogflowCnrmCloudGoogleComV1alpha1DialogflowIntent";
...
export class DialogflowIntent extends Model<IDialogflowIntent> implements IDialogflowIntent {
...
static apiVersion: IDialogflowIntent["apiVersion"] = "dialogflow.cnrm.cloud.google.com/v1alpha1";
static kind: IDialogflowIntent["kind"] = "DialogflowIntent";
static is = createTypeMetaGuard<IDialogflowIntent>(DialogflowIntent);

constructor(data?: ModelData<IDialogflowIntent>) {
  super();

  this.setDefinedProps({
    apiVersion: DialogflowIntent.apiVersion,
    kind: DialogflowIntent.kind,
    ...data
  } as IDialogflowIntent);
}
}


setValidateFunc(DialogflowIntent, validate as ValidateFunc<IDialogflowIntent>);
