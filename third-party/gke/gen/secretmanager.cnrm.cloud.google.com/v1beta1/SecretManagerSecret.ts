...
import { validate } from "../../_schemas/SecretmanagerCnrmCloudGoogleComV1beta1SecretManagerSecret";
...
export class SecretManagerSecret extends Model<ISecretManagerSecret> implements ISecretManagerSecret {
...
static apiVersion: ISecretManagerSecret["apiVersion"] = "secretmanager.cnrm.cloud.google.com/v1beta1";
static kind: ISecretManagerSecret["kind"] = "SecretManagerSecret";
static is = createTypeMetaGuard<ISecretManagerSecret>(SecretManagerSecret);

constructor(data?: ModelData<ISecretManagerSecret>) {
  super();

  this.setDefinedProps({
    apiVersion: SecretManagerSecret.apiVersion,
    kind: SecretManagerSecret.kind,
    ...data
  } as ISecretManagerSecret);
}
}


setValidateFunc(SecretManagerSecret, validate as ValidateFunc<ISecretManagerSecret>);
