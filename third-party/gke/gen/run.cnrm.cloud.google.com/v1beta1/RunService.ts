...
import { validate } from "../../_schemas/RunCnrmCloudGoogleComV1beta1RunService";
...
export class RunService extends Model<IRunService> implements IRunService {
  "apiVersion": IRunService["apiVersion"];
  "kind": IRunService["kind"];
  "metadata"?: IRunService["metadata"];
  "spec": IRunService["spec"];
  "status"?: IRunService["status"];

static apiVersion: IRunService["apiVersion"] = "run.cnrm.cloud.google.com/v1beta1";
static kind: IRunService["kind"] = "RunService";
static is = createTypeMetaGuard<IRunService>(RunService);

constructor(data?: ModelData<IRunService>) {
  super();

  this.setDefinedProps({
    apiVersion: RunService.apiVersion,
    kind: RunService.kind,
    ...data
  } as IRunService);
}
}
...
setValidateFunc(RunService, validate as ValidateFunc<IRunService>);
