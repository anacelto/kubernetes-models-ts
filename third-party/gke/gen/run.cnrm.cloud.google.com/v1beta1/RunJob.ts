...
import { validate } from "../../_schemas/RunCnrmCloudGoogleComV1beta1RunJob";
...
export class RunJob extends Model<IRunJob> implements IRunJob {
...
static apiVersion: IRunJob["apiVersion"] = "run.cnrm.cloud.google.com/v1beta1";
static kind: IRunJob["kind"] = "RunJob";
static is = createTypeMetaGuard<IRunJob>(RunJob);

constructor(data?: ModelData<IRunJob>) {
  super();

  this.setDefinedProps({
    apiVersion: RunJob.apiVersion,
    kind: RunJob.kind,
    ...data
  } as IRunJob);
}
...
setValidateFunc(RunJob, validate as ValidateFunc<IRunJob>);
