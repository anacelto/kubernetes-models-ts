...
import { validate } from "../../_schemas/EventarcCnrmCloudGoogleComV1beta1EventarcTrigger";
...
export class EventarcTrigger extends Model<IEventarcTrigger> implements IEventarcTrigger {
...
static apiVersion: IEventarcTrigger["apiVersion"] = "eventarc.cnrm.cloud.google.com/v1beta1";
static kind: IEventarcTrigger["kind"] = "EventarcTrigger";
static is = createTypeMetaGuard<IEventarcTrigger>(EventarcTrigger);

constructor(data?: ModelData<IEventarcTrigger>) {
  super();

  this.setDefinedProps({
    apiVersion: EventarcTrigger.apiVersion,
    kind: EventarcTrigger.kind,
    ...data
  } as IEventarcTrigger);
}
}
...
setValidateFunc(EventarcTrigger, validate as ValidateFunc<IEventarcTrigger>);
