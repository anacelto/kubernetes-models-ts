...
import { validate } from "../../_schemas/MonitoringCnrmCloudGoogleComV1beta1MonitoringDashboard";
...
export class MonitoringDashboard extends Model<IMonitoringDashboard> implements IMonitoringDashboard {
...
static apiVersion: IMonitoringDashboard["apiVersion"] = "monitoring.cnrm.cloud.google.com/v1beta1";
static kind: IMonitoringDashboard["kind"] = "MonitoringDashboard";
static is = createTypeMetaGuard<IMonitoringDashboard>(MonitoringDashboard);

constructor(data?: ModelData<IMonitoringDashboard>) {
  super();

  this.setDefinedProps({
    apiVersion: MonitoringDashboard.apiVersion,
    kind: MonitoringDashboard.kind,
    ...data
  } as IMonitoringDashboard);
}
}


setValidateFunc(MonitoringDashboard, validate as ValidateFunc<IMonitoringDashboard>);
