...
import { validate } from "../../_schemas/MonitoringCnrmCloudGoogleComV1beta1MonitoringMetricDescriptor";

export interface IMonitoringMetricDescriptor {
  /**
...
export class MonitoringMetricDescriptor extends Model<IMonitoringMetricDescriptor> implements IMonitoringMetricDescriptor {
  "apiVersion": IMonitoringMetricDescriptor["apiVersion"];
  "kind": IMonitoringMetricDescriptor["kind"];
  "metadata"?: IMonitoringMetricDescriptor["metadata"];
  "spec": IMonitoringMetricDescriptor["spec"];
  "status"?: IMonitoringMetricDescriptor["status"];

static apiVersion: IMonitoringMetricDescriptor["apiVersion"] = "monitoring.cnrm.cloud.google.com/v1beta1";
static kind: IMonitoringMetricDescriptor["kind"] = "MonitoringMetricDescriptor";
static is = createTypeMetaGuard<IMonitoringMetricDescriptor>(MonitoringMetricDescriptor);

constructor(data?: ModelData<IMonitoringMetricDescriptor>) {
  super();

  this.setDefinedProps({
    apiVersion: MonitoringMetricDescriptor.apiVersion,
    kind: MonitoringMetricDescriptor.kind,
    ...data
  } as IMonitoringMetricDescriptor);
}
}


setValidateFunc(MonitoringMetricDescriptor, validate as ValidateFunc<IMonitoringMetricDescriptor>);
