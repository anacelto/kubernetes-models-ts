...
import { validate } from "../../_schemas/NetworkconnectivityCnrmCloudGoogleComV1beta1NetworkConnectivitySpoke";

export interface INetworkConnectivitySpoke {
  /**
...
export class NetworkConnectivitySpoke extends Model<INetworkConnectivitySpoke> implements INetworkConnectivitySpoke {
  "apiVersion": INetworkConnectivitySpoke["apiVersion"];
  "kind": INetworkConnectivitySpoke["kind"];
  "metadata"?: INetworkConnectivitySpoke["metadata"];
  "spec": INetworkConnectivitySpoke["spec"];
  "status"?: INetworkConnectivitySpoke["status"];

static apiVersion: INetworkConnectivitySpoke["apiVersion"] = "networkconnectivity.cnrm.cloud.google.com/v1beta1";
static kind: INetworkConnectivitySpoke["kind"] = "NetworkConnectivitySpoke";
static is = createTypeMetaGuard<INetworkConnectivitySpoke>(NetworkConnectivitySpoke);

constructor(data?: ModelData<INetworkConnectivitySpoke>) {
  super();

  this.setDefinedProps({
    apiVersion: NetworkConnectivitySpoke.apiVersion,
    kind: NetworkConnectivitySpoke.kind,
    ...data
  } as INetworkConnectivitySpoke);
}
}


setValidateFunc(NetworkConnectivitySpoke, validate as ValidateFunc<INetworkConnectivitySpoke>);
