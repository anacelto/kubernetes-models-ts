...
import { validate } from "../../_schemas/LoggingCnrmCloudGoogleComV1beta1LoggingLogView";

export interface ILoggingLogView {
  /**
...
export class LoggingLogView extends Model<ILoggingLogView> implements ILoggingLogView {
  "apiVersion": ILoggingLogView["apiVersion"];
  "kind": ILoggingLogView["kind"];
  "metadata"?: ILoggingLogView["metadata"];
  "spec": ILoggingLogView["spec"];
  "status"?: ILoggingLogView["status"];

static apiVersion: ILoggingLogView["apiVersion"] = "logging.cnrm.cloud.google.com/v1beta1";
static kind: ILoggingLogView["kind"] = "LoggingLogView";
static is = createTypeMetaGuard<ILoggingLogView>(LoggingLogView);

constructor(data?: ModelData<ILoggingLogView>) {
  super();

  this.setDefinedProps({
    apiVersion: LoggingLogView.apiVersion,
    kind: LoggingLogView.kind,
    ...data
  } as ILoggingLogView);
}
}
...
setValidateFunc(LoggingLogView, validate as ValidateFunc<ILoggingLogView>);
