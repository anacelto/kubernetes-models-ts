...
import { validate } from "../../_schemas/LoggingCnrmCloudGoogleComV1beta1LoggingLogSink";

export interface ILoggingLogSink {
  /**
...
export class LoggingLogSink extends Model<ILoggingLogSink> implements ILoggingLogSink {
  "apiVersion": ILoggingLogSink["apiVersion"];
  "kind": ILoggingLogSink["kind"];
  "metadata"?: ILoggingLogSink["metadata"];
  "spec": ILoggingLogSink["spec"];
  "status"?: ILoggingLogSink["status"];

static apiVersion: ILoggingLogSink["apiVersion"] = "logging.cnrm.cloud.google.com/v1beta1";
static kind: ILoggingLogSink["kind"] = "LoggingLogSink";
static is = createTypeMetaGuard<ILoggingLogSink>(LoggingLogSink);

constructor(data?: ModelData<ILoggingLogSink>) {
  super();

  this.setDefinedProps({
    apiVersion: LoggingLogSink.apiVersion,
    kind: LoggingLogSink.kind,
    ...data
  } as ILoggingLogSink);
}
}
...
setValidateFunc(LoggingLogSink, validate as ValidateFunc<ILoggingLogSink>);
