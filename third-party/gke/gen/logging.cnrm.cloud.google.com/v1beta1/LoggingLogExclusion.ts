...
import { validate } from "../../_schemas/LoggingCnrmCloudGoogleComV1beta1LoggingLogExclusion";

export interface ILoggingLogExclusion {
  /**
...
export class LoggingLogExclusion extends Model<ILoggingLogExclusion> implements ILoggingLogExclusion {
  "apiVersion": ILoggingLogExclusion["apiVersion"];
  "kind": ILoggingLogExclusion["kind"];
  "metadata"?: ILoggingLogExclusion["metadata"];
  "spec": ILoggingLogExclusion["spec"];
  "status"?: ILoggingLogExclusion["status"];

static apiVersion: ILoggingLogExclusion["apiVersion"] = "logging.cnrm.cloud.google.com/v1beta1";
static kind: ILoggingLogExclusion["kind"] = "LoggingLogExclusion";
static is = createTypeMetaGuard<ILoggingLogExclusion>(LoggingLogExclusion);

constructor(data?: ModelData<ILoggingLogExclusion>) {
  super();

  this.setDefinedProps({
    apiVersion: LoggingLogExclusion.apiVersion,
    kind: LoggingLogExclusion.kind,
    ...data
  } as ILoggingLogExclusion);
}
}


setValidateFunc(LoggingLogExclusion, validate as ValidateFunc<ILoggingLogExclusion>);
