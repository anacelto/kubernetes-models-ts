...
import { validate } from "../../_schemas/LoggingCnrmCloudGoogleComV1beta1LoggingLogMetric";

export interface ILoggingLogMetric {
  /**
...
export class LoggingLogMetric extends Model<ILoggingLogMetric> implements ILoggingLogMetric {
  "apiVersion": ILoggingLogMetric["apiVersion"];
  "kind": ILoggingLogMetric["kind"];
  "metadata"?: ILoggingLogMetric["metadata"];
  "spec": ILoggingLogMetric["spec"];
  "status"?: ILoggingLogMetric["status"];

static apiVersion: ILoggingLogMetric["apiVersion"] = "logging.cnrm.cloud.google.com/v1beta1";
static kind: ILoggingLogMetric["kind"] = "LoggingLogMetric";
static is = createTypeMetaGuard<ILoggingLogMetric>(LoggingLogMetric);

constructor(data?: ModelData<ILoggingLogMetric>) {
  super();

  this.setDefinedProps({
    apiVersion: LoggingLogMetric.apiVersion,
    kind: LoggingLogMetric.kind,
    ...data
  } as ILoggingLogMetric);
}
}


setValidateFunc(LoggingLogMetric, validate as ValidateFunc<ILoggingLogMetric>);
