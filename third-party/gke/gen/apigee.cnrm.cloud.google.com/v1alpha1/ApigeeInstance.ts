...
import { validate } from "../../_schemas/ApigeeCnrmCloudGoogleComV1alpha1ApigeeInstance";
...
export class ApigeeInstance extends Model<IApigeeInstance> implements IApigeeInstance {
...
static apiVersion: IApigeeInstance["apiVersion"] = "apigee.cnrm.cloud.google.com/v1alpha1";
static kind: IApigeeInstance["kind"] = "ApigeeInstance";
static is = createTypeMetaGuard<IApigeeInstance>(ApigeeInstance);

constructor(data?: ModelData<IApigeeInstance>) {
  super();

  this.setDefinedProps({
    apiVersion: ApigeeInstance.apiVersion,
    kind: ApigeeInstance.kind,
    ...data
  } as IApigeeInstance);
}
}
...
setValidateFunc(ApigeeInstance, validate as ValidateFunc<IApigeeInstance>);
