...
import { validate } from "../../_schemas/ApigeeCnrmCloudGoogleComV1beta1ApigeeEnvironment";
...
export class ApigeeEnvironment extends Model<IApigeeEnvironment> implements IApigeeEnvironment {
...
static apiVersion: IApigeeEnvironment["apiVersion"] = "apigee.cnrm.cloud.google.com/v1beta1";
static kind: IApigeeEnvironment["kind"] = "ApigeeEnvironment";
static is = createTypeMetaGuard<IApigeeEnvironment>(ApigeeEnvironment);

constructor(data?: ModelData<IApigeeEnvironment>) {
  super();

  this.setDefinedProps({
    apiVersion: ApigeeEnvironment.apiVersion,
    kind: ApigeeEnvironment.kind,
    ...data
  } as IApigeeEnvironment);
}
}


setValidateFunc(ApigeeEnvironment, validate as ValidateFunc<IApigeeEnvironment>);
