...
import { validate } from "../../_schemas/DnsCnrmCloudGoogleComV1beta1DNSManagedZone";
...
export class DNSManagedZone extends Model<IDNSManagedZone> implements IDNSManagedZone {
...
static apiVersion: IDNSManagedZone["apiVersion"] = "dns.cnrm.cloud.google.com/v1beta1";
static kind: IDNSManagedZone["kind"] = "DNSManagedZone";
static is = createTypeMetaGuard<IDNSManagedZone>(DNSManagedZone);

constructor(data?: ModelData<IDNSManagedZone>) {
  super();

  this.setDefinedProps({
    apiVersion: DNSManagedZone.apiVersion,
    kind: DNSManagedZone.kind,
    ...data
  } as IDNSManagedZone);
}
}
...
setValidateFunc(DNSManagedZone, validate as ValidateFunc<IDNSManagedZone>);
