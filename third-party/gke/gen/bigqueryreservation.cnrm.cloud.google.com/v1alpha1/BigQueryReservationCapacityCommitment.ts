...
import { validate } from "../../_schemas/BigqueryreservationCnrmCloudGoogleComV1alpha1BigQueryReservationCapacityCommitment";
...
export class BigQueryReservationCapacityCommitment extends Model<IBigQueryReservationCapacityCommitment> implements IBigQueryReservationCapacityCommitment {
...
static apiVersion: IBigQueryReservationCapacityCommitment["apiVersion"] = "bigqueryreservation.cnrm.cloud.google.com/v1alpha1";
static kind: IBigQueryReservationCapacityCommitment["kind"] = "BigQueryReservationCapacityCommitment";
static is = createTypeMetaGuard<IBigQueryReservationCapacityCommitment>(BigQueryReservationCapacityCommitment);

constructor(data?: ModelData<IBigQueryReservationCapacityCommitment>) {
  super();

  this.setDefinedProps({
    apiVersion: BigQueryReservationCapacityCommitment.apiVersion,
    kind: BigQueryReservationCapacityCommitment.kind,
    ...data
  } as IBigQueryReservationCapacityCommitment);
}
}


setValidateFunc(BigQueryReservationCapacityCommitment, validate as ValidateFunc<IBigQueryReservationCapacityCommitment>);
