...
import { validate } from "../../_schemas/EdgecontainerCnrmCloudGoogleComV1beta1EdgeContainerNodePool";
...
export class EdgeContainerNodePool extends Model<IEdgeContainerNodePool> implements IEdgeContainerNodePool {
...
static apiVersion: IEdgeContainerNodePool["apiVersion"] = "edgecontainer.cnrm.cloud.google.com/v1beta1";
static kind: IEdgeContainerNodePool["kind"] = "EdgeContainerNodePool";
static is = createTypeMetaGuard<IEdgeContainerNodePool>(EdgeContainerNodePool);

constructor(data?: ModelData<IEdgeContainerNodePool>) {
  super();

  this.setDefinedProps({
    apiVersion: EdgeContainerNodePool.apiVersion,
    kind: EdgeContainerNodePool.kind,
    ...data
  } as IEdgeContainerNodePool);
}
}


setValidateFunc(EdgeContainerNodePool, validate as ValidateFunc<IEdgeContainerNodePool>);
