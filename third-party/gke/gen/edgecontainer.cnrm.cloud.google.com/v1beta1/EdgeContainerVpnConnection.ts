...
import { validate } from "../../_schemas/EdgecontainerCnrmCloudGoogleComV1beta1EdgeContainerVpnConnection";
...
export class EdgeContainerVpnConnection extends Model<IEdgeContainerVpnConnection> implements IEdgeContainerVpnConnection {
...
static apiVersion: IEdgeContainerVpnConnection["apiVersion"] = "edgecontainer.cnrm.cloud.google.com/v1beta1";
static kind: IEdgeContainerVpnConnection["kind"] = "EdgeContainerVpnConnection";
static is = createTypeMetaGuard<IEdgeContainerVpnConnection>(EdgeContainerVpnConnection);

constructor(data?: ModelData<IEdgeContainerVpnConnection>) {
  super();

  this.setDefinedProps({
    apiVersion: EdgeContainerVpnConnection.apiVersion,
    kind: EdgeContainerVpnConnection.kind,
    ...data
  } as IEdgeContainerVpnConnection);
}
}


setValidateFunc(EdgeContainerVpnConnection, validate as ValidateFunc<IEdgeContainerVpnConnection>);
