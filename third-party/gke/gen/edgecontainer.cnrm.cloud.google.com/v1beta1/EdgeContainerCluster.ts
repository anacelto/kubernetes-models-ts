...
import { validate } from "../../_schemas/EdgecontainerCnrmCloudGoogleComV1beta1EdgeContainerCluster";
...
export class EdgeContainerCluster extends Model<IEdgeContainerCluster> implements IEdgeContainerCluster {
...
static apiVersion: IEdgeContainerCluster["apiVersion"] = "edgecontainer.cnrm.cloud.google.com/v1beta1";
static kind: IEdgeContainerCluster["kind"] = "EdgeContainerCluster";
static is = createTypeMetaGuard<IEdgeContainerCluster>(EdgeContainerCluster);

constructor(data?: ModelData<IEdgeContainerCluster>) {
  super();

  this.setDefinedProps({
    apiVersion: EdgeContainerCluster.apiVersion,
    kind: EdgeContainerCluster.kind,
    ...data
  } as IEdgeContainerCluster);
}
}


setValidateFunc(EdgeContainerCluster, validate as ValidateFunc<IEdgeContainerCluster>);
