...
import { validate } from "../../_schemas/AccesscontextmanagerCnrmCloudGoogleComV1alpha1AccessContextManagerAccessLevelCondition";
...
export class AccessContextManagerAccessLevelCondition extends Model<IAccessContextManagerAccessLevelCondition> implements IAccessContextManagerAccessLevelCondition {
...
static apiVersion: IAccessContextManagerAccessLevelCondition["apiVersion"] = "accesscontextmanager.cnrm.cloud.google.com/v1alpha1";
static kind: IAccessContextManagerAccessLevelCondition["kind"] = "AccessContextManagerAccessLevelCondition";
static is = createTypeMetaGuard<IAccessContextManagerAccessLevelCondition>(AccessContextManagerAccessLevelCondition);

constructor(data?: ModelData<IAccessContextManagerAccessLevelCondition>) {
  super();

  this.setDefinedProps({
    apiVersion: AccessContextManagerAccessLevelCondition.apiVersion,
    kind: AccessContextManagerAccessLevelCondition.kind,
    ...data
  } as IAccessContextManagerAccessLevelCondition);
}
}


setValidateFunc(AccessContextManagerAccessLevelCondition, validate as ValidateFunc<IAccessContextManagerAccessLevelCondition>);
