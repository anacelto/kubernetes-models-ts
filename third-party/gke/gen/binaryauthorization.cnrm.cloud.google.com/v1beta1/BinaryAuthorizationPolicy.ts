...
import { validate } from "../../_schemas/BinaryauthorizationCnrmCloudGoogleComV1beta1BinaryAuthorizationPolicy";

export interface IBinaryAuthorizationPolicy {
  /**
  ...
  "spec": {
     ...
     */
    "admissionWhitelistPatterns"?: Array<{
      /**
...
export class BinaryAuthorizationPolicy extends Model<IBinaryAuthorizationPolicy> implements IBinaryAuthorizationPolicy {
  "apiVersion": IBinaryAuthorizationPolicy["apiVersion"];
  "kind": IBinaryAuthorizationPolicy["kind"];
  "metadata"?: IBinaryAuthorizationPolicy["metadata"];
  "spec": IBinaryAuthorizationPolicy["spec"];
  "status"?: IBinaryAuthorizationPolicy["status"];

static apiVersion: IBinaryAuthorizationPolicy["apiVersion"] = "binaryauthorization.cnrm.cloud.google.com/v1beta1";
static kind: IBinaryAuthorizationPolicy["kind"] = "BinaryAuthorizationPolicy";
static is = createTypeMetaGuard<IBinaryAuthorizationPolicy>(BinaryAuthorizationPolicy);

constructor(data?: ModelData<IBinaryAuthorizationPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: BinaryAuthorizationPolicy.apiVersion,
    kind: BinaryAuthorizationPolicy.kind,
    ...data
  } as IBinaryAuthorizationPolicy);
}
}


setValidateFunc(BinaryAuthorizationPolicy, validate as ValidateFunc<IBinaryAuthorizationPolicy>);
