...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1alpha1ComputeOrganizationSecurityPolicyRule";
...
export class ComputeOrganizationSecurityPolicyRule extends Model<IComputeOrganizationSecurityPolicyRule> implements IComputeOrganizationSecurityPolicyRule {
...
static apiVersion: IComputeOrganizationSecurityPolicyRule["apiVersion"] = "compute.cnrm.cloud.google.com/v1alpha1";
static kind: IComputeOrganizationSecurityPolicyRule["kind"] = "ComputeOrganizationSecurityPolicyRule";
static is = createTypeMetaGuard<IComputeOrganizationSecurityPolicyRule>(ComputeOrganizationSecurityPolicyRule);

constructor(data?: ModelData<IComputeOrganizationSecurityPolicyRule>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeOrganizationSecurityPolicyRule.apiVersion,
    kind: ComputeOrganizationSecurityPolicyRule.kind,
    ...data
  } as IComputeOrganizationSecurityPolicyRule);
}
}


setValidateFunc(ComputeOrganizationSecurityPolicyRule, validate as ValidateFunc<IComputeOrganizationSecurityPolicyRule>);
