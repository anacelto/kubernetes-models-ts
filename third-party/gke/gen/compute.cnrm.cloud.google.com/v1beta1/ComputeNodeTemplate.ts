...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeNodeTemplate";
...
export class ComputeNodeTemplate extends Model<IComputeNodeTemplate> implements IComputeNodeTemplate {
...
static apiVersion: IComputeNodeTemplate["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeNodeTemplate["kind"] = "ComputeNodeTemplate";
static is = createTypeMetaGuard<IComputeNodeTemplate>(ComputeNodeTemplate);

constructor(data?: ModelData<IComputeNodeTemplate>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeNodeTemplate.apiVersion,
    kind: ComputeNodeTemplate.kind,
    ...data
  } as IComputeNodeTemplate);
}
}


setValidateFunc(ComputeNodeTemplate, validate as ValidateFunc<IComputeNodeTemplate>);
