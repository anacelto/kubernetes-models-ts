...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeFirewall";
...
export class ComputeFirewall extends Model<IComputeFirewall> implements IComputeFirewall {
...
static apiVersion: IComputeFirewall["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeFirewall["kind"] = "ComputeFirewall";
static is = createTypeMetaGuard<IComputeFirewall>(ComputeFirewall);

constructor(data?: ModelData<IComputeFirewall>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeFirewall.apiVersion,
    kind: ComputeFirewall.kind,
    ...data
  } as IComputeFirewall);
}
}
...
setValidateFunc(ComputeFirewall, validate as ValidateFunc<IComputeFirewall>);
