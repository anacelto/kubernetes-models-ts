...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeInstanceTemplate";

export interface IComputeInstanceTemplate {
  /**
...
export class ComputeInstanceTemplate extends Model<IComputeInstanceTemplate> implements IComputeInstanceTemplate {
  "apiVersion": IComputeInstanceTemplate["apiVersion"];
  "kind": IComputeInstanceTemplate["kind"];
  "metadata"?: IComputeInstanceTemplate["metadata"];
  "spec": IComputeInstanceTemplate["spec"];
  "status"?: IComputeInstanceTemplate["status"];

static apiVersion: IComputeInstanceTemplate["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeInstanceTemplate["kind"] = "ComputeInstanceTemplate";
static is = createTypeMetaGuard<IComputeInstanceTemplate>(ComputeInstanceTemplate);

constructor(data?: ModelData<IComputeInstanceTemplate>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeInstanceTemplate.apiVersion,
    kind: ComputeInstanceTemplate.kind,
    ...data
  } as IComputeInstanceTemplate);
}
}


setValidateFunc(ComputeInstanceTemplate, validate as ValidateFunc<IComputeInstanceTemplate>);
