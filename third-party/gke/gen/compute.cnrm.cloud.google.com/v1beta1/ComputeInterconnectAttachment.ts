...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeInterconnectAttachment";
...
export class ComputeInterconnectAttachment extends Model<IComputeInterconnectAttachment> implements IComputeInterconnectAttachment {
...
static apiVersion: IComputeInterconnectAttachment["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeInterconnectAttachment["kind"] = "ComputeInterconnectAttachment";
static is = createTypeMetaGuard<IComputeInterconnectAttachment>(ComputeInterconnectAttachment);

constructor(data?: ModelData<IComputeInterconnectAttachment>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeInterconnectAttachment.apiVersion,
    kind: ComputeInterconnectAttachment.kind,
    ...data
  } as IComputeInterconnectAttachment);
}
}


setValidateFunc(ComputeInterconnectAttachment, validate as ValidateFunc<IComputeInterconnectAttachment>);
