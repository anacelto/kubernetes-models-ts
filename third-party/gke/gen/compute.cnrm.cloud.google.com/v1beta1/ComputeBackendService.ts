...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeBackendService";

export interface IComputeBackendService {
  /**
...
export class ComputeBackendService extends Model<IComputeBackendService> implements IComputeBackendService {
  "apiVersion": IComputeBackendService["apiVersion"];
  "kind": IComputeBackendService["kind"];
  "metadata"?: IComputeBackendService["metadata"];
  "spec": IComputeBackendService["spec"];
  "status"?: IComputeBackendService["status"];

static apiVersion: IComputeBackendService["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeBackendService["kind"] = "ComputeBackendService";
static is = createTypeMetaGuard<IComputeBackendService>(ComputeBackendService);

constructor(data?: ModelData<IComputeBackendService>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeBackendService.apiVersion,
    kind: ComputeBackendService.kind,
    ...data
  } as IComputeBackendService);
}
}


setValidateFunc(ComputeBackendService, validate as ValidateFunc<IComputeBackendService>);
