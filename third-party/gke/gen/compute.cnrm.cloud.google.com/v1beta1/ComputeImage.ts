...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeImage";
...
export class ComputeImage extends Model<IComputeImage> implements IComputeImage {
...
static apiVersion: IComputeImage["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeImage["kind"] = "ComputeImage";
static is = createTypeMetaGuard<IComputeImage>(ComputeImage);

constructor(data?: ModelData<IComputeImage>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeImage.apiVersion,
    kind: ComputeImage.kind,
    ...data
  } as IComputeImage);
}
}
...
setValidateFunc(ComputeImage, validate as ValidateFunc<IComputeImage>);
