...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeInstanceGroupManager";

export interface IComputeInstanceGroupManager {
  /**
...
export class ComputeInstanceGroupManager extends Model<IComputeInstanceGroupManager> implements IComputeInstanceGroupManager {
  "apiVersion": IComputeInstanceGroupManager["apiVersion"];
  "kind": IComputeInstanceGroupManager["kind"];
  "metadata"?: IComputeInstanceGroupManager["metadata"];
  "spec": IComputeInstanceGroupManager["spec"];
  "status"?: IComputeInstanceGroupManager["status"];

static apiVersion: IComputeInstanceGroupManager["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeInstanceGroupManager["kind"] = "ComputeInstanceGroupManager";
static is = createTypeMetaGuard<IComputeInstanceGroupManager>(ComputeInstanceGroupManager);

constructor(data?: ModelData<IComputeInstanceGroupManager>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeInstanceGroupManager.apiVersion,
    kind: ComputeInstanceGroupManager.kind,
    ...data
  } as IComputeInstanceGroupManager);
}
}


setValidateFunc(ComputeInstanceGroupManager, validate as ValidateFunc<IComputeInstanceGroupManager>);
