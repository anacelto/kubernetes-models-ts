...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeInstance";
...
export class ComputeInstance extends Model<IComputeInstance> implements IComputeInstance {
...
static apiVersion: IComputeInstance["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeInstance["kind"] = "ComputeInstance";
static is = createTypeMetaGuard<IComputeInstance>(ComputeInstance);

constructor(data?: ModelData<IComputeInstance>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeInstance.apiVersion,
    kind: ComputeInstance.kind,
    ...data
  } as IComputeInstance);
}
}
...
setValidateFunc(ComputeInstance, validate as ValidateFunc<IComputeInstance>);
