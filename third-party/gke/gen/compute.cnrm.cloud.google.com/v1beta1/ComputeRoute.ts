...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeRoute";

export interface IComputeRoute {
  /**
...
export class ComputeRoute extends Model<IComputeRoute> implements IComputeRoute {
  "apiVersion": IComputeRoute["apiVersion"];
  "kind": IComputeRoute["kind"];
  "metadata"?: IComputeRoute["metadata"];
  "spec": IComputeRoute["spec"];
  "status"?: IComputeRoute["status"];

static apiVersion: IComputeRoute["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeRoute["kind"] = "ComputeRoute";
static is = createTypeMetaGuard<IComputeRoute>(ComputeRoute);

constructor(data?: ModelData<IComputeRoute>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeRoute.apiVersion,
    kind: ComputeRoute.kind,
    ...data
  } as IComputeRoute);
}
}
...
setValidateFunc(ComputeRoute, validate as ValidateFunc<IComputeRoute>);
