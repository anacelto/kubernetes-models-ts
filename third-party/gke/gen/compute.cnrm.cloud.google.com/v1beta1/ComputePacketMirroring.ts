...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputePacketMirroring";
...
export class ComputePacketMirroring extends Model<IComputePacketMirroring> implements IComputePacketMirroring {
...
static apiVersion: IComputePacketMirroring["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputePacketMirroring["kind"] = "ComputePacketMirroring";
static is = createTypeMetaGuard<IComputePacketMirroring>(ComputePacketMirroring);

constructor(data?: ModelData<IComputePacketMirroring>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputePacketMirroring.apiVersion,
    kind: ComputePacketMirroring.kind,
    ...data
  } as IComputePacketMirroring);
}
}


setValidateFunc(ComputePacketMirroring, validate as ValidateFunc<IComputePacketMirroring>);
