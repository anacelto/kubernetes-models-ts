...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeURLMap";

export interface IComputeURLMap {
  /**
...
export class ComputeURLMap extends Model<IComputeURLMap> implements IComputeURLMap {
  "apiVersion": IComputeURLMap["apiVersion"];
  "kind": IComputeURLMap["kind"];
  "metadata"?: IComputeURLMap["metadata"];
  "spec": IComputeURLMap["spec"];
  "status"?: IComputeURLMap["status"];

static apiVersion: IComputeURLMap["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeURLMap["kind"] = "ComputeURLMap";
static is = createTypeMetaGuard<IComputeURLMap>(ComputeURLMap);

constructor(data?: ModelData<IComputeURLMap>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeURLMap.apiVersion,
    kind: ComputeURLMap.kind,
    ...data
  } as IComputeURLMap);
}
}
...
setValidateFunc(ComputeURLMap, validate as ValidateFunc<IComputeURLMap>);
