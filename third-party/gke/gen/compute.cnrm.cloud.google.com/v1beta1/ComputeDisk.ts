...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeDisk";
...
export class ComputeDisk extends Model<IComputeDisk> implements IComputeDisk {
...
static apiVersion: IComputeDisk["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeDisk["kind"] = "ComputeDisk";
static is = createTypeMetaGuard<IComputeDisk>(ComputeDisk);

constructor(data?: ModelData<IComputeDisk>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeDisk.apiVersion,
    kind: ComputeDisk.kind,
    ...data
  } as IComputeDisk);
}
}
...
setValidateFunc(ComputeDisk, validate as ValidateFunc<IComputeDisk>);
