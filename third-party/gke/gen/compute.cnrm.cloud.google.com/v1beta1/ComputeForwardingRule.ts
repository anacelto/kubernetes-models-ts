...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeForwardingRule";

export interface IComputeForwardingRule {
  /**
  ...
  "spec": {
     ...
     */
    "serviceDirectoryRegistrations"?: Array<{
      /**
...
export class ComputeForwardingRule extends Model<IComputeForwardingRule> implements IComputeForwardingRule {
  "apiVersion": IComputeForwardingRule["apiVersion"];
  "kind": IComputeForwardingRule["kind"];
  "metadata"?: IComputeForwardingRule["metadata"];
  "spec": IComputeForwardingRule["spec"];
  "status"?: IComputeForwardingRule["status"];

static apiVersion: IComputeForwardingRule["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeForwardingRule["kind"] = "ComputeForwardingRule";
static is = createTypeMetaGuard<IComputeForwardingRule>(ComputeForwardingRule);

constructor(data?: ModelData<IComputeForwardingRule>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeForwardingRule.apiVersion,
    kind: ComputeForwardingRule.kind,
    ...data
  } as IComputeForwardingRule);
}
}


setValidateFunc(ComputeForwardingRule, validate as ValidateFunc<IComputeForwardingRule>);
