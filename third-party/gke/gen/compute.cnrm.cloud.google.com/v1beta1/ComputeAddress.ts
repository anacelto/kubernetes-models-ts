...
import { validate } from "../../_schemas/ComputeCnrmCloudGoogleComV1beta1ComputeAddress";
...
export class ComputeAddress extends Model<IComputeAddress> implements IComputeAddress {
...
static apiVersion: IComputeAddress["apiVersion"] = "compute.cnrm.cloud.google.com/v1beta1";
static kind: IComputeAddress["kind"] = "ComputeAddress";
static is = createTypeMetaGuard<IComputeAddress>(ComputeAddress);

constructor(data?: ModelData<IComputeAddress>) {
  super();

  this.setDefinedProps({
    apiVersion: ComputeAddress.apiVersion,
    kind: ComputeAddress.kind,
    ...data
  } as IComputeAddress);
}
}
...
setValidateFunc(ComputeAddress, validate as ValidateFunc<IComputeAddress>);
