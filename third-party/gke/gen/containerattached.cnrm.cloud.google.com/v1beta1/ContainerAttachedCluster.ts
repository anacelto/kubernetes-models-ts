...
import { validate } from "../../_schemas/ContainerattachedCnrmCloudGoogleComV1beta1ContainerAttachedCluster";
...
export class ContainerAttachedCluster extends Model<IContainerAttachedCluster> implements IContainerAttachedCluster {
...
static apiVersion: IContainerAttachedCluster["apiVersion"] = "containerattached.cnrm.cloud.google.com/v1beta1";
static kind: IContainerAttachedCluster["kind"] = "ContainerAttachedCluster";
static is = createTypeMetaGuard<IContainerAttachedCluster>(ContainerAttachedCluster);

constructor(data?: ModelData<IContainerAttachedCluster>) {
  super();

  this.setDefinedProps({
    apiVersion: ContainerAttachedCluster.apiVersion,
    kind: ContainerAttachedCluster.kind,
    ...data
  } as IContainerAttachedCluster);
}
}


setValidateFunc(ContainerAttachedCluster, validate as ValidateFunc<IContainerAttachedCluster>);
