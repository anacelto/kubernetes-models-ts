...
import { validate } from "../../_schemas/MemcacheCnrmCloudGoogleComV1beta1MemcacheInstance";
...
export class MemcacheInstance extends Model<IMemcacheInstance> implements IMemcacheInstance {
...
static apiVersion: IMemcacheInstance["apiVersion"] = "memcache.cnrm.cloud.google.com/v1beta1";
static kind: IMemcacheInstance["kind"] = "MemcacheInstance";
static is = createTypeMetaGuard<IMemcacheInstance>(MemcacheInstance);

constructor(data?: ModelData<IMemcacheInstance>) {
  super();

  this.setDefinedProps({
    apiVersion: MemcacheInstance.apiVersion,
    kind: MemcacheInstance.kind,
    ...data
  } as IMemcacheInstance);
}
}


setValidateFunc(MemcacheInstance, validate as ValidateFunc<IMemcacheInstance>);
