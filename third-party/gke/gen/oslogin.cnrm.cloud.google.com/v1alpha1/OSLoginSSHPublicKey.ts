...
import { validate } from "../../_schemas/OsloginCnrmCloudGoogleComV1alpha1OSLoginSSHPublicKey";
...
export class OSLoginSSHPublicKey extends Model<IOSLoginSSHPublicKey> implements IOSLoginSSHPublicKey {
...
static apiVersion: IOSLoginSSHPublicKey["apiVersion"] = "oslogin.cnrm.cloud.google.com/v1alpha1";
static kind: IOSLoginSSHPublicKey["kind"] = "OSLoginSSHPublicKey";
static is = createTypeMetaGuard<IOSLoginSSHPublicKey>(OSLoginSSHPublicKey);

constructor(data?: ModelData<IOSLoginSSHPublicKey>) {
  super();

  this.setDefinedProps({
    apiVersion: OSLoginSSHPublicKey.apiVersion,
    kind: OSLoginSSHPublicKey.kind,
    ...data
  } as IOSLoginSSHPublicKey);
}
}


setValidateFunc(OSLoginSSHPublicKey, validate as ValidateFunc<IOSLoginSSHPublicKey>);
