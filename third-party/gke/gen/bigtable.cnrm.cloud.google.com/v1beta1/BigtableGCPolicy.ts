...
import { validate } from "../../_schemas/BigtableCnrmCloudGoogleComV1beta1BigtableGCPolicy";
...
export class BigtableGCPolicy extends Model<IBigtableGCPolicy> implements IBigtableGCPolicy {
...
static apiVersion: IBigtableGCPolicy["apiVersion"] = "bigtable.cnrm.cloud.google.com/v1beta1";
static kind: IBigtableGCPolicy["kind"] = "BigtableGCPolicy";
static is = createTypeMetaGuard<IBigtableGCPolicy>(BigtableGCPolicy);

constructor(data?: ModelData<IBigtableGCPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: BigtableGCPolicy.apiVersion,
    kind: BigtableGCPolicy.kind,
    ...data
  } as IBigtableGCPolicy);
}
}


setValidateFunc(BigtableGCPolicy, validate as ValidateFunc<IBigtableGCPolicy>);
