...
import { validate } from "../../_schemas/BigtableCnrmCloudGoogleComV1beta1BigtableInstance";
...
export class BigtableInstance extends Model<IBigtableInstance> implements IBigtableInstance {
...
static apiVersion: IBigtableInstance["apiVersion"] = "bigtable.cnrm.cloud.google.com/v1beta1";
static kind: IBigtableInstance["kind"] = "BigtableInstance";
static is = createTypeMetaGuard<IBigtableInstance>(BigtableInstance);

constructor(data?: ModelData<IBigtableInstance>) {
  super();

  this.setDefinedProps({
    apiVersion: BigtableInstance.apiVersion,
    kind: BigtableInstance.kind,
    ...data
  } as IBigtableInstance);
}
}


setValidateFunc(BigtableInstance, validate as ValidateFunc<IBigtableInstance>);
