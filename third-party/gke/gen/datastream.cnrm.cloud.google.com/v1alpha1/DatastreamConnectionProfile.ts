...
import { validate } from "../../_schemas/DatastreamCnrmCloudGoogleComV1alpha1DatastreamConnectionProfile";
...
export class DatastreamConnectionProfile extends Model<IDatastreamConnectionProfile> implements IDatastreamConnectionProfile {
...
static apiVersion: IDatastreamConnectionProfile["apiVersion"] = "datastream.cnrm.cloud.google.com/v1alpha1";
static kind: IDatastreamConnectionProfile["kind"] = "DatastreamConnectionProfile";
static is = createTypeMetaGuard<IDatastreamConnectionProfile>(DatastreamConnectionProfile);

constructor(data?: ModelData<IDatastreamConnectionProfile>) {
  super();

  this.setDefinedProps({
    apiVersion: DatastreamConnectionProfile.apiVersion,
    kind: DatastreamConnectionProfile.kind,
    ...data
  } as IDatastreamConnectionProfile);
}
}


setValidateFunc(DatastreamConnectionProfile, validate as ValidateFunc<IDatastreamConnectionProfile>);
