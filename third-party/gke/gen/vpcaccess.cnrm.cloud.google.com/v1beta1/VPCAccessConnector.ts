...
import { validate } from "../../_schemas/VpcaccessCnrmCloudGoogleComV1beta1VPCAccessConnector";

export interface IVPCAccessConnector {
  /**
...
export class VPCAccessConnector extends Model<IVPCAccessConnector> implements IVPCAccessConnector {
  "apiVersion": IVPCAccessConnector["apiVersion"];
  "kind": IVPCAccessConnector["kind"];
  "metadata"?: IVPCAccessConnector["metadata"];
  "spec": IVPCAccessConnector["spec"];
  "status"?: IVPCAccessConnector["status"];

static apiVersion: IVPCAccessConnector["apiVersion"] = "vpcaccess.cnrm.cloud.google.com/v1beta1";
static kind: IVPCAccessConnector["kind"] = "VPCAccessConnector";
static is = createTypeMetaGuard<IVPCAccessConnector>(VPCAccessConnector);

constructor(data?: ModelData<IVPCAccessConnector>) {
  super();

  this.setDefinedProps({
    apiVersion: VPCAccessConnector.apiVersion,
    kind: VPCAccessConnector.kind,
    ...data
  } as IVPCAccessConnector);
}
}


setValidateFunc(VPCAccessConnector, validate as ValidateFunc<IVPCAccessConnector>);
