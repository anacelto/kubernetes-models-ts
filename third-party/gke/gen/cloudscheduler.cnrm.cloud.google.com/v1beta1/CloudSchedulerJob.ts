...
import { validate } from "../../_schemas/CloudschedulerCnrmCloudGoogleComV1beta1CloudSchedulerJob";

export interface ICloudSchedulerJob {
  /**
...
export class CloudSchedulerJob extends Model<ICloudSchedulerJob> implements ICloudSchedulerJob {
  "apiVersion": ICloudSchedulerJob["apiVersion"];
  "kind": ICloudSchedulerJob["kind"];
  "metadata"?: ICloudSchedulerJob["metadata"];
  "spec": ICloudSchedulerJob["spec"];
  "status"?: ICloudSchedulerJob["status"];

static apiVersion: ICloudSchedulerJob["apiVersion"] = "cloudscheduler.cnrm.cloud.google.com/v1beta1";
static kind: ICloudSchedulerJob["kind"] = "CloudSchedulerJob";
static is = createTypeMetaGuard<ICloudSchedulerJob>(CloudSchedulerJob);

constructor(data?: ModelData<ICloudSchedulerJob>) {
  super();

  this.setDefinedProps({
    apiVersion: CloudSchedulerJob.apiVersion,
    kind: CloudSchedulerJob.kind,
    ...data
  } as ICloudSchedulerJob);
}
}


setValidateFunc(CloudSchedulerJob, validate as ValidateFunc<ICloudSchedulerJob>);
