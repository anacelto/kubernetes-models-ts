...
export declare class DataprocCluster extends Model<IDataprocCluster> implements IDataprocCluster {
    ...
    static apiVersion: IDataprocCluster["apiVersion"];
    static kind: IDataprocCluster["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDataprocCluster>;
