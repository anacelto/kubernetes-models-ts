...
export declare class DataprocAutoscalingPolicy extends Model<IDataprocAutoscalingPolicy> implements IDataprocAutoscalingPolicy {
    ...
    static apiVersion: IDataprocAutoscalingPolicy["apiVersion"];
    static kind: IDataprocAutoscalingPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDataprocAutoscalingPolicy>;
