...
export declare class DataprocWorkflowTemplate extends Model<IDataprocWorkflowTemplate> implements IDataprocWorkflowTemplate {
    ...
    static apiVersion: IDataprocWorkflowTemplate["apiVersion"];
    static kind: IDataprocWorkflowTemplate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDataprocWorkflowTemplate>;
