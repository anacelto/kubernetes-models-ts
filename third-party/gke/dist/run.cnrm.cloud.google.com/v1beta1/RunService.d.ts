...
export declare class RunService extends Model<IRunService> implements IRunService {
    ...
    static apiVersion: IRunService["apiVersion"];
    static kind: IRunService["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IRunService>;
