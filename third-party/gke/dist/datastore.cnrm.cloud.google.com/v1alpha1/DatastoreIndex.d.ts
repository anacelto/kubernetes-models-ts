...
export declare class DatastoreIndex extends Model<IDatastoreIndex> implements IDatastoreIndex {
    ...
    static apiVersion: IDatastoreIndex["apiVersion"];
    static kind: IDatastoreIndex["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDatastoreIndex>;
