...
export declare class CloudSchedulerJob extends Model<ICloudSchedulerJob> implements ICloudSchedulerJob {
    ...
    static apiVersion: ICloudSchedulerJob["apiVersion"];
    static kind: ICloudSchedulerJob["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICloudSchedulerJob>;
