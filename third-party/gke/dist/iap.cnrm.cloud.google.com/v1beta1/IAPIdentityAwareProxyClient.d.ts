...
export declare class IAPIdentityAwareProxyClient extends Model<IIAPIdentityAwareProxyClient> implements IIAPIdentityAwareProxyClient {
    ...
    static apiVersion: IIAPIdentityAwareProxyClient["apiVersion"];
    static kind: IIAPIdentityAwareProxyClient["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIAPIdentityAwareProxyClient>;
