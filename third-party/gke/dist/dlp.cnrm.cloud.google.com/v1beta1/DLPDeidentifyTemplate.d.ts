...
export declare class DLPDeidentifyTemplate extends Model<IDLPDeidentifyTemplate> implements IDLPDeidentifyTemplate {
    ...
    static apiVersion: IDLPDeidentifyTemplate["apiVersion"];
    static kind: IDLPDeidentifyTemplate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDLPDeidentifyTemplate>;
