...
export declare class DLPInspectTemplate extends Model<IDLPInspectTemplate> implements IDLPInspectTemplate {
    ...
    static apiVersion: IDLPInspectTemplate["apiVersion"];
    static kind: IDLPInspectTemplate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDLPInspectTemplate>;
