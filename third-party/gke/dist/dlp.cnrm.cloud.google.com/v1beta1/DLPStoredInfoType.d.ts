...
export declare class DLPStoredInfoType extends Model<IDLPStoredInfoType> implements IDLPStoredInfoType {
    ...
    static apiVersion: IDLPStoredInfoType["apiVersion"];
    static kind: IDLPStoredInfoType["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDLPStoredInfoType>;
