...
export declare class EssentialContactsContact extends Model<IEssentialContactsContact> implements IEssentialContactsContact {
    ...
    static apiVersion: IEssentialContactsContact["apiVersion"];
    static kind: IEssentialContactsContact["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IEssentialContactsContact>;
