...
export declare class NetworkSecurityClientTLSPolicy extends Model<INetworkSecurityClientTLSPolicy> implements INetworkSecurityClientTLSPolicy {
    ...
    static apiVersion: INetworkSecurityClientTLSPolicy["apiVersion"];
    static kind: INetworkSecurityClientTLSPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<INetworkSecurityClientTLSPolicy>;
