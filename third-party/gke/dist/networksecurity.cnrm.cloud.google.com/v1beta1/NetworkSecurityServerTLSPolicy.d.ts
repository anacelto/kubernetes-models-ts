...
export declare class NetworkSecurityServerTLSPolicy extends Model<INetworkSecurityServerTLSPolicy> implements INetworkSecurityServerTLSPolicy {
    ...
    static apiVersion: INetworkSecurityServerTLSPolicy["apiVersion"];
    static kind: INetworkSecurityServerTLSPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<INetworkSecurityServerTLSPolicy>;
