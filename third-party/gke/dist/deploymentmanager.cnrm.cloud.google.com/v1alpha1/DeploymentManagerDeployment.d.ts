...
export declare class DeploymentManagerDeployment extends Model<IDeploymentManagerDeployment> implements IDeploymentManagerDeployment {
    ...
    static apiVersion: IDeploymentManagerDeployment["apiVersion"];
    static kind: IDeploymentManagerDeployment["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDeploymentManagerDeployment>;
