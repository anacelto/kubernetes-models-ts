...
export declare class EdgeNetworkSubnet extends Model<IEdgeNetworkSubnet> implements IEdgeNetworkSubnet {
    ...
    static apiVersion: IEdgeNetworkSubnet["apiVersion"];
    static kind: IEdgeNetworkSubnet["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IEdgeNetworkSubnet>;
