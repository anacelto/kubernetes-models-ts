...
export interface IBigtableGCPolicy {
    /**
...
export declare class BigtableGCPolicy extends Model<IBigtableGCPolicy> implements IBigtableGCPolicy {
    "apiVersion": IBigtableGCPolicy["apiVersion"];
    "kind": IBigtableGCPolicy["kind"];
    "metadata"?: IBigtableGCPolicy["metadata"];
    "spec": IBigtableGCPolicy["spec"];
    "status"?: IBigtableGCPolicy["status"];
    static apiVersion: IBigtableGCPolicy["apiVersion"];
    static kind: IBigtableGCPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBigtableGCPolicy>;
    constructor(data?: ModelData<IBigtableGCPolicy>);
}
