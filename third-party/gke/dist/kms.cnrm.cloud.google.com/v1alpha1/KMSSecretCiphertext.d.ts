...
export declare class KMSSecretCiphertext extends Model<IKMSSecretCiphertext> implements IKMSSecretCiphertext {
    ...
    static apiVersion: IKMSSecretCiphertext["apiVersion"];
    static kind: IKMSSecretCiphertext["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IKMSSecretCiphertext>;
