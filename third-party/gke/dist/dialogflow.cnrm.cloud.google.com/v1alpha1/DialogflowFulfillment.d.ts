...
export declare class DialogflowFulfillment extends Model<IDialogflowFulfillment> implements IDialogflowFulfillment {
    ...
    static apiVersion: IDialogflowFulfillment["apiVersion"];
    static kind: IDialogflowFulfillment["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDialogflowFulfillment>;
