...
export declare class DialogflowAgent extends Model<IDialogflowAgent> implements IDialogflowAgent {
    ...
    static apiVersion: IDialogflowAgent["apiVersion"];
    static kind: IDialogflowAgent["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDialogflowAgent>;
