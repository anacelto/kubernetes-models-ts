...
export declare class StorageBucket extends Model<IStorageBucket> implements IStorageBucket {
    ...
    static apiVersion: IStorageBucket["apiVersion"];
    static kind: IStorageBucket["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IStorageBucket>;
