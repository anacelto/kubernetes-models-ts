...
export declare class StorageNotification extends Model<IStorageNotification> implements IStorageNotification {
    "apiVersion": IStorageNotification["apiVersion"];
    "kind": IStorageNotification["kind"];
    "metadata"?: IStorageNotification["metadata"];
    "spec": IStorageNotification["spec"];
    "status"?: IStorageNotification["status"];
    static apiVersion: IStorageNotification["apiVersion"];
    static kind: IStorageNotification["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IStorageNotification>;
    constructor(data?: ModelData<IStorageNotification>);
}
