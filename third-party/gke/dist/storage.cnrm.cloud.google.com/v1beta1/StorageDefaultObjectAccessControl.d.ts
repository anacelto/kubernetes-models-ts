...
export declare class StorageDefaultObjectAccessControl extends Model<IStorageDefaultObjectAccessControl> implements IStorageDefaultObjectAccessControl {
    ...
    static apiVersion: IStorageDefaultObjectAccessControl["apiVersion"];
    static kind: IStorageDefaultObjectAccessControl["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IStorageDefaultObjectAccessControl>;
