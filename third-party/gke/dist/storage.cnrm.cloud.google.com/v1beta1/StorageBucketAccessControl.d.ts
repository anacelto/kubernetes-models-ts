...
export declare class StorageBucketAccessControl extends Model<IStorageBucketAccessControl> implements IStorageBucketAccessControl {
    ...
    static apiVersion: IStorageBucketAccessControl["apiVersion"];
    static kind: IStorageBucketAccessControl["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IStorageBucketAccessControl>;
