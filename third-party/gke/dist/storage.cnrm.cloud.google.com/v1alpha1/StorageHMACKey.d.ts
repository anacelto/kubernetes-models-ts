...
export declare class StorageHMACKey extends Model<IStorageHMACKey> implements IStorageHMACKey {
    ...
    static apiVersion: IStorageHMACKey["apiVersion"];
    static kind: IStorageHMACKey["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IStorageHMACKey>;
