...
export declare class FirebaseDatabaseInstance extends Model<IFirebaseDatabaseInstance> implements IFirebaseDatabaseInstance {
    ...
    static apiVersion: IFirebaseDatabaseInstance["apiVersion"];
    static kind: IFirebaseDatabaseInstance["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IFirebaseDatabaseInstance>;
