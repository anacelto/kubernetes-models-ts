...
export declare class GKEHubFeature extends Model<IGKEHubFeature> implements IGKEHubFeature {
    ...
    static apiVersion: IGKEHubFeature["apiVersion"];
    static kind: IGKEHubFeature["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGKEHubFeature>;
