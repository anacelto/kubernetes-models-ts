...
export declare class DialogflowCXEntityType extends Model<IDialogflowCXEntityType> implements IDialogflowCXEntityType {
    ...
    static apiVersion: IDialogflowCXEntityType["apiVersion"];
    static kind: IDialogflowCXEntityType["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDialogflowCXEntityType>;
