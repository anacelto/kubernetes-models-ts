...
export declare class DialogflowCXAgent extends Model<IDialogflowCXAgent> implements IDialogflowCXAgent {
    ...
    static apiVersion: IDialogflowCXAgent["apiVersion"];
    static kind: IDialogflowCXAgent["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDialogflowCXAgent>;
