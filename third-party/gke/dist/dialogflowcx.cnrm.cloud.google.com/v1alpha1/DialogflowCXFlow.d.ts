...
export declare class DialogflowCXFlow extends Model<IDialogflowCXFlow> implements IDialogflowCXFlow {
    ...
    static apiVersion: IDialogflowCXFlow["apiVersion"];
    static kind: IDialogflowCXFlow["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDialogflowCXFlow>;
