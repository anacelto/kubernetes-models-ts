...
export declare class LoggingLogMetric extends Model<ILoggingLogMetric> implements ILoggingLogMetric {
    ...
    static apiVersion: ILoggingLogMetric["apiVersion"];
    static kind: ILoggingLogMetric["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ILoggingLogMetric>;
