...
export declare class LoggingLogExclusion extends Model<ILoggingLogExclusion> implements ILoggingLogExclusion {
    ...
    static apiVersion: ILoggingLogExclusion["apiVersion"];
    static kind: ILoggingLogExclusion["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ILoggingLogExclusion>;
