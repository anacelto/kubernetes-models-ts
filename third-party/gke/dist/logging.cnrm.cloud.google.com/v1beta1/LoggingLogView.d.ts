...
export declare class LoggingLogView extends Model<ILoggingLogView> implements ILoggingLogView {
    ...
    static apiVersion: ILoggingLogView["apiVersion"];
    static kind: ILoggingLogView["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ILoggingLogView>;
