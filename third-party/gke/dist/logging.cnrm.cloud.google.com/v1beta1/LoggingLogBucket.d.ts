...
export interface ILoggingLogBucket {
    /**
...
export declare class LoggingLogBucket extends Model<ILoggingLogBucket> implements ILoggingLogBucket {
    "apiVersion": ILoggingLogBucket["apiVersion"];
    "kind": ILoggingLogBucket["kind"];
    "metadata"?: ILoggingLogBucket["metadata"];
    "spec": ILoggingLogBucket["spec"];
    "status"?: ILoggingLogBucket["status"];
    static apiVersion: ILoggingLogBucket["apiVersion"];
    static kind: ILoggingLogBucket["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ILoggingLogBucket>;
    constructor(data?: ModelData<ILoggingLogBucket>);
}
