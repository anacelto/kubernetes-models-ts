...
export interface IMLEngineModel {
    /**
...
export declare class MLEngineModel extends Model<IMLEngineModel> implements IMLEngineModel {
    "apiVersion": IMLEngineModel["apiVersion"];
    "kind": IMLEngineModel["kind"];
    "metadata"?: IMLEngineModel["metadata"];
    "spec": IMLEngineModel["spec"];
    "status"?: IMLEngineModel["status"];
    static apiVersion: IMLEngineModel["apiVersion"];
    static kind: IMLEngineModel["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMLEngineModel>;
    constructor(data?: ModelData<IMLEngineModel>);
}
