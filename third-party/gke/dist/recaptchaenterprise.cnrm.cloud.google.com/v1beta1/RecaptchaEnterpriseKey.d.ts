...
export declare class RecaptchaEnterpriseKey extends Model<IRecaptchaEnterpriseKey> implements IRecaptchaEnterpriseKey {
    ...
    static apiVersion: IRecaptchaEnterpriseKey["apiVersion"];
    static kind: IRecaptchaEnterpriseKey["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IRecaptchaEnterpriseKey>;
