...
export declare class FirebaseHostingSite extends Model<IFirebaseHostingSite> implements IFirebaseHostingSite {
    ...
    static apiVersion: IFirebaseHostingSite["apiVersion"];
    static kind: IFirebaseHostingSite["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IFirebaseHostingSite>;
