...
export declare class IdentityPlatformTenant extends Model<IIdentityPlatformTenant> implements IIdentityPlatformTenant {
    ...
    static apiVersion: IIdentityPlatformTenant["apiVersion"];
    static kind: IIdentityPlatformTenant["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIdentityPlatformTenant>;
