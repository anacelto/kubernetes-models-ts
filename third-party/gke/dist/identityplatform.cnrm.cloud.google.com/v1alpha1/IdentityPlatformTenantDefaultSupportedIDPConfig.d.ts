...
export declare class IdentityPlatformTenantDefaultSupportedIDPConfig extends Model<IIdentityPlatformTenantDefaultSupportedIDPConfig> implements IIdentityPlatformTenantDefaultSupportedIDPConfig {
    ...
    static apiVersion: IIdentityPlatformTenantDefaultSupportedIDPConfig["apiVersion"];
    static kind: IIdentityPlatformTenantDefaultSupportedIDPConfig["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIdentityPlatformTenantDefaultSupportedIDPConfig>;
