...
export declare class OSConfigGuestPolicy extends Model<IOSConfigGuestPolicy> implements IOSConfigGuestPolicy {
    ...
    static apiVersion: IOSConfigGuestPolicy["apiVersion"];
    static kind: IOSConfigGuestPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IOSConfigGuestPolicy>;
