...
export declare class MonitoringGroup extends Model<IMonitoringGroup> implements IMonitoringGroup {
    ...
    static apiVersion: IMonitoringGroup["apiVersion"];
    static kind: IMonitoringGroup["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMonitoringGroup>;
