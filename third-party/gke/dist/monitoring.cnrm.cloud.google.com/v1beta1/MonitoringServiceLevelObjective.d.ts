...
export declare class MonitoringServiceLevelObjective extends Model<IMonitoringServiceLevelObjective> implements IMonitoringServiceLevelObjective {
    ...
    static apiVersion: IMonitoringServiceLevelObjective["apiVersion"];
    static kind: IMonitoringServiceLevelObjective["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMonitoringServiceLevelObjective>;
