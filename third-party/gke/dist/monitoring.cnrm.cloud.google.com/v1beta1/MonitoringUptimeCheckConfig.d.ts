...
export declare class MonitoringUptimeCheckConfig extends Model<IMonitoringUptimeCheckConfig> implements IMonitoringUptimeCheckConfig {
    ...
    static apiVersion: IMonitoringUptimeCheckConfig["apiVersion"];
    static kind: IMonitoringUptimeCheckConfig["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMonitoringUptimeCheckConfig>;
