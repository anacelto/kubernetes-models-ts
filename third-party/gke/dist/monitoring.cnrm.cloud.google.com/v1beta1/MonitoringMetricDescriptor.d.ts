...
export declare class MonitoringMetricDescriptor extends Model<IMonitoringMetricDescriptor> implements IMonitoringMetricDescriptor {
    ...
    static apiVersion: IMonitoringMetricDescriptor["apiVersion"];
    static kind: IMonitoringMetricDescriptor["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMonitoringMetricDescriptor>;
