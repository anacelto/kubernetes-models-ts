...
export declare class MonitoringAlertPolicy extends Model<IMonitoringAlertPolicy> implements IMonitoringAlertPolicy {
    ...
    static apiVersion: IMonitoringAlertPolicy["apiVersion"];
    static kind: IMonitoringAlertPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMonitoringAlertPolicy>;
