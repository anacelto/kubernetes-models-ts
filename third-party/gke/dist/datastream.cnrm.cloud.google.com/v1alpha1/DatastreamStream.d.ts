...
export declare class DatastreamStream extends Model<IDatastreamStream> implements IDatastreamStream {
    ...
    static apiVersion: IDatastreamStream["apiVersion"];
    static kind: IDatastreamStream["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDatastreamStream>;
