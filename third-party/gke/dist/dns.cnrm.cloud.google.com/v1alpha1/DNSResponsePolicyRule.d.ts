...
export declare class DNSResponsePolicyRule extends Model<IDNSResponsePolicyRule> implements IDNSResponsePolicyRule {
    ...
    static apiVersion: IDNSResponsePolicyRule["apiVersion"];
    static kind: IDNSResponsePolicyRule["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDNSResponsePolicyRule>;
