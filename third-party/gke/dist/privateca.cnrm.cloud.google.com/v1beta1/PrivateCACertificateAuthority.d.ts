...
export declare class PrivateCACertificateAuthority extends Model<IPrivateCACertificateAuthority> implements IPrivateCACertificateAuthority {
    ...
    static apiVersion: IPrivateCACertificateAuthority["apiVersion"];
    static kind: IPrivateCACertificateAuthority["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPrivateCACertificateAuthority>;
