...
export declare class PrivateCACAPool extends Model<IPrivateCACAPool> implements IPrivateCACAPool {
    ...
    static apiVersion: IPrivateCACAPool["apiVersion"];
    static kind: IPrivateCACAPool["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPrivateCACAPool>;
