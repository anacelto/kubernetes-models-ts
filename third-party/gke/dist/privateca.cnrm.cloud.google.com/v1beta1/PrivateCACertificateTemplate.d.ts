...
export declare class PrivateCACertificateTemplate extends Model<IPrivateCACertificateTemplate> implements IPrivateCACertificateTemplate {
    ...
    static apiVersion: IPrivateCACertificateTemplate["apiVersion"];
    static kind: IPrivateCACertificateTemplate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPrivateCACertificateTemplate>;
