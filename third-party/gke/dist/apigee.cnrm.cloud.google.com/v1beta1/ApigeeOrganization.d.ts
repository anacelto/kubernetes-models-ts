...
export declare class ApigeeOrganization extends Model<IApigeeOrganization> implements IApigeeOrganization {
    ...
    static apiVersion: IApigeeOrganization["apiVersion"];
    static kind: IApigeeOrganization["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IApigeeOrganization>;
