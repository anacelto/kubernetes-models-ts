...
export declare class PubSubTopic extends Model<IPubSubTopic> implements IPubSubTopic {
    ...
    static apiVersion: IPubSubTopic["apiVersion"];
    static kind: IPubSubTopic["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPubSubTopic>;
