...
export declare class PubSubSubscription extends Model<IPubSubSubscription> implements IPubSubSubscription {
    ...
    static apiVersion: IPubSubSubscription["apiVersion"];
    static kind: IPubSubSubscription["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPubSubSubscription>;
