...
export declare class ServiceDirectoryEndpoint extends Model<IServiceDirectoryEndpoint> implements IServiceDirectoryEndpoint {
    ...
    static apiVersion: IServiceDirectoryEndpoint["apiVersion"];
    static kind: IServiceDirectoryEndpoint["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IServiceDirectoryEndpoint>;
