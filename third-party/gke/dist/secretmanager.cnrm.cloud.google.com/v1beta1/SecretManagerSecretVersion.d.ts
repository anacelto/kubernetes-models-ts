...
export declare class SecretManagerSecretVersion extends Model<ISecretManagerSecretVersion> implements ISecretManagerSecretVersion {
    ...
    static apiVersion: ISecretManagerSecretVersion["apiVersion"];
    static kind: ISecretManagerSecretVersion["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISecretManagerSecretVersion>;
