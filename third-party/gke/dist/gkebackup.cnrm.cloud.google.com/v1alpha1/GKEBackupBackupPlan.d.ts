...
export declare class GKEBackupBackupPlan extends Model<IGKEBackupBackupPlan> implements IGKEBackupBackupPlan {
    ...
    static apiVersion: IGKEBackupBackupPlan["apiVersion"];
    static kind: IGKEBackupBackupPlan["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGKEBackupBackupPlan>;
