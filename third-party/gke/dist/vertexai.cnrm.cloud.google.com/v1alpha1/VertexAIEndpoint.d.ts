...
export declare class VertexAIEndpoint extends Model<IVertexAIEndpoint> implements IVertexAIEndpoint {
    ...
    static apiVersion: IVertexAIEndpoint["apiVersion"];
    static kind: IVertexAIEndpoint["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVertexAIEndpoint>;
