...
export declare class VertexAIDataset extends Model<IVertexAIDataset> implements IVertexAIDataset {
    ...
    static apiVersion: IVertexAIDataset["apiVersion"];
    static kind: IVertexAIDataset["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVertexAIDataset>;
