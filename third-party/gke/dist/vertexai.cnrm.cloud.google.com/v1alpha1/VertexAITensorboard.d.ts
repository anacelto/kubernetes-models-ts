...
export declare class VertexAITensorboard extends Model<IVertexAITensorboard> implements IVertexAITensorboard {
    ...
    static apiVersion: IVertexAITensorboard["apiVersion"];
    static kind: IVertexAITensorboard["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVertexAITensorboard>;
