...
export declare class VertexAIMetadataStore extends Model<IVertexAIMetadataStore> implements IVertexAIMetadataStore {
    ...
    static apiVersion: IVertexAIMetadataStore["apiVersion"];
    static kind: IVertexAIMetadataStore["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVertexAIMetadataStore>;
