...
export declare class CloudIdentityMembership extends Model<ICloudIdentityMembership> implements ICloudIdentityMembership {
    ...
    static apiVersion: ICloudIdentityMembership["apiVersion"];
    static kind: ICloudIdentityMembership["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICloudIdentityMembership>;
