...
export declare class CloudIdentityGroup extends Model<ICloudIdentityGroup> implements ICloudIdentityGroup {
    ...
    static apiVersion: ICloudIdentityGroup["apiVersion"];
    static kind: ICloudIdentityGroup["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICloudIdentityGroup>;
