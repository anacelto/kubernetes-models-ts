...
export declare class NetworkConnectivitySpoke extends Model<INetworkConnectivitySpoke> implements INetworkConnectivitySpoke {
    ...
    static apiVersion: INetworkConnectivitySpoke["apiVersion"];
    static kind: INetworkConnectivitySpoke["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<INetworkConnectivitySpoke>;
