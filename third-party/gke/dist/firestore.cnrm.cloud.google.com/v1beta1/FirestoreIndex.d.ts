...
export declare class FirestoreIndex extends Model<IFirestoreIndex> implements IFirestoreIndex {
    ...
    static apiVersion: IFirestoreIndex["apiVersion"];
    static kind: IFirestoreIndex["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IFirestoreIndex>;
