...
export declare class AlloyDBInstance extends Model<IAlloyDBInstance> implements IAlloyDBInstance {
    ...
    static apiVersion: IAlloyDBInstance["apiVersion"];
    static kind: IAlloyDBInstance["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAlloyDBInstance>;
