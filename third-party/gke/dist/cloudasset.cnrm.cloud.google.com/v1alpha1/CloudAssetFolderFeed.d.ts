...
export declare class CloudAssetFolderFeed extends Model<ICloudAssetFolderFeed> implements ICloudAssetFolderFeed {
    ...
    static apiVersion: ICloudAssetFolderFeed["apiVersion"];
    static kind: ICloudAssetFolderFeed["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICloudAssetFolderFeed>;
