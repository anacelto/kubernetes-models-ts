...
export declare class BeyondCorpAppConnection extends Model<IBeyondCorpAppConnection> implements IBeyondCorpAppConnection {
    ...
    static apiVersion: IBeyondCorpAppConnection["apiVersion"];
    static kind: IBeyondCorpAppConnection["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBeyondCorpAppConnection>;
