...
export declare class ResourceManagerPolicy extends Model<IResourceManagerPolicy> implements IResourceManagerPolicy {
    ...
    static apiVersion: IResourceManagerPolicy["apiVersion"];
    static kind: IResourceManagerPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IResourceManagerPolicy>;
