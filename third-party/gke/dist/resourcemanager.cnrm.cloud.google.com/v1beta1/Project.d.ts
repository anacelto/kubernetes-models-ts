...
export declare class Project extends Model<IProject> implements IProject {
    "apiVersion": IProject["apiVersion"];
    "kind": IProject["kind"];
    "metadata"?: IProject["metadata"];
    "spec": IProject["spec"];
    "status"?: IProject["status"];
    static apiVersion: IProject["apiVersion"];
    static kind: IProject["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IProject>;
