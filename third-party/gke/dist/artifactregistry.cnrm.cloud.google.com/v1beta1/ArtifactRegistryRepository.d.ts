...
export declare class ArtifactRegistryRepository extends Model<IArtifactRegistryRepository> implements IArtifactRegistryRepository {
    ...
    static apiVersion: IArtifactRegistryRepository["apiVersion"];
    static kind: IArtifactRegistryRepository["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IArtifactRegistryRepository>;
