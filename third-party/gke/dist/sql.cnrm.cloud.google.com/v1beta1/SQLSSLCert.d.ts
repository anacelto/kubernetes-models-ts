...
export declare class SQLSSLCert extends Model<ISQLSSLCert> implements ISQLSSLCert {
    ...
    static apiVersion: ISQLSSLCert["apiVersion"];
    static kind: ISQLSSLCert["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISQLSSLCert>;
