...
export declare class SQLInstance extends Model<ISQLInstance> implements ISQLInstance {
    ...
    static apiVersion: ISQLInstance["apiVersion"];
    static kind: ISQLInstance["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISQLInstance>;
