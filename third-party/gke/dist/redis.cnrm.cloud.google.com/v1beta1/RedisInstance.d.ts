...
export declare class RedisInstance extends Model<IRedisInstance> implements IRedisInstance {
    ...
    static apiVersion: IRedisInstance["apiVersion"];
    static kind: IRedisInstance["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IRedisInstance>;
