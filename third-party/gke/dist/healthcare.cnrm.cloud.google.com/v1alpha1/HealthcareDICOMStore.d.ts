...
export declare class HealthcareDICOMStore extends Model<IHealthcareDICOMStore> implements IHealthcareDICOMStore {
    ...
    static apiVersion: IHealthcareDICOMStore["apiVersion"];
    static kind: IHealthcareDICOMStore["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IHealthcareDICOMStore>;
