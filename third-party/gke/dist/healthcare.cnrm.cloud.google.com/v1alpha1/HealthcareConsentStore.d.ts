...
export declare class HealthcareConsentStore extends Model<IHealthcareConsentStore> implements IHealthcareConsentStore {
    ...
    static apiVersion: IHealthcareConsentStore["apiVersion"];
    static kind: IHealthcareConsentStore["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IHealthcareConsentStore>;
