...
export declare class HealthcareHL7V2Store extends Model<IHealthcareHL7V2Store> implements IHealthcareHL7V2Store {
    ...
    static apiVersion: IHealthcareHL7V2Store["apiVersion"];
    static kind: IHealthcareHL7V2Store["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IHealthcareHL7V2Store>;
