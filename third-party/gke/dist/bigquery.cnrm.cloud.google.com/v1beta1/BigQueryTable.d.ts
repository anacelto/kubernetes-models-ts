...
export declare class BigQueryTable extends Model<IBigQueryTable> implements IBigQueryTable {
    ...
    static apiVersion: IBigQueryTable["apiVersion"];
    static kind: IBigQueryTable["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBigQueryTable>;
