...
export declare class BigQueryDataset extends Model<IBigQueryDataset> implements IBigQueryDataset {
    ...
    static apiVersion: IBigQueryDataset["apiVersion"];
    static kind: IBigQueryDataset["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBigQueryDataset>;
