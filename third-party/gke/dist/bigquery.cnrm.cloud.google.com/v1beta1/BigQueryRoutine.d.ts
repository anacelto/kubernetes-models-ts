...
export declare class BigQueryRoutine extends Model<IBigQueryRoutine> implements IBigQueryRoutine {
    ...
    static apiVersion: IBigQueryRoutine["apiVersion"];
    static kind: IBigQueryRoutine["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBigQueryRoutine>;
