...
export declare class BigQueryDatasetAccess extends Model<IBigQueryDatasetAccess> implements IBigQueryDatasetAccess {
    ...
    static apiVersion: IBigQueryDatasetAccess["apiVersion"];
    static kind: IBigQueryDatasetAccess["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBigQueryDatasetAccess>;
