...
export declare class BinaryAuthorizationAttestor extends Model<IBinaryAuthorizationAttestor> implements IBinaryAuthorizationAttestor {
    ...
    static apiVersion: IBinaryAuthorizationAttestor["apiVersion"];
    static kind: IBinaryAuthorizationAttestor["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBinaryAuthorizationAttestor>;
