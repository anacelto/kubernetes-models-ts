...
export declare class BinaryAuthorizationPolicy extends Model<IBinaryAuthorizationPolicy> implements IBinaryAuthorizationPolicy {
    ...
    static apiVersion: IBinaryAuthorizationPolicy["apiVersion"];
    static kind: IBinaryAuthorizationPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBinaryAuthorizationPolicy>;
