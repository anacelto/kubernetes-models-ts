...
export declare class SpannerInstance extends Model<ISpannerInstance> implements ISpannerInstance {
    ...
    static apiVersion: ISpannerInstance["apiVersion"];
    static kind: ISpannerInstance["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISpannerInstance>;
