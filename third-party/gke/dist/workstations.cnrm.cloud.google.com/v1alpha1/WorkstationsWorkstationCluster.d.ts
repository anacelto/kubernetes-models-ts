...
export declare class WorkstationsWorkstationCluster extends Model<IWorkstationsWorkstationCluster> implements IWorkstationsWorkstationCluster {
    ...
    static apiVersion: IWorkstationsWorkstationCluster["apiVersion"];
    static kind: IWorkstationsWorkstationCluster["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IWorkstationsWorkstationCluster>;
