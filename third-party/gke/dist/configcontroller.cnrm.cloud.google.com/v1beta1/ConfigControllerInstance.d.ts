...
export declare class ConfigControllerInstance extends Model<IConfigControllerInstance> implements IConfigControllerInstance {
    ...
    static apiVersion: IConfigControllerInstance["apiVersion"];
    static kind: IConfigControllerInstance["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IConfigControllerInstance>;
