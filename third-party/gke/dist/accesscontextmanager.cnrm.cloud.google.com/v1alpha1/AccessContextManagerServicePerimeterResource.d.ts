...
export declare class AccessContextManagerServicePerimeterResource extends Model<IAccessContextManagerServicePerimeterResource> implements IAccessContextManagerServicePerimeterResource {
    ...
    static apiVersion: IAccessContextManagerServicePerimeterResource["apiVersion"];
    static kind: IAccessContextManagerServicePerimeterResource["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAccessContextManagerServicePerimeterResource>;
