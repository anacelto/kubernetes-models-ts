...
export declare class AccessContextManagerAccessLevel extends Model<IAccessContextManagerAccessLevel> implements IAccessContextManagerAccessLevel {
    ...
    static apiVersion: IAccessContextManagerAccessLevel["apiVersion"];
    static kind: IAccessContextManagerAccessLevel["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAccessContextManagerAccessLevel>;
