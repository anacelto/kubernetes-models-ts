...
export declare class BillingBudgetsBudget extends Model<IBillingBudgetsBudget> implements IBillingBudgetsBudget {
    ...
    static apiVersion: IBillingBudgetsBudget["apiVersion"];
    static kind: IBillingBudgetsBudget["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBillingBudgetsBudget>;
