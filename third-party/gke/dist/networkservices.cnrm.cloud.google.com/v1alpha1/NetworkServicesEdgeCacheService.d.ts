...
export declare class NetworkServicesEdgeCacheService extends Model<INetworkServicesEdgeCacheService> implements INetworkServicesEdgeCacheService {
    ...
    static apiVersion: INetworkServicesEdgeCacheService["apiVersion"];
    static kind: INetworkServicesEdgeCacheService["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<INetworkServicesEdgeCacheService>;
