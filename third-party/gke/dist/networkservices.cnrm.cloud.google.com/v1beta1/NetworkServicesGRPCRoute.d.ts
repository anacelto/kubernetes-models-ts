...
export declare class NetworkServicesGRPCRoute extends Model<INetworkServicesGRPCRoute> implements INetworkServicesGRPCRoute {
    ...
    static apiVersion: INetworkServicesGRPCRoute["apiVersion"];
    static kind: INetworkServicesGRPCRoute["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<INetworkServicesGRPCRoute>;
