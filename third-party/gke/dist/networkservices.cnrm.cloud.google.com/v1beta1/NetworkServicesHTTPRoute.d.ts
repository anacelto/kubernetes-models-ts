...
export declare class NetworkServicesHTTPRoute extends Model<INetworkServicesHTTPRoute> implements INetworkServicesHTTPRoute {
    ...
    static apiVersion: INetworkServicesHTTPRoute["apiVersion"];
    static kind: INetworkServicesHTTPRoute["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<INetworkServicesHTTPRoute>;
