...
export declare class NetworkServicesEndpointPolicy extends Model<INetworkServicesEndpointPolicy> implements INetworkServicesEndpointPolicy {
    ...
    static apiVersion: INetworkServicesEndpointPolicy["apiVersion"];
    static kind: INetworkServicesEndpointPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<INetworkServicesEndpointPolicy>;
