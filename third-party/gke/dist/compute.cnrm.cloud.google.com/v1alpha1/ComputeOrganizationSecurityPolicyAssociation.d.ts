...
export declare class ComputeOrganizationSecurityPolicyAssociation extends Model<IComputeOrganizationSecurityPolicyAssociation> implements IComputeOrganizationSecurityPolicyAssociation {
    ...
    static apiVersion: IComputeOrganizationSecurityPolicyAssociation["apiVersion"];
    static kind: IComputeOrganizationSecurityPolicyAssociation["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeOrganizationSecurityPolicyAssociation>;
