...
export declare class ComputeMachineImage extends Model<IComputeMachineImage> implements IComputeMachineImage {
    ...
    static apiVersion: IComputeMachineImage["apiVersion"];
    static kind: IComputeMachineImage["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeMachineImage>;
