...
export declare class ComputeManagedSSLCertificate extends Model<IComputeManagedSSLCertificate> implements IComputeManagedSSLCertificate {
    ...
    static apiVersion: IComputeManagedSSLCertificate["apiVersion"];
    static kind: IComputeManagedSSLCertificate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeManagedSSLCertificate>;
