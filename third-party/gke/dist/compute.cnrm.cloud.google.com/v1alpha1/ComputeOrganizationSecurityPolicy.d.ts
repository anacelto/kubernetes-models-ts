...
export declare class ComputeOrganizationSecurityPolicy extends Model<IComputeOrganizationSecurityPolicy> implements IComputeOrganizationSecurityPolicy {
    ...
    static apiVersion: IComputeOrganizationSecurityPolicy["apiVersion"];
    static kind: IComputeOrganizationSecurityPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeOrganizationSecurityPolicy>;
