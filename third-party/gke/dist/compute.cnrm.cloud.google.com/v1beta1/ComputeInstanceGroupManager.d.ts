...
export declare class ComputeInstanceGroupManager extends Model<IComputeInstanceGroupManager> implements IComputeInstanceGroupManager {
    ...
    static apiVersion: IComputeInstanceGroupManager["apiVersion"];
    static kind: IComputeInstanceGroupManager["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeInstanceGroupManager>;
