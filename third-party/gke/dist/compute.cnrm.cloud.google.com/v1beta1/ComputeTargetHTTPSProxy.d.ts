...
export declare class ComputeTargetHTTPSProxy extends Model<IComputeTargetHTTPSProxy> implements IComputeTargetHTTPSProxy {
    ...
    static apiVersion: IComputeTargetHTTPSProxy["apiVersion"];
    static kind: IComputeTargetHTTPSProxy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeTargetHTTPSProxy>;
