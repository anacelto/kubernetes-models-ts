...
export declare class ComputeInstanceTemplate extends Model<IComputeInstanceTemplate> implements IComputeInstanceTemplate {
    ...
    static apiVersion: IComputeInstanceTemplate["apiVersion"];
    static kind: IComputeInstanceTemplate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeInstanceTemplate>;
