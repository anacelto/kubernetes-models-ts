...
export declare class ComputeReservation extends Model<IComputeReservation> implements IComputeReservation {
    ...
    static apiVersion: IComputeReservation["apiVersion"];
    static kind: IComputeReservation["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeReservation>;
