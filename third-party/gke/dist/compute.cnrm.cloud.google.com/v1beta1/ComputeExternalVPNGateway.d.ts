...
export declare class ComputeExternalVPNGateway extends Model<IComputeExternalVPNGateway> implements IComputeExternalVPNGateway {
    ...
    static apiVersion: IComputeExternalVPNGateway["apiVersion"];
    static kind: IComputeExternalVPNGateway["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeExternalVPNGateway>;
