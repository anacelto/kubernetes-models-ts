...
export declare class ComputeRoute extends Model<IComputeRoute> implements IComputeRoute {
    ...
    static apiVersion: IComputeRoute["apiVersion"];
    static kind: IComputeRoute["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeRoute>;
