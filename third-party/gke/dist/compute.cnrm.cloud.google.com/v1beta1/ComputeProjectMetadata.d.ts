...
export declare class ComputeProjectMetadata extends Model<IComputeProjectMetadata> implements IComputeProjectMetadata {
    ...
    static apiVersion: IComputeProjectMetadata["apiVersion"];
    static kind: IComputeProjectMetadata["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeProjectMetadata>;
