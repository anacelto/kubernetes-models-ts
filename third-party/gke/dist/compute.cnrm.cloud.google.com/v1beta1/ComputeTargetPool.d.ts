...
export declare class ComputeTargetPool extends Model<IComputeTargetPool> implements IComputeTargetPool {
    ...
    static apiVersion: IComputeTargetPool["apiVersion"];
    static kind: IComputeTargetPool["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeTargetPool>;
