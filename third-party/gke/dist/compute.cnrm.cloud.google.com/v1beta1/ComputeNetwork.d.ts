...
export declare class ComputeNetwork extends Model<IComputeNetwork> implements IComputeNetwork {
    ...
    static apiVersion: IComputeNetwork["apiVersion"];
    static kind: IComputeNetwork["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeNetwork>;
