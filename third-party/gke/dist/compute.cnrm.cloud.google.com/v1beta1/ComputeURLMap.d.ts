...
export declare class ComputeURLMap extends Model<IComputeURLMap> implements IComputeURLMap {
    ...
    static apiVersion: IComputeURLMap["apiVersion"];
    static kind: IComputeURLMap["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeURLMap>;
