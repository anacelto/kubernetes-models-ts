...
export declare class ComputeRouterNAT extends Model<IComputeRouterNAT> implements IComputeRouterNAT {
    ...
    static apiVersion: IComputeRouterNAT["apiVersion"];
    static kind: IComputeRouterNAT["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeRouterNAT>;
