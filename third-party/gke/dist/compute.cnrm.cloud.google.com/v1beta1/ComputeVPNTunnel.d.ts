...
export declare class ComputeVPNTunnel extends Model<IComputeVPNTunnel> implements IComputeVPNTunnel {
    ...
    static apiVersion: IComputeVPNTunnel["apiVersion"];
    static kind: IComputeVPNTunnel["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeVPNTunnel>;
