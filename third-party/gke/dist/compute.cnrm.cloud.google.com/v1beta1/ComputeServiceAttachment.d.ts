...
export declare class ComputeServiceAttachment extends Model<IComputeServiceAttachment> implements IComputeServiceAttachment {
    ...
    static apiVersion: IComputeServiceAttachment["apiVersion"];
    static kind: IComputeServiceAttachment["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeServiceAttachment>;
