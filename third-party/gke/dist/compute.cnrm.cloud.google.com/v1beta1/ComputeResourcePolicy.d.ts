...
export declare class ComputeResourcePolicy extends Model<IComputeResourcePolicy> implements IComputeResourcePolicy {
    ...
    static apiVersion: IComputeResourcePolicy["apiVersion"];
    static kind: IComputeResourcePolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeResourcePolicy>;
