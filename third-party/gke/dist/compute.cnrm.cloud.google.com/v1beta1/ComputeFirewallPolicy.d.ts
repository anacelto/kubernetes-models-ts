...
export declare class ComputeFirewallPolicy extends Model<IComputeFirewallPolicy> implements IComputeFirewallPolicy {
    ...
    static apiVersion: IComputeFirewallPolicy["apiVersion"];
    static kind: IComputeFirewallPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeFirewallPolicy>;
