...
export declare class ComputeHealthCheck extends Model<IComputeHealthCheck> implements IComputeHealthCheck {
    ...
    static apiVersion: IComputeHealthCheck["apiVersion"];
    static kind: IComputeHealthCheck["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeHealthCheck>;
