...
export declare class ComputeTargetHTTPProxy extends Model<IComputeTargetHTTPProxy> implements IComputeTargetHTTPProxy {
    ...
    static apiVersion: IComputeTargetHTTPProxy["apiVersion"];
    static kind: IComputeTargetHTTPProxy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeTargetHTTPProxy>;
