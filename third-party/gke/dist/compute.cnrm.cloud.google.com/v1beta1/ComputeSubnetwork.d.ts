...
export declare class ComputeSubnetwork extends Model<IComputeSubnetwork> implements IComputeSubnetwork {
    ...
    static apiVersion: IComputeSubnetwork["apiVersion"];
    static kind: IComputeSubnetwork["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeSubnetwork>;
