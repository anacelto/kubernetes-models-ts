...
export declare class ComputeFirewallPolicyAssociation extends Model<IComputeFirewallPolicyAssociation> implements IComputeFirewallPolicyAssociation {
    ...
    static apiVersion: IComputeFirewallPolicyAssociation["apiVersion"];
    static kind: IComputeFirewallPolicyAssociation["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeFirewallPolicyAssociation>;
