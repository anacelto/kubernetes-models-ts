...
export declare class ComputeSnapshot extends Model<IComputeSnapshot> implements IComputeSnapshot {
    ...
    static apiVersion: IComputeSnapshot["apiVersion"];
    static kind: IComputeSnapshot["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeSnapshot>;
