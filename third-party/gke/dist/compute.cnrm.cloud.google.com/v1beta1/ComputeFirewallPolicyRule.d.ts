...
export declare class ComputeFirewallPolicyRule extends Model<IComputeFirewallPolicyRule> implements IComputeFirewallPolicyRule {
    ...
    static apiVersion: IComputeFirewallPolicyRule["apiVersion"];
    static kind: IComputeFirewallPolicyRule["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeFirewallPolicyRule>;
