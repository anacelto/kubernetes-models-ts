...
export interface IComputeTargetSSLProxy {
    /**
...
export declare class ComputeTargetSSLProxy extends Model<IComputeTargetSSLProxy> implements IComputeTargetSSLProxy {
    "apiVersion": IComputeTargetSSLProxy["apiVersion"];
    "kind": IComputeTargetSSLProxy["kind"];
    "metadata"?: IComputeTargetSSLProxy["metadata"];
    "spec": IComputeTargetSSLProxy["spec"];
    "status"?: IComputeTargetSSLProxy["status"];
    static apiVersion: IComputeTargetSSLProxy["apiVersion"];
    static kind: IComputeTargetSSLProxy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeTargetSSLProxy>;
    constructor(data?: ModelData<IComputeTargetSSLProxy>);
}
