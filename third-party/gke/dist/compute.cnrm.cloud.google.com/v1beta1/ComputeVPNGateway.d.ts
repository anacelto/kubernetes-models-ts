...
export declare class ComputeVPNGateway extends Model<IComputeVPNGateway> implements IComputeVPNGateway {
    ...
    static apiVersion: IComputeVPNGateway["apiVersion"];
    static kind: IComputeVPNGateway["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeVPNGateway>;
