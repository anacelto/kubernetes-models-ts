...
export declare class ComputeRouterPeer extends Model<IComputeRouterPeer> implements IComputeRouterPeer {
    ...
    static apiVersion: IComputeRouterPeer["apiVersion"];
    static kind: IComputeRouterPeer["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeRouterPeer>;
