...
export interface IComputeRouterInterface {
    /**
...
export declare class ComputeRouterInterface extends Model<IComputeRouterInterface> implements IComputeRouterInterface {
    "apiVersion": IComputeRouterInterface["apiVersion"];
    "kind": IComputeRouterInterface["kind"];
    "metadata"?: IComputeRouterInterface["metadata"];
    "spec": IComputeRouterInterface["spec"];
    "status"?: IComputeRouterInterface["status"];
    static apiVersion: IComputeRouterInterface["apiVersion"];
    static kind: IComputeRouterInterface["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeRouterInterface>;
    constructor(data?: ModelData<IComputeRouterInterface>);
}
