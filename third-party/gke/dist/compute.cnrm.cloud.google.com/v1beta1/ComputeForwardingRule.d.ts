...
export declare class ComputeForwardingRule extends Model<IComputeForwardingRule> implements IComputeForwardingRule {
    ...
    static apiVersion: IComputeForwardingRule["apiVersion"];
    static kind: IComputeForwardingRule["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeForwardingRule>;
