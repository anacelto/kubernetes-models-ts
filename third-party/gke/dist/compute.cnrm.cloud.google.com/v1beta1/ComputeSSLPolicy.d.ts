...
export declare class ComputeSSLPolicy extends Model<IComputeSSLPolicy> implements IComputeSSLPolicy {
    ...
    static apiVersion: IComputeSSLPolicy["apiVersion"];
    static kind: IComputeSSLPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeSSLPolicy>;
