...
export declare class ComputeBackendBucket extends Model<IComputeBackendBucket> implements IComputeBackendBucket {
    ...
    static apiVersion: IComputeBackendBucket["apiVersion"];
    static kind: IComputeBackendBucket["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeBackendBucket>;
