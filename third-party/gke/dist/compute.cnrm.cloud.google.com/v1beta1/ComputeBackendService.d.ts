...
export declare class ComputeBackendService extends Model<IComputeBackendService> implements IComputeBackendService {
    ...
    static apiVersion: IComputeBackendService["apiVersion"];
    static kind: IComputeBackendService["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeBackendService>;
