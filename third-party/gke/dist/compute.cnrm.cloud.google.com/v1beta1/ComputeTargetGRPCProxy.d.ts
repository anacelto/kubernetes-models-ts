...
export declare class ComputeTargetGRPCProxy extends Model<IComputeTargetGRPCProxy> implements IComputeTargetGRPCProxy {
    ...
    static apiVersion: IComputeTargetGRPCProxy["apiVersion"];
    static kind: IComputeTargetGRPCProxy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeTargetGRPCProxy>;
