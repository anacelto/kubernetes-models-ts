...
export declare class ComputeHTTPSHealthCheck extends Model<IComputeHTTPSHealthCheck> implements IComputeHTTPSHealthCheck {
    ...
    static apiVersion: IComputeHTTPSHealthCheck["apiVersion"];
    static kind: IComputeHTTPSHealthCheck["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeHTTPSHealthCheck>;
