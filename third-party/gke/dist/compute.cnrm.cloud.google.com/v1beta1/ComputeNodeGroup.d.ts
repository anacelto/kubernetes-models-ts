...
export declare class ComputeNodeGroup extends Model<IComputeNodeGroup> implements IComputeNodeGroup {
    ...
    static apiVersion: IComputeNodeGroup["apiVersion"];
    static kind: IComputeNodeGroup["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeNodeGroup>;
