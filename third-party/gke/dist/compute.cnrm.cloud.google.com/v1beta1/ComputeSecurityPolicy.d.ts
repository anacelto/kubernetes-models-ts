...
export declare class ComputeSecurityPolicy extends Model<IComputeSecurityPolicy> implements IComputeSecurityPolicy {
    ...
    static apiVersion: IComputeSecurityPolicy["apiVersion"];
    static kind: IComputeSecurityPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IComputeSecurityPolicy>;
