...
export declare class CertificateManagerDNSAuthorization extends Model<ICertificateManagerDNSAuthorization> implements ICertificateManagerDNSAuthorization {
    ...
    static apiVersion: ICertificateManagerDNSAuthorization["apiVersion"];
    static kind: ICertificateManagerDNSAuthorization["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICertificateManagerDNSAuthorization>;
