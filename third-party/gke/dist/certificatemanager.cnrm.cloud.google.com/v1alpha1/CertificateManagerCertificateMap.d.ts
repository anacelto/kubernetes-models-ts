...
export declare class CertificateManagerCertificateMap extends Model<ICertificateManagerCertificateMap> implements ICertificateManagerCertificateMap {
    ...
    static apiVersion: ICertificateManagerCertificateMap["apiVersion"];
    static kind: ICertificateManagerCertificateMap["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICertificateManagerCertificateMap>;
