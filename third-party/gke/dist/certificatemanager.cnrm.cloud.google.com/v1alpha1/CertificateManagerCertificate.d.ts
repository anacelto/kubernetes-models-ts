...
export declare class CertificateManagerCertificate extends Model<ICertificateManagerCertificate> implements ICertificateManagerCertificate {
    ...
    static apiVersion: ICertificateManagerCertificate["apiVersion"];
    static kind: ICertificateManagerCertificate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICertificateManagerCertificate>;
