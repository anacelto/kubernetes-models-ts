...
export declare class StorageTransferJob extends Model<IStorageTransferJob> implements IStorageTransferJob {
    ...
    static apiVersion: IStorageTransferJob["apiVersion"];
    static kind: IStorageTransferJob["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IStorageTransferJob>;
