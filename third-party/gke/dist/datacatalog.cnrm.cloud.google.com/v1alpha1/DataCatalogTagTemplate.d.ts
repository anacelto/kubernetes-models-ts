...
export declare class DataCatalogTagTemplate extends Model<IDataCatalogTagTemplate> implements IDataCatalogTagTemplate {
    ...
    static apiVersion: IDataCatalogTagTemplate["apiVersion"];
    static kind: IDataCatalogTagTemplate["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDataCatalogTagTemplate>;
