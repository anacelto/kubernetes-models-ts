...
export declare class DataCatalogTaxonomy extends Model<IDataCatalogTaxonomy> implements IDataCatalogTaxonomy {
    ...
    static apiVersion: IDataCatalogTaxonomy["apiVersion"];
    static kind: IDataCatalogTaxonomy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDataCatalogTaxonomy>;
