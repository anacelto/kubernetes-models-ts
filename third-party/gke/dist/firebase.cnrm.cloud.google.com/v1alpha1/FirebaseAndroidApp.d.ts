...
export declare class FirebaseAndroidApp extends Model<IFirebaseAndroidApp> implements IFirebaseAndroidApp {
    ...
    static apiVersion: IFirebaseAndroidApp["apiVersion"];
    static kind: IFirebaseAndroidApp["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IFirebaseAndroidApp>;
