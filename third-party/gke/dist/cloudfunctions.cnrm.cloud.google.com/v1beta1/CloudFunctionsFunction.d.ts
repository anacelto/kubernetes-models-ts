...
export declare class CloudFunctionsFunction extends Model<ICloudFunctionsFunction> implements ICloudFunctionsFunction {
    ...
    static apiVersion: ICloudFunctionsFunction["apiVersion"];
    static kind: ICloudFunctionsFunction["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICloudFunctionsFunction>;
