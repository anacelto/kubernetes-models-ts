 ...
 * be distributed to its targeting service(s).
 */
export declare class GCPTrafficDistributionPolicy extends Model<IGCPTrafficDistributionPolicy> implements IGCPTrafficDistributionPolicy {
    ...
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGCPTrafficDistributionPolicy>;
