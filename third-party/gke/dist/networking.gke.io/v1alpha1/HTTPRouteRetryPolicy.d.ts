 ...
 * HTTPRouteRetryPolicy provides a way to apply LoadBalancer policy configuration with the GKE implementation of the Gateway API.
 */
export declare class HTTPRouteRetryPolicy extends Model<IHTTPRouteRetryPolicy> implements IHTTPRouteRetryPolicy {
    ...
    static apiVersion: IHTTPRouteRetryPolicy["apiVersion"];
    static kind: IHTTPRouteRetryPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IHTTPRouteRetryPolicy>;
