 ...
 * IAPPolicy provides a way to apply IAP policy configuration with the GKE implementation of the Gateway API.
 */
export declare class IAPPolicy extends Model<IIAPPolicy> implements IIAPPolicy {
    ...
    static apiVersion: IIAPPolicy["apiVersion"];
    static kind: IIAPPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIAPPolicy>;
