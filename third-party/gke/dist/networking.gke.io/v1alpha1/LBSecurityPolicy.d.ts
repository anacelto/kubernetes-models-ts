 ...
 * LBSecurityPolicy provides a way to apply Security policy configuration with the GKE implementation of the Gateway API.
 */
export declare class LBSecurityPolicy extends Model<ILBSecurityPolicy> implements ILBSecurityPolicy {
    ...
    static apiVersion: ILBSecurityPolicy["apiVersion"];
    static kind: ILBSecurityPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ILBSecurityPolicy>;
