...
export declare class TagsTagValue extends Model<ITagsTagValue> implements ITagsTagValue {
    ...
    static apiVersion: ITagsTagValue["apiVersion"];
    static kind: ITagsTagValue["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ITagsTagValue>;
