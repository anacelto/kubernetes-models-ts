...
export declare class DataFusionInstance extends Model<IDataFusionInstance> implements IDataFusionInstance {
    ...
    static apiVersion: IDataFusionInstance["apiVersion"];
    static kind: IDataFusionInstance["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDataFusionInstance>;
