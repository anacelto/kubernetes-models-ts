...
export declare class IAMWorkloadIdentityPool extends Model<IIAMWorkloadIdentityPool> implements IIAMWorkloadIdentityPool {
    ...
    static apiVersion: IIAMWorkloadIdentityPool["apiVersion"];
    static kind: IIAMWorkloadIdentityPool["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIAMWorkloadIdentityPool>;
