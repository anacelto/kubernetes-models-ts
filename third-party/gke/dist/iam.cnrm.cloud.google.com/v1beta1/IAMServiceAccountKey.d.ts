...
export declare class IAMServiceAccountKey extends Model<IIAMServiceAccountKey> implements IIAMServiceAccountKey {
    ...
    static apiVersion: IIAMServiceAccountKey["apiVersion"];
    static kind: IIAMServiceAccountKey["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIAMServiceAccountKey>;
