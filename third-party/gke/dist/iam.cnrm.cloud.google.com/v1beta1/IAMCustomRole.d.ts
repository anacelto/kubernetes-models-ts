...
export declare class IAMCustomRole extends Model<IIAMCustomRole> implements IIAMCustomRole {
    ...
    static apiVersion: IIAMCustomRole["apiVersion"];
    static kind: IIAMCustomRole["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIAMCustomRole>;
