...
export declare class IAMWorkforcePoolProvider extends Model<IIAMWorkforcePoolProvider> implements IIAMWorkforcePoolProvider {
    ...
    static apiVersion: IIAMWorkforcePoolProvider["apiVersion"];
    static kind: IIAMWorkforcePoolProvider["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIAMWorkforcePoolProvider>;
