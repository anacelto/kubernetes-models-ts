...
export declare class IAMAccessBoundaryPolicy extends Model<IIAMAccessBoundaryPolicy> implements IIAMAccessBoundaryPolicy {
    ...
    static apiVersion: IIAMAccessBoundaryPolicy["apiVersion"];
    static kind: IIAMAccessBoundaryPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIAMAccessBoundaryPolicy>;
