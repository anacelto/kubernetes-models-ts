...
export declare class IAMWorkloadIdentityPoolProvider extends Model<IIAMWorkloadIdentityPoolProvider> implements IIAMWorkloadIdentityPoolProvider {
    ...
    static apiVersion: IIAMWorkloadIdentityPoolProvider["apiVersion"];
    static kind: IIAMWorkloadIdentityPoolProvider["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIAMWorkloadIdentityPoolProvider>;
