...
export declare class AppEngineFirewallRule extends Model<IAppEngineFirewallRule> implements IAppEngineFirewallRule {
    ...
    static apiVersion: IAppEngineFirewallRule["apiVersion"];
    static kind: IAppEngineFirewallRule["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAppEngineFirewallRule>;
