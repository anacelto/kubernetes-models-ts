...
export declare class AppEngineDomainMapping extends Model<IAppEngineDomainMapping> implements IAppEngineDomainMapping {
    ...
    static apiVersion: IAppEngineDomainMapping["apiVersion"];
    static kind: IAppEngineDomainMapping["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAppEngineDomainMapping>;
