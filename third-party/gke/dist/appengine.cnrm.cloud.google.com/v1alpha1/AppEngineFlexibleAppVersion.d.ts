...
export declare class AppEngineFlexibleAppVersion extends Model<IAppEngineFlexibleAppVersion> implements IAppEngineFlexibleAppVersion {
    ...
    static apiVersion: IAppEngineFlexibleAppVersion["apiVersion"];
    static kind: IAppEngineFlexibleAppVersion["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAppEngineFlexibleAppVersion>;
