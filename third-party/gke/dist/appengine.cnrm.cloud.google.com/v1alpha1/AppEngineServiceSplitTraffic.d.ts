...
export declare class AppEngineServiceSplitTraffic extends Model<IAppEngineServiceSplitTraffic> implements IAppEngineServiceSplitTraffic {
    ...
    static apiVersion: IAppEngineServiceSplitTraffic["apiVersion"];
    static kind: IAppEngineServiceSplitTraffic["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAppEngineServiceSplitTraffic>;
