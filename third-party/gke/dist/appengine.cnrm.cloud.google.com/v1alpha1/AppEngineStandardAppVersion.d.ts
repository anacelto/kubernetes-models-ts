...
export declare class AppEngineStandardAppVersion extends Model<IAppEngineStandardAppVersion> implements IAppEngineStandardAppVersion {
    ...
    static apiVersion: IAppEngineStandardAppVersion["apiVersion"];
    static kind: IAppEngineStandardAppVersion["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAppEngineStandardAppVersion>;
