...
export declare class CloudIDSEndpoint extends Model<ICloudIDSEndpoint> implements ICloudIDSEndpoint {
    ...
    static apiVersion: ICloudIDSEndpoint["apiVersion"];
    static kind: ICloudIDSEndpoint["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICloudIDSEndpoint>;
