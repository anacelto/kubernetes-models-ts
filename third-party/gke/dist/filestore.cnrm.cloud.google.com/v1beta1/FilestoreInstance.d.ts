...
export declare class FilestoreInstance extends Model<IFilestoreInstance> implements IFilestoreInstance {
    ...
    static apiVersion: IFilestoreInstance["apiVersion"];
    static kind: IFilestoreInstance["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IFilestoreInstance>;
