...
export declare class FilestoreBackup extends Model<IFilestoreBackup> implements IFilestoreBackup {
    ...
    static apiVersion: IFilestoreBackup["apiVersion"];
    static kind: IFilestoreBackup["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IFilestoreBackup>;
