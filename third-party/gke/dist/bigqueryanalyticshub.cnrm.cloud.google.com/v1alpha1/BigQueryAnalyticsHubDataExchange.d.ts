...
export declare class BigQueryAnalyticsHubDataExchange extends Model<IBigQueryAnalyticsHubDataExchange> implements IBigQueryAnalyticsHubDataExchange {
    ...
    static apiVersion: IBigQueryAnalyticsHubDataExchange["apiVersion"];
    static kind: IBigQueryAnalyticsHubDataExchange["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBigQueryAnalyticsHubDataExchange>;
