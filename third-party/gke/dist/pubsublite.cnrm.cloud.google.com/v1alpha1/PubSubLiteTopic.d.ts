...
export declare class PubSubLiteTopic extends Model<IPubSubLiteTopic> implements IPubSubLiteTopic {
    ...
    static apiVersion: IPubSubLiteTopic["apiVersion"];
    static kind: IPubSubLiteTopic["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPubSubLiteTopic>;
