...
import { validate } from "../../_schemas/ArgoprojIoV1alpha1AppProject";
 ...
 * AppProject provides a logical grouping of applications, providing controls for: \* where the apps may deploy to (cluster whitelist) \* what may be deployed (repository whitelist, resource whitelist/blacklist) \* who can access these applications (roles, OIDC group claims bindings) \* and what they can do (RBAC policies) \* automation access to these roles (JWT tokens)
 */
export class AppProject extends Model<IAppProject> implements IAppProject {
...
static apiVersion: IAppProject["apiVersion"] = "argoproj.io/v1alpha1";
static kind: IAppProject["kind"] = "AppProject";
static is = createTypeMetaGuard<IAppProject>(AppProject);

constructor(data?: ModelData<IAppProject>) {
  super();

  this.setDefinedProps({
    apiVersion: AppProject.apiVersion,
...
setValidateFunc(AppProject, validate as ValidateFunc<IAppProject>);
