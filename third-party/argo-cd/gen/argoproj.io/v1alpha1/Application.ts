...
import { validate } from "../../_schemas/ArgoprojIoV1alpha1Application";
...
export class Application extends Model<IApplication> implements IApplication {
  "apiVersion": IApplication["apiVersion"];
  "kind": IApplication["kind"];
  "metadata": IApplication["metadata"];
  "operation"?: IApplication["operation"];
  "spec": IApplication["spec"];
  "status"?: IApplication["status"];

static apiVersion: IApplication["apiVersion"] = "argoproj.io/v1alpha1";
static kind: IApplication["kind"] = "Application";
static is = createTypeMetaGuard<IApplication>(Application);
...
setValidateFunc(Application, validate as ValidateFunc<IApplication>);
