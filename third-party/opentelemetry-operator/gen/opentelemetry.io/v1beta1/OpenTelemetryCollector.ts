...
import { validate } from "../../_schemas/OpentelemetryIoV1beta1OpenTelemetryCollector";
...
export class OpenTelemetryCollector extends Model<IOpenTelemetryCollector> implements IOpenTelemetryCollector {
...
static apiVersion: IOpenTelemetryCollector["apiVersion"] = "opentelemetry.io/v1beta1";
static kind: IOpenTelemetryCollector["kind"] = "OpenTelemetryCollector";
static is = createTypeMetaGuard<IOpenTelemetryCollector>(OpenTelemetryCollector);

constructor(data?: ModelData<IOpenTelemetryCollector>) {
  super();

  this.setDefinedProps({
    apiVersion: OpenTelemetryCollector.apiVersion,
    kind: OpenTelemetryCollector.kind,
    ...data
  } as IOpenTelemetryCollector);
}
}


setValidateFunc(OpenTelemetryCollector, validate as ValidateFunc<IOpenTelemetryCollector>);
