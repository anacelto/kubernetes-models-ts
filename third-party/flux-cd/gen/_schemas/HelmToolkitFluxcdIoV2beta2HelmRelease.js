...
const schema20 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "F95K3psf0RVV4bax5GTkxUsOH2H6gaT2uuzTifqsVN8"
    },
    "status": {
      "$ref": "nACaqcHykj1lC0neg2k2GMq7NR9L95QIbHPguJVkQ"
    }
  },
...
const schema25 = {
  "properties": {
    "chart": {
      "$ref": "X1vjIMuTSc6qeXe5FUJ8du9RiB2IUy6m2YVCM0qZSk"
    },
    "dependsOn": {
...
const schema26 = {
  "properties": {
    ...
    "spec": {
      "$ref": "t3KywnTTU89aTnHDd9In9wFHi4PpLoOzXc0TDBc"
    }
  },
  "required": ["spec"],
  "type": "object"
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.valuesFiles !== undefined) {
      if (!validate72(data.valuesFiles, {
...
function validate104(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.remediation !== undefined) {
      if (!validate111(data.remediation, {
...
function validate132(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.patchesJson6902 !== undefined) {
      if (!validate147(data.patchesJson6902, {
    ...
    if (data.patchesStrategicMerge !== undefined) {
      if (!validate169(data.patchesStrategicMerge, {
...
function validate203(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.deletionPropagation !== undefined) {
      if (!validate204(data.deletionPropagation, {
...
function validate211(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.remediation !== undefined) {
      if (!validate220(data.remediation, {
        instancePath: instancePath + "/remediation",
        parentData: data,
        parentDataProperty: "remediation",
        rootData
...
function validate231(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.targetPath !== undefined) {
      if (!validate236(data.targetPath, {
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.driftDetection !== undefined) {
      if (!validate92(data.driftDetection, {
    ...
    if (data.kubeConfig !== undefined) {
      if (!validate122(data.kubeConfig, {
    ...
    if (data.postRenderers !== undefined) {
      if (!validate130(data.postRenderers, {
    ...
    if (data.releaseName !== undefined) {
      if (!validate175(data.releaseName, {
    ...
    if (data.serviceAccountName !== undefined) {
      if (!validate186(data.serviceAccountName, {
    ...
    if (data.valuesFrom !== undefined) {
      if (!validate230(data.valuesFrom, {
...
function validate245(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate249(data.observedGeneration, {
...
function validate243(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastAttemptedReleaseAction !== undefined) {
      if (!validate289(data.lastAttemptedReleaseAction, {
