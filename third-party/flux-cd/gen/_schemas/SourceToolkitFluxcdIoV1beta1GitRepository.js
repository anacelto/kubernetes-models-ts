...
const schema11 = {
  ...
  "properties": {
    ...
    "status": {
      "$ref": "jQJ4V7iOWSrlu8x65P4zcDVP1jNxNjIasbZTgEgf4"
    }
  },
...
const schema30 = {
  ...
  "properties": {
    ...
    "includedArtifacts": {
      "$ref": "agzdH8uD9FOB3S2h1Iz1NejdDMOlY9QRGrp8MUdD0OE"
    },
...
const schema40 = {
  "items": {
    "$ref": "DrBPZdlCSZXjSaPweoE1ibfeeJFvg8454lZ4yckxU"
  },
  "type": "array",
  "nullable": true
};
...
function validate78(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.includedArtifacts !== undefined) {
      if (!validate102(data.includedArtifacts, {
