...
const schema17 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "XxhqjOtSxasBbWNpmyhD5hB9vbUz6AGNJq5PvfMl5hA"
    },
    "status": {
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.includedArtifacts !== undefined) {
      if (!validate99(data.includedArtifacts, {
