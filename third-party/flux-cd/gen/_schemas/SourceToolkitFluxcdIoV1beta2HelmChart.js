...
const schema11 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "7Td47pm4yQ6i9ItSz0gzZzYdxzixuJGO2q2zAUiU"
    },
    "status": {
      "$ref": "ARwmnZfoNsJ9MSrRcQNnkHYgFEdW4VEKy0iQmY"
    }
  },
...
const schema16 = {
  "properties": {
    ...
    "verify": {
      "$ref": "nhZQ7cAZ5tadHi8uGTPyFKTN1nMIM5ySwYq1pVX76o0"
    },
    "version": {
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.matchOIDCIdentity !== undefined) {
      if (!validate62(data.matchOIDCIdentity, {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.reconcileStrategy !== undefined) {
      if (!validate47(data.reconcileStrategy, {
    ...
    if (data.valuesFiles !== undefined) {
      if (!validate58(data.valuesFiles, {
...
function validate78(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastUpdateTime !== undefined) {
      if (!validate25(data.lastUpdateTime, {
...
function validate89(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate93(data.observedGeneration, {
...
function validate77(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedChartName !== undefined) {
      if (!validate22(data.observedChartName, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate26(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
    ...
    if (data.observedSourceArtifactRevision !== undefined) {
      if (!validate22(data.observedSourceArtifactRevision, {
