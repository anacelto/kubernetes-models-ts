...
const schema11 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "O2pXhHGvebG75bgKe5cGCdjYe6jiHuvhNLpXQ"
    },
    "status": {
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate68(data.lastTransitionTime, {
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastScanResult !== undefined) {
      if (!validate83(data.lastScanResult, {
