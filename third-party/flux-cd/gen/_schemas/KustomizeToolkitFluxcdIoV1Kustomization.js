...
const schema12 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "HlF0sqhZKQxkdRtq0TmPLtFWjtiSplCdnua6Rf2mLU"
    },
    "status": {
...
function validate98(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.substituteFrom !== undefined) {
      if (!validate100(data.substituteFrom, {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.commonMetadata !== undefined) {
      if (!validate38(data.commonMetadata, {
    ...
    if (data.healthChecks !== undefined) {
      if (!validate59(data.healthChecks, {
    ...
    if (data.retryInterval !== undefined) {
      if (!validate26(data.retryInterval, {
    ...
    if (data.targetNamespace !== undefined) {
      if (!validate122(data.targetNamespace, {
...
function validate129(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate130(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate134(data.observedGeneration, {
