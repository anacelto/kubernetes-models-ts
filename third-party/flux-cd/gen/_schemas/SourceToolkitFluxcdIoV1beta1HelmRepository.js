...
const schema9 = {
  ...
  "properties": {
    ...
    "status": {
      "$ref": "WSuBHCzZKvRzpmKLQlatbe7bn13wEPJOvBeQlMwmU"
    }
  },
...
const schema21 = {
  ...
  "properties": {
    "artifact": {
      "$ref": "TFegmy1dvgpaUf4gvkhlUL0V44Jka0Bf5RFUHnqCqk"
    },
    "conditions": {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastUpdateTime !== undefined) {
      if (!validate56(data.lastUpdateTime, {
...
function validate63(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate64(data.lastTransitionTime, {
