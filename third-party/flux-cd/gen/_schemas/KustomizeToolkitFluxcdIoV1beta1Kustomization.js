...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "cBR8e9HmwFjNnV0OhMk2a1raOUdgb8CWTR7RGexjsg"
    },
    "status": {
...
const schema15 = {
  "properties": {
    ...
    "kubeConfig": {
      "$ref": "z116kw32kcsPH2YNThCzCfMRnXO6C0jmn7VkZvFQ"
    },
    "patches": {
...
function validate109(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.substitute !== undefined) {
      if (!validate110(data.substitute, {
    ...
    if (data.substituteFrom !== undefined) {
      if (!validate113(data.substituteFrom, {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.patchesJson6902 !== undefined) {
      if (!validate83(data.patchesJson6902, {
    ...
    if (data.patchesStrategicMerge !== undefined) {
      if (!validate105(data.patchesStrategicMerge, {
    ...
    if (data.targetNamespace !== undefined) {
      if (!validate135(data.targetNamespace, {
    ...
    if (data.validation !== undefined) {
      if (!validate138(data.validation, {
...
function validate143(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate144(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate148(data.observedGeneration, {
...
function validate141(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate142(data.conditions, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate161(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
