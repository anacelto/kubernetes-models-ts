 ...
 * Kustomization is the Schema for the kustomizations API.
 */
export declare class Kustomization extends Model<IKustomization> implements IKustomization {
    ...
    static apiVersion: IKustomization["apiVersion"];
    static kind: IKustomization["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IKustomization>;
