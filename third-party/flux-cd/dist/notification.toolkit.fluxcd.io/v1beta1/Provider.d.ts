 ...
 * Provider is the Schema for the providers API
 */
export declare class Provider extends Model<IProvider> implements IProvider {
    "apiVersion": IProvider["apiVersion"];
    "kind": IProvider["kind"];
    "metadata"?: IProvider["metadata"];
    "spec"?: IProvider["spec"];
    "status"?: IProvider["status"];
    static apiVersion: IProvider["apiVersion"];
    static kind: IProvider["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IProvider>;
