 ...
 * HelmRepository is the Schema for the helmrepositories API
 */
export declare class HelmRepository extends Model<IHelmRepository> implements IHelmRepository {
    ...
    static apiVersion: IHelmRepository["apiVersion"];
    static kind: IHelmRepository["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IHelmRepository>;
