 ...
 * GitRepository is the Schema for the gitrepositories API
 */
export declare class GitRepository extends Model<IGitRepository> implements IGitRepository {
    ...
    static apiVersion: IGitRepository["apiVersion"];
    static kind: IGitRepository["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGitRepository>;
