 ...
 * OCIRepository is the Schema for the ocirepositories API
 */
export declare class OCIRepository extends Model<IOCIRepository> implements IOCIRepository {
    ...
    static apiVersion: IOCIRepository["apiVersion"];
    static kind: IOCIRepository["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IOCIRepository>;
