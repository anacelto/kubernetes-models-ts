 ...
 * Bucket is the Schema for the buckets API.
 */
export declare class Bucket extends Model<IBucket> implements IBucket {
    "apiVersion": IBucket["apiVersion"];
    "kind": IBucket["kind"];
    "metadata"?: IBucket["metadata"];
    "spec"?: IBucket["spec"];
    "status"?: IBucket["status"];
    static apiVersion: IBucket["apiVersion"];
    static kind: IBucket["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBucket>;
