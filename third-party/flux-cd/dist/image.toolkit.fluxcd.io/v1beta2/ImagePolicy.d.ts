 ...
 * ImagePolicy is the Schema for the imagepolicies API
 */
export declare class ImagePolicy extends Model<IImagePolicy> implements IImagePolicy {
    ...
    static apiVersion: IImagePolicy["apiVersion"];
    static kind: IImagePolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IImagePolicy>;
