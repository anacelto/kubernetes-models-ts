 ...
 * ImageRepository is the Schema for the imagerepositories API
 */
export declare class ImageRepository extends Model<IImageRepository> implements IImageRepository {
    ...
    static kind: IImageRepository["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IImageRepository>;
