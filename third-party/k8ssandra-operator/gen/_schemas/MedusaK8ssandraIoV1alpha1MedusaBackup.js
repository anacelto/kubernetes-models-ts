...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "18Nib6gu1Ui8ooqeLQKBqWJfkiAuP38KrXobZp4wgsY"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Ta36sb8xJNA3EMUSrUPDtDXkBPPIkMofWQVhdTMTh8"
    },
    "status": {
      "$ref": "CUtTqHFRLwjrgMo4UpWL8HrVpui0aZoOBnpw0TE7qXQ"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "medusa.k8ssandra.io.v1alpha1.MedusaBackup"
};
const schema10 = {
  "type": "string",
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cassandraDatacenter !== undefined) {
      if (!validate36(data.cassandraDatacenter, {
...
const schema17 = {
  "properties": {
    ...
    "nodes": {
      "$ref": "2TxjzHG3RP7l0OK8lMC2ZVH2DmS71SCINIGql82as"
    },
    "startTime": {
      "$ref": "thZzwpySeU7LsVtTYjwqN1mWUAwFAnezim8OMie8k"
    },
...
const schema18 = {
  "items": {
    "$ref": "wG7TBiU2TG3B2wzBBNpx7qiEWMgJIzs7UE5TMKPddEc"
  },
  "type": "array",
  "nullable": true
};
...
function validate43(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tokens !== undefined) {
      if (!validate47(data.tokens, {
        instancePath: instancePath + "/tokens",
        parentData: data,
        parentDataProperty: "tokens",
        rootData
      })) {
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.finishedNodes !== undefined) {
      if (!validate23(data.finishedNodes, {
        instancePath: instancePath + "/finishedNodes",
        parentData: data,
        parentDataProperty: "finishedNodes",
        rootData
      })) {
    ...
    if (data.totalFiles !== undefined) {
      if (!validate55(data.totalFiles, {
        instancePath: instancePath + "/totalFiles",
        parentData: data,
        parentDataProperty: "totalFiles",
        rootData
      })) {
    ...
    if (data.totalNodes !== undefined) {
      if (!validate23(data.totalNodes, {
        instancePath: instancePath + "/totalNodes",
        parentData: data,
        parentDataProperty: "totalNodes",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="medusa.k8ssandra.io.v1alpha1.MedusaBackup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
