...
const schema11 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "zqZ4RszBfrHuOaOUmlKoS7Y0SdGN6zLFTA95cAa10"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "SaaPm0n3xtVYodHYXpbqgKwjNzFxKyfJVM1dfxqKeE"
    },
    "status": {
  ...
  "$id": "medusa.k8ssandra.io.v1alpha1.MedusaConfiguration"
};
const schema12 = {
  "type": "string",
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.accessModes !== undefined) {
      if (!validate50(data.accessModes, {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.backupGracePeriodInDays !== undefined) {
      if (!validate24(data.backupGracePeriodInDays, {
    ...
    if (data.concurrentTransfers !== undefined) {
      if (!validate40(data.concurrentTransfers, {
    ...
    if (data.credentialsType !== undefined) {
      if (!validate42(data.credentialsType, {
    ...
    if (data.maxBackupAge !== undefined) {
      if (!validate22(data.maxBackupAge, {
    ...
    if (data.maxBackupCount !== undefined) {
      if (!validate22(data.maxBackupCount, {
    ...
    if (data.multiPartUploadThreshold !== undefined) {
      if (!validate47(data.multiPartUploadThreshold, {
    ...
    if (data.storageProvider !== undefined) {
      if (!validate65(data.storageProvider, {
    ...
    if (data.storageSecretRef !== undefined) {
      if (!validate67(data.storageSecretRef, {
    ...
    if (data.transferMaxBandwidth !== undefined) {
      if (!validate70(data.transferMaxBandwidth, {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.storageProperties !== undefined) {
      if (!validate36(data.storageProperties, {
...
function validate26(data, {
  ...
  /*# sourceURL="medusa.k8ssandra.io.v1alpha1.MedusaConfiguration" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
