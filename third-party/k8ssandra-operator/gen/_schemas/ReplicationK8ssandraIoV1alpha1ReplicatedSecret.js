...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "LXCg3sY0Mq99oroDEyuNuvFdCCnZpqtgNSS9TJE3Ag"
    },
    "kind": {
      "$ref": "l8ucVKMlZ4pY0ngEeKNXCw3pjoT1u1HMvRYKIfYRX1k"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "4zGNVtsPDhsJpOWlUzUtikESmJ3rE29Bf36ZJaJRMo"
    },
    "status": {
      "$ref": "KtO2AOuwXb9yn7rDXLf353ee9zVDiNsLJCcAPaaN8"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "replication.k8ssandra.io.v1alpha1.ReplicatedSecret"
};
const schema9 = {
  "type": "string",
  "enum": ["replication.k8ssandra.io/v1alpha1"]
};
function validate24(data, {
  ...
  if (!(data === "replication.k8ssandra.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    "replicationTargets": {
      "$ref": "DGAUb6GUYRrvLAY9V2qrXI6eVoURgPhzfwLyUe6Vha0"
    },
    "selector": {
...
const schema14 = {
  "items": {
    "$ref": "xlQo8BMw3uYgPQm5kiVTp8bfUwZN9bihn5Ema66mPo"
  },
  "type": "array",
  "nullable": true
};
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.k8sContextName !== undefined) {
      if (!validate21(data.k8sContextName, {
        instancePath: instancePath + "/k8sContextName",
        parentData: data,
        parentDataProperty: "k8sContextName",
        rootData
      })) {
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate40(data.matchExpressions, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.replicationTargets !== undefined) {
      if (!validate33(data.replicationTargets, {
        instancePath: instancePath + "/replicationTargets",
        parentData: data,
        parentDataProperty: "replicationTargets",
        rootData
      })) {
...
const schema21 = {
  "properties": {
    "conditions": {
      "$ref": "A7uVJlcjnkmG4ppW5VQ8IFoVpLjEiGiliE6Arj1o"
    }
  },
  "type": "object",
  "nullable": true
...
const schema22 = {
  "items": {
    "$ref": "aLGjx8FhHlqhNTy0B4qOmnlXHB7yB2VO2IyDJnSGA"
  },
  "type": "array",
  "nullable": true
};
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate58(data.lastTransitionTime, {
...
function validate23(data, {
  ...
  /*# sourceURL="replication.k8ssandra.io.v1alpha1.ReplicatedSecret" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
