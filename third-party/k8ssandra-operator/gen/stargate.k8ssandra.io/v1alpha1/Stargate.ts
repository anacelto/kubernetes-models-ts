...
import { validate } from "../../_schemas/StargateK8ssandraIoV1alpha1Stargate";
 ...
 * Stargate is the Schema for the stargates API
 */
export class Stargate extends Model<IStargate> implements IStargate {
...
static apiVersion: IStargate["apiVersion"] = "stargate.k8ssandra.io/v1alpha1";
static kind: IStargate["kind"] = "Stargate";
static is = createTypeMetaGuard<IStargate>(Stargate);

constructor(data?: ModelData<IStargate>) {
  super();

  this.setDefinedProps({
    apiVersion: Stargate.apiVersion,
    kind: Stargate.kind,
    ...data
  } as IStargate);
}
...
setValidateFunc(Stargate, validate as ValidateFunc<IStargate>);
