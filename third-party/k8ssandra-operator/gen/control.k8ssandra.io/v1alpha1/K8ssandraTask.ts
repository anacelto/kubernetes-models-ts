...
import { validate } from "../../_schemas/ControlK8ssandraIoV1alpha1K8ssandraTask";
 ...
 * K8ssandraTask is the Schema for the k8ssandratasks API
 */
export class K8ssandraTask extends Model<IK8ssandraTask> implements IK8ssandraTask {
...
static apiVersion: IK8ssandraTask["apiVersion"] = "control.k8ssandra.io/v1alpha1";
static kind: IK8ssandraTask["kind"] = "K8ssandraTask";
static is = createTypeMetaGuard<IK8ssandraTask>(K8ssandraTask);

constructor(data?: ModelData<IK8ssandraTask>) {
  super();

  this.setDefinedProps({
    apiVersion: K8ssandraTask.apiVersion,
    kind: K8ssandraTask.kind,
    ...data
  } as IK8ssandraTask);
}
}
...
setValidateFunc(K8ssandraTask, validate as ValidateFunc<IK8ssandraTask>);
