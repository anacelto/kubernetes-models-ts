 ...
 * ReplicatedSecret is the Schema for the replicatedsecrets API
 */
export declare class ReplicatedSecret extends Model<IReplicatedSecret> implements IReplicatedSecret {
    ...
    static apiVersion: IReplicatedSecret["apiVersion"];
    static kind: IReplicatedSecret["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IReplicatedSecret>;
