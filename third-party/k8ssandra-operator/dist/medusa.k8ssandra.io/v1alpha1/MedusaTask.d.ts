 ...
 * MedusaTask is the Schema for the MedusaTasks API
 */
export declare class MedusaTask extends Model<IMedusaTask> implements IMedusaTask {
    ...
    static apiVersion: IMedusaTask["apiVersion"];
    static kind: IMedusaTask["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMedusaTask>;
