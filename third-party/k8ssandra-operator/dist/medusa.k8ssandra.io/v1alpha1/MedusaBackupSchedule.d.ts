 ...
 * MedusaBackupSchedule is the Schema for the medusabackupschedules API
 */
export declare class MedusaBackupSchedule extends Model<IMedusaBackupSchedule> implements IMedusaBackupSchedule {
    ...
    static apiVersion: IMedusaBackupSchedule["apiVersion"];
    static kind: IMedusaBackupSchedule["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMedusaBackupSchedule>;
