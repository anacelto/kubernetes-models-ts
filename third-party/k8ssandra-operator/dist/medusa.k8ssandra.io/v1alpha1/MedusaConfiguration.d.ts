 ...
 * MedusaConfiguration is the Schema for the medusaconfigurations API
 */
export declare class MedusaConfiguration extends Model<IMedusaConfiguration> implements IMedusaConfiguration {
    ...
    static apiVersion: IMedusaConfiguration["apiVersion"];
    static kind: IMedusaConfiguration["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMedusaConfiguration>;
