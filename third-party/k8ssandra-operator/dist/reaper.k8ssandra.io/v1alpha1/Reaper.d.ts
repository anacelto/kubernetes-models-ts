 ...
 * Reaper is the Schema for the reapers API
 */
export declare class Reaper extends Model<IReaper> implements IReaper {
    "apiVersion": IReaper["apiVersion"];
    "kind": IReaper["kind"];
    "metadata"?: IReaper["metadata"];
    "spec"?: IReaper["spec"];
    "status"?: IReaper["status"];
    static apiVersion: IReaper["apiVersion"];
    static kind: IReaper["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IReaper>;
