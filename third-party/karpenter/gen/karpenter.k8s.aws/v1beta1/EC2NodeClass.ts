...
import { validate } from "../../_schemas/KarpenterK8sAwsV1beta1EC2NodeClass";
 ...
 * EC2NodeClass is the Schema for the EC2NodeClass API
 */
export class EC2NodeClass extends Model<IEC2NodeClass> implements IEC2NodeClass {
...
static apiVersion: IEC2NodeClass["apiVersion"] = "karpenter.k8s.aws/v1beta1";
static kind: IEC2NodeClass["kind"] = "EC2NodeClass";
static is = createTypeMetaGuard<IEC2NodeClass>(EC2NodeClass);

constructor(data?: ModelData<IEC2NodeClass>) {
  super();

  this.setDefinedProps({
    apiVersion: EC2NodeClass.apiVersion,
    kind: EC2NodeClass.kind,
    ...data
  } as IEC2NodeClass);
}
}
...
setValidateFunc(EC2NodeClass, validate as ValidateFunc<IEC2NodeClass>);
