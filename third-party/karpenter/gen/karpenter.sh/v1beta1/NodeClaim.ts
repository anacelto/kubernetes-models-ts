...
import { validate } from "../../_schemas/KarpenterShV1beta1NodeClaim";
 ...
 * NodeClaim is the Schema for the NodeClaims API
 */
export class NodeClaim extends Model<INodeClaim> implements INodeClaim {
...
static apiVersion: INodeClaim["apiVersion"] = "karpenter.sh/v1beta1";
static kind: INodeClaim["kind"] = "NodeClaim";
static is = createTypeMetaGuard<INodeClaim>(NodeClaim);
...
setValidateFunc(NodeClaim, validate as ValidateFunc<INodeClaim>);
