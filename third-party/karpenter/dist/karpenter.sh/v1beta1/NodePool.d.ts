 ...
 * NodePool is the Schema for the NodePools API
 */
export declare class NodePool extends Model<INodePool> implements INodePool {
    "apiVersion": INodePool["apiVersion"];
    "kind": INodePool["kind"];
    "metadata"?: INodePool["metadata"];
    "spec": INodePool["spec"];
    "status"?: INodePool["status"];
    static apiVersion: INodePool["apiVersion"];
    static kind: INodePool["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<INodePool>;
