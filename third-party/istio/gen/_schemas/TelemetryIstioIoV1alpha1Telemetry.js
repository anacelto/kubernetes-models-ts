...
const schema18 = {
  ...
  "properties": {
    "spec": {
      "$ref": "M0iEzhpUsRDXpfyGll0XIREERp7WfKKetWLtkMYwk"
    },
    "status": {
...
const schema19 = {
  "properties": {
    ...
    "metrics": {
      "$ref": "dKbDqxRiyE9bxUHPkDym6iVVB2y4vMWNshGLJ0ogE"
    },
    "selector": {
...
const schema23 = {
  "items": {
    "$ref": "v2bMmYDCFhYNsT3ZhthPwV2eKE2upPXLsZUgWixVOn8"
  },
  "type": "array",
  "nullable": true
};
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.reportingInterval !== undefined) {
      if (!validate21(data.reportingInterval, {
        instancePath: instancePath + "/reportingInterval",
        parentData: data,
        parentDataProperty: "reportingInterval",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate82(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchLabels !== undefined) {
      if (!validate83(data.matchLabels, {
...
function validate89(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.randomSamplingPercentage !== undefined) {
      if (!validate112(data.randomSamplingPercentage, {
