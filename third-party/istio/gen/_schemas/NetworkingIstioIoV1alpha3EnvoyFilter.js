...
const schema14 = {
  ...
  "properties": {
    "spec": {
      "$ref": "2SHRz0rfbUF3X5qQuckYJhAl8NkdtIJ8mu2JY4MEno"
    },
    "status": {
...
const schema15 = {
  "properties": {
    "configPatches": {
      "$ref": "OKYA58VShxm0glJh3NXFgbjcBhk0fH4WIALt4EwNp4"
    },
    "priority": {
...
const schema16 = {
  "items": {
    "$ref": "ApbfbzWDZofKG99gIrz9r2JcnlgSDncwH1SVFHTQg"
  },
  "type": "array",
  "nullable": true
};
const schema17 = {
  "properties": {
    "applyTo": {
      "$ref": "2YVNSo46dBDfA21nqTFyKqcGShMKNsrXpHetAv4U4"
    },
    "match": {
      "$ref": "AjlpldEFMCqW4BhoXvQ8eLLyIJFiYS7ujeDtuCHTiNc"
    },
    "patch": {
...
function validate34(data, {
  ...
  if (!(data === "INVALID" || data === "LISTENER" || data === "FILTER_CHAIN" || data === "NETWORK_FILTER" || data === "HTTP_FILTER" || data === "ROUTE_CONFIGURATION" || data === "VIRTUAL_HOST" || data === "HTTP_ROUTE" || data === "CLUSTER" || data === "EXTENSION_CONFIG" || data === "BOOTSTRAP" || data === "LISTENER_FILTER")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  ...
  "properties": {
    ...
    "listener": {
      "$ref": "UO53ViG886v0hGm8fsbO2x8waELfTv24Evrwt7k8"
    },
    "proxy": {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.listenerFilter !== undefined) {
      if (!validate21(data.listenerFilter, {
        instancePath: instancePath + "/listenerFilter",
        parentData: data,
        parentDataProperty: "listenerFilter",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.routeConfiguration !== undefined) {
      if (!validate78(data.routeConfiguration, {
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.filterClass !== undefined) {
      if (!validate94(data.filterClass, {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.workloadSelector !== undefined) {
      if (!validate104(data.workloadSelector, {
...
const schema41 = {};
import { validate as validate114 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
function validate30(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate109(data.apiVersion, {
