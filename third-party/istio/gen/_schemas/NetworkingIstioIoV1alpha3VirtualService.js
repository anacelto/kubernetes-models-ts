...
export const validate = validate87;
const schema38 = {
  "type": "object",
  "properties": {
    "spec": {
      "$ref": "ofuRT4zaWSosW0BqmPizc3n7AtqldnaO6wL6yNA10"
    },
    "status": {
...
const schema39 = {
  "properties": {
    ...
    "http": {
      "$ref": "LV1wGuh5qNDjh8w62GrlKyJS8vc19UZBhvkw0"
    },
    "tcp": {
...
const schema40 = {
  "items": {
    "$ref": "BFpc4yNWhDtV8pxFWBWH6cK8BMkxW9v2yGrafsCpqA"
  },
  "type": "array",
  "nullable": true
};
const schema41 = {
  "properties": {
    ...
    "directResponse": {
      "$ref": "KFwMwaMhHuxDXiJGrffR0heuUqFqMHRXhidxAdEDQ"
    },
    "fault": {
    ...
    "match": {
      "$ref": "reoeDAqoREJDTMmrg7XFJGNq4Wfd44iCx6hBDW4U"
    },
    "mirror": {
...
function validate94(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowCredentials !== undefined) {
      if (!validate59(data.allowCredentials, {
    ...
    if (data.allowOrigins !== undefined) {
      if (!validate99(data.allowOrigins, {
...
const schema45 = {
  "properties": {
    "body": {
      "$ref": "kPVlAX5iorDIQ3ZnwYHEzWuOTgcYJH1EhOIZrSREh30"
    },
    "status": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    }
...
const schema46 = {
  "oneOf": [{
    "$ref": "RakJELUOhCBApZGdJVWwM4WTsoaAD68e1eH6pWTxuyI"
  }, {
    "$ref": "Q2nY278x5HaJmkydMrE67y780rgHyWZ29m3AVQU"
  }, {
    "$ref": "QYKTIFxD4qvdFBrbKaZPwzGd1RSQMzHH4V8kNYdY"
  }],
  "properties": {
    "bytes": {
      "$ref": "Qk5NQNZEVgEph46X6BOWWIsvy3DO9KttVuQCqA2Yo"
    },
    "string": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema47 = {
  "not": {
    "$ref": "WM6Ltl9nOh8BP7d4xqNomCcim7fVTUfx6tneTcFLM"
  }
};
const schema48 = {
  "anyOf": [{
...
function validate110(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.bytes !== undefined) {
      if (!validate119(data.bytes, {
        instancePath: instancePath + "/bytes",
        parentData: data,
        parentDataProperty: "bytes",
        rootData
      })) {
...
const schema57 = {
  "items": {
    "$ref": "PWZ3KtcBc6rPBvkcbmhc7BUfQxakJsI9NGkREofW0"
  },
  "type": "array",
  "nullable": true
};
...
function validate159(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ignoreUriCase !== undefined) {
      if (!validate59(data.ignoreUriCase, {
    ...
    if (data.queryParams !== undefined) {
      if (!validate69(data.queryParams, {
    ...
    if (data.statPrefix !== undefined) {
      if (!validate24(data.statPrefix, {
        instancePath: instancePath + "/statPrefix",
        parentData: data,
        parentDataProperty: "statPrefix",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.withoutHeaders !== undefined) {
      if (!validate69(data.withoutHeaders, {
...
function validate181(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.derivePort !== undefined) {
      if (!validate191(data.derivePort, {
...
function validate198(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.retryRemoteLocalities !== undefined) {
      if (!validate59(data.retryRemoteLocalities, {
...
function validate209(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.destination !== undefined) {
      if (!validate73(data.destination, {
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.directResponse !== undefined) {
      if (!validate109(data.directResponse, {
        instancePath: instancePath + "/directResponse",
        parentData: data,
        parentDataProperty: "directResponse",
        rootData
      })) {
    ...
    if (data.mirrorPercentage !== undefined) {
      if (!validate34(data.mirrorPercentage, {
...
const schema79 = {};
import { validate as validate256 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
function validate87(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate251(data.apiVersion, {
