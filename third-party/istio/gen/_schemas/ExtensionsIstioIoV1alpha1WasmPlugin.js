...
const schema9 = {
  ...
  "properties": {
    "spec": {
      "$ref": "MmhjlcwEfmFuax5AUDFboWaLIGYEJrX8EpJJCmCBw"
    },
    "status": {
...
const schema10 = {
  "properties": {
    ...
    "match": {
      "$ref": "37feiqAjDeKeJv8jMyu00JXp781d0L7Mqq94iX0o4"
    },
    "phase": {
...
const schema12 = {
  "items": {
    "$ref": "e8MOqCchFO8urwYkQqCNv0QP4EIeoK7gC6KR4hAwSbM"
  },
  "type": "array",
  "nullable": true
};
const schema13 = {
  "properties": {
    "mode": {
      "$ref": "xtIwWEypLLsF0ULqFiGCENFZfu3gyqw4cktFWMaKcxI"
    },
    "ports": {
      "$ref": "KjpulS6wNG5FRv4oBhNiuJcRYbUmnpSqtPNeNIg0po"
    }
  },
  "type": "object"
};
...
function validate31(data, {
  ...
  if (!(data === "UNDEFINED" || data === "CLIENT" || data === "SERVER" || data === "CLIENT_AND_SERVER")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "items": {
    "$ref": "6PJz6o5l0ZzoYV60eBw4bhh6VQeznTEGSvsTtqsfqU"
  },
  "type": "array",
  "nullable": true
};
...
function validate25(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.pluginConfig !== undefined) {
      if (!validate23(data.pluginConfig, {
