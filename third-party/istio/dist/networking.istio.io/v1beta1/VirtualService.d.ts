...
export declare class VirtualService extends Model<IVirtualService> implements IVirtualService {
    ...
    static apiVersion: IVirtualService["apiVersion"];
    static kind: IVirtualService["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVirtualService>;
