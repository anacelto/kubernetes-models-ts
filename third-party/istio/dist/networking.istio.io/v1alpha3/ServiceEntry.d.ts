...
export declare class ServiceEntry extends Model<IServiceEntry> implements IServiceEntry {
    ...
    static apiVersion: IServiceEntry["apiVersion"];
    static kind: IServiceEntry["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IServiceEntry>;
