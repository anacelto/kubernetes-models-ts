...
export declare class Alertmanager extends Model<IAlertmanager> implements IAlertmanager {
    ...
    static apiVersion: IAlertmanager["apiVersion"];
    static kind: IAlertmanager["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAlertmanager>;
