...
export declare class Prometheus extends Model<IPrometheus> implements IPrometheus {
    ...
    static apiVersion: IPrometheus["apiVersion"];
    static kind: IPrometheus["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPrometheus>;
