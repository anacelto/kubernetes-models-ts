...
export declare class ServiceMonitor extends Model<IServiceMonitor> implements IServiceMonitor {
    "apiVersion": IServiceMonitor["apiVersion"];
    "kind": IServiceMonitor["kind"];
    "metadata"?: IServiceMonitor["metadata"];
    "spec": IServiceMonitor["spec"];
    static apiVersion: IServiceMonitor["apiVersion"];
    static kind: IServiceMonitor["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IServiceMonitor>;
