...
export declare class ThanosRuler extends Model<IThanosRuler> implements IThanosRuler {
    ...
    static apiVersion: IThanosRuler["apiVersion"];
    static kind: IThanosRuler["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IThanosRuler>;
