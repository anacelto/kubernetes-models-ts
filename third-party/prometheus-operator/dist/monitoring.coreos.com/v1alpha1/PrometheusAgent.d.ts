...
export declare class PrometheusAgent extends Model<IPrometheusAgent> implements IPrometheusAgent {
    ...
    static apiVersion: IPrometheusAgent["apiVersion"];
    static kind: IPrometheusAgent["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPrometheusAgent>;
