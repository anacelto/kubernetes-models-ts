...
const schema20 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "tZ9N7iwDGQuZRiS3SwFDo5Moqypj03ZrciCdSAbtVY"
    }
  },
...
const schema25 = {
  "properties": {
    ...
    "podMetricsEndpoints": {
      "$ref": "n3ksS40NWVsWbJG63qKNvQoH7KFPsxCFq5uZUGATwxk"
    },
    "podTargetLabels": {
...
const schema28 = {
  "items": {
    "$ref": "1XpzxcimaRLgA6vba8IMy6cpb2dLT3hSVdTfQ1swi8"
  },
  "type": "array"
};
const schema29 = {
...
function validate90(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clientSecret !== undefined) {
      if (!validate95(data.clientSecret, {
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.enableHttp2 !== undefined) {
      if (!validate22(data.enableHttp2, {
    ...
    if (data.filterRunning !== undefined) {
      if (!validate22(data.filterRunning, {
    ...
    if (data.targetPort !== undefined) {
      if (!validate117(data.targetPort, {
...
function validate133(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate134(data.matchExpressions, {
