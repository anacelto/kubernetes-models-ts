...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "lzuMAOhUTa8X2GAqo5w7QTao7CWeY14TK8ieHvgKMTA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AGi1LblHbrlfejiD2GzgcuXUSipUzZkxs3bWDRdcYs"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "monitoring.coreos.com.v1alpha1.ScrapeConfig"
};
const schema11 = {
  "type": "string",
...
const schema15 = {
  "properties": {
    "fileSDConfigs": {
      "$ref": "ZvgV7F7lV9HYO0GzYLtsN3EbbKx9IV0ytdE1gxfro"
    },
    "honorLabels": {
    ...
    "httpSDConfigs": {
      "$ref": "kvBJ8kDOkSB2zjZw2oywAkKx37QJVmnATkHN0hDEWI"
    },
    "metricsPath": {
...
const schema16 = {
  "items": {
    "$ref": "f4oRi5IV2ywLEOTaMnPLoBgRBbN5NrzaudOy0ROf9Qo"
  },
  "type": "array",
  "nullable": true
};
const schema17 = {
  "properties": {
    "files": {
      "$ref": "dW69F4JbaiPUE1Fi7YNngJ679QIASRvpWuvHR5o"
    },
    "refreshInterval": {
...
const schema18 = {
  "items": {
    "$ref": "OpXAlRdV2jx4dOZfMF5zvaoC31wHxrOOK4XAgrYq4dU"
  },
  "minItems": 1,
  "type": "array"
};
...
const pattern1 = new RegExp("^[^*]*(\\*[^/]*)?\\.(json|yml|yaml|JSON|YML|YAML)$", "u");
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.refreshInterval !== undefined) {
      if (!validate22(data.refreshInterval, {
...
const schema20 = {
  "items": {
    "$ref": "oWqZZKrIN3iKAfMXaZkfMeaSHK40quyM5rXGSKlz0s"
  },
  "type": "array",
  "nullable": true
};
...
const pattern2 = new RegExp("^http(s)?://.+$", "u");
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.replacement !== undefined) {
      if (!validate23(data.replacement, {
    ...
    if (data.sourceLabels !== undefined) {
      if (!validate63(data.sourceLabels, {
    ...
    if (data.targetLabel !== undefined) {
      if (!validate23(data.targetLabel, {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.fileSDConfigs !== undefined) {
      if (!validate35(data.fileSDConfigs, {
    ...
    if (data.httpSDConfigs !== undefined) {
      if (!validate46(data.httpSDConfigs, {
    ...
    if (data.metricsPath !== undefined) {
      if (!validate23(data.metricsPath, {
        instancePath: instancePath + "/metricsPath",
        parentData: data,
        parentDataProperty: "metricsPath",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.relabelings !== undefined) {
      if (!validate54(data.relabelings, {
    ...
    if (data.staticConfigs !== undefined) {
      if (!validate70(data.staticConfigs, {
...
function validate25(data, {
  ...
  /*# sourceURL="monitoring.coreos.com.v1alpha1.ScrapeConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
