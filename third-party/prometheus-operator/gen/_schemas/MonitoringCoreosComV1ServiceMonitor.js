...
const schema20 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "iWCYLN8bm02dcdIeDQulW3V0eDVyHR6LM8z7ZrVWA"
    }
  },
...
const schema25 = {
  "properties": {
    ...
    "endpoints": {
      "$ref": "g6wJyOE1FKDbSrW3aqdipr7pcB3czlpSlT5kefTOU"
    },
    "jobLabel": {
...
const schema27 = {
  "items": {
    "$ref": "3IUtqZF3HU7phBGhNyBDd1M7f2qzdKOEKaOdMU"
  },
  "type": "array"
};
const schema28 = {
  "properties": {
    ...
    "metricRelabelings": {
      "$ref": "tddkAeCeTFeYO0i5LI09Bv1i2NYh6uQoGfpinECGWA"
    },
    "oauth2": {
...
const schema10 = {
  "items": {
    "$ref": "z2Uo4Wj2tE6RT4y4VHzClOfxJ0L43oYcVuUUeTSEAA"
  },
  "type": "array",
  "nullable": true
};
const schema11 = {
  "properties": {
    "action": {
      "$ref": "YjzAjc1FdLyVrXcJEpojVIOJmVcz1y6OCBws3cPcUqs"
    },
    "modulus": {
      "$ref": "NW88HfrvS38u8Yy207QW6S7qFs2gsa0jBgSYGvqPw"
    },
...
function validate30(data, {
  ...
  if (!(data === "replace" || data === "Replace" || data === "keep" || data === "Keep" || data === "drop" || data === "Drop" || data === "hashmod" || data === "HashMod" || data === "labelmap" || data === "LabelMap" || data === "labeldrop" || data === "LabelDrop" || data === "labelkeep" || data === "LabelKeep" || data === "lowercase" || data === "Lowercase" || data === "uppercase" || data === "Uppercase" || data === "keepequal" || data === "KeepEqual" || data === "dropequal" || data === "DropEqual")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate29(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.replacement !== undefined) {
      if (!validate22(data.replacement, {
    ...
    if (data.targetLabel !== undefined) {
      if (!validate22(data.targetLabel, {
...
function validate83(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clientSecret !== undefined) {
      if (!validate88(data.clientSecret, {
...
function validate65(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authorization !== undefined) {
      if (!validate66(data.authorization, {
    ...
    if (data.bearerTokenFile !== undefined) {
      if (!validate22(data.bearerTokenFile, {
    ...
    if (data.bearerTokenSecret !== undefined) {
      if (!validate23(data.bearerTokenSecret, {
    ...
    if (data.enableHttp2 !== undefined) {
      if (!validate21(data.enableHttp2, {
        instancePath: instancePath + "/enableHttp2",
        parentData: data,
        parentDataProperty: "enableHttp2",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.followRedirects !== undefined) {
      if (!validate21(data.followRedirects, {
    ...
    if (data.targetPort !== undefined) {
      if (!validate110(data.targetPort, {
...
function validate137(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate138(data.matchExpressions, {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate131(data.namespaceSelector, {
