...
const schema20 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "5IVCi03XOWkqikv4xXKQOugqMINqSyV6UizrbsNJA"
    }
  },
...
const schema25 = {
  "properties": {
    ...
    "prober": {
      "$ref": "5LxMaAKyaGOVTkZKZ678uYDN5kN3DKbCXqDdVnDVjRw"
    },
    "sampleLimit": {
      "$ref": "NW88HfrvS38u8Yy207QW6S7qFs2gsa0jBgSYGvqPw"
    },
    ...
    "targets": {
      "$ref": "4ArEparxtzr1lFQnmzAsWwWYdVviS9pwiooalRrFg4"
    },
    "tlsConfig": {
...
const schema32 = {
  "properties": {
    "path": {
      "$ref": "QblkXZfCxctpbOOEPZ6siczBfIcYd0qnFLcdFCBWM"
    },
    "proxyUrl": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema35 = {
  "properties": {
    "ingress": {
      "$ref": "zCad3ivCh3UpsaT5yYILhPk8dM2XoKx9yDGT79IbA"
    },
    "staticConfig": {
      "$ref": "Z5SqB9qITv7hU5FrXG98mRTEWUP4fv37V97bUztE"
    }
  },
  "type": "object",
  "nullable": true
...
function validate110(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate111(data.matchExpressions, {
...
function validate104(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.namespaceSelector !== undefined) {
      if (!validate105(data.namespaceSelector, {
...
function validate103(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.staticConfig !== undefined) {
      if (!validate121(data.staticConfig, {
