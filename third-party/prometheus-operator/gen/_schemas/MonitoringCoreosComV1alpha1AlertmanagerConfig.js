...
const schema29 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "EuLGPCuR4jyoq4FhOxk8M4uaJle1bClpAs43MFqz4"
    }
  },
...
const schema34 = {
  "properties": {
    ...
    "route": {
      "$ref": "na8XoqXUz6nGAs1Urnr8pjog65PsUuKIQsRVwyIJA"
    }
  },
  "type": "object"
};
...
function validate350(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.activeTimeIntervals !== undefined) {
      if (!validate47(data.activeTimeIntervals, {
        instancePath: instancePath + "/activeTimeIntervals",
        parentData: data,
        parentDataProperty: "activeTimeIntervals",
        rootData
      })) {
        vErrors = vErrors === null ? validate47.errors : vErrors.concat(validate47.errors);
        errors = vErrors.length;
