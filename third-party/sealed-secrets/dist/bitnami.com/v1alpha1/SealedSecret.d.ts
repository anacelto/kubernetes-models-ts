 ...
 * SealedSecret is the K8s representation of a "sealed Secret" - a regular k8s Secret that has been sealed (encrypted) using the controller's key.
 */
export declare class SealedSecret extends Model<ISealedSecret> implements ISealedSecret {
    ...
    static apiVersion: ISealedSecret["apiVersion"];
    static kind: ISealedSecret["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISealedSecret>;
