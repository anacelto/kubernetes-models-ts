...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "6NAmhT42ZJBruVGRH1jjMkLYzCmRez74gx4o5t5gH0"
    },
    "status": {
      "$ref": "tbooiHeG6bgx5G4oFm4vJtB626kuN8btIA03IV4Ds0"
    }
  },
...
const schema15 = {
  "properties": {
    ...
    "template": {
      "$ref": "0gEDeer6FUh3YAEt4PPzOrT9yUBmvzHuTvEwQZgM"
    }
  },
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.encryptedData !== undefined) {
      if (!validate38(data.encryptedData, {
        instancePath: instancePath + "/encryptedData",
        parentData: data,
        parentDataProperty: "encryptedData",
        rootData
      })) {
