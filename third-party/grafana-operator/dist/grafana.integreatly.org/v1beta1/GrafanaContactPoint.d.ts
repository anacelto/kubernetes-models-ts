 ...
 * GrafanaContactPoint is the Schema for the grafanacontactpoints API
 */
export declare class GrafanaContactPoint extends Model<IGrafanaContactPoint> implements IGrafanaContactPoint {
    ...
    static apiVersion: IGrafanaContactPoint["apiVersion"];
    static kind: IGrafanaContactPoint["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGrafanaContactPoint>;
