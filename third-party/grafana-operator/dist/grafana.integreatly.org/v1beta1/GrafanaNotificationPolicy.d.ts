 ...
 * GrafanaNotificationPolicy is the Schema for the GrafanaNotificationPolicy API
 */
export declare class GrafanaNotificationPolicy extends Model<IGrafanaNotificationPolicy> implements IGrafanaNotificationPolicy {
    ...
    static apiVersion: IGrafanaNotificationPolicy["apiVersion"];
    static kind: IGrafanaNotificationPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGrafanaNotificationPolicy>;
