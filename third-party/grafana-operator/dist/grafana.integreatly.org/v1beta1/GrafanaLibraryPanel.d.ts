 ...
 * GrafanaLibraryPanel is the Schema for the grafanalibrarypanels API
 */
export declare class GrafanaLibraryPanel extends Model<IGrafanaLibraryPanel> implements IGrafanaLibraryPanel {
    ...
    static apiVersion: IGrafanaLibraryPanel["apiVersion"];
    static kind: IGrafanaLibraryPanel["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGrafanaLibraryPanel>;
