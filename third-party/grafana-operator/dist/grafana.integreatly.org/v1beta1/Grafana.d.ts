        ...
        "route"?: {
            ...
            "spec"?: {
                ...
                "tls"?: {
                     ...
                     */
                    "termination": "edge" | "reencrypt" | "passthrough";
                };
                /**
 ...
 * Grafana is the Schema for the grafanas API
 */
export declare class Grafana extends Model<IGrafana> implements IGrafana {
    "apiVersion": IGrafana["apiVersion"];
    "kind": IGrafana["kind"];
    "metadata"?: IGrafana["metadata"];
    "spec": IGrafana["spec"];
    "status"?: IGrafana["status"];
    static apiVersion: IGrafana["apiVersion"];
    static kind: IGrafana["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IGrafana>;
