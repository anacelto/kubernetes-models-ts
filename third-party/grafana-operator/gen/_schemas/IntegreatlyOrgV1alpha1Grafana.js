...
export const validate = validate214;
const schema67 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "uBnESxp4q2rV570Wd93BfrWLbqys5hFzA7z5VN7U"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "tL5OoabNCkmEY4YjLhu5b3rtbAYvEXSjSqrReNv1rB0"
    },
    "status": {
      "$ref": "N59PQfB6DoMvR7Va84RibNm2oWs4LxtE7V3GuyA"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "integreatly.org.v1alpha1.Grafana"
};
const schema68 = {
  "type": "string",
...
const schema71 = {};
import { validate as validate220 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema72 = {
  "properties": {
    ...
    "client": {
      "$ref": "z7c279IrkmPBw4So0qvLRJyRuxkqGTpiFVd38Eeduc"
    },
    "config": {
      "$ref": "BQ7FnnTnp9sJCeyqXXP6YZ2x4nnuoddJSSYfJhz8"
    },
    "configMaps": {
    ...
    "dataStorage": {
      "$ref": "sObxBEBmLrkWsHwRJMnT97vXXVpF1M3TZMgD1vN1Es"
    },
    "deployment": {
      "$ref": "NaOTRbAwtoosCKRYCdRabVWs3s0ITFHIZ6mRStX4jDg"
    },
    "ingress": {
      "$ref": "DBac8zEo5vqU9kHGerZm6mZhM2lcNIBaEbYjjK05No"
    },
    "initImage": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    ...
    "jsonnet": {
      "$ref": "Nl8qru0ZgkNRTIZfdZBF6eKcRXcfNMYMd4N8mYs"
    },
    "livenessProbeSpec": {
      "$ref": "r5YnM17XV8MvXjJfhS8gUhpQRdlBtLahn0O3Iafur0"
    },
    "readinessProbeSpec": {
      "$ref": "r5YnM17XV8MvXjJfhS8gUhpQRdlBtLahn0O3Iafur0"
    },
    ...
    "service": {
      "$ref": "ls0EEKBgvVEsfVXYwXKxqRUfYh2M7yaF7w2hKrRXpY"
    },
    "serviceAccount": {
      "$ref": "PZA8yjepjDr4YiPKZyIGkVVD3Mi5uDcTZS96JeHE"
    }
  },
  "required": ["config"],
  "type": "object",
...
function validate225(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferService !== undefined) {
      if (!validate22(data.preferService, {
        instancePath: instancePath + "/preferService",
        parentData: data,
        parentDataProperty: "preferService",
        rootData
      })) {
...
const schema74 = {
  "properties": {
    "alerting": {
      "$ref": "eS7OBWqNFElLRzWzq4fmeiJtiyiHC94OGHUAsowd0"
    },
    "analytics": {
      "$ref": "UDuwKBfJhJgQLZT4TXvIhg1WizJFybSC6fbcNMSkJo"
    },
    "auth": {
      "$ref": "yziMaW3mkrJuoczUzfk3YRmTyBBYAPPTTZko2FA"
    },
    "auth.anonymous": {
      "$ref": "d4iNWv35W6qKjlguEaebJfsafiHhRyLcVNTrQmyC9Xc"
    },
    "auth.azuread": {
      "$ref": "T7QtagXNENIK3nb7NmgD8D5FON5y0UR12WCQ7ka9Fc"
    },
    "auth.basic": {
      "$ref": "jGnVHu3UZIESVSbmGsblHm4RqAftnIrItcRlvqGcAs"
    },
    "auth.generic_oauth": {
      "$ref": "d6pnQ6FHpdmNUms3B6rN44aUyGMTMGygJHNdieXdtA"
    },
    "auth.github": {
      "$ref": "Z7WLgvQUonxeddbdcyP3ZYLdB4UchNTalTUAHKdhXc"
    },
    "auth.gitlab": {
      "$ref": "3opgXLbuANhRkY1qQ4OD14709UzxVqHe5KmnSOCRQAU"
    },
    "auth.google": {
      "$ref": "gAizssPinrhoUh8iaLDlQUZo9ABN4byUwuBdkCTeZQ"
    },
    "auth.ldap": {
      "$ref": "9fq8bZFKD9qzf56OEEm6Ajj1Zs6vq9isTA4VNZPJG0"
    },
    "auth.okta": {
      "$ref": "f3I1ArD8Cu1dOkJWma4qoHVUEZmCebHDxIMMQAyxYM"
    },
    "auth.proxy": {
      "$ref": "or95TfrZp48IyKYajTrZdZH4C9KenjHKxBtk7gZp8"
    },
    "auth.saml": {
      "$ref": "StXuralBddNlao1oq5JrjUNSybzDFIwby4YqoTY4E"
    },
    "dashboards": {
      "$ref": "r22yJM8ML6wBfiyugi5qjAO9KVZzi93Iqp6YJDjLfQU"
    },
    "database": {
      "$ref": "D18Nx7ABdBhncsAaVetgZTUrJnazc5Qnl1lmI9bEE"
    },
    "dataproxy": {
      "$ref": "mf7oY0AKhWqHK0e0LH4ohdeOQn9qdkKIVh28SQ0Itc"
    },
    "external_image_storage": {
      "$ref": "Ocm4ZGmPfacoCcgcsNb3lv96jfB5DjSjdjOB1E7sg"
    },
    "external_image_storage.azure_blob": {
      "$ref": "2Qwok6orzoiXec1xNaUrK6cmr3mGIq0HYW0Ph2sGk"
    },
    "external_image_storage.gcs": {
      "$ref": "KBmZFyWHxdR5T9r8ytP6atWJUt4aliDrW0Hmbezc"
    },
    "external_image_storage.s3": {
      "$ref": "V5av5fBn5eOXw3sYdl3xcFyojxYgJYYmMYdDsQMt8"
    },
    "external_image_storage.webdav": {
      "$ref": "vZm6RnK2MExVupW0sjZLEUVodFjQEmeJUUgJyItM"
    },
    "feature_toggles": {
      "$ref": "fheoZWBgrJtWYcXZYgIsoyMx2c33Ja47HQ7MYFXw"
    },
    "live": {
      "$ref": "dyRsph4trAwF6KUAoEYgSmw5xpnE0fmD1H0UFad0M40"
    },
    "log": {
      "$ref": "UUhlrtSsVKXFcjSk3TPVF27pHJ3Qo4TGZNoVbODYw"
    },
    "log.console": {
      "$ref": "04jZXT87gFxusRgtu2naIsk1TxRvQz4wD86PTPb50"
    },
    "log.frontend": {
      "$ref": "ksRznpEAhvNCRDoh8tBSPyjtCJryoAazVptaMmjoAo"
    },
    "metrics": {
      "$ref": "Wn36cq7gaskHlcWgRzfY8tmWwFSHzwczEtNz6BooCqA"
    },
    "metrics.graphite": {
      "$ref": "gEzWbeTXYE9wDCLGE2UqkGs8XZv2gyfOksrUUgqU"
    },
    "panels": {
      "$ref": "5fgCv7B0z4lMPLbT5dKDWHT9e3HoWfObln8ABm6lGY"
    },
    "paths": {
      "$ref": "kPgjy8KaX6FH3NHKRn2Hq9OPckdWrtWA6lKszB0I"
    },
    "plugins": {
      "$ref": "nVPXhGNvgx6N6mhHWPQSInK5efsn7EVZYxZTOaWQ"
    },
    "remote_cache": {
      "$ref": "jLU9jvXuY2RHCPh3PqpQEbkWpGkTJ6vrzvrnZ4q0Og"
    },
    "rendering": {
      "$ref": "nSZqYObqu5Z6FvXIcsPJ38mfbmciBb0wQECf8Vl80"
    },
    "security": {
      "$ref": "13sdHkod6K2pL9CtRUCDz8tWMXVoffg3I8U8YtaPWBE"
    },
    "server": {
      "$ref": "xIjUBTmAfkjgWHqMxnYysLiOCHu9VgNPr5XO6DpABXM"
    },
    "smtp": {
      "$ref": "1ZyEUaXnX5BFQUWLHgl16D1v3E0bh0spR2J6tNBrg8"
    },
    "snapshots": {
      "$ref": "DVdndXVFOwselvqumkYol3PPQl9pR0h24NJ9ejQSnI"
    },
    "unified_alerting": {
      "$ref": "ReN22dlFncodF5cf12afWouGE5NvOG2XODJdqMfhw"
    },
    "users": {
      "$ref": "mN2CnuvNDmDx4OggWm35gLe79U64Tw8gzTOmPFNILk"
    }
  },
  "type": "object"
};
...
function validate230(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.concurrent_render_limit !== undefined) {
      if (!validate21(data.concurrent_render_limit, {
        instancePath: instancePath + "/concurrent_render_limit",
        parentData: data,
        parentDataProperty: "concurrent_render_limit",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.error_or_timeout !== undefined) {
      if (!validate23(data.error_or_timeout, {
        instancePath: instancePath + "/error_or_timeout",
        parentData: data,
        parentDataProperty: "error_or_timeout",
        rootData
      })) {
    ...
    if (data.evaluation_timeout_seconds !== undefined) {
      if (!validate21(data.evaluation_timeout_seconds, {
        instancePath: instancePath + "/evaluation_timeout_seconds",
        parentData: data,
        parentDataProperty: "evaluation_timeout_seconds",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.execute_alerts !== undefined) {
      if (!validate22(data.execute_alerts, {
        instancePath: instancePath + "/execute_alerts",
        parentData: data,
        parentDataProperty: "execute_alerts",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.max_attempts !== undefined) {
      if (!validate21(data.max_attempts, {
        instancePath: instancePath + "/max_attempts",
        parentData: data,
        parentDataProperty: "max_attempts",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.nodata_or_nullvalues !== undefined) {
      if (!validate23(data.nodata_or_nullvalues, {
        instancePath: instancePath + "/nodata_or_nullvalues",
        parentData: data,
        parentDataProperty: "nodata_or_nullvalues",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.notification_timeout_seconds !== undefined) {
      if (!validate21(data.notification_timeout_seconds, {
        instancePath: instancePath + "/notification_timeout_seconds",
        parentData: data,
        parentDataProperty: "notification_timeout_seconds",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate240(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.check_for_updates !== undefined) {
      if (!validate22(data.check_for_updates, {
        instancePath: instancePath + "/check_for_updates",
        parentData: data,
        parentDataProperty: "check_for_updates",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.google_analytics_ua_id !== undefined) {
      if (!validate23(data.google_analytics_ua_id, {
        instancePath: instancePath + "/google_analytics_ua_id",
        parentData: data,
        parentDataProperty: "google_analytics_ua_id",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.reporting_enabled !== undefined) {
      if (!validate22(data.reporting_enabled, {
        instancePath: instancePath + "/reporting_enabled",
        parentData: data,
        parentDataProperty: "reporting_enabled",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate245(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.disable_login_form !== undefined) {
      if (!validate22(data.disable_login_form, {
        instancePath: instancePath + "/disable_login_form",
        parentData: data,
        parentDataProperty: "disable_login_form",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.disable_signout_menu !== undefined) {
      if (!validate22(data.disable_signout_menu, {
        instancePath: instancePath + "/disable_signout_menu",
        parentData: data,
        parentDataProperty: "disable_signout_menu",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.login_cookie_name !== undefined) {
      if (!validate23(data.login_cookie_name, {
        instancePath: instancePath + "/login_cookie_name",
        parentData: data,
        parentDataProperty: "login_cookie_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.login_maximum_inactive_lifetime_days !== undefined) {
      if (!validate21(data.login_maximum_inactive_lifetime_days, {
        instancePath: instancePath + "/login_maximum_inactive_lifetime_days",
        parentData: data,
        parentDataProperty: "login_maximum_inactive_lifetime_days",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.login_maximum_inactive_lifetime_duration !== undefined) {
      if (!validate23(data.login_maximum_inactive_lifetime_duration, {
        instancePath: instancePath + "/login_maximum_inactive_lifetime_duration",
        parentData: data,
        parentDataProperty: "login_maximum_inactive_lifetime_duration",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.login_maximum_lifetime_days !== undefined) {
      if (!validate21(data.login_maximum_lifetime_days, {
        instancePath: instancePath + "/login_maximum_lifetime_days",
        parentData: data,
        parentDataProperty: "login_maximum_lifetime_days",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.login_maximum_lifetime_duration !== undefined) {
      if (!validate23(data.login_maximum_lifetime_duration, {
        instancePath: instancePath + "/login_maximum_lifetime_duration",
        parentData: data,
        parentDataProperty: "login_maximum_lifetime_duration",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.oauth_auto_login !== undefined) {
      if (!validate22(data.oauth_auto_login, {
        instancePath: instancePath + "/oauth_auto_login",
        parentData: data,
        parentDataProperty: "oauth_auto_login",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.signout_redirect_url !== undefined) {
      if (!validate23(data.signout_redirect_url, {
        instancePath: instancePath + "/signout_redirect_url",
        parentData: data,
        parentDataProperty: "signout_redirect_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.sigv4_auth_enabled !== undefined) {
      if (!validate22(data.sigv4_auth_enabled, {
        instancePath: instancePath + "/sigv4_auth_enabled",
        parentData: data,
        parentDataProperty: "sigv4_auth_enabled",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.token_rotation_interval_minutes !== undefined) {
      if (!validate21(data.token_rotation_interval_minutes, {
        instancePath: instancePath + "/token_rotation_interval_minutes",
        parentData: data,
        parentDataProperty: "token_rotation_interval_minutes",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate258(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.org_name !== undefined) {
      if (!validate23(data.org_name, {
        instancePath: instancePath + "/org_name",
        parentData: data,
        parentDataProperty: "org_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.org_role !== undefined) {
      if (!validate23(data.org_role, {
        instancePath: instancePath + "/org_role",
        parentData: data,
        parentDataProperty: "org_role",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate263(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allow_sign_up !== undefined) {
      if (!validate22(data.allow_sign_up, {
        instancePath: instancePath + "/allow_sign_up",
        parentData: data,
        parentDataProperty: "allow_sign_up",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.allowed_domains !== undefined) {
      if (!validate23(data.allowed_domains, {
        instancePath: instancePath + "/allowed_domains",
        parentData: data,
        parentDataProperty: "allowed_domains",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.allowed_groups !== undefined) {
      if (!validate23(data.allowed_groups, {
        instancePath: instancePath + "/allowed_groups",
        parentData: data,
        parentDataProperty: "allowed_groups",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.auth_url !== undefined) {
      if (!validate23(data.auth_url, {
        instancePath: instancePath + "/auth_url",
        parentData: data,
        parentDataProperty: "auth_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.client_secret !== undefined) {
      if (!validate23(data.client_secret, {
...
function validate277(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.email_attribute_path !== undefined) {
      if (!validate23(data.email_attribute_path, {
        instancePath: instancePath + "/email_attribute_path",
        parentData: data,
        parentDataProperty: "email_attribute_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.role_attribute_path !== undefined) {
      if (!validate23(data.role_attribute_path, {
        instancePath: instancePath + "/role_attribute_path",
        parentData: data,
        parentDataProperty: "role_attribute_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.role_attribute_strict !== undefined) {
      if (!validate22(data.role_attribute_strict, {
        instancePath: instancePath + "/role_attribute_strict",
        parentData: data,
        parentDataProperty: "role_attribute_strict",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.team_ids !== undefined) {
      if (!validate23(data.team_ids, {
        instancePath: instancePath + "/team_ids",
        parentData: data,
        parentDataProperty: "team_ids",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.team_ids_attribute_path !== undefined) {
      if (!validate23(data.team_ids_attribute_path, {
        instancePath: instancePath + "/team_ids_attribute_path",
        parentData: data,
        parentDataProperty: "team_ids_attribute_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.teams_url !== undefined) {
      if (!validate23(data.teams_url, {
        instancePath: instancePath + "/teams_url",
        parentData: data,
        parentDataProperty: "teams_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.tls_client_ca !== undefined) {
      if (!validate23(data.tls_client_ca, {
        instancePath: instancePath + "/tls_client_ca",
        parentData: data,
        parentDataProperty: "tls_client_ca",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.tls_client_cert !== undefined) {
      if (!validate23(data.tls_client_cert, {
        instancePath: instancePath + "/tls_client_cert",
        parentData: data,
        parentDataProperty: "tls_client_cert",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.tls_client_key !== undefined) {
      if (!validate23(data.tls_client_key, {
        instancePath: instancePath + "/tls_client_key",
        parentData: data,
        parentDataProperty: "tls_client_key",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.tls_skip_verify_insecure !== undefined) {
      if (!validate22(data.tls_skip_verify_insecure, {
        instancePath: instancePath + "/tls_skip_verify_insecure",
        parentData: data,
        parentDataProperty: "tls_skip_verify_insecure",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate298(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowed_organizations !== undefined) {
      if (!validate23(data.allowed_organizations, {
        instancePath: instancePath + "/allowed_organizations",
        parentData: data,
        parentDataProperty: "allowed_organizations",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate331(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.config_file !== undefined) {
      if (!validate23(data.config_file, {
        instancePath: instancePath + "/config_file",
        parentData: data,
        parentDataProperty: "config_file",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate351(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.auto_sign_up !== undefined) {
      if (!validate22(data.auto_sign_up, {
        instancePath: instancePath + "/auto_sign_up",
        parentData: data,
        parentDataProperty: "auto_sign_up",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.enable_login_token !== undefined) {
      if (!validate22(data.enable_login_token, {
        instancePath: instancePath + "/enable_login_token",
        parentData: data,
        parentDataProperty: "enable_login_token",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.header_name !== undefined) {
      if (!validate23(data.header_name, {
        instancePath: instancePath + "/header_name",
        parentData: data,
        parentDataProperty: "header_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.header_property !== undefined) {
      if (!validate23(data.header_property, {
        instancePath: instancePath + "/header_property",
        parentData: data,
        parentDataProperty: "header_property",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.ldap_sync_ttl !== undefined) {
      if (!validate23(data.ldap_sync_ttl, {
        instancePath: instancePath + "/ldap_sync_ttl",
        parentData: data,
        parentDataProperty: "ldap_sync_ttl",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.whitelist !== undefined) {
      if (!validate23(data.whitelist, {
        instancePath: instancePath + "/whitelist",
        parentData: data,
        parentDataProperty: "whitelist",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate361(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allow_idp_initiated !== undefined) {
      if (!validate22(data.allow_idp_initiated, {
        instancePath: instancePath + "/allow_idp_initiated",
        parentData: data,
        parentDataProperty: "allow_idp_initiated",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.assertion_attribute_email !== undefined) {
      if (!validate23(data.assertion_attribute_email, {
        instancePath: instancePath + "/assertion_attribute_email",
        parentData: data,
        parentDataProperty: "assertion_attribute_email",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.assertion_attribute_groups !== undefined) {
      if (!validate23(data.assertion_attribute_groups, {
        instancePath: instancePath + "/assertion_attribute_groups",
        parentData: data,
        parentDataProperty: "assertion_attribute_groups",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.assertion_attribute_login !== undefined) {
      if (!validate23(data.assertion_attribute_login, {
        instancePath: instancePath + "/assertion_attribute_login",
        parentData: data,
        parentDataProperty: "assertion_attribute_login",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.assertion_attribute_name !== undefined) {
      if (!validate23(data.assertion_attribute_name, {
        instancePath: instancePath + "/assertion_attribute_name",
        parentData: data,
        parentDataProperty: "assertion_attribute_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.assertion_attribute_org !== undefined) {
      if (!validate23(data.assertion_attribute_org, {
        instancePath: instancePath + "/assertion_attribute_org",
        parentData: data,
        parentDataProperty: "assertion_attribute_org",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.assertion_attribute_role !== undefined) {
      if (!validate23(data.assertion_attribute_role, {
        instancePath: instancePath + "/assertion_attribute_role",
        parentData: data,
        parentDataProperty: "assertion_attribute_role",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.certificate_path !== undefined) {
      if (!validate23(data.certificate_path, {
        instancePath: instancePath + "/certificate_path",
        parentData: data,
        parentDataProperty: "certificate_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.idp_metadata_url !== undefined) {
      if (!validate23(data.idp_metadata_url, {
        instancePath: instancePath + "/idp_metadata_url",
        parentData: data,
        parentDataProperty: "idp_metadata_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.max_issue_delay !== undefined) {
      if (!validate23(data.max_issue_delay, {
        instancePath: instancePath + "/max_issue_delay",
        parentData: data,
        parentDataProperty: "max_issue_delay",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.metadata_valid_duration !== undefined) {
      if (!validate23(data.metadata_valid_duration, {
        instancePath: instancePath + "/metadata_valid_duration",
        parentData: data,
        parentDataProperty: "metadata_valid_duration",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.org_mapping !== undefined) {
      if (!validate23(data.org_mapping, {
        instancePath: instancePath + "/org_mapping",
        parentData: data,
        parentDataProperty: "org_mapping",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.private_key_path !== undefined) {
      if (!validate23(data.private_key_path, {
        instancePath: instancePath + "/private_key_path",
        parentData: data,
        parentDataProperty: "private_key_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.relay_state !== undefined) {
      if (!validate23(data.relay_state, {
        instancePath: instancePath + "/relay_state",
        parentData: data,
        parentDataProperty: "relay_state",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.role_values_admin !== undefined) {
      if (!validate23(data.role_values_admin, {
        instancePath: instancePath + "/role_values_admin",
        parentData: data,
        parentDataProperty: "role_values_admin",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.role_values_editor !== undefined) {
      if (!validate23(data.role_values_editor, {
        instancePath: instancePath + "/role_values_editor",
        parentData: data,
        parentDataProperty: "role_values_editor",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.role_values_grafana_admin !== undefined) {
      if (!validate23(data.role_values_grafana_admin, {
        instancePath: instancePath + "/role_values_grafana_admin",
        parentData: data,
        parentDataProperty: "role_values_grafana_admin",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.signature_algorithm !== undefined) {
      if (!validate23(data.signature_algorithm, {
        instancePath: instancePath + "/signature_algorithm",
        parentData: data,
        parentDataProperty: "signature_algorithm",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.single_logout !== undefined) {
      if (!validate22(data.single_logout, {
        instancePath: instancePath + "/single_logout",
        parentData: data,
        parentDataProperty: "single_logout",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate384(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.default_home_dashboard_path !== undefined) {
      if (!validate23(data.default_home_dashboard_path, {
        instancePath: instancePath + "/default_home_dashboard_path",
        parentData: data,
        parentDataProperty: "default_home_dashboard_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.versions_to_keep !== undefined) {
      if (!validate21(data.versions_to_keep, {
        instancePath: instancePath + "/versions_to_keep",
        parentData: data,
        parentDataProperty: "versions_to_keep",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate388(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.ca_cert_path !== undefined) {
      if (!validate23(data.ca_cert_path, {
        instancePath: instancePath + "/ca_cert_path",
        parentData: data,
        parentDataProperty: "ca_cert_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.cache_mode !== undefined) {
      if (!validate23(data.cache_mode, {
        instancePath: instancePath + "/cache_mode",
        parentData: data,
        parentDataProperty: "cache_mode",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.client_cert_path !== undefined) {
      if (!validate23(data.client_cert_path, {
        instancePath: instancePath + "/client_cert_path",
        parentData: data,
        parentDataProperty: "client_cert_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.client_key_path !== undefined) {
      if (!validate23(data.client_key_path, {
        instancePath: instancePath + "/client_key_path",
        parentData: data,
        parentDataProperty: "client_key_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.conn_max_lifetime !== undefined) {
      if (!validate21(data.conn_max_lifetime, {
        instancePath: instancePath + "/conn_max_lifetime",
        parentData: data,
        parentDataProperty: "conn_max_lifetime",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.log_queries !== undefined) {
      if (!validate22(data.log_queries, {
        instancePath: instancePath + "/log_queries",
        parentData: data,
        parentDataProperty: "log_queries",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.max_idle_conn !== undefined) {
      if (!validate21(data.max_idle_conn, {
        instancePath: instancePath + "/max_idle_conn",
        parentData: data,
        parentDataProperty: "max_idle_conn",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.max_open_conn !== undefined) {
      if (!validate21(data.max_open_conn, {
        instancePath: instancePath + "/max_open_conn",
        parentData: data,
        parentDataProperty: "max_open_conn",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.server_cert_name !== undefined) {
      if (!validate23(data.server_cert_name, {
        instancePath: instancePath + "/server_cert_name",
        parentData: data,
        parentDataProperty: "server_cert_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.ssl_mode !== undefined) {
      if (!validate23(data.ssl_mode, {
        instancePath: instancePath + "/ssl_mode",
        parentData: data,
        parentDataProperty: "ssl_mode",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate407(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.send_user_header !== undefined) {
      if (!validate22(data.send_user_header, {
        instancePath: instancePath + "/send_user_header",
        parentData: data,
        parentDataProperty: "send_user_header",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate415(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.account_key !== undefined) {
      if (!validate23(data.account_key, {
        instancePath: instancePath + "/account_key",
        parentData: data,
        parentDataProperty: "account_key",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.account_name !== undefined) {
      if (!validate23(data.account_name, {
        instancePath: instancePath + "/account_name",
        parentData: data,
        parentDataProperty: "account_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.container_name !== undefined) {
      if (!validate23(data.container_name, {
        instancePath: instancePath + "/container_name",
        parentData: data,
        parentDataProperty: "container_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate420(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.key_file !== undefined) {
      if (!validate23(data.key_file, {
        instancePath: instancePath + "/key_file",
        parentData: data,
        parentDataProperty: "key_file",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate425(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.bucket_url !== undefined) {
      if (!validate23(data.bucket_url, {
        instancePath: instancePath + "/bucket_url",
        parentData: data,
        parentDataProperty: "bucket_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.secret_key !== undefined) {
      if (!validate23(data.secret_key, {
        instancePath: instancePath + "/secret_key",
        parentData: data,
        parentDataProperty: "secret_key",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate433(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.public_url !== undefined) {
      if (!validate23(data.public_url, {
        instancePath: instancePath + "/public_url",
        parentData: data,
        parentDataProperty: "public_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate442(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowed_origins !== undefined) {
      if (!validate23(data.allowed_origins, {
        instancePath: instancePath + "/allowed_origins",
        parentData: data,
        parentDataProperty: "allowed_origins",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.max_connections !== undefined) {
      if (!validate21(data.max_connections, {
        instancePath: instancePath + "/max_connections",
        parentData: data,
        parentDataProperty: "max_connections",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate455(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.custom_endpoint !== undefined) {
      if (!validate23(data.custom_endpoint, {
        instancePath: instancePath + "/custom_endpoint",
        parentData: data,
        parentDataProperty: "custom_endpoint",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.log_endpoint_burst_limit !== undefined) {
      if (!validate21(data.log_endpoint_burst_limit, {
        instancePath: instancePath + "/log_endpoint_burst_limit",
        parentData: data,
        parentDataProperty: "log_endpoint_burst_limit",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.log_endpoint_requests_per_second_limit !== undefined) {
      if (!validate21(data.log_endpoint_requests_per_second_limit, {
        instancePath: instancePath + "/log_endpoint_requests_per_second_limit",
        parentData: data,
        parentDataProperty: "log_endpoint_requests_per_second_limit",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.sample_rate !== undefined) {
      if (!validate23(data.sample_rate, {
        instancePath: instancePath + "/sample_rate",
        parentData: data,
        parentDataProperty: "sample_rate",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.sentry_dsn !== undefined) {
      if (!validate23(data.sentry_dsn, {
        instancePath: instancePath + "/sentry_dsn",
        parentData: data,
        parentDataProperty: "sentry_dsn",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate463(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.basic_auth_password !== undefined) {
      if (!validate23(data.basic_auth_password, {
        instancePath: instancePath + "/basic_auth_password",
        parentData: data,
        parentDataProperty: "basic_auth_password",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.basic_auth_username !== undefined) {
      if (!validate23(data.basic_auth_username, {
        instancePath: instancePath + "/basic_auth_username",
        parentData: data,
        parentDataProperty: "basic_auth_username",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.interval_seconds !== undefined) {
      if (!validate21(data.interval_seconds, {
        instancePath: instancePath + "/interval_seconds",
        parentData: data,
        parentDataProperty: "interval_seconds",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate473(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.disable_sanitize_html !== undefined) {
      if (!validate22(data.disable_sanitize_html, {
        instancePath: instancePath + "/disable_sanitize_html",
        parentData: data,
        parentDataProperty: "disable_sanitize_html",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate476(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.temp_data_lifetime !== undefined) {
      if (!validate23(data.temp_data_lifetime, {
        instancePath: instancePath + "/temp_data_lifetime",
        parentData: data,
        parentDataProperty: "temp_data_lifetime",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate479(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.plugin_admin_enabled === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "plugin_admin_enabled"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.allow_loading_unsigned_plugins !== undefined) {
      if (!validate23(data.allow_loading_unsigned_plugins, {
        instancePath: instancePath + "/allow_loading_unsigned_plugins",
        parentData: data,
        parentDataProperty: "allow_loading_unsigned_plugins",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.enable_alpha !== undefined) {
      if (!validate22(data.enable_alpha, {
        instancePath: instancePath + "/enable_alpha",
        parentData: data,
        parentDataProperty: "enable_alpha",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.plugin_admin_enabled !== undefined) {
      if (!validate22(data.plugin_admin_enabled, {
        instancePath: instancePath + "/plugin_admin_enabled",
        parentData: data,
        parentDataProperty: "plugin_admin_enabled",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.plugin_catalog_hidden_plugins !== undefined) {
      if (!validate23(data.plugin_catalog_hidden_plugins, {
        instancePath: instancePath + "/plugin_catalog_hidden_plugins",
        parentData: data,
        parentDataProperty: "plugin_catalog_hidden_plugins",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.plugin_catalog_url !== undefined) {
      if (!validate23(data.plugin_catalog_url, {
        instancePath: instancePath + "/plugin_catalog_url",
        parentData: data,
        parentDataProperty: "plugin_catalog_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate486(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.connstr !== undefined) {
      if (!validate23(data.connstr, {
        instancePath: instancePath + "/connstr",
        parentData: data,
        parentDataProperty: "connstr",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate490(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.callback_url !== undefined) {
      if (!validate23(data.callback_url, {
        instancePath: instancePath + "/callback_url",
        parentData: data,
        parentDataProperty: "callback_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.concurrent_render_request_limit !== undefined) {
      if (!validate21(data.concurrent_render_request_limit, {
        instancePath: instancePath + "/concurrent_render_request_limit",
        parentData: data,
        parentDataProperty: "concurrent_render_request_limit",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.server_url !== undefined) {
      if (!validate23(data.server_url, {
        instancePath: instancePath + "/server_url",
        parentData: data,
        parentDataProperty: "server_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate495(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.admin_password !== undefined) {
      if (!validate23(data.admin_password, {
        instancePath: instancePath + "/admin_password",
        parentData: data,
        parentDataProperty: "admin_password",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.admin_user !== undefined) {
      if (!validate23(data.admin_user, {
        instancePath: instancePath + "/admin_user",
        parentData: data,
        parentDataProperty: "admin_user",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.allow_embedding !== undefined) {
      if (!validate22(data.allow_embedding, {
        instancePath: instancePath + "/allow_embedding",
        parentData: data,
        parentDataProperty: "allow_embedding",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.cookie_samesite !== undefined) {
      if (!validate23(data.cookie_samesite, {
        instancePath: instancePath + "/cookie_samesite",
        parentData: data,
        parentDataProperty: "cookie_samesite",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.cookie_secure !== undefined) {
      if (!validate22(data.cookie_secure, {
        instancePath: instancePath + "/cookie_secure",
        parentData: data,
        parentDataProperty: "cookie_secure",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.data_source_proxy_whitelist !== undefined) {
      if (!validate23(data.data_source_proxy_whitelist, {
        instancePath: instancePath + "/data_source_proxy_whitelist",
        parentData: data,
        parentDataProperty: "data_source_proxy_whitelist",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.disable_gravatar !== undefined) {
      if (!validate22(data.disable_gravatar, {
        instancePath: instancePath + "/disable_gravatar",
        parentData: data,
        parentDataProperty: "disable_gravatar",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.login_remember_days !== undefined) {
      if (!validate21(data.login_remember_days, {
        instancePath: instancePath + "/login_remember_days",
        parentData: data,
        parentDataProperty: "login_remember_days",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.strict_transport_security !== undefined) {
      if (!validate22(data.strict_transport_security, {
        instancePath: instancePath + "/strict_transport_security",
        parentData: data,
        parentDataProperty: "strict_transport_security",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.strict_transport_security_max_age_seconds !== undefined) {
      if (!validate21(data.strict_transport_security_max_age_seconds, {
        instancePath: instancePath + "/strict_transport_security_max_age_seconds",
        parentData: data,
        parentDataProperty: "strict_transport_security_max_age_seconds",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.strict_transport_security_preload !== undefined) {
      if (!validate22(data.strict_transport_security_preload, {
        instancePath: instancePath + "/strict_transport_security_preload",
        parentData: data,
        parentDataProperty: "strict_transport_security_preload",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.strict_transport_security_subdomains !== undefined) {
      if (!validate22(data.strict_transport_security_subdomains, {
        instancePath: instancePath + "/strict_transport_security_subdomains",
        parentData: data,
        parentDataProperty: "strict_transport_security_subdomains",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.x_content_type_options !== undefined) {
      if (!validate22(data.x_content_type_options, {
        instancePath: instancePath + "/x_content_type_options",
        parentData: data,
        parentDataProperty: "x_content_type_options",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.x_xss_protection !== undefined) {
      if (!validate22(data.x_xss_protection, {
        instancePath: instancePath + "/x_xss_protection",
        parentData: data,
        parentDataProperty: "x_xss_protection",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate512(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.cert_file !== undefined) {
      if (!validate23(data.cert_file, {
        instancePath: instancePath + "/cert_file",
        parentData: data,
        parentDataProperty: "cert_file",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.cert_key !== undefined) {
      if (!validate23(data.cert_key, {
        instancePath: instancePath + "/cert_key",
        parentData: data,
        parentDataProperty: "cert_key",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.enable_gzip !== undefined) {
      if (!validate22(data.enable_gzip, {
        instancePath: instancePath + "/enable_gzip",
        parentData: data,
        parentDataProperty: "enable_gzip",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.enforce_domain !== undefined) {
      if (!validate22(data.enforce_domain, {
        instancePath: instancePath + "/enforce_domain",
        parentData: data,
        parentDataProperty: "enforce_domain",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.http_addr !== undefined) {
      if (!validate23(data.http_addr, {
        instancePath: instancePath + "/http_addr",
        parentData: data,
        parentDataProperty: "http_addr",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.http_port !== undefined) {
      if (!validate23(data.http_port, {
        instancePath: instancePath + "/http_port",
        parentData: data,
        parentDataProperty: "http_port",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.root_url !== undefined) {
      if (!validate23(data.root_url, {
        instancePath: instancePath + "/root_url",
        parentData: data,
        parentDataProperty: "root_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.router_logging !== undefined) {
      if (!validate22(data.router_logging, {
        instancePath: instancePath + "/router_logging",
        parentData: data,
        parentDataProperty: "router_logging",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.serve_from_sub_path !== undefined) {
      if (!validate22(data.serve_from_sub_path, {
        instancePath: instancePath + "/serve_from_sub_path",
        parentData: data,
        parentDataProperty: "serve_from_sub_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.static_root_path !== undefined) {
      if (!validate23(data.static_root_path, {
        instancePath: instancePath + "/static_root_path",
        parentData: data,
        parentDataProperty: "static_root_path",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate528(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ehlo_identity !== undefined) {
      if (!validate23(data.ehlo_identity, {
        instancePath: instancePath + "/ehlo_identity",
        parentData: data,
        parentDataProperty: "ehlo_identity",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.from_address !== undefined) {
      if (!validate23(data.from_address, {
        instancePath: instancePath + "/from_address",
        parentData: data,
        parentDataProperty: "from_address",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.from_name !== undefined) {
      if (!validate23(data.from_name, {
        instancePath: instancePath + "/from_name",
        parentData: data,
        parentDataProperty: "from_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.skip_verify !== undefined) {
      if (!validate22(data.skip_verify, {
        instancePath: instancePath + "/skip_verify",
        parentData: data,
        parentDataProperty: "skip_verify",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate540(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.external_enabled !== undefined) {
      if (!validate22(data.external_enabled, {
        instancePath: instancePath + "/external_enabled",
        parentData: data,
        parentDataProperty: "external_enabled",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.external_snapshot_name !== undefined) {
      if (!validate23(data.external_snapshot_name, {
        instancePath: instancePath + "/external_snapshot_name",
        parentData: data,
        parentDataProperty: "external_snapshot_name",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.external_snapshot_url !== undefined) {
      if (!validate23(data.external_snapshot_url, {
        instancePath: instancePath + "/external_snapshot_url",
        parentData: data,
        parentDataProperty: "external_snapshot_url",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.snapshot_remove_expired !== undefined) {
      if (!validate22(data.snapshot_remove_expired, {
        instancePath: instancePath + "/snapshot_remove_expired",
        parentData: data,
        parentDataProperty: "snapshot_remove_expired",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate546(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.evaluation_timeout !== undefined) {
      if (!validate23(data.evaluation_timeout, {
        instancePath: instancePath + "/evaluation_timeout",
        parentData: data,
        parentDataProperty: "evaluation_timeout",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.min_interval !== undefined) {
      if (!validate23(data.min_interval, {
        instancePath: instancePath + "/min_interval",
        parentData: data,
        parentDataProperty: "min_interval",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate553(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allow_org_create !== undefined) {
      if (!validate22(data.allow_org_create, {
        instancePath: instancePath + "/allow_org_create",
        parentData: data,
        parentDataProperty: "allow_org_create",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.auto_assign_org !== undefined) {
      if (!validate22(data.auto_assign_org, {
        instancePath: instancePath + "/auto_assign_org",
        parentData: data,
        parentDataProperty: "auto_assign_org",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.auto_assign_org_id !== undefined) {
      if (!validate23(data.auto_assign_org_id, {
        instancePath: instancePath + "/auto_assign_org_id",
        parentData: data,
        parentDataProperty: "auto_assign_org_id",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.auto_assign_org_role !== undefined) {
      if (!validate23(data.auto_assign_org_role, {
        instancePath: instancePath + "/auto_assign_org_role",
        parentData: data,
        parentDataProperty: "auto_assign_org_role",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.default_theme !== undefined) {
      if (!validate23(data.default_theme, {
        instancePath: instancePath + "/default_theme",
        parentData: data,
        parentDataProperty: "default_theme",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.editors_can_admin !== undefined) {
      if (!validate22(data.editors_can_admin, {
        instancePath: instancePath + "/editors_can_admin",
        parentData: data,
        parentDataProperty: "editors_can_admin",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.login_hint !== undefined) {
      if (!validate23(data.login_hint, {
        instancePath: instancePath + "/login_hint",
        parentData: data,
        parentDataProperty: "login_hint",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.password_hint !== undefined) {
      if (!validate23(data.password_hint, {
        instancePath: instancePath + "/password_hint",
        parentData: data,
        parentDataProperty: "password_hint",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.viewers_can_edit !== undefined) {
      if (!validate22(data.viewers_can_edit, {
        instancePath: instancePath + "/viewers_can_edit",
        parentData: data,
        parentDataProperty: "viewers_can_edit",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate229(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.analytics !== undefined) {
      if (!validate240(data.analytics, {
        instancePath: instancePath + "/analytics",
        parentData: data,
        parentDataProperty: "analytics",
        rootData
      })) {
    ...
    if (data["auth.anonymous"] !== undefined) {
      if (!validate258(data["auth.anonymous"], {
        instancePath: instancePath + "/auth.anonymous",
        parentData: data,
        parentDataProperty: "auth.anonymous",
        rootData
      })) {
    ...
    if (data["auth.azuread"] !== undefined) {
      if (!validate263(data["auth.azuread"], {
        instancePath: instancePath + "/auth.azuread",
        parentData: data,
        parentDataProperty: "auth.azuread",
        rootData
      })) {
    ...
    if (data["auth.basic"] !== undefined) {
      if (!validate274(data["auth.basic"], {
        instancePath: instancePath + "/auth.basic",
        parentData: data,
        parentDataProperty: "auth.basic",
        rootData
      })) {
    ...
    if (data["auth.generic_oauth"] !== undefined) {
      if (!validate277(data["auth.generic_oauth"], {
        instancePath: instancePath + "/auth.generic_oauth",
        parentData: data,
        parentDataProperty: "auth.generic_oauth",
        rootData
      })) {
    ...
    if (data["auth.github"] !== undefined) {
      if (!validate298(data["auth.github"], {
        instancePath: instancePath + "/auth.github",
        parentData: data,
        parentDataProperty: "auth.github",
        rootData
      })) {
    ...
    if (data["auth.gitlab"] !== undefined) {
      if (!validate310(data["auth.gitlab"], {
        instancePath: instancePath + "/auth.gitlab",
        parentData: data,
        parentDataProperty: "auth.gitlab",
        rootData
      })) {
    ...
    if (data["auth.google"] !== undefined) {
      if (!validate321(data["auth.google"], {
        instancePath: instancePath + "/auth.google",
        parentData: data,
        parentDataProperty: "auth.google",
        rootData
      })) {
    ...
    if (data["auth.ldap"] !== undefined) {
      if (!validate331(data["auth.ldap"], {
        instancePath: instancePath + "/auth.ldap",
        parentData: data,
        parentDataProperty: "auth.ldap",
        rootData
      })) {
    ...
    if (data["auth.okta"] !== undefined) {
      if (!validate336(data["auth.okta"], {
        instancePath: instancePath + "/auth.okta",
        parentData: data,
        parentDataProperty: "auth.okta",
        rootData
      })) {
    ...
    if (data["auth.proxy"] !== undefined) {
      if (!validate351(data["auth.proxy"], {
        instancePath: instancePath + "/auth.proxy",
        parentData: data,
        parentDataProperty: "auth.proxy",
        rootData
      })) {
    ...
    if (data["auth.saml"] !== undefined) {
      if (!validate361(data["auth.saml"], {
        instancePath: instancePath + "/auth.saml",
        parentData: data,
        parentDataProperty: "auth.saml",
        rootData
      })) {
    ...
    if (data.dashboards !== undefined) {
      if (!validate384(data.dashboards, {
        instancePath: instancePath + "/dashboards",
        parentData: data,
        parentDataProperty: "dashboards",
        rootData
      })) {
    ...
    if (data.dataproxy !== undefined) {
      if (!validate407(data.dataproxy, {
        instancePath: instancePath + "/dataproxy",
        parentData: data,
        parentDataProperty: "dataproxy",
        rootData
      })) {
    ...
    if (data.external_image_storage !== undefined) {
      if (!validate412(data.external_image_storage, {
        instancePath: instancePath + "/external_image_storage",
        parentData: data,
        parentDataProperty: "external_image_storage",
        rootData
      })) {
    ...
    if (data["external_image_storage.azure_blob"] !== undefined) {
      if (!validate415(data["external_image_storage.azure_blob"], {
        instancePath: instancePath + "/external_image_storage.azure_blob",
        parentData: data,
        parentDataProperty: "external_image_storage.azure_blob",
        rootData
      })) {
    ...
    if (data["external_image_storage.gcs"] !== undefined) {
      if (!validate420(data["external_image_storage.gcs"], {
        instancePath: instancePath + "/external_image_storage.gcs",
        parentData: data,
        parentDataProperty: "external_image_storage.gcs",
        rootData
      })) {
    ...
    if (data["external_image_storage.s3"] !== undefined) {
      if (!validate425(data["external_image_storage.s3"], {
        instancePath: instancePath + "/external_image_storage.s3",
        parentData: data,
        parentDataProperty: "external_image_storage.s3",
        rootData
      })) {
    ...
    if (data["external_image_storage.webdav"] !== undefined) {
      if (!validate433(data["external_image_storage.webdav"], {
        instancePath: instancePath + "/external_image_storage.webdav",
        parentData: data,
        parentDataProperty: "external_image_storage.webdav",
        rootData
      })) {
    ...
    if (data.feature_toggles !== undefined) {
      if (!validate439(data.feature_toggles, {
        instancePath: instancePath + "/feature_toggles",
        parentData: data,
        parentDataProperty: "feature_toggles",
        rootData
      })) {
    ...
    if (data.live !== undefined) {
      if (!validate442(data.live, {
        instancePath: instancePath + "/live",
        parentData: data,
        parentDataProperty: "live",
        rootData
      })) {
    ...
    if (data["log.console"] !== undefined) {
      if (!validate451(data["log.console"], {
        instancePath: instancePath + "/log.console",
        parentData: data,
        parentDataProperty: "log.console",
        rootData
      })) {
    ...
    if (data["log.frontend"] !== undefined) {
      if (!validate455(data["log.frontend"], {
        instancePath: instancePath + "/log.frontend",
        parentData: data,
        parentDataProperty: "log.frontend",
        rootData
      })) {
    ...
    if (data["metrics.graphite"] !== undefined) {
      if (!validate469(data["metrics.graphite"], {
        instancePath: instancePath + "/metrics.graphite",
        parentData: data,
        parentDataProperty: "metrics.graphite",
        rootData
      })) {
    ...
    if (data.panels !== undefined) {
      if (!validate473(data.panels, {
        instancePath: instancePath + "/panels",
        parentData: data,
        parentDataProperty: "panels",
        rootData
      })) {
    ...
    if (data.remote_cache !== undefined) {
      if (!validate486(data.remote_cache, {
        instancePath: instancePath + "/remote_cache",
        parentData: data,
        parentDataProperty: "remote_cache",
        rootData
      })) {
    ...
    if (data.rendering !== undefined) {
      if (!validate490(data.rendering, {
        instancePath: instancePath + "/rendering",
        parentData: data,
        parentDataProperty: "rendering",
        rootData
      })) {
    ...
    if (data.security !== undefined) {
      if (!validate495(data.security, {
        instancePath: instancePath + "/security",
        parentData: data,
        parentDataProperty: "security",
        rootData
      })) {
    ...
    if (data.smtp !== undefined) {
      if (!validate528(data.smtp, {
        instancePath: instancePath + "/smtp",
        parentData: data,
        parentDataProperty: "smtp",
        rootData
      })) {
    ...
    if (data.unified_alerting !== undefined) {
      if (!validate546(data.unified_alerting, {
        instancePath: instancePath + "/unified_alerting",
        parentData: data,
        parentDataProperty: "unified_alerting",
        rootData
      })) {
...
function validate147(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.containerName !== undefined) {
      if (!validate23(data.containerName, {
...
function validate141(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.resourceFieldRef !== undefined) {
      if (!validate147(data.resourceFieldRef, {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.failureThreshold !== undefined) {
      if (!validate58(data.failureThreshold, {
    ...
    if (data.initialDelaySeconds !== undefined) {
      if (!validate58(data.initialDelaySeconds, {
    ...
    if (data.periodSeconds !== undefined) {
      if (!validate58(data.periodSeconds, {
    ...
    if (data.successThreshold !== undefined) {
      if (!validate58(data.successThreshold, {
    ...
    if (data.timeoutSeconds !== undefined) {
      if (!validate58(data.timeoutSeconds, {
...
function validate582(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.containerPort !== undefined) {
      if (!validate59(data.containerPort, {
...
function validate127(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.localhostProfile !== undefined) {
      if (!validate23(data.localhostProfile, {
...
function validate131(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.gmsaCredentialSpec !== undefined) {
      if (!validate23(data.gmsaCredentialSpec, {
    ...
    if (data.gmsaCredentialSpecName !== undefined) {
      if (!validate23(data.gmsaCredentialSpecName, {
    ...
    if (data.hostProcess !== undefined) {
      if (!validate22(data.hostProcess, {
    ...
    if (data.runAsUserName !== undefined) {
      if (!validate23(data.runAsUserName, {
...
function validate109(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowPrivilegeEscalation !== undefined) {
      if (!validate22(data.allowPrivilegeEscalation, {
    ...
    if (data.capabilities !== undefined) {
      if (!validate111(data.capabilities, {
    ...
    if (data.readOnlyRootFilesystem !== undefined) {
      if (!validate22(data.readOnlyRootFilesystem, {
    ...
    if (data.runAsNonRoot !== undefined) {
      if (!validate22(data.runAsNonRoot, {
    ...
    if (data.windowsOptions !== undefined) {
      if (!validate131(data.windowsOptions, {
...
function validate162(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.mountPropagation !== undefined) {
      if (!validate23(data.mountPropagation, {
    ...
    if (data.subPathExpr !== undefined) {
      if (!validate23(data.subPathExpr, {
...
function validate568(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imagePullPolicy !== undefined) {
      if (!validate23(data.imagePullPolicy, {
    ...
    if (data.livenessProbe !== undefined) {
      if (!validate60(data.livenessProbe, {
    ...
    if (data.readinessProbe !== undefined) {
      if (!validate60(data.readinessProbe, {
    ...
    if (data.securityContext !== undefined) {
      if (!validate109(data.securityContext, {
    ...
    if (data.startupProbe !== undefined) {
      if (!validate60(data.startupProbe, {
    ...
    if (data.terminationMessagePath !== undefined) {
      if (!validate23(data.terminationMessagePath, {
    ...
    if (data.terminationMessagePolicy !== undefined) {
      if (!validate23(data.terminationMessagePolicy, {
    ...
    if (data.volumeDevices !== undefined) {
      if (!validate599(data.volumeDevices, {
    ...
    if (data.volumeMounts !== undefined) {
      if (!validate161(data.volumeMounts, {
...
function validate611(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate80(data.matchExpressions, {
...
function validate617(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.annotations !== undefined) {
      if (!validate86(data.annotations, {
...
const schema126 = {
  "properties": {
    ...
    "httpProxy": {
      "$ref": "JzJ58T5XT3Ja7q0I5Xx1fQZBG2iIjpNQmAzwAQHQas"
    },
    "labels": {
      "$ref": "C53Ns4GLXWl74ijREqYSmV6XcmHYHGe7sMKYak37s"
    },
...
function validate88(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.matchFields !== undefined) {
      if (!validate80(data.matchFields, {
...
function validate634(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelectorTerms !== undefined) {
      if (!validate635(data.nodeSelectorTerms, {
...
function validate627(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate628(data.preferredDuringSchedulingIgnoredDuringExecution, {
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate634(data.requiredDuringSchedulingIgnoredDuringExecution, {
...
function validate94(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.labelSelector !== undefined) {
      if (!validate91(data.labelSelector, {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate91(data.namespaceSelector, {
...
function validate101(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podAffinityTerm !== undefined) {
      if (!validate94(data.podAffinityTerm, {
...
function validate99(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate100(data.preferredDuringSchedulingIgnoredDuringExecution, {
        instancePath: instancePath + "/preferredDuringSchedulingIgnoredDuringExecution",
        parentData: data,
        parentDataProperty: "preferredDuringSchedulingIgnoredDuringExecution",
        rootData
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate106(data.requiredDuringSchedulingIgnoredDuringExecution, {
        instancePath: instancePath + "/requiredDuringSchedulingIgnoredDuringExecution",
        parentData: data,
        parentDataProperty: "requiredDuringSchedulingIgnoredDuringExecution",
        rootData
...
function validate626(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nodeAffinity !== undefined) {
      if (!validate627(data.nodeAffinity, {
    ...
    if (data.podAffinity !== undefined) {
      if (!validate99(data.podAffinity, {
    ...
    if (data.podAntiAffinity !== undefined) {
      if (!validate99(data.podAntiAffinity, {
...
function validate656(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cachingMode !== undefined) {
      if (!validate23(data.cachingMode, {
...
function validate683(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.defaultMode !== undefined) {
      if (!validate58(data.defaultMode, {
...
function validate689(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodePublishSecretRef !== undefined) {
      if (!validate170(data.nodePublishSecretRef, {
    ...
    if (data.volumeAttributes !== undefined) {
      if (!validate86(data.volumeAttributes, {
...
function validate708(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataSource !== undefined) {
      if (!validate172(data.dataSource, {
    ...
    if (data.dataSourceRef !== undefined) {
      if (!validate172(data.dataSourceRef, {
    ...
    if (data.storageClassName !== undefined) {
      if (!validate23(data.storageClassName, {
...
function validate704(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.volumeClaimTemplate !== undefined) {
      if (!validate705(data.volumeClaimTemplate, {
...
function validate734(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.datasetName !== undefined) {
      if (!validate23(data.datasetName, {
    ...
    if (data.datasetUUID !== undefined) {
      if (!validate23(data.datasetUUID, {
...
function validate758(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.chapAuthDiscovery !== undefined) {
      if (!validate22(data.chapAuthDiscovery, {
    ...
    if (data.chapAuthSession !== undefined) {
      if (!validate22(data.chapAuthSession, {
    ...
    if (data.initiatorName !== undefined) {
      if (!validate23(data.initiatorName, {
    ...
    if (data.iscsiInterface !== undefined) {
      if (!validate23(data.iscsiInterface, {
...
function validate793(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate795(data.downwardAPI, {
    ...
    if (data.serviceAccountToken !== undefined) {
      if (!validate799(data.serviceAccountToken, {
...
function validate825(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.protectionDomain !== undefined) {
      if (!validate23(data.protectionDomain, {
    ...
    if (data.storageMode !== undefined) {
      if (!validate23(data.storageMode, {
    ...
    if (data.storagePool !== undefined) {
      if (!validate23(data.storagePool, {
...
function validate843(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.volumeNamespace !== undefined) {
      if (!validate23(data.volumeNamespace, {
...
function validate850(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.storagePolicyID !== undefined) {
      if (!validate23(data.storagePolicyID, {
    ...
    if (data.storagePolicyName !== undefined) {
      if (!validate23(data.storagePolicyName, {
...
function validate649(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.awsElasticBlockStore !== undefined) {
      if (!validate650(data.awsElasticBlockStore, {
    ...
    if (data.downwardAPI !== undefined) {
      if (!validate696(data.downwardAPI, {
        instancePath: instancePath + "/downwardAPI",
        parentData: data,
        parentDataProperty: "downwardAPI",
        rootData
    ...
    if (data.flexVolume !== undefined) {
      if (!validate727(data.flexVolume, {
    ...
    if (data.gcePersistentDisk !== undefined) {
      if (!validate738(data.gcePersistentDisk, {
    ...
    if (data.persistentVolumeClaim !== undefined) {
      if (!validate777(data.persistentVolumeClaim, {
    ...
    if (data.photonPersistentDisk !== undefined) {
      if (!validate781(data.photonPersistentDisk, {
    ...
    if (data.portworxVolume !== undefined) {
      if (!validate785(data.portworxVolume, {
    ...
    if (data.rbd !== undefined) {
      if (!validate815(data.rbd, {
        instancePath: instancePath + "/rbd",
        parentData: data,
        parentDataProperty: "rbd",
        rootData
      })) {
        vErrors = vErrors === null ? validate815.errors : vErrors.concat(validate815.errors);
        errors = vErrors.length;
      }
    }
    if (data.scaleIO !== undefined) {
      if (!validate825(data.scaleIO, {
        instancePath: instancePath + "/scaleIO",
        parentData: data,
        parentDataProperty: "scaleIO",
        rootData
      })) {
        vErrors = vErrors === null ? validate825.errors : vErrors.concat(validate825.errors);
        errors = vErrors.length;
      }
    }
    if (data.secret !== undefined) {
      if (!validate837(data.secret, {
        instancePath: instancePath + "/secret",
        parentData: data,
        parentDataProperty: "secret",
        rootData
    ...
    if (data.storageos !== undefined) {
      if (!validate843(data.storageos, {
        instancePath: instancePath + "/storageos",
        parentData: data,
        parentDataProperty: "storageos",
        rootData
      })) {
        vErrors = vErrors === null ? validate843.errors : vErrors.concat(validate843.errors);
        errors = vErrors.length;
      }
    }
    if (data.vsphereVolume !== undefined) {
      if (!validate850(data.vsphereVolume, {
        instancePath: instancePath + "/vsphereVolume",
        parentData: data,
        parentDataProperty: "vsphereVolume",
        rootData
      })) {
        vErrors = vErrors === null ? validate850.errors : vErrors.concat(validate850.errors);
        errors = vErrors.length;
      }
    }
  } else {
...
function validate859(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.noProxy !== undefined) {
      if (!validate23(data.noProxy, {
        instancePath: instancePath + "/noProxy",
        parentData: data,
        parentDataProperty: "noProxy",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.secureUrl !== undefined) {
      if (!validate23(data.secureUrl, {
        instancePath: instancePath + "/secureUrl",
        parentData: data,
        parentDataProperty: "secureUrl",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate870(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.fsGroupChangePolicy !== undefined) {
      if (!validate23(data.fsGroupChangePolicy, {
    ...
    if (data.supplementalGroups !== undefined) {
      if (!validate878(data.supplementalGroups, {
...
function validate886(data, {
  ...
  validate886.errors = vErrors;
  return errors === 0;
}
function validate885(data, {
  instancePath = "",
  parentData,
  parentDataProperty,
  rootData = data
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.rollingUpdate !== undefined) {
      if (!validate886(data.rollingUpdate, {
        instancePath: instancePath + "/rollingUpdate",
        parentData: data,
        parentDataProperty: "rollingUpdate",
        rootData
      })) {
        vErrors = vErrors === null ? validate886.errors : vErrors.concat(validate886.errors);
        errors = vErrors.length;
      }
    }
    if (data.type !== undefined) {
...
function validate893(data, {
  ...
  if (Array.isArray(data)) {
    const len0 = data.length;
    for (let i0 = 0; i0 < len0; i0++) {
      if (!validate894(data[i0], {
        instancePath: instancePath + "/" + i0,
        parentData: data,
        parentDataProperty: i0,
        rootData
      })) {
        vErrors = vErrors === null ? validate894.errors : vErrors.concat(validate894.errors);
        errors = vErrors.length;
      }
    }
  }
  validate893.errors = vErrors;
  return errors === 0;
}
const schema179 = {
  "items": {
...
function validate903(data, {
  ...
  validate903.errors = vErrors;
  return errors === 0;
}
function validate902(data, {
  instancePath = "",
  parentData,
  parentDataProperty,
  rootData = data
  ...
  if (Array.isArray(data)) {
    const len0 = data.length;
    for (let i0 = 0; i0 < len0; i0++) {
      if (!validate903(data[i0], {
        instancePath: instancePath + "/" + i0,
        parentData: data,
        parentDataProperty: i0,
        rootData
      })) {
        vErrors = vErrors === null ? validate903.errors : vErrors.concat(validate903.errors);
        errors = vErrors.length;
      }
    }
  }
...
function validate625(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.containerSecurityContext !== undefined) {
      if (!validate109(data.containerSecurityContext, {
    ...
    if (data.extraVolumeMounts !== undefined) {
      if (!validate161(data.extraVolumeMounts, {
        instancePath: instancePath + "/extraVolumeMounts",
        parentData: data,
        parentDataProperty: "extraVolumeMounts",
        rootData
      })) {
        vErrors = vErrors === null ? validate161.errors : vErrors.concat(validate161.errors);
        errors = vErrors.length;
    ...
    if (data.extraVolumes !== undefined) {
      if (!validate648(data.extraVolumes, {
    ...
    if (data.hostNetwork !== undefined) {
      if (!validate22(data.hostNetwork, {
    ...
    if (data.httpProxy !== undefined) {
      if (!validate859(data.httpProxy, {
        instancePath: instancePath + "/httpProxy",
        parentData: data,
        parentDataProperty: "httpProxy",
        rootData
      })) {
        vErrors = vErrors === null ? validate859.errors : vErrors.concat(validate859.errors);
        errors = vErrors.length;
      }
    }
    if (data.labels !== undefined) {
    ...
    if (data.priorityClassName !== undefined) {
      if (!validate23(data.priorityClassName, {
    ...
    if (data.securityContext !== undefined) {
      if (!validate870(data.securityContext, {
        instancePath: instancePath + "/securityContext",
        parentData: data,
        parentDataProperty: "securityContext",
        rootData
      })) {
        vErrors = vErrors === null ? validate870.errors : vErrors.concat(validate870.errors);
        errors = vErrors.length;
      }
    }
    if (data.skipCreateAdminAccount !== undefined) {
      if (!validate22(data.skipCreateAdminAccount, {
        instancePath: instancePath + "/skipCreateAdminAccount",
        parentData: data,
        parentDataProperty: "skipCreateAdminAccount",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.tolerations !== undefined) {
      if (!validate893(data.tolerations, {
        instancePath: instancePath + "/tolerations",
        parentData: data,
        parentDataProperty: "tolerations",
        rootData
      })) {
        vErrors = vErrors === null ? validate893.errors : vErrors.concat(validate893.errors);
        errors = vErrors.length;
      }
    }
    if (data.topologySpreadConstraints !== undefined) {
      if (!validate902(data.topologySpreadConstraints, {
        instancePath: instancePath + "/topologySpreadConstraints",
        parentData: data,
        parentDataProperty: "topologySpreadConstraints",
        rootData
      })) {
        vErrors = vErrors === null ? validate902.errors : vErrors.concat(validate902.errors);
        errors = vErrors.length;
      }
    }
  }
...
function validate912(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ingressClassName !== undefined) {
      if (!validate23(data.ingressClassName, {
    ...
    if (data.termination !== undefined) {
      if (!validate23(data.termination, {
    ...
    if (data.tlsEnabled !== undefined) {
      if (!validate22(data.tlsEnabled, {
        instancePath: instancePath + "/tlsEnabled",
        parentData: data,
        parentDataProperty: "tlsEnabled",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.tlsSecretName !== undefined) {
      if (!validate23(data.tlsSecretName, {
        instancePath: instancePath + "/tlsSecretName",
        parentData: data,
        parentDataProperty: "tlsSecretName",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate927(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.libraryLabelSelector !== undefined) {
      if (!validate91(data.libraryLabelSelector, {
        instancePath: instancePath + "/libraryLabelSelector",
        parentData: data,
        parentDataProperty: "libraryLabelSelector",
        rootData
      })) {
        vErrors = vErrors === null ? validate91.errors : vErrors.concat(validate91.errors);
        errors = vErrors.length;
...
function validate940(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.appProtocol !== undefined) {
      if (!validate23(data.appProtocol, {
...
function validate939(data, {
  ...
  if (Array.isArray(data)) {
    const len0 = data.length;
    for (let i0 = 0; i0 < len0; i0++) {
      if (!validate940(data[i0], {
        instancePath: instancePath + "/" + i0,
        parentData: data,
        parentDataProperty: i0,
        rootData
      })) {
        vErrors = vErrors === null ? validate940.errors : vErrors.concat(validate940.errors);
        errors = vErrors.length;
      }
    }
  }
...
function validate951(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate953(data.imagePullSecrets, {
        instancePath: instancePath + "/imagePullSecrets",
        parentData: data,
        parentDataProperty: "imagePullSecrets",
        rootData
      })) {
        vErrors = vErrors === null ? validate953.errors : vErrors.concat(validate953.errors);
        errors = vErrors.length;
      }
    }
    if (data.labels !== undefined) {
...
function validate223(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.containers !== undefined) {
      if (!validate567(data.containers, {
    ...
    if (data.dashboardContentCacheDuration !== undefined) {
      if (!validate23(data.dashboardContentCacheDuration, {
        instancePath: instancePath + "/dashboardContentCacheDuration",
        parentData: data,
        parentDataProperty: "dashboardContentCacheDuration",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.dashboardLabelSelector !== undefined) {
      if (!validate610(data.dashboardLabelSelector, {
        instancePath: instancePath + "/dashboardLabelSelector",
        parentData: data,
        parentDataProperty: "dashboardLabelSelector",
        rootData
      })) {
    ...
    if (data.dashboardNamespaceSelector !== undefined) {
      if (!validate91(data.dashboardNamespaceSelector, {
        instancePath: instancePath + "/dashboardNamespaceSelector",
        parentData: data,
        parentDataProperty: "dashboardNamespaceSelector",
        rootData
      })) {
        vErrors = vErrors === null ? validate91.errors : vErrors.concat(validate91.errors);
        errors = vErrors.length;
    ...
    if (data.dataStorage !== undefined) {
      if (!validate617(data.dataStorage, {
        instancePath: instancePath + "/dataStorage",
        parentData: data,
        parentDataProperty: "dataStorage",
        rootData
      })) {
    ...
    if (data.deployment !== undefined) {
      if (!validate625(data.deployment, {
        instancePath: instancePath + "/deployment",
        parentData: data,
        parentDataProperty: "deployment",
        rootData
      })) {
    ...
    if (data.initResources !== undefined) {
      if (!validate176(data.initResources, {
        instancePath: instancePath + "/initResources",
        parentData: data,
        parentDataProperty: "initResources",
        rootData
      })) {
        vErrors = vErrors === null ? validate176.errors : vErrors.concat(validate176.errors);
        errors = vErrors.length;
    ...
    if (data.jsonnet !== undefined) {
      if (!validate927(data.jsonnet, {
        instancePath: instancePath + "/jsonnet",
        parentData: data,
        parentDataProperty: "jsonnet",
        rootData
      })) {
        vErrors = vErrors === null ? validate927.errors : vErrors.concat(validate927.errors);
        errors = vErrors.length;
      }
    }
    if (data.livenessProbeSpec !== undefined) {
      if (!validate198(data.livenessProbeSpec, {
        instancePath: instancePath + "/livenessProbeSpec",
        parentData: data,
        parentDataProperty: "livenessProbeSpec",
        rootData
      })) {
    ...
    if (data.readinessProbeSpec !== undefined) {
      if (!validate198(data.readinessProbeSpec, {
        instancePath: instancePath + "/readinessProbeSpec",
        parentData: data,
        parentDataProperty: "readinessProbeSpec",
        rootData
      })) {
        vErrors = vErrors === null ? validate198.errors : vErrors.concat(validate198.errors);
        errors = vErrors.length;
    ...
    if (data.service !== undefined) {
      if (!validate934(data.service, {
        instancePath: instancePath + "/service",
        parentData: data,
        parentDataProperty: "service",
        rootData
      })) {
        vErrors = vErrors === null ? validate934.errors : vErrors.concat(validate934.errors);
        errors = vErrors.length;
      }
    }
    if (data.serviceAccount !== undefined) {
      if (!validate951(data.serviceAccount, {
...
const schema188 = {
  "properties": {
    "dashboards": {
      "$ref": "jqwzVNih4ke9vj47YTqMWtqPp1qanxi5luGn0uORMQ"
    },
    "failedPlugins": {
...
const schema189 = {
  "items": {
    "$ref": "kGBCmpL3jLrvb4E6Fm2aVL4pdxKgC028090Y6tvDdQ"
  },
  "nullable": true,
  "type": "array"
};
const schema190 = {
  ...
  "required": ["folderId", "folderName", "hash", "name", "namespace", "uid"],
  "type": "object"
};
function validate962(data, {
  instancePath = "",
  parentData,
  parentDataProperty,
  rootData = data
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.folderName !== undefined) {
      if (!validate25(data.folderName, {
        instancePath: instancePath + "/folderName",
        parentData: data,
        parentDataProperty: "folderName",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
...
function validate961(data, {
  ...
  if (Array.isArray(data)) {
    const len0 = data.length;
    for (let i0 = 0; i0 < len0; i0++) {
      if (!validate962(data[i0], {
        instancePath: instancePath + "/" + i0,
        parentData: data,
        parentDataProperty: i0,
        rootData
      })) {
        vErrors = vErrors === null ? validate962.errors : vErrors.concat(validate962.errors);
        errors = vErrors.length;
      }
    }
  }
...
function validate960(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.dashboards !== undefined) {
      if (!validate961(data.dashboards, {
        instancePath: instancePath + "/dashboards",
        parentData: data,
        parentDataProperty: "dashboards",
        rootData
    ...
    if (data.failedPlugins !== undefined) {
      if (!validate209(data.failedPlugins, {
        instancePath: instancePath + "/failedPlugins",
        parentData: data,
        parentDataProperty: "failedPlugins",
        rootData
      })) {
    ...
    if (data.installedPlugins !== undefined) {
      if (!validate209(data.installedPlugins, {
        instancePath: instancePath + "/installedPlugins",
        parentData: data,
        parentDataProperty: "installedPlugins",
        rootData
      })) {
        vErrors = vErrors === null ? validate209.errors : vErrors.concat(validate209.errors);
        errors = vErrors.length;
    ...
    if (data.previousServiceName !== undefined) {
      if (!validate23(data.previousServiceName, {
        instancePath: instancePath + "/previousServiceName",
        parentData: data,
        parentDataProperty: "previousServiceName",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate214(data, {
  ...
  /*# sourceURL="integreatly.org.v1alpha1.Grafana" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate215(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
    ...
    if (data.status !== undefined) {
      if (!validate960(data.status, {
        instancePath: instancePath + "/status",
        parentData: data,
        parentDataProperty: "status",
        rootData
      })) {
        vErrors = vErrors === null ? validate960.errors : vErrors.concat(validate960.errors);
        errors = vErrors.length;
      }
    }
  } else {
