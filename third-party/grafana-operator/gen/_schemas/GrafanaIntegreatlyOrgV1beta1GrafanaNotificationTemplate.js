...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "LDtu38mCWj8iY4KGDX4bPbD9pZeA1qCUdyFy62SY9pQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "IZIGPgVU5QhV6ah5Wc3IJthyB9AwNvjlHA61TDORI"
    },
    "status": {
  ...
  "$id": "grafana.integreatly.org.v1beta1.GrafanaNotificationTemplate"
};
const schema8 = {
  "type": "string",
...
const schema9 = {
  "type": "string",
  "enum": ["GrafanaNotificationTemplate"]
};
function validate25(data, {
  ...
  if (!(data === "GrafanaNotificationTemplate")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowCrossNamespaceImport !== undefined) {
      if (!validate32(data.allowCrossNamespaceImport, {
    ...
    if (data.instanceSelector !== undefined) {
      if (!validate36(data.instanceSelector, {
...
function validate22(data, {
  ...
  /*# sourceURL="grafana.integreatly.org.v1beta1.GrafanaNotificationTemplate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
