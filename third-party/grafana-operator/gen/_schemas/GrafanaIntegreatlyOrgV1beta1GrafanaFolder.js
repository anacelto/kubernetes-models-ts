...
const schema8 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "7XdFBEDBB5hzeHinMn5hg0zuE5JazMpiRisNzI"
    },
    "status": {
      "$ref": "7LRDqFwxFVBUEw7vffigddjbaaucSaywlO72F8pY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "grafana.integreatly.org.v1beta1.GrafanaFolder"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowCrossNamespaceImport !== undefined) {
      if (!validate33(data.allowCrossNamespaceImport, {
    ...
    if (data.instanceSelector !== undefined) {
      if (!validate35(data.instanceSelector, {
    ...
    if (data.parentFolderRef !== undefined) {
      if (!validate22(data.parentFolderRef, {
        instancePath: instancePath + "/parentFolderRef",
        parentData: data,
        parentDataProperty: "parentFolderRef",
        rootData
      })) {
    ...
    if (data.parentFolderUID !== undefined) {
      if (!validate22(data.parentFolderUID, {
        instancePath: instancePath + "/parentFolderUID",
        parentData: data,
        parentDataProperty: "parentFolderUID",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.resyncPeriod !== undefined) {
      if (!validate52(data.resyncPeriod, {
...
function validate58(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.NoMatchingInstances !== undefined) {
      if (!validate59(data.NoMatchingInstances, {
...
function validate23(data, {
  ...
  /*# sourceURL="grafana.integreatly.org.v1beta1.GrafanaFolder" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
