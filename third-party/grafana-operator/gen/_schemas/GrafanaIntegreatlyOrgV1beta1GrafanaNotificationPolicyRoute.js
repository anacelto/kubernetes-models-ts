...
const schema11 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "hq7tqfJeXcaVSC4fB0LmuHQoMduhC2X9dk65Vkjk"
    },
    "metadata": {
  ...
  "$id": "grafana.integreatly.org.v1beta1.GrafanaNotificationPolicyRoute"
};
const schema12 = {
  "type": "string",
...
const schema13 = {
  "type": "string",
  "enum": ["GrafanaNotificationPolicyRoute"]
};
function validate31(data, {
  ...
  if (!(data === "GrafanaNotificationPolicyRoute")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.mute_time_intervals !== undefined) {
      if (!validate24(data.mute_time_intervals, {
    ...
    if (data.object_matchers !== undefined) {
      if (!validate53(data.object_matchers, {
    ...
    if (data.routeSelector !== undefined) {
      if (!validate62(data.routeSelector, {
...
function validate77(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate78(data.lastTransitionTime, {
...
function validate28(data, {
  ...
  /*# sourceURL="grafana.integreatly.org.v1beta1.GrafanaNotificationPolicyRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
