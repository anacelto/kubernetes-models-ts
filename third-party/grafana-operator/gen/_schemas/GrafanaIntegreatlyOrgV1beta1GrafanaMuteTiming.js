...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "HO4yZynV4JFxSfekbgS0QouFTa2mtPWCmemNHPRzDM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "2qPukPSE5GAJDixybNKeDR4N7hlCjS7GSFvbCLM4"
    },
    "status": {
  ...
  "$id": "grafana.integreatly.org.v1beta1.GrafanaMuteTiming"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    ...
    "time_intervals": {
      "$ref": "C6vRyvxYG01RrpPH9DTpB7BGDXY2Ds6x72XNbJpDU"
    }
  },
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.days_of_month !== undefined) {
      if (!validate22(data.days_of_month, {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowCrossNamespaceImport !== undefined) {
      if (!validate34(data.allowCrossNamespaceImport, {
    ...
    if (data.instanceSelector !== undefined) {
      if (!validate38(data.instanceSelector, {
    ...
    if (data.time_intervals !== undefined) {
      if (!validate53(data.time_intervals, {
...
function validate24(data, {
  ...
  /*# sourceURL="grafana.integreatly.org.v1beta1.GrafanaMuteTiming" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
