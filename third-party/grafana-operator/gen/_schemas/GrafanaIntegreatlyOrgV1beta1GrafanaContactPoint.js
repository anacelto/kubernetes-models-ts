...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "j8ZnPPacxj4yICitL9u8TB4YL6MfvmNYNS41b8Eyqg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "i06kA8DkeDPW3AlGgQFpbrgggoSz7QDnFs9dOgTER0"
    },
    "status": {
  ...
  "$id": "grafana.integreatly.org.v1beta1.GrafanaContactPoint"
};
const schema11 = {
  "type": "string",
...
const schema15 = {
  ...
  "required": ["instanceSelector", "name", "settings", "type"],
  "type": "object"
};
const schema16 = {
  "default": false,
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate42(data.matchExpressions, {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate51(data.matchLabels, {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowCrossNamespaceImport !== undefined) {
      if (!validate38(data.allowCrossNamespaceImport, {
    ...
    if (data.disableResolveMessage !== undefined) {
      if (!validate22(data.disableResolveMessage, {
        instancePath: instancePath + "/disableResolveMessage",
        parentData: data,
        parentDataProperty: "disableResolveMessage",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.instanceSelector !== undefined) {
      if (!validate41(data.instanceSelector, {
    ...
    if (data.resyncPeriod !== undefined) {
      if (!validate56(data.resyncPeriod, {
...
function validate28(data, {
  ...
  /*# sourceURL="grafana.integreatly.org.v1beta1.GrafanaContactPoint" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
