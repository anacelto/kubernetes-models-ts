...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "4GuU6n5DiOIxMJdBqQz09btCt1nExe7jipbfD3E7Edk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "ar826u9EgPtuEdWXBCPt7YktuTkpcs1A1ru8omUjpgE"
    },
    "status": {
      "$ref": "FBfPSbugNLG7rwr8k5XVRi65FJMvpsArmM0hQqCyBxs"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "integreatly.org.v1alpha1.GrafanaNotificationChannel"
};
const schema8 = {
  "type": "string",
...
const schema9 = {
  "type": "string",
  "enum": ["GrafanaNotificationChannel"]
};
function validate25(data, {
  ...
  if (!(data === "GrafanaNotificationChannel")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  ...
  "required": ["hash", "id", "message", "phase", "uid"],
  "type": "object",
  "nullable": true
};
const schema14 = {
...
function validate22(data, {
  ...
  /*# sourceURL="integreatly.org.v1alpha1.GrafanaNotificationChannel" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
