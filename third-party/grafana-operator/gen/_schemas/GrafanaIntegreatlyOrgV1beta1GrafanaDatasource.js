...
const schema12 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "qImEUZJgXr538AlgrTrtShoEsuPHGwg9JGx3JxWno"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "xcWYHfdf1E82M2aQtOXWfe7SvcRaOQv6fmxhZW0"
    },
    "status": {
      "$ref": "j78ocx02dTc4TxMJ9NgqfGOJ65asiCDgsvj0WLggn4"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "grafana.integreatly.org.v1beta1.GrafanaDatasource"
};
const schema13 = {
  "type": "string",
...
const schema17 = {
  "properties": {
    ...
    "datasource": {
      "$ref": "y5qfP3t35gxKfxqJY0oTRcamOebLN8ZUMV1eK13PM"
    },
    "instanceSelector": {
    ...
    "valuesFrom": {
      "$ref": "AhoIMvV9LOPJoV25iVejhHSXTZWitjEaCeBHbSTAAg"
    }
  },
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.secureJsonData !== undefined) {
      if (!validate23(data.secureJsonData, {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate60(data.matchExpressions, {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate69(data.matchLabels, {
...
const schema30 = {
  "items": {
    "$ref": "lFYTy49uCSWsGc6nkIyucvMz3A2tTS3KVPji7lvsws"
  },
  "maxItems": 99,
  "type": "array",
  "nullable": true
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.instanceSelector !== undefined) {
      if (!validate59(data.instanceSelector, {
    ...
    if (data.resyncPeriod !== undefined) {
      if (!validate79(data.resyncPeriod, {
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.NoMatchingInstances !== undefined) {
      if (!validate22(data.NoMatchingInstances, {
    ...
    if (data.lastResync !== undefined) {
      if (!validate113(data.lastResync, {
...
function validate30(data, {
  ...
  /*# sourceURL="grafana.integreatly.org.v1beta1.GrafanaDatasource" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
