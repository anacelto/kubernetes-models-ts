...
import { validate } from "../../_schemas/GrafanaIntegreatlyOrgV1beta1GrafanaNotificationTemplate";
 ...
 * GrafanaNotificationTemplate is the Schema for the GrafanaNotificationTemplate API
 */
export class GrafanaNotificationTemplate extends Model<IGrafanaNotificationTemplate> implements IGrafanaNotificationTemplate {
...
static apiVersion: IGrafanaNotificationTemplate["apiVersion"] = "grafana.integreatly.org/v1beta1";
static kind: IGrafanaNotificationTemplate["kind"] = "GrafanaNotificationTemplate";
static is = createTypeMetaGuard<IGrafanaNotificationTemplate>(GrafanaNotificationTemplate);

constructor(data?: ModelData<IGrafanaNotificationTemplate>) {
  super();

  this.setDefinedProps({
    apiVersion: GrafanaNotificationTemplate.apiVersion,
    kind: GrafanaNotificationTemplate.kind,
    ...data
  } as IGrafanaNotificationTemplate);
}
}


setValidateFunc(GrafanaNotificationTemplate, validate as ValidateFunc<IGrafanaNotificationTemplate>);
