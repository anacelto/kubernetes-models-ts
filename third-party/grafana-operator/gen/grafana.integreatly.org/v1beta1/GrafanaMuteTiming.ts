...
import { validate } from "../../_schemas/GrafanaIntegreatlyOrgV1beta1GrafanaMuteTiming";
 ...
 * GrafanaMuteTiming is the Schema for the GrafanaMuteTiming API
 */
export class GrafanaMuteTiming extends Model<IGrafanaMuteTiming> implements IGrafanaMuteTiming {
...
static apiVersion: IGrafanaMuteTiming["apiVersion"] = "grafana.integreatly.org/v1beta1";
static kind: IGrafanaMuteTiming["kind"] = "GrafanaMuteTiming";
static is = createTypeMetaGuard<IGrafanaMuteTiming>(GrafanaMuteTiming);

constructor(data?: ModelData<IGrafanaMuteTiming>) {
  super();

  this.setDefinedProps({
    apiVersion: GrafanaMuteTiming.apiVersion,
    kind: GrafanaMuteTiming.kind,
    ...data
  } as IGrafanaMuteTiming);
}
}


setValidateFunc(GrafanaMuteTiming, validate as ValidateFunc<IGrafanaMuteTiming>);
