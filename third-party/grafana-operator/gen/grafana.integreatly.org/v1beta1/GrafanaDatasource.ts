...
import { validate } from "../../_schemas/GrafanaIntegreatlyOrgV1beta1GrafanaDatasource";
 ...
 * GrafanaDatasource is the Schema for the grafanadatasources API
 */
export class GrafanaDatasource extends Model<IGrafanaDatasource> implements IGrafanaDatasource {
...
static apiVersion: IGrafanaDatasource["apiVersion"] = "grafana.integreatly.org/v1beta1";
static kind: IGrafanaDatasource["kind"] = "GrafanaDatasource";
static is = createTypeMetaGuard<IGrafanaDatasource>(GrafanaDatasource);

constructor(data?: ModelData<IGrafanaDatasource>) {
  super();

  this.setDefinedProps({
    apiVersion: GrafanaDatasource.apiVersion,
    kind: GrafanaDatasource.kind,
    ...data
  } as IGrafanaDatasource);
}
}


setValidateFunc(GrafanaDatasource, validate as ValidateFunc<IGrafanaDatasource>);
