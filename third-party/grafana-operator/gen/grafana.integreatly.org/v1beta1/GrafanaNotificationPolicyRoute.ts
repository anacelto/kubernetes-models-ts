...
import { validate } from "../../_schemas/GrafanaIntegreatlyOrgV1beta1GrafanaNotificationPolicyRoute";
 ...
 * GrafanaNotificationPolicyRoute is the Schema for the grafananotificationpolicyroutes API
 */
export class GrafanaNotificationPolicyRoute extends Model<IGrafanaNotificationPolicyRoute> implements IGrafanaNotificationPolicyRoute {
...
static apiVersion: IGrafanaNotificationPolicyRoute["apiVersion"] = "grafana.integreatly.org/v1beta1";
static kind: IGrafanaNotificationPolicyRoute["kind"] = "GrafanaNotificationPolicyRoute";
static is = createTypeMetaGuard<IGrafanaNotificationPolicyRoute>(GrafanaNotificationPolicyRoute);

constructor(data?: ModelData<IGrafanaNotificationPolicyRoute>) {
  super();

  this.setDefinedProps({
    apiVersion: GrafanaNotificationPolicyRoute.apiVersion,
    kind: GrafanaNotificationPolicyRoute.kind,
    ...data
  } as IGrafanaNotificationPolicyRoute);
}
}


setValidateFunc(GrafanaNotificationPolicyRoute, validate as ValidateFunc<IGrafanaNotificationPolicyRoute>);
