...
import { validate } from "../../_schemas/GrafanaIntegreatlyOrgV1beta1GrafanaLibraryPanel";

/**
 * GrafanaLibraryPanel is the Schema for the grafanalibrarypanels API
 */
export interface IGrafanaLibraryPanel {
  /**
 ...
 * GrafanaLibraryPanel is the Schema for the grafanalibrarypanels API
 */
export class GrafanaLibraryPanel extends Model<IGrafanaLibraryPanel> implements IGrafanaLibraryPanel {
  "apiVersion": IGrafanaLibraryPanel["apiVersion"];
  "kind": IGrafanaLibraryPanel["kind"];
  "metadata"?: IGrafanaLibraryPanel["metadata"];
  "spec": IGrafanaLibraryPanel["spec"];
  "status"?: IGrafanaLibraryPanel["status"];

static apiVersion: IGrafanaLibraryPanel["apiVersion"] = "grafana.integreatly.org/v1beta1";
static kind: IGrafanaLibraryPanel["kind"] = "GrafanaLibraryPanel";
static is = createTypeMetaGuard<IGrafanaLibraryPanel>(GrafanaLibraryPanel);

constructor(data?: ModelData<IGrafanaLibraryPanel>) {
  super();

  this.setDefinedProps({
    apiVersion: GrafanaLibraryPanel.apiVersion,
    kind: GrafanaLibraryPanel.kind,
    ...data
  } as IGrafanaLibraryPanel);
}
}


setValidateFunc(GrafanaLibraryPanel, validate as ValidateFunc<IGrafanaLibraryPanel>);
