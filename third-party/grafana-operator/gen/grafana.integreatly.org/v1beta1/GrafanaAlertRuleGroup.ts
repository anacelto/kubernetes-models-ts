...
import { validate } from "../../_schemas/GrafanaIntegreatlyOrgV1beta1GrafanaAlertRuleGroup";
 ...
 * GrafanaAlertRuleGroup is the Schema for the grafanaalertrulegroups API
 */
export class GrafanaAlertRuleGroup extends Model<IGrafanaAlertRuleGroup> implements IGrafanaAlertRuleGroup {
...
static apiVersion: IGrafanaAlertRuleGroup["apiVersion"] = "grafana.integreatly.org/v1beta1";
static kind: IGrafanaAlertRuleGroup["kind"] = "GrafanaAlertRuleGroup";
static is = createTypeMetaGuard<IGrafanaAlertRuleGroup>(GrafanaAlertRuleGroup);

constructor(data?: ModelData<IGrafanaAlertRuleGroup>) {
  super();

  this.setDefinedProps({
    apiVersion: GrafanaAlertRuleGroup.apiVersion,
    kind: GrafanaAlertRuleGroup.kind,
    ...data
  } as IGrafanaAlertRuleGroup);
}
}


setValidateFunc(GrafanaAlertRuleGroup, validate as ValidateFunc<IGrafanaAlertRuleGroup>);
