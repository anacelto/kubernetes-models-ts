...
import { validate } from "../../_schemas/PostgresqlCnpgIoV1Pooler";
 ...
 * Pooler is the Schema for the poolers API
 */
export class Pooler extends Model<IPooler> implements IPooler {
  "apiVersion": IPooler["apiVersion"];
  "kind": IPooler["kind"];
  "metadata": IPooler["metadata"];
  "spec": IPooler["spec"];
  "status"?: IPooler["status"];

static apiVersion: IPooler["apiVersion"] = "postgresql.cnpg.io/v1";
static kind: IPooler["kind"] = "Pooler";
static is = createTypeMetaGuard<IPooler>(Pooler);

constructor(data?: ModelData<IPooler>) {
  super();

  this.setDefinedProps({
    apiVersion: Pooler.apiVersion,
    kind: Pooler.kind,
    ...data
  } as IPooler);
}
...
setValidateFunc(Pooler, validate as ValidateFunc<IPooler>);
