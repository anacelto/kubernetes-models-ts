...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "pi6NQIlY4FZqonHUYfx2O0Ff1tBoGjcp3j1hvkRY"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "BLTFmZdeVJGeQMP9u9z2Tn5XAviUcJqVFFxsI4WsSjA"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "postgresql.cnpg.io.v1.ImageCatalog"
};
const schema7 = {
  "type": "string",
...
const schema11 = {
  "properties": {
    "images": {
      "$ref": "eXzQsRm2hEiRvuTwuyQleV8kUoC8S0hVLtYeah1Qqss"
    }
  },
  "required": ["images"],
  "type": "object"
...
const schema12 = {
  "items": {
    "$ref": "WsdtEvD1k5xFX7u7zYyepy03V4JwIFU63QLSRo0cCI"
  },
  "maxItems": 8,
  "minItems": 1,
  "type": "array"
...
const schema13 = {
  "properties": {
    ...
    "major": {
      "$ref": "8LSk3GsKWlJQRvpTya266Iy8GmfmdvsGIPkDQmY"
    }
  },
  "required": ["image", "major"],
  "type": "object"
};
const schema14 = {
  "type": "string"
...
function validate21(data, {
  ...
  /*# sourceURL="postgresql.cnpg.io.v1.ImageCatalog" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
