...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "bUP8ppAXwQ8xaIQLdKOrOpogjVRcPCxSEYK7wqcyces"
    },
    "metadata": {
  ...
  "$id": "postgresql.cnpg.io.v1.ClusterImageCatalog"
};
const schema7 = {
  "type": "string",
...
function validate21(data, {
  ...
  /*# sourceURL="postgresql.cnpg.io.v1.ClusterImageCatalog" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
