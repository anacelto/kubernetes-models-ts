 ...
 * ImageCatalog is the Schema for the imagecatalogs API
 */
export declare class ImageCatalog extends Model<IImageCatalog> implements IImageCatalog {
    "apiVersion": IImageCatalog["apiVersion"];
    "kind": IImageCatalog["kind"];
    "metadata": IImageCatalog["metadata"];
    "spec": IImageCatalog["spec"];
    static apiVersion: IImageCatalog["apiVersion"];
    static kind: IImageCatalog["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IImageCatalog>;
