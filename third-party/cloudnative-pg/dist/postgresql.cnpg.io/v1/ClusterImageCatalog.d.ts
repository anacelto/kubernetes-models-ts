 ...
 * ClusterImageCatalog is the Schema for the clusterimagecatalogs API
 */
export declare class ClusterImageCatalog extends Model<IClusterImageCatalog> implements IClusterImageCatalog {
    ...
    static apiVersion: IClusterImageCatalog["apiVersion"];
    static kind: IClusterImageCatalog["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterImageCatalog>;
