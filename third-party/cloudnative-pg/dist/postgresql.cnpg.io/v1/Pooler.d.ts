 ...
 * Pooler is the Schema for the poolers API
 */
export declare class Pooler extends Model<IPooler> implements IPooler {
    "apiVersion": IPooler["apiVersion"];
    "kind": IPooler["kind"];
    "metadata": IPooler["metadata"];
    "spec": IPooler["spec"];
    "status"?: IPooler["status"];
    static apiVersion: IPooler["apiVersion"];
    static kind: IPooler["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPooler>;
