...
import { validate } from "../../_schemas/FlaggerAppV1beta1Canary";
 ...
 * Canary is the Schema for the Canary API.
 */
export class Canary extends Model<ICanary> implements ICanary {
...
static apiVersion: ICanary["apiVersion"] = "flagger.app/v1beta1";
static kind: ICanary["kind"] = "Canary";
static is = createTypeMetaGuard<ICanary>(Canary);

constructor(data?: ModelData<ICanary>) {
  super();

  this.setDefinedProps({
    apiVersion: Canary.apiVersion,
    kind: Canary.kind,
    ...data
  } as ICanary);
}
...
setValidateFunc(Canary, validate as ValidateFunc<ICanary>);
