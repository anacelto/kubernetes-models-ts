...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "3A7yuGG9gSS73jVeAT0HiKrjZ8Gpoygz1PqqNWhs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AYvl9EQ06NG1glDLXNB1HWhUm45MChUwiYXU67N2yM"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "flagger.app.v1beta1.AlertProvider"
};
const schema8 = {
  "type": "string",
...
const schema12 = {
  "type": "object",
  "oneOf": [{
    "$ref": "G7Errvu13osVIlCHN0AnrR76vxGg5gy9gAolfdRnBs8"
  }, {
    "$ref": "o2SfIThcJrCoJhJCYhUvAIDa2dm4ELdjS6XC7v1a0"
  }],
  "properties": {
    "type": {
      "$ref": "pWN6KtMwhN2IQ1Gp0XSYHxW7fXm8T9fL4HJHZc"
    },
    "channel": {
...
function validate36(data, {
  ...
  if (!(data === "slack" || data === "msteams" || data === "discord" || data === "rocket" || data === "gchat")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="flagger.app.v1beta1.AlertProvider" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
