...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "kHKkduSwsvUx3DRs2WBCIa70mmKwSfVbyN6KkLxI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Npu6FvQnEgYkBiu1gOUGmunFc40SUQLF3myryeEk"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "flagger.app.v1beta1.MetricTemplate"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  ...
  "properties": {
    "provider": {
      "$ref": "9jnJ8NTT480G4WRHw4ztVvehV0H2HAAaow2C5OROko"
    },
    "query": {
...
const schema14 = {
  ...
  "properties": {
    "type": {
      "$ref": "K7YUOYlXfkYwuzf9LSULSMfV3OssGAFG0z2FOyLjKRM"
    },
    "address": {
...
const schema15 = {
  "type": "string",
  "enum": ["prometheus", "influxdb", "datadog", "stackdriver", "cloudwatch", "newrelic", "graphite", "dynatrace"]
};
function validate34(data, {
  ...
  if (!(data === "prometheus" || data === "influxdb" || data === "datadog" || data === "stackdriver" || data === "cloudwatch" || data === "newrelic" || data === "graphite" || data === "dynatrace")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.insecureSkipVerify !== undefined) {
      if (!validate41(data.insecureSkipVerify, {
...
function validate23(data, {
  ...
  /*# sourceURL="flagger.app.v1beta1.MetricTemplate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
