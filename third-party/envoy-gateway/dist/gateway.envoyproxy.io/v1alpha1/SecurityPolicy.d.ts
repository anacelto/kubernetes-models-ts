 ...
 * SecurityPolicy allows the user to configure various security settings for a Gateway.
 */
export declare class SecurityPolicy extends Model<ISecurityPolicy> implements ISecurityPolicy {
    ...
    static apiVersion: ISecurityPolicy["apiVersion"];
    static kind: ISecurityPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISecurityPolicy>;
