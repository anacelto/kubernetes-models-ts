 ...
 * BackendTrafficPolicy allows the user to configure the behavior of the connection between the Envoy Proxy listener and the backend service.
 */
export declare class BackendTrafficPolicy extends Model<IBackendTrafficPolicy> implements IBackendTrafficPolicy {
    ...
    static apiVersion: IBackendTrafficPolicy["apiVersion"];
    static kind: IBackendTrafficPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBackendTrafficPolicy>;
