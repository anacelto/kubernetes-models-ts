 ...
 * ClientTrafficPolicy allows the user to configure the behavior of the connection between the downstream client and Envoy Proxy listener.
 */
export declare class ClientTrafficPolicy extends Model<IClientTrafficPolicy> implements IClientTrafficPolicy {
    ...
    static apiVersion: IClientTrafficPolicy["apiVersion"];
    static kind: IClientTrafficPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClientTrafficPolicy>;
