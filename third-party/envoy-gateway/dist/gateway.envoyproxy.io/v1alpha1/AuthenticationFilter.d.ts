...
export declare class AuthenticationFilter extends Model<IAuthenticationFilter> implements IAuthenticationFilter {
    ...
    static apiVersion: IAuthenticationFilter["apiVersion"];
    static kind: IAuthenticationFilter["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAuthenticationFilter>;
