 ...
 * RateLimitFilter allows the user to limit the number of incoming requests to a predefined value based on attributes within the traffic flow.
 */
export declare class RateLimitFilter extends Model<IRateLimitFilter> implements IRateLimitFilter {
    ...
    static apiVersion: IRateLimitFilter["apiVersion"];
    static kind: IRateLimitFilter["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IRateLimitFilter>;
