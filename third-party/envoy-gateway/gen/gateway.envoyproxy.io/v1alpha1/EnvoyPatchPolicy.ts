...
import { validate } from "../../_schemas/GatewayEnvoyproxyIoV1alpha1EnvoyPatchPolicy";
 ...
 * EnvoyPatchPolicy allows the user to modify the generated Envoy xDS resources by Envoy Gateway using this patch API
 */
export class EnvoyPatchPolicy extends Model<IEnvoyPatchPolicy> implements IEnvoyPatchPolicy {
...
static apiVersion: IEnvoyPatchPolicy["apiVersion"] = "gateway.envoyproxy.io/v1alpha1";
static kind: IEnvoyPatchPolicy["kind"] = "EnvoyPatchPolicy";
static is = createTypeMetaGuard<IEnvoyPatchPolicy>(EnvoyPatchPolicy);

constructor(data?: ModelData<IEnvoyPatchPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: EnvoyPatchPolicy.apiVersion,
    kind: EnvoyPatchPolicy.kind,
    ...data
  } as IEnvoyPatchPolicy);
}
}


setValidateFunc(EnvoyPatchPolicy, validate as ValidateFunc<IEnvoyPatchPolicy>);
