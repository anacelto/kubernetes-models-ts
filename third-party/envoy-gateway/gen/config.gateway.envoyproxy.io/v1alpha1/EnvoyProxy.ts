...
import { validate } from "../../_schemas/ConfigGatewayEnvoyproxyIoV1alpha1EnvoyProxy";
 ...
 * EnvoyProxy is the schema for the envoyproxies API.
 */
export class EnvoyProxy extends Model<IEnvoyProxy> implements IEnvoyProxy {
...
static apiVersion: IEnvoyProxy["apiVersion"] = "config.gateway.envoyproxy.io/v1alpha1";
static kind: IEnvoyProxy["kind"] = "EnvoyProxy";
static is = createTypeMetaGuard<IEnvoyProxy>(EnvoyProxy);

constructor(data?: ModelData<IEnvoyProxy>) {
  super();

  this.setDefinedProps({
    apiVersion: EnvoyProxy.apiVersion,
...
setValidateFunc(EnvoyProxy, validate as ValidateFunc<IEnvoyProxy>);
