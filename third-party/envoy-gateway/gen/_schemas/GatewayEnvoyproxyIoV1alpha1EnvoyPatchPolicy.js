...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "qGQ1o0Do6T3HRNwZYcQ4AWAvpidKP1k1Zg6GFssDuI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "QtVL9e5QHmyoh3dfyRsgAmNI9T4KO9pfOhFDYgVo"
    },
    "status": {
  ...
  "$id": "gateway.envoyproxy.io.v1alpha1.EnvoyPatchPolicy"
};
const schema8 = {
  "type": "string",
...
const schema12 = {
  "properties": {
    "jsonPatches": {
      "$ref": "KeFJmCu8pQO63FMQ8XWx0kXqDIoZ9mYdJeMBueic7Q"
    },
    "priority": {
    ...
    "type": {
      "$ref": "nzfmU9iVAlQhOPOQFSflVTzD1rWoPwavpb4qESWlJc"
    }
  },
...
const schema13 = {
  "items": {
    "$ref": "ythb53H2quHoc55VOUzossW5WoRzLAodGMZMUUK7yl8"
  },
  "type": "array",
  "nullable": true
};
const schema14 = {
  "properties": {
    ...
    "operation": {
      "$ref": "d3VUACGqQ3gXwS5h709hADbrF3LAmx4KDbBwvoo8"
    },
    "type": {
      "$ref": "Onymz46zBUK0Deg9YBAEgfk5KR4jkZhjDMzOhyAtUw"
    }
  },
...
const schema15 = {
  "properties": {
    ...
    "op": {
      "$ref": "6xZvBceTLmNeVE3PYyclIRabgCX1UDzvQBJnArOEJVw"
    },
    "path": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
...
function validate38(data, {
  ...
  if (!(data === "add" || data === "remove" || data === "replace" || data === "move" || data === "copy" || data === "test")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate44(data, {
  ...
  if (!(data === "type.googleapis.com/envoy.config.listener.v3.Listener" || data === "type.googleapis.com/envoy.config.route.v3.RouteConfiguration" || data === "type.googleapis.com/envoy.config.cluster.v3.Cluster" || data === "type.googleapis.com/envoy.config.endpoint.v3.ClusterLoadAssignment" || data === "type.googleapis.com/envoy.extensions.transport_sockets.tls.v3.Secret")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.jsonPatches !== undefined) {
      if (!validate32(data.jsonPatches, {
        instancePath: instancePath + "/jsonPatches",
        parentData: data,
        parentDataProperty: "jsonPatches",
        rootData
      })) {
...
function validate65(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate66(data.lastTransitionTime, {
...
function validate22(data, {
  ...
  /*# sourceURL="gateway.envoyproxy.io.v1alpha1.EnvoyPatchPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
