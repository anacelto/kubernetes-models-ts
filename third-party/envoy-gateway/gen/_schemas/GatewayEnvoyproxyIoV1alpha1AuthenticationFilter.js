...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "rMnrKrPizvERl0tZqq7DS894NLMgV0704Y9aotUn12w"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "j2fufmkXicgiGyg92B2aPWif1tWPgfAm9G7imtLp7mY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "gateway.envoyproxy.io.v1alpha1.AuthenticationFilter"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    "jwtProviders": {
      "$ref": "ZgAn49FGyKfJ8tgGe7DC6JMH3lMI19US7wEoPADF4"
    },
    "type": {
      "$ref": "jJ4P3bU4fR5ab6l22RFeGzEZV3QHwFbRQilKKUw"
    }
  },
  "required": ["type"],
  "type": "object"
...
const schema14 = {
  "items": {
    "$ref": "o8FVJKNnh1GIcXkjs2BRfAY8zUNLse25LBTzfYUf4KA"
  },
  "maxItems": 4,
  "type": "array",
  "nullable": true
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.claimToHeaders !== undefined) {
      if (!validate38(data.claimToHeaders, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.jwtProviders !== undefined) {
      if (!validate33(data.jwtProviders, {
...
function validate23(data, {
  ...
  /*# sourceURL="gateway.envoyproxy.io.v1alpha1.AuthenticationFilter" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
