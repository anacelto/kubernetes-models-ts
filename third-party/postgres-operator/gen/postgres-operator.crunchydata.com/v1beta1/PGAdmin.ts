...
import { validate } from "../../_schemas/PostgresOperatorCrunchydataComV1beta1PGAdmin";
 ...
 * PGAdmin is the Schema for the PGAdmin API
 */
export class PGAdmin extends Model<IPGAdmin> implements IPGAdmin {
...
static apiVersion: IPGAdmin["apiVersion"] = "postgres-operator.crunchydata.com/v1beta1";
static kind: IPGAdmin["kind"] = "PGAdmin";
static is = createTypeMetaGuard<IPGAdmin>(PGAdmin);

constructor(data?: ModelData<IPGAdmin>) {
  super();

  this.setDefinedProps({
    apiVersion: PGAdmin.apiVersion,
    kind: PGAdmin.kind,
    ...data
  } as IPGAdmin);
}
...
setValidateFunc(PGAdmin, validate as ValidateFunc<IPGAdmin>);
