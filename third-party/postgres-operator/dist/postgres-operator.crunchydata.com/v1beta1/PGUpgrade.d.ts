 ...
 * PGUpgrade is the Schema for the pgupgrades API
 */
export declare class PGUpgrade extends Model<IPGUpgrade> implements IPGUpgrade {
    ...
    static apiVersion: IPGUpgrade["apiVersion"];
    static kind: IPGUpgrade["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPGUpgrade>;
