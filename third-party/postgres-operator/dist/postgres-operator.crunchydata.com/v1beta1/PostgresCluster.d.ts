 ...
 * PostgresCluster is the Schema for the postgresclusters API
 */
export declare class PostgresCluster extends Model<IPostgresCluster> implements IPostgresCluster {
    ...
    static apiVersion: IPostgresCluster["apiVersion"];
    static kind: IPostgresCluster["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPostgresCluster>;
