...
export declare class OperatorConfiguration extends Model<IOperatorConfiguration> implements IOperatorConfiguration {
    ...
    static apiVersion: IOperatorConfiguration["apiVersion"];
    static kind: IOperatorConfiguration["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IOperatorConfiguration>;
