...
export declare class postgresql extends Model<Ipostgresql> implements Ipostgresql {
    ...
    static apiVersion: Ipostgresql["apiVersion"];
    static kind: Ipostgresql["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<Ipostgresql>;
