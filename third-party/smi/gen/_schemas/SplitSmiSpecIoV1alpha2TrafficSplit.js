...
const schema6 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "bNHzymKVKeiKPcrsVK5zbCn321zKnu8SHh3liQievY"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "n9fJ3Y2uiY0QLRRPH8IsWT4Vd2EAcmwSVUZHGL901A"
    },
    "status": {
  ...
  "$id": "split.smi-spec.io.v1alpha2.TrafficSplit"
};
const schema7 = {
  "type": "string",
  "enum": ["split.smi-spec.io/v1alpha2"]
};
function validate22(data, {
  ...
  if (!(data === "split.smi-spec.io/v1alpha2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema11 = {
  "properties": {
    "backends": {
      "$ref": "Bn2gd9V6Kbfd9SpJWUnt3Yyv8eoOWufbYTlLImvV10"
    },
    "service": {
...
function validate21(data, {
  ...
  /*# sourceURL="split.smi-spec.io.v1alpha2.TrafficSplit" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
