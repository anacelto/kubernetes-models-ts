...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "J7slkqZUyvK8NSvpsv7PbFFYyjrttzQ4eU4JLcjY2yw"
    },
    "kind": {
  ...
  "$id": "specs.smi-spec.io.v1alpha2.HTTPRouteGroup"
};
const schema9 = {
  "type": "string",
  "enum": ["specs.smi-spec.io/v1alpha2"]
};
function validate24(data, {
  ...
  if (!(data === "specs.smi-spec.io/v1alpha2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="specs.smi-spec.io.v1alpha2.HTTPRouteGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
