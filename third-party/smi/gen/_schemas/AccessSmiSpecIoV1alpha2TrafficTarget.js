...
const schema10 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "F2m2735HOythaKbh3qSHJgZJfKneXvagFAs2aFIM"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "Kyw5iJBnnPIMWMhhytPQIXsUJwjtabvRcJw2J1sY"
    },
    "status": {
  ...
  "$id": "access.smi-spec.io.v1alpha2.TrafficTarget"
};
const schema11 = {
  "type": "string",
  "enum": ["access.smi-spec.io/v1alpha2"]
};
function validate30(data, {
  ...
  if (!(data === "access.smi-spec.io/v1alpha2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {
  "properties": {
    ...
    "sources": {
      "$ref": "mwP8AZGd3o04ywvPFNDL996ukzoaBkueFNeDDnqoAks"
    }
  },
...
function validate29(data, {
  ...
  /*# sourceURL="access.smi-spec.io.v1alpha2.TrafficTarget" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
