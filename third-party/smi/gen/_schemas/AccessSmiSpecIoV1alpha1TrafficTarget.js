...
const schema10 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "2rFYFNvUW5NkCtVAj0VFkqfKsmusshvMUOuEM7jZj5g"
    },
    "destination": {
      "$ref": "c1pEtDoD4H4Gk4xaSacTV4xPxWkn3hISXbzAoSU"
    },
    "kind": {
    ...
    "sources": {
      "$ref": "fZr7sn8qgoB4iQo89NRha5A6Yg9nIFb3zaVn5Ueqh8"
    },
    "specs": {
      "$ref": "mmkohuLOa0KWFIriYo48JsRXwuIPcRqOfpO9u8"
    }
  },
  "required": ["destination", "sources", "specs", "apiVersion", "kind"],
  "$id": "access.smi-spec.io.v1alpha1.TrafficTarget"
};
const schema11 = {
  "type": "string",
  "enum": ["access.smi-spec.io/v1alpha1"]
};
function validate30(data, {
  ...
  if (!(data === "access.smi-spec.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema16 = {
  "items": {
    "$ref": "x8JUkMERRMDd8nvwwdV2E1Oysv443Bt8LNP3l6U1CaU"
  },
  "type": "array"
};
const schema17 = {
...
function validate29(data, {
  ...
  /*# sourceURL="access.smi-spec.io.v1alpha1.TrafficTarget" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
