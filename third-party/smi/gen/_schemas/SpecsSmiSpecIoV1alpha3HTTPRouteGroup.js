...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "kJ5ELnQi3rivcLQN1BBeQz6ReqzUIr1P09OMKzJUWs"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "3HaEHuxYm2Ld5ado4ETRibpX1YHzTAckeLmw7A4BrQ"
    },
    "status": {
  ...
  "$id": "specs.smi-spec.io.v1alpha3.HTTPRouteGroup"
};
const schema9 = {
  "type": "string",
  "enum": ["specs.smi-spec.io/v1alpha3"]
};
function validate24(data, {
  ...
  if (!(data === "specs.smi-spec.io/v1alpha3")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate23(data, {
  ...
  /*# sourceURL="specs.smi-spec.io.v1alpha3.HTTPRouteGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
