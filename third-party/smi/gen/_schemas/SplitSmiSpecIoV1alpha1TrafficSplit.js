...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "IKizbtyHRfdpvIYzhC2eKtaXiRs0aemAgdALcR1Nc"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "zTdy6BhR1Y9kO2UKH17vwTpK9F2TAk16pUuuvJlIXOc"
    },
    "status": {
  ...
  "$id": "split.smi-spec.io.v1alpha1.TrafficSplit"
};
const schema8 = {
  "type": "string",
  "enum": ["split.smi-spec.io/v1alpha1"]
};
function validate23(data, {
  ...
  if (!(data === "split.smi-spec.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "properties": {
    "backends": {
      "$ref": "iDspHM7M2L39YQm8JGQ3VO28sWGZzW92k429QJRBiM"
    },
    "service": {
...
const schema13 = {
  "items": {
    "$ref": "6ReTJxEB5rXukdS6dltQTgaONDj3NF79DnLQK5iU"
  },
  "type": "array",
  "nullable": true
};
...
function validate22(data, {
  ...
  /*# sourceURL="split.smi-spec.io.v1alpha1.TrafficSplit" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
