...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "WMqwRWy21rYEGY7dvh2c0pUwJmQ69n149IOskkPZk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "gynDNEZNtxjpSppooO8I6JoKXjNNI7xUNoY7x5yM"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "access.smi-spec.io.v1alpha4.TrafficTarget"
};
const schema11 = {
  "type": "string",
...
const schema15 = {
  "properties": {
    "destination": {
      "$ref": "NiILcHmVu6NNsqtCknxYmKEJz2OSHXhgjYM0FNSOKg"
    },
    "rules": {
      "$ref": "wM3SEdphuwZdaLOfzR5YhzycAOb8SJblpNG8JciAzc"
    },
    "sources": {
      "$ref": "7B0fKOohzAmZloGxuCU2qtPaAyj4aUF2KpRtufxgo"
    }
  },
...
const schema7 = {
  "properties": {
    "kind": {
      "$ref": "jeXt4sa3QvFnhu6UUOqWLellGTVbk1QrVqh88uY"
    },
    "name": {
...
const schema8 = {
  "enum": ["ServiceAccount", "IdentityBinding"],
  "type": "string"
};
function validate23(data, {
  ...
  if (!(data === "ServiceAccount" || data === "IdentityBinding")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema16 = {
  "items": {
    "$ref": "yCHTjeMtjwv9Ps25RJ8YfTLb3pjzoB0iAUxvbVh9g"
  },
  "type": "array",
  "nullable": true
};
...
function validate28(data, {
  ...
  /*# sourceURL="access.smi-spec.io.v1alpha4.TrafficTarget" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
