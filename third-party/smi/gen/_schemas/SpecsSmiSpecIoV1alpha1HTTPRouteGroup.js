...
const schema7 = {
  ...
  "properties": {
    ...
    "matches": {
      "$ref": "Y6Dnoua2VhN7oKw6kpwsToqwCVSINygJezC6XNlQwc"
    },
    "metadata": {
  ...
  "$id": "specs.smi-spec.io.v1alpha1.HTTPRouteGroup"
};
const schema8 = {
  "type": "string",
...
const schema10 = {
  "items": {
    "$ref": "uvoSQQngo0x0Q0vb2O63aZGT9LPs1Jyf9wobNMCns"
  },
  "type": "array",
  "nullable": true
};
...
function validate22(data, {
  ...
  /*# sourceURL="specs.smi-spec.io.v1alpha1.HTTPRouteGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
