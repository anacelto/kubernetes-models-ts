...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "aPFyCgr4kkRmBCLftj7DodIMwCMDv5JrThLQDAJ3s"
    },
    "kind": {
      "$ref": "49usx81OrOafUKrcDmfWmYB6yWAVcs24Y5oMcuD1s"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "A5ViPI6JVP1djyWjhxSOLRB4kwhtjNxhNMtqN92wELg"
    },
    "status": {
  ...
  "$id": "specs.smi-spec.io.v1alpha4.HTTPRouteGroup"
};
const schema9 = {
  "type": "string",
  "enum": ["specs.smi-spec.io/v1alpha4"]
};
function validate24(data, {
  ...
  if (!(data === "specs.smi-spec.io/v1alpha4")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema13 = {
  "properties": {
    "matches": {
      "$ref": "twT0i9HkPl67yJ1PYRzef026QtkqwY1YGoPviSdE"
    }
  },
  "type": "object",
  "nullable": true
...
const schema14 = {
  "items": {
    "$ref": "4W9f2mMUZoXN4Nuck8hnOFDnIXMNleDjlw7dAdX1gc"
  },
  "type": "array",
  "nullable": true
};
...
function validate23(data, {
  ...
  /*# sourceURL="specs.smi-spec.io.v1alpha4.HTTPRouteGroup" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
