...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "IXuuvDawSebSKbQXf5RvplOgMfr951EFo12UWS3kCs"
    },
    "kind": {
  ...
  "$id": "split.smi-spec.io.v1alpha3.TrafficSplit"
};
const schema8 = {
  "type": "string",
  "enum": ["split.smi-spec.io/v1alpha3"]
};
function validate23(data, {
  ...
  if (!(data === "split.smi-spec.io/v1alpha3")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="split.smi-spec.io.v1alpha3.TrafficSplit" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
