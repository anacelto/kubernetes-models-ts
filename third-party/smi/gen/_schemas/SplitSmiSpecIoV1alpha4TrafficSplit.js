...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "lzs1dmGWpMpHMCqLnCJnM5V3CB3L5xYNyrVBGZ2AYQ"
    },
    "kind": {
      "$ref": "zeB5Bb27hfqqeud8OS7BP3sULjcdFuq2xJvZeU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "LbZ0xWPotbISzkaCDc0OeWllCmIl23XWeHeoolg9s"
    },
    "status": {
  ...
  "$id": "split.smi-spec.io.v1alpha4.TrafficSplit"
};
const schema8 = {
  "type": "string",
  "enum": ["split.smi-spec.io/v1alpha4"]
};
function validate23(data, {
  ...
  if (!(data === "split.smi-spec.io/v1alpha4")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  "properties": {
    "backends": {
      "$ref": "qjUJGSDVmcMWub67Jsm6YtlNo1uXMthRbxPomU1V8M"
    },
    "matches": {
      "$ref": "ZWOLMjXTrmT2C0ucafSIXVnCGZQ9rKqrjoXT2vpkkbA"
    },
    "service": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    }
  },
  "required": ["backends", "service"],
  "type": "object",
  "nullable": true
};
const schema13 = {
  "items": {
    "$ref": "RjkXjc62wlFsZO4ftc3trkKFITtV6Qr5idXH1LCRV8"
  },
  "type": "array"
};
const schema14 = {
  "properties": {
    ...
    "weight": {
      "$ref": "lUZqDB1t3N4x2sAYY6SWklYZyKg6au7Of9UhEiDuZA"
    }
  },
...
const schema16 = {
  "items": {
    "$ref": "FJ706WLCrfrt4VjVv3qNyVGSRSDLJq4DcSnmnl1ny0"
  },
  "type": "array",
  "nullable": true
};
...
function validate22(data, {
  ...
  /*# sourceURL="split.smi-spec.io.v1alpha4.TrafficSplit" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
