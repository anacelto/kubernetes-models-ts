...
const schema6 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "ZRFdfEW0z2w8wFH9SXxIyB41883i4vnEdayD08DNTk"
    },
    "kind": {
  ...
  "$id": "specs.smi-spec.io.v1alpha1.TCPRoute"
};
const schema7 = {
  "type": "string",
  "enum": ["specs.smi-spec.io/v1alpha1"]
};
function validate22(data, {
  ...
  if (!(data === "specs.smi-spec.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  /*# sourceURL="specs.smi-spec.io.v1alpha1.TCPRoute" */;
  let vErrors = null;
  let errors = 0;
