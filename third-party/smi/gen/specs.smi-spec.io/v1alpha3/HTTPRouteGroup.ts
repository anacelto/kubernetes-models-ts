...
import { validate } from "../../_schemas/SpecsSmiSpecIoV1alpha3HTTPRouteGroup";
...
export interface IHTTPRouteGroup {
  ...
  /**
   * HTTPRouteGroupSpec defines the desired state of HTTPRouteGroup It is the specification for a HTTPRouteGroup
   */
  "spec": {
    /**
...
static apiVersion: IHTTPRouteGroup["apiVersion"] = "specs.smi-spec.io/v1alpha3";
