 ...
 * An `IdentityBinding` declares the set of identities belonging to a particular workload for the purposes of policy (i.e. TrafficTarget).
 */
export declare class IdentityBinding extends Model<IIdentityBinding> implements IIdentityBinding {
    ...
    static apiVersion: IIdentityBinding["apiVersion"];
    static kind: IIdentityBinding["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIdentityBinding>;
