 ...
 * SuperStream is the Schema for the queues API
 */
export declare class SuperStream extends Model<ISuperStream> implements ISuperStream {
    ...
    static apiVersion: ISuperStream["apiVersion"];
    static kind: ISuperStream["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISuperStream>;
