 ...
 * Shovel is the Schema for the shovels API
 */
export declare class Shovel extends Model<IShovel> implements IShovel {
    "apiVersion": IShovel["apiVersion"];
    "kind": IShovel["kind"];
    "metadata"?: IShovel["metadata"];
    "spec"?: IShovel["spec"];
    "status"?: IShovel["status"];
    static apiVersion: IShovel["apiVersion"];
    static kind: IShovel["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IShovel>;
