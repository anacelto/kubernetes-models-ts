 ...
 * Policy is the Schema for the policies API
 */
export declare class Policy extends Model<IPolicy> implements IPolicy {
    "apiVersion": IPolicy["apiVersion"];
    "kind": IPolicy["kind"];
    "metadata"?: IPolicy["metadata"];
    "spec"?: IPolicy["spec"];
    "status"?: IPolicy["status"];
    static apiVersion: IPolicy["apiVersion"];
    static kind: IPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPolicy>;
