 ...
 * SchemaReplication is the Schema for the schemareplications API This feature requires Tanzu RabbitMQ with schema replication plugin. For more information, see: https://tanzu.vmware.com/rabbitmq and https://www.rabbitmq.com/definitions-standby.html.
 */
export declare class SchemaReplication extends Model<ISchemaReplication> implements ISchemaReplication {
    ...
    static apiVersion: ISchemaReplication["apiVersion"];
    static kind: ISchemaReplication["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISchemaReplication>;
