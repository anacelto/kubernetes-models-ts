 ...
 * Queue is the Schema for the queues API
 */
export declare class Queue extends Model<IQueue> implements IQueue {
    "apiVersion": IQueue["apiVersion"];
    "kind": IQueue["kind"];
    "metadata"?: IQueue["metadata"];
    "spec"?: IQueue["spec"];
    "status"?: IQueue["status"];
    static apiVersion: IQueue["apiVersion"];
    static kind: IQueue["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IQueue>;
