 ...
 * TopicPermission is the Schema for the topicpermissions API
 */
export declare class TopicPermission extends Model<ITopicPermission> implements ITopicPermission {
    ...
    static apiVersion: ITopicPermission["apiVersion"];
    static kind: ITopicPermission["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ITopicPermission>;
