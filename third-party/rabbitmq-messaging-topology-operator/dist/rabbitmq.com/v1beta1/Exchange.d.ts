 ...
 * Exchange is the Schema for the exchanges API
 */
export declare class Exchange extends Model<IExchange> implements IExchange {
    "apiVersion": IExchange["apiVersion"];
    "kind": IExchange["kind"];
    "metadata"?: IExchange["metadata"];
    "spec"?: IExchange["spec"];
    "status"?: IExchange["status"];
    static apiVersion: IExchange["apiVersion"];
    static kind: IExchange["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IExchange>;
