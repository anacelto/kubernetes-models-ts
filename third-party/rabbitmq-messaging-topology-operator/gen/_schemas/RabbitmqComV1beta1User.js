...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "JYyuFdGo8YnQiGpTffAQtjCxwSB0f5Bc4Ye9TpDJWPE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "h8ef1x3hq92snORXkwOL8AltK6rdvgB5xe6SOxYTSw"
    },
    "status": {
      "$ref": "CpCMHOEOI4IMdtQ90zJvJOSj6j1Pv2N9iOAZlnUPFkc"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "rabbitmq.com.v1beta1.User"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    ...
    "tags": {
      "$ref": "U6yopdTWE5jGAY4WS8cycCaPAhuoqWfC3qd8xXw4qw"
    }
  },
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.connectionSecret !== undefined) {
      if (!validate21(data.connectionSecret, {
...
const schema16 = {
  "items": {
    "$ref": "Qt12HqLPbFbcWldfFBw2y83k9YHzWcXIGbiPzhVzOg"
  },
  "type": "array",
  "nullable": true
};
const schema17 = {
  "enum": ["management", "policymaker", "monitoring", "administrator"],
  "type": "string"
};
function validate42(data, {
  ...
  if (!(data === "management" || data === "policymaker" || data === "monitoring" || data === "administrator")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.importCredentialsSecret !== undefined) {
      if (!validate21(data.importCredentialsSecret, {
        instancePath: instancePath + "/importCredentialsSecret",
        parentData: data,
        parentDataProperty: "importCredentialsSecret",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate25(data, {
  ...
  /*# sourceURL="rabbitmq.com.v1beta1.User" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
