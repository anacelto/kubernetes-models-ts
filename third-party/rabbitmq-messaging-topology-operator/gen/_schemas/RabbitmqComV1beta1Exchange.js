...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "02LGE6lEHDWC3g40iaDK7EHPmbs3inYD6kd1qCSdg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "DyCZBsTQOSXqb0f4EtZrPdJErEQ8hMbgGxQrPeeLk"
    },
    "status": {
  ...
  "$id": "rabbitmq.com.v1beta1.Exchange"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    ...
    "type": {
      "$ref": "hP5SEWXetJYBcfzEEsa6poDWk7w9OP77sB9jXCL72AU"
    },
    "vhost": {
      "$ref": "z6LHlrknYSxhvGB40fWbleDDx5iN5dAfq5SPMmkey8"
    }
  },
  "required": ["name", "rabbitmqClusterReference"],
  "type": "object",
  "nullable": true
};
const schema15 = {
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.connectionSecret !== undefined) {
      if (!validate40(data.connectionSecret, {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.durable !== undefined) {
      if (!validate21(data.durable, {
        instancePath: instancePath + "/durable",
        parentData: data,
        parentDataProperty: "durable",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.rabbitmqClusterReference !== undefined) {
      if (!validate39(data.rabbitmqClusterReference, {
...
function validate24(data, {
  ...
  /*# sourceURL="rabbitmq.com.v1beta1.Exchange" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
