...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "u5nmunjCD9b2VZ5OifiiOAfyQMcx9zEcubVF3oQ2z24"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "F0iuqgTOs76Kif1dqhbFRJwtsWIcIW6nT0hz03hmkLM"
    },
    "status": {
  ...
  "$id": "rabbitmq.com.v1beta1.Binding"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    ...
    "destinationType": {
      "$ref": "fftK9cIb6wu0Ayqm8KPjmcfa2oRQ5M7F02Sr0MPU"
    },
...
function validate38(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.connectionSecret !== undefined) {
      if (!validate39(data.connectionSecret, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.destinationType !== undefined) {
      if (!validate36(data.destinationType, {
        instancePath: instancePath + "/destinationType",
        parentData: data,
        parentDataProperty: "destinationType",
        rootData
      })) {
    ...
    if (data.rabbitmqClusterReference !== undefined) {
      if (!validate38(data.rabbitmqClusterReference, {
...
function validate23(data, {
  ...
  /*# sourceURL="rabbitmq.com.v1beta1.Binding" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
