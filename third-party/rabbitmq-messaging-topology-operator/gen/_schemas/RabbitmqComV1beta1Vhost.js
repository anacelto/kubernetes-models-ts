...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "sTjhIylDyJBcIEGFotfWSrLVYCIiqa8DHBAh8lPDN28"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "NRb6J7ogsL79zPEw58OOVA5gE0f4MORyk72Fhb09Ak"
    },
    "status": {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.connectionSecret !== undefined) {
      if (!validate35(data.connectionSecret, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.rabbitmqClusterReference !== undefined) {
      if (!validate34(data.rabbitmqClusterReference, {
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate50(data.lastTransitionTime, {
...
function validate23(data, {
  ...
  /*# sourceURL="rabbitmq.com.v1beta1.Vhost" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
