...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "7XFs7w8Q7JGZd2bNM3UhYNyzuMDMXXxVetMowQz7Ldc"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Hzt9pLOWl7aeFINryFoSWkCdsXG98cJ97HcoAn2a4J0"
    },
    "status": {
  ...
  "$id": "rabbitmq.com.v1beta1.Permission"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    "permissions": {
      "$ref": "qGE9g7KHR3dzKyVN8JF6m2hwPhVSgfYNnHFCNqc0es"
    },
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configure !== undefined) {
      if (!validate21(data.configure, {
        instancePath: instancePath + "/configure",
        parentData: data,
        parentDataProperty: "configure",
        rootData
      })) {
...
function validate25(data, {
  ...
  /*# sourceURL="rabbitmq.com.v1beta1.Permission" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
