...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "0OjVAUULXzVNmHyqNmvMRlkAR7s921xmCDbwXkRYNpc"
    },
    "kind": {
      "$ref": "4Uqs5Pcbz0Szi6L3OBsanFuO46uHOel8t2DSnkUN9uE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "kQLaoFPZWeR16jgyFSnD9MHFGWsoqORKCqb2kdDY"
    },
    "status": {
      "$ref": "JzMRdwAIPKF7htAKNLnHmxYfuGVH4mMp43eQ4WYAE14"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "rabbitmq.com.v1alpha1.SuperStream"
};
const schema10 = {
  "type": "string",
  "enum": ["rabbitmq.com/v1alpha1"]
};
...
const schema14 = {
  "properties": {
    ...
    "partitions": {
      "$ref": "F4CoF1XcjjN4vhqbOgP1qoju8NNSsFA4ocgye2f55Y"
    },
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.partitions !== undefined) {
      if (!validate36(data.partitions, {
        instancePath: instancePath + "/partitions",
        parentData: data,
        parentDataProperty: "partitions",
        rootData
      })) {
    ...
    if (data.routingKeys !== undefined) {
      if (!validate23(data.routingKeys, {
        instancePath: instancePath + "/routingKeys",
        parentData: data,
        parentDataProperty: "routingKeys",
        rootData
      })) {
...
function validate25(data, {
  ...
  /*# sourceURL="rabbitmq.com.v1alpha1.SuperStream" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
