...
import { validate } from "../../_schemas/RabbitmqComV1beta1Permission";
...
static apiVersion: IPermission["apiVersion"] = "rabbitmq.com/v1beta1";
static kind: IPermission["kind"] = "Permission";
static is = createTypeMetaGuard<IPermission>(Permission);

constructor(data?: ModelData<IPermission>) {
  super();

  this.setDefinedProps({
    apiVersion: Permission.apiVersion,
...
setValidateFunc(Permission, validate as ValidateFunc<IPermission>);
