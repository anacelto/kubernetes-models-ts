...
import { validate } from "../../_schemas/RabbitmqComV1beta1Vhost";
 ...
 * Vhost is the Schema for the vhosts API
 */
export class Vhost extends Model<IVhost> implements IVhost {
...
static apiVersion: IVhost["apiVersion"] = "rabbitmq.com/v1beta1";
static kind: IVhost["kind"] = "Vhost";
static is = createTypeMetaGuard<IVhost>(Vhost);

constructor(data?: ModelData<IVhost>) {
  super();

  this.setDefinedProps({
    apiVersion: Vhost.apiVersion,
    kind: Vhost.kind,
    ...data
  } as IVhost);
}
...
setValidateFunc(Vhost, validate as ValidateFunc<IVhost>);
