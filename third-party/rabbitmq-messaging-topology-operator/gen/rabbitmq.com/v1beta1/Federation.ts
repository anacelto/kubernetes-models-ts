...
import { validate } from "../../_schemas/RabbitmqComV1beta1Federation";
 ...
 * Federation is the Schema for the federations API
 */
export class Federation extends Model<IFederation> implements IFederation {
...
static apiVersion: IFederation["apiVersion"] = "rabbitmq.com/v1beta1";
static kind: IFederation["kind"] = "Federation";
static is = createTypeMetaGuard<IFederation>(Federation);

constructor(data?: ModelData<IFederation>) {
  super();

  this.setDefinedProps({
    apiVersion: Federation.apiVersion,
...
setValidateFunc(Federation, validate as ValidateFunc<IFederation>);
