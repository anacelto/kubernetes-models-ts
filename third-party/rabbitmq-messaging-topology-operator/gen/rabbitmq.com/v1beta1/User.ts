...
import { validate } from "../../_schemas/RabbitmqComV1beta1User";
...
static apiVersion: IUser["apiVersion"] = "rabbitmq.com/v1beta1";
static kind: IUser["kind"] = "User";
static is = createTypeMetaGuard<IUser>(User);
...
setValidateFunc(User, validate as ValidateFunc<IUser>);
