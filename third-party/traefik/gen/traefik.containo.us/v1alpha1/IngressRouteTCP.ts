...
import { validate } from "../../_schemas/TraefikContainoUsV1alpha1IngressRouteTCP";
 ...
 * IngressRouteTCP is the CRD implementation of a Traefik TCP Router.
 */
export class IngressRouteTCP extends Model<IIngressRouteTCP> implements IIngressRouteTCP {
...
static apiVersion: IIngressRouteTCP["apiVersion"] = "traefik.containo.us/v1alpha1";
static kind: IIngressRouteTCP["kind"] = "IngressRouteTCP";
static is = createTypeMetaGuard<IIngressRouteTCP>(IngressRouteTCP);

constructor(data?: ModelData<IIngressRouteTCP>) {
  super();

  this.setDefinedProps({
    apiVersion: IngressRouteTCP.apiVersion,
    kind: IngressRouteTCP.kind,
    ...data
  } as IIngressRouteTCP);
}
}
...
setValidateFunc(IngressRouteTCP, validate as ValidateFunc<IIngressRouteTCP>);
