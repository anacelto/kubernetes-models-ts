...
import { validate } from "../../_schemas/TraefikContainoUsV1alpha1TLSOption";
 ...
 * TLSOption is the CRD implementation of a Traefik TLS Option, allowing to configure some parameters of the TLS connection. More info: https://doc.traefik.io/traefik/v2.10/https/tls/#tls-options
 */
export class TLSOption extends Model<ITLSOption> implements ITLSOption {
  "apiVersion": ITLSOption["apiVersion"];
  "kind": ITLSOption["kind"];
  "metadata": ITLSOption["metadata"];
  "spec": ITLSOption["spec"];

static apiVersion: ITLSOption["apiVersion"] = "traefik.containo.us/v1alpha1";
static kind: ITLSOption["kind"] = "TLSOption";
static is = createTypeMetaGuard<ITLSOption>(TLSOption);

constructor(data?: ModelData<ITLSOption>) {
  super();

  this.setDefinedProps({
    apiVersion: TLSOption.apiVersion,
    kind: TLSOption.kind,
    ...data
  } as ITLSOption);
}
...
setValidateFunc(TLSOption, validate as ValidateFunc<ITLSOption>);
