...
import { validate } from "../../_schemas/TraefikContainoUsV1alpha1Middleware";
 ...
 * Middleware is the CRD implementation of a Traefik Middleware. More info: https://doc.traefik.io/traefik/v2.10/middlewares/http/overview/
 */
export class Middleware extends Model<IMiddleware> implements IMiddleware {
  "apiVersion": IMiddleware["apiVersion"];
  "kind": IMiddleware["kind"];
  "metadata": IMiddleware["metadata"];
  "spec": IMiddleware["spec"];

static apiVersion: IMiddleware["apiVersion"] = "traefik.containo.us/v1alpha1";
static kind: IMiddleware["kind"] = "Middleware";
static is = createTypeMetaGuard<IMiddleware>(Middleware);
...
setValidateFunc(Middleware, validate as ValidateFunc<IMiddleware>);
