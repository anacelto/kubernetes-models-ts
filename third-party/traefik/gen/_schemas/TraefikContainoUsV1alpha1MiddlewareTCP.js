...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "MKYsT7TVrl2X31fhObxBr5QA8wL146x5ZT4aa2GC8U"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "UEw6O2XL2VSzFOK5Qy1VE01jaEcLqA9Ajq9H9rrH94"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "traefik.containo.us.v1alpha1.MiddlewareTCP"
};
const schema7 = {
  "type": "string",
...
const schema11 = {
  "properties": {
    "inFlightConn": {
      "$ref": "8D9eJVUNC7dEbR9JqnQzl3KKSKhkV3DXZNoBPQz0I"
    },
    "ipWhiteList": {
      "$ref": "TQOuNntxBBRwVbdbmHZrw3pRQRkh4wCQgpZnn8n1lc"
    }
  },
  "type": "object"
};
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.sourceRange !== undefined) {
      if (!validate36(data.sourceRange, {
...
function validate30(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.inFlightConn !== undefined) {
      if (!validate31(data.inFlightConn, {
        instancePath: instancePath + "/inFlightConn",
        parentData: data,
        parentDataProperty: "inFlightConn",
        rootData
      })) {
    ...
    if (data.ipWhiteList !== undefined) {
      if (!validate35(data.ipWhiteList, {
...
function validate21(data, {
  ...
  /*# sourceURL="traefik.containo.us.v1alpha1.MiddlewareTCP" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
