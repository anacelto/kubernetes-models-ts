...
const schema12 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "IfrQa4ecdF1ri4iL0vh5foX5yAeALMCev35WjdXFp8"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "s1iXhZaFBGar8BKK6hLTL2afYKPmZFgpHODrsFJEoD0"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "traefik.io.v1alpha1.IngressRoute"
};
const schema13 = {
  "type": "string",
...
const schema17 = {
  "properties": {
    ...
    "routes": {
      "$ref": "DoN7XmOXopWvsU3kR4OUzRFTUih1ANJ6vSiDfHXX4A"
    },
    "tls": {
      "$ref": "4kS1cgkAReq1GDVNbXq0BaHtPjdhLDgF3mUFoKcc8"
    }
  },
  "required": ["routes"],
  "type": "object"
...
const schema18 = {
  "items": {
    "$ref": "69tyayGFWLnmaqB391cUHDVrVZCSzc1R15j7sGEz9s"
  },
  "type": "array"
};
const schema19 = {
  "properties": {
    "kind": {
      "$ref": "b0dWbTSGeO13PbPNiT1DPhfcV37WGtOHNmGgfqTUGE"
    },
    "match": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    ...
    "services": {
      "$ref": "JrnkDUmxptYEsjZw3h9jfpDWlyMEnRtdmuJFC9rzEk"
    }
  },
  "required": ["kind", "match"],
  "type": "object"
...
const schema23 = {
  "items": {
    "$ref": "5RSaaHFAttg16veC3FxAS5FYrQFtVvPZaWFgYUcsaw"
  },
  "type": "array",
  "nullable": true
};
...
function validate66(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.flushInterval !== undefined) {
      if (!validate22(data.flushInterval, {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.passHostHeader !== undefined) {
      if (!validate23(data.passHostHeader, {
    ...
    if (data.responseForwarding !== undefined) {
      if (!validate66(data.responseForwarding, {
    ...
    if (data.serversTransport !== undefined) {
      if (!validate22(data.serversTransport, {
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.middlewares !== undefined) {
      if (!validate46(data.middlewares, {
...
const schema31 = {
  "properties": {
    ...
    "domains": {
      "$ref": "0MlrN6TGi0WMLfHqJJtXyiSTC1Sj3kXOjpjdNiKVWpY"
    },
    "options": {
...
const schema32 = {
  "items": {
    "$ref": "kGpoMUCxrFnpv07pI2KO7WIj5v99GaJ55qQrOf3GF78"
  },
  "type": "array",
  "nullable": true
};
...
function validate85(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certResolver !== undefined) {
      if (!validate22(data.certResolver, {
        instancePath: instancePath + "/certResolver",
        parentData: data,
        parentDataProperty: "certResolver",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.store !== undefined) {
      if (!validate27(data.store, {
        instancePath: instancePath + "/store",
        parentData: data,
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.entryPoints !== undefined) {
      if (!validate25(data.entryPoints, {
...
function validate30(data, {
  ...
  /*# sourceURL="traefik.io.v1alpha1.IngressRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
