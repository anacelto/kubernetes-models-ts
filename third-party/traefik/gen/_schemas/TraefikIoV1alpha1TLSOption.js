...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "OJyYkENdrL9gDpAn1db5CMVtkNwY5GWfrJ34BXV3I0I"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "eJdXsdQ2muJoapUIBpNy7ZV0XyijcphT2Ziu8mqJcTM"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "traefik.io.v1alpha1.TLSOption"
};
const schema11 = {
  "type": "string",
...
const schema15 = {
  "properties": {
    ...
    "clientAuth": {
      "$ref": "65V00OWMNrlRR1TdIVZ6857EPIiQYZvH4ZWMnG26IA"
    },
    "curvePreferences": {
      "$ref": "aRQtgAls8PT3219P8mxz6PPEAVWN1SvmCHi6z12UM"
    },
...
const schema16 = {
  "properties": {
    "clientAuthType": {
      "$ref": "V3YzRBs76aXWQ2SHRbS2DJ8Lno9LVC2Dmx320sX4eU"
    },
    "secretNames": {
      "$ref": "aRQtgAls8PT3219P8mxz6PPEAVWN1SvmCHi6z12UM"
    }
...
function validate39(data, {
  ...
  if (!(data === "NoClientCert" || data === "RequestClientCert" || data === "RequireAnyClientCert" || data === "VerifyClientCertIfGiven" || data === "RequireAndVerifyClientCert")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate38(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.clientAuthType !== undefined) {
      if (!validate39(data.clientAuthType, {
    ...
    if (data.secretNames !== undefined) {
      if (!validate21(data.secretNames, {
        instancePath: instancePath + "/secretNames",
        parentData: data,
        parentDataProperty: "secretNames",
        rootData
      })) {
...
function validate35(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.alpnProtocols !== undefined) {
      if (!validate21(data.alpnProtocols, {
        instancePath: instancePath + "/alpnProtocols",
        parentData: data,
        parentDataProperty: "alpnProtocols",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.cipherSuites !== undefined) {
      if (!validate21(data.cipherSuites, {
    ...
    if (data.clientAuth !== undefined) {
      if (!validate38(data.clientAuth, {
        instancePath: instancePath + "/clientAuth",
        parentData: data,
        parentDataProperty: "clientAuth",
        rootData
      })) {
    ...
    if (data.curvePreferences !== undefined) {
      if (!validate21(data.curvePreferences, {
    ...
    if (data.preferServerCipherSuites !== undefined) {
      if (!validate25(data.preferServerCipherSuites, {
    ...
    if (data.sniStrict !== undefined) {
      if (!validate25(data.sniStrict, {
        instancePath: instancePath + "/sniStrict",
        parentData: data,
        parentDataProperty: "sniStrict",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
...
function validate26(data, {
  ...
  /*# sourceURL="traefik.io.v1alpha1.TLSOption" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
