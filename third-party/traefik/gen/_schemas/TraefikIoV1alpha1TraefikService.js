...
const schema16 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "fEHM2OXIEJtHPgZmlILScBM3g6aJC1HBvVSs1UA6Yw"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "I9beiF0ZB2xOF7uyuwL4MecPOkkOpV2W5ohYirWfBuM"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "traefik.io.v1alpha1.TraefikService"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    "mirroring": {
      "$ref": "mKVRhu6NEn88ajb4ocZQVWrn4DxADy45cELXkall8"
    },
    "weighted": {
      "$ref": "DHYMlElwzATGWzpvACSwnFMilAdLUt43pv2XBhjnQ"
    }
  },
  "type": "object"
};
const schema22 = {
  "properties": {
    ...
    "mirrors": {
      "$ref": "ifobOeJgV5YKVruHxr55BwGU9ctQMLV7vkF5Td7qE"
    },
    "name": {
...
const schema24 = {
  "items": {
    "$ref": "wl92xWmjnCFuRR67p4MEDA0HtZCHKPCe3PD0bbsJE"
  },
  "type": "array",
  "nullable": true
};
...
function validate30(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.flushInterval !== undefined) {
      if (!validate24(data.flushInterval, {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.passHostHeader !== undefined) {
      if (!validate22(data.passHostHeader, {
    ...
    if (data.responseForwarding !== undefined) {
      if (!validate30(data.responseForwarding, {
    ...
    if (data.serversTransport !== undefined) {
      if (!validate24(data.serversTransport, {
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.maxBodySize !== undefined) {
      if (!validate51(data.maxBodySize, {
        instancePath: instancePath + "/maxBodySize",
        parentData: data,
        parentDataProperty: "maxBodySize",
        rootData
      })) {
    ...
    if (data.mirrors !== undefined) {
      if (!validate53(data.mirrors, {
        instancePath: instancePath + "/mirrors",
        parentData: data,
        parentDataProperty: "mirrors",
        rootData
      })) {
...
function validate48(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.mirroring !== undefined) {
      if (!validate49(data.mirroring, {
        instancePath: instancePath + "/mirroring",
        parentData: data,
        parentDataProperty: "mirroring",
        rootData
      })) {
    ...
    if (data.weighted !== undefined) {
      if (!validate82(data.weighted, {
        instancePath: instancePath + "/weighted",
        parentData: data,
        parentDataProperty: "weighted",
        rootData
      })) {
...
function validate39(data, {
  ...
  /*# sourceURL="traefik.io.v1alpha1.TraefikService" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
