...
const schema12 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "yzklhg7hZdnsiTuElO5LRaRahmPBmI3NU0SylAugBY"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "bXKVIsiwNAzxpu8NAPWlvPeghF1a0X9hhobhqHmzQ"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "traefik.io.v1alpha1.IngressRouteTCP"
};
const schema13 = {
  "type": "string",
...
const schema17 = {
  "properties": {
    ...
    "routes": {
      "$ref": "ErGaFGvo3eJinTkQvzsYfqLsIAspSSzt5AbDHefsg"
    },
    "tls": {
      "$ref": "RHQCPpgqfvIyE5dkd7bJbsf87EL9FOWLHVR0zUw8atM"
    }
  },
  "required": ["routes"],
  "type": "object"
...
const schema18 = {
  "items": {
    "$ref": "MIHaWQ2GufbeWb2ZSRpkZZLvy93lGDO1MAhmvIkzA"
  },
  "type": "array"
};
const schema19 = {
  "properties": {
    ...
    "services": {
      "$ref": "WgOU77cDWlPPwO8R6J0pRWF2dvYEnonjy8L75MR5X8"
    }
  },
  "required": ["match"],
  "type": "object"
...
const schema22 = {
  "items": {
    "$ref": "MXb8snqw4H5r8GIYp6WB2QD5smXtoC4hJSANgmGzhb4"
  },
  "type": "array",
  "nullable": true
};
const schema23 = {
  "properties": {
    ...
    "proxyProtocol": {
      "$ref": "epKbMbSot0wzVqDmggj9ERPxYLQNrZ9bSAnyvyUKW0"
    },
    "terminationDelay": {
      "$ref": "CZNoVCXQYuwanyJkiA9GsIPJnKVUhcC3TsHe7jwaJk"
    },
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.proxyProtocol !== undefined) {
      if (!validate61(data.proxyProtocol, {
    ...
    if (data.terminationDelay !== undefined) {
      if (!validate23(data.terminationDelay, {
        instancePath: instancePath + "/terminationDelay",
        parentData: data,
        parentDataProperty: "terminationDelay",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.middlewares !== undefined) {
      if (!validate44(data.middlewares, {
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.passthrough !== undefined) {
      if (!validate26(data.passthrough, {
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.entryPoints !== undefined) {
      if (!validate24(data.entryPoints, {
...
function validate30(data, {
  ...
  /*# sourceURL="traefik.io.v1alpha1.IngressRouteTCP" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
