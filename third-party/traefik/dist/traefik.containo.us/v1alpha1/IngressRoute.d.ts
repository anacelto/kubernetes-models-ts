 ...
 * IngressRoute is the CRD implementation of a Traefik HTTP Router.
 */
export declare class IngressRoute extends Model<IIngressRoute> implements IIngressRoute {
    "apiVersion": IIngressRoute["apiVersion"];
    "kind": IIngressRoute["kind"];
    "metadata": IIngressRoute["metadata"];
    "spec": IIngressRoute["spec"];
    static apiVersion: IIngressRoute["apiVersion"];
    static kind: IIngressRoute["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IIngressRoute>;
