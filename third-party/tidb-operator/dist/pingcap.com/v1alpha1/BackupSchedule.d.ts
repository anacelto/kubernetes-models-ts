...
export declare class BackupSchedule extends Model<IBackupSchedule> implements IBackupSchedule {
    ...
    static apiVersion: IBackupSchedule["apiVersion"];
    static kind: IBackupSchedule["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBackupSchedule>;
