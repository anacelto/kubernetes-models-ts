...
export declare class DMCluster extends Model<IDMCluster> implements IDMCluster {
    ...
    static apiVersion: IDMCluster["apiVersion"];
    static kind: IDMCluster["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IDMCluster>;
