...
export declare class TidbCluster extends Model<ITidbCluster> implements ITidbCluster {
    ...
    static apiVersion: ITidbCluster["apiVersion"];
    static kind: ITidbCluster["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ITidbCluster>;
