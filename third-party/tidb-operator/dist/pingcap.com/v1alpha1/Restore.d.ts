...
export declare class Restore extends Model<IRestore> implements IRestore {
    "apiVersion": IRestore["apiVersion"];
    "kind": IRestore["kind"];
    "metadata": IRestore["metadata"];
    "spec": IRestore["spec"];
    "status"?: IRestore["status"];
    static apiVersion: IRestore["apiVersion"];
    static kind: IRestore["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IRestore>;
