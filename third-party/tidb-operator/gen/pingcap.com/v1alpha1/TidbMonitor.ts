...
import { validate } from "../../_schemas/PingcapComV1alpha1TidbMonitor";
...
export class TidbMonitor extends Model<ITidbMonitor> implements ITidbMonitor {
...
static apiVersion: ITidbMonitor["apiVersion"] = "pingcap.com/v1alpha1";
static kind: ITidbMonitor["kind"] = "TidbMonitor";
static is = createTypeMetaGuard<ITidbMonitor>(TidbMonitor);

constructor(data?: ModelData<ITidbMonitor>) {
  super();

  this.setDefinedProps({
    apiVersion: TidbMonitor.apiVersion,
    kind: TidbMonitor.kind,
    ...data
  } as ITidbMonitor);
}
}
...
setValidateFunc(TidbMonitor, validate as ValidateFunc<ITidbMonitor>);
