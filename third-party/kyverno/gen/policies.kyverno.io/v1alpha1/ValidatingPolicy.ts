...
import { validate } from "../../_schemas/PoliciesKyvernoIoV1alpha1ValidatingPolicy";

export interface IValidatingPolicy {
  /**
...
export class ValidatingPolicy extends Model<IValidatingPolicy> implements IValidatingPolicy {
  "apiVersion": IValidatingPolicy["apiVersion"];
  "kind": IValidatingPolicy["kind"];
  "metadata"?: IValidatingPolicy["metadata"];
  "spec": IValidatingPolicy["spec"];
  "status"?: IValidatingPolicy["status"];

static apiVersion: IValidatingPolicy["apiVersion"] = "policies.kyverno.io/v1alpha1";
static kind: IValidatingPolicy["kind"] = "ValidatingPolicy";
static is = createTypeMetaGuard<IValidatingPolicy>(ValidatingPolicy);

constructor(data?: ModelData<IValidatingPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: ValidatingPolicy.apiVersion,
    kind: ValidatingPolicy.kind,
    ...data
  } as IValidatingPolicy);
}
}


setValidateFunc(ValidatingPolicy, validate as ValidateFunc<IValidatingPolicy>);
