...
const schema26 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "3K0P64G9xjdXsw2bbRGYBBkBy37k3BY408ddN8TQ"
    },
    "metadata": {
  ...
  "$id": "kyverno.io.v2.ClusterCleanupPolicy"
};
const schema27 = {
  "type": "string",
  "enum": ["kyverno.io/v2"]
...
function validate74(data, {
  ...
  /*# sourceURL="kyverno.io.v2.ClusterCleanupPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
