...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "MrRRCv7pNpFfzG3mfLBywNfIqwCY45SXhuF6yU"
    },
    "kind": {
  ...
  "$id": "wgpolicyk8s.io.v1alpha2.ClusterPolicyReport"
};
const schema15 = {
  "type": "string",
  "enum": ["wgpolicyk8s.io/v1alpha2"]
};
function validate38(data, {
  ...
  if (!(data === "wgpolicyk8s.io/v1alpha2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate37(data, {
  ...
  /*# sourceURL="wgpolicyk8s.io.v1alpha2.ClusterPolicyReport" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
