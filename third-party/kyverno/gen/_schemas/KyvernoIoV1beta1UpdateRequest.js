...
const schema14 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "AxtHGtmXEVqwL053FX3iOuXUGQotyCmIhTfqUSXPo"
    },
    "status": {
      "$ref": "cu5gJqAOzOAu11aH5I1tGOFfQfqc6iZTwgOBXVKb68"
    }
  },
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.requestKind !== undefined) {
      if (!validate62(data.requestKind, {
    ...
    if (data.requestResource !== undefined) {
      if (!validate67(data.requestResource, {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.admissionRequest !== undefined) {
      if (!validate49(data.admissionRequest, {
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.admissionRequestInfo !== undefined) {
      if (!validate48(data.admissionRequestInfo, {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deleteDownstream !== undefined) {
      if (!validate100(data.deleteDownstream, {
    ...
    if (data.requestType !== undefined) {
      if (!validate103(data.requestType, {
    ...
    if (data.synchronize !== undefined) {
      if (!validate30(data.synchronize, {
...
function validate109(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.generatedResources !== undefined) {
      if (!validate110(data.generatedResources, {
    ...
    if (data.retryCount !== undefined) {
      if (!validate115(data.retryCount, {
