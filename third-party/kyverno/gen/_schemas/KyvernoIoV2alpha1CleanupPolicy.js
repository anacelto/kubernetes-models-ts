...
const schema25 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "xZ8qc2aQzYqCdDciEy23ZHYiRCcOhnkhO00T8iPRdlE"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "4NkjRTJmmRqW17jia2ydnAyEIEwjWHPShHPATgQbI"
    },
    "status": {
  ...
  "$id": "kyverno.io.v2alpha1.CleanupPolicy"
};
const schema26 = {
  "type": "string",
  "enum": ["kyverno.io/v2alpha1"]
};
...
const schema30 = {
  "properties": {
    ...
    "context": {
      "$ref": "17obgmTaAcK0wUmv53muVXWkj5D23BXIpYHbRZKMxM"
    },
    "exclude": {
      "$ref": "50KZNzrzhq87Ri6RiYQeuUhGeAIQ9U8hJKXfGxbbr40"
    },
    "match": {
      "$ref": "50KZNzrzhq87Ri6RiYQeuUhGeAIQ9U8hJKXfGxbbr40"
    },
...
const schema32 = {
  "items": {
    "$ref": "swU1JNmkxW4SR9LifmgXECIDR3lh8976b28rFA3G8"
  },
  "type": "array",
  "nullable": true
};
const schema33 = {
  "properties": {
    "apiCall": {
      "$ref": "7VsyImWBNdZN2d3m2etkkb1SOTarNgCXzniuPkV9OU"
    },
    "configMap": {
...
const schema34 = {
  "properties": {
    ...
    "service": {
      "$ref": "DYejTFnfhDGypfgecS9FlXAAbxvM4tLhDzuBkFqo"
    },
    "urlPath": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
function validate111(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowInsecureRegistry !== undefined) {
      if (!validate112(data.allowInsecureRegistry, {
...
function validate110(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imageRegistryCredentials !== undefined) {
      if (!validate111(data.imageRegistryCredentials, {
...
function validate89(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imageRegistry !== undefined) {
      if (!validate110(data.imageRegistry, {
...
const schema24 = {
  "properties": {
    "all": {
      "$ref": "fn7gDgDl5YRIWjaAlWgH0gPuVhP2F09gXhzOFLHxrY"
    },
    "any": {
      "$ref": "fn7gDgDl5YRIWjaAlWgH0gPuVhP2F09gXhzOFLHxrY"
    }
...
const schema17 = {
  "items": {
    "$ref": "w18Lrcxk36EA5FMGamyD0JBRsCWAWuUolzI2zaquI"
  },
  "type": "array",
  "nullable": true
};
const schema18 = {
  "properties": {
    ...
    "resources": {
      "$ref": "2wn4ACVZ1UYDQinWIgnsAnZuFhNjeqMpTvFAQ43e4pw"
    },
    "roles": {
      "$ref": "aRQtgAls8PT3219P8mxz6PPEAVWN1SvmCHi6z12UM"
    },
...
function validate137(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate138(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate142(data.observedGeneration, {
...
function validate135(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate136(data.conditions, {
        instancePath: instancePath + "/conditions",
        parentData: data,
        parentDataProperty: "conditions",
        rootData
    ...
    if (data.lastExecutionTime !== undefined) {
      if (!validate152(data.lastExecutionTime, {
...
function validate74(data, {
  ...
  /*# sourceURL="kyverno.io.v2alpha1.CleanupPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
