...
const schema11 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "N0TNMYlY1nugNwoD2rUysrDixpblRq7EDnDYksIFg8"
    },
    "kind": {
      "$ref": "oqf3M9sprIoiPfK7vv7nLzuWvH0fJONrxyGbTMGFw"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "RYf3XAQeNnExrj4d7ZTvrTEbZ1xqfUPZChX5GuLSE5M"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "reports.kyverno.io.v1.ClusterEphemeralReport"
};
const schema12 = {
  "type": "string",
  "enum": ["reports.kyverno.io/v1"]
};
...
function validate30(data, {
  ...
  if (!(data === "ClusterEphemeralReport")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.blockOwnerDeletion !== undefined) {
      if (!validate21(data.blockOwnerDeletion, {
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate52(data.matchExpressions, {
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.resourceVersion !== undefined) {
      if (!validate23(data.resourceVersion, {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.resourceSelector !== undefined) {
      if (!validate51(data.resourceSelector, {
...
function validate27(data, {
  ...
  /*# sourceURL="reports.kyverno.io.v1.ClusterEphemeralReport" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
