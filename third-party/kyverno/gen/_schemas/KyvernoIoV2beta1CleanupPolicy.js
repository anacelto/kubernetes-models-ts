...
const schema26 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "QdsXD9am4QGEx7NCMubX8ghbWq53rJfZGtLBPLWV8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "mtru4vYi6mweYXcfIrmmjXHF0FCNNS6dEMfTzD4opqI"
    },
    "status": {
      "$ref": "uDkLF3z8a7VOJXi0R5WFcotVAmgPwWuIt7GC90RCA"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "kyverno.io.v2beta1.CleanupPolicy"
};
const schema27 = {
  "type": "string",
...
const schema31 = {
  "properties": {
    ...
    "deletionPropagationPolicy": {
      "$ref": "w6aVSddj0bcqWtIiuXQJ2LPKMq9LoNOSzsAie9xjI"
    },
    "exclude": {
...
function validate132(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowInsecureRegistry !== undefined) {
      if (!validate133(data.allowInsecureRegistry, {
...
function validate131(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imageRegistryCredentials !== undefined) {
      if (!validate132(data.imageRegistryCredentials, {
...
function validate89(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.globalReference !== undefined) {
      if (!validate127(data.globalReference, {
    ...
    if (data.imageRegistry !== undefined) {
      if (!validate131(data.imageRegistry, {
...
function validate152(data, {
  ...
  if (!(data === "Foreground" || data === "Background" || data === "Orphan")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate36(data.namespaceSelector, {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.clusterRoles !== undefined) {
      if (!validate32(data.clusterRoles, {
...
function validate83(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deletionPropagationPolicy !== undefined) {
      if (!validate152(data.deletionPropagationPolicy, {
        instancePath: instancePath + "/deletionPropagationPolicy",
        parentData: data,
        parentDataProperty: "deletionPropagationPolicy",
        rootData
      })) {
...
function validate168(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate169(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate173(data.observedGeneration, {
...
function validate166(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate167(data.conditions, {
        instancePath: instancePath + "/conditions",
        parentData: data,
        parentDataProperty: "conditions",
        rootData
    ...
    if (data.lastExecutionTime !== undefined) {
      if (!validate183(data.lastExecutionTime, {
        instancePath: instancePath + "/lastExecutionTime",
        parentData: data,
        parentDataProperty: "lastExecutionTime",
        rootData
      })) {
...
function validate74(data, {
  ...
  /*# sourceURL="kyverno.io.v2beta1.CleanupPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
