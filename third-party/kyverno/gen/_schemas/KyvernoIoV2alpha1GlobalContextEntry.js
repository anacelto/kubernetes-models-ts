...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Rw1ryObGva77sOBStePS0dszhAOkhWU67ypWVKF5gM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AJmZLbq6KfgVmdivPSIZ3moXzPalAgsNxXRwWkReY"
    },
    "status": {
      "$ref": "Eqi5xgzJQKQOQZv19WYHqJNLUbT3VmRthdvByThmZw"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "kyverno.io.v2alpha1.GlobalContextEntry"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "oneOf": [{
    "$ref": "OxYlVqkp9O3yMYc9vafH7arTid5JKT2h04a0ok"
  }, {
    "$ref": "sNHncEdlP5PatsH51j0KJw3P7cpqFo4nMia4XNNgVA"
  }],
  "properties": {
    "apiCall": {
      "$ref": "lVHRNab6EHitxM9dCt4AEQBT1ZtUtO6mdWHLSrs"
    },
    "kubernetesResource": {
      "$ref": "wI0IK0e5bxtciVa7GKruxRbuBBXUajt8Lzi36s5nA08"
    },
    "projections": {
      "$ref": "rLNu5BSvKNgMJWY4XCnoxjpEvLwR5lQfn770oPgFY"
    }
  },
  "type": "object"
};
const schema14 = {
  "required": ["kubernetesResource"]
};
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.kubernetesResource === undefined) {
      const err0 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "kubernetesResource"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
const schema16 = {
  "properties": {
    ...
    "refreshInterval": {
      "$ref": "Z2EsJLh3U3g8m5SAEToHpC50rzp3HioJsaj3zFCQ"
    },
    "retryLimit": {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.refreshInterval !== undefined) {
      if (!validate47(data.refreshInterval, {
    ...
    if (data.retryLimit !== undefined) {
      if (!validate49(data.retryLimit, {
        instancePath: instancePath + "/retryLimit",
        parentData: data,
        parentDataProperty: "retryLimit",
        rootData
      })) {
...
const schema27 = {
  "items": {
    "$ref": "mQJellpDpAf6RBr469phzwgV6QRe878TxoPXCjZinDo"
  },
  "type": "array",
  "nullable": true
};
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.projections !== undefined) {
      if (!validate69(data.projections, {
        instancePath: instancePath + "/projections",
        parentData: data,
        parentDataProperty: "projections",
        rootData
      })) {
...
function validate78(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate79(data.lastTransitionTime, {
...
function validate76(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastRefreshTime !== undefined) {
      if (!validate93(data.lastRefreshTime, {
        instancePath: instancePath + "/lastRefreshTime",
        parentData: data,
        parentDataProperty: "lastRefreshTime",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="kyverno.io.v2alpha1.GlobalContextEntry" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
