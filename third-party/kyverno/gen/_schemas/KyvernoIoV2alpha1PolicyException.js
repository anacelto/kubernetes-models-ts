...
const schema20 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "N0GYJsQk0N0i7ZYOGdZsQwSn0cUWdLfoHFYwvSpgA"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "kyverno.io.v2alpha1.PolicyException"
};
const schema21 = {
  "type": "string",
...
const schema25 = {
  "properties": {
    ...
    "match": {
      "$ref": "jeAhKffKin50YKO6oeyX418masF2NM8eBhUwizzk"
    }
  },
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate26(data.namespaceSelector, {
...
function validate62(data, {
  ...
  /*# sourceURL="kyverno.io.v2alpha1.PolicyException" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
