...
const schema7 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "CeARNTFWEi3fXaK0ZCljNyl9jXbWmHazrzzvRNyZI9k"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "policies.kyverno.io.v1alpha1.PolicyException"
};
const schema8 = {
  "type": "string",
...
const schema12 = {
  "properties": {
    ...
    "policyRefs": {
      "$ref": "vMxg2Q4pu0kXIhIQdVwwbZvmXBEBHVMkABAMIrOtHQ"
    }
  },
  "required": ["policyRefs"],
  "type": "object"
...
const schema15 = {
  "items": {
    "$ref": "iKwSStPuvWmOCMlON82oPCJoFnpm6dOcYZCPvA5bnI"
  },
  "type": "array"
};
const schema16 = {
...
function validate31(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.policyRefs === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "policyRefs"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.matchConditions !== undefined) {
      if (!validate32(data.matchConditions, {
    ...
    if (data.policyRefs !== undefined) {
      if (!validate38(data.policyRefs, {
        instancePath: instancePath + "/policyRefs",
        parentData: data,
        parentDataProperty: "policyRefs",
        rootData
      })) {
...
function validate22(data, {
  ...
  /*# sourceURL="policies.kyverno.io.v1alpha1.PolicyException" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
