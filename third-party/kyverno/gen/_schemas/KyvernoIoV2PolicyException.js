export const validate = validate73;
const schema25 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "sr4lR2tTsz35qXbE801EVC3YZXzuaon5CwRnBnKIo"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Mn01QFwYVwbxLrFP4ICK6XJJVHlWtyKtojhSt2pBY"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "kyverno.io.v2.PolicyException"
};
const schema26 = {
  "type": "string",
  "enum": ["kyverno.io/v2"]
...
const schema30 = {
  "properties": {
    ...
    "exceptions": {
      "$ref": "cREl9GabQEiQ4n9y0uYOEGpd1zR4CBuZVqbsB1gggs"
    },
    "match": {
...
const schema33 = {
  "items": {
    "$ref": "pNFGSIsmA4XiHGA6jxzXq9gix7x4tCXyzkwmlLkA"
  },
  "type": "array"
};
const schema34 = {
...
function validate90(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ruleNames === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "ruleNames"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.policyName !== undefined) {
      if (!validate31(data.policyName, {
        instancePath: instancePath + "/policyName",
        parentData: data,
        parentDataProperty: "policyName",
        rootData
      })) {
        vErrors = vErrors === null ? validate31.errors : vErrors.concat(validate31.errors);
        errors = vErrors.length;
    ...
    if (data.ruleNames !== undefined) {
      if (!validate92(data.ruleNames, {
        instancePath: instancePath + "/ruleNames",
        parentData: data,
        parentDataProperty: "ruleNames",
        rootData
      })) {
...
function validate104(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.controlName !== undefined) {
      if (!validate105(data.controlName, {
...
function validate82(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.exceptions !== undefined) {
      if (!validate89(data.exceptions, {
        instancePath: instancePath + "/exceptions",
        parentData: data,
        parentDataProperty: "exceptions",
        rootData
      })) {
    ...
    if (data.podSecurity !== undefined) {
      if (!validate103(data.podSecurity, {
...
function validate73(data, {
  ...
  /*# sourceURL="kyverno.io.v2.PolicyException" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
