...
export const validate = validate385;
const schema120 = {
  "type": "object",
  "properties": {
    "apiVersion": {
      "$ref": "WaCojizIJYdfM0JdBpXfvshBdMM428Vnj5Bhyjgro"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "DeGXoId26712lxVZxQJ6yDGvtUjSV6yyPaAKwf8HFc8"
    },
    "status": {
  ...
  "$id": "kyverno.io.v2beta1.ClusterPolicy"
};
const schema121 = {
  "type": "string",
  "enum": ["kyverno.io/v2beta1"]
};
...
const schema124 = {};
import { validate as validate391 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema125 = {
  "properties": {
    ...
    "rules": {
      "$ref": "LxDj4heOiPUQNXq6qM4Cp4g6Zkl1QtEuETTkbr6ZAo"
    },
    "schemaValidation": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
...
const schema127 = {
  "items": {
    "$ref": "vKYvcORq9jT3fXwcD6XiLxvLEbNmo1gwwkANpSrblI"
  },
  "type": "array",
  "nullable": true
};
const schema128 = {
  "properties": {
    ...
    "exclude": {
      "$ref": "SGHddG1ZjS8ah1hq0uOIatzQc8IOZm2Ymq0WnGs2WA"
    },
    "generate": {
    ...
    "match": {
      "$ref": "8c0EdnG2QSgGj4ex8Z9fexSJ3XA6nSlH8QTScll5w"
    },
    "mutate": {
    ...
    "preconditions": {
      "$ref": "gN2GlP5uKZeQqhbTQn4nJJeS7lmRshXI9xv9iZLrHcg"
    },
    "skipBackgroundRequests": {
      "$ref": "XI8SHPWBW6IRtzOhSeom8NHPNafxnM7Xgk3N9ZeNk"
    },
    "validate": {
      "$ref": "MMssiesD1z1AGI0cs3WP9qB3KlGhDgPuy79hY66xSo"
    },
    "verifyImages": {
      "$ref": "vXwP6XvoHWsYjzNmBi2aPjEH2xsA4oQgG7Pku5zuIY"
    }
  },
  "required": ["match", "name"],
  "type": "object"
...
const schema58 = {
  "properties": {
    "all": {
      "$ref": "jkhFH64NzGjWWWMhKsDcqscrmOghsxDGlnO6kXmOggo"
    },
    "any": {
      "$ref": "jkhFH64NzGjWWWMhKsDcqscrmOghsxDGlnO6kXmOggo"
    }
...
const schema52 = {
  "items": {
    "$ref": "n6UkRKAXu6U7sDq5ZoIUc6MkKXPLFaM6wGbYzLacmSk"
  },
  "type": "array",
  "nullable": true
};
const schema53 = {
  "properties": {
    ...
    "operator": {
      "$ref": "XbShhNu7rzY9HyNsO326rOTFAdGlD4tfTNbsaqJqkM"
    },
    "value": {
      "$ref": "PV5SIH4Pb4Rd3cOKB0TmpocWXJ4M8i9zrFifAtVgtUQ"
    }
...
const schema54 = {
  "enum": ["Equals", "NotEquals", "AnyIn", "AllIn", "AnyNotIn", "AllNotIn", "GreaterThanOrEquals", "GreaterThan", "LessThanOrEquals", "LessThan", "DurationGreaterThanOrEquals", "DurationGreaterThan", "DurationLessThanOrEquals", "DurationLessThan"],
  "type": "string",
  "nullable": true
};
function validate152(data, {
  ...
  if (!(data === "Equals" || data === "NotEquals" || data === "AnyIn" || data === "AllIn" || data === "AnyNotIn" || data === "AllNotIn" || data === "GreaterThanOrEquals" || data === "GreaterThan" || data === "LessThanOrEquals" || data === "LessThan" || data === "DurationGreaterThanOrEquals" || data === "DurationGreaterThan" || data === "DurationLessThanOrEquals" || data === "DurationLessThan")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema131 = {
  "properties": {
    ...
    "deny": {
      "$ref": "p8PHA82X16HxBWUptfGnvc22cNwrv6WLHVF4ZeH1Y"
    },
    "failureAction": {
...
function validate293(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.auditAnnotations !== undefined) {
      if (!validate294(data.auditAnnotations, {
    ...
    if (data.expressions !== undefined) {
      if (!validate300(data.expressions, {
...
function validate428(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate162(data.conditions, {
...
function validate198(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.signatureAlgorithm !== undefined) {
      if (!validate173(data.signatureAlgorithm, {
...
function validate179(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.certificates !== undefined) {
      if (!validate182(data.certificates, {
...
function validate331(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ignoreFields !== undefined) {
      if (!validate338(data.ignoreFields, {
...
function validate355(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.controlName !== undefined) {
      if (!validate356(data.controlName, {
...
function validate424(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.failureAction !== undefined) {
      if (!validate214(data.failureAction, {
    ...
    if (data.failureActionOverrides !== undefined) {
      if (!validate217(data.failureActionOverrides, {
    ...
    if (data.podSecurity !== undefined) {
      if (!validate353(data.podSecurity, {
...
const schema133 = {
  "items": {
    "$ref": "vSaM8yWoT3amQ16ZU0mS0trBlrsbP78ERuDr1BHPm44"
  },
  "type": "array",
  "nullable": true
};
...
function validate368(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate370(data.conditions, {
        instancePath: instancePath + "/conditions",
        parentData: data,
        parentDataProperty: "conditions",
        rootData
...
function validate440(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.attestations !== undefined) {
      if (!validate367(data.attestations, {
...
function validate405(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.celPreconditions !== undefined) {
      if (!validate157(data.celPreconditions, {
    ...
    if (data.imageExtractors !== undefined) {
      if (!validate253(data.imageExtractors, {
    ...
    if (data.preconditions !== undefined) {
      if (!validate162(data.preconditions, {
        instancePath: instancePath + "/preconditions",
        parentData: data,
        parentDataProperty: "preconditions",
        rootData
    ...
    if (data.verifyImages !== undefined) {
      if (!validate439(data.verifyImages, {
...
function validate463(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.failurePolicy !== undefined) {
      if (!validate224(data.failurePolicy, {
    ...
    if (data.matchConditions !== undefined) {
      if (!validate157(data.matchConditions, {
    ...
    if (data.timeoutSeconds !== undefined) {
      if (!validate225(data.timeoutSeconds, {
...
function validate394(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.applyRules !== undefined) {
      if (!validate396(data.applyRules, {
    ...
    if (data.emitWarning !== undefined) {
      if (!validate156(data.emitWarning, {
    ...
    if (data.validationFailureAction !== undefined) {
      if (!validate460(data.validationFailureAction, {
    ...
    if (data.validationFailureActionOverrides !== undefined) {
      if (!validate217(data.validationFailureActionOverrides, {
    ...
    if (data.webhookConfiguration !== undefined) {
      if (!validate463(data.webhookConfiguration, {
    ...
    if (data.webhookTimeoutSeconds !== undefined) {
      if (!validate225(data.webhookTimeoutSeconds, {
...
function validate473(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.verifyImages !== undefined) {
      if (!validate515(data.verifyImages, {
        instancePath: instancePath + "/verifyImages",
        parentData: data,
        parentDataProperty: "verifyImages",
        rootData
...
function validate544(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate545(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate549(data.observedGeneration, {
...
function validate560(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.verifyimages !== undefined) {
      if (!validate384(data.verifyimages, {
        instancePath: instancePath + "/verifyimages",
        parentData: data,
        parentDataProperty: "verifyimages",
        rootData
...
function validate470(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate543(data.conditions, {
        instancePath: instancePath + "/conditions",
        parentData: data,
        parentDataProperty: "conditions",
        rootData
    ...
    if (data.validatingadmissionpolicy !== undefined) {
      if (!validate566(data.validatingadmissionpolicy, {
...
function validate385(data, {
  ...
  /*# sourceURL="kyverno.io.v2beta1.ClusterPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate386(data.apiVersion, {
        instancePath: instancePath + "/apiVersion",
        parentData: data,
        parentDataProperty: "apiVersion",
        rootData
