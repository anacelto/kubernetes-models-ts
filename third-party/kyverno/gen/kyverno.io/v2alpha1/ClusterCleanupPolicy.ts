...
import { validate } from "../../_schemas/KyvernoIoV2alpha1ClusterCleanupPolicy";

/**
 * ClusterCleanupPolicy defines rule for resource cleanup.
 */
export interface IClusterCleanupPolicy {
  /**
 ...
 * ClusterCleanupPolicy defines rule for resource cleanup.
 */
export class ClusterCleanupPolicy extends Model<IClusterCleanupPolicy> implements IClusterCleanupPolicy {
  "apiVersion": IClusterCleanupPolicy["apiVersion"];
  "kind": IClusterCleanupPolicy["kind"];
  "metadata"?: IClusterCleanupPolicy["metadata"];
  "spec": IClusterCleanupPolicy["spec"];
  "status"?: IClusterCleanupPolicy["status"];

static apiVersion: IClusterCleanupPolicy["apiVersion"] = "kyverno.io/v2alpha1";
static kind: IClusterCleanupPolicy["kind"] = "ClusterCleanupPolicy";
static is = createTypeMetaGuard<IClusterCleanupPolicy>(ClusterCleanupPolicy);

constructor(data?: ModelData<IClusterCleanupPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: ClusterCleanupPolicy.apiVersion,
    kind: ClusterCleanupPolicy.kind,
    ...data
  } as IClusterCleanupPolicy);
}
}


setValidateFunc(ClusterCleanupPolicy, validate as ValidateFunc<IClusterCleanupPolicy>);
