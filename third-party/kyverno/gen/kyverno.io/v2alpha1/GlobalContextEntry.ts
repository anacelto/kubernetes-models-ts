...
import { validate } from "../../_schemas/KyvernoIoV2alpha1GlobalContextEntry";
 ...
 * GlobalContextEntry declares resources to be cached.
 */
export class GlobalContextEntry extends Model<IGlobalContextEntry> implements IGlobalContextEntry {
...
static apiVersion: IGlobalContextEntry["apiVersion"] = "kyverno.io/v2alpha1";
static kind: IGlobalContextEntry["kind"] = "GlobalContextEntry";
static is = createTypeMetaGuard<IGlobalContextEntry>(GlobalContextEntry);

constructor(data?: ModelData<IGlobalContextEntry>) {
  super();

  this.setDefinedProps({
    apiVersion: GlobalContextEntry.apiVersion,
    kind: GlobalContextEntry.kind,
    ...data
  } as IGlobalContextEntry);
}
}


setValidateFunc(GlobalContextEntry, validate as ValidateFunc<IGlobalContextEntry>);
