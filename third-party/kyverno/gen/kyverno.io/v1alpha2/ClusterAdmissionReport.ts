...
import { validate } from "../../_schemas/KyvernoIoV1alpha2ClusterAdmissionReport";

/**
 * ClusterAdmissionReport is the Schema for the ClusterAdmissionReports API
 */
export interface IClusterAdmissionReport {
  /**
 ...
 * ClusterAdmissionReport is the Schema for the ClusterAdmissionReports API
 */
export class ClusterAdmissionReport extends Model<IClusterAdmissionReport> implements IClusterAdmissionReport {
  "apiVersion": IClusterAdmissionReport["apiVersion"];
  "kind": IClusterAdmissionReport["kind"];
  "metadata"?: IClusterAdmissionReport["metadata"];
  "spec": IClusterAdmissionReport["spec"];

static apiVersion: IClusterAdmissionReport["apiVersion"] = "kyverno.io/v1alpha2";
static kind: IClusterAdmissionReport["kind"] = "ClusterAdmissionReport";
static is = createTypeMetaGuard<IClusterAdmissionReport>(ClusterAdmissionReport);

constructor(data?: ModelData<IClusterAdmissionReport>) {
  super();

  this.setDefinedProps({
    apiVersion: ClusterAdmissionReport.apiVersion,
    kind: ClusterAdmissionReport.kind,
    ...data
  } as IClusterAdmissionReport);
}
}


setValidateFunc(ClusterAdmissionReport, validate as ValidateFunc<IClusterAdmissionReport>);
