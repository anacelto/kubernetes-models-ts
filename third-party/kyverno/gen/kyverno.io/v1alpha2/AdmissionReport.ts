...
import { validate } from "../../_schemas/KyvernoIoV1alpha2AdmissionReport";
 ...
 * AdmissionReport is the Schema for the AdmissionReports API
 */
export class AdmissionReport extends Model<IAdmissionReport> implements IAdmissionReport {
  "apiVersion": IAdmissionReport["apiVersion"];
  "kind": IAdmissionReport["kind"];
  "metadata"?: IAdmissionReport["metadata"];
  "spec": IAdmissionReport["spec"];

static apiVersion: IAdmissionReport["apiVersion"] = "kyverno.io/v1alpha2";
static kind: IAdmissionReport["kind"] = "AdmissionReport";
static is = createTypeMetaGuard<IAdmissionReport>(AdmissionReport);

constructor(data?: ModelData<IAdmissionReport>) {
  super();

  this.setDefinedProps({
    apiVersion: AdmissionReport.apiVersion,
    kind: AdmissionReport.kind,
    ...data
  } as IAdmissionReport);
}
}
...
setValidateFunc(AdmissionReport, validate as ValidateFunc<IAdmissionReport>);
