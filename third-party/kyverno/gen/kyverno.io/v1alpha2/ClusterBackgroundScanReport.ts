...
import { validate } from "../../_schemas/KyvernoIoV1alpha2ClusterBackgroundScanReport";

/**
 * ClusterBackgroundScanReport is the Schema for the ClusterBackgroundScanReports API
 */
export interface IClusterBackgroundScanReport {
  /**
 ...
 * ClusterBackgroundScanReport is the Schema for the ClusterBackgroundScanReports API
 */
export class ClusterBackgroundScanReport extends Model<IClusterBackgroundScanReport> implements IClusterBackgroundScanReport {
  "apiVersion": IClusterBackgroundScanReport["apiVersion"];
  "kind": IClusterBackgroundScanReport["kind"];
  "metadata"?: IClusterBackgroundScanReport["metadata"];
  "spec": IClusterBackgroundScanReport["spec"];

static apiVersion: IClusterBackgroundScanReport["apiVersion"] = "kyverno.io/v1alpha2";
static kind: IClusterBackgroundScanReport["kind"] = "ClusterBackgroundScanReport";
static is = createTypeMetaGuard<IClusterBackgroundScanReport>(ClusterBackgroundScanReport);

constructor(data?: ModelData<IClusterBackgroundScanReport>) {
  super();

  this.setDefinedProps({
    apiVersion: ClusterBackgroundScanReport.apiVersion,
    kind: ClusterBackgroundScanReport.kind,
    ...data
  } as IClusterBackgroundScanReport);
}
}


setValidateFunc(ClusterBackgroundScanReport, validate as ValidateFunc<IClusterBackgroundScanReport>);
