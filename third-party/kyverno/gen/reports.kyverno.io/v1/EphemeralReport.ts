...
import { validate } from "../../_schemas/ReportsKyvernoIoV1EphemeralReport";

/**
 * EphemeralReport is the Schema for the EphemeralReports API
 */
export interface IEphemeralReport {
  /**
 ...
 * EphemeralReport is the Schema for the EphemeralReports API
 */
export class EphemeralReport extends Model<IEphemeralReport> implements IEphemeralReport {
  "apiVersion": IEphemeralReport["apiVersion"];
  "kind": IEphemeralReport["kind"];
  "metadata"?: IEphemeralReport["metadata"];
  "spec": IEphemeralReport["spec"];

static apiVersion: IEphemeralReport["apiVersion"] = "reports.kyverno.io/v1";
static kind: IEphemeralReport["kind"] = "EphemeralReport";
static is = createTypeMetaGuard<IEphemeralReport>(EphemeralReport);

constructor(data?: ModelData<IEphemeralReport>) {
  super();

  this.setDefinedProps({
    apiVersion: EphemeralReport.apiVersion,
    kind: EphemeralReport.kind,
    ...data
  } as IEphemeralReport);
}
}
...
setValidateFunc(EphemeralReport, validate as ValidateFunc<IEphemeralReport>);
