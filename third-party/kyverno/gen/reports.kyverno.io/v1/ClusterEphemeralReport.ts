...
import { validate } from "../../_schemas/ReportsKyvernoIoV1ClusterEphemeralReport";

/**
 * ClusterEphemeralReport is the Schema for the ClusterEphemeralReports API
 */
export interface IClusterEphemeralReport {
  /**
 ...
 * ClusterEphemeralReport is the Schema for the ClusterEphemeralReports API
 */
export class ClusterEphemeralReport extends Model<IClusterEphemeralReport> implements IClusterEphemeralReport {
  "apiVersion": IClusterEphemeralReport["apiVersion"];
  "kind": IClusterEphemeralReport["kind"];
  "metadata"?: IClusterEphemeralReport["metadata"];
  "spec": IClusterEphemeralReport["spec"];

static apiVersion: IClusterEphemeralReport["apiVersion"] = "reports.kyverno.io/v1";
static kind: IClusterEphemeralReport["kind"] = "ClusterEphemeralReport";
static is = createTypeMetaGuard<IClusterEphemeralReport>(ClusterEphemeralReport);

constructor(data?: ModelData<IClusterEphemeralReport>) {
  super();

  this.setDefinedProps({
    apiVersion: ClusterEphemeralReport.apiVersion,
    kind: ClusterEphemeralReport.kind,
    ...data
  } as IClusterEphemeralReport);
}
}


setValidateFunc(ClusterEphemeralReport, validate as ValidateFunc<IClusterEphemeralReport>);
