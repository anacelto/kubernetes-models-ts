 ...
 * PolicyReport is the Schema for the policyreports API
 */
export declare class PolicyReport extends Model<IPolicyReport> implements IPolicyReport {
    ...
    static apiVersion: IPolicyReport["apiVersion"];
    static kind: IPolicyReport["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPolicyReport>;
