 ...
 * ClusterPolicyReport is the Schema for the clusterpolicyreports API
 */
export declare class ClusterPolicyReport extends Model<IClusterPolicyReport> implements IClusterPolicyReport {
    ...
    static apiVersion: IClusterPolicyReport["apiVersion"];
    static kind: IClusterPolicyReport["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterPolicyReport>;
