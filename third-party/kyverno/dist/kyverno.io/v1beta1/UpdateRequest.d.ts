 ...
 * UpdateRequest is a request to process mutate and generate rules in background.
 */
export declare class UpdateRequest extends Model<IUpdateRequest> implements IUpdateRequest {
    ...
    static apiVersion: IUpdateRequest["apiVersion"];
    static kind: IUpdateRequest["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IUpdateRequest>;
