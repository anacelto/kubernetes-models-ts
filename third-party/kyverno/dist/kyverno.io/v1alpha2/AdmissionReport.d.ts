 ...
 * AdmissionReport is the Schema for the AdmissionReports API
 */
export declare class AdmissionReport extends Model<IAdmissionReport> implements IAdmissionReport {
    ...
    static apiVersion: IAdmissionReport["apiVersion"];
    static kind: IAdmissionReport["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAdmissionReport>;
