 ...
 * ClusterAdmissionReport is the Schema for the ClusterAdmissionReports API
 */
export declare class ClusterAdmissionReport extends Model<IClusterAdmissionReport> implements IClusterAdmissionReport {
    ...
    static apiVersion: IClusterAdmissionReport["apiVersion"];
    static kind: IClusterAdmissionReport["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterAdmissionReport>;
