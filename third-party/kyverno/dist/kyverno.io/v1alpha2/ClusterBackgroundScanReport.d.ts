 ...
 * ClusterBackgroundScanReport is the Schema for the ClusterBackgroundScanReports API
 */
export declare class ClusterBackgroundScanReport extends Model<IClusterBackgroundScanReport> implements IClusterBackgroundScanReport {
    ...
    static apiVersion: IClusterBackgroundScanReport["apiVersion"];
    static kind: IClusterBackgroundScanReport["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterBackgroundScanReport>;
