 ...
 * BackgroundScanReport is the Schema for the BackgroundScanReports API
 */
export declare class BackgroundScanReport extends Model<IBackgroundScanReport> implements IBackgroundScanReport {
    ...
    static apiVersion: IBackgroundScanReport["apiVersion"];
    static kind: IBackgroundScanReport["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IBackgroundScanReport>;
