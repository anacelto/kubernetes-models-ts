 ...
 * ClusterCleanupPolicy defines rule for resource cleanup.
 */
export declare class ClusterCleanupPolicy extends Model<IClusterCleanupPolicy> implements IClusterCleanupPolicy {
    ...
    static apiVersion: IClusterCleanupPolicy["apiVersion"];
    static kind: IClusterCleanupPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterCleanupPolicy>;
