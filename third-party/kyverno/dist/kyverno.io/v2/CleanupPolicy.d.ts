 ...
 * CleanupPolicy defines a rule for resource cleanup.
 */
export declare class CleanupPolicy extends Model<ICleanupPolicy> implements ICleanupPolicy {
    ...
    static apiVersion: ICleanupPolicy["apiVersion"];
    static kind: ICleanupPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICleanupPolicy>;
