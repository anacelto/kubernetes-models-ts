 ...
 * ClusterEphemeralReport is the Schema for the ClusterEphemeralReports API
 */
export declare class ClusterEphemeralReport extends Model<IClusterEphemeralReport> implements IClusterEphemeralReport {
    ...
    static apiVersion: IClusterEphemeralReport["apiVersion"];
    static kind: IClusterEphemeralReport["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterEphemeralReport>;
