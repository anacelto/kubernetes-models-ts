 ...
 * EphemeralReport is the Schema for the EphemeralReports API
 */
export declare class EphemeralReport extends Model<IEphemeralReport> implements IEphemeralReport {
    ...
    static apiVersion: IEphemeralReport["apiVersion"];
    static kind: IEphemeralReport["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IEphemeralReport>;
