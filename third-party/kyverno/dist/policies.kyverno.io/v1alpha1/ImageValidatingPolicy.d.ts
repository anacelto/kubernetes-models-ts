...
export declare class ImageValidatingPolicy extends Model<IImageValidatingPolicy> implements IImageValidatingPolicy {
    ...
    static apiVersion: IImageValidatingPolicy["apiVersion"];
    static kind: IImageValidatingPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IImageValidatingPolicy>;
