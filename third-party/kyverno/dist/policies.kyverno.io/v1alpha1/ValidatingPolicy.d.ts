...
export declare class ValidatingPolicy extends Model<IValidatingPolicy> implements IValidatingPolicy {
    ...
    static apiVersion: IValidatingPolicy["apiVersion"];
    static kind: IValidatingPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IValidatingPolicy>;
