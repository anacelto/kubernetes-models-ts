 ...
 * PodMonitor defines monitoring for a set of pods.
 */
export declare class PodMonitor extends Model<IPodMonitor> implements IPodMonitor {
    "apiVersion": IPodMonitor["apiVersion"];
    "kind": IPodMonitor["kind"];
    "metadata"?: IPodMonitor["metadata"];
    "spec": IPodMonitor["spec"];
    static apiVersion: IPodMonitor["apiVersion"];
    static kind: IPodMonitor["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPodMonitor>;
