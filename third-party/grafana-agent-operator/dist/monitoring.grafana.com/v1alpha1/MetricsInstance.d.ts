 ...
 * MetricsInstance controls an individual Metrics instance within a Grafana Agent deployment.
 */
export declare class MetricsInstance extends Model<IMetricsInstance> implements IMetricsInstance {
    ...
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMetricsInstance>;
