 ...
 * PodLogs defines how to collect logs for a pod.
 */
export declare class PodLogs extends Model<IPodLogs> implements IPodLogs {
    "apiVersion": IPodLogs["apiVersion"];
    "kind": IPodLogs["kind"];
    "metadata"?: IPodLogs["metadata"];
    "spec"?: IPodLogs["spec"];
    static apiVersion: IPodLogs["apiVersion"];
    static kind: IPodLogs["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPodLogs>;
