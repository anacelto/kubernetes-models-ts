...
import { validate } from "../../_schemas/MonitoringGrafanaComV1alpha1GrafanaAgent";
 ...
 * GrafanaAgent defines a Grafana Agent deployment.
 */
export class GrafanaAgent extends Model<IGrafanaAgent> implements IGrafanaAgent {
  "apiVersion": IGrafanaAgent["apiVersion"];
  "kind": IGrafanaAgent["kind"];
  "metadata"?: IGrafanaAgent["metadata"];
  "spec"?: IGrafanaAgent["spec"];

static apiVersion: IGrafanaAgent["apiVersion"] = "monitoring.grafana.com/v1alpha1";
static kind: IGrafanaAgent["kind"] = "GrafanaAgent";
static is = createTypeMetaGuard<IGrafanaAgent>(GrafanaAgent);

constructor(data?: ModelData<IGrafanaAgent>) {
  super();

  this.setDefinedProps({
    apiVersion: GrafanaAgent.apiVersion,
    kind: GrafanaAgent.kind,
    ...data
  } as IGrafanaAgent);
}
}
...
setValidateFunc(GrafanaAgent, validate as ValidateFunc<IGrafanaAgent>);
