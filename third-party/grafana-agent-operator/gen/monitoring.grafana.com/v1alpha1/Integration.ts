...
import { validate } from "../../_schemas/MonitoringGrafanaComV1alpha1Integration";
...
static apiVersion: IIntegration["apiVersion"] = "monitoring.grafana.com/v1alpha1";
static kind: IIntegration["kind"] = "Integration";
static is = createTypeMetaGuard<IIntegration>(Integration);
...
setValidateFunc(Integration, validate as ValidateFunc<IIntegration>);
