...
import { validate } from "../../_schemas/MonitoringGrafanaComV1alpha1LogsInstance";
 ...
 * LogsInstance controls an individual logs instance within a Grafana Agent deployment.
 */
export class LogsInstance extends Model<ILogsInstance> implements ILogsInstance {
  "apiVersion": ILogsInstance["apiVersion"];
  "kind": ILogsInstance["kind"];
  "metadata"?: ILogsInstance["metadata"];
  "spec"?: ILogsInstance["spec"];

static apiVersion: ILogsInstance["apiVersion"] = "monitoring.grafana.com/v1alpha1";
static kind: ILogsInstance["kind"] = "LogsInstance";
static is = createTypeMetaGuard<ILogsInstance>(LogsInstance);

constructor(data?: ModelData<ILogsInstance>) {
  super();

  this.setDefinedProps({
    apiVersion: LogsInstance.apiVersion,
    kind: LogsInstance.kind,
    ...data
  } as ILogsInstance);
}
}
...
setValidateFunc(LogsInstance, validate as ValidateFunc<ILogsInstance>);
