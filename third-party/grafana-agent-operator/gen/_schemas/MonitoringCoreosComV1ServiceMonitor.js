...
const schema19 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "GELrqjlc10NOJLOqGtaLqatamVSkjoyDLUSgL2BjGEc"
    }
  },
...
const schema24 = {
  "properties": {
    "endpoints": {
      "$ref": "XO1iuJKViQPZ7ayqdXwbZv9EGQZJqwkBXmlgTFX1Y"
    },
    "jobLabel": {
...
const schema25 = {
  "items": {
    "$ref": "frLobESqJv8rLOlTOKTyTkXQwWTxJvIOZVHvCvYY0E"
  },
  "type": "array"
};
const schema26 = {
...
function validate77(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.endpointParams !== undefined) {
      if (!validate48(data.endpointParams, {
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authorization !== undefined) {
      if (!validate62(data.authorization, {
    ...
    if (data.targetPort !== undefined) {
      if (!validate103(data.targetPort, {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate124(data.namespaceSelector, {
    ...
    if (data.podTargetLabels !== undefined) {
      if (!validate46(data.podTargetLabels, {
    ...
    if (data.targetLabels !== undefined) {
      if (!validate46(data.targetLabels, {
