...
const schema19 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "Ey35JeOADqO9MUELK2tVn1OPn3lglHNMtgDJmpE2I"
    }
  },
...
function validate76(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clientSecret !== undefined) {
      if (!validate81(data.clientSecret, {
    ...
    if (data.endpointParams !== undefined) {
      if (!validate45(data.endpointParams, {
...
function validate107(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate108(data.matchExpressions, {
...
function validate101(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.namespaceSelector !== undefined) {
      if (!validate102(data.namespaceSelector, {
    ...
    if (data.relabelingConfigs !== undefined) {
      if (!validate31(data.relabelingConfigs, {
...
function validate100(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.staticConfig !== undefined) {
      if (!validate118(data.staticConfig, {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authorization !== undefined) {
      if (!validate60(data.authorization, {
