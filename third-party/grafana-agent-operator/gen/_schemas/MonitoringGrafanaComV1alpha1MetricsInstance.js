...
const schema17 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "kWGYycAZ8bzVA7SnLDzASGT8s8Q6EuUGEaukRhp6c"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "7GAUj9ZCmsPuporRZONfbTioKriyA1LTzHK6ENQkoY"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "monitoring.grafana.com.v1alpha1.MetricsInstance"
};
const schema18 = {
  "type": "string",
...
function validate65(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clientSecret !== undefined) {
      if (!validate70(data.clientSecret, {
    ...
    if (data.endpointParams !== undefined) {
      if (!validate33(data.endpointParams, {
...
function validate87(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sendInterval !== undefined) {
      if (!validate21(data.sendInterval, {
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.maxSamplesPerSend !== undefined) {
      if (!validate41(data.maxSamplesPerSend, {
    ...
    if (data.retryOnRateLimit !== undefined) {
      if (!validate39(data.retryOnRateLimit, {
...
function validate112(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.insecureSkipVerify !== undefined) {
      if (!validate39(data.insecureSkipVerify, {
...
function validate124(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sourceLabels !== undefined) {
      if (!validate132(data.sourceLabels, {
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.metadataConfig !== undefined) {
      if (!validate87(data.metadataConfig, {
    ...
    if (data.queueConfig !== undefined) {
      if (!validate93(data.queueConfig, {
    ...
    if (data.remoteTimeout !== undefined) {
      if (!validate21(data.remoteTimeout, {
    ...
    if (data.writeRelabelConfigs !== undefined) {
      if (!validate123(data.writeRelabelConfigs, {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.additionalScrapeConfigs !== undefined) {
      if (!validate36(data.additionalScrapeConfigs, {
    ...
    if (data.maxWALTime !== undefined) {
      if (!validate21(data.maxWALTime, {
        instancePath: instancePath + "/maxWALTime",
        parentData: data,
        parentDataProperty: "maxWALTime",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.minWALTime !== undefined) {
      if (!validate21(data.minWALTime, {
        instancePath: instancePath + "/minWALTime",
        parentData: data,
        parentDataProperty: "minWALTime",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.podMonitorNamespaceSelector !== undefined) {
      if (!validate23(data.podMonitorNamespaceSelector, {
    ...
    if (data.podMonitorSelector !== undefined) {
      if (!validate23(data.podMonitorSelector, {
    ...
    if (data.probeNamespaceSelector !== undefined) {
      if (!validate23(data.probeNamespaceSelector, {
    ...
    if (data.probeSelector !== undefined) {
      if (!validate23(data.probeSelector, {
    ...
    if (data.remoteFlushDeadline !== undefined) {
      if (!validate21(data.remoteFlushDeadline, {
        instancePath: instancePath + "/remoteFlushDeadline",
        parentData: data,
        parentDataProperty: "remoteFlushDeadline",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.remoteWrite !== undefined) {
      if (!validate63(data.remoteWrite, {
    ...
    if (data.serviceMonitorNamespaceSelector !== undefined) {
      if (!validate23(data.serviceMonitorNamespaceSelector, {
    ...
    if (data.serviceMonitorSelector !== undefined) {
      if (!validate23(data.serviceMonitorSelector, {
    ...
    if (data.walTruncateFrequency !== undefined) {
      if (!validate21(data.walTruncateFrequency, {
        instancePath: instancePath + "/walTruncateFrequency",
        parentData: data,
        parentDataProperty: "walTruncateFrequency",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.writeStaleOnShutdown !== undefined) {
      if (!validate39(data.writeStaleOnShutdown, {
        instancePath: instancePath + "/writeStaleOnShutdown",
        parentData: data,
        parentDataProperty: "writeStaleOnShutdown",
        rootData
      })) {
        vErrors = vErrors === null ? validate39.errors : vErrors.concat(validate39.errors);
        errors = vErrors.length;
...
function validate45(data, {
  ...
  /*# sourceURL="monitoring.grafana.com.v1alpha1.MetricsInstance" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
