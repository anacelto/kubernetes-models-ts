...
const schema19 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "p3x64Ezh0GwBuAvzeuOK1J1U6Tel0A72zvrAsMbuo"
    }
  },
...
const schema24 = {
  "properties": {
    ...
    "podMetricsEndpoints": {
      "$ref": "S5cRgogoZ5XOAhqY9c25plKR99o4V2ag9bWBxLytosc"
    },
    "podTargetLabels": {
...
const schema26 = {
  "items": {
    "$ref": "tVwYtCMJyyO6zdQoV3otGb0p3NRk332hs1vAuWF6TcQ"
  },
  "type": "array"
};
const schema27 = {
...
function validate84(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clientSecret !== undefined) {
      if (!validate89(data.clientSecret, {
...
function validate115(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.insecureSkipVerify !== undefined) {
      if (!validate24(data.insecureSkipVerify, {
...
function validate69(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authorization !== undefined) {
      if (!validate70(data.authorization, {
    ...
    if (data.followRedirects !== undefined) {
      if (!validate24(data.followRedirects, {
    ...
    if (data.honorLabels !== undefined) {
      if (!validate24(data.honorLabels, {
    ...
    if (data.honorTimestamps !== undefined) {
      if (!validate24(data.honorTimestamps, {
    ...
    if (data.scrapeTimeout !== undefined) {
      if (!validate23(data.scrapeTimeout, {
...
function validate126(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate127(data.matchExpressions, {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podMetricsEndpoints !== undefined) {
      if (!validate68(data.podMetricsEndpoints, {
