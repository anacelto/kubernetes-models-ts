...
import { validate } from "../../_schemas/JaegertracingIoV1Jaeger";
...
export class Jaeger extends Model<IJaeger> implements IJaeger {
...
static apiVersion: IJaeger["apiVersion"] = "jaegertracing.io/v1";
static kind: IJaeger["kind"] = "Jaeger";
static is = createTypeMetaGuard<IJaeger>(Jaeger);
...
setValidateFunc(Jaeger, validate as ValidateFunc<IJaeger>);
