 ...
 *  A CertificateRequest is a one-shot resource, meaning it represents a single point in time request for a certificate and cannot be re-used.
 */
export declare class CertificateRequest extends Model<ICertificateRequest> implements ICertificateRequest {
    ...
    static apiVersion: ICertificateRequest["apiVersion"];
    static kind: ICertificateRequest["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ICertificateRequest>;
