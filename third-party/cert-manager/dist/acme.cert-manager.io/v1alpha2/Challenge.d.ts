 ...
 * Challenge is a type to represent a Challenge request with an ACME server
 */
export declare class Challenge extends Model<IChallenge> implements IChallenge {
    ...
    static apiVersion: IChallenge["apiVersion"];
    static kind: IChallenge["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IChallenge>;
