...
import { validate } from "../../_schemas/AwspcaCertManagerIoV1beta1AWSPCAClusterIssuer";
 ...
 * AWSPCAClusterIssuer is the Schema for the awspcaclusterissuers API
 */
export class AWSPCAClusterIssuer extends Model<IAWSPCAClusterIssuer> implements IAWSPCAClusterIssuer {
...
static apiVersion: IAWSPCAClusterIssuer["apiVersion"] = "awspca.cert-manager.io/v1beta1";
static kind: IAWSPCAClusterIssuer["kind"] = "AWSPCAClusterIssuer";
static is = createTypeMetaGuard<IAWSPCAClusterIssuer>(AWSPCAClusterIssuer);

constructor(data?: ModelData<IAWSPCAClusterIssuer>) {
  super();

  this.setDefinedProps({
    apiVersion: AWSPCAClusterIssuer.apiVersion,
    kind: AWSPCAClusterIssuer.kind,
    ...data
  } as IAWSPCAClusterIssuer);
}
}


setValidateFunc(AWSPCAClusterIssuer, validate as ValidateFunc<IAWSPCAClusterIssuer>);
