...
import { validate } from "../../_schemas/PolicyCertManagerIoV1alpha1CertificateRequestPolicy";
 ...
 * CertificateRequestPolicy is an object for describing a "policy profile" that makes decisions on whether applicable CertificateRequests should be approved or denied.
 */
export class CertificateRequestPolicy extends Model<ICertificateRequestPolicy> implements ICertificateRequestPolicy {
...
static apiVersion: ICertificateRequestPolicy["apiVersion"] = "policy.cert-manager.io/v1alpha1";
static kind: ICertificateRequestPolicy["kind"] = "CertificateRequestPolicy";
static is = createTypeMetaGuard<ICertificateRequestPolicy>(CertificateRequestPolicy);

constructor(data?: ModelData<ICertificateRequestPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: CertificateRequestPolicy.apiVersion,
    kind: CertificateRequestPolicy.kind,
    ...data
  } as ICertificateRequestPolicy);
}
}


setValidateFunc(CertificateRequestPolicy, validate as ValidateFunc<ICertificateRequestPolicy>);
