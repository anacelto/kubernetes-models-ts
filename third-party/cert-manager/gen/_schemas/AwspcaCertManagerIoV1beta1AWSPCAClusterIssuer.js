...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Tkkshs5vZIDsIg5FbBxtgmiN5yET76PnDkwi2tq9E"
    },
    "metadata": {
  ...
  "$id": "awspca.cert-manager.io.v1beta1.AWSPCAClusterIssuer"
};
const schema8 = {
  "type": "string",
...
function validate22(data, {
  ...
  /*# sourceURL="awspca.cert-manager.io.v1beta1.AWSPCAClusterIssuer" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
