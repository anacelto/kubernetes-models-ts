...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "mw07xRrKtcA427KQSKn2dg0vDzlV3PakgEpkT1w"
    },
    "status": {
  ...
  "$id": "certmanager.k8s.io.v1alpha1.CertificateRequest"
};
const schema11 = {
  "type": "string",
...
function validate25(data, {
  ...
  /*# sourceURL="certmanager.k8s.io.v1alpha1.CertificateRequest" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
