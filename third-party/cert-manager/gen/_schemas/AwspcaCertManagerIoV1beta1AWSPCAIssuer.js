...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "jUDsJ5X3LpWZIGRxlO7W8zYP8Ki1yRvzkLCBKeABg"
    },
    "kind": {
      "$ref": "kzo3UyGMWAShaPMhfYLCAk3IiJPaOWaGGSjbhdmpA0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "etfwf32T6KLvkbeikoAHVthvReFdcF1idtUHDTDfGrg"
    },
    "status": {
  ...
  "$id": "awspca.cert-manager.io.v1beta1.AWSPCAIssuer"
};
const schema8 = {
  "type": "string",
  "enum": ["awspca.cert-manager.io/v1beta1"]
};
function validate23(data, {
  ...
  if (!(data === "awspca.cert-manager.io/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.arn !== undefined) {
      if (!validate21(data.arn, {
        instancePath: instancePath + "/arn",
        parentData: data,
        parentDataProperty: "arn",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate42(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate46(data.observedGeneration, {
...
function validate22(data, {
  ...
  /*# sourceURL="awspca.cert-manager.io.v1beta1.AWSPCAIssuer" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
