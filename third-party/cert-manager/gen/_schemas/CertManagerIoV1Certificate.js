...
const schema16 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "OJ6q8WM0AFbYKfxmx0QDNEQM1UfN9XnEvpEAl4i5r4"
    },
    "status": {
      "$ref": "zeAjr0xpFtgUXwMxNT7LfxRR4sdCdfEfmmwg3MyRlCA"
    }
  },
...
const schema21 = {
  ...
  "properties": {
    "additionalOutputFormats": {
      "$ref": "qwo8Ash8fPAou6cZ87zqrQCVIkymZEkY5fXU35oHto"
    },
    "commonName": {
    ...
    "privateKey": {
      "$ref": "to3MdorLsxPvvxtKEUVhaN6M7INWW8F0jhD7x4MDFw"
    },
    "renewBefore": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema22 = {
  "type": "array",
  "items": {
    "$ref": "85aaahf7kAqpq9R74CgU7gAIxtZ8HnYxqZuzbFtEY"
  },
  "nullable": true
};
const schema23 = {
  ...
  "properties": {
    "type": {
      "$ref": "oFbqGBFUeSKSMky6rIbtfS83EltD80UE4sZkJWFXOY"
    }
  }
};
const schema24 = {
...
const schema27 = {
  ...
  "properties": {
    ...
    "rotationPolicy": {
      "$ref": "igfTlJTjcyfPbIZQTiaSMP4oxK2tkd37iDHK5FlNE"
    },
    "size": {
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.rotationPolicy !== undefined) {
      if (!validate75(data.rotationPolicy, {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.additionalOutputFormats !== undefined) {
      if (!validate47(data.additionalOutputFormats, {
        instancePath: instancePath + "/additionalOutputFormats",
        parentData: data,
        parentDataProperty: "additionalOutputFormats",
        rootData
      })) {
    ...
    if (data.literalSubject !== undefined) {
      if (!validate21(data.literalSubject, {
        instancePath: instancePath + "/literalSubject",
        parentData: data,
        parentDataProperty: "literalSubject",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.revisionHistoryLimit !== undefined) {
      if (!validate80(data.revisionHistoryLimit, {
    ...
    if (data.secretTemplate !== undefined) {
      if (!validate83(data.secretTemplate, {
...
function validate105(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate36(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate108(data.observedGeneration, {
...
function validate103(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.failedIssuanceAttempts !== undefined) {
      if (!validate35(data.failedIssuanceAttempts, {
        instancePath: instancePath + "/failedIssuanceAttempts",
        parentData: data,
        parentDataProperty: "failedIssuanceAttempts",
        rootData
      })) {
        vErrors = vErrors === null ? validate35.errors : vErrors.concat(validate35.errors);
        errors = vErrors.length;
    ...
    if (data.lastFailureTime !== undefined) {
      if (!validate36(data.lastFailureTime, {
    ...
    if (data.renewalTime !== undefined) {
      if (!validate36(data.renewalTime, {
