...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "JXnsL4W5XHrdfNX52oEUzbGPXLB1rps4RHeMwscNcg"
    },
    "kind": {
      "$ref": "WQzw2pqGu0lBR2n6KI46OS8rchQ4F26Qh5x4bvgeI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "Q38gusw4Riq1bMXmvvEDMHMB0WW9jhUIxaAnnNrEw8"
    },
    "status": {
      "$ref": "qUhYXUx0nArfHN5fnVjTHzeHMFw2OT9qx43jDhY"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "policy.cert-manager.io.v1alpha1.CertificateRequestPolicy"
};
const schema15 = {
  "type": "string",
  "enum": ["policy.cert-manager.io/v1alpha1"]
};
function validate36(data, {
  ...
  if (!(data === "policy.cert-manager.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate38(data, {
  ...
  if (!(data === "CertificateRequestPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  "properties": {
    "allowed": {
      "$ref": "eGKgEbYkQeWyXQDGRGvdLgQZqSPAzR9uhszmO6o17g"
    },
    "constraints": {
      "$ref": "Q6YijNXTOEJHForBRUCVnz3BzhhjGA35poZ09j07o3o"
    },
    "plugins": {
      "$ref": "reSTDU9gigDyY512wyml9A5iCkPo0GZiW4QpXoSVI0"
    },
    "selector": {
      "$ref": "6h83MydzqQJcyAN2f33BSVNzfYKJeIzY8gF4slgmI0"
    }
  },
  "required": ["selector"],
  "type": "object",
...
const schema20 = {
  "properties": {
    "commonName": {
      "$ref": "t5x02qzWm6IA5Gob96hv2QzNvAx5Au9diPGcqat04"
    },
    "dnsNames": {
      "$ref": "vNamTbKShNvOPLiTCP4Nv3ErQoxTKSrWQzA6mUkuFE"
    },
    "emailAddresses": {
      "$ref": "vNamTbKShNvOPLiTCP4Nv3ErQoxTKSrWQzA6mUkuFE"
    },
    ...
    "subject": {
      "$ref": "8LdHDT0Artpo6B25RVExtHqWH6LsQALleLiIdpVEY"
    },
    "uris": {
      "$ref": "vNamTbKShNvOPLiTCP4Nv3ErQoxTKSrWQzA6mUkuFE"
    },
...
const schema24 = {
  "properties": {
    ...
    "privateKey": {
      "$ref": "dcp83IarpSI2OnVo8A4id9OYdKliPGds0YXVlXQ"
    }
  },
  "type": "object",
  "nullable": true
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.minSize !== undefined) {
      if (!validate32(data.minSize, {
        instancePath: instancePath + "/minSize",
        parentData: data,
        parentDataProperty: "minSize",
        rootData
      })) {
        vErrors = vErrors === null ? validate32.errors : vErrors.concat(validate32.errors);
        errors = vErrors.length;
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.maxDuration !== undefined) {
      if (!validate30(data.maxDuration, {
    ...
    if (data.minDuration !== undefined) {
      if (!validate30(data.minDuration, {
        instancePath: instancePath + "/minDuration",
        parentData: data,
        parentDataProperty: "minDuration",
        rootData
      })) {
        vErrors = vErrors === null ? validate30.errors : vErrors.concat(validate30.errors);
        errors = vErrors.length;
...
const schema27 = {
  "additionalProperties": {
    "$ref": "bXt5ylPf2SGgRDnr4vHipk87LILVj64ycECfFk2sQ"
  },
  "type": "object",
  "properties": {},
  "nullable": true
...
const schema29 = {
  "properties": {
    "issuerRef": {
      "$ref": "J29FRyFUT17mkr3uI0dXEIZ2nxcf2MTxL6n67IrWNLY"
    },
    "namespace": {
      "$ref": "w5Y9GH1ajVT4H6ODvzYly4mdOs1LJIGsnt5VgK0eEQ"
    }
  },
  "type": "object"
};
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.constraints !== undefined) {
      if (!validate67(data.constraints, {
...
const schema32 = {
  "properties": {
    "conditions": {
      "$ref": "TSvdgzZ5rtw7TxeAaM7bjewm3lK1b4nQZUySMK64w"
    }
  },
  "type": "object",
  "nullable": true
...
const schema33 = {
  "items": {
    "$ref": "Q0hpx1DZrpOrdpPyyWmZz6A475D7V0JvKK5hQBPQ8"
  },
  "type": "array",
  "nullable": true
};
...
function validate35(data, {
  ...
  /*# sourceURL="policy.cert-manager.io.v1alpha1.CertificateRequestPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
