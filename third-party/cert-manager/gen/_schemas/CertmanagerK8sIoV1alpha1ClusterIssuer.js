...
export const validate = validate103;
const schema35 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "spec": {
      "$ref": "4nHyXREz7K3N8Lf6aFBuMoqJBaxdfnuyFmw2yjxmQRo"
    },
    "status": {
      "$ref": "MUbAMIPwqzuINyelFoVTSI8MzOMon7rdDEDvAaOMZoA"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "certmanager.k8s.io.v1alpha1.ClusterIssuer"
};
const schema36 = {
  "type": "string",
...
const schema39 = {};
import { validate as validate109 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema40 = {
  "properties": {
    "acme": {
      "$ref": "1II8TlJ6XwLd3o53xLP7XX9WgR9VEKNISrjmHMDIXrM"
    },
    "ca": {
    ...
    "vault": {
      "$ref": "KGqaKNrSYrMOO1lhQmX5vOnqCAnwp5ki7oWGttXxEKI"
    },
    "venafi": {
      "$ref": "M77mL5nPgPbpBE8M2QXEEJmgXc9yht722KfhqMFKzMA"
    }
  },
  "type": "object",
  "nullable": true
...
const schema41 = {
  "properties": {
    "dns01": {
      "$ref": "aLFipMrjdqBCjlrOQurVmDkkt9KmGsEcvsOeD6BSU"
    },
    "email": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "http01": {
      "$ref": "mnA5SnOw50r3JsBeFv9PVXb7X4W5QpH8NGihZ5I"
    },
    "privateKeySecretRef": {
    ...
    "solvers": {
      "$ref": "hPnLIXeY4ZrsXZkYzsLXqE6dtchSPlhFsANti2GRGY"
    }
  },
...
const schema42 = {
  "properties": {
    "providers": {
      "$ref": "RicKTXgzwLCUwSayqopz4vh5cY11afbxw3oSoJtOQM"
    }
  },
  "type": "object",
  "nullable": true
...
const schema43 = {
  "items": {
    "$ref": "SQFocP4tBGSncAqe9NkMHwo97puJiJzeZIPkdYsps"
  },
  "type": "array",
  "nullable": true
};
const schema44 = {
  "properties": {
    ...
    "azuredns": {
      "$ref": "WigS6BH5gCXfoQbT5b4uA14OXtU1RLraytziz7n4s"
    },
    "clouddns": {
      "$ref": "ZVBKsD51nTmzXnhd4O7hOpaDZ9xNiitLzA7FiwQ8"
    },
    "cloudflare": {
      "$ref": "f84sQXRsv9wDWvQbqvx7PUghRFnPkQXZWSD3qIs"
    },
    "cnameStrategy": {
    ...
    "webhook": {
      "$ref": "Qr0S36wqisKyhmNXozysABPQqFPVr4Ie3rLkM0tTK0"
    }
  },
  "required": ["name"],
  "type": "object"
...
function validate29(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.accountSecretRef !== undefined) {
      if (!validate22(data.accountSecretRef, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.accessTokenSecretRef !== undefined) {
      if (!validate22(data.accessTokenSecretRef, {
    ...
    if (data.clientSecretSecretRef !== undefined) {
      if (!validate22(data.clientSecretSecretRef, {
    ...
    if (data.clientTokenSecretRef !== undefined) {
      if (!validate22(data.clientTokenSecretRef, {
...
const schema12 = {
  ...
  "required": ["clientID", "clientSecretSecretRef", "resourceGroupName", "subscriptionID", "tenantID"],
  "type": "object",
  "nullable": true
};
const schema13 = {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.environment !== undefined) {
      if (!validate40(data.environment, {
    ...
    if (data.hostedZoneName !== undefined) {
      if (!validate23(data.hostedZoneName, {
...
const schema14 = {
  ...
  "required": ["project", "serviceAccountSecretRef"],
  "type": "object",
  "nullable": true
};
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.serviceAccountSecretRef === undefined) {
      const err2 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "serviceAccountSecretRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.serviceAccountSecretRef !== undefined) {
      if (!validate22(data.serviceAccountSecretRef, {
...
const schema15 = {
  ...
  "required": ["apiKeySecretRef", "email"],
  "type": "object",
  "nullable": true
};
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiKeySecretRef === undefined) {
      const err1 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "apiKeySecretRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.apiKeySecretRef !== undefined) {
      if (!validate22(data.apiKeySecretRef, {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tsigAlgorithm !== undefined) {
      if (!validate23(data.tsigAlgorithm, {
    ...
    if (data.tsigKeyName !== undefined) {
      if (!validate23(data.tsigKeyName, {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.hostedZoneID !== undefined) {
      if (!validate23(data.hostedZoneID, {
...
function validate116(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cnameStrategy !== undefined) {
      if (!validate52(data.cnameStrategy, {
    ...
    if (data.digitalocean !== undefined) {
      if (!validate53(data.digitalocean, {
...
function validate132(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.serviceType !== undefined) {
      if (!validate23(data.serviceType, {
...
const schema47 = {
  "items": {
    "$ref": "fj4gpeAtdbZaODVXS6bMeFw1X4LxW0foUQcXjlfzpo"
  },
  "type": "array",
  "nullable": true
};
const schema48 = {
  "properties": {
    "dns01": {
      "$ref": "mnDpt3tUwtNiOjUj4LWxwf9dWMeOZSXgfOMrBssag"
    },
    "http01": {
      "$ref": "JUsGtGgVnHpXcoatzoUD5IHjWXrlTtZDM3WPYTzWpus"
    },
    "selector": {
...
const schema50 = {
  "properties": {
    "ingress": {
      "$ref": "rGSm0kO1sFIuKnJAZ4hvmVLNDkxh3nsIUzTe5rIoIs"
    }
  },
  "type": "object",
  "nullable": true
...
const schema51 = {
  "properties": {
    ...
    "podTemplate": {
      "$ref": "tIrOWFwvWbkdsBQYXPLlgTDyrwD86ltnVcclNvIDc"
    },
    "serviceType": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema52 = {
  "properties": {
    ...
    "spec": {
      "$ref": "FwZNTti0mX5KkpckjgnD9a546g1R0jqnh2S2Qec"
    }
  },
  "type": "object",
  "nullable": true
...
function validate79(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate71(data.matchExpressions, {
    ...
    if (data.matchFields !== undefined) {
      if (!validate71(data.matchFields, {
...
function validate168(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelectorTerms !== undefined) {
      if (!validate169(data.nodeSelectorTerms, {
...
function validate161(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate162(data.preferredDuringSchedulingIgnoredDuringExecution, {
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate168(data.requiredDuringSchedulingIgnoredDuringExecution, {
...
function validate83(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.labelSelector !== undefined) {
      if (!validate84(data.labelSelector, {
...
function validate94(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podAffinityTerm !== undefined) {
      if (!validate83(data.podAffinityTerm, {
...
function validate92(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate93(data.preferredDuringSchedulingIgnoredDuringExecution, {
        instancePath: instancePath + "/preferredDuringSchedulingIgnoredDuringExecution",
        parentData: data,
        parentDataProperty: "preferredDuringSchedulingIgnoredDuringExecution",
        rootData
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate99(data.requiredDuringSchedulingIgnoredDuringExecution, {
        instancePath: instancePath + "/requiredDuringSchedulingIgnoredDuringExecution",
        parentData: data,
        parentDataProperty: "requiredDuringSchedulingIgnoredDuringExecution",
        rootData
...
function validate160(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nodeAffinity !== undefined) {
      if (!validate161(data.nodeAffinity, {
    ...
    if (data.podAffinity !== undefined) {
      if (!validate92(data.podAffinity, {
    ...
    if (data.podAntiAffinity !== undefined) {
      if (!validate92(data.podAntiAffinity, {
...
function validate179(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tolerationSeconds !== undefined) {
      if (!validate183(data.tolerationSeconds, {
...
function validate159(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelector !== undefined) {
      if (!validate86(data.nodeSelector, {
    ...
    if (data.tolerations !== undefined) {
      if (!validate178(data.tolerations, {
...
function validate154(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podTemplate !== undefined) {
      if (!validate157(data.podTemplate, {
...
function validate113(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.privateKeySecretRef !== undefined) {
      if (!validate22(data.privateKeySecretRef, {
    ...
    if (data.skipTLSVerify !== undefined) {
      if (!validate137(data.skipTLSVerify, {
...
const schema65 = {
  "properties": {
    "auth": {
      "$ref": "eo1NbxPhWQ8a2Z6MWkibqZUdAhAePQjFCqO1xkQ"
    },
    "caBundle": {
...
function validate206(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tokenSecretRef !== undefined) {
      if (!validate26(data.tokenSecretRef, {
        instancePath: instancePath + "/tokenSecretRef",
        parentData: data,
        parentDataProperty: "tokenSecretRef",
        rootData
...
const schema68 = {
  "properties": {
    "cloud": {
      "$ref": "cDPoXqRYiWJwZMLOf4vElJfqpKl2SQjd7HynX55Q9A"
    },
    "tpp": {
...
const schema69 = {
  ...
  "required": ["apiTokenSecretRef", "url"],
  "type": "object",
  "nullable": true
};
function validate219(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiTokenSecretRef !== undefined) {
      if (!validate22(data.apiTokenSecretRef, {
...
function validate223(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.credentialsRef !== undefined) {
      if (!validate225(data.credentialsRef, {
...
function validate234(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.lastRegisteredEmail !== undefined) {
      if (!validate23(data.lastRegisteredEmail, {
...
function validate239(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate240(data.lastTransitionTime, {
...
function validate233(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate238(data.conditions, {
...
function validate103(data, {
  ...
  /*# sourceURL="certmanager.k8s.io.v1alpha1.ClusterIssuer" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiVersion !== undefined) {
      if (!validate104(data.apiVersion, {
