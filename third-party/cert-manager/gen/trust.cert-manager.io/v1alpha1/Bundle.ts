...
import { validate } from "../../_schemas/TrustCertManagerIoV1alpha1Bundle";
...
export class Bundle extends Model<IBundle> implements IBundle {
...
static apiVersion: IBundle["apiVersion"] = "trust.cert-manager.io/v1alpha1";
static kind: IBundle["kind"] = "Bundle";
static is = createTypeMetaGuard<IBundle>(Bundle);
...
setValidateFunc(Bundle, validate as ValidateFunc<IBundle>);
