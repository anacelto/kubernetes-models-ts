...
import { validate } from "../../_schemas/FissionIoV1KubernetesWatchTrigger";
 ...
 * KubernetesWatchTrigger watches kubernetes resource events and invokes functions.
 */
export class KubernetesWatchTrigger extends Model<IKubernetesWatchTrigger> implements IKubernetesWatchTrigger {
...
static apiVersion: IKubernetesWatchTrigger["apiVersion"] = "fission.io/v1";
static kind: IKubernetesWatchTrigger["kind"] = "KubernetesWatchTrigger";
static is = createTypeMetaGuard<IKubernetesWatchTrigger>(KubernetesWatchTrigger);

constructor(data?: ModelData<IKubernetesWatchTrigger>) {
  super();

  this.setDefinedProps({
    apiVersion: KubernetesWatchTrigger.apiVersion,
    kind: KubernetesWatchTrigger.kind,
    ...data
  } as IKubernetesWatchTrigger);
}
}


setValidateFunc(KubernetesWatchTrigger, validate as ValidateFunc<IKubernetesWatchTrigger>);
