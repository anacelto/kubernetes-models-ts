...
import { validate } from "../../_schemas/FissionIoV1Function";
 ...
 * Function is function runs within environment runtime with given package and secrets/configmaps.
 */
export class Function extends Model<IFunction> implements IFunction {
  "apiVersion": IFunction["apiVersion"];
  "kind": IFunction["kind"];
  "metadata": IFunction["metadata"];
  "spec": IFunction["spec"];

static apiVersion: IFunction["apiVersion"] = "fission.io/v1";
static kind: IFunction["kind"] = "Function";
static is = createTypeMetaGuard<IFunction>(Function);

constructor(data?: ModelData<IFunction>) {
  super();
...
setValidateFunc(Function, validate as ValidateFunc<IFunction>);
