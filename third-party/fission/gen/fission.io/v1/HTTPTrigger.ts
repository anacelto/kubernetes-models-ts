...
import { validate } from "../../_schemas/FissionIoV1HTTPTrigger";
 ...
 * HTTPTrigger is the trigger invokes user functions when receiving HTTP requests.
 */
export class HTTPTrigger extends Model<IHTTPTrigger> implements IHTTPTrigger {
  "apiVersion": IHTTPTrigger["apiVersion"];
  "kind": IHTTPTrigger["kind"];
  "metadata": IHTTPTrigger["metadata"];
  "spec": IHTTPTrigger["spec"];

static apiVersion: IHTTPTrigger["apiVersion"] = "fission.io/v1";
static kind: IHTTPTrigger["kind"] = "HTTPTrigger";
static is = createTypeMetaGuard<IHTTPTrigger>(HTTPTrigger);

constructor(data?: ModelData<IHTTPTrigger>) {
  super();

  this.setDefinedProps({
    apiVersion: HTTPTrigger.apiVersion,
    kind: HTTPTrigger.kind,
    ...data
  } as IHTTPTrigger);
}
}
...
setValidateFunc(HTTPTrigger, validate as ValidateFunc<IHTTPTrigger>);
