...
import { validate } from "../../_schemas/FissionIoV1MessageQueueTrigger";
 ...
 * MessageQueueTrigger invokes functions when messages arrive to certain topic that trigger subscribes to.
 */
export class MessageQueueTrigger extends Model<IMessageQueueTrigger> implements IMessageQueueTrigger {
  "apiVersion": IMessageQueueTrigger["apiVersion"];
  "kind": IMessageQueueTrigger["kind"];
  "metadata": IMessageQueueTrigger["metadata"];
  "spec": IMessageQueueTrigger["spec"];

static apiVersion: IMessageQueueTrigger["apiVersion"] = "fission.io/v1";
static kind: IMessageQueueTrigger["kind"] = "MessageQueueTrigger";
static is = createTypeMetaGuard<IMessageQueueTrigger>(MessageQueueTrigger);

constructor(data?: ModelData<IMessageQueueTrigger>) {
  super();

  this.setDefinedProps({
    apiVersion: MessageQueueTrigger.apiVersion,
    kind: MessageQueueTrigger.kind,
    ...data
...
setValidateFunc(MessageQueueTrigger, validate as ValidateFunc<IMessageQueueTrigger>);
