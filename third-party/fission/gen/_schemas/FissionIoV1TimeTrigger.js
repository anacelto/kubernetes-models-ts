...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "TRwz1UUJ9gkRa1nEQtBNz5KkBB5N6B0nYByJH0WaY0"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "bgQbc1phBcVWCUD1a87MCqrDln4g45uBmPnaIzE"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "fission.io.v1.TimeTrigger"
};
const schema8 = {
  "type": "string",
  "enum": ["fission.io/v1"]
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.functionweights !== undefined) {
      if (!validate34(data.functionweights, {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.functionref !== undefined) {
      if (!validate33(data.functionref, {
...
function validate22(data, {
  ...
  /*# sourceURL="fission.io.v1.TimeTrigger" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
