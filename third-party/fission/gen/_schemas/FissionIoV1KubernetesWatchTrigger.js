...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Qamf3CnLSZ8dEleI54mEuc3gpSJ6ftEFJ77BfTcGg"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "fzV1I8oxFDxKmyQXi3SGXPiXeSmP1GBWZdfVhGDOEiA"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "fission.io.v1.KubernetesWatchTrigger"
};
const schema8 = {
  "type": "string",
  "enum": ["fission.io/v1"]
...
function validate25(data, {
  ...
  if (!(data === "KubernetesWatchTrigger")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema12 = {
  ...
  "required": ["functionref", "namespace", "type"],
  "type": "object"
};
const schema13 = {
  "properties": {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.functionweights !== undefined) {
      if (!validate33(data.functionweights, {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.functionref !== undefined) {
      if (!validate32(data.functionref, {
    ...
    if (data.labelselector !== undefined) {
      if (!validate40(data.labelselector, {
...
function validate22(data, {
  ...
  /*# sourceURL="fission.io.v1.KubernetesWatchTrigger" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
