...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Q5Zr5exd36xfbCgi9HBAWNPujqm6D3l06gMgGiG2aY"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "DxQvhsLWTtib9qfIMRjYCkRD1LGq5RvJmhYYsKgWU"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "fission.io.v1.HTTPTrigger"
};
const schema10 = {
  "type": "string",
  "enum": ["fission.io/v1"]
...
const schema14 = {
  "properties": {
    ...
    "functionref": {
      "$ref": "M0KgE05YxIxhp0eRpZoKCFBTsyPVNHqlUn7EpYPqA"
    },
    "host": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
    "ingressconfig": {
      "$ref": "MFjv2ndQcOkvNaIbeTFFFvNRU0CRfgjdYUlHAvR4"
    },
    "keepPrefix": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.functionweights !== undefined) {
      if (!validate36(data.functionweights, {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.createingress !== undefined) {
      if (!validate23(data.createingress, {
        instancePath: instancePath + "/createingress",
        parentData: data,
        parentDataProperty: "createingress",
        rootData
      })) {
    ...
    if (data.functionref !== undefined) {
      if (!validate35(data.functionref, {
    ...
    if (data.ingressconfig !== undefined) {
      if (!validate44(data.ingressconfig, {
        instancePath: instancePath + "/ingressconfig",
        parentData: data,
        parentDataProperty: "ingressconfig",
        rootData
      })) {
    ...
    if (data.keepPrefix !== undefined) {
      if (!validate23(data.keepPrefix, {
        instancePath: instancePath + "/keepPrefix",
        parentData: data,
        parentDataProperty: "keepPrefix",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.relativeurl !== undefined) {
      if (!validate22(data.relativeurl, {
        instancePath: instancePath + "/relativeurl",
        parentData: data,
        parentDataProperty: "relativeurl",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="fission.io.v1.HTTPTrigger" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
