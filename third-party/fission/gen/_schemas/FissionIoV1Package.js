...
const schema11 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "wrc1FziHgpKNfLZZWEPsiiV2g9vHEtW3b2v6UPz7OkI"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "JYWZK7meVI3BZcqfwUZvI5qrjT4uq5yKurWB1sYSyg"
    },
    "status": {
      "$ref": "BdUVT1ANQysuW5LeMnFzE7686VoSJWPZYsV7pcUvI"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "fission.io.v1.Package"
};
const schema12 = {
  "type": "string",
  "enum": ["fission.io/v1"]
...
const schema16 = {
  "properties": {
    ...
    "deployment": {
      "$ref": "JLmF93CzMeZG66mE0lqJWWmMlQWA2i87OdgGU4uoa5c"
    },
    "environment": {
...
const schema8 = {
  "properties": {
    "checksum": {
      "$ref": "28IeGmvYISAX70GaTdydMjbQArnutjjoE7AmhXb4TY"
    },
    "literal": {
...
function validate24(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.sum !== undefined) {
      if (!validate21(data.sum, {
        instancePath: instancePath + "/sum",
        parentData: data,
        parentDataProperty: "sum",
        rootData
      })) {
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.buildcmd !== undefined) {
      if (!validate21(data.buildcmd, {
        instancePath: instancePath + "/buildcmd",
        parentData: data,
        parentDataProperty: "buildcmd",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.environment !== undefined) {
      if (!validate44(data.environment, {
...
const schema18 = {
  "properties": {
    ...
    "buildstatus": {
      "$ref": "ioLLzcM0XcZFc0N1MJDooEEEeGhAwoU4ZrSlKOs1Q"
    },
    "lastUpdateTimestamp": {
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.buildlog !== undefined) {
      if (!validate21(data.buildlog, {
        instancePath: instancePath + "/buildlog",
        parentData: data,
        parentDataProperty: "buildlog",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.buildstatus !== undefined) {
      if (!validate52(data.buildstatus, {
        instancePath: instancePath + "/buildstatus",
        parentData: data,
        parentDataProperty: "buildstatus",
        rootData
      })) {
    ...
    if (data.lastUpdateTimestamp !== undefined) {
      if (!validate54(data.lastUpdateTimestamp, {
...
function validate32(data, {
  ...
  /*# sourceURL="fission.io.v1.Package" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
