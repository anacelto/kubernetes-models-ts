 ...
 * Function is function runs within environment runtime with given package and secrets/configmaps.
 */
export declare class Function extends Model<IFunction> implements IFunction {
    "apiVersion": IFunction["apiVersion"];
    "kind": IFunction["kind"];
    "metadata": IFunction["metadata"];
    "spec": IFunction["spec"];
    static apiVersion: IFunction["apiVersion"];
    static kind: IFunction["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IFunction>;
