 ...
 * Package Think of these as function-level images.
 */
export declare class Package extends Model<IPackage> implements IPackage {
    "apiVersion": IPackage["apiVersion"];
    "kind": IPackage["kind"];
    "metadata": IPackage["metadata"];
    "spec": IPackage["spec"];
    "status"?: IPackage["status"];
    static apiVersion: IPackage["apiVersion"];
    static kind: IPackage["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPackage>;
