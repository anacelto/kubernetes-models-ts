 ...
 * MessageQueueTrigger invokes functions when messages arrive to certain topic that trigger subscribes to.
 */
export declare class MessageQueueTrigger extends Model<IMessageQueueTrigger> implements IMessageQueueTrigger {
    ...
    static apiVersion: IMessageQueueTrigger["apiVersion"];
    static kind: IMessageQueueTrigger["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IMessageQueueTrigger>;
