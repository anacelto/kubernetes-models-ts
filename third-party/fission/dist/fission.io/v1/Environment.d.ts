 ...
 * Environment is environment for building and running user functions.
 */
export declare class Environment extends Model<IEnvironment> implements IEnvironment {
    "apiVersion": IEnvironment["apiVersion"];
    "kind": IEnvironment["kind"];
    "metadata": IEnvironment["metadata"];
    "spec": IEnvironment["spec"];
    static apiVersion: IEnvironment["apiVersion"];
    static kind: IEnvironment["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IEnvironment>;
