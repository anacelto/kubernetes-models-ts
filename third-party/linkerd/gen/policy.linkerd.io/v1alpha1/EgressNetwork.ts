...
import { validate } from "../../_schemas/PolicyLinkerdIoV1alpha1EgressNetwork";
 ...
 * An EgressNetwork captures traffic to egress destinations
 */
export class EgressNetwork extends Model<IEgressNetwork> implements IEgressNetwork {
...
static apiVersion: IEgressNetwork["apiVersion"] = "policy.linkerd.io/v1alpha1";
static kind: IEgressNetwork["kind"] = "EgressNetwork";
static is = createTypeMetaGuard<IEgressNetwork>(EgressNetwork);

constructor(data?: ModelData<IEgressNetwork>) {
  super();

  this.setDefinedProps({
    apiVersion: EgressNetwork.apiVersion,
    kind: EgressNetwork.kind,
    ...data
  } as IEgressNetwork);
}
}
...
setValidateFunc(EgressNetwork, validate as ValidateFunc<IEgressNetwork>);
