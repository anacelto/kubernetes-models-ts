...
import { validate } from "../../_schemas/PolicyLinkerdIoV1alpha1HTTPLocalRateLimitPolicy";
...
export class HTTPLocalRateLimitPolicy extends Model<IHTTPLocalRateLimitPolicy> implements IHTTPLocalRateLimitPolicy {
...
static apiVersion: IHTTPLocalRateLimitPolicy["apiVersion"] = "policy.linkerd.io/v1alpha1";
static kind: IHTTPLocalRateLimitPolicy["kind"] = "HTTPLocalRateLimitPolicy";
static is = createTypeMetaGuard<IHTTPLocalRateLimitPolicy>(HTTPLocalRateLimitPolicy);

constructor(data?: ModelData<IHTTPLocalRateLimitPolicy>) {
  super();

  this.setDefinedProps({
    apiVersion: HTTPLocalRateLimitPolicy.apiVersion,
    kind: HTTPLocalRateLimitPolicy.kind,
    ...data
  } as IHTTPLocalRateLimitPolicy);
}
}


setValidateFunc(HTTPLocalRateLimitPolicy, validate as ValidateFunc<IHTTPLocalRateLimitPolicy>);
