...
const schema7 = {
  ...
  "properties": {
    "spec": {
      "$ref": "UftbtQARsbXaJdfazwl0nHIm49wzJxW4T40I4oSmKk"
    },
    "apiVersion": {
  ...
  "$id": "policy.linkerd.io.v1alpha1.Server"
};
const schema8 = {
  "type": "object",
  "required": ["podSelector", "port"],
  "properties": {
    "podSelector": {
      "$ref": "OM8TBSDEQFYlmT4C6hjPWO5doFOUcdHUPSjwOFWs0"
    },
    "port": {
...
const schema9 = {
  "type": "object",
  "oneOf": [{
    "$ref": "R8JZjuu9i61zUoisHJ8SH3tlWYByPNVbLM044ZlA"
  }, {
    "$ref": "mqd8DDPiwsg5UxoEltZk5zaJQj2D5TuExHkPAPhdRc"
  }],
  "properties": {
    "matchLabels": {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions === undefined) {
      const err0 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "matchExpressions"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podSelector !== undefined) {
      if (!validate24(data.podSelector, {
    ...
    if (data.proxyProtocol !== undefined) {
      if (!validate44(data.proxyProtocol, {
...
function validate22(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1alpha1.Server" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
