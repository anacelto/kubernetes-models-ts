...
const schema12 = {
  ...
  "properties": {
    "spec": {
      "$ref": "NiUeKK3GOaaW0aS7WAos5TFXBZDEjwBvWyowduLbM"
    },
    "apiVersion": {
      "$ref": "LU6o1J5YWuUN91Oc4orXYo9AWx34yog9gJAPpEI2hkw"
    },
    "kind": {
  ...
  "$id": "linkerd.io.v1alpha1.ServiceProfile"
};
const schema13 = {
  "type": "object",
  "required": ["routes"],
  "properties": {
    ...
    "routes": {
      "$ref": "oukHfFt0JmUCJF02JBDzqbBEMIx09tPIpwblzpYJbY"
    }
  },
  "nullable": true
};
...
function validate28(data, {
  ...
  /*# sourceURL="linkerd.io.v1alpha1.ServiceProfile" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
