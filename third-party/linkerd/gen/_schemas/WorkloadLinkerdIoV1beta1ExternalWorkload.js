...
const schema9 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "09LedXdadYjBWffvsoN0ATdECXYgTGgxBmDlRm0zAM"
    },
    "status": {
      "$ref": "2ienIzNTgCV9sRrvSxiHlwxLKzrQwxvVvSf5JrH5Y"
    },
    "apiVersion": {
      "$ref": "YhhdKt2D1ay6dQfhX0hqgXyfayThjFissNcvpaoU"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "workload.linkerd.io.v1beta1.ExternalWorkload"
};
const schema7 = {
  "type": "string",
  "nullable": true
...
const schema13 = {
  "properties": {
    ...
    "workloadIPs": {
      "$ref": "Aoywx5vAXVQuLFyWX0ffnMeK0sA4Nom3zR0M3jk0X2A"
    }
  },
  "type": "object",
  "required": ["meshTLS"]
...
const schema28 = {
  "type": "string",
  "enum": ["workload.linkerd.io/v1beta1"]
};
function validate68(data, {
  ...
  if (!(data === "workload.linkerd.io/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate24(data, {
  ...
  /*# sourceURL="workload.linkerd.io.v1beta1.ExternalWorkload" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
