...
const schema13 = {
  ...
  "properties": {
    "spec": {
      "$ref": "VdXIk6M1Ns6XJAylAgriKVTZtGi73kDFPf4plS9xDE"
    },
    "apiVersion": {
  ...
  "$id": "policy.linkerd.io.v1beta3.Server"
};
const schema14 = {
  "type": "object",
  "required": ["port"],
  ...
  "properties": {
    "accessPolicy": {
      "$ref": "6PasAixSxZWWBgEwTTjttvOSabneP7AMLRb8Lqb8"
    },
    "podSelector": {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.accessPolicy !== undefined) {
      if (!validate41(data.accessPolicy, {
...
function validate35(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1beta3.Server" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
