...
const schema7 = {
  ...
  "properties": {
    "spec": {
      "$ref": "7rI9gp5hX36QS1E1Qji13BGd3sXBqmdapWnwY8zJY20"
    },
    "apiVersion": {
      "$ref": "QIUZ5N0tgSnGp07DbkpWDq2wypmECDam5fRTFiCEaok"
    },
    "kind": {
      "$ref": "HrDm2RUSfPIUASppZhQmPKlzA6lZfmzg7ROmQ5ELQ9Y"
    },
    "metadata": {
  ...
  "$id": "policy.linkerd.io.v1alpha1.NetworkAuthentication"
};
const schema8 = {
  "type": "object",
  "required": ["networks"],
  "properties": {
    "networks": {
      "$ref": "qYDZnXyxOC558UiT6jJzYrc6z5oh1ufkrNGoLm5iyw"
    }
  }
};
const schema9 = {
...
function validate22(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1alpha1.NetworkAuthentication" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
