...
const schema28 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "8B9AS8r2ahZdGLopfuky3qD7WVcSKlhQiglzozOYR4"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "AkZTqy8dAZZQ7GfdoSVOWuPKhsySeXMkOJGmzZjKJU"
    },
    "status": {
  ...
  "$id": "policy.linkerd.io.v1beta3.HTTPRoute"
};
const schema29 = {
  "type": "string",
  "enum": ["policy.linkerd.io/v1beta3"]
};
function validate65(data, {
  ...
  if (!(data === "policy.linkerd.io/v1beta3")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema33 = {
  "properties": {
    ...
    "parentRefs": {
      "$ref": "4kuQDvob6s1Mjd4VKkfOLQt9PYN4Bfu9beMSkswY"
    },
    "rules": {
      "$ref": "fdU8qyFnqRPzbulzEKmDZxwOSTivjOceJqPreNZMA"
    }
  },
  "type": "object"
};
...
const schema37 = {
  ...
  "items": {
    "$ref": "xfbBDfkFcnE2pwL45HpdxHB9cX5Oc1jTifUkX4SF8L0"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema38 = {
  "properties": {
    "backendRefs": {
      "$ref": "l3P9pwO9KHoBZELUU9H96qhXEzk3HAKlhVtqS2O08"
    },
    "filters": {
    ...
    "timeouts": {
      "$ref": "95wPxD9RjRlJBYTleBdFzXEr9GLiMXkNSbA1Cd8Cc"
    }
  },
  "type": "object"
};
const schema39 = {
  "items": {
    "$ref": "j9LyMTs8tUtGmdbvF5hl0JD8JDCk10RR7kCFqGumVA"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const pattern1 = new RegExp("^[A-Za-z0-9!#$%&'*+\\-.^_\\x60|~]+$", "u");
...
function validate95(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.requestRedirect !== undefined) {
      if (!validate40(data.requestRedirect, {
...
function validate114(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.queryParams !== undefined) {
      if (!validate130(data.queryParams, {
...
function validate141(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendRequest !== undefined) {
      if (!validate54(data.backendRequest, {
...
function validate64(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1beta3.HTTPRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
