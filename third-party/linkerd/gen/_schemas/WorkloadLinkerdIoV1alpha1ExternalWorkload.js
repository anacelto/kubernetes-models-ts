...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "WlvrQoDHv6QAJroamcK4D0kQCvensxegdrGJeHO4t3Y"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "SYp01JIyrrlUqn2zDFDpDf1NsHMI1aHAnz14pJkQ"
    },
    "status": {
      "$ref": "2ienIzNTgCV9sRrvSxiHlwxLKzrQwxvVvSf5JrH5Y"
    },
    "apiVersion": {
      "$ref": "xro2SXm1DW0JGmN0UgK6r4CQ7tiDyESTjBQ6x6M8"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "workload.linkerd.io.v1alpha1.ExternalWorkload"
};
const schema7 = {
  "type": "string",
  "nullable": true
...
const schema13 = {
  "properties": {
    "meshTls": {
      "$ref": "p6tyeQrEbexoyNSSDzcSmVn5kDZM2bAVX7ozRoi9Iac"
    },
    "ports": {
      "$ref": "UGZROEfxyWjYlFz5Ru3wn6DdH50xWBiIjut1AK2nCCw"
    },
    "workloadIPs": {
      "$ref": "VcDCFQ1mcXZLb10j24JPwXijwmQiOvb7v9fKZorw"
    }
  },
  "type": "object",
  "required": ["meshTls"]
...
const schema15 = {
  "type": "array",
  "items": {
    "$ref": "E6zzr3t4YYHCC8NA3AphRjb2dOVYCwxSclhhZeoU"
  },
  "nullable": true
};
const schema16 = {
...
const schema19 = {
  "type": "array",
  "items": {
    "$ref": "zEEKMNOaN36LGfhdYFClYWAhIv308OS4auOqrT55Y"
  },
  "maxItems": 1,
  "nullable": true
};
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.workloadIPs !== undefined) {
      if (!validate46(data.workloadIPs, {
        instancePath: instancePath + "/workloadIPs",
        parentData: data,
        parentDataProperty: "workloadIPs",
        rootData
      })) {
...
const schema21 = {
  ...
  "properties": {
    "conditions": {
      "$ref": "GByOQN8kXPQotzg0wOUrwjkJBn1G8yFYkuc0Wg7D6C8"
    }
  },
  "nullable": true
};
const schema22 = {
  "type": "array",
  "items": {
    "$ref": "Q6orDYLw00XtEQ611FXM39REtEbFPO4Q0GXQSJpA"
  },
...
const pattern0 = new RegExp("^([a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*/)?(([A-Za-z0-9][-A-Za-z0-9_.]*)?[A-Za-z0-9])$", "u");
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.lastProbeTime !== undefined) {
      if (!validate23(data.lastProbeTime, {
...
const schema28 = {
  "type": "string",
  "enum": ["workload.linkerd.io/v1alpha1"]
};
function validate68(data, {
  ...
  if (!(data === "workload.linkerd.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate24(data, {
  ...
  /*# sourceURL="workload.linkerd.io.v1alpha1.ExternalWorkload" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.apiVerson !== undefined) {
      if (!validate22(data.apiVerson, {
        instancePath: instancePath + "/apiVerson",
        parentData: data,
        parentDataProperty: "apiVerson",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
