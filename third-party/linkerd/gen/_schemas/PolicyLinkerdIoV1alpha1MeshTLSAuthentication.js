...
const schema6 = {
  ...
  "properties": {
    "spec": {
      "$ref": "NzoIyWkxRlSfiA7xVnBupLsEsV1MpMLSgjCnvKOSLI"
    },
    "apiVersion": {
      "$ref": "QIUZ5N0tgSnGp07DbkpWDq2wypmECDam5fRTFiCEaok"
    },
    "kind": {
      "$ref": "Jz2QB9MoqesP9CDwIQCNzlcReEzSQlkJjCU8LwnKkU"
    },
    "metadata": {
  ...
  "$id": "policy.linkerd.io.v1alpha1.MeshTLSAuthentication"
};
const schema7 = {
  "type": "object",
  "oneOf": [{
    "$ref": "R5Pw1DrdMqgIwyoGcofVpbwz11WfaOOu7Nbu7PyZNM"
  }, {
    "$ref": "AMqwMMZMBPm3lpt4cB31FX4J2zkpJsEi1IVWO7Kin2U"
  }],
  "properties": {
    "identities": {
    ...
    "identityRefs": {
      "$ref": "fvq5ra8fcD2XvDCrtywhcIwW1z5uudGDf5O7b8W5ak"
    }
  }
};
const schema8 = {
...
function validate25(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.identityRefs === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "identityRefs"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
const schema12 = {
  ...
  "minItems": 1,
  "items": {
    "$ref": "DEqBJq68WiTAncJyAAaAcZcBKgCjzcoaNtQ502sDE"
  },
  "nullable": true
};
const schema13 = {
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.identityRefs !== undefined) {
      if (!validate31(data.identityRefs, {
        instancePath: instancePath + "/identityRefs",
        parentData: data,
        parentDataProperty: "identityRefs",
        rootData
      })) {
...
function validate21(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1alpha1.MeshTLSAuthentication" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
