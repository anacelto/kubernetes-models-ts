...
const schema13 = {
  ...
  "properties": {
    "spec": {
      "$ref": "2CF7ZQu151APuUZzfiV511SirsRhU4nduVAYvWc2k"
    },
    "apiVersion": {
      "$ref": "8u3ESohQUIGXRePhawpcm8EmBEBZG1eV2r8zQGojMGk"
    },
    "kind": {
  ...
  "$id": "policy.linkerd.io.v1beta2.Server"
};
const schema14 = {
  "type": "object",
  "required": ["port"],
  "oneOf": [{
    "$ref": "ayV6fHA6rFvyBBN2RNObkHGJnpWeZl8ZdaE5SpH1mUE"
  }, {
    "$ref": "NZ2L9fACUGVh7Dacce8FJ7uaShmp2hA0SxARTiRtOM"
  }],
  "properties": {
    "podSelector": {
    ...
    "proxyProtocol": {
      "$ref": "xS1NQlfUbupPOpamFPpSqA47agyLhy92Q4VyYEfs"
    }
  }
};
const schema15 = {
...
function validate39(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.externalWorkloadSelector === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "externalWorkloadSelector"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
function validate22(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.matchExpressions !== undefined) {
      if (!validate25(data.matchExpressions, {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podSelector !== undefined) {
      if (!validate22(data.podSelector, {
    ...
    if (data.externalWorkloadSelector !== undefined) {
      if (!validate22(data.externalWorkloadSelector, {
        instancePath: instancePath + "/externalWorkloadSelector",
        parentData: data,
        parentDataProperty: "externalWorkloadSelector",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.proxyProtocol !== undefined) {
      if (!validate45(data.proxyProtocol, {
...
const schema19 = {
  "type": "string",
  "enum": ["policy.linkerd.io/v1beta2"]
};
function validate48(data, {
  ...
  if (!(data === "policy.linkerd.io/v1beta2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate35(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1beta2.Server" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
