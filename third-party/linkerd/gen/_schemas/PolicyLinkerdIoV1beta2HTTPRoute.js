...
const schema27 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "ynjKMU8EYFqCBPn6sa9cdw5eeeB8apSUQUNYl0MsM"
    },
    "status": {
  ...
  "$id": "policy.linkerd.io.v1beta2.HTTPRoute"
};
const schema28 = {
  "type": "string",
...
const schema32 = {
  "properties": {
    ...
    "rules": {
      "$ref": "kyynurguvxZ9bft03gpvDD5bFNgn80Kse6tzg1DBbs"
    }
  },
  "type": "object"
};
...
const schema36 = {
  ...
  "items": {
    "$ref": "8sQ5A66ru24iqARYdLTmY721giWEu7sX2fBtGQXscY"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
function validate113(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.queryParams !== undefined) {
      if (!validate129(data.queryParams, {
...
function validate81(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.backendRefs !== undefined) {
      if (!validate82(data.backendRefs, {
...
function validate147(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate148(data.lastTransitionTime, {
...
function validate145(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conditions !== undefined) {
      if (!validate146(data.conditions, {
    ...
    if (data.controllerName !== undefined) {
      if (!validate162(data.controllerName, {
...
function validate63(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1beta2.HTTPRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
