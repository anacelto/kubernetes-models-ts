...
const schema10 = {
  ...
  "properties": {
    "spec": {
      "$ref": "P2bRJ07b2wDShADNGlzbYMoQugNIAvyLMI2PNwvQ"
    },
    "apiVersion": {
      "$ref": "lYEa1aJZCHL84jTMcupYlsntZWsVIGB9TSHWx09vtk"
    },
    "kind": {
      "$ref": "8f9t7QFjwyJFBOAQpKwIqeKTm2ImsIBEnsBc961mxb4"
    },
    "metadata": {
  ...
  "$id": "policy.linkerd.io.v1beta1.ServerAuthorization"
};
const schema11 = {
  "type": "object",
  ...
  "properties": {
    "server": {
      "$ref": "AHsmewbfm6OIEf2vkWoQa3Q8kYome11FUacaOWPTc"
    },
    "client": {
      "$ref": "lHnuNpAKnPgQH2uZqX5B2GvIcXKxBz0GlJgh5BiU"
    }
  }
};
const schema12 = {
  ...
  "oneOf": [{
    ...
    "$ref": "fWEJTxkbb8v2jgIl56eIdjq2Vdr3junuQOYIrYW6ZY"
  }],
  "properties": {
    "name": {
      "$ref": "VCzBiQYImpZ6Spb7FEz6VfSZ9J3zHBraRIaE3ZaE"
    },
    "selector": {
      "$ref": "frrSSuKwDw1p8oNAac7mA8r3wHjU9woL2NsndfaSkI"
    }
  }
};
const schema13 = {
...
const schema20 = {
  ...
  "properties": {
    "networks": {
      "$ref": "xpD40IpiYO0BL6xsElNGJkSiBJJuByvQpTpfVPGxko"
    },
    "unauthenticated": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
    "meshTLS": {
      "$ref": "8jazf7cLODefCJ0IjGj4uO29jni8hK3xXrPAgKCpLE"
    }
  }
};
const schema21 = {
  "type": "array",
  "items": {
    "$ref": "zWPTxYvHonYUWnt6QxXpnR2hjrDwMqqCsX9NIdwqH8"
  },
  "nullable": true
};
const schema22 = {
...
const schema23 = {
  ...
  "properties": {
    ...
    "identities": {
      "$ref": "qdhkjsn2dX2Gy38rrC1Ao9RXxkKIfwmRh1KuVkkU0g"
    },
    "serviceAccounts": {
      "$ref": "xNmdGJ2lq9S0KIJm37DqYLmRhN2hutQ4V9HeAI"
    }
  },
  "nullable": true
};
const schema24 = {
  "type": "array",
  "items": {
    "$ref": "DjZRdIXERppucKTRArSzOlhzhFh04IkAMlnojFRHY"
  },
  "nullable": true
};
const schema25 = {
...
const schema26 = {
  "type": "array",
  "items": {
    "$ref": "UJbeqE7TNj8GYDPnEMwpgE7a3NgnXd9kzWuU21QAmRQ"
  },
  "nullable": true
};
const schema27 = {
  ...
  "properties": {
    "name": {
      "$ref": "2BaaDknHNlTisuu57iJDLVPg6I14fL8nr0sqP53bfY"
    },
    "namespace": {
      "$ref": "VCzBiQYImpZ6Spb7FEz6VfSZ9J3zHBraRIaE3ZaE"
    }
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.unauthenticatedTLS !== undefined) {
      if (!validate24(data.unauthenticatedTLS, {
        instancePath: instancePath + "/unauthenticatedTLS",
        parentData: data,
        parentDataProperty: "unauthenticatedTLS",
        rootData
      })) {
    ...
    if (data.serviceAccounts !== undefined) {
      if (!validate61(data.serviceAccounts, {
        instancePath: instancePath + "/serviceAccounts",
        parentData: data,
        parentDataProperty: "serviceAccounts",
        rootData
      })) {
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.networks !== undefined) {
      if (!validate48(data.networks, {
        instancePath: instancePath + "/networks",
        parentData: data,
        parentDataProperty: "networks",
        rootData
      })) {
    ...
    if (data.unauthenticated !== undefined) {
      if (!validate24(data.unauthenticated, {
        instancePath: instancePath + "/unauthenticated",
        parentData: data,
        parentDataProperty: "unauthenticated",
        rootData
      })) {
        vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);
        errors = vErrors.length;
    ...
    if (data.meshTLS !== undefined) {
      if (!validate55(data.meshTLS, {
        instancePath: instancePath + "/meshTLS",
        parentData: data,
        parentDataProperty: "meshTLS",
        rootData
      })) {
...
const schema29 = {
  "type": "string",
  "enum": ["policy.linkerd.io/v1beta1"]
};
function validate71(data, {
  ...
  if (!(data === "policy.linkerd.io/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema32 = {};
import { validate as validate76 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
function validate26(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1beta1.ServerAuthorization" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
