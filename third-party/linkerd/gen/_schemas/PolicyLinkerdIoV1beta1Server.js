...
const schema7 = {
  ...
  "properties": {
    "spec": {
      "$ref": "3yW5NjPx9DYTFKAHwNDPgO6qcewvcZ4WNj3HdoR6sYk"
    },
    "apiVersion": {
  ...
  "$id": "policy.linkerd.io.v1beta1.Server"
};
const schema8 = {
  "type": "object",
  ...
  "properties": {
    "podSelector": {
      "$ref": "xvhM0dFSKZtkWSltEG7EcAzZSeHxKxOLEnPKWcgurg"
    },
    "port": {
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.proxyProtocol !== undefined) {
      if (!validate40(data.proxyProtocol, {
...
function validate22(data, {
  ...
  /*# sourceURL="policy.linkerd.io.v1beta1.Server" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
