...
const schema18 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "RC3yd4vSbqJp5Tnr1RWFann5mbQDPkZ0D826NgyPME0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "QptJuNwxuy0Ntc2Wo82oNi8J7i82TxXlE3oCvOh0sQ"
    },
    "status": {
  ...
  "$id": "monitoring.banzaicloud.io.v1alpha1.StoreEndpoint"
};
const schema19 = {
  "type": "string",
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.servicePort !== undefined) {
      if (!validate36(data.servicePort, {
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ingressOverrides !== undefined) {
      if (!validate64(data.ingressOverrides, {
...
function validate111(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.externalIPs !== undefined) {
      if (!validate44(data.externalIPs, {
    ...
    if (data.healthCheckNodePort !== undefined) {
      if (!validate43(data.healthCheckNodePort, {
    ...
    if (data.loadBalancerSourceRanges !== undefined) {
      if (!validate44(data.loadBalancerSourceRanges, {
    ...
    if (data.sessionAffinityConfig !== undefined) {
      if (!validate140(data.sessionAffinityConfig, {
...
function validate55(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.metaOverrides !== undefined) {
      if (!validate40(data.metaOverrides, {
    ...
    if (data.serviceOverrides !== undefined) {
      if (!validate109(data.serviceOverrides, {
...
function validate46(data, {
  ...
  /*# sourceURL="monitoring.banzaicloud.io.v1alpha1.StoreEndpoint" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
