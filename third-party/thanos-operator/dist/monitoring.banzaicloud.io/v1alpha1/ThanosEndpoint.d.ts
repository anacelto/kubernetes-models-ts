...
export declare class ThanosEndpoint extends Model<IThanosEndpoint> implements IThanosEndpoint {
    ...
    static apiVersion: IThanosEndpoint["apiVersion"];
    static kind: IThanosEndpoint["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IThanosEndpoint>;
