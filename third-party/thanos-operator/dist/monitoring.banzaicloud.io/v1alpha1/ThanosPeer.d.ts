...
export declare class ThanosPeer extends Model<IThanosPeer> implements IThanosPeer {
    ...
    static apiVersion: IThanosPeer["apiVersion"];
    static kind: IThanosPeer["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IThanosPeer>;
