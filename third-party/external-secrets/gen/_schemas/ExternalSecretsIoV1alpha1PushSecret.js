...
const schema12 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "oCoBuIoaL8tRC7x33Q5Rwjnf8Ub7f4m8bBktRjL67hA"
    },
    "status": {
      "$ref": "Ykzli5vj7qzsJsWrO4AKbdugaz5rDmUSGNHbNtk2Cz0"
    }
  },
...
const schema17 = {
  "properties": {
    "data": {
      "$ref": "H9mjI62iCueNLv9ZQ7OvJuN9vuIcVFyNH7aLq8Vc1Y"
    },
    "deletionPolicy": {
    ...
    "selector": {
      "$ref": "ce2Lil7QUn4YeCupjNECUQuVjCVohHfhOkKcYGOqgM"
    }
  },
...
const schema18 = {
  "items": {
    "$ref": "KUzDRROz0O3e2svqgPmhGryswWwddFazpNVd3Kw6w"
  },
  "type": "array",
  "nullable": true
};
const schema9 = {
  "properties": {
    "match": {
      "$ref": "MAEReoVvSlhhWHWjzhxyQzr8TPcp4q2MvMHHL3lT5sc"
    }
  },
  "required": ["match"],
  "type": "object"
...
const schema10 = {
  "properties": {
    "remoteRef": {
      "$ref": "gXeNmwsPkKLlnttnHY0cUd2LY69UBDCfECcOpX51Dy4"
    },
    "secretKey": {
...
function validate51(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate61(data.matchLabels, {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.labelSelector !== undefined) {
      if (!validate51(data.labelSelector, {
...
function validate40(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deletionPolicy !== undefined) {
      if (!validate44(data.deletionPolicy, {
    ...
    if (data.secretStoreRefs !== undefined) {
      if (!validate47(data.secretStoreRefs, {
...
const schema30 = {
  "properties": {
    ...
    "syncedPushSecrets": {
      "$ref": "43VsJUaSMlOdc8g2jo3ae6dBisAVKldcDsWPOL7EMI"
    },
...
const schema33 = {
  "additionalProperties": {
    "$ref": "FsyDNywcZRn4gBqzJLtbw2h90zEH2gb8hIGADn1j0HU"
  },
  "type": "object",
  "properties": {},
  "nullable": true
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.refreshTime !== undefined) {
      if (!validate23(data.refreshTime, {
    ...
    if (data.syncedPushSecrets !== undefined) {
      if (!validate85(data.syncedPushSecrets, {
    ...
    if (data.syncedResourceVersion !== undefined) {
      if (!validate22(data.syncedResourceVersion, {
