...
const schema11 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "qmyeQWiZftUgwdZUW5CtsnRyu7JIt1rdGnzqINPs"
    }
  },
...
const schema16 = {
  "properties": {
    ...
    "provider": {
      "$ref": "SyECzH6QoIN10xDcopG5u1JLn4Zfh7R6VWzvc7Go"
    }
  },
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.expirationSeconds !== undefined) {
      if (!validate63(data.expirationSeconds, {
    ...
    if (data.serviceAccountRef !== undefined) {
      if (!validate65(data.serviceAccountRef, {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.kubernetesServiceAccountToken !== undefined) {
      if (!validate61(data.kubernetesServiceAccountToken, {
...
function validate76(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.serviceAccountRef !== undefined) {
      if (!validate81(data.serviceAccountRef, {
        instancePath: instancePath + "/serviceAccountRef",
        parentData: data,
        parentDataProperty: "serviceAccountRef",
        rootData
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.forwardInconsistent !== undefined) {
      if (!validate29(data.forwardInconsistent, {
    ...
    if (data.readYourWrites !== undefined) {
      if (!validate29(data.readYourWrites, {
