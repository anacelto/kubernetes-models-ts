...
const schema20 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "yr6wDv3ZaoC0YJHyQWiSrxsWHN3c9WbQyoZLAtHyHM"
    },
    "status": {
      "$ref": "z6zW3YY7efB8gXgQ5efVTRfCCavBBIIrKbgMX5b6d7w"
    }
  },
...
const schema25 = {
  "properties": {
    ...
    "externalSecretSpec": {
      "$ref": "qh2FHRvx61o4CV5gkHm23ZcAHKSJV2QOC7Vg6adCrcY"
    },
    "namespaceSelector": {
  ...
  "required": ["externalSecretSpec", "namespaceSelector"],
  "type": "object",
  "nullable": true
};
const schema6 = {
...
function validate116(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.engineVersion !== undefined) {
      if (!validate118(data.engineVersion, {
    ...
    if (data.templateFrom !== undefined) {
      if (!validate124(data.templateFrom, {
...
function validate108(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.creationPolicy !== undefined) {
      if (!validate109(data.creationPolicy, {
    ...
    if (data.deletionPolicy !== undefined) {
      if (!validate111(data.deletionPolicy, {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.refreshInterval !== undefined) {
      if (!validate105(data.refreshInterval, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaceSelector === undefined) {
      const err2 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "namespaceSelector"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.externalSecretName !== undefined) {
      if (!validate21(data.externalSecretName, {
    ...
    if (data.externalSecretSpec !== undefined) {
      if (!validate60(data.externalSecretSpec, {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate137(data.namespaceSelector, {
    ...
    if (data.refreshTime !== undefined) {
      if (!validate21(data.refreshTime, {
...
function validate149(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate150(data.conditions, {
    ...
    if (data.failedNamespaces !== undefined) {
      if (!validate157(data.failedNamespaces, {
    ...
    if (data.provisionedNamespaces !== undefined) {
      if (!validate47(data.provisionedNamespaces, {
