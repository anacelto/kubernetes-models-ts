...
export declare class VaultDynamicSecret extends Model<IVaultDynamicSecret> implements IVaultDynamicSecret {
    ...
    static apiVersion: IVaultDynamicSecret["apiVersion"];
    static kind: IVaultDynamicSecret["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IVaultDynamicSecret>;
