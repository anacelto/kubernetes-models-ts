 ...
 *  See docs: https://github.com/Azure/acr/blob/main/docs/AAD-OAuth.md
 */
export declare class ACRAccessToken extends Model<IACRAccessToken> implements IACRAccessToken {
    "apiVersion": IACRAccessToken["apiVersion"];
    "kind": IACRAccessToken["kind"];
    "metadata"?: IACRAccessToken["metadata"];
    "spec"?: IACRAccessToken["spec"];
    static apiVersion: IACRAccessToken["apiVersion"];
    static kind: IACRAccessToken["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IACRAccessToken>;
