 ...
 * Password generates a random password based on the configuration parameters in spec. You can specify the length, characterset and other attributes.
 */
export declare class Password extends Model<IPassword> implements IPassword {
    "apiVersion": IPassword["apiVersion"];
    "kind": IPassword["kind"];
    "metadata"?: IPassword["metadata"];
    "spec"?: IPassword["spec"];
    static apiVersion: IPassword["apiVersion"];
    static kind: IPassword["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPassword>;
