    ...
    "spec"?: {
        ...
        "provider": {
            ...
            "doppler"?: {
                 ...
                 */
                "nameTransformer"?: "upper-camel" | "camel" | "lower-snake" | "tf-var" | "dotnet-env";
                /**
 ...
 * ClusterSecretStore represents a secure external location for storing secrets, which can be referenced as part of `storeRef` fields.
 */
export declare class ClusterSecretStore extends Model<IClusterSecretStore> implements IClusterSecretStore {
    ...
    static apiVersion: IClusterSecretStore["apiVersion"];
    static kind: IClusterSecretStore["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterSecretStore>;
