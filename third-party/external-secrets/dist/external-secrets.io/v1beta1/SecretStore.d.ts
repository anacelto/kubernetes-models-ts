 ...
 * SecretStore represents a secure external location for storing secrets, which can be referenced as part of `storeRef` fields.
 */
export declare class SecretStore extends Model<ISecretStore> implements ISecretStore {
    ...
    static apiVersion: ISecretStore["apiVersion"];
    static kind: ISecretStore["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISecretStore>;
