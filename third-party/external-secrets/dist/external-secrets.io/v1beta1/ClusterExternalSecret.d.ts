 ...
 * ClusterExternalSecret is the Schema for the clusterexternalsecrets API.
 */
export declare class ClusterExternalSecret extends Model<IClusterExternalSecret> implements IClusterExternalSecret {
    ...
    static apiVersion: IClusterExternalSecret["apiVersion"];
    static kind: IClusterExternalSecret["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IClusterExternalSecret>;
