 ...
 * ExternalSecret is the Schema for the external-secrets API.
 */
export declare class ExternalSecret extends Model<IExternalSecret> implements IExternalSecret {
    ...
    static apiVersion: IExternalSecret["apiVersion"];
    static kind: IExternalSecret["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IExternalSecret>;
