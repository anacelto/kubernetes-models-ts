...
export declare class PushSecret extends Model<IPushSecret> implements IPushSecret {
    ...
    static apiVersion: IPushSecret["apiVersion"];
    static kind: IPushSecret["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IPushSecret>;
