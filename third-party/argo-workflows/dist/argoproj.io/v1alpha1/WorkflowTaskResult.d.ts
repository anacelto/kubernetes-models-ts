...
export declare class WorkflowTaskResult extends Model<IWorkflowTaskResult> implements IWorkflowTaskResult {
    ...
    static apiVersion: IWorkflowTaskResult["apiVersion"];
    static kind: IWorkflowTaskResult["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IWorkflowTaskResult>;
