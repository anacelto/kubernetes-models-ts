...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "zPx5B4KkTX4mn3oATvThQVj6ye1XcMn46kubLQmYqw"
    },
    "metadata": {
  ...
  "$id": "argoproj.io.v1alpha1.WorkflowTaskSet"
};
const schema7 = {
  "type": "string",
...
function validate21(data, {
  ...
  /*# sourceURL="argoproj.io.v1alpha1.WorkflowTaskSet" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
