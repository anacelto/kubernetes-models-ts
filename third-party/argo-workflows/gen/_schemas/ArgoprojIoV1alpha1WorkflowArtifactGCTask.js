...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "9HkB5j0q5zqtHziZQZG5wwcmqvP6TFEHSFObO9oHvw"
    },
    "metadata": {
  ...
  "$id": "argoproj.io.v1alpha1.WorkflowArtifactGCTask"
};
const schema7 = {
  "type": "string",
...
function validate24(data, {
  ...
  if (!(data === "WorkflowArtifactGCTask")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  /*# sourceURL="argoproj.io.v1alpha1.WorkflowArtifactGCTask" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
