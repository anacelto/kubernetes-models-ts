...
const schema6 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "q83YgD2q42RZMtzZqnyz7FzxoAVmt17nQC7kiaE7ARo"
    },
    "metadata": {
  ...
  "$id": "argoproj.io.v1alpha1.ClusterWorkflowTemplate"
};
const schema7 = {
  "type": "string",
...
function validate24(data, {
  ...
  if (!(data === "ClusterWorkflowTemplate")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  /*# sourceURL="argoproj.io.v1alpha1.ClusterWorkflowTemplate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
