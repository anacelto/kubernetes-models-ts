...
import { validate } from "../../_schemas/AutoscalingK8sElasticCoV1alpha1ElasticsearchAutoscaler";
...
static apiVersion: IElasticsearchAutoscaler["apiVersion"] = "autoscaling.k8s.elastic.co/v1alpha1";
