...
import { validate } from "../../_schemas/ElasticsearchK8sElasticCoV1Elasticsearch";
...
export interface IElasticsearch {
  ...
  "spec"?: {
     ...
     */
    "volumeClaimDeletePolicy"?: "DeleteOnScaledownOnly" | "DeleteOnScaledownAndClusterDeletion";
  };
  /**
...
static apiVersion: IElasticsearch["apiVersion"] = "elasticsearch.k8s.elastic.co/v1";
