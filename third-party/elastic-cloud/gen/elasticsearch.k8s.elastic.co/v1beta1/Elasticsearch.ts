...
import { validate } from "../../_schemas/ElasticsearchK8sElasticCoV1beta1Elasticsearch";
...
static apiVersion: IElasticsearch["apiVersion"] = "elasticsearch.k8s.elastic.co/v1beta1";
