...
import { validate } from "../../_schemas/EnterprisesearchK8sElasticCoV1EnterpriseSearch";
...
static apiVersion: IEnterpriseSearch["apiVersion"] = "enterprisesearch.k8s.elastic.co/v1";
