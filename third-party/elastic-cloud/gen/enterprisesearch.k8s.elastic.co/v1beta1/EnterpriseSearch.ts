...
import { validate } from "../../_schemas/EnterprisesearchK8sElasticCoV1beta1EnterpriseSearch";
 ...
 * EnterpriseSearch is a Kubernetes CRD to represent Enterprise Search.
 */
export class EnterpriseSearch extends Model<IEnterpriseSearch> implements IEnterpriseSearch {
...
static apiVersion: IEnterpriseSearch["apiVersion"] = "enterprisesearch.k8s.elastic.co/v1beta1";
static kind: IEnterpriseSearch["kind"] = "EnterpriseSearch";
static is = createTypeMetaGuard<IEnterpriseSearch>(EnterpriseSearch);

constructor(data?: ModelData<IEnterpriseSearch>) {
  super();

  this.setDefinedProps({
    apiVersion: EnterpriseSearch.apiVersion,
    kind: EnterpriseSearch.kind,
    ...data
  } as IEnterpriseSearch);
}
}


setValidateFunc(EnterpriseSearch, validate as ValidateFunc<IEnterpriseSearch>);
