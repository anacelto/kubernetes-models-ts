...
import { validate } from "../../_schemas/MapsK8sElasticCoV1alpha1ElasticMapsServer";

/**
 * ElasticMapsServer represents an Elastic Map Server resource in a Kubernetes cluster.
 */
export interface IElasticMapsServer {
  /**
 ...
 * ElasticMapsServer represents an Elastic Map Server resource in a Kubernetes cluster.
 */
export class ElasticMapsServer extends Model<IElasticMapsServer> implements IElasticMapsServer {
  "apiVersion": IElasticMapsServer["apiVersion"];
  "kind": IElasticMapsServer["kind"];
  "metadata"?: IElasticMapsServer["metadata"];
  "spec"?: IElasticMapsServer["spec"];
  "status"?: IElasticMapsServer["status"];

static apiVersion: IElasticMapsServer["apiVersion"] = "maps.k8s.elastic.co/v1alpha1";
static kind: IElasticMapsServer["kind"] = "ElasticMapsServer";
static is = createTypeMetaGuard<IElasticMapsServer>(ElasticMapsServer);

constructor(data?: ModelData<IElasticMapsServer>) {
  super();

  this.setDefinedProps({
    apiVersion: ElasticMapsServer.apiVersion,
    kind: ElasticMapsServer.kind,
    ...data
  } as IElasticMapsServer);
}
}


setValidateFunc(ElasticMapsServer, validate as ValidateFunc<IElasticMapsServer>);
