...
import { validate } from "../../_schemas/ApmK8sElasticCoV1beta1ApmServer";
...
export class ApmServer extends Model<IApmServer> implements IApmServer {
  ...
  "spec"?: IApmServer["spec"];
  "status"?: IApmServer["status"];

static apiVersion: IApmServer["apiVersion"] = "apm.k8s.elastic.co/v1beta1";
