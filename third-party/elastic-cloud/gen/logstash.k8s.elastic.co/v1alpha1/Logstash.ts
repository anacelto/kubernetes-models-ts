...
import { validate } from "../../_schemas/LogstashK8sElasticCoV1alpha1Logstash";
 ...
 * Logstash is the Schema for the logstashes API
 */
export class Logstash extends Model<ILogstash> implements ILogstash {
  "apiVersion": ILogstash["apiVersion"];
  "kind": ILogstash["kind"];
  "metadata"?: ILogstash["metadata"];
  "spec"?: ILogstash["spec"];
  "status"?: ILogstash["status"];

static apiVersion: ILogstash["apiVersion"] = "logstash.k8s.elastic.co/v1alpha1";
static kind: ILogstash["kind"] = "Logstash";
static is = createTypeMetaGuard<ILogstash>(Logstash);

constructor(data?: ModelData<ILogstash>) {
  super();

  this.setDefinedProps({
    apiVersion: Logstash.apiVersion,
    kind: Logstash.kind,
    ...data
  } as ILogstash);
}
...
setValidateFunc(Logstash, validate as ValidateFunc<ILogstash>);
