...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "3JDATl3M27W6hTUXzCTiPHNgti8e2aS4VeRODLaS4"
    },
    "kind": {
      "$ref": "qtpOZSW7os1wERGM8hIJa7jfgHaFyTMFYvpmCz3rg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "uF4AgmFYmujvnSslFHWlXkjXSu86g4AKCz8YLejJZk"
    },
    "status": {
      "$ref": "4tgn2YTAisxJpvezCUKad1Uarf6gkhMbAE1qE3ICE"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "enterprisesearch.k8s.elastic.co.v1.EnterpriseSearch"
};
const schema15 = {
  "type": "string",
  "enum": ["enterprisesearch.k8s.elastic.co/v1"]
};
function validate33(data, {
  ...
  if (!(data === "enterprisesearch.k8s.elastic.co/v1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  "properties": {
    ...
    "elasticsearchRef": {
      "$ref": "BpN9ewqSCgYbHq2i7DG1oaQu1b7cXSbg2H2KYQ4Q8w"
    },
    "http": {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sessionAffinityConfig !== undefined) {
      if (!validate93(data.sessionAffinityConfig, {
...
function validate103(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.subjectAltNames !== undefined) {
      if (!validate105(data.subjectAltNames, {
...
function validate101(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificate !== undefined) {
      if (!validate29(data.certificate, {
    ...
    if (data.selfSignedCertificate !== undefined) {
      if (!validate103(data.selfSignedCertificate, {
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.configRef !== undefined) {
      if (!validate29(data.configRef, {
        instancePath: instancePath + "/configRef",
        parentData: data,
        parentDataProperty: "configRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate29.errors : vErrors.concat(validate29.errors);
        errors = vErrors.length;
    ...
    if (data.elasticsearchRef !== undefined) {
      if (!validate45(data.elasticsearchRef, {
    ...
    if (data.podTemplate !== undefined) {
      if (!validate31(data.podTemplate, {
    ...
    if (data.revisionHistoryLimit !== undefined) {
      if (!validate27(data.revisionHistoryLimit, {
...
function validate120(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.associationStatus !== undefined) {
      if (!validate21(data.associationStatus, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate125(data.observedGeneration, {
...
function validate32(data, {
  ...
  /*# sourceURL="enterprisesearch.k8s.elastic.co.v1.EnterpriseSearch" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
