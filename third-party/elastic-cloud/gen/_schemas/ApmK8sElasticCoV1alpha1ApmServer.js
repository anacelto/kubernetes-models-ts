...
const schema6 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "SSEMLCshziKow1cnoNFnolFwEnOw8XOLGSJwW1I"
    },
    "kind": {
      "$ref": "5XP5FsAatJ7gld51voHHhD8uNezQrKIZdXdIo7d7JY"
    },
    "metadata": {
...
const schema7 = {
  "type": "string",
  "enum": ["apm.k8s.elastic.co/v1alpha1"]
};
function validate22(data, {
  ...
  if (!(data === "apm.k8s.elastic.co/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  /*# sourceURL="apm.k8s.elastic.co.v1alpha1.ApmServer" */;
  let vErrors = null;
  let errors = 0;
