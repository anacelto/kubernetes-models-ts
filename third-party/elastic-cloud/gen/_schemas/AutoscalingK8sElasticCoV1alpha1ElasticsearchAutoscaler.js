...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "EyHhRT2vx7q1wyzUvwREtz9Cc0OnLxEFNoTOVDCNSOE"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "wikpPczqfp5DrXTUz4hKgb6PdqmTr90dyBbrXKSEeo"
    },
    "status": {
      "$ref": "aVrbxkPTBuJSNBf0fQIGkXpY2zKypDcBqHciKKTk2g"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "autoscaling.k8s.elastic.co.v1alpha1.ElasticsearchAutoscaler"
};
const schema15 = {
  "type": "string",
  "enum": ["autoscaling.k8s.elastic.co/v1alpha1"]
};
function validate36(data, {
  ...
  if (!(data === "autoscaling.k8s.elastic.co/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  "properties": {
    ...
    "policies": {
      "$ref": "KoEKhFY7XcqvNNXWUZt9dLkttUqodKvZiH4m65wKMg"
    },
    "pollingPeriod": {
...
const schema22 = {
  "items": {
    "$ref": "K6mtbxNZ0aC5gnGDFXxFYeMCMuiYr7ZFlcDYEVk"
  },
  "type": "array"
};
const schema23 = {
  "properties": {
    ...
    "resources": {
      "$ref": "ai8f0XhSRjexYm8tHu8kvGtvgf7gYm0JieHmIybtYZ4"
    },
    "roles": {
...
const schema26 = {
  "properties": {
    "cpu": {
      "$ref": "MOHgqiwBtJXhaqfwJg9KgYUkMqXitRNbzQ6l9k1MHY"
    },
    "memory": {
      "$ref": "MOHgqiwBtJXhaqfwJg9KgYUkMqXitRNbzQ6l9k1MHY"
    },
    "nodeCount": {
      "$ref": "Ty0hi3FfEaJvcuozIiUqsq0xrKNyOfgoiyjWN8dIjA"
    },
    "storage": {
      "$ref": "MOHgqiwBtJXhaqfwJg9KgYUkMqXitRNbzQ6l9k1MHY"
    }
...
function validate26(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.requestsToLimitsRatio !== undefined) {
      if (!validate22(data.requestsToLimitsRatio, {
        instancePath: instancePath + "/requestsToLimitsRatio",
        parentData: data,
        parentDataProperty: "requestsToLimitsRatio",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.deciders !== undefined) {
      if (!validate51(data.deciders, {
        instancePath: instancePath + "/deciders",
        parentData: data,
        parentDataProperty: "deciders",
        rootData
      })) {
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.pollingPeriod !== undefined) {
      if (!validate31(data.pollingPeriod, {
        instancePath: instancePath + "/pollingPeriod",
        parentData: data,
        parentDataProperty: "pollingPeriod",
        rootData
      })) {
        vErrors = vErrors === null ? validate31.errors : vErrors.concat(validate31.errors);
        errors = vErrors.length;
...
const schema29 = {
  "properties": {
    ...
    "policies": {
      "$ref": "gZaF6MY6REOLsrDssZZIQXsIlqLSMA8WGXHlIvT2N4"
    }
  },
  "type": "object",
  "nullable": true
...
const schema33 = {
  "items": {
    "$ref": "Mjg37sAnRWEliEUlIUCAkGS8tMDtvlk20kxCcJcmV8"
  },
  "type": "array",
  "nullable": true
};
const schema34 = {
  "properties": {
    ...
    "nodeSets": {
      "$ref": "a3HSYws4eHSGLv4brZjOtm0YwDdpfd6WQwWvY6XuE"
    },
    "resources": {
      "$ref": "7WXa2aF6GMGgfmkZvnQ0mQJTzClD5QYxEdLx0dV7xuQ"
    },
    "state": {
      "$ref": "4wZvvtqSwnpMrT7Fc4tTGHFzSTkvjLRtgabi3tdIM"
    }
  },
  "required": ["name"],
  "type": "object"
...
const schema35 = {
  "items": {
    "$ref": "bcT0NqIhZSLIx0Ph1xK9XDzzWOoPIgY6qRkc7eeWG8"
  },
  "type": "array",
  "nullable": true
};
...
const schema38 = {
  "items": {
    "$ref": "QwMA1KAwhruQOygtrS50ED3TWC78Odr2lpROB69EM"
  },
  "type": "array",
  "nullable": true
};
...
function validate85(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastModificationTime !== undefined) {
      if (!validate32(data.lastModificationTime, {
...
function validate35(data, {
  ...
  /*# sourceURL="autoscaling.k8s.elastic.co.v1alpha1.ElasticsearchAutoscaler" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
