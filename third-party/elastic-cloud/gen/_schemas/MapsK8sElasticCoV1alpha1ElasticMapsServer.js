...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "Q0TfZ9KwtF2SsQqOcHKbSHr4vZbdJQQHNF7s3m16O5k"
    },
    "kind": {
      "$ref": "HVxwbPjVlPFTg2qRTUWwthldBF5MXolHQsCCJk4So"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "aX2qP0Yq14b1uTYO9qYmLMiE3pNfKmG5Tb54asNBIQ"
    },
    "status": {
      "$ref": "qxMUY0gqwvKxiamFSz0hU2aTyRhuzDVVblWgQBwYsE"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "maps.k8s.elastic.co.v1alpha1.ElasticMapsServer"
};
const schema15 = {
  "type": "string",
  "enum": ["maps.k8s.elastic.co/v1alpha1"]
};
function validate33(data, {
  ...
  if (!(data === "maps.k8s.elastic.co/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  /*# sourceURL="maps.k8s.elastic.co.v1alpha1.ElasticMapsServer" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
