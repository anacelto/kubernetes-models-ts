...
const schema6 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "2HxsWest9hwRWZVxI1aguwl9z3W0syKAEQZ8ZdD4RyQ"
    },
    "kind": {
...
const schema7 = {
  "type": "string",
  "enum": ["kibana.k8s.elastic.co/v1alpha1"]
};
function validate22(data, {
  ...
  if (!(data === "kibana.k8s.elastic.co/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  /*# sourceURL="kibana.k8s.elastic.co.v1alpha1.Kibana" */;
  let vErrors = null;
  let errors = 0;
