...
const schema17 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "V95Mu6HYEkZO5KkEOjRsaFFcprI4UuUzYthk1CniNo"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "PSSyznuz9W5hBudfStBkXiuGs30zGMcykvwP0yU0Mw"
    },
    "status": {
      "$ref": "W2jrckmgtmVdPRZ7EMz5yqkCqgaaoGeFfZFUnFZVSdU"
    }
  },
...
function validate45(data, {
  ...
  if (!(data === "kibana.k8s.elastic.co/v1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate101(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.timeoutSeconds !== undefined) {
      if (!validate32(data.timeoutSeconds, {
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allocateLoadBalancerNodePorts !== undefined) {
      if (!validate33(data.allocateLoadBalancerNodePorts, {
    ...
    if (data.externalIPs !== undefined) {
      if (!validate30(data.externalIPs, {
    ...
    if (data.healthCheckNodePort !== undefined) {
      if (!validate32(data.healthCheckNodePort, {
    ...
    if (data.loadBalancerSourceRanges !== undefined) {
      if (!validate30(data.loadBalancerSourceRanges, {
    ...
    if (data.publishNotReadyAddresses !== undefined) {
      if (!validate33(data.publishNotReadyAddresses, {
    ...
    if (data.sessionAffinityConfig !== undefined) {
      if (!validate100(data.sessionAffinityConfig, {
...
function validate112(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.subjectAltNames !== undefined) {
      if (!validate114(data.subjectAltNames, {
...
function validate108(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificate !== undefined) {
      if (!validate109(data.certificate, {
    ...
    if (data.selfSignedCertificate !== undefined) {
      if (!validate112(data.selfSignedCertificate, {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.elasticsearchRefs !== undefined) {
      if (!validate35(data.elasticsearchRefs, {
...
function validate53(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.elasticsearchRef !== undefined) {
      if (!validate22(data.elasticsearchRef, {
    ...
    if (data.enterpriseSearchRef !== undefined) {
      if (!validate22(data.enterpriseSearchRef, {
        instancePath: instancePath + "/enterpriseSearchRef",
        parentData: data,
        parentDataProperty: "enterpriseSearchRef",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.monitoring !== undefined) {
      if (!validate124(data.monitoring, {
    ...
    if (data.podTemplate !== undefined) {
      if (!validate43(data.podTemplate, {
    ...
    if (data.revisionHistoryLimit !== undefined) {
      if (!validate32(data.revisionHistoryLimit, {
    ...
    if (data.secureSettings !== undefined) {
      if (!validate130(data.secureSettings, {
...
function validate144(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.availableNodes !== undefined) {
      if (!validate32(data.availableNodes, {
    ...
    if (data.elasticsearchAssociationStatus !== undefined) {
      if (!validate21(data.elasticsearchAssociationStatus, {
        instancePath: instancePath + "/elasticsearchAssociationStatus",
        parentData: data,
        parentDataProperty: "elasticsearchAssociationStatus",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.enterpriseSearchAssociationStatus !== undefined) {
      if (!validate21(data.enterpriseSearchAssociationStatus, {
        instancePath: instancePath + "/enterpriseSearchAssociationStatus",
        parentData: data,
        parentDataProperty: "enterpriseSearchAssociationStatus",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.monitoringAssociationStatus !== undefined) {
      if (!validate28(data.monitoringAssociationStatus, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate152(data.observedGeneration, {
...
function validate44(data, {
  ...
  /*# sourceURL="kibana.k8s.elastic.co.v1.Kibana" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
