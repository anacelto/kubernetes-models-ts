...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "OQ9NFtCY2fPiKVeqxtonkwiaq938wir3nMcXVP9i4"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "upsHQzVuiXUcGOS5GdRUAjpJgz5lIXRG7hiNgQ0hQ"
    },
    "status": {
      "$ref": "DNr5U0OUlBMkTdaI1pe9jJ4X65owGXxrGmJ2RPeRQ"
    }
  },
...
function validate57(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sessionAffinityConfig !== undefined) {
      if (!validate90(data.sessionAffinityConfig, {
...
function validate102(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.subjectAltNames !== undefined) {
      if (!validate104(data.subjectAltNames, {
...
function validate98(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificate !== undefined) {
      if (!validate99(data.certificate, {
    ...
    if (data.selfSignedCertificate !== undefined) {
      if (!validate102(data.selfSignedCertificate, {
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.elasticsearchRef !== undefined) {
      if (!validate29(data.elasticsearchRef, {
    ...
    if (data.podTemplate !== undefined) {
      if (!validate34(data.podTemplate, {
    ...
    if (data.secureSettings !== undefined) {
      if (!validate117(data.secureSettings, {
...
function validate131(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.kibanaAssociationStatus !== undefined) {
      if (!validate21(data.kibanaAssociationStatus, {
    ...
    if (data.secretTokenSecret !== undefined) {
      if (!validate21(data.secretTokenSecret, {
        instancePath: instancePath + "/secretTokenSecret",
        parentData: data,
        parentDataProperty: "secretTokenSecret",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate35(data, {
  ...
  /*# sourceURL="apm.k8s.elastic.co.v1.ApmServer" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
