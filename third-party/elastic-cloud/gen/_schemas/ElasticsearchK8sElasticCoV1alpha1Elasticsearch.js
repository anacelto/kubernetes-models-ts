...
const schema6 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "kFZqAllaKxDVXjbfaVz5LqiFTbwvvvQ1fO4lxJhWNw0"
    },
    "kind": {
...
const schema7 = {
  "type": "string",
  "enum": ["elasticsearch.k8s.elastic.co/v1alpha1"]
};
function validate22(data, {
  ...
  if (!(data === "elasticsearch.k8s.elastic.co/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  /*# sourceURL="elasticsearch.k8s.elastic.co.v1alpha1.Elasticsearch" */;
  let vErrors = null;
  let errors = 0;
