...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "2lj7NTPtDblHwHV7SEobxjO0gQscHNrefWj8YSpWCbg"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "WTAtSCyxCJ5c33BjNWYCH0udzOwugoAdwlx771bE"
    },
    "status": {
      "$ref": "handuRfFeICCBpB6jJAWHwInYhTUo0avMeBkeu9H8Q"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "enterprisesearch.k8s.elastic.co.v1beta1.EnterpriseSearch"
};
const schema15 = {
  "type": "string",
  "enum": ["enterprisesearch.k8s.elastic.co/v1beta1"]
};
function validate33(data, {
  ...
  if (!(data === "enterprisesearch.k8s.elastic.co/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate32(data, {
  ...
  /*# sourceURL="enterprisesearch.k8s.elastic.co.v1beta1.EnterpriseSearch" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
