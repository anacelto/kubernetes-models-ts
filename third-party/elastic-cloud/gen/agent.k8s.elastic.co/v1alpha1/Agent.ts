...
import { validate } from "../../_schemas/AgentK8sElasticCoV1alpha1Agent";
 ...
 * Agent is the Schema for the Agents API.
 */
export class Agent extends Model<IAgent> implements IAgent {
  "apiVersion": IAgent["apiVersion"];
  "kind": IAgent["kind"];
  "metadata"?: IAgent["metadata"];
  "spec"?: IAgent["spec"];
  "status"?: IAgent["status"];

static apiVersion: IAgent["apiVersion"] = "agent.k8s.elastic.co/v1alpha1";
static kind: IAgent["kind"] = "Agent";
static is = createTypeMetaGuard<IAgent>(Agent);

constructor(data?: ModelData<IAgent>) {
  super();
...
setValidateFunc(Agent, validate as ValidateFunc<IAgent>);
