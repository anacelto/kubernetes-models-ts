 ...
 * StackConfigPolicy represents a StackConfigPolicy resource in a Kubernetes cluster.
 */
export declare class StackConfigPolicy extends Model<IStackConfigPolicy> implements IStackConfigPolicy {
    ...
    static apiVersion: IStackConfigPolicy["apiVersion"];
    static kind: IStackConfigPolicy["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IStackConfigPolicy>;
