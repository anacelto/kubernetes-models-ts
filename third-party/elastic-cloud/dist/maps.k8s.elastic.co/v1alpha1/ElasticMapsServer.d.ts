 ...
 * ElasticMapsServer represents an Elastic Map Server resource in a Kubernetes cluster.
 */
export declare class ElasticMapsServer extends Model<IElasticMapsServer> implements IElasticMapsServer {
    ...
    static apiVersion: IElasticMapsServer["apiVersion"];
    static kind: IElasticMapsServer["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IElasticMapsServer>;
