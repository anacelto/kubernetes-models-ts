 ...
 * Logstash is the Schema for the logstashes API
 */
export declare class Logstash extends Model<ILogstash> implements ILogstash {
    "apiVersion": ILogstash["apiVersion"];
    "kind": ILogstash["kind"];
    "metadata"?: ILogstash["metadata"];
    "spec"?: ILogstash["spec"];
    "status"?: ILogstash["status"];
    static apiVersion: ILogstash["apiVersion"];
    static kind: ILogstash["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ILogstash>;
