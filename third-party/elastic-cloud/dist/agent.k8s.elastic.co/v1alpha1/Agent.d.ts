 ...
 * Agent is the Schema for the Agents API.
 */
export declare class Agent extends Model<IAgent> implements IAgent {
    "apiVersion": IAgent["apiVersion"];
    "kind": IAgent["kind"];
    "metadata"?: IAgent["metadata"];
    "spec"?: IAgent["spec"];
    "status"?: IAgent["status"];
    static apiVersion: IAgent["apiVersion"];
    static kind: IAgent["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IAgent>;
