...
const schema49 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "dRaw2zBxpC5YcQDhDkRixDFvFuQpXnEys4Tz1QZYFg"
    },
    "kind": {
      "$ref": "ccT2iK4OslKggTQjXadRegbTxHRjDVLDAHIvIhNm4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "1o2Yl8ETWFGCypGEfuXLVvHlr5OhSPS8SViAJqnuZQ"
    },
    "status": {
  ...
  "$id": "redis.redis.opstreelabs.in.v1beta1.RedisCluster"
};
const schema50 = {
  "type": "string",
  "enum": ["redis.redis.opstreelabs.in/v1beta1"]
};
function validate134(data, {
  ...
  if (!(data === "redis.redis.opstreelabs.in/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema54 = {
  "properties": {
    "TLS": {
      "$ref": "QdVqm8ex4UenJ2hTbG9n4Xl6DWwuhq5nxHzf9rqf8"
    },
    "clusterSize": {
      "$ref": "ppOMqvYEA3GSH3ozhOJ2Wta6ImWhzC9DOYsjidshCYo"
    },
    "clusterVersion": {
      "$ref": "UsctNeDwEqtF6Q7MaO40FZNs3PTUy16Vy1uGKp1JQ"
    },
    "kubernetesConfig": {
      "$ref": "uFyhduoUrz1kYCoaW50PwIHHXAxtISag491RPfFoBE"
    },
    "nodeSelector": {
    ...
    "redisExporter": {
      "$ref": "JBiHXoQSAucKC9IzCTSCUUQKATlE186oGzz5YN4"
    },
    "redisFollower": {
      "$ref": "fK8cRHJd2KGpDd27S9EntOogALYg1rK26VRoCWJ49w"
    },
    "redisLeader": {
      "$ref": "fK8cRHJd2KGpDd27S9EntOogALYg1rK26VRoCWJ49w"
    },
    ...
    "sidecars": {
      "$ref": "CL9DPRGKaoXtE9kN9vjQOLASiP9oH2UG8y9dAjHzw"
    },
    "storage": {
      "$ref": "OxAT7V51L2LooRFiBQSSfMy9W3LpUFdy5qYJZxzK2k"
    },
    "tolerations": {
      "$ref": "0n4c9hC8BjWXgqJPcgtzXIbgzIfyT58Oy1pU5nsoec"
    }
  },
  "required": ["clusterSize", "kubernetesConfig"],
  "type": "object"
};
const schema55 = {
  "properties": {
    ...
    "secret": {
      "$ref": "kF144fG3dCLM2cUe1bswQpkofaRb5L1q87HOFdikKM"
    }
  },
  "required": ["secret"],
  "type": "object",
...
function validate176(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.rollingUpdate !== undefined) {
      if (!validate177(data.rollingUpdate, {
...
function validate163(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate166(data.imagePullSecrets, {
    ...
    if (data.redisSecret !== undefined) {
      if (!validate171(data.redisSecret, {
        instancePath: instancePath + "/redisSecret",
        parentData: data,
        parentDataProperty: "redisSecret",
        rootData
      })) {
    ...
    if (data.updateStrategy !== undefined) {
      if (!validate176(data.updateStrategy, {
...
function validate113(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.configMapKeyRef !== undefined) {
      if (!validate31(data.configMapKeyRef, {
    ...
    if (data.resourceFieldRef !== undefined) {
      if (!validate119(data.resourceFieldRef, {
    ...
    if (data.secretKeyRef !== undefined) {
      if (!validate31(data.secretKeyRef, {
...
const schema31 = {
  ...
  "properties": {
    ...
    "livenessProbe": {
      "$ref": "NEso5tc9JrhL6hfixCE48FAr0LCaZBtwDLPQTIkIm0"
    },
    "pdb": {
      "$ref": "B85yKEs68TCWqBxayhmNtWVHgJhUjNQ5lh3j5fYzEo"
    },
    "readinessProbe": {
      "$ref": "NEso5tc9JrhL6hfixCE48FAr0LCaZBtwDLPQTIkIm0"
    },
    "redisConfig": {
      "$ref": "jCpfGnHWOxdvsmOqHMObvzNnNhL89eNd8UYx2q1x9YY"
    },
    "replicas": {
      "$ref": "Ccz0XZyNWiwVpe2nvsmnlMV1SnfQGMXuejl0yByE"
    }
...
function validate88(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelectorTerms !== undefined) {
      if (!validate89(data.nodeSelectorTerms, {
...
function validate81(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate82(data.preferredDuringSchedulingIgnoredDuringExecution, {
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate88(data.requiredDuringSchedulingIgnoredDuringExecution, {
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate50(data.matchLabels, {
...
function validate62(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.podAffinityTerm !== undefined) {
      if (!validate55(data.podAffinityTerm, {
...
function validate80(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nodeAffinity !== undefined) {
      if (!validate81(data.nodeAffinity, {
...
function validate71(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.failureThreshold !== undefined) {
      if (!validate72(data.failureThreshold, {
    ...
    if (data.initialDelaySeconds !== undefined) {
      if (!validate70(data.initialDelaySeconds, {
    ...
    if (data.periodSeconds !== undefined) {
      if (!validate75(data.periodSeconds, {
    ...
    if (data.successThreshold !== undefined) {
      if (!validate70(data.successThreshold, {
    ...
    if (data.timeoutSeconds !== undefined) {
      if (!validate70(data.timeoutSeconds, {
...
function validate98(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.minAvailable !== undefined) {
      if (!validate22(data.minAvailable, {
...
function validate104(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.additionalRedisConfig !== undefined) {
      if (!validate21(data.additionalRedisConfig, {
        instancePath: instancePath + "/additionalRedisConfig",
        parentData: data,
        parentDataProperty: "additionalRedisConfig",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate79(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.pdb !== undefined) {
      if (!validate98(data.pdb, {
        instancePath: instancePath + "/pdb",
        parentData: data,
        parentDataProperty: "pdb",
        rootData
      })) {
    ...
    if (data.redisConfig !== undefined) {
      if (!validate104(data.redisConfig, {
        instancePath: instancePath + "/redisConfig",
        parentData: data,
        parentDataProperty: "redisConfig",
        rootData
      })) {
...
function validate196(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.runAsGroup !== undefined) {
      if (!validate108(data.runAsGroup, {
    ...
    if (data.seLinuxOptions !== undefined) {
      if (!validate202(data.seLinuxOptions, {
    ...
    if (data.seccompProfile !== undefined) {
      if (!validate208(data.seccompProfile, {
    ...
    if (data.supplementalGroups !== undefined) {
      if (!validate212(data.supplementalGroups, {
    ...
    if (data.windowsOptions !== undefined) {
      if (!validate222(data.windowsOptions, {
...
const schema75 = {
  "items": {
    "$ref": "8KWyxcz999iWrxTxbXa4ijlMIYW04lUSL97fS7bvc"
  },
  "type": "array",
  "nullable": true
};
...
const schema77 = {
  "properties": {
    "volumeClaimTemplate": {
      "$ref": "RJ4gAT7sDbG182JPU61xkmVnAP5rbOxlP8Z28wXfEdc"
    }
  },
  "type": "object",
  "nullable": true
...
function validate244(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.dataSource !== undefined) {
      if (!validate127(data.dataSource, {
    ...
    if (data.dataSourceRef !== undefined) {
      if (!validate127(data.dataSourceRef, {
...
function validate259(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastProbeTime !== undefined) {
      if (!validate131(data.lastProbeTime, {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate131(data.lastTransitionTime, {
...
function validate254(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allocatedResources !== undefined) {
      if (!validate24(data.allocatedResources, {
    ...
    if (data.conditions !== undefined) {
      if (!validate258(data.conditions, {
...
function validate239(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.volumeClaimTemplate !== undefined) {
      if (!validate240(data.volumeClaimTemplate, {
...
function validate274(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tolerationSeconds !== undefined) {
      if (!validate108(data.tolerationSeconds, {
...
function validate142(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.clusterSize === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "clusterSize"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.kubernetesConfig === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "kubernetesConfig"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.clusterSize !== undefined) {
      if (!validate46(data.clusterSize, {
        instancePath: instancePath + "/clusterSize",
        parentData: data,
        parentDataProperty: "clusterSize",
        rootData
      })) {
        vErrors = vErrors === null ? validate46.errors : vErrors.concat(validate46.errors);
        errors = vErrors.length;
    ...
    if (data.clusterVersion !== undefined) {
      if (!validate161(data.clusterVersion, {
    ...
    if (data.kubernetesConfig !== undefined) {
      if (!validate163(data.kubernetesConfig, {
        instancePath: instancePath + "/kubernetesConfig",
        parentData: data,
        parentDataProperty: "kubernetesConfig",
        rootData
      })) {
    ...
    if (data.nodeSelector !== undefined) {
      if (!validate50(data.nodeSelector, {
    ...
    if (data.persistenceEnabled !== undefined) {
      if (!validate30(data.persistenceEnabled, {
        instancePath: instancePath + "/persistenceEnabled",
        parentData: data,
        parentDataProperty: "persistenceEnabled",
        rootData
      })) {
        vErrors = vErrors === null ? validate30.errors : vErrors.concat(validate30.errors);
        errors = vErrors.length;
    ...
    if (data.redisExporter !== undefined) {
      if (!validate186(data.redisExporter, {
        instancePath: instancePath + "/redisExporter",
        parentData: data,
        parentDataProperty: "redisExporter",
        rootData
      })) {
    ...
    if (data.redisFollower !== undefined) {
      if (!validate79(data.redisFollower, {
        instancePath: instancePath + "/redisFollower",
        parentData: data,
        parentDataProperty: "redisFollower",
        rootData
      })) {
    ...
    if (data.redisLeader !== undefined) {
      if (!validate79(data.redisLeader, {
        instancePath: instancePath + "/redisLeader",
        parentData: data,
        parentDataProperty: "redisLeader",
        rootData
      })) {
        vErrors = vErrors === null ? validate79.errors : vErrors.concat(validate79.errors);
        errors = vErrors.length;
    ...
    if (data.securityContext !== undefined) {
      if (!validate196(data.securityContext, {
    ...
    if (data.tolerations !== undefined) {
      if (!validate273(data.tolerations, {
...
function validate133(data, {
  ...
  /*# sourceURL="redis.redis.opstreelabs.in.v1beta1.RedisCluster" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.spec === undefined) {
