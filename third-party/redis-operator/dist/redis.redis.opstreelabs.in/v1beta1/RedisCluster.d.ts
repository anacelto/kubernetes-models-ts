 ...
 * RedisCluster is the Schema for the redisclusters API
 */
export declare class RedisCluster extends Model<IRedisCluster> implements IRedisCluster {
    ...
    static apiVersion: IRedisCluster["apiVersion"];
    static kind: IRedisCluster["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IRedisCluster>;
