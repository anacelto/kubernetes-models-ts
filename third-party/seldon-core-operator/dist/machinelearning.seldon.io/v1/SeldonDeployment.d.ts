 ...
 * SeldonDeployment is the Schema for the seldondeployments API
 */
export declare class SeldonDeployment extends Model<ISeldonDeployment> implements ISeldonDeployment {
    ...
    static apiVersion: ISeldonDeployment["apiVersion"];
    static kind: ISeldonDeployment["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISeldonDeployment>;
