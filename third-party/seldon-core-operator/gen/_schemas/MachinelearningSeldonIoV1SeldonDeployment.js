...
const schema73 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "NwPEjVaz4IcfhNOYkav8Qfuef17V6xwO7Knh520KSoY"
    },
    "kind": {
  ...
  "$id": "machinelearning.seldon.io.v1.SeldonDeployment"
};
const schema74 = {
  "type": "string",
  "enum": ["machinelearning.seldon.io/v1"]
};
function validate257(data, {
  ...
  if (!(data === "machinelearning.seldon.io/v1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate256(data, {
  ...
  /*# sourceURL="machinelearning.seldon.io.v1.SeldonDeployment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
