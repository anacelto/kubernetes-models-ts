...
const schema73 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "vna3fILYRodlxZWRm2qfgdLnBVkPHA7IdUe7KRk7iCs"
    },
    "kind": {
  ...
  "$id": "machinelearning.seldon.io.v1alpha2.SeldonDeployment"
};
const schema74 = {
  "type": "string",
  "enum": ["machinelearning.seldon.io/v1alpha2"]
};
function validate257(data, {
  ...
  if (!(data === "machinelearning.seldon.io/v1alpha2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate256(data, {
  ...
  /*# sourceURL="machinelearning.seldon.io.v1alpha2.SeldonDeployment" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
