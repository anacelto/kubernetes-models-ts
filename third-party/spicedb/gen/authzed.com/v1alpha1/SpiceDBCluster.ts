...
import { validate } from "../../_schemas/AuthzedComV1alpha1SpiceDBCluster";
 ...
 * SpiceDBCluster defines all options for a full SpiceDB cluster
 */
export class SpiceDBCluster extends Model<ISpiceDBCluster> implements ISpiceDBCluster {
...
static apiVersion: ISpiceDBCluster["apiVersion"] = "authzed.com/v1alpha1";
static kind: ISpiceDBCluster["kind"] = "SpiceDBCluster";
static is = createTypeMetaGuard<ISpiceDBCluster>(SpiceDBCluster);

constructor(data?: ModelData<ISpiceDBCluster>) {
  super();

  this.setDefinedProps({
    apiVersion: SpiceDBCluster.apiVersion,
...
setValidateFunc(SpiceDBCluster, validate as ValidateFunc<ISpiceDBCluster>);
