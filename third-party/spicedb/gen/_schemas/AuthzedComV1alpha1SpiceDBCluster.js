...
const schema10 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "r0UuOEDqT7ExWTetoFDjHDQ4mqk13ASS2MBa94aBOU"
    },
    "kind": {
      "$ref": "7atjv1SUPszDhViAnhmoYwyXiSjHUTvFAPNlvXt8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "IG7wnKFLlSrIeUFVQm6BNFEkvtTcH84XSIrohAKFrsE"
    },
    "status": {
      "$ref": "mVFc5Mx645QcyNN4WDL1paUPIKe4SHTQIkTFOICg"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "authzed.com.v1alpha1.SpiceDBCluster"
};
const schema11 = {
  "type": "string",
  "enum": ["authzed.com/v1alpha1"]
};
...
const schema15 = {
  "properties": {
    ...
    "patches": {
      "$ref": "HbjEjVuzeUJ4m6x2kBFTjPqwxqeN4l2ZDzcjhDThQg"
    },
    "secretName": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema17 = {
  "items": {
    "$ref": "jBhArW7Yown4n1ca58anKjGflbuZnXbGJf8CcTGMww"
  },
  "type": "array",
  "nullable": true
};
...
const schema20 = {
  "properties": {
    "availableVersions": {
      "$ref": "WFXupChiw7FPBV7B87WoOJnOz5Pdo2naZ8sQUDzE"
    },
    "conditions": {
    ...
    "version": {
      "$ref": "HSZJrGVpqSojErdFEhHP36qjJpSzD2U7Q36t0LIKE"
    }
  },
  "type": "object",
  "nullable": true
...
const schema21 = {
  "items": {
    "$ref": "H92UtfWIaBhF1qJt1SgIHMw4gPQABoP92GiKdpE0"
  },
  "type": "array",
  "nullable": true
};
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.availableVersions !== undefined) {
      if (!validate50(data.availableVersions, {
        instancePath: instancePath + "/availableVersions",
        parentData: data,
        parentDataProperty: "availableVersions",
        rootData
      })) {
    ...
    if (data.currentMigrationHash !== undefined) {
      if (!validate21(data.currentMigrationHash, {
        instancePath: instancePath + "/currentMigrationHash",
        parentData: data,
        parentDataProperty: "currentMigrationHash",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.migration !== undefined) {
      if (!validate21(data.migration, {
        instancePath: instancePath + "/migration",
        parentData: data,
        parentDataProperty: "migration",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.secretHash !== undefined) {
      if (!validate21(data.secretHash, {
        instancePath: instancePath + "/secretHash",
        parentData: data,
        parentDataProperty: "secretHash",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.targetMigrationHash !== undefined) {
      if (!validate21(data.targetMigrationHash, {
        instancePath: instancePath + "/targetMigrationHash",
        parentData: data,
        parentDataProperty: "targetMigrationHash",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate26(data, {
  ...
  /*# sourceURL="authzed.com.v1alpha1.SpiceDBCluster" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
