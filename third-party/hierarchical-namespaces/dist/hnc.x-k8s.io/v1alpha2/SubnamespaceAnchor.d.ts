 ...
 * SubnamespaceAnchor is the Schema for the subnamespace API. See details at http://bit.ly/hnc-self-serve-ux.
 */
export declare class SubnamespaceAnchor extends Model<ISubnamespaceAnchor> implements ISubnamespaceAnchor {
    ...
    static apiVersion: ISubnamespaceAnchor["apiVersion"];
    static kind: ISubnamespaceAnchor["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<ISubnamespaceAnchor>;
