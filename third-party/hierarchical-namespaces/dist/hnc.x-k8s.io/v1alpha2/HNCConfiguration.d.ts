 ...
 * HNCConfiguration is a cluster-wide configuration for HNC as a whole. See details in http://bit.ly/hnc-type-configuration
 */
export declare class HNCConfiguration extends Model<IHNCConfiguration> implements IHNCConfiguration {
    ...
    static apiVersion: IHNCConfiguration["apiVersion"];
    static kind: IHNCConfiguration["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IHNCConfiguration>;
