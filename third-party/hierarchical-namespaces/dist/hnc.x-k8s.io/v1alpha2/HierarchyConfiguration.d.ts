 ...
 * Hierarchy is the Schema for the hierarchies API
 */
export declare class HierarchyConfiguration extends Model<IHierarchyConfiguration> implements IHierarchyConfiguration {
    ...
    static apiVersion: IHierarchyConfiguration["apiVersion"];
    static kind: IHierarchyConfiguration["kind"];
    static is: import("@kubernetes-models/base").TypeMetaGuard<IHierarchyConfiguration>;
