...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "ldhL6QZ64kDO3wUrWbWxWqQjoB7yEmwdBK6jmgPoU0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "67G23BvZ0mbwP4f9SJ3vlGCpMKb7b9DuncbFzU6YZQ"
    },
    "status": {
      "$ref": "mMg08kDY9drdDMqVDkHfL5j6uOiLZOQrfbS6wmlcjQ"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "hnc.x-k8s.io.v1alpha2.HierarchicalResourceQuota"
};
const schema11 = {
  "type": "string",
...
const schema12 = {
  "type": "string",
  "enum": ["HierarchicalResourceQuota"]
};
function validate31(data, {
  ...
  if (!(data === "HierarchicalResourceQuota")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate28(data, {
  ...
  /*# sourceURL="hnc.x-k8s.io.v1alpha2.HierarchicalResourceQuota" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
