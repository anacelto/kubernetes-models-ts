...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "z5kMpP4WpACBwFS5dDzZGrpSlWX77IldeFEhTu3LQ"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "wjYlGT2PTiVKCwCvUK8RNFkcuqoGut9wBlGlj8iER0"
    },
    "status": {
      "$ref": "HthWq475e2p2pf1GFoVg5DQ6heeLJPfH65UzNt6KQ"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "hnc.x-k8s.io.v1alpha2.SubnamespaceAnchor"
};
const schema10 = {
  "type": "string",
...
function validate27(data, {
  ...
  /*# sourceURL="hnc.x-k8s.io.v1alpha2.SubnamespaceAnchor" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
