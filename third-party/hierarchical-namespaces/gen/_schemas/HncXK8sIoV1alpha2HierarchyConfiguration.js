...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "u079nPHchtVZlNCxpFTDKvPt4uAjK23TSzb75w2h0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "C4YFwSKXcfIYnpZUFx1YDurptTxC5wUB7hVEtHHeic"
    },
    "status": {
      "$ref": "GLyeKLpVk9Aws95XJOMkgEBJMeF9gNmJJKF22scOFs"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "hnc.x-k8s.io.v1alpha2.HierarchyConfiguration"
};
const schema10 = {
  "type": "string",
...
function validate30(data, {
  ...
  if (!(data === "HierarchyConfiguration")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.allowCascadingDeletion !== undefined) {
      if (!validate37(data.allowCascadingDeletion, {
        instancePath: instancePath + "/allowCascadingDeletion",
        parentData: data,
        parentDataProperty: "allowCascadingDeletion",
        rootData
      })) {
...
function validate27(data, {
  ...
  /*# sourceURL="hnc.x-k8s.io.v1alpha2.HierarchyConfiguration" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
