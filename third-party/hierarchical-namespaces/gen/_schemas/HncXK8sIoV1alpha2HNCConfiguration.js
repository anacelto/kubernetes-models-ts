...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "I6wmkzBUhcjKosHWJ697b4AnhvYbnjN0fwujdJZM"
    },
    "kind": {
      "$ref": "AbhnLVQnZRrLbVerzuY9oM9B8Y8fsHfUv89Fd81gzmU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "8Ge0sVA2igLAo9Lap3dFkV36OpDzmJdJNbZpAVHE4W0"
    },
    "status": {
      "$ref": "IxYVtrKmVnH54ZKb0Bg9umLGL0L1ViIhD4eBapKrcNg"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "hnc.x-k8s.io.v1alpha2.HNCConfiguration"
};
const schema10 = {
  "type": "string",
  "enum": ["hnc.x-k8s.io/v1alpha2"]
};
...
const schema14 = {
  "properties": {
    "resources": {
      "$ref": "FYbZlAUICKvm10PRzvMIXgVftJvF5R0w2rMuekk7QkI"
    }
  },
  "type": "object",
  "nullable": true
...
const schema15 = {
  "items": {
    "$ref": "AX1uiEFMfPnqTjA1vtmdPD1G6gEdHeVlqdyoxeaBUY"
  },
  "type": "array",
  "nullable": true
};
const schema16 = {
  "properties": {
    ...
    "mode": {
      "$ref": "7XpuESXCviMPPso8w0pEtLQWXp23sU6tBK5nLEqA"
    },
    "resource": {
...
const schema17 = {
  "enum": ["Propagate", "Ignore", "Remove", "AllowPropagate"],
  "type": "string",
  "nullable": true
};
function validate37(data, {
  ...
  if (!(data === "Propagate" || data === "Ignore" || data === "Remove" || data === "AllowPropagate")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema18 = {
  "properties": {
    ...
    "resources": {
      "$ref": "aQhYwaZTlvtcWF2ySjtMwrxZp1GMkcgiRdmn2pvpfs"
    }
  },
  "type": "object",
  "nullable": true
...
function validate45(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate46(data.lastTransitionTime, {
...
const schema27 = {
  "items": {
    "$ref": "1t5Q2CJm2wgZKDwKRcvZ6cAbDsZqLXqXn8HAbqMAY"
  },
  "type": "array",
  "nullable": true
};
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.numPropagatedObjects !== undefined) {
      if (!validate23(data.numPropagatedObjects, {
        instancePath: instancePath + "/numPropagatedObjects",
        parentData: data,
        parentDataProperty: "numPropagatedObjects",
        rootData
      })) {
    ...
    if (data.numSourceObjects !== undefined) {
      if (!validate23(data.numSourceObjects, {
        instancePath: instancePath + "/numSourceObjects",
        parentData: data,
        parentDataProperty: "numSourceObjects",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="hnc.x-k8s.io.v1alpha2.HNCConfiguration" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
